import"./chunks/chunk-ZUUPKAA6.js";var $e=[{id:"wc-spain-austria-spread",category:"Sports",timeframe:"Daily",question:"Will Spain beat Austria by a margin of 2 or more goals?",probability:52,marketAddress:"0x123580A3Af7E22a591a460E249346a3beeCEd930",deploymentBlock:49766205,kickoffAt:"2026-07-02T19:00:00Z",expectedEndAt:"2026-07-02T20:45:00Z",resolveAfter:"2026-07-02T21:40:00Z",closes:"Jul 2, 7:40 PM GMT+1",resolution:"Resolves Yes if Spain defeat Austria by a margin of 2 or more goals in their July 2, 2026 World Cup knockout match, including extra time if played. Resolves No if Spain win by exactly 1 goal, Austria advance, or the match is decided by penalties after a draw. Penalty shootout goals do not count toward the margin. Resolve after the official result is final, including extra time and penalties if needed.",threadTopic:"Spain Austria World Cup Knockout",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1574629810360-7efbbe195018?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-ronaldo-score-assist-croatia",category:"Sports",timeframe:"Daily",question:"Will Cristiano Ronaldo score or assist against Croatia?",probability:43,marketAddress:"0xBccb9DC161C1260F3074752f4D1579a74bD86490",deploymentBlock:49766205,kickoffAt:"2026-07-02T23:00:00Z",expectedEndAt:"2026-07-03T00:45:00Z",resolveAfter:"2026-07-03T01:40:00Z",closes:"Jul 2, 11:40 PM GMT+1",resolution:"Resolves Yes if Cristiano Ronaldo is officially credited with at least one goal or assist for Portugal against Croatia in their July 2, 2026 World Cup knockout match, including regular time and extra time. Penalty shootout goals do not count. Resolves No if he does not play or is not officially credited with a goal or assist. Resolve after the official match stats are final.",threadTopic:"Portugal Croatia Ronaldo World Cup Knockout",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1522778119026-d647f0596c20?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-portugal-croatia-extra-time",category:"Sports",timeframe:"Daily",question:"Will Portugal vs Croatia go to extra time?",probability:36,marketAddress:"0x18de1CD95b5c34cc5189e31510AD0C71123345cE",deploymentBlock:49766205,kickoffAt:"2026-07-02T23:00:00Z",expectedEndAt:"2026-07-03T00:45:00Z",resolveAfter:"2026-07-03T01:40:00Z",closes:"Jul 2, 11:40 PM GMT+1",resolution:"Resolves Yes if Portugal vs Croatia is level after 90 minutes plus stoppage time and goes to extra time in their July 2, 2026 World Cup knockout match. Resolves No if either team wins in regulation. Penalty shootouts are only relevant if the match has already gone to extra time. Resolve after regulation ends, or after the official result is final if needed.",threadTopic:"Portugal Croatia World Cup Knockout",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-tonali-spurs",category:"Sports",timeframe:"Sagas",question:"Will Sandro Tonali sign with Tottenham Hotspur in the Summer Transfer Window?",probability:58,closes:"September 1, 2026",resolution:"Resolves Yes if Tottenham Hotspur officially announces the transfer/signing of Sandro Tonali by the transfer deadline.",threadTopic:"Sandro Tonali Tottenham Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$182K",traders:"980",liquidity:"$29K",imageUrl:"https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-guimaraes-arsenal",category:"Sports",timeframe:"Sagas",question:"Will Bruno Guimaraes officially sign with Arsenal by September 1, 2026?",probability:45,closes:"September 1, 2026",resolution:"Resolves Yes if Arsenal officially announces the transfer/signing of Bruno Guimaraes by the transfer deadline.",threadTopic:"Bruno Guimaraes Arsenal Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$204K",traders:"1,240",liquidity:"$36K",imageUrl:"https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=1200&q=80",evidence:[]}];var Re="https://faucet.circle.com/",tt="siftle_backend_wallet_migration_notice",Be=null,N=()=>(Be||(Be=import("./chunks/arc-65MWE6WY.js")),Be),D=e=>e.length>10?`${e.slice(0,6)}...${e.slice(-4)}`:e,ta=async()=>(await N()).connectArcWallet(),ue=async e=>(await N()).readArcUsdcBalance(e),aa=async(e,a,r)=>(await N()).payAiBriefingUnlock(e,a,r),ra=e=>{N().then(a=>a.resolveLocalTestMarketYes(e))},oa=async e=>(await N()).readArcMarketSnapshot(e);var sa=async(e,a)=>(await N()).readArcMarketState(e,a),na=async(e,a,r,o,s,n,i)=>(await N()).executeArcMarketOrder(e,a,r,o,s,n,i),xt=()=>{N().then(e=>e.disconnectArcWallet())},ia=async(e,a)=>(await N()).claimArcMarketPayout(e,a),je=async()=>(await N()).getConnectedArcWallet(),la=async()=>(await N()).validateArcSession(),da=async e=>(await N()).subscribeArcWallet(e),ca=["Sports"],ma="https://siftle.onrender.com",pa=()=>{let e=(window.SIFTLE_API_BASE||"").replace(/\/$/,"");if(e)return e;let a=typeof window<"u"?window.location.hostname.toLowerCase():"";return a==="siftle.xyz"||a.endsWith(".siftle.xyz")||a.endsWith(".vercel.app")?ma:""},ua=pa(),M=e=>`${ua}${e}`,$t="siftle_theme",fa=()=>{try{return window.localStorage.getItem($t)==="light"?"light":"dark"}catch{return"dark"}},fe=fa();function P(e){fetch(M("/api/analytics"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:e})}).catch(a=>console.error("Failed to track event:",a))}var t={activeSurface:"markets",profileUsername:null,selectedMarketId:null,marketOrderMode:"buy",marketTradeSide:"yes",marketTradeAmount:5,marketSnapshots:{},marketPositions:{},marketEvidenceOverrides:{},loadingMarkets:!0,checkedMarketEvidence:{},checkedMarketSnapshots:{},loadingMarketSnapshots:{},loadingMarketEvidence:{},loadingPortfolioPositions:!1,marketTradeStatus:null,hasLoadedPortfolioPositions:!1,walletConnecting:!1,walletAddress:null,walletBalance:null,activeCategory:"Sports",stories:[],isLoading:!1,selectedStoryId:null,aiSummaries:{},loadingSummaryUrl:null,unlockingSummaryUrl:null,archiveDates:[],activeArchiveDate:null,activeShareStoryId:null,selectedThreadUrl:null,activeThread:null,loadingThreadUrl:null,feedScrollY:0,hasLoadedFeed:!1,showSaved:!1,tradeDrawerOpen:!1,activeMarketTimeframe:"All",profileNotice:null,portfolioMarketPreviews:[],referralPanelOpen:!1,referralData:null,referralError:null,loadingReferralData:!1},de=null,V="global",G=null,at=!1,rt=!1,ot=new URLSearchParams(window.location.search).get("ref")||localStorage.getItem("siftle_pending_referral_code")||"";ot&&localStorage.setItem("siftle_pending_referral_code",ot.trim().toUpperCase());var Tt=20,C=$e,ga=(...e)=>{let a=new Map;return e.flat().forEach(r=>{r?.id&&a.set(r.id,{...a.get(r.id)||{},...r})}),Array.from(a.values())},Ae=()=>ga(t.portfolioMarketPreviews,C,$e),ha=async()=>{t.loadingMarkets=!0,C.length===0&&(C=$e);try{let e=new AbortController,a=window.setTimeout(()=>e.abort(),3500),r=await fetch(M("/api/markets"),{signal:e.signal});if(window.clearTimeout(a),r.ok){let o=await r.json();Array.isArray(o)&&o.length>0&&(C=o)}}catch(e){console.error("Failed to load markets:",e)}finally{t.loadingMarkets=!1}},At=async()=>{try{let e=await fetch(M("/api/portfolio/markets"));if(!e.ok)return;let a=await e.json();Array.isArray(a)&&(t.portfolioMarketPreviews=a.map(r=>({threadStoryId:0,updates:0,movement:0,evidence:[],...r})))}catch(e){console.warn(e)}},Mt="siftle.savedUrls",Q=new Set,qe=()=>{try{let e=localStorage.getItem(Mt)||"[]",a=JSON.parse(e);Q=new Set(a.filter(Boolean))}catch{Q=new Set}},va=()=>{try{localStorage.setItem(Mt,JSON.stringify(Array.from(Q)))}catch{}},ge=()=>{if(Array.isArray(t.stories))for(let e of t.stories)e.saved=!!Q.has(e.sourceUrl)};qe();ge();var We=document.querySelector("#dateLabel"),ee=document.querySelector("#categoryTabs"),w=document.querySelector("#storyList"),$=document.querySelector("#storyDetail"),De=document.querySelector("#menuButton"),Ne=document.querySelector("#menuPanel"),T=document.querySelector("#menuStatus"),R=document.querySelector("#archiveDateSelect"),st=document.querySelector("#archiveStatus"),ba=document.querySelector("#todayButton"),Me=document.querySelector(".brief-hero"),Le=document.querySelector("#archiveControls"),be=document.querySelector("[data-surface='markets']"),ye=document.querySelector("[data-surface='feed']"),ke=document.querySelector("[data-surface='portfolio']"),Z=document.querySelector("#walletButton"),ce=document.querySelector("[data-theme-toggle]"),Lt=Array.from(document.querySelectorAll("[data-bottom-nav]")),_e,ya=()=>{if(!ce)return;let a=`Switch to ${fe==="light"?"dark":"light"} mode`;ce.setAttribute("aria-label",a),ce.title=a,ce.dataset.activeTheme=fe},Ct=e=>{fe=e,document.documentElement.dataset.theme=e;try{window.localStorage.setItem($t,e)}catch{}ya()};Ct(fe);var E=()=>{if(Z){let e=Z.querySelector(".wallet-button-label");Z.classList.toggle("connected",!!t.walletAddress),Z.disabled=t.walletConnecting,Z.setAttribute("aria-label",t.walletAddress?`Wallet ${D(t.walletAddress)}`:"Sign in"),e&&(e.textContent=t.walletConnecting?"Signing in...":t.walletAddress?"Wallet":"Sign in"),Z.title=t.walletAddress?`${t.walletBalance??"0"} Arc Testnet USDC - ${D(t.walletAddress)}`:"Sign in"}};window.addEventListener("resize",E);ce?.addEventListener("click",()=>{Ct(fe==="light"?"dark":"light")});var ka=async e=>{let a=localStorage.getItem("siftle_pending_referral_code");if(a)try{let r=await fetch(M("/api/referrals/bind"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:e,referralCode:a})}),o=await r.json().catch(()=>({}));r.ok&&(o.bound||o.reason==="already_bound"||o.reason==="invalid_code")&&(localStorage.removeItem("siftle_pending_referral_code"),o.bound&&k("Referral connected"))}catch(r){console.warn(r)}},he=async()=>{if(!(!t.walletAddress||t.loadingReferralData)){t.loadingReferralData=!0,t.referralError=null;try{let e=await fetch(M(`/api/referrals?walletAddress=${encodeURIComponent(t.walletAddress)}`)),a=await e.json().catch(()=>({}));e.ok?t.referralData=a:t.referralError=a?.error||"Referral tools are temporarily unavailable."}catch(e){console.warn(e),t.referralError="Referral tools are temporarily unavailable."}finally{t.loadingReferralData=!1,t.activeSurface==="portfolio"&&z()}}},Ye=async()=>{if(!t.walletConnecting){t.walletConnecting=!0,P("wallet_connect_start"),E();try{let e=await ta();if(e){P("wallet_connect_success"),t.walletAddress=e,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,se(),t.walletBalance=await ue(e),await ka(e),he(),await Y(),ae(!0).catch(r=>console.error("Failed to report leaderboard entry:",r));let a=localStorage.getItem(tt);a?(localStorage.removeItem(tt),k(a)):k("Connected to Arc Testnet"),window.location.hash="#portfolio",Se()}}catch(e){P("wallet_connect_failed"),k(e instanceof Error?e.message:"Wallet connection failed")}finally{t.walletConnecting=!1,E()}}},k=e=>{let a=document.querySelector("#actionToast");a||(a=document.createElement("div"),a.id="actionToast",a.className="action-toast",a.setAttribute("role","status"),a.setAttribute("aria-live","polite"),document.body.appendChild(a)),a.textContent=e,a.classList.add("show"),_e&&window.clearTimeout(_e),_e=window.setTimeout(()=>{a?.classList.remove("show")},1700)},wa=(e,a,r,o)=>{let s=document.createElement("div");s.className="success-modal-overlay",s.innerHTML=`
  ...
  `,document.body.appendChild(s),setTimeout(()=>{s.classList.add("show")},10);let n=()=>{s.classList.remove("show"),setTimeout(()=>{s.remove()},300)};s.querySelector(".success-modal-close-btn")?.addEventListener("click",n),s.querySelector(".success-modal-action-btn")?.addEventListener("click",n),s.addEventListener("click",i=>{i.target===s&&n()})},F=()=>{t.feedScrollY=0,window.scrollTo({top:0,behavior:"auto"})},Pt=e=>{let a=e?new Date(`${e}T12:00:00`):new Date;return new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric"}).format(a)},Sa=()=>t.stories.filter(e=>t.showSaved?!!e.saved:t.activeCategory==="All"||e.category===t.activeCategory),me=e=>t.activeArchiveDate?e.postedAt:`${e.postedAt} ago`,xa=e=>/(\*\*?\s*critique|attempt\s*\d|prompt says|let'?s try|tighter version|word count|violat(?:e|es)|output only|valid json|the model|the prompt)/i.test(e),$a=(e,a=140)=>{let r=e.split(/\s+/).filter(Boolean);if(r.length<=a)return e;let s=r.slice(0,a).join(" "),n=Math.max(s.lastIndexOf("."),s.lastIndexOf("?"),s.lastIndexOf("!"));return n>s.length*.45?s.slice(0,n+1).trim():`${s.replace(/[,:;.'"!\?\s]+$/,"")}...`},nt=e=>{let a=String(e||"").trim();for(let r=0;r<2;r+=1){let o=a.match(/^```(?:json)?\s*([\s\S]*?)\s*```$/i);if(o&&(a=o[1].trim()),!/^\s*\{[\s\S]*\}\s*$/.test(a))break;try{let s=JSON.parse(a);if(typeof s.summary=="string"){a=s.summary.trim();continue}}catch{break}break}return a=a.replace(/&lt;|&#60;/gi,"<").replace(/&gt;|&#62;/gi,">").replace(/<[^>]+>/g," ").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&#39;/g,"'").replace(/&apos;/g,"'").replace(/&quot;/g,'"').replace(/^["'{\s]+/,"").replace(/["'}\s]+$/,"").replace(/^summary["'\s]*:[\s"']*/i,"").replace(/\s+/g," ").trim(),xa(a)?"":$a(a)},J=(e,a)=>nt(a||"")||nt(e.summary)||e.headline,Ge=e=>{let a=e.split(/(?:\*\*|__)?(WHAT HAPPENED|KEY POINTS|TAKEAWAY)\s*:?\s*(?:\*\*|__)?\s*:?\s*/i);if(a.length<=1)return`<p class="briefing-text">${e}</p>`;let r="";a[0].trim()&&(r+=`<p class="briefing-intro">${a[0].trim()}</p>`);for(let o=1;o<a.length;o+=2){let s=a[o].trim().toUpperCase(),n=a[o+1]?a[o+1].trim():"";if(!n)continue;let i="";if(s==="KEY POINTS"){let d=n.split(/(?:•|\*|-)\s+/).map(c=>c.trim()).filter(Boolean);d.length>0?i=`<ul class="briefing-list">${d.map(c=>`<li>${c}</li>`).join("")}</ul>`:i=`<p class="briefing-text">${n}</p>`}else i=`<p class="briefing-text">${n}</p>`;let l=s.toLowerCase().replace(/\s+/g,"-");r+=`
      <div class="briefing-section ${l}-section">
        <h4 class="briefing-title">${s}</h4>
        ${i}
      </div>
    `}return r},Ut=e=>`siftle_ai_briefing_unlock_${btoa(unescape(encodeURIComponent(e.sourceUrl))).replace(/=+$/g,"")}`,Et=e=>localStorage.getItem(Ut(e))||"",we=e=>!!Et(e),ze=(e,a)=>({id:0,headline:a.headline,category:e.category,summary:a.summary,source:a.source,sourceUrl:a.sourceUrl,imageUrl:e.imageUrl||"",publishedAt:void 0,readTime:"3 min read",postedAt:a.date,accent:"slate",saved:Q.has(a.sourceUrl),ai_summary:void 0,ai_provider:void 0}),Ta=e=>{let a=t.stories.find(s=>s.sourceUrl===e);if(a)return a;let o=[t.activeThread?.current,...t.activeThread?.items??[]].filter(Boolean).find(s=>s.sourceUrl===e);if(o)return o;if(t.selectedMarketId){let s=C.find(n=>n.id===t.selectedMarketId);if(s){let n=Pe(s).evidence.find(i=>i.sourceUrl===e);if(n)return ze(s,n)}}return null},Je=(e,a)=>{let r=Da(e,a);return r===null?null:r-Tt*60*1e3},Aa=(e,a)=>{let r=Je(e,a);return r===null?e.closes:new Intl.DateTimeFormat("en",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZoneName:"short"}).format(new Date(r))},It=(e,a)=>{let r=Je(e,a);return r===null?null:Date.now()>=r?`Locked ${Tt}m before kickoff`:null},Ma=(e,a)=>`
...
`,it=async e=>{if(!t.walletAddress){k("Please sign in first.");return}if(t.unlockingSummaryUrl!==e.sourceUrl){t.unlockingSummaryUrl=e.sourceUrl,P("ai_unlock_attempt"),g();try{let a=await fetch(M("/api/summary/unlock-config")),r=await a.json();if(!a.ok||!r.treasuryAddress)throw new Error(r.error||"AI briefing is not configured");let o=await aa(r.treasuryAddress,Number(r.amountUsdc)||.05,l=>{T&&(T.textContent=l)}),s=await fetch(M("/api/summary/unlock"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sourceUrl:e.sourceUrl,walletAddress:t.walletAddress,txHash:o})}),n=await s.json();if(!s.ok||!n.unlockToken)throw new Error(n.error||"AI briefing failed");localStorage.setItem(Ut(e),n.unlockToken),P("ai_unlock_success"),(Number(n?.bonus?.points)||0)>0&&ae(!1).catch(l=>console.error("Failed to refresh leaderboard bonus:",l)),await Ce(e)}catch(a){P("ai_unlock_failed"),k(a instanceof Error?a.message:"AI briefing failed")}finally{t.unlockingSummaryUrl=null,g()}}},Ce=async e=>{if(we(e)&&!(t.aiSummaries[e.sourceUrl]||t.loadingSummaryUrl===e.sourceUrl)){if(e.ai_summary){t.aiSummaries[e.sourceUrl]=J(e,e.ai_summary),P("view_summary"),T&&(T.textContent=e.ai_provider==="0g"?"Archived 0G summary loaded":"Archived summary loaded"),g();return}t.loadingSummaryUrl=e.sourceUrl,g();try{let a=await fetch(M("/api/summary"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...e,walletAddress:t.walletAddress,unlockToken:Et(e)})});if(!a.ok)throw new Error(`Summary request failed with ${a.status}`);let r=await a.json();t.aiSummaries[e.sourceUrl]=J(e,r.summary),T&&r.provider&&(T.textContent=r.provider==="0g"?"Summary generated by 0G":`Summary loaded from ${r.provider}`)}catch(a){console.warn(a),t.aiSummaries[e.sourceUrl]=J(e),T&&(T.textContent="Summary fallback loaded")}finally{t.loadingSummaryUrl=null,g()}}},Bt=e=>{let a=t.stories.find(r=>r.id===e);a&&(t.feedScrollY=window.scrollY,t.selectedStoryId=a.id,t.selectedThreadUrl=null,t.activeThread=null,window.history.pushState({},"",`#story-${a.id}`),g(),Ce(a),window.scrollTo({top:0,behavior:"smooth"}))},La=e=>{t.feedScrollY=window.scrollY,t.selectedStoryId=null,t.selectedThreadUrl=e.sourceUrl,t.activeThread=null,t.loadingThreadUrl=e.sourceUrl,window.history.pushState({},"",`#thread-${e.id}`),g(),Dt(e),window.scrollTo({top:0,behavior:"smooth"})},Ca=()=>{t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,t.loadingThreadUrl=null,window.history.pushState({},"","#feed"),g(),requestAnimationFrame(()=>window.scrollTo({top:t.feedScrollY,behavior:"auto"}))},Dt=async e=>{try{let a=await fetch(M(`/api/thread?category=${encodeURIComponent(e.category)}&sourceUrl=${encodeURIComponent(e.sourceUrl)}`));if(!a.ok)throw new Error(`Thread request failed with ${a.status}`);t.activeThread=await a.json(),T&&(T.textContent=`${t.activeThread?.count??0} related updates found`)}catch(a){console.warn(a),t.activeThread=null,delete e.thread,t.selectedThreadUrl=null,window.history.replaceState({},"","#feed"),k("That timeline no longer has a verified past update"),T&&(T.textContent="Thread unavailable")}finally{t.loadingThreadUrl=null,g()}};function Se(){if(window.location.hash==="#resolve-local-yes"){let a=C.find(r=>r.id==="siftle-local-test-2")||C.find(r=>r.timeframe==="Daily"&&q(r).startsWith("0x00000000000000000000000000000000000001"));if(a){ra(q(a)),Fa(a,"yes"),delete t.marketSnapshots[a.id],delete t.marketPositions[a.id],delete t.checkedMarketSnapshots[a.id],delete t.loadingMarketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.activeSurface="portfolio",t.selectedMarketId=null,window.history.replaceState({},"","#portfolio"),k("Local test market resolved YES"),Y().then(()=>{ae(!0).catch(r=>console.error("Failed to report leaderboard entry:",r)),E(),z()});return}}let e=window.location.hash.match(/^#market-(.+)$/);if(window.location.hash==="#markets"||e){t.activeSurface="markets",t.selectedMarketId=e?.[1]??null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,g();return}if(window.location.hash==="#portfolio"){t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,g();return}if(window.location.hash==="#leaderboard"){t.activeSurface="leaderboard",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,g();return}if(window.location.hash==="#feed"||window.location.hash.startsWith("#story-")||window.location.hash.startsWith("#thread-")){t.activeSurface="feed";let a=window.location.hash.match(/^#story-(\d+)$/),r=window.location.hash.match(/^#thread-(\d+)$/),o=a?t.stories.find(i=>i.id===Number(a[1])):void 0,s=r?t.stories.find(i=>i.id===Number(r[1])):void 0,n=t.selectedStoryId!==null||t.selectedThreadUrl!==null;t.selectedStoryId=o?.id??null,t.selectedThreadUrl=s?.sourceUrl??null,t.activeThread=null,g(),o&&Ce(o),s&&Dt(s),!o&&!s&&n&&requestAnimationFrame(()=>window.scrollTo({top:t.feedScrollY,behavior:"auto"}));return}t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,g()}var Fe=e=>{st&&(st.textContent=e)},Pa=async(e=t.activeCategory,a=!1)=>{a||(t.activeSurface="feed",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,t.loadingThreadUrl=null,t.showSaved=!1),t.isLoading=!0,t.activeSurface==="feed"&&(Nt(),g());try{let r=t.activeArchiveDate?`/api/archive?date=${encodeURIComponent(t.activeArchiveDate)}&category=${encodeURIComponent(e)}`:`/api/feed?category=${encodeURIComponent(e)}`,o=await fetch(M(r));if(!o.ok)throw new Error(`Feed request failed with ${o.status}`);let s=await o.json();if(t.stories=s.top_stories??[],ge(),t.hasLoadedFeed=!0,We&&(We.textContent=Pt(s.date??t.activeArchiveDate)),T)if(t.activeArchiveDate)T.textContent=`Showing ${e} from ${t.activeArchiveDate}`;else{let n=s.archive?.provider==="shelby"?"Shelby":"local archive";T.textContent=`Latest published feed loaded from ${n}`}Fe(t.activeArchiveDate?`Archive: ${t.activeArchiveDate}`:"Live feed")}catch(r){console.warn(r),t.hasLoadedFeed||(t.stories=[]),ge(),T&&(T.textContent=t.activeArchiveDate?"That saved day/category is not available yet":"Feed data is currently unavailable. Please check back shortly.")}finally{t.isLoading=!1,g(),Se()}},Ua=async()=>{if(R)try{let e=await fetch(M("/api/archive"));if(!e.ok)throw new Error(`Archive index failed with ${e.status}`);let a=await e.json(),r=new Date().toLocaleDateString("en-CA",{timeZone:"Africa/Lagos",year:"numeric",month:"2-digit",day:"2-digit"});t.archiveDates=(a.dates??[]).filter(o=>o.date!==r),R.innerHTML=['<option value="">Today</option>',...t.archiveDates.map(o=>`<option value="${o.date}">${o.date}</option>`)].join(""),R.value=t.activeArchiveDate??"",Fe(t.archiveDates.length>0?"Saved days ready":"Live feed ready")}catch(e){console.warn(e),Fe("Archive unavailable")}},xe=()=>{at||(at=!0,Ua())},te=(e=t.activeCategory,a=!1)=>{t.hasLoadedFeed&&e===t.activeCategory&&!t.activeArchiveDate||Pa(e,a)},Ea=()=>{rt||(rt=!0,window.setTimeout(()=>{t.activeSurface!=="feed"&&!t.hasLoadedFeed&&te(t.activeCategory,!0),xe()},8e3))},Ia=e=>e==="All"?"For you":e==="Sports"?"Football":e,H=e=>e==="Sports"?"Football":e,Nt=()=>{ee&&(ee.innerHTML=ca.map(e=>`
        <button class="category-tab ${e===t.activeCategory?"active":""}" type="button" data-category="${e}">
          ${Ia(e)}
        </button>
      `).join(""))},_t=e=>(e.thread?.count??0)>=1,Ba=(e=0)=>`${e} past ${e===1?"update":"updates"}`,Ot=(e=[])=>[...e].sort((a,r)=>{let o=new Date(a.publishedAt||0).getTime(),s=new Date(r.publishedAt||0).getTime();return(Number.isNaN(s)?0:s)-(Number.isNaN(o)?0:o)}),Pe=e=>{let a=t.marketEvidenceOverrides[e.id],r={...e,evidence:e.evidence??[]};return a?{...r,...a,updates:a.evidence.length}:r},Da=(e,a)=>{if(e.timeframe!=="Daily")return null;let r=e.kickoffAt?new Date(e.kickoffAt).getTime():Number.NaN;if(Number.isFinite(r))return r;let o=a?.closesAtUnix??0;return o>0?o*1e3:null},Na=(e,a)=>a===0?"Latest":e.publishedAt?new Intl.DateTimeFormat("en",{month:"short",day:"numeric"}).format(new Date(e.publishedAt)):e.postedAt,_a=(e,a)=>({date:Na(e,a),source:e.source,headline:e.headline,summary:J(e,e.ai_summary),impact:a===0?"Latest":"Update",direction:"flat",sourceUrl:e.sourceUrl}),Ht=async e=>{if(!(t.checkedMarketEvidence[e.id]||t.loadingMarketEvidence[e.id])){t.loadingMarketEvidence[e.id]=!0;try{let a=await fetch(M(`/api/market-thread?id=${encodeURIComponent(e.id)}&nocache=${Date.now()}`));if(!a.ok)return;let r=await a.json(),o=[r.current,...Ot(r.items??[])],s=o.filter((l,d,c)=>c.findIndex(f=>f.sourceUrl===l.sourceUrl)===d).map(_a),i=o[0]?.imageUrl;s.length>=1&&(t.marketEvidenceOverrides[e.id]={threadTopic:r.topic||e.threadTopic,evidence:s,imageUrl:i||e.imageUrl})}catch(a){console.warn(a)}finally{t.checkedMarketEvidence[e.id]=!0,t.loadingMarketEvidence[e.id]=!1,t.activeSurface==="markets"&&g()}}},q=e=>e.marketAddress||window.SIFTLE_MARKET_ADDRESSES?.[e.id]||"",W=e=>e.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),U=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Ke=e=>`siftle_profile_username_${e.toLowerCase()}`,Rt=e=>e.trim().replace(/\s+/g," ").slice(0,15),se=()=>{if(!t.walletAddress){t.profileUsername=null,t.profileNotice=null;return}let e=Ke(t.walletAddress),a=localStorage.getItem(e),r=localStorage.getItem("siftle_profile_username");!a&&r&&(a=Rt(r),a&&localStorage.setItem(e,a),localStorage.removeItem("siftle_profile_username")),t.profileUsername=a||null,t.profileNotice=null},Oa=e=>{if(!t.walletAddress)return;let a=Ke(t.walletAddress),r=Rt(e);r?(localStorage.setItem(a,r),t.profileUsername=r):(localStorage.removeItem(a),t.profileUsername=null),localStorage.removeItem("siftle_profile_username")},Ha=()=>{let e="one-hour-test-market",a=[];for(let r=0;r<localStorage.length;r++){let o=localStorage.key(r);o&&o.includes(e)&&a.push(o)}a.forEach(r=>localStorage.removeItem(r))},jt=(e,a,r)=>{if(e==="sell"){let o=a==="yes"?r?.yesSharesUsdc??0:r?.noSharesUsdc??0;return o<=0?{min:.01,max:.01,fallback:.01}:{min:Math.min(.01,o),max:o,fallback:o}}return{min:5,max:10,fallback:5}},Ue=(e,a,r,o)=>{let{min:s,max:n,fallback:i}=jt(a,r,o);return Number.isFinite(e)?Math.min(n,Math.max(s,e)):i},Wt=(e,a,r,o,s)=>{if(!e||!Number.isFinite(r)||r<=0)return 0;let n=a==="yes"?s?.yesSharesUsdc??0:s?.noSharesUsdc??0,i=e.yesSharesUsdc,l=e.noSharesUsdc;if(o==="sell")return Math.min(r,n);let d=(a==="yes"?i:l)+r,c=i+l+r;return d<=0||c<=0?r:(n+r)/d*c},zt=(e,a)=>{let r=a?.volumeUsdc??0,o=[];return e.yesSharesUsdc>0&&o.push({label:"YES Shares",shares:e.yesSharesUsdc,payout:a&&a.yesSharesUsdc>0?e.yesSharesUsdc/a.yesSharesUsdc*r:0}),e.noSharesUsdc>0&&o.push({label:"NO Shares",shares:e.noSharesUsdc,payout:a&&a.noSharesUsdc>0?e.noSharesUsdc/a.noSharesUsdc*r:0}),o},Ra=e=>{let a=e?.yesSharesUsdc??0,r=e?.noSharesUsdc??0;return a>0&&r<=0?"yes":r>0&&a<=0?"no":null},Ft=e=>`siftle_claimed_markets_${e.toLowerCase()}`,Ve=()=>{if(!t.walletAddress)return new Set;try{return new Set(JSON.parse(localStorage.getItem(Ft(t.walletAddress))||"[]"))}catch{return new Set}},ja=e=>{if(!t.walletAddress)return;let a=Ve();a.add(e),localStorage.setItem(Ft(t.walletAddress),JSON.stringify(Array.from(a)))},Ze=(e,a)=>(a?.outcome??0)!==0?!0:/^resolved$/i.test(String(e.closes||"").trim()),X=(e,a,r)=>{let o=r?.yesSharesUsdc??0,s=r?.noSharesUsdc??0;return e==="sell"?a==="yes"?o>0:s>0:a==="yes"?s<=0:o<=0},Xe=(e,a,r)=>{if(X(e,a,r))return a;let o=a==="yes"?"no":"yes";return X(e,o,r)?o:a};var Wa=e=>{let a=e instanceof Error?e.message:String(e||"");return/token|session|auth|unauthori[sz]ed|expired|401/i.test(a)},Oe=e=>{let a=String(e||"").trim();if(!a)return"0 wins, 0 losses";let r=a.replace(/closed profits?/gi,"losses").replace(/\bprofit\b/gi,"losses");return/\bloss/i.test(r)?r:`${r}, 0 losses`},qt="siftle_leaderboard_cache_",lt=e=>{let a=String(e||"").match(/(\d+)\s+wins?/i),r=String(e||"").match(/(\d+)\s+loss(?:es)?/i);return{wins:a&&Number(a[1])||0,losses:r&&Number(r[1])||0}},dt=e=>{try{let a=JSON.parse(localStorage.getItem(`${qt}${e}`)||"null");return Array.isArray(a?.players)&&a.players.length?a:null}catch{return null}},He=(e,a)=>{if(!(!Array.isArray(a?.players)||a.players.length===0))try{localStorage.setItem(`${qt}${e}`,JSON.stringify({...a,cachedAt:Date.now()}))}catch{}},za=(e,a)=>{let r=lt(e?.status||""),o=lt(a?.status||""),s=(Number(a?.points)||0)-(Number(e?.points)||0);return s||(o.wins!==r.wins?o.wins-r.wins:r.losses!==o.losses?r.losses-o.losses:String(e?.username||"").localeCompare(String(a?.username||"")))},ct=(e,a=[],r=!1)=>{let o=new Map(a.map(l=>[String(l?.username||"").toLowerCase(),l])),s=new Set,n=e.map(l=>{let d=String(l?.username||"").toLowerCase();s.add(d);let c=o.get(d);return c&&(Number(c.points)||0)>(Number(l.points)||0)?{...l,...c}:l});a.forEach(l=>{let d=String(l?.username||"").toLowerCase();d&&!s.has(d)&&(Number(l?.points)||0)>0&&n.push(l)});let i=n.slice().sort(za);return r?i.map((l,d)=>({...l,globalRank:d+1})):i},mt=()=>`
  <div class="leaderboard-sync-note" role="status">
    Showing saved standings while Siftle refreshes live scores...
  </div>
`,Qe=()=>{let e=0,a=0,r=0,o=C.filter(i=>i.timeframe==="Daily").map(i=>i.id),s=t.walletAddress?`siftle_resolved_results_${t.walletAddress.toLowerCase()}`:"",n={};if(s)try{n=JSON.parse(localStorage.getItem(s)||"{}")}catch{}if(t.walletAddress&&t.hasLoadedPortfolioPositions)for(let i of o){if(n[i]?.result==="win"){e+=Number(n[i].points)||0,a++;continue}if(n[i]?.result==="loss"){r++;continue}let l=t.marketPositions[i],c=t.marketSnapshots[i]?.outcome??0;if(c===0)continue;let f=`siftle_traded_sides_${i}_${t.walletAddress.toLowerCase()}`,u=[];try{u=JSON.parse(localStorage.getItem(f)||"[]")}catch{}let h=u.includes("yes")&&u.includes("no");if(c===1&&l&&l.yesSharesUsdc>0){let p=h?50:100;e+=p,a++,n[i]={result:"win",points:p}}else if(c===2&&l&&l.noSharesUsdc>0){let p=h?50:100;e+=p,a++,n[i]={result:"win",points:p}}else l&&(l.yesSharesUsdc>0||l.noSharesUsdc>0)&&(r++,n[i]={result:"loss",points:0})}return s&&localStorage.setItem(s,JSON.stringify(n)),{points:e,status:`${a} win${a===1?"":"s"}, ${r} loss${r===1?"":"es"}`}},Fa=(e,a)=>{let r=q(e).toLowerCase();if(!r)return;let o=`siftle_mock_pos_${r}_`,s=new Set;for(let n=0;n<localStorage.length;n++){let i=localStorage.key(n);if(!i||!i.startsWith(o))continue;let l=i.slice(o.length).toLowerCase();/^0x[a-f0-9]{40}$/.test(l)&&s.add(l)}s.forEach(n=>{let i=`${o}${n}`,l={yesSharesUsdc:0,noSharesUsdc:0};try{l=JSON.parse(localStorage.getItem(i)||"{}")}catch{}let d=(Number(l.yesSharesUsdc)||0)>0,c=(Number(l.noSharesUsdc)||0)>0;if(!d&&!c)return;let f=`siftle_traded_sides_${e.id}_${n}`,u=[];try{u=JSON.parse(localStorage.getItem(f)||"[]")}catch{}let h=u.includes("yes")&&u.includes("no"),p=a==="yes"?d:c,m=`siftle_resolved_results_${n}`,v={};try{v=JSON.parse(localStorage.getItem(m)||"{}")}catch{}v[e.id]={result:p?"win":"loss",points:p?h?50:100:0},localStorage.setItem(m,JSON.stringify(v));let b=0,y=0,x=0;Object.values(v).forEach(A=>{A.result==="win"?(y+=1,b+=Number(A.points)||0):A.result==="loss"&&(x+=1)});let S=localStorage.getItem(Ke(n))||"";fetch(M("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:n,username:S,points:b,status:`${y} win${y===1?"":"s"}, ${x} loss${x===1?"":"es"}`})}).catch(A=>console.error("Failed to report local resolved score:",A))})},ae=async e=>{if(!t.walletAddress)return!1;let a=e&&t.hasLoadedPortfolioPositions?Qe():null,r=await fetch(M("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:t.walletAddress,username:t.profileUsername||"",...a?{points:a.points,status:a.status}:{}})}),o=await r.json().catch(()=>({}));if(!r.ok||o?.success===!1)throw new Error(o?.error||"Failed to save leaderboard profile");if(o?.supabaseConfigured&&o?.supabaseSaved===!1)throw new Error(o?.supabaseError||"Supabase did not save profile");return!0},qa=()=>{let e=new Set;for(let a=0;a<localStorage.length;a++){let r=localStorage.key(a);if(r&&r.startsWith("siftle_mock_pos_")){let o=r.slice(r.lastIndexOf("_")+1).toLowerCase();try{let s=JSON.parse(localStorage.getItem(r)||"{}");((Number(s.yesSharesUsdc)||0)>0||(Number(s.noSharesUsdc)||0)>0)&&/^0x[a-f0-9]{40}$/.test(o)&&e.add(o)}catch{}}}e.forEach(a=>{fetch(M("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:a})}).catch(r=>console.error("Failed to report stored local trader:",r))})},Ya=async e=>{let a=q(e);if(!(!a||t.marketSnapshots[e.id]||t.loadingMarketSnapshots[e.id]||t.checkedMarketSnapshots[e.id])){t.loadingMarketSnapshots[e.id]=!0;try{t.marketSnapshots[e.id]=await oa(a)}catch(r){console.warn(r)}finally{t.checkedMarketSnapshots[e.id]=!0,t.loadingMarketSnapshots[e.id]=!1,t.activeSurface==="markets"&&g()}}},Y=async()=>{if(!(!t.walletAddress||t.loadingPortfolioPositions)){t.loadingPortfolioPositions=!0;try{t.portfolioMarketPreviews.length===0&&await At();let e=Ae(),a=await Promise.all(e.map(async r=>{let o=q(r);if(!o)return[r.id,{yesSharesUsdc:0,noSharesUsdc:0}];try{let{position:s,snapshot:n}=await sa(o,t.walletAddress);return t.marketSnapshots[r.id]=n,[r.id,s]}catch(s){return console.warn(`Failed to load portfolio market ${r.id}:`,s),[r.id,{yesSharesUsdc:0,noSharesUsdc:0}]}}));t.marketPositions=Object.fromEntries(a)}catch(e){console.warn(e)}finally{t.loadingPortfolioPositions=!1,t.hasLoadedPortfolioPositions=!0,ae(!0).catch(e=>console.error("Failed to report leaderboard entry:",e)),(t.activeSurface==="portfolio"||t.activeSurface==="leaderboard")&&g()}}},Ga=async(e,a)=>{if(!t.walletAddress){k("Session expired or wallet not connected. Please sign in."),Ye();return}let r=Ae().find(c=>c.id===e);if(!r)return;t.marketTradeSide=a;let o=q(r);if(!o){k("Deploy this Arc market contract before trading"),g();return}if(!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",g(),await Y(),t.marketTradeStatus=null),!t.hasLoadedPortfolioPositions){k("Still loading your position. Try again in a moment."),g();return}let s=t.marketSnapshots[r.id];if(Ze(r,s)){t.tradeDrawerOpen=!1,k("This market is resolved and can no longer be traded."),g();return}let n=s?.yesPriceCents??r.probability,i=s?.noPriceCents??100-r.probability,l=t.marketPositions[r.id]||{yesSharesUsdc:0,noSharesUsdc:0};if(!X(t.marketOrderMode,a,l)){let c=Ra(l),f=t.marketOrderMode==="sell"?c?`You can only exit your ${c.toUpperCase()} shares.`:"You do not have shares to exit in this market.":c?`Exit your ${c.toUpperCase()} shares before buying the other side.`:"You cannot buy both sides in the same market.";k(f),t.marketTradeSide=Xe(t.marketOrderMode,a,l),g();return}let d=Ue(Number(t.marketTradeAmount)||0,t.marketOrderMode,a,l);t.marketTradeAmount=d,P("trade_attempt");try{t.marketTradeStatus="Preparing transaction...",g();let c=await na(o,t.marketOrderMode,a,d,f=>{t.marketTradeStatus=f,g()},n,i);if(delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],delete t.loadingMarketSnapshots[r.id],t.walletAddress=await je(),t.walletAddress&&(t.walletBalance=await ue(t.walletAddress)),await Y(),ae(!0).catch(f=>console.error("Failed to report leaderboard entry:",f)),t.walletAddress){let f=`siftle_cost_basis_${r.id}_${t.walletAddress.toLowerCase()}`,u={yesCost:0,noCost:0,yesShares:0,noShares:0};try{let p=localStorage.getItem(f);if(p){let m=JSON.parse(p);u={yesCost:m.yesCost||0,noCost:m.noCost||0,yesShares:m.yesShares||0,noShares:m.noShares||0}}}catch{}let h=d;if(t.marketOrderMode==="buy"){let p=`siftle_traded_sides_${r.id}_${t.walletAddress.toLowerCase()}`,m=[];try{m=JSON.parse(localStorage.getItem(p)||"[]")}catch{}m.includes(a)||(m.push(a),localStorage.setItem(p,JSON.stringify(m))),a==="yes"?(u.yesCost+=h,u.yesShares=(u.yesShares||0)+h/(n/100)):(u.noCost+=h,u.noShares=(u.noShares||0)+h/(i/100))}else{let p=t.marketPositions[r.id];if(p){if(a==="yes"&&p.yesSharesUsdc>0){let m=Math.min(1,h/p.yesSharesUsdc);u.yesCost=Math.max(0,u.yesCost-u.yesCost*m),u.yesShares=Math.max(0,(u.yesShares||0)-(u.yesShares||0)*m)}else if(a==="no"&&p.noSharesUsdc>0){let m=Math.min(1,h/p.noSharesUsdc);u.noCost=Math.max(0,u.noCost-u.noCost*m),u.noShares=Math.max(0,(u.noShares||0)-(u.noShares||0)*m)}}}localStorage.setItem(f,JSON.stringify(u))}k(`Trade confirmed ${c.slice(0,8)}...`),P(t.marketOrderMode==="buy"?"trade_buy_success":"trade_sell_success"),wa(t.marketOrderMode,t.marketTradeAmount,a.toUpperCase(),r.question)}catch(c){P("trade_failed"),Wa(c)?(xt(),t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,se(),k("Session expired. Please sign in again.")):k(c instanceof Error?c.message:"Arc trade failed")}finally{t.marketTradeStatus=null,E(),g()}},pt=e=>_t(e)?`<button class="card-source-button thread-button" type="button" data-thread-story-id="${e.id}">Thread (${e.thread?.count})</button>`:"",ut=e=>_t(e)?`<button class="mobile-action-btn thread-btn" type="button" data-thread-story-id="${e.id}">Thread</button>`:"",ft=()=>'<svg class="action-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 4.75h10a1.75 1.75 0 0 1 1.75 1.75v14.25L12 16.35l-6.75 4.4V6.5A1.75 1.75 0 0 1 7 4.75Z"/></svg>',gt=()=>'<svg class="action-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 15V4.75"/><path d="m7.25 9.5 4.75-4.75 4.75 4.75"/><path d="M5 13.25v4.5A2.25 2.25 0 0 0 7.25 20h9.5A2.25 2.25 0 0 0 19 17.75v-4.5"/></svg>',ie=e=>`<span class="skeleton-aria-label" role="status" aria-live="polite">${e}</span>`,Ja=()=>`
...
`,Ka=(e=4)=>`${ie("Loading stories")}${Array.from({length:e},Ja).join("")}`,et=()=>`
...
`,ve=()=>{if(!w)return;let e=Sa();if(w.hidden=!!(t.selectedStoryId||t.selectedThreadUrl),t.isLoading){w.innerHTML=Ka(4);return}if(e.length===0){let a=t.showSaved?[]:t.stories;if(a.length>0){w.innerHTML=a.map(r=>`
          ...
          <div class="mobile-card-inner mobile-only">
            <div class="mobile-card-body">
              <div class="mobile-card-text">
                ...
                <h2>${r.headline}</h2>
                <span class="mobile-card-time">${me(r)}</span>
              </div>
          ...
          <div class="mobile-card-inner mobile-only">
            <div class="mobile-card-body">
              <div class="mobile-card-text">
                ...
                <h2>${a.headline}</h2>
                <span class="mobile-card-time">${me(a)}</span>
              </div>
              <div class="mobile-card-image" aria-hidden="true">
                <img src="${a.imageUrl}" alt="" loading="lazy" />
              </div>
      ...
      `).join("")},ht=e=>new Promise((a,r)=>{let o=new Image;o.crossOrigin="anonymous",o.onload=()=>a(o),o.onerror=()=>r(new Error(`Unable to load image: ${e}`)),o.src=e}),pe=(e,a,r,o,s,n)=>{e.beginPath(),e.moveTo(a+n,r),e.lineTo(a+o-n,r),e.quadraticCurveTo(a+o,r,a+o,r+n),e.lineTo(a+o,r+s-n),e.quadraticCurveTo(a+o,r+s,a+o-n,r+s),e.lineTo(a+n,r+s),e.quadraticCurveTo(a,r+s,a,r+s-n),e.lineTo(a,r+n),e.quadraticCurveTo(a,r,a+n,r),e.closePath()},Qa=(e,a,r,o,s,n,i)=>{let l=a.split(/\s+/).filter(Boolean),d=[],c="";for(let f of l){let u=c?`${c} ${f}`:f;if(e.measureText(u).width<=s){c=u;continue}if(c&&d.push(c),c=f,d.length===i)break}if(c&&d.length<i&&d.push(c),l.length>0&&d.length===i){for(;e.measureText(`${d[i-1]}...`).width>s&&d[i-1].length>0;)d[i-1]=d[i-1].slice(0,-1).trim();d[i-1]=`${d[i-1]}...`}return d.forEach((f,u)=>e.fillText(f,r,o+u*n)),o+d.length*n},er=(e,a,r,o,s,n,i)=>{let l=Math.max(s/a.naturalWidth,n/a.naturalHeight),d=s/l,c=n/l,f=(a.naturalWidth-d)/2,u=(a.naturalHeight-c)/2;e.save(),pe(e,r,o,s,n,i),e.clip(),e.drawImage(a,f,u,d,c,r,o,s,n),e.restore()},vt=e=>new Promise((a,r)=>{try{e.toBlob(o=>{o?a(o):r(new Error("Unable to export image"))},"image/png")}catch(o){r(o)}}),bt=e=>e?e.replace(/&quot;/g,'"').replace(/&apos;/g,"'").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&nbsp;/g," ").replace(/&#39;/g,"'").replace(/&#34;/g,'"').replace(/&#38;/g,"&").replace(/&#60;/g,"<").replace(/&#62;/g,">").replace(/&#8216;/g,"'").replace(/&#8217;/g,"'").replace(/&#8220;/g,'"').replace(/&#8221;/g,'"').replace(/&#8211;/g,"\u2013").replace(/&#8212;/g,"\u2014").replace(/&#8230;/g,"...").replace(/&#(\d+);/g,(a,r)=>String.fromCharCode(Number(r))):"",tr=e=>e?e.startsWith("data:")||e.startsWith("./")||e.startsWith("/")||e.includes(window.location.host)?e:`${(window.SIFTLE_API_BASE||"").replace(/\/$/,"")}/api/proxy-image?url=${encodeURIComponent(e)}`:"",yt=async(e,a=!0)=>{let r=document.createElement("canvas");r.width=1080,r.height=1120;let o=r.getContext("2d");if(!o)throw new Error("Canvas is not available");o.fillStyle="#f4f7fb",o.fillRect(0,0,r.width,r.height),o.shadowColor="rgba(23, 34, 72, 0.16)",o.shadowBlur=44,o.shadowOffsetY=18,o.fillStyle="#ffffff",pe(o,70,70,940,980,34),o.fill(),o.shadowColor="transparent";let s=await ht("./assets/siftle-logo-small.png").catch(()=>null);s&&o.drawImage(s,784,106,54,54),o.fillStyle="#071229",o.font="800 34px Inter, Arial, sans-serif",o.textAlign="left",o.fillText("Siftle",850,143),o.fillStyle="#6b748c",o.font="700 24px Inter, Arial, sans-serif",o.fillText(`${bt(e.source)} - ${e.postedAt} ago`,110,140);let n=195;if(a){let l=await ht(tr(e.imageUrl)).catch(()=>null);l?er(o,l,110,n,860,520,28):(o.fillStyle="#eef2ff",pe(o,110,n,860,520,28),o.fill())}else o.fillStyle="#eef2ff",pe(o,110,n,860,520,28),o.fill();let i=775;return o.fillStyle=e.category==="Sports"?"#dffaf4":e.category==="Tech"?"#e8eef6":e.category==="Anime"?"#efe7ff":e.category==="Gaming"?"#ffebd9":"#eee7ff",pe(o,110,i,118,42,21),o.fill(),o.fillStyle=e.category==="Sports"?"#11a98d":e.category==="Tech"?"#3f5f86":e.category==="Gaming"?"#d95c14":"#6f3cff",o.font="800 22px Inter, Arial, sans-serif",o.fillText(H(e.category),132,i+28),o.fillStyle="#07142f",o.font="680 44px Space Grotesk, Inter, Arial, sans-serif",Qa(o,bt(e.headline),110,888,860,54,4),r},Yt=async e=>{let a=await yt(e,!0);try{return await vt(a)}catch{return vt(await yt(e,!1))}},Gt=e=>`siftle-${e.headline.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"").slice(0,48)||"story"}.png`,Jt=async e=>{let a=await Yt(e),r=URL.createObjectURL(a),o=document.createElement("a");o.href=r,o.download=Gt(e),o.click(),URL.revokeObjectURL(r)},ar=async e=>{let a=await Yt(e),r=new File([a],Gt(e),{type:"image/png"}),o={title:e.headline,text:`Siftle: ${e.headline}`,files:[r]};if(navigator.canShare?.(o)&&navigator.share){await navigator.share(o);return}await Jt(e)},rr=async(e,a)=>{let r=t.stories.find(o=>o.id===e);if(r){t.activeShareStoryId=null,ve(),k(a==="share"?"Preparing share image":"Preparing download"),T&&(T.textContent=a==="share"?"Preparing share image...":"Preparing image download...");try{a==="share"?await ar(r):await Jt(r),k(a==="share"?"Share image ready":"Image saved"),T&&(T.textContent="Branded story image ready")}catch(o){console.warn(o),k("Image export unavailable"),T&&(T.textContent="Image export was cancelled or unavailable")}}},kt=(e,a)=>`
  <article class="thread-item">
    ...
    <div class="thread-item-body">
      ...
      ${we(e)?t.loadingSummaryUrl===e.sourceUrl?`<div style="margin-top: 12px;">${et()}</div>`:`<div style="margin-top: 12px;">${Ge(J(e,t.aiSummaries[e.sourceUrl]||e.ai_summary))}</div>`:""}
    </div>
  </article>
`,or=()=>{if(!$||!w)return;let e=t.stories.find(o=>o.sourceUrl===t.selectedThreadUrl);if(w.hidden=!0,$.hidden=!1,$.classList.add("fullscreen"),document.body.classList.add("detail-mode"),!e){$.innerHTML="";return}let a=t.loadingThreadUrl===e.sourceUrl,r=t.activeThread;if(a&&!r){$.innerHTML=`
  ...
  `},sr=()=>{if(!$||!w)return;if(t.selectedThreadUrl){or();return}let e=t.stories.find(n=>n.id===t.selectedStoryId);if(!e){$.hidden=!0,$.classList.remove("fullscreen"),document.body.classList.remove("detail-mode"),w.hidden=!1;return}let a=J(e,t.aiSummaries[e.sourceUrl]),r=t.loadingSummaryUrl===e.sourceUrl,o=we(e),s=t.unlockingSummaryUrl===e.sourceUrl;w.hidden=!0,$.hidden=!1,$.classList.add("fullscreen"),document.body.classList.add("detail-mode"),$.innerHTML=`
    <div class="detail-container">
      ...
      <article class="detail-card">
        <div class="detail-topline">
          <span class="category-chip ${e.category}">${H(e.category)}</span>
          <span>${e.source} - ${me(e)} - ${e.readTime}</span>
        </div>
        <h2>${e.headline}</h2>
  ...
  `},nr=e=>{let a=t.marketSnapshots[e.id],r=q(e),o=a?.yesPriceCents,s=o??e.probability,n=`${s}%`,i=o===void 0?r?"Loading Arc pools":"Arc setup required":`Yes ${o}\xA2 \xB7 No ${100-o}\xA2`,l=o===void 0?`Yes ${e.probability}c - No ${100-e.probability}c`:i,d=Pe(e);return`
  ...
  `},ir=e=>{let a=Pe(e),o=t.marketSnapshots[e.id]?.yesPriceCents??e.probability,s=100-o,n=a.evidence[0],i=n?n.headline:"No updates yet",l=`${window.location.origin}${window.location.pathname}#market-${e.id}`;return`\u{1F6A8} *Siftle Market Alert* \u{1F6A8}
...
Trade and discuss here: ${l}`},lr=e=>{if(!w||!$)return;let a=Pe(e),r=!t.checkedMarketEvidence[e.id],o=q(e),s=t.marketSnapshots[e.id],n=!!(o&&!s),i=s?.yesPriceCents??(o?e.probability:0),l=s?.noPriceCents??(o?100-e.probability:0),d=n?"":o?`${i}\xA2`:"--",c=n?"":o?`${l}\xA2`:"--",f=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},u=Ue(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,f),h=jt(t.marketOrderMode,t.marketTradeSide,f),p=t.marketOrderMode==="buy"?"$5-$10 USDC":`Up to $${W(h.max)} USDC`,m=!t.walletAddress||t.hasLoadedPortfolioPositions,v=Ze(e,s),b=It(e,s),y=!!b;t.marketTradeSide=Xe(t.marketOrderMode,t.marketTradeSide,f);let x=!v&&!y&&m&&X(t.marketOrderMode,"yes",f),S=!v&&!y&&m&&X(t.marketOrderMode,"no",f),A=!v&&!y&&m&&X(t.marketOrderMode,t.marketTradeSide,f),I=v?"Market resolved":b||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),j=v?"Market resolved":b||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),_=Wt(s,t.marketTradeSide,u,t.marketOrderMode,f),O=t.marketOrderMode==="buy"?"Buy":"Exit",re=o?"Arc testnet live":"Contract not deployed";w.hidden=!0,$.hidden=!1,$.classList.add("fullscreen"),document.body.classList.add("detail-mode"),Ya(e),Ht(e),t.walletAddress&&!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&Y();let B=f.yesSharesUsdc>0||f.noSharesUsdc>0,oe="";B&&t.walletAddress&&(oe=`
    ...
    <div class="detail-container market-detail-container">
      ...
      <article class="market-detail-card">
        <div class="market-detail-main">
          <div class="market-detail-topline">
            <span class="category-chip ${e.category}">${H(e.category)}</span>
            <span class="market-status-pill">${re}</span>
          </div>
          <h2>${e.question}</h2>
          ${oe}
          ${a.imageUrl?`
          ...
          <div class="market-resolution-panel">
            ...
            <p>${e.resolution}</p>
            ${b?`<p style="margin-top: 10px; color: #f59e0b; font-weight: 600;">${b}</p>`:""}
          </div>
          ...
          <section class="market-evidence-thread">
            ...
            <div class="market-thread-timeline">
              ${r?Za(3):a.evidence.length===0?'<div class="portfolio-empty compact">Market thread is still being prepared for this match.</div>':a.evidence.map(L=>`
                <article class="market-thread-update">
                  ...
                  <div class="market-thread-update-content">
                    ...
                    ${we(ze(e,L))?t.loadingSummaryUrl===L.sourceUrl?`<div style="margin-top: 12px;">${et()}</div>`:`<div style="margin-top: 12px;">${Ge(J(ze(e,L),t.aiSummaries[L.sourceUrl]))}</div>`:""}
                  </div>
                </article>
              `).join("")}
            </div>
      ...
      <div class="sticky-trade-bar">
        ...
        <button class="sticky-trade-btn" type="button" id="openTradeDrawerBtn" ${v||y?"disabled":""}>
          ${v?"Market Resolved":b||"Trade Market"}
        </button>
      </div>
      ...
      <div class="trade-drawer ${t.tradeDrawerOpen?"open":""}" id="tradeDrawer">
        ...
        <div class="trade-drawer-body">
          <div class="market-order-mode">
            <button type="button" class="${t.marketOrderMode==="buy"?"active":""}" data-market-order-mode="buy" ${v||y?"disabled":""}>Buy</button>
            <button type="button" class="${t.marketOrderMode==="sell"?"active":""}" data-market-order-mode="sell" ${v||y?"disabled":""}>Exit</button>
          </div>
          ...
          <div class="market-amount-panel">
            ...
            <div class="market-amount-input-row">
              <span>$</span>
              <input id="marketAmountInput" type="number" min="${h.min.toFixed(2)}" max="${Math.max(h.min,h.max).toFixed(2)}" step="0.01" inputmode="decimal" value="${u}" data-market-amount ${v||y?"disabled":""} />
              <span>USDC</span>
            </div>
          </div>
  ...
  `},Kt=()=>{if(!w||!$)return;if(Me?.toggleAttribute("hidden",!0),Le?.toggleAttribute("hidden",!0),ee?.toggleAttribute("hidden",!0),be?.classList.add("active"),ye?.classList.remove("active"),ke?.classList.remove("active"),window.setTimeout(()=>{t.activeSurface==="markets"&&C.forEach(n=>{Ht(n)})},750),t.selectedMarketId){let n=C.find(i=>i.id===t.selectedMarketId);if(n){lr(n);return}t.selectedMarketId=null,window.location.hash.startsWith("#market-")&&window.history.replaceState({},"","#markets");return}document.body.classList.remove("detail-mode"),$.hidden=!0,$.classList.remove("fullscreen"),w.hidden=!1,w.classList.add("markets-list");let e=C,r=`
  ...
  `},Vt=()=>{if(!w||!$)return;Me?.toggleAttribute("hidden",!0),Le?.toggleAttribute("hidden",!0),ee?.toggleAttribute("hidden",!0),be?.classList.remove("active"),ye?.classList.remove("active"),ke?.classList.remove("active"),document.body.classList.remove("detail-mode"),$.hidden=!0,w.hidden=!1,w.classList.add("markets-list");let e=t.walletAddress&&t.hasLoadedPortfolioPositions?Qe():null;t.walletAddress&&e&&fetch(M("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:t.walletAddress,points:e.points,status:e.status,username:t.profileUsername||""})}).catch(p=>console.error("Failed to report user score:",p)),G&&(clearInterval(G),G=null),w.innerHTML=`
  ...
  `;let a=(p="2026-07-19T23:59:59.000Z")=>{let m=document.getElementById("seasonTimer");G&&clearInterval(G);let v=()=>{let y=new Date(p).getTime()-new Date().getTime();if(y<=0){m&&(m.innerText="Season Finished!"),G&&clearInterval(G);return}let x=Math.floor(y/(1e3*60*60*24)),S=Math.floor(y%(1e3*60*60*24)/(1e3*60*60)),A=Math.floor(y%(1e3*60*60)/(1e3*60)),I=Math.floor(y%(1e3*60)/1e3);m&&(m.innerText=`${x}d ${S}h ${A}m ${I}s`)};v(),G=setInterval(v,1e3)};a();let r=p=>p.map((m,v)=>{let b=Number(m.globalRank)||v+1,y=String(m.username||""),x=!!(t.walletAddress&&y.toLowerCase()===t.walletAddress.toLowerCase()),S=x&&t.profileUsername?t.profileUsername:m.displayName||y,A=x?`${t.profileUsername?S:D(y)} (You)`:S.startsWith("0x")&&S.length===42?D(S):S,I=U(A),j=U(Oe(m.status)),_=m.nextSeasonDivision?`Division ${m.nextSeasonDivision}`:"Qualify",O=b<=10?"promotion-zone":"safety-zone",re=b<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
    ...
    `}).join(""),o=p=>p.map((m,v)=>{let b=v+1,y=String(m.username||""),x=!!(t.walletAddress&&y.toLowerCase()===t.walletAddress.toLowerCase()),S=x&&t.profileUsername?t.profileUsername:m.displayName||y,A=U(Oe(m.status)),I=x?`${t.profileUsername?S:D(y)} (You)`:S.startsWith("0x")&&S.length===42?D(S):S,j=U(I),_="safety-zone",O='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return b<=2?(_="promotion-zone",O='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):b>=5&&(_="relegation-zone",O='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
    ...
    `)},i=()=>{s("global");let p=document.getElementById("leaderboardListContainer"),m="global",v=dt(m);v&&p?(p.innerHTML=mt()+r(v.players),v.seasonEndsAt&&a(v.seasonEndsAt)):n(10);let b=new URLSearchParams;t.walletAddress&&b.set("walletAddress",t.walletAddress);let y=b.toString();fetch(M(`/api/leaderboard/global${y?`?${y}`:""}`)).then(x=>x.json()).then(x=>{let S=ct(x.players||[],v?.players||[],!0);p&&(p.innerHTML=S.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players on the global leaderboard yet.</p>`:r(S)),He(m,{players:S,seasonEndsAt:x.seasonEndsAt}),a(x.seasonEndsAt)}).catch(x=>{console.error("Failed to load global leaderboard:",x),p&&(p.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading global leaderboard. Please try again.</p>`)})},l=p=>{s("division");let m=document.getElementById("leaderboardListContainer"),v=`division_${p||de||"current"}`,b=dt(v);b&&m?(m.innerHTML=mt()+o(b.players),b.divisionNumber&&(de=b.divisionNumber),b.seasonEndsAt&&a(b.seasonEndsAt)):m&&p!==void 0&&(m.innerHTML=`
        <div class="leaderboard-skeleton" style="display: flex; flex-direction: column; gap: 12px; width: 100%;">
          ${Array.from({length:6}).map(()=>`
            <div style="height: 52px; background: rgba(255,255,255,0.02); border: 1px solid #1e1f2b; border-radius: 8px; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 0 16px;">
              <div style="display: flex; align-items: center; gap: 12px; width: 60%;">
      ...
      `);let y=new URLSearchParams;t.walletAddress&&y.set("walletAddress",t.walletAddress),p&&y.set("division",String(p));let x=y.toString();fetch(M(`/api/leaderboard/division${x?`?${x}`:""}`)).then(S=>S.json()).then(S=>{let A=S.divisionNumber||1,I=ct(S.players||[],b?.players||[],!1),j=S.totalDivisions||1,_=S.seasonEndsAt;de=A;let O=document.getElementById("divisionTitleText");O&&(O.innerText=`Division ${A}`);let re=document.getElementById("divisionSelector");re&&(re.innerHTML=Array.from({length:j},(B,oe)=>oe+1).map(B=>`
            <option value="${B}" ${B===A?"selected":""}>Division ${B}</option>
          `).join("")),m&&(I.length===0?m.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No active players in this division.</p>`:m.innerHTML=I.map((B,oe)=>{let L=oe+1,K=t.walletAddress&&B.username.toLowerCase()===t.walletAddress.toLowerCase(),le=K&&t.profileUsername?t.profileUsername:B.displayName||B.username,Xt=U(Oe(B.status)),Qt=K?`${t.profileUsername?le:D(B.username)} (You)`:le.startsWith("0x")&&le.length===42?D(le):le,ea=U(Qt),Ee="safety-zone",Ie='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return L<=2?(Ee="promotion-zone",Ie='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):L>=5&&(Ee="relegation-zone",Ie='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
                <div class="leaderboard-row ${K?"user-highlight":""} ${Ee}" role="listitem" style="display: flex !important; align-items: center !important; justify-content: space-between !important; padding: 12px 16px !important; border-bottom: 1px solid rgba(255, 255, 255, 0.06) !important; margin-bottom: 0 !important; background: transparent !important; font-family: 'Space Grotesk', sans-serif !important;">
                  ...
                  <div style="flex: 1.5; display: flex; align-items: center; gap: 8px; min-width: 0;">
                    ...
                    <span class="leaderboard-username" style="font-weight: 600; color: #ffffff; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${ea}</span>
                  </div>
                  <!-- Center Side: Points -->
                  <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
                  ...
                  <!-- Right Side: Status -->
                  <div style="flex: 1.5; display: flex; flex-direction: column; align-items: flex-end; justify-content: center; text-align: right; min-width: 0;">
                    <span style="font-size: 0.78rem; color: #8e8e93; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${Xt}</span>
                  </div>
                </div>
              `}).join("")),He(v,{players:I,divisionNumber:A,totalDivisions:j,seasonEndsAt:_}),He(`division_${A}`,{players:I,divisionNumber:A,totalDivisions:j,seasonEndsAt:_}),a(_)}).catch(S=>{console.error("Failed to load division leaderboard:",S),m&&(m.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading division leaderboard. Please try again.</p>`)})};V==="division"?l(de||void 0):i(),document.querySelectorAll("[data-leaderboard-view]").forEach(p=>{p.addEventListener("click",()=>{(p.dataset.leaderboardView==="division"?"division":"global")==="division"?l(de||void 0):i()})}),document.getElementById("divisionSelector")?.addEventListener("change",p=>{let m=Number(p.target.value);l(m)}),document.getElementById("faucetClaimButton")?.addEventListener("click",async()=>{if(!t.walletAddress){k("Please sign in first!");return}if(localStorage.getItem("siftle_circle_is_mock")==="true"){let m=parseFloat(localStorage.getItem(`siftle_mock_balance_${t.walletAddress}`)||"1000.00")+100;localStorage.setItem(`siftle_mock_balance_${t.walletAddress}`,m.toFixed(2)),t.walletBalance=m.toFixed(2),k("Claimed $100 USDC mock credits!"),E(),Vt()}else k("Opening Circle Faucet..."),window.open(Re,"_blank")});let f=document.getElementById("howItWorksBtn"),u=document.getElementById("howItWorksModal"),h=document.getElementById("closeRulesModalBtn");f?.addEventListener("click",()=>{u&&u.classList.add("active")}),h?.addEventListener("click",()=>{u&&u.classList.remove("active")}),u?.addEventListener("click",p=>{p.target===u&&u.classList.remove("active")})},Zt=()=>{t.activeSurface="feed",t.selectedMarketId=null,Me?.removeAttribute("hidden"),Le?.removeAttribute("hidden"),ee?.removeAttribute("hidden"),be?.classList.remove("active"),ye?.classList.add("active"),ke?.classList.remove("active"),w?.classList.remove("markets-list")},dr=e=>e===1?"Yes resolved":e===2?"No resolved":e===3?"Invalid":"Open",wt=e=>{let a=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},r=t.marketSnapshots[e.id],o=dr(r?.outcome),s=zt(a,r),n=s.reduce((m,v)=>Math.max(m,v.payout),0),i=a.yesSharesUsdc+a.noSharesUsdc,l=r?.outcome??0,d=Ve().has(e.id),c=l===1?a.yesSharesUsdc:l===2?a.noSharesUsdc:0,f=l===1?r?.yesSharesUsdc??0:l===2?r?.noSharesUsdc??0:0,u=r?.volumeUsdc??0,h=c>0&&f>0?c/f*u:0,p=l===0?"":d?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':h>0?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${W(h)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>';return`
  ...
  `},cr=async e=>{if(!t.walletAddress){k("Please sign in first.");return}let a=Ae().find(o=>o.id===e),r=a?q(a):"";if(!a||!r){k("Market is not available.");return}try{P("claim_attempt"),Qe();let o=await ia(r,t.walletAddress);P("claim_success"),o.won&&ja(a.id),delete t.marketPositions[a.id],delete t.marketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.walletBalance=await ue(t.walletAddress),await Y(),k(o.won?`Claimed $${W(o.amountUsdc)}`:"No payout to claim"),E(),z()}catch(o){P("claim_failed"),k(o instanceof Error?o.message:"Claim failed")}},mr=e=>{if(!e)return"";let a=t.referralData,r=a?.referrals?.length?a.referrals.map(s=>{let n=s.displayName||D(s.walletAddress),i=s.remaining<=0;return`
  ...
  `},z=()=>{if(!w||!$)return;Me?.toggleAttribute("hidden",!0),Le?.toggleAttribute("hidden",!0),ee?.toggleAttribute("hidden",!0),be?.classList.remove("active"),ye?.classList.remove("active"),ke?.classList.add("active"),document.body.classList.remove("detail-mode"),$.hidden=!0,w.hidden=!1,w.classList.add("markets-list"),t.walletAddress&&!t.referralData&&!t.referralError&&!t.loadingReferralData&&he(),t.walletAddress&&!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.portfolioMarketPreviews.length===0&&At(),Y());let e=Ve(),a=Ae().filter(f=>{let u=t.marketPositions[f.id];return e.has(f.id)||u&&u.yesSharesUsdc+u.noSharesUsdc>0}),r=a.filter(f=>(t.marketSnapshots[f.id]?.outcome??0)===0),o=a.filter(f=>(t.marketSnapshots[f.id]?.outcome??0)!==0),s=!!t.walletAddress,n=t.profileUsername||(t.walletAddress?D(t.walletAddress):"Anonymous"),i=U(n),l=U(t.profileUsername||""),d=t.profileNotice?`<div style="margin-top: 14px !important; padding: 10px 12px !important; border-radius: 8px !important; border: 1px solid ${t.profileNotice.type==="error"?"rgba(239, 68, 68, 0.28)":"rgba(16, 185, 129, 0.24)"} !important; background: ${t.profileNotice.type==="error"?"rgba(127, 29, 29, 0.22)":"rgba(6, 95, 70, 0.18)"} !important; color: ${t.profileNotice.type==="error"?"#fca5a5":"#86efac"} !important; font-size: 0.8rem !important; font-weight: 650 !important;">${U(t.profileNotice.message)}</div>`:"",c=n.charAt(0).toUpperCase();w.innerHTML=`
    <section class="portfolio-surface">
      ...
      ${t.loadingPortfolioPositions?Xa(2):t.walletAddress?a.length===0?'<div class="portfolio-empty">No positions found for this wallet yet. Confirmed trades will appear here after the Arc transaction settles.</div>':`
  ...
  `},g=()=>{if(Lt.forEach(e=>{let a=e.dataset.bottomNav;e.classList.toggle("active",a==="saved"?t.showSaved:a===t.activeSurface&&!t.showSaved)}),t.activeSurface==="markets"){Kt();return}if(t.activeSurface==="portfolio"){z();return}if(t.activeSurface==="leaderboard"){Vt();return}Zt(),Nt(),ve(),sr(),R&&(R.value=t.activeArchiveDate??"")};We.textContent=Pt();ee?.addEventListener("click",e=>{let r=e.target.closest("[data-category]");r&&(t.activeCategory=r.dataset.category,window.history.pushState({},"","#feed"),F(),g(),xe(),te(t.activeCategory))});be?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,window.history.pushState({},"","#markets"),F(),g()});ye?.addEventListener("click",()=>{t.activeSurface="feed",t.showSaved=!1,window.history.pushState({},"","#feed"),F(),g(),xe(),te(t.activeCategory)});ke?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=!1,window.history.pushState({},"","#portfolio"),F(),g()});Z?.addEventListener("click",()=>{t.walletAddress?(window.location.hash="#portfolio",Se()):Ye()});document.addEventListener("click",e=>{let a=e.target,r=a.closest(".copy-address-btn");if(r){let i=r.getAttribute("data-address");i&&navigator.clipboard.writeText(i).then(()=>{k("Wallet address copied!")})}let o=a.closest("[data-claim-market]");if(o){let i=o.getAttribute("data-claim-market");i&&cr(i);return}if(a.closest("[data-open-referrals]")){t.referralPanelOpen=!t.referralPanelOpen,!t.referralData&&!t.loadingReferralData&&he(),z();return}if(a.closest("[data-close-referrals]")){t.referralPanelOpen=!1,z();return}if(a.closest("[data-refresh-referrals]")){t.referralError=null,he(),z();return}let s=a.closest("[data-copy-referral-code]");if(s){let i=s.getAttribute("data-copy-referral-code")||"";i&&navigator.clipboard.writeText(i).then(()=>k("Invite code copied"));return}let n=a.closest("[data-copy-referral-link]");if(n){let i=n.getAttribute("data-copy-referral-link")||"";i&&navigator.clipboard.writeText(i).then(()=>k("Invite link copied"));return}a.closest("[data-connect-wallet]")&&(t.walletAddress?xt():Ye())});Lt.forEach(e=>{e.addEventListener("click",()=>{let a=e.dataset.bottomNav;t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=a==="saved",a==="markets"?(t.activeSurface="markets",window.history.pushState({},"","#markets")):a==="portfolio"?(t.activeSurface="portfolio",window.history.pushState({},"","#portfolio")):a==="leaderboard"?(t.activeSurface="leaderboard",window.history.pushState({},"","#leaderboard")):(t.activeSurface="feed",window.history.pushState({},"","#feed"),xe(),te(t.activeCategory),a==="saved"&&(Ha(),qe(),ge())),F(),g()})});R?.addEventListener("change",()=>{t.activeArchiveDate=R.value||null,window.history.pushState({},"","#feed"),F(),g(),te(t.activeCategory)});ba?.addEventListener("click",()=>{t.activeArchiveDate=null,R&&(R.value=""),window.history.pushState({},"","#feed"),F(),g(),te(t.activeCategory)});w?.addEventListener("click",async e=>{let a=e.target;if(a.closest("#editUsernameBtn")){let h=w?.querySelector(".username-display-row"),p=w?.querySelector("#usernameEditForm");if(h&&p){h.style.display="none",p.style.display="flex";let m=p.querySelector("#usernameInput");m&&m.focus()}return}if(a.closest("#cancelUsernameBtn")){let h=w?.querySelector(".username-display-row"),p=w?.querySelector("#usernameEditForm");h&&p&&(h.style.display="flex",p.style.display="none");return}let s=a.closest("#saveUsernameBtn");if(s){let p=w?.querySelector("#usernameEditForm")?.querySelector("#usernameInput");if(p){let m=p.value.trim().slice(0,15),v=s,b=v.textContent||"Save";v.disabled=!0,v.textContent="Saving...",Oa(m),t.profileNotice=null;try{t.walletAddress&&await ae(!1),t.profileNotice={type:"success",message:"Username saved to your shared leaderboard profile."},k("Username updated"),z()}catch(y){let x=y instanceof Error?y.message:"Username save failed";t.profileNotice={type:"error",message:x},k(x),v.disabled=!1,v.textContent=b,z()}}return}let n=a.closest("[data-timeframe]");if(n){let h=n.dataset.timeframe;t.activeMarketTimeframe=h,Kt();return}let i=a.closest("[data-market-id]");if(i){t.selectedMarketId=i.dataset.marketId??null,P("market_view"),window.history.pushState({},"",`#market-${t.selectedMarketId}`),g(),window.scrollTo({top:0,behavior:"smooth"});return}let l=a.closest("[data-thread-story-id]"),d=a.closest("[data-export-id]"),c=a.closest("[data-export-action]"),f=a.closest("[data-story-id]");if(l){e.stopPropagation();let h=t.stories.find(p=>p.id===Number(l.dataset.threadStoryId));h&&La(h);return}let u=a.closest(".mobile-bookmark-btn, .bookmark-button");if(u){e.stopPropagation();let h=u.dataset.bookmarkUrl||"",p=t.stories.find(m=>m.sourceUrl===h);if(!p)return;p.saved=!p.saved,p.saved?Q.add(h):Q.delete(h),va(),k(p.saved?"Saved to your list":"Removed from saved"),ve();return}if(c){e.stopPropagation(),rr(Number(c.dataset.exportStoryId),c.dataset.exportAction);return}if(d){e.stopPropagation();let h=Number(d.dataset.exportId);t.activeShareStoryId=t.activeShareStoryId===h?null:h,ve();return}f&&(a.closest("a")||Bt(Number(f.dataset.storyId)))});w?.addEventListener("keydown",e=>{let r=e.target.closest("[data-story-id]");!r||e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),Bt(Number(r.dataset.storyId)))});$?.addEventListener("click",e=>{let a=e.target,r=a.closest("[data-unlock-briefing]");if(r){let d=t.stories.find(c=>c.id===Number(r.dataset.unlockBriefing));d&&it(d);return}let o=a.closest("[data-unlock-briefing-url]");if(o){let d=decodeURIComponent(o.dataset.unlockBriefingUrl||""),c=Ta(d);c&&(we(c)?Ce(c):it(c));return}if(a.closest("[data-back-markets]")){t.selectedMarketId=null,t.tradeDrawerOpen=!1,window.history.pushState({},"","#markets"),g();return}if(a.closest("#openTradeDrawerBtn")){let d=C.find(u=>u.id===t.selectedMarketId);if(d){if(Ze(d,t.marketSnapshots[d.id])){k("This market is resolved and can no longer be traded.");return}if(It(d,t.marketSnapshots[d.id])){k("Trading is locked 20 minutes before kickoff.");return}}t.tradeDrawerOpen=!0,P("trade_drawer_open");let c=$.querySelector("#tradeDrawer"),f=$.querySelector("#tradeDrawerBackdrop");c?.classList.add("open"),f?.classList.add("open");return}if(a.closest("#closeTradeDrawerBtn")||a.closest("#tradeDrawerBackdrop")){t.tradeDrawerOpen=!1;let d=$.querySelector("#tradeDrawer"),c=$.querySelector("#tradeDrawerBackdrop");d?.classList.remove("open"),c?.classList.remove("open");return}if(a.closest("#shareWhatsAppBtn")){let d=C.find(c=>c.id===t.selectedMarketId);if(d){let c=ir(d),f=`https://api.whatsapp.com/send?text=${encodeURIComponent(c)}`;window.open(f,"_blank")}return}let s=a.closest("[data-market-trade]");if(s&&t.selectedMarketId){let d=s.dataset.marketTrade;Ga(t.selectedMarketId,d);return}let n=a.closest("[data-market-trade-side]");if(n){if(n.disabled||n.classList.contains("disabled"))return;let d=C.find(u=>u.id===t.selectedMarketId),c=d?t.marketPositions[d.id]:void 0,f=n.dataset.marketTradeSide;if(!X(t.marketOrderMode,f,c))return;t.marketTradeSide=f,g();return}let i=a.closest("[data-market-order-mode]");if(i){t.marketOrderMode=i.dataset.marketOrderMode;let d=C.find(f=>f.id===t.selectedMarketId),c=d?t.marketPositions[d.id]:void 0;t.marketTradeSide=Xe(t.marketOrderMode,t.marketTradeSide,c),t.marketTradeAmount=Ue(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,c),g();return}a.closest("[data-back-to-feed]")&&Ca()});$?.addEventListener("input",e=>{let a=e.target;if(!a.matches("[data-market-amount]"))return;let r=C.find(l=>l.id===t.selectedMarketId),o=r?t.marketSnapshots[r.id]:void 0,s=r?t.marketPositions[r.id]:void 0;t.marketTradeAmount=Ue(Number(a.value)||0,t.marketOrderMode,t.marketTradeSide,s),a.value=String(t.marketTradeAmount);let n=Wt(o,t.marketTradeSide,t.marketTradeAmount,t.marketOrderMode,s),i=$.querySelector(".market-inline-payout strong");i&&(i.textContent=`$${W(n)}`)});$?.addEventListener("focusin",e=>{e.target.matches("[data-market-amount]")&&document.body.classList.add("market-amount-focused")});$?.addEventListener("focusout",e=>{e.target.matches("[data-market-amount]")&&window.setTimeout(()=>document.body.classList.remove("market-amount-focused"),120)});window.addEventListener("popstate",Se);window.addEventListener("hashchange",Se);De?.addEventListener("click",()=>{if(!Ne||!De)return;let e=!Ne.hidden;Ne.hidden=e,De.setAttribute("aria-expanded",String(!e))});document.addEventListener("click",e=>{let a=e.target;!a.closest(".share-control")&&t.activeShareStoryId!==null&&(t.activeShareStoryId=null,ve());let r=a.closest("[data-menu-action]");if(!r)return;let o={today:"Showing today's brief",saved:`${t.stories.filter(s=>s.saved).length} saved stories`,archive:t.archiveDates.length>0?"Choose a saved day from the archive selector":"No saved days yet"};T&&(T.textContent=o[r.dataset.menuAction??"today"]),r.dataset.menuAction==="today"&&(t.showSaved=!1,t.activeArchiveDate=null,R&&(R.value=""),F(),xe(),te(t.activeCategory)),r.dataset.menuAction==="saved"&&(Zt(),qe(),ge(),t.showSaved=!0,document.querySelector("#archiveControls")?.classList.remove("mobile-open"),F(),g())});g();E();ha().then(()=>{qa(),g(),E(),window.setTimeout(fr,1200),Ea()});var pr=document.querySelector("#mobileArchiveCard"),ne=document.querySelector("#archiveControls");pr?.addEventListener("click",()=>{if(!ne)return;ne.classList.toggle("mobile-open")&&setTimeout(()=>ne.scrollIntoView({behavior:"smooth",block:"center"}),50)});var ur=document.querySelector("#archivePill");ur?.addEventListener("click",e=>{if(e.stopPropagation(),!ne)return;ne.classList.toggle("mobile-open")&&setTimeout(()=>ne.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Te=!1,St=!1,fr=()=>{St||(St=!0,(async()=>{let e=await je();if(Te=!!e,e){t.walletConnecting=!0,E();try{let a=await la();Te=!1,t.walletConnecting=!1,a?(t.walletAddress=await je(),t.walletAddress&&(se(),t.walletBalance=await ue(t.walletAddress),await Y()),E(),t.activeSurface==="portfolio"&&g()):(t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,se(),k("Session expired. Please sign in again."),E(),g())}catch(a){console.warn(a),Te=!1,t.walletConnecting=!1,t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,se(),k("Session expired. Please sign in again."),E(),g()}}await da(a=>{Te||(t.walletAddress=a,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,se(),a&&ae(!1).catch(r=>console.error("Failed to report leaderboard entry:",r)),t.marketPositions={},t.hasLoadedPortfolioPositions=!1,E(),a?(he(),ue(a).then(r=>{t.walletBalance=r,E(),t.activeSurface==="portfolio"&&g()}),Y()):t.activeSurface==="portfolio"&&g())})})())};P("app_open");document.addEventListener("click",e=>{let r=e.target.closest("a, button");if(r){let o=r.className||"",s=typeof o=="string"?o:r.getAttribute("class")||"",n=r.getAttribute("href")||"";!(r.hasAttribute("data-unlock-briefing")||r.hasAttribute("data-unlock-briefing-url"))&&(s.includes("source-button")||s.includes("source-btn")||s.includes("source-link")||r.textContent?.trim()==="Open source")&&!s.includes("disabled")&&n!=="#"&&P("open_source")}},!0);
