import"./chunks/chunk-ZUUPKAA6.js";var me="Sports",Ne=[{id:"wc-portugal-spain-qualify",category:me,timeframe:"Daily",optionMarket:!0,question:"Which team will qualify in Portugal vs Spain?",options:[{id:"portugal",label:"Portugal"},{id:"spain",label:"Spain"}],probability:0,kickoffAt:"2026-07-06T19:00:00Z",closes:"Jul 6, 7:40 PM GMT+1",resolution:"One option resolves correct based on the team that officially qualifies in Portugal vs Spain, including extra time and penalties.",threadTopic:"Portugal vs Spain Qualify Watch",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-ronaldo-header-spain",category:me,timeframe:"Daily",optionMarket:!0,question:"Will Cristiano Ronaldo score a header vs Spain?",options:[{id:"yes",label:"Yes"},{id:"no",label:"No"}],probability:0,kickoffAt:"2026-07-06T19:00:00Z",closes:"Jul 6, 7:40 PM GMT+1",resolution:"Resolves Yes if Cristiano Ronaldo is officially credited with a headed goal for Portugal against Spain in regular time or extra time. Penalty shootout goals do not count. Otherwise resolves No.",threadTopic:"Ronaldo Header Watch vs Spain",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-usa-belgium-qualify",category:me,timeframe:"Daily",optionMarket:!0,question:"Which team will qualify in USA vs Belgium?",options:[{id:"usa",label:"USA"},{id:"belgium",label:"Belgium"}],probability:0,kickoffAt:"2026-07-07T00:00:00Z",closes:"Jul 7, 12:40 AM GMT+1",resolution:"One option resolves correct based on the team that officially qualifies in USA vs Belgium, including extra time and penalties.",threadTopic:"USA vs Belgium Qualify Watch",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-usa-goals-belgium",category:me,timeframe:"Daily",optionMarket:!0,question:"How many goals will USA score in regular + extra time vs Belgium?",options:[{id:"0",label:"0 goals"},{id:"1",label:"1 goal"},{id:"2",label:"2 goals"},{id:"3-plus",label:"3+ goals"}],probability:0,kickoffAt:"2026-07-07T00:00:00Z",closes:"Jul 7, 12:40 AM GMT+1",resolution:"One option resolves correct based on the number of goals officially scored by the United States against Belgium in regular time and extra time. Penalty shootout goals do not count.",threadTopic:"USA Goals vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-tonali-spurs",category:me,timeframe:"Sagas",question:"Will Sandro Tonali sign with Tottenham Hotspur in the Summer Transfer Window?",probability:58,closes:"September 1, 2026",resolution:"Resolves Yes if Tottenham Hotspur officially announces the transfer/signing of Sandro Tonali by the transfer deadline.",threadTopic:"Sandro Tonali Tottenham Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$182K",traders:"980",liquidity:"$29K",imageUrl:"https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-guimaraes-arsenal",category:me,timeframe:"Sagas",question:"Will Bruno Guimaraes officially sign with Arsenal by September 1, 2026?",probability:45,closes:"September 1, 2026",resolution:"Resolves Yes if Arsenal officially announces the transfer/signing of Bruno Guimaraes by the transfer deadline.",threadTopic:"Bruno Guimaraes Arsenal Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$204K",traders:"1,240",liquidity:"$36K",imageUrl:"https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=1200&q=80",evidence:[]}];var Xe="https://faucet.circle.com/",ft="siftle_backend_wallet_migration_notice",Ge=null,H=()=>(Ge||(Ge=import("./chunks/arc-ZAE4BJZI.js")),Ge),q=e=>e.length>10?`${e.slice(0,6)}...${e.slice(-4)}`:e,fa=async()=>(await H()).connectArcWallet(),X=async e=>(await H()).readArcUsdcBalance(e),ga=async(e,a,r,o)=>(await H()).payAiBriefingUnlock(e,a,r,o),ha=e=>{H().then(a=>a.resolveLocalTestMarketYes(e))},va=async e=>(await H()).readArcMarketSnapshot(e);var Bt=async(e,a)=>(await H()).readArcMarketState(e,a),ba=async(e,a,r,o,s,n,i)=>(await H()).executeArcMarketOrder(e,a,r,o,s,n,i),ya=async(e,a,r,o,s)=>(await H()).executeArcOptionMarketOrder(e,a,r,o,s),Dt=()=>{H().then(e=>e.disconnectArcWallet())},ka=async(e,a)=>(await H()).claimArcMarketPayout(e,a),_e=async()=>(await H()).getConnectedArcWallet(),wa=async()=>(await H()).validateArcSession(),Sa=async e=>(await H()).subscribeArcWallet(e),xa=async()=>(await H()).triggerGatewayWarmup(),$a=["Sports"],Ta="https://siftle.onrender.com",Aa=()=>{let e=(window.SIFTLE_API_BASE||"").replace(/\/$/,"");if(e)return e;let a=typeof window<"u"?window.location.hostname.toLowerCase():"";return a==="siftle.xyz"||a.endsWith(".siftle.xyz")||a.endsWith(".vercel.app")?Ta:""},Ma=Aa(),I=e=>`${Ma}${e}`,Nt="siftle_theme",La=()=>{try{return window.localStorage.getItem(Nt)==="light"?"light":"dark"}catch{return"dark"}},Te=La();function C(e){fetch(I("/api/analytics"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:e})}).catch(a=>console.error("Failed to track event:",a))}var t={activeSurface:"markets",profileUsername:null,selectedMarketId:null,marketOrderMode:"buy",marketTradeSide:"yes",marketTradeOptionId:null,marketTradeAmount:5,marketSnapshots:{},marketPositions:{},marketEvidenceOverrides:{},loadingMarkets:!0,checkedMarketEvidence:{},checkedMarketSnapshots:{},loadingMarketSnapshots:{},loadingMarketEvidence:{},loadingPortfolioPositions:!1,marketTradeStatus:null,hasLoadedPortfolioPositions:!1,walletConnecting:!1,walletAddress:null,walletBalance:null,activeCategory:"Sports",stories:[],isLoading:!1,selectedStoryId:null,aiSummaries:{},loadingSummaryUrl:null,unlockingSummaryUrl:null,archiveDates:[],activeArchiveDate:null,activeShareStoryId:null,selectedThreadUrl:null,activeThread:null,loadingThreadUrl:null,feedScrollY:0,hasLoadedFeed:!1,showSaved:!1,tradeDrawerOpen:!1,activeMarketTimeframe:"All",profileNotice:null,portfolioMarketPreviews:[],referralPanelOpen:!1,referralData:null,referralError:null,loadingReferralData:!1,portfolioPositionsLoadedAt:0,unlockConfig:null,newsSearchQuery:"",briefingStatusByUrl:{},claimingMarketIds:{}},we=null,V="global",J=null,gt=!1;var ht=new URLSearchParams(window.location.search).get("ref")||localStorage.getItem("siftle_pending_referral_code")||"";ht&&localStorage.setItem("siftle_pending_referral_code",ht.trim().toUpperCase());var Ot=20,E=Ne,Ua=(...e)=>{let a=new Map;return e.flat().forEach(r=>{r?.id&&a.set(r.id,{...a.get(r.id)||{},...r})}),Array.from(a.values())},Ue=()=>Ua(t.portfolioMarketPreviews,E,Ne),Pa=async()=>{t.loadingMarkets=!0,E.length===0&&(E=Ne);try{let e=new AbortController,a=window.setTimeout(()=>e.abort(),3500),r=await fetch(I("/api/markets"),{signal:e.signal});if(window.clearTimeout(a),r.ok){let o=await r.json();Array.isArray(o)&&o.length>0&&(E=o)}}catch(e){console.error("Failed to load markets:",e)}finally{t.loadingMarkets=!1}},_t=async()=>{try{let e=await fetch(I("/api/portfolio/markets"));if(!e.ok)return;let a=await e.json();Array.isArray(a)&&(t.portfolioMarketPreviews=a.map(r=>({threadStoryId:0,updates:0,movement:0,evidence:[],...r})))}catch(e){console.warn(e)}},Ht="siftle.savedUrls",ee=new Set,rt=()=>{try{let e=localStorage.getItem(Ht)||"[]",a=JSON.parse(e);ee=new Set(a.filter(Boolean))}catch{ee=new Set}},Ca=()=>{try{localStorage.setItem(Ht,JSON.stringify(Array.from(ee)))}catch{}},Ae=()=>{if(Array.isArray(t.stories))for(let e of t.stories)e.saved=!!ee.has(e.sourceUrl)};rt();Ae();var et=document.querySelector("#dateLabel"),te=document.querySelector("#categoryTabs"),k=document.querySelector("#storyList"),T=document.querySelector("#storyDetail"),Je=document.querySelector("#menuButton"),Ke=document.querySelector("#menuPanel"),A=document.querySelector("#menuStatus"),F=document.querySelector("#archiveDateSelect"),vt=document.querySelector("#archiveStatus"),Ea=document.querySelector("#todayButton"),Re=document.querySelector(".brief-hero"),qe=document.querySelector("#archiveControls"),Pe=document.querySelector("[data-surface='markets']"),Ce=document.querySelector("[data-surface='feed']"),Ee=document.querySelector("[data-surface='portfolio']"),Q=document.querySelector("#walletButton"),Se=document.querySelector("[data-theme-toggle]"),Rt=Array.from(document.querySelectorAll("[data-bottom-nav]")),Ve,Ia=()=>{if(!Se)return;let a=`Switch to ${Te==="light"?"dark":"light"} mode`;Se.setAttribute("aria-label",a),Se.title=a,Se.dataset.activeTheme=Te},qt=e=>{Te=e,document.documentElement.dataset.theme=e;try{window.localStorage.setItem(Nt,e)}catch{}Ia()};qt(Te);var B=()=>{if(Q){let e=Q.querySelector(".wallet-button-label");Q.classList.toggle("connected",!!t.walletAddress),Q.disabled=t.walletConnecting,Q.setAttribute("aria-label",t.walletAddress?`Wallet ${q(t.walletAddress)}`:"Sign in"),e&&(e.textContent=t.walletConnecting?"Signing in...":t.walletAddress?"Wallet":"Sign in"),Q.title=t.walletAddress?`${t.walletBalance??"0"} Arc Testnet USDC - ${q(t.walletAddress)}`:"Sign in"}};window.addEventListener("resize",B);Se?.addEventListener("click",()=>{qt(Te==="light"?"dark":"light")});var Ba=async e=>{let a=localStorage.getItem("siftle_pending_referral_code");if(a)try{let r=await fetch(I("/api/referrals/bind"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:e,referralCode:a})}),o=await r.json().catch(()=>({}));r.ok&&(o.bound||o.reason==="already_bound"||o.reason==="invalid_code")&&(localStorage.removeItem("siftle_pending_referral_code"),o.bound&&v("Referral connected"))}catch(r){console.warn(r)}},Me=async()=>{if(!(!t.walletAddress||t.loadingReferralData)){t.loadingReferralData=!0,t.referralError=null;try{let e=await fetch(I(`/api/referrals?walletAddress=${encodeURIComponent(t.walletAddress)}`)),a=await e.json().catch(()=>({}));e.ok?t.referralData=a:t.referralError=a?.error||"Referral tools are temporarily unavailable."}catch(e){console.warn(e),t.referralError="Referral tools are temporarily unavailable."}finally{t.loadingReferralData=!1,t.activeSurface==="portfolio"&&W()}}},je=async()=>{if(!t.walletConnecting){t.walletConnecting=!0,C("wallet_connect_start"),B();try{let e=await fa();if(e){C("wallet_connect_success"),t.walletAddress=e,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),t.walletBalance=await X(e),await Ba(e),Me(),await z(),le(!0).catch(r=>console.error("Failed to report leaderboard entry:",r));let a=localStorage.getItem(ft);a?(localStorage.removeItem(ft),v(a)):v("Connected to Arc Testnet"),window.location.hash="#portfolio",se()}}catch(e){C("wallet_connect_failed"),v(e instanceof Error?e.message:"Wallet connection failed")}finally{t.walletConnecting=!1,B()}}},v=e=>{let a=document.querySelector("#actionToast");a||(a=document.createElement("div"),a.id="actionToast",a.className="action-toast",a.setAttribute("role","status"),a.setAttribute("aria-live","polite"),document.body.appendChild(a)),a.textContent=e,a.classList.add("show"),Ve&&window.clearTimeout(Ve),Ve=window.setTimeout(()=>{a?.classList.remove("show")},1700)};window.showActionToast=v;var Da=(e,a,r,o)=>{let s=document.createElement("div");s.className="success-modal-overlay",s.innerHTML=`
  ...
  `,document.body.appendChild(s),setTimeout(()=>{s.classList.add("show")},10);let n=()=>{s.classList.remove("show"),setTimeout(()=>{s.remove()},300)};s.querySelector(".success-modal-close-btn")?.addEventListener("click",n),s.querySelector(".success-modal-action-btn")?.addEventListener("click",n),s.addEventListener("click",i=>{i.target===s&&n()})},Y=()=>{t.feedScrollY=0,window.scrollTo({top:0,behavior:"auto"})},jt=e=>{let a=e?new Date(`${e}T12:00:00`):new Date;return new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric"}).format(a)},Na=()=>t.stories.filter(e=>{if(t.showSaved)return!!e.saved;if(!(t.activeCategory==="All"||e.category===t.activeCategory))return!1;let a=t.newsSearchQuery.trim().toLowerCase();return a?[e.headline,e.summary,e.source,e.ai_summary].filter(Boolean).join(" ").toLowerCase().includes(a):!0}),xe=e=>t.activeArchiveDate?e.postedAt:`${e.postedAt} ago`,Oa=e=>/(\*\*?\s*critique|attempt\s*\d|prompt says|let'?s try|tighter version|word count|violat(?:e|es)|output only|valid json|the model|the prompt)/i.test(e),_a=(e,a=140)=>{let r=e.split(/\s+/).filter(Boolean);if(r.length<=a)return e;let s=r.slice(0,a).join(" "),n=Math.max(s.lastIndexOf("."),s.lastIndexOf("?"),s.lastIndexOf("!"));return n>s.length*.45?s.slice(0,n+1).trim():`${s.replace(/[,:;.'"!\?\s]+$/,"")}...`},bt=e=>{let a=String(e||"").trim();for(let r=0;r<2;r+=1){let o=a.match(/^```(?:json)?\s*([\s\S]*?)\s*```$/i);if(o&&(a=o[1].trim()),!/^\s*\{[\s\S]*\}\s*$/.test(a))break;try{let s=JSON.parse(a);if(typeof s.summary=="string"){a=s.summary.trim();continue}}catch{break}break}return a=a.replace(/&lt;|&#60;/gi,"<").replace(/&gt;|&#62;/gi,">").replace(/<[^>]+>/g," ").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&#39;/g,"'").replace(/&apos;/g,"'").replace(/&quot;/g,'"').replace(/^["'{\s]+/,"").replace(/["'}\s]+$/,"").replace(/^summary["'\s]*:[\s"']*/i,"").replace(/\s+/g," ").trim(),Oa(a)?"":_a(a)},ae=(e,a)=>bt(a||"")||bt(e.summary)||e.headline,Ha=e=>{let r=e?.closest(".detail-summary, .thread-item, .market-thread-update")?.querySelector(".briefing-capture-area");if(!r||!window.html2canvas)return;let o=document.createElement("div");o.className="briefing-export-staging";let s=r.cloneNode(!0);s.classList.add("briefing-export-surface");let n=document.documentElement.dataset.theme==="light";n?(s.style.background="linear-gradient(180deg, #ffffff, #f8fafc)",s.style.border="1px solid #cbd5e1"):(s.style.background="linear-gradient(180deg, rgba(15, 23, 42, 0.98), rgba(17, 24, 39, 0.98))",s.style.border="1px solid #1e293b"),s.style.width="704px",s.style.padding="28px 30px",s.style.borderRadius="24px";let i=s.querySelector(".briefing-capture-header");i&&(i.style.display="flex",i.style.marginBottom="18px",i.style.paddingBottom="14px");let l=s.querySelector(".briefing-capture-title");l&&(l.style.display="block",l.style.fontSize="1.48rem",l.style.lineHeight="1.3",l.style.marginBottom="16px");let p=s.querySelector(".briefing-capture-intro");p&&(p.style.fontSize="1rem",p.style.lineHeight="1.65",p.style.marginBottom="18px"),s.querySelectorAll(".briefing-section").forEach(m=>{m.style.border="none",m.style.borderRadius="18px",m.style.padding="18px 20px 18px 22px",m.style.marginBottom="14px",n?m.style.backgroundColor="#f1f5f9":m.style.backgroundColor="rgba(30, 41, 59, 0.45)"}),s.querySelectorAll(".briefing-title").forEach(m=>{m.style.fontSize="0.84rem",m.style.letterSpacing="0.12em",m.style.marginBottom="12px"}),s.querySelectorAll(".briefing-text, .briefing-list li").forEach(m=>{m.style.fontSize="1rem",m.style.lineHeight="1.72",m.style.fontWeight="650",n?m.style.color="#000000":m.style.color="#e2e8f0"}),o.appendChild(s),document.body.appendChild(o),s.offsetHeight,requestAnimationFrame(()=>{setTimeout(()=>{window.html2canvas(s,{backgroundColor:n?"#f5f7fb":"#0f172a",scale:2,logging:!1,useCORS:!0}).then(m=>{let d=document.createElement("a");d.download="siftle-briefing.png",d.href=m.toDataURL("image/png"),d.click(),window.showActionToast?.("Briefing card image downloaded!")}).catch(()=>{window.showActionToast?.("Unable to download briefing card")}).finally(()=>{o.remove()})},40)})};window.downloadBriefingCard=Ha;var Le=e=>e.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/(^-|-$)/g,""),Ra=e=>{let a=t.stories.find(s=>s.id===e),r=a?Le(a.headline):String(e),o=`${window.location.origin}${window.location.pathname}#story-${r}`;navigator.clipboard.writeText(o).then(()=>{window.showActionToast?.("Link copied to clipboard!")}).catch(()=>{window.showActionToast?.("Unable to copy link")})};window.copyBriefingLink=Ra;var ot=(e,a)=>{let r=e.split(/(?:\*\*|__)?(WHAT HAPPENED|KEY POINTS|TAKEAWAY)\s*:?\s*(?:\*\*|__)?\s*:?\s*/i);if(r.length<=1)return`<p class="briefing-text">${e}</p>`;let o='<div class="briefing-capture-area">';if(a){let n=a.headline||"Football Match Update";o+=`
    ...
    `}r[0].trim()&&(o+=`<p class="briefing-capture-intro">${r[0].trim()}</p>`);let s="";for(let n=1;n<r.length;n+=2){let i=r[n].trim().toUpperCase(),l=r[n+1]?r[n+1].trim():"";if(!l)continue;let p="";if(i==="KEY POINTS"){let f=l.split(/(?:•|\*|-)\s+/).map(c=>c.trim()).filter(Boolean);f.length>0?p=`<ul class="briefing-list">${f.map(c=>`<li>${c}</li>`).join("")}</ul>`:p=`<p class="briefing-text">${l}</p>`}else p=`<p class="briefing-text">${l}</p>`,i==="TAKEAWAY"&&(s=l);let g=i.toLowerCase().replace(/\s+/g,"-");o+=`
      <div class="briefing-section ${g}-section">
    ...
    `),o},Ie=e=>{let a=t.briefingStatusByUrl[e.sourceUrl]||"";return a?`<p class="briefing-status-note">${M(a)}</p>`:""},qa=()=>{let e=String(t.walletAddress||"").trim().toLowerCase();return/^0x[a-f0-9]{40}$/.test(e)?e:"guest"},st=e=>`siftle_ai_briefing_unlock_${qa()}_${btoa(unescape(encodeURIComponent(e.sourceUrl))).replace(/=+$/g,"")}`,zt=e=>localStorage.getItem(st(e))||"",ja=e=>{localStorage.removeItem(st(e))},re=e=>!!zt(e),Ft=(e,a)=>({id:0,headline:a.headline,category:e.category,summary:a.summary,source:a.source,sourceUrl:a.sourceUrl,imageUrl:e.imageUrl||"",publishedAt:void 0,readTime:"3 min read",postedAt:a.date,accent:"slate",saved:ee.has(a.sourceUrl),ai_summary:void 0,ai_provider:void 0}),za=e=>{let a=t.stories.find(s=>s.sourceUrl===e);if(a)return a;let o=[t.activeThread?.current,...t.activeThread?.items??[]].filter(Boolean).find(s=>s.sourceUrl===e);if(o)return o;if(t.selectedMarketId){let s=E.find(n=>n.id===t.selectedMarketId);if(s){let n=We(s).evidence.find(i=>i.sourceUrl===e);if(n)return Ft(s,n)}}return null},nt=(e,a)=>{let r=Va(e,a);return r===null?null:r-Ot*60*1e3},Wt=(e,a)=>{let r=nt(e,a);return r===null?e.closes:new Intl.DateTimeFormat("en",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZoneName:"short"}).format(new Date(r))},Yt=(e,a)=>{let r=nt(e,a);return r===null?null:Date.now()>=r?`Locked ${Ot}m before kickoff`:null},Fa=(e,a)=>{let r=t.unlockConfig?`${t.unlockConfig.amountUsdc} USDC`:"0.05 USDC",o=t.unlockConfig?.x402Enabled;return`
...
`,tt=async(e,a=!1)=>{if(!t.walletAddress){v("Please sign in first.");return}if(!(t.unlockingSummaryUrl===e.sourceUrl&&!a)){t.unlockingSummaryUrl=e.sourceUrl,t.briefingStatusByUrl[e.sourceUrl]="Preparing AI briefing payment...",C("ai_unlock_attempt"),h();try{let r=await fetch(I("/api/summary/unlock-config")),o=await r.json();if(!r.ok||!o.treasuryAddress)throw new Error(o.error||"AI briefing is not configured");let s=Number(o.amountUsdc)||1e-4;if(Number(t.walletBalance||0)<s)throw new Error(`Your wallet has insufficient balance. Please fund your wallet (minimum ${s} USDC required).`);let i=await ga(o.treasuryAddress,s,f=>{A&&(A.textContent=f),t.briefingStatusByUrl[e.sourceUrl]=f,h()},{sourceUrl:e.sourceUrl,topic:e.headline});t.briefingStatusByUrl[e.sourceUrl]=o.x402Enabled?`Payment successful. Loading AI briefing paid with ${o.amountUsdc} testnet USDC through x402.`:`Payment successful. Loading AI briefing paid with ${o.amountUsdc} testnet USDC.`,h();let l=await fetch(I("/api/summary/unlock"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sourceUrl:e.sourceUrl,walletAddress:t.walletAddress,txHash:i})}),p=await l.json();if(!l.ok||!p.unlockToken)throw new Error(p.error||"AI briefing failed");localStorage.setItem(st(e),p.unlockToken),C("ai_unlock_success"),(Number(p?.bonus?.points)||0)>0&&le(!1).catch(f=>console.error("Failed to refresh leaderboard bonus:",f)),await ze(e)}catch(r){C("ai_unlock_failed"),delete t.briefingStatusByUrl[e.sourceUrl],v(r instanceof Error?r.message:"AI briefing failed")}finally{t.unlockingSummaryUrl=null,h()}}},ze=async e=>{if(re(e)&&!(t.aiSummaries[e.sourceUrl]||t.loadingSummaryUrl===e.sourceUrl)){if(e.ai_summary){t.aiSummaries[e.sourceUrl]=ae(e,e.ai_summary),C("view_summary"),A&&(A.textContent=e.ai_provider==="0g"?"Archived 0G summary loaded":"Archived summary loaded"),h();return}t.loadingSummaryUrl=e.sourceUrl,t.briefingStatusByUrl[e.sourceUrl]="Generating briefing...",h();try{let a=await fetch(I("/api/summary"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...e,walletAddress:t.walletAddress,unlockToken:zt(e)})});if(!a.ok){if(a.status===402){ja(e),delete t.aiSummaries[e.sourceUrl],t.briefingStatusByUrl[e.sourceUrl]="AI briefing unlock expired. Unlock it again to generate a new briefing.",A&&(A.textContent="Unlock expired. Unlock again to continue."),h();return}throw new Error(`Summary request failed with ${a.status}`)}let r=await a.json();t.aiSummaries[e.sourceUrl]=ae(e,r.summary),t.briefingStatusByUrl[e.sourceUrl]="AI briefing ready.",A&&r.provider&&(A.textContent=r.provider==="0g"?"Summary generated by 0G":`Summary loaded from ${r.provider}`)}catch(a){console.warn(a),delete t.aiSummaries[e.sourceUrl],t.briefingStatusByUrl[e.sourceUrl]="AI briefing unavailable. Retry to generate it again.",A&&(A.textContent="AI briefing failed. Retry available.")}finally{t.loadingSummaryUrl=null,h()}}},Gt=(e,a=!1)=>{let r=t.stories.find(o=>o.id===e);r&&(t.feedScrollY=window.scrollY,t.selectedStoryId=r.id,t.selectedThreadUrl=null,t.activeThread=null,window.history.pushState({},"",`#story-${Le(r.headline)}`),h(),a&&!re(r)?(t.walletAddress&&(t.unlockingSummaryUrl=r.sourceUrl),h(),tt(r,!0)):re(r)&&ze(r),window.scrollTo({top:0,behavior:"smooth"}))},Wa=e=>{t.feedScrollY=window.scrollY,t.selectedStoryId=null,t.selectedThreadUrl=e.sourceUrl,t.activeThread=null,t.loadingThreadUrl=e.sourceUrl,window.history.pushState({},"",`#thread-${Le(e.headline)}`),h(),Jt(e),window.scrollTo({top:0,behavior:"smooth"})},Ya=()=>{t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,t.loadingThreadUrl=null,window.history.pushState({},"","#feed"),h(),requestAnimationFrame(()=>window.scrollTo({top:t.feedScrollY,behavior:"auto"}))},Jt=async e=>{try{let a=await fetch(I(`/api/thread?category=${encodeURIComponent(e.category)}&sourceUrl=${encodeURIComponent(e.sourceUrl)}`));if(!a.ok)throw new Error(`Thread request failed with ${a.status}`);t.activeThread=await a.json(),A&&(A.textContent=`${t.activeThread?.count??0} related updates found`)}catch(a){console.warn(a),t.activeThread=null,delete e.thread,t.selectedThreadUrl=null,window.history.replaceState({},"","#feed"),v("That timeline no longer has a verified past update"),A&&(A.textContent="Thread unavailable")}finally{t.loadingThreadUrl=null,h()}};function se(){if(window.location.hash==="#resolve-local-yes"){let a=E.find(r=>r.id==="siftle-local-test-2")||E.find(r=>r.timeframe==="Daily"&&G(r).startsWith("0x00000000000000000000000000000000000001"));if(a){ha(G(a)),ir(a,"yes"),delete t.marketSnapshots[a.id],delete t.marketPositions[a.id],delete t.checkedMarketSnapshots[a.id],delete t.loadingMarketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.activeSurface="portfolio",t.selectedMarketId=null,window.history.replaceState({},"","#portfolio"),v("Local test market resolved YES"),z().then(()=>{le(!0).catch(r=>console.error("Failed to report leaderboard entry:",r)),B(),W()});return}}let e=window.location.hash.match(/^#market-(.+)$/);if(window.location.hash==="#markets"||e){t.activeSurface="markets",t.selectedMarketId=e?.[1]??null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null;let a=e?E.find(r=>r.id===e[1]):void 0;document.title=a?`${a.question} | Siftle`:"Siftle Markets",h();return}if(window.location.hash==="#portfolio"){t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,document.title="Siftle Portfolio",h();return}if(window.location.hash==="#leaderboard"){t.activeSurface="leaderboard",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,document.title="Siftle Leaderboard",h();return}if(window.location.hash==="#feed"||window.location.hash.startsWith("#story-")||window.location.hash.startsWith("#thread-")){t.activeSurface="feed";let a=window.location.hash.match(/^#story-(.+)$/),r=window.location.hash.match(/^#thread-(.+)$/);if(t.stories.length===0&&!t.isLoading){Kt(t.activeCategory).then(()=>{se()});return}let o;if(a){let i=a[1];o=t.stories.find(l=>Le(l.headline)===i),!o&&/^\d+$/.test(i)&&(o=t.stories.find(l=>l.id===Number(i)))}let s;if(r){let i=r[1];s=t.stories.find(l=>Le(l.headline)===i),!s&&/^\d+$/.test(i)&&(s=t.stories.find(l=>l.id===Number(i)))}o?document.title=`${o.headline} | Siftle`:s?document.title=`${s.headline} | Siftle`:document.title="Siftle News";let n=t.selectedStoryId!==null||t.selectedThreadUrl!==null;t.selectedStoryId=o?.id??null,t.selectedThreadUrl=s?.sourceUrl??null,t.activeThread=null,h(),o&&ze(o),s&&Jt(s),!o&&!s&&n&&requestAnimationFrame(()=>window.scrollTo({top:t.feedScrollY,behavior:"auto"}));return}t.activeSurface="feed",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,document.title="Siftle",h(),ne(t.activeCategory)}var at=e=>{vt&&(vt.textContent=e)},Kt=async(e=t.activeCategory,a=!1)=>{a||(t.activeSurface="feed",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,t.loadingThreadUrl=null,t.showSaved=!1),t.isLoading=!0,t.activeSurface==="feed"&&(Vt(),h());try{let r=t.activeArchiveDate?`/api/archive?date=${encodeURIComponent(t.activeArchiveDate)}&category=${encodeURIComponent(e)}`:`/api/feed?category=${encodeURIComponent(e)}`,o=await fetch(I(r));if(!o.ok)throw new Error(`Feed request failed with ${o.status}`);let s=await o.json();if(t.stories=s.top_stories??[],Ae(),t.hasLoadedFeed=!0,et&&(et.textContent=jt(s.date??t.activeArchiveDate)),A)if(t.activeArchiveDate)A.textContent=`Showing ${e} from ${t.activeArchiveDate}`;else{let n=s.archive?.provider==="shelby"?"Shelby":"local archive";A.textContent=`Latest published feed loaded from ${n}`}at(t.activeArchiveDate?`Archive: ${t.activeArchiveDate}`:"Live feed")}catch(r){console.warn(r),t.hasLoadedFeed||(t.stories=[]),Ae(),A&&(A.textContent=t.activeArchiveDate?"That saved day/category is not available yet":"Feed data is currently unavailable. Please check back shortly.")}finally{t.isLoading=!1,h(),se()}},Ga=async()=>{if(F)try{let e=await fetch(I("/api/archive"));if(!e.ok)throw new Error(`Archive index failed with ${e.status}`);let a=await e.json(),r=new Date().toLocaleDateString("en-CA",{timeZone:"Africa/Lagos",year:"numeric",month:"2-digit",day:"2-digit"});t.archiveDates=(a.dates??[]).filter(o=>o.date!==r),F.innerHTML=['<option value="">Today</option>',...t.archiveDates.map(o=>`<option value="${o.date}">${o.date}</option>`)].join(""),F.value=t.activeArchiveDate??"",at(t.archiveDates.length>0?"Saved days ready":"Live feed ready")}catch(e){console.warn(e),at("Archive unavailable")}},Fe=()=>{gt||(gt=!0,Ga())},ne=(e=t.activeCategory,a=!1)=>{t.hasLoadedFeed&&e===t.activeCategory&&!t.activeArchiveDate||Kt(e,a)};var Ja=e=>e==="All"?"For you":e==="Sports"?"Football":e,j=e=>e==="Sports"?"Football":e,Vt=()=>{te&&(te.innerHTML=$a.map(e=>`
        <button class="category-tab ${e===t.activeCategory?"active":""}" type="button" data-category="${e}">
          ${Ja(e)}
        </button>
      `).join(""))},Qt=e=>(e.thread?.count??0)>=1,Ka=(e=0)=>`${e} past ${e===1?"update":"updates"}`,Zt=(e=[])=>[...e].sort((a,r)=>{let o=new Date(a.publishedAt||0).getTime(),s=new Date(r.publishedAt||0).getTime();return(Number.isNaN(s)?0:s)-(Number.isNaN(o)?0:o)}),We=e=>{let a=t.marketEvidenceOverrides[e.id],r={...e,evidence:e.evidence??[]};return a?{...r,...a,updates:a.evidence.length}:r},Va=(e,a)=>{if(e.timeframe!=="Daily")return null;let r=e.kickoffAt?new Date(e.kickoffAt).getTime():Number.NaN;if(Number.isFinite(r))return r;let o=a?.closesAtUnix??0;return o>0?o*1e3:null},Qa=(e,a)=>a===0?"Latest":e.publishedAt?new Intl.DateTimeFormat("en",{month:"short",day:"numeric"}).format(new Date(e.publishedAt)):e.postedAt,Za=(e,a)=>({date:Qa(e,a),source:e.source,headline:e.headline,summary:ae(e),impact:a===0?"Latest":"Update",direction:"flat",sourceUrl:e.sourceUrl}),Xt=async e=>{if(!(t.checkedMarketEvidence[e.id]||t.loadingMarketEvidence[e.id])){t.loadingMarketEvidence[e.id]=!0;try{let a=await fetch(I(`/api/market-thread?id=${encodeURIComponent(e.id)}&nocache=${Date.now()}`));if(!a.ok)return;let r=await a.json(),o=[r.current,...Zt(r.items??[])],s=o.filter((l,p,g)=>g.findIndex(f=>f.sourceUrl===l.sourceUrl)===p).map(Za),i=o[0]?.imageUrl;s.length>=1&&(t.marketEvidenceOverrides[e.id]={threadTopic:r.topic||e.threadTopic,evidence:s,imageUrl:i||e.imageUrl})}catch(a){console.warn(a)}finally{t.checkedMarketEvidence[e.id]=!0,t.loadingMarketEvidence[e.id]=!1,t.activeSurface==="markets"&&h()}}},G=e=>e.optionMarket?e.id:e.marketAddress||window.SIFTLE_MARKET_ADDRESSES?.[e.id]||"",ie=e=>Array.isArray(e.options)?e.options.filter(a=>a?.id&&a?.label):[],oe=e=>!!(e.optionMarket&&ie(e).length>1),Xa=e=>{let a=ie(e);return a.find(r=>r.id===t.marketTradeOptionId)||a[0]||null},N=e=>e.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),M=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),dt=e=>`siftle_profile_username_${e.toLowerCase()}`,ea=e=>e.trim().replace(/\s+/g," ").slice(0,15),fe=()=>{if(!t.walletAddress){t.profileUsername=null,t.profileNotice=null;return}let e=dt(t.walletAddress),a=localStorage.getItem(e),r=localStorage.getItem("siftle_profile_username");!a&&r&&(a=ea(r),a&&localStorage.setItem(e,a),localStorage.removeItem("siftle_profile_username")),t.profileUsername=a||null,t.profileNotice=null},er=e=>{if(!t.walletAddress)return;let a=dt(t.walletAddress),r=ea(e);r?(localStorage.setItem(a,r),t.profileUsername=r):(localStorage.removeItem(a),t.profileUsername=null),localStorage.removeItem("siftle_profile_username")},tr=()=>{let e="one-hour-test-market",a=[];for(let r=0;r<localStorage.length;r++){let o=localStorage.key(r);o&&o.includes(e)&&a.push(o)}a.forEach(r=>localStorage.removeItem(r))},ta=(e,a,r)=>{if(e==="sell"){let o=a==="yes"?r?.yesSharesUsdc??0:r?.noSharesUsdc??0;return o<=0?{min:.01,max:.01,fallback:.01}:{min:Math.min(.01,o),max:o,fallback:o}}return{min:5,max:10,fallback:5}},Be=(e,a,r,o)=>{let{min:s,max:n,fallback:i}=ta(a,r,o);return Number.isFinite(e)?Math.min(n,Math.max(s,e)):i},aa=(e,a,r,o,s)=>{if(!e||!Number.isFinite(r)||r<=0)return 0;let n=a==="yes"?s?.yesSharesUsdc??0:s?.noSharesUsdc??0,i=e.yesSharesUsdc,l=e.noSharesUsdc;if(o==="sell")return Math.min(r,n);let p=(a==="yes"?i:l)+r,g=i+l+r;return p<=0||g<=0?r:(n+r)/p*g},ra=(e,a)=>{let r=a?.volumeUsdc??0,o=[];return e.yesSharesUsdc>0&&o.push({label:"YES Shares",shares:e.yesSharesUsdc,payout:a&&a.yesSharesUsdc>0?e.yesSharesUsdc/a.yesSharesUsdc*r:0}),e.noSharesUsdc>0&&o.push({label:"NO Shares",shares:e.noSharesUsdc,payout:a&&a.noSharesUsdc>0?e.noSharesUsdc/a.noSharesUsdc*r:0}),o},ar=e=>{let a=e?.yesSharesUsdc??0,r=e?.noSharesUsdc??0;return a>0&&r<=0?"yes":r>0&&a<=0?"no":null},oa=e=>`siftle_claimed_markets_${e.toLowerCase()}`,He=()=>{if(!t.walletAddress)return new Set;try{return new Set(JSON.parse(localStorage.getItem(oa(t.walletAddress))||"[]"))}catch{return new Set}},rr=e=>{if(!t.walletAddress)return;let a=He();a.add(e),localStorage.setItem(oa(t.walletAddress),JSON.stringify(Array.from(a)))},Ye=(e,a)=>(a?.outcome??0)!==0?!0:/^resolved$/i.test(String(e.closes||"").trim()),Z=(e,a,r)=>{let o=r?.yesSharesUsdc??0,s=r?.noSharesUsdc??0;return e==="sell"?a==="yes"?o>0:s>0:a==="yes"?s<=0:o<=0},ct=(e,a,r)=>{if(Z(e,a,r))return a;let o=a==="yes"?"no":"yes";return Z(e,o,r)?o:a};var or=e=>{let a=e instanceof Error?e.message:String(e||"");return/token|session|auth|unauthori[sz]ed|expired|401/i.test(a)},Qe=e=>{let a=String(e||"").trim();if(!a)return"0 wins, 0 losses";let r=a.replace(/closed profits?/gi,"losses").replace(/\bprofit\b/gi,"losses");return/\bloss/i.test(r)?r:`${r}, 0 losses`},sa="siftle_leaderboard_cache_v4_",yt=e=>{let a=String(e||"").match(/(\d+)\s+wins?/i),r=String(e||"").match(/(\d+)\s+loss(?:es)?/i);return{wins:a&&Number(a[1])||0,losses:r&&Number(r[1])||0}},kt=e=>{try{let a=JSON.parse(localStorage.getItem(`${sa}${e}`)||"null");return Array.isArray(a?.players)&&a.players.length?a:null}catch{return null}},Ze=(e,a)=>{if(!(!Array.isArray(a?.players)||a.players.length===0))try{localStorage.setItem(`${sa}${e}`,JSON.stringify({...a,cachedAt:Date.now()}))}catch{}},na=(e,a)=>{let r=yt(e?.status||""),o=yt(a?.status||""),s=(Number(a?.points)||0)-(Number(e?.points)||0);return s||(o.wins!==r.wins?o.wins-r.wins:r.losses!==o.losses?r.losses-o.losses:String(e?.username||"").localeCompare(String(a?.username||"")))},sr=e=>{let a=String(e?.displayName||"").trim().toLowerCase();return a&&!/^0x[a-f0-9]{40}$/i.test(a)?`name:${a}`:`wallet:${String(e?.username||"").toLowerCase()}`},nr=e=>{let a=new Map;return e.forEach(r=>{let o=sr(r);if(!o||o==="wallet:")return;let s=a.get(o);if(!s){a.set(o,r);return}a.set(o,na(s,r)<=0?s:r)}),Array.from(a.values())},wt=(e,a=[],r=!1)=>{let o=nr(e).slice().sort(na);return r?o.map((s,n)=>({...s,globalRank:n+1})):o},ia=(e,a)=>{let r=String(e?.optionId||"").trim(),o=Math.max(0,Number(e?.optionSharesUsdc)||0),s=Math.max(0,Number(a?.optionPools?.[r])||0),n=Math.max(0,Number(a?.volumeUsdc)||0);return!r||o<=0||s<=0||n<=0?0:o/s*n},St=()=>`
  <div class="leaderboard-sync-note" role="status">
    Showing saved standings while Siftle refreshes live scores...
  </div>
`,ut=()=>{let e=0,a=0,r=0,o=E.filter(i=>i.timeframe==="Daily").map(i=>i.id),s=t.walletAddress?`siftle_resolved_results_${t.walletAddress.toLowerCase()}`:"",n={};if(s)try{n=JSON.parse(localStorage.getItem(s)||"{}")}catch{}if(t.walletAddress&&t.hasLoadedPortfolioPositions)for(let i of o){if(n[i]?.result==="win"){e+=Number(n[i].points)||0,a++;continue}if(n[i]?.result==="loss"){r++;continue}let l=t.marketPositions[i],g=t.marketSnapshots[i]?.outcome??0;if(g===0)continue;let f=`siftle_traded_sides_${i}_${t.walletAddress.toLowerCase()}`,c=[];try{c=JSON.parse(localStorage.getItem(f)||"[]")}catch{}let m=c.includes("yes")&&c.includes("no");if(g===1&&l&&l.yesSharesUsdc>0){let d=m?50:100;e+=d,a++,n[i]={result:"win",points:d}}else if(g===2&&l&&l.noSharesUsdc>0){let d=m?50:100;e+=d,a++,n[i]={result:"win",points:d}}else l&&(l.yesSharesUsdc>0||l.noSharesUsdc>0)&&(r++,n[i]={result:"loss",points:0})}return s&&localStorage.setItem(s,JSON.stringify(n)),{points:e,status:`${a} win${a===1?"":"s"}, ${r} loss${r===1?"":"es"}`}},ir=(e,a)=>{let r=G(e).toLowerCase();if(!r)return;let o=`siftle_mock_pos_${r}_`,s=new Set;for(let n=0;n<localStorage.length;n++){let i=localStorage.key(n);if(!i||!i.startsWith(o))continue;let l=i.slice(o.length).toLowerCase();/^0x[a-f0-9]{40}$/.test(l)&&s.add(l)}s.forEach(n=>{let i=`${o}${n}`,l={yesSharesUsdc:0,noSharesUsdc:0};try{l=JSON.parse(localStorage.getItem(i)||"{}")}catch{}let p=(Number(l.yesSharesUsdc)||0)>0,g=(Number(l.noSharesUsdc)||0)>0;if(!p&&!g)return;let f=`siftle_traded_sides_${e.id}_${n}`,c=[];try{c=JSON.parse(localStorage.getItem(f)||"[]")}catch{}let m=c.includes("yes")&&c.includes("no"),d=a==="yes"?p:g,u=`siftle_resolved_results_${n}`,b={};try{b=JSON.parse(localStorage.getItem(u)||"{}")}catch{}b[e.id]={result:d?"win":"loss",points:d?m?50:100:0},localStorage.setItem(u,JSON.stringify(b));let x=0,w=0,$=0;Object.values(b).forEach(S=>{S.result==="win"?(w+=1,x+=Number(S.points)||0):S.result==="loss"&&($+=1)});let y=localStorage.getItem(dt(n))||"";fetch(I("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:n,username:y,points:x,status:`${w} win${w===1?"":"s"}, ${$} loss${$===1?"":"es"}`})}).catch(S=>console.error("Failed to report local resolved score:",S))})},le=async e=>{if(!t.walletAddress)return!1;let a=e&&t.hasLoadedPortfolioPositions?ut():null,r=await fetch(I("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:t.walletAddress,username:t.profileUsername||"",...a?{points:a.points,status:a.status}:{}})}),o=await r.json().catch(()=>({}));if(!r.ok||o?.success===!1)throw new Error(o?.error||"Failed to save leaderboard profile");if(o?.supabaseConfigured&&o?.supabaseSaved===!1)throw new Error(o?.supabaseError||"Supabase did not save profile");return!0},lr=()=>{let e=new Set;for(let a=0;a<localStorage.length;a++){let r=localStorage.key(a);if(r&&r.startsWith("siftle_mock_pos_")){let o=r.slice(r.lastIndexOf("_")+1).toLowerCase();try{let s=JSON.parse(localStorage.getItem(r)||"{}");((Number(s.yesSharesUsdc)||0)>0||(Number(s.noSharesUsdc)||0)>0)&&/^0x[a-f0-9]{40}$/.test(o)&&e.add(o)}catch{}}}e.forEach(a=>{fetch(I("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:a})}).catch(r=>console.error("Failed to report stored local trader:",r))})},dr=async e=>{let a=G(e);if(!(!a||t.marketSnapshots[e.id]||t.loadingMarketSnapshots[e.id]||t.checkedMarketSnapshots[e.id])){if(oe(e)&&!t.walletAddress){let r=e.resolvedOptionId||null,o=Number(e.outcome);t.marketSnapshots[e.id]={yesPriceCents:0,noPriceCents:0,volumeUsdc:Number(e.volumeUsdc)||0,yesSharesUsdc:0,noSharesUsdc:0,outcome:o===1||o===2||o===3?o:r?1:0,optionPools:e.optionPools||Object.fromEntries(ie(e).map(s=>[s.id,0])),resolvedOptionId:r,traderCount:0},t.checkedMarketSnapshots[e.id]=!0;return}t.loadingMarketSnapshots[e.id]=!0;try{if(oe(e)&&t.walletAddress){let{position:r,snapshot:o}=await Bt(a,t.walletAddress);t.marketPositions[e.id]=r,t.marketSnapshots[e.id]=o}else t.marketSnapshots[e.id]=await va(a)}catch(r){console.warn(r)}finally{t.checkedMarketSnapshots[e.id]=!0,t.loadingMarketSnapshots[e.id]=!1,t.activeSurface==="markets"&&h()}}},z=async(e={})=>{if(t.walletAddress&&!(t.loadingPortfolioPositions&&!e.force)){t.hasLoadedPortfolioPositions=!1,t.loadingPortfolioPositions=!0;try{t.portfolioMarketPreviews.length===0&&await _t();let a=Ue(),r=await Promise.all(a.map(async o=>{let s=G(o);if(!s)return[o.id,{yesSharesUsdc:0,noSharesUsdc:0}];try{let{position:n,snapshot:i}=await Bt(s,t.walletAddress);return t.marketSnapshots[o.id]=i,[o.id,n]}catch(n){return console.warn(`Failed to load portfolio market ${o.id}:`,n),[o.id,{yesSharesUsdc:0,noSharesUsdc:0}]}}));t.marketPositions=Object.fromEntries(r),t.portfolioPositionsLoadedAt=Date.now()}catch(a){console.warn(a)}finally{t.loadingPortfolioPositions=!1,t.hasLoadedPortfolioPositions=!0,le(!0).catch(a=>console.error("Failed to report leaderboard entry:",a)),(t.activeSurface==="portfolio"||t.activeSurface==="leaderboard"||t.activeSurface==="markets")&&h()}}},cr=async(e,a)=>{if(!t.walletAddress){v("Session expired or wallet not connected. Please sign in."),je();return}let r=Ue().find(g=>g.id===e);if(!r)return;t.marketTradeSide=a;let o=G(r);if(!o){v("Deploy this Arc market contract before trading"),h();return}if(!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",h(),await z(),t.marketTradeStatus=null),!t.hasLoadedPortfolioPositions){v("Still loading your position. Try again in a moment."),h();return}let s=t.marketSnapshots[r.id];if(Ye(r,s)){t.tradeDrawerOpen=!1,v("This market is resolved and can no longer be traded."),h();return}let n=s?.yesPriceCents??r.probability,i=s?.noPriceCents??100-r.probability,l=t.marketPositions[r.id]||{yesSharesUsdc:0,noSharesUsdc:0};if(!Z(t.marketOrderMode,a,l)){let g=ar(l),f=t.marketOrderMode==="sell"?g?`You can only exit your ${g.toUpperCase()} shares.`:"You do not have shares to exit in this market.":g?`Exit your ${g.toUpperCase()} shares before buying the other side.`:"You cannot buy both sides in the same market.";v(f),t.marketTradeSide=ct(t.marketOrderMode,a,l),h();return}let p=Be(Number(t.marketTradeAmount)||0,t.marketOrderMode,a,l);t.marketTradeAmount=p,C("trade_attempt");try{t.marketTradeStatus="Preparing transaction...",h();let g=await ba(o,t.marketOrderMode,a,p,f=>{t.marketTradeStatus=f,h()},n,i);if(delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],delete t.loadingMarketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await _e(),t.walletAddress&&(t.walletBalance=await X(t.walletAddress)),await z({force:!0}),le(!0).catch(f=>console.error("Failed to report leaderboard entry:",f)),t.walletAddress){let f=`siftle_cost_basis_${r.id}_${t.walletAddress.toLowerCase()}`,c={yesCost:0,noCost:0,yesShares:0,noShares:0};try{let d=localStorage.getItem(f);if(d){let u=JSON.parse(d);c={yesCost:u.yesCost||0,noCost:u.noCost||0,yesShares:u.yesShares||0,noShares:u.noShares||0}}}catch{}let m=p;if(t.marketOrderMode==="buy"){let d=`siftle_traded_sides_${r.id}_${t.walletAddress.toLowerCase()}`,u=[];try{u=JSON.parse(localStorage.getItem(d)||"[]")}catch{}u.includes(a)||(u.push(a),localStorage.setItem(d,JSON.stringify(u))),a==="yes"?(c.yesCost+=m,c.yesShares=(c.yesShares||0)+m/(n/100)):(c.noCost+=m,c.noShares=(c.noShares||0)+m/(i/100))}else{let d=t.marketPositions[r.id];if(d){if(a==="yes"&&d.yesSharesUsdc>0){let u=Math.min(1,m/d.yesSharesUsdc);c.yesCost=Math.max(0,c.yesCost-c.yesCost*u),c.yesShares=Math.max(0,(c.yesShares||0)-(c.yesShares||0)*u)}else if(a==="no"&&d.noSharesUsdc>0){let u=Math.min(1,m/d.noSharesUsdc);c.noCost=Math.max(0,c.noCost-c.noCost*u),c.noShares=Math.max(0,(c.noShares||0)-(c.noShares||0)*u)}}}localStorage.setItem(f,JSON.stringify(c))}v(`Trade confirmed ${g.slice(0,8)}...`),C(t.marketOrderMode==="buy"?"trade_buy_success":"trade_sell_success"),Da(t.marketOrderMode,t.marketTradeAmount,a.toUpperCase(),r.question)}catch(g){C("trade_failed"),or(g)?(Dt(),t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),v("Session expired. Please sign in again.")):v(g instanceof Error?g.message:"Arc trade failed")}finally{t.marketTradeStatus=null,B(),h()}},xt=e=>Qt(e)?`<button class="card-source-button thread-button" type="button" data-thread-story-id="${e.id}">Thread (${e.thread?.count})</button>`:"",$t=e=>Qt(e)?`<button class="mobile-action-btn thread-btn" type="button" data-thread-story-id="${e.id}">Thread</button>`:"",Tt=()=>'<svg class="action-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 4.75h10a1.75 1.75 0 0 1 1.75 1.75v14.25L12 16.35l-6.75 4.4V6.5A1.75 1.75 0 0 1 7 4.75Z"/></svg>',At=()=>'<svg class="action-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 15V4.75"/><path d="m7.25 9.5 4.75-4.75 4.75 4.75"/><path d="M5 13.25v4.5A2.25 2.25 0 0 0 7.25 20h9.5A2.25 2.25 0 0 0 19 17.75v-4.5"/></svg>',be=e=>`<span class="skeleton-aria-label" role="status" aria-live="polite">${e}</span>`,ur=()=>`
...
`,pr=(e=4)=>`${be("Loading stories")}${Array.from({length:e},ur).join("")}`,he=()=>`
...
`,ve=()=>{if(!k)return;let e=Na();if(k.hidden=!!(t.selectedStoryId||t.selectedThreadUrl),t.isLoading){k.innerHTML=pr(4);return}let a=Number(t.unlockConfig?.amountUsdc)||.001,r=M(t.newsSearchQuery.trim()),s=`
  ...
  `;if(e.length===0){let n=t.showSaved?[]:t.stories;if(n.length>0){k.innerHTML=s+n.map(i=>`
        <article class="story-card" data-story-id="${i.id}" role="button" tabindex="0" aria-label="Open summary for ${i.headline}">
          ...
          <div class="story-copy desktop-only">
            <span class="category-chip ${i.category}">${j(i.category)}</span>
            <h2>${i.headline}</h2>
          ...
          <div class="mobile-card-inner mobile-only">
            <div class="mobile-card-body">
              <div class="mobile-card-text">
                ...
                <h2>${i.headline}</h2>
                <span class="mobile-card-time">${xe(i)}</span>
              </div>
      ...
      `).join("");return}k.innerHTML=s+'<div class="portfolio-empty compact news-search-empty">No stories match that keyword yet.</div>';return}k.innerHTML=s+e.map(n=>`
        <article class="story-card" data-story-id="${n.id}" role="button" tabindex="0" aria-label="Open summary for ${n.headline}">
          ...
          <div class="story-topline desktop-only">
            <div class="story-source">
              <div>
                ...
                <span>${xe(n)} - ${n.readTime}</span>
              </div>
            </div>
            <div class="story-card-actions">
              <button class="bookmark-button" type="button" data-bookmark-url="${n.sourceUrl}" aria-pressed="${n.saved?"true":"false"}" aria-label="${n.saved?"Remove saved story":"Save story"}">
                ${Tt()}
              </button>
              <div class="share-control">
                <button class="export-button" type="button" aria-label="Export story card" data-export-id="${n.id}" aria-expanded="${t.activeShareStoryId===n.id}">
                  ${At()}
                </button>
                <div class="share-menu" ${t.activeShareStoryId===n.id?"":"hidden"}>
                  <button type="button" data-export-action="save" data-export-story-id="${n.id}">Save image</button>
                  <button type="button" data-export-action="share" data-export-story-id="${n.id}">Share</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="story-copy desktop-only">
            <span class="category-chip ${n.category}">${j(n.category)}</span>
            <h2>${n.headline}</h2>
            <p>Tap to read the AI briefing.</p>
          </div>
          ...
          <div class="card-action-row desktop-only">
            ${xt(n)}
            <button class="card-source-button summary-btn" type="button">AI briefing</button>
            ${/example\\.com/i.test(n.sourceUrl)?`<a class="card-source-button disabled" href="#" onclick="event.preventDefault(); alert('No original source available for this mock story.');" aria-disabled="true">Open source</a>`:`<a class="card-source-button" href="${n.sourceUrl}" target="_blank" rel="noreferrer">Open source</a>`}
          </div>
          ...
          <div class="mobile-card-inner mobile-only">
            <div class="mobile-card-body">
              <div class="mobile-card-text">
                <div class="mobile-card-topline">
                  <span class="category-chip ${n.category}">${j(n.category)}</span>
                  <div class="mobile-icons">
                    <button class="mobile-bookmark-btn" type="button" data-bookmark-url="${n.sourceUrl}" aria-pressed="${n.saved?"true":"false"}" aria-label="Save story">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg>
                    </button>
                    <button class="mobile-export-icon" type="button" data-export-action="save" data-export-story-id="${n.id}" aria-label="Save image">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 5 17 10"/><line x1="12" y1="5" x2="12" y2="19"/></svg>
                    </button>
                  </div>
                </div>
                <h2>${n.headline}</h2>
                <span class="mobile-card-time">${xe(n)}</span>
              </div>
              <div class="mobile-card-image" aria-hidden="true">
                <img src="${n.imageUrl}" alt="" loading="lazy" />
              </div>
            ...
            <div class="mobile-card-actions">
              ${$t(n)}
              ${/example\\.com/i.test(n.sourceUrl)?`<a class="mobile-action-btn source-btn disabled" href="#" onclick="event.preventDefault(); event.stopPropagation(); alert('No original source available for this mock story.');" aria-disabled="true">Open source</a>`:`<a class="mobile-action-btn source-btn" href="${n.sourceUrl}" target="_blank" rel="noreferrer" onclick="event.stopPropagation()">Open source</a>`}
              <button class="mobile-action-btn summary-btn" type="button">AI briefing</button>
            </div>
          </div>

        </article>
      `).join("")},Mt=e=>new Promise((a,r)=>{let o=new Image;o.crossOrigin="anonymous",o.onload=()=>a(o),o.onerror=()=>r(new Error(`Unable to load image: ${e}`)),o.src=e}),$e=(e,a,r,o,s,n)=>{e.beginPath(),e.moveTo(a+n,r),e.lineTo(a+o-n,r),e.quadraticCurveTo(a+o,r,a+o,r+n),e.lineTo(a+o,r+s-n),e.quadraticCurveTo(a+o,r+s,a+o-n,r+s),e.lineTo(a+n,r+s),e.quadraticCurveTo(a,r+s,a,r+s-n),e.lineTo(a,r+n),e.quadraticCurveTo(a,r,a+n,r),e.closePath()},hr=(e,a,r,o,s,n,i)=>{let l=a.split(/\s+/).filter(Boolean),p=[],g="";for(let f of l){let c=g?`${g} ${f}`:f;if(e.measureText(c).width<=s){g=c;continue}if(g&&p.push(g),g=f,p.length===i)break}if(g&&p.length<i&&p.push(g),l.length>0&&p.length===i){for(;e.measureText(`${p[i-1]}...`).width>s&&p[i-1].length>0;)p[i-1]=p[i-1].slice(0,-1).trim();p[i-1]=`${p[i-1]}...`}return p.forEach((f,c)=>e.fillText(f,r,o+c*n)),o+p.length*n},vr=(e,a,r,o,s,n,i)=>{let l=Math.max(s/a.naturalWidth,n/a.naturalHeight),p=s/l,g=n/l,f=(a.naturalWidth-p)/2,c=(a.naturalHeight-g)/2;e.save(),$e(e,r,o,s,n,i),e.clip(),e.drawImage(a,f,c,p,g,r,o,s,n),e.restore()},Lt=e=>new Promise((a,r)=>{try{e.toBlob(o=>{o?a(o):r(new Error("Unable to export image"))},"image/png")}catch(o){r(o)}}),Ut=e=>e?e.replace(/&quot;/g,'"').replace(/&apos;/g,"'").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&nbsp;/g," ").replace(/&#39;/g,"'").replace(/&#34;/g,'"').replace(/&#38;/g,"&").replace(/&#60;/g,"<").replace(/&#62;/g,">").replace(/&#8216;/g,"'").replace(/&#8217;/g,"'").replace(/&#8220;/g,'"').replace(/&#8221;/g,'"').replace(/&#8211;/g,"\u2013").replace(/&#8212;/g,"\u2014").replace(/&#8230;/g,"...").replace(/&#(\d+);/g,(a,r)=>String.fromCharCode(Number(r))):"",br=e=>e?e.startsWith("data:")||e.startsWith("./")||e.startsWith("/")||e.includes(window.location.host)?e:`${(window.SIFTLE_API_BASE||"").replace(/\/$/,"")}/api/proxy-image?url=${encodeURIComponent(e)}`:"",Pt=async(e,a=!0)=>{let r=document.createElement("canvas");r.width=1080,r.height=1120;let o=r.getContext("2d");if(!o)throw new Error("Canvas is not available");o.fillStyle="#f4f7fb",o.fillRect(0,0,r.width,r.height),o.shadowColor="rgba(23, 34, 72, 0.16)",o.shadowBlur=44,o.shadowOffsetY=18,o.fillStyle="#ffffff",$e(o,70,70,940,980,34),o.fill(),o.shadowColor="transparent";let s=await Mt("./assets/siftle-logo-small.png").catch(()=>null);s&&o.drawImage(s,784,106,54,54),o.fillStyle="#071229",o.font="800 34px Inter, Arial, sans-serif",o.textAlign="left",o.fillText("Siftle",850,143),o.fillStyle="#6b748c",o.font="700 24px Inter, Arial, sans-serif",o.fillText(`${Ut(e.source)} - ${e.postedAt} ago`,110,140);let n=195;if(a){let l=await Mt(br(e.imageUrl)).catch(()=>null);l?vr(o,l,110,n,860,520,28):(o.fillStyle="#eef2ff",$e(o,110,n,860,520,28),o.fill())}else o.fillStyle="#eef2ff",$e(o,110,n,860,520,28),o.fill();let i=775;return o.fillStyle=e.category==="Sports"?"#dffaf4":e.category==="Tech"?"#e8eef6":e.category==="Anime"?"#efe7ff":e.category==="Gaming"?"#ffebd9":"#eee7ff",$e(o,110,i,118,42,21),o.fill(),o.fillStyle=e.category==="Sports"?"#11a98d":e.category==="Tech"?"#3f5f86":e.category==="Gaming"?"#d95c14":"#6f3cff",o.font="800 22px Inter, Arial, sans-serif",o.fillText(j(e.category),132,i+28),o.fillStyle="#07142f",o.font="680 44px Space Grotesk, Inter, Arial, sans-serif",hr(o,Ut(e.headline),110,888,860,54,4),r},la=async e=>{let a=await Pt(e,!0);try{return await Lt(a)}catch{return Lt(await Pt(e,!1))}},da=e=>`siftle-${e.headline.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"").slice(0,48)||"story"}.png`,ca=async e=>{let a=await la(e),r=URL.createObjectURL(a),o=document.createElement("a");o.href=r,o.download=da(e),o.click(),URL.revokeObjectURL(r)},yr=async e=>{let a=await la(e),r=new File([a],da(e),{type:"image/png"}),o={title:e.headline,text:`Siftle: ${e.headline}`,files:[r]};if(navigator.canShare?.(o)&&navigator.share){await navigator.share(o);return}await ca(e)},kr=async(e,a)=>{let r=t.stories.find(o=>o.id===e);if(r){t.activeShareStoryId=null,ve(),v(a==="share"?"Preparing share image":"Preparing download"),A&&(A.textContent=a==="share"?"Preparing share image...":"Preparing image download...");try{a==="share"?await yr(r):await ca(r),v(a==="share"?"Share image ready":"Image saved"),A&&(A.textContent="Branded story image ready")}catch(o){console.warn(o),v("Image export unavailable"),A&&(A.textContent="Image export was cancelled or unavailable")}}},Ct=(e,a)=>{let r=t.unlockingSummaryUrl===e.sourceUrl,o=it(e);return`
...
`},wr=async(e,a)=>{if(!t.walletAddress){v("Session expired or wallet not connected. Please sign in."),je();return}let r=Ue().find(g=>g.id===e);if(!r||!oe(r))return;let o=ie(r).find(g=>g.id===a);if(!o){v("Choose a valid option.");return}!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",h(),await z(),t.marketTradeStatus=null);let s=t.marketSnapshots[r.id];if(Ye(r,s)){v("This market is resolved and can no longer be traded.");return}let n=t.marketPositions[r.id],i=t.marketOrderMode==="sell";if(!i&&n?.optionId){v("Your pick is already locked for this market.");return}if(i&&!n?.optionId){v("You do not have a pick to exit.");return}let l=Math.max(0,Number(n?.optionSharesUsdc)||0);if(i&&l<=0){v("Your pick is still loading. Please try again."),await z({force:!0});return}let p=i?l:Be(Number(t.marketTradeAmount)||0,"buy","yes",void 0);t.marketTradeAmount=p,t.marketTradeOptionId=i&&n?.optionId||o.id,C("trade_attempt");try{t.marketTradeStatus=i?"Exiting your pick...":"Locking your pick...",h(),await ya(r.id,i?"sell":"buy",i&&n?.optionId||o.id,p,g=>{t.marketTradeStatus=g,h()}),delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await _e(),t.walletAddress&&(t.walletBalance=await X(t.walletAddress)),await z({force:!0}),C(i?"trade_sell_success":"trade_buy_success"),v(i?"Pick exited":`Pick locked: ${o.label}`),t.tradeDrawerOpen=!1}catch(g){C("trade_failed"),v(g instanceof Error?g.message:"Trade failed")}finally{t.marketTradeStatus=null,B(),h()}},Sr=()=>{if(!T||!k)return;let e=t.stories.find(o=>o.sourceUrl===t.selectedThreadUrl);if(k.hidden=!0,T.hidden=!1,T.classList.add("fullscreen"),document.body.classList.add("detail-mode"),!e){T.innerHTML="";return}let a=t.loadingThreadUrl===e.sourceUrl,r=t.activeThread;if(a&&!r){T.innerHTML=`
  ...
  `},xr=()=>{if(!T||!k)return;if(t.selectedThreadUrl){Sr();return}let e=t.stories.find(i=>i.id===t.selectedStoryId);if(!e){T.hidden=!0,T.classList.remove("fullscreen"),document.body.classList.remove("detail-mode"),k.hidden=!1;return}let a=ae(e,t.aiSummaries[e.sourceUrl]),r=t.loadingSummaryUrl===e.sourceUrl,o=re(e),s=t.unlockingSummaryUrl===e.sourceUrl,n=it(e);k.hidden=!0,T.hidden=!1,T.classList.add("fullscreen"),document.body.classList.add("detail-mode"),T.innerHTML=`
    <div class="detail-container">
      ...
      <article class="detail-card">
        <div class="detail-topline">
          <span class="category-chip ${e.category}">${j(e.category)}</span>
          <span>${e.source} - ${xe(e)} - ${e.readTime}</span>
        </div>
        <h2>${e.headline}</h2>
        ...
        <section class="detail-summary ${e.category}">
          ...
          ${o?Ie(e):""}
          ${o?r?he():n?lt(e):ot(a,e):Fa(e,s)}
        </section>
        <a class="source-button" href="${e.sourceUrl}" target="_blank" rel="noreferrer">Open source</a>
      </article>
    </div>
  `},$r=e=>{let a=t.marketSnapshots[e.id],r=G(e),o=oe(e),s=ie(e).length,n=a?.volumeUsdc??(Number(e.volumeUsdc)||0),i=a?.yesPriceCents,l=i??e.probability,p=o?`${s}`:`${l}%`,g=i===void 0?r?"Loading Arc pools":"Arc setup required":`Yes ${i}\xA2 \xB7 No ${100-i}\xA2`,f=i===void 0?`Yes ${e.probability}c - No ${100-e.probability}c`:g,c=We(e),m=e.timeframe==="Daily"?Wt(e,a):e.closes;return`
    <button class="market-card" type="button" data-market-id="${e.id}">
      ...
      <div class="market-card-footer">
        <span>${c.evidence.length} related news</span>
        <span>${e.timeframe==="Daily"?`Locks ${m}`:`Closes ${m}`}</span>
      </div>
    </button>
  `},Tr=e=>{let a=We(e),o=t.marketSnapshots[e.id]?.yesPriceCents??e.probability,s=100-o,n=a.evidence[0],i=n?n.headline:"No updates yet",l=`${window.location.origin}${window.location.pathname}#market-${e.id}`;return`\u{1F6A8} *Siftle Market Alert* \u{1F6A8}
...
Trade and discuss here: ${l}`},Ar=e=>{if(!k||!T)return;let a=We(e),r=!t.checkedMarketEvidence[e.id],o=G(e),s=t.marketSnapshots[e.id],n=oe(e),i=ie(e);n&&!t.marketTradeOptionId&&(t.marketTradeOptionId=i[0]?.id||null);let l=Xa(e),p=!!(o&&!s),g=s?.yesPriceCents??(o?e.probability:0),f=s?.noPriceCents??(o?100-e.probability:0),c=p?"":o?`${g}\xA2`:"--",m=p?"":o?`${f}\xA2`:"--",d=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},u=!!d.optionId;n&&u&&t.marketOrderMode!=="sell"&&(t.marketOrderMode="sell"),n&&!u&&t.marketOrderMode==="sell"&&(t.marketOrderMode="buy");let b=n&&t.marketOrderMode==="sell"&&u?Math.max(0,Number(d.optionSharesUsdc)||0):0,x=b>0?b:Be(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,d),w=b>0?{min:0,max:b}:ta(t.marketOrderMode,t.marketTradeSide,d),$=t.marketOrderMode==="buy"?"$5-$10 USDC":`Up to $${N(w.max)} USDC`,y=!t.walletAddress||t.hasLoadedPortfolioPositions,S=Ye(e,s),U=Yt(e,s),P=!!U;n||(t.marketTradeSide=ct(t.marketOrderMode,t.marketTradeSide,d));let O=!n&&!S&&!P&&y&&Z(t.marketOrderMode,"yes",d),R=!n&&!S&&!P&&y&&Z(t.marketOrderMode,"no",d),de=n?!S&&!P&&y&&(t.marketOrderMode==="sell"?u:!u&&!!l):!S&&!P&&y&&Z(t.marketOrderMode,t.marketTradeSide,d),_=S?"Market resolved":U||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),ce=S?"Market resolved":U||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),ue=n?x:aa(s,t.marketTradeSide,x,t.marketOrderMode,d),pe=t.marketOrderMode==="buy"?"Buy":"Exit",K=n?"Pick one outcome":o?"Arc testnet live":"Contract not deployed";k.hidden=!0,T.hidden=!1,T.classList.add("fullscreen"),document.body.classList.add("detail-mode"),dr(e),Xt(e),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&z({force:!t.hasLoadedPortfolioPositions});let De=n?!!d.optionId:d.yesSharesUsdc>0||d.noSharesUsdc>0,ye="";if(n&&De&&t.walletAddress){let L=ia(d,s);ye=`
      <div class="user-market-position-box" style="margin: 16px 0; padding: 16px; background: rgba(59, 130, 246, 0.05); border: 1px solid rgba(59, 130, 246, 0.15); border-radius: 12px; font-family: 'Space Grotesk', sans-serif;">
        ...
        <div style="display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 1fr); gap: 12px;">
          <div>
            ...
            <strong style="font-size: 0.95rem; color: var(--market-text-main);">${M(d.optionLabel||"Selected option")}</strong>
          </div>
          <div>
    ...
    <div class="detail-container market-detail-container">
        ...
        <div class="market-detail-main">
          ...
          <section class="market-evidence-thread">
            ...
            <div class="market-thread-timeline">
              ${r?fr(3):a.evidence.length===0?'<div class="portfolio-empty compact">Related news is still loading for this market.</div>':a.evidence.map(L=>{let D=Ft(e,L),ke=t.unlockingSummaryUrl===L.sourceUrl;return`
      ...
      <div class="sticky-trade-bar">
        <div class="sticky-trade-info">
          ${n?`<span>${u?"Pick locked":"Choose one option"}</span><span><strong>${i.length} options</strong></span>`:`<span>Yes <strong>${c}</strong></span><span>No <strong>${m}</strong></span>`}
        </div>
        <button class="sticky-trade-btn" type="button" id="openTradeDrawerBtn" ${S||P?"disabled":""}>
          ${S?"Market Resolved":U||(n?u?"Pick Locked":"Pick Outcome":"Trade Market")}
        </button>
      </div>
      ...
      <div class="trade-drawer ${t.tradeDrawerOpen?"open":""}" id="tradeDrawer">
        ...
        <div class="trade-drawer-body">
          ...
          <div class="market-action-grid">
            ${n?i.map(L=>{let D=s?.optionPools?.[L.id]||0,ke=t.marketTradeOptionId===L.id||d.optionId===L.id,mt=S||P||t.marketOrderMode==="sell"||u||!y;return`
                  <button type="button" class="market-side option ${ke?"active":""} ${mt?"disabled":""}" data-market-option-id="${M(L.id)}" ${mt?"disabled":""}>
                    <span>${M(L.label)}</span>
                    <strong>$${N(D)}</strong>
                    ${d.optionId===L.id?"<small>Your pick</small>":""}
                  </button>
                `}).join(""):p?`
  ...
  `},ua=()=>{if(!k||!T)return;if(Re?.toggleAttribute("hidden",!0),qe?.toggleAttribute("hidden",!0),te?.toggleAttribute("hidden",!0),Pe?.classList.add("active"),Ce?.classList.remove("active"),Ee?.classList.remove("active"),window.setTimeout(()=>{t.activeSurface==="markets"&&E.forEach(n=>{Xt(n)})},750),t.selectedMarketId){let n=E.find(i=>i.id===t.selectedMarketId);if(n){Ar(n);return}t.selectedMarketId=null,window.location.hash.startsWith("#market-")&&window.history.replaceState({},"","#markets");return}document.body.classList.remove("detail-mode"),T.hidden=!0,T.classList.remove("fullscreen"),k.hidden=!1,k.classList.add("markets-list");let e=E,r=`
    <nav class="market-timeframe-tabs" aria-label="Timeframe navigation">
      ${["All","Daily","Weekly","Sagas"].map(n=>{let i=t.activeMarketTimeframe===n,l=n==="All"?e.length:e.filter(g=>g.timeframe===n).length;return`
  ...
  `},pa=()=>{if(!k||!T)return;Re?.toggleAttribute("hidden",!0),qe?.toggleAttribute("hidden",!0),te?.toggleAttribute("hidden",!0),Pe?.classList.remove("active"),Ce?.classList.remove("active"),Ee?.classList.remove("active"),document.body.classList.remove("detail-mode"),T.hidden=!0,k.hidden=!1,k.classList.add("markets-list");let e=t.walletAddress&&t.hasLoadedPortfolioPositions?ut():null;t.walletAddress&&e&&fetch(I("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:t.walletAddress,points:e.points,status:e.status,username:t.profileUsername||""})}).catch(d=>console.error("Failed to report user score:",d)),J&&(clearInterval(J),J=null),k.innerHTML=`
  ...
  `;let a=(d="2026-07-19T23:59:59.000Z")=>{let u=document.getElementById("seasonTimer");J&&clearInterval(J);let b=()=>{let w=new Date(d).getTime()-new Date().getTime();if(w<=0){u&&(u.innerText="Season Finished!"),J&&clearInterval(J);return}let $=Math.floor(w/(1e3*60*60*24)),y=Math.floor(w%(1e3*60*60*24)/(1e3*60*60)),S=Math.floor(w%(1e3*60*60)/(1e3*60)),U=Math.floor(w%(1e3*60)/1e3);u&&(u.innerText=`${$}d ${y}h ${S}m ${U}s`)};b(),J=setInterval(b,1e3)};a();let r=d=>d.map((u,b)=>{let x=Number(u.globalRank)||b+1,w=String(u.username||""),$=!!(t.walletAddress&&w.toLowerCase()===t.walletAddress.toLowerCase()),y=$&&t.profileUsername?t.profileUsername:u.displayName||w,S=$?`${t.profileUsername?y:q(w)} (You)`:y.startsWith("0x")&&y.length===42?q(y):y,U=M(S),P=M(Qe(u.status)),O=u.nextSeasonDivision?`Division ${u.nextSeasonDivision}`:"Qualify",R=x<=10?"promotion-zone":"safety-zone",de=x<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
    ...
    `}).join(""),o=d=>d.map((u,b)=>{let x=b+1,w=String(u.username||""),$=!!(t.walletAddress&&w.toLowerCase()===t.walletAddress.toLowerCase()),y=$&&t.profileUsername?t.profileUsername:u.displayName||w,S=M(Qe(u.status)),U=$?`${t.profileUsername?y:q(w)} (You)`:y.startsWith("0x")&&y.length===42?q(y):y,P=M(U),O="safety-zone",R='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return x<=2?(O="promotion-zone",R='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):x>=5&&(O="relegation-zone",R='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
      <div class="leaderboard-row ${$?"user-highlight":""} ${O}" role="listitem" style="display: flex !important; align-items: center !important; justify-content: space-between !important; padding: 12px 16px !important; border-bottom: 1px solid rgba(255, 255, 255, 0.06) !important; margin-bottom: 0 !important; background: transparent !important; font-family: 'Space Grotesk', sans-serif !important;">
        ...
        <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
          <span style="color: #ffffff; font-weight: 750; font-size: 0.95rem; white-space: nowrap;">${Number(u.points)||0} pts</span>
        </div>
    ...
    `)},i=()=>{s("global");let d=document.getElementById("leaderboardListContainer"),u="global",b=kt(u);b&&d?(d.innerHTML=St()+r(b.players),b.seasonEndsAt&&a(b.seasonEndsAt)):n(10);let x=new URLSearchParams;t.walletAddress&&x.set("walletAddress",t.walletAddress);let w=x.toString();fetch(I(`/api/leaderboard/global${w?`?${w}`:""}`)).then($=>$.json()).then($=>{let y=wt($.players||[],b?.players||[],!0);d&&(d.innerHTML=y.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players on the global leaderboard yet.</p>`:r(y)),Ze(u,{players:y,seasonEndsAt:$.seasonEndsAt}),a($.seasonEndsAt)}).catch($=>{console.error("Failed to load global leaderboard:",$),d&&(d.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading global leaderboard. Please try again.</p>`)})},l=d=>{s("division");let u=document.getElementById("leaderboardListContainer"),b=`division_${d||we||"current"}`,x=kt(b);x&&u?(u.innerHTML=St()+o(x.players),x.divisionNumber&&(we=x.divisionNumber),x.seasonEndsAt&&a(x.seasonEndsAt)):u&&d!==void 0&&(u.innerHTML=`
        <div class="leaderboard-skeleton" style="display: flex; flex-direction: column; gap: 12px; width: 100%;">
          ${Array.from({length:6}).map(()=>`
            <div style="height: 52px; background: rgba(255,255,255,0.02); border: 1px solid #1e1f2b; border-radius: 8px; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 0 16px;">
              <div style="display: flex; align-items: center; gap: 12px; width: 60%;">
      ...
      `);let w=new URLSearchParams;t.walletAddress&&w.set("walletAddress",t.walletAddress),d&&w.set("division",String(d));let $=w.toString();fetch(I(`/api/leaderboard/division${$?`?${$}`:""}`)).then(y=>y.json()).then(y=>{let S=y.divisionNumber||1,U=wt(y.players||[],x?.players||[],!1),P=y.totalDivisions||1,O=y.seasonEndsAt;we=S;let R=document.getElementById("divisionTitleText");R&&(R.innerText=`Division ${S}`);let de=document.getElementById("divisionSelector");de&&(de.innerHTML=Array.from({length:P},(_,ce)=>ce+1).map(_=>`
            <option value="${_}" ${_===S?"selected":""}>Division ${_}</option>
          `).join("")),u&&(U.length===0?u.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No active players in this division.</p>`:u.innerHTML=U.map((_,ce)=>{let ue=ce+1,pe=t.walletAddress&&_.username.toLowerCase()===t.walletAddress.toLowerCase(),K=pe&&t.profileUsername?t.profileUsername:_.displayName||_.username,pt=M(Qe(_.status)),De=pe?`${t.profileUsername?K:q(_.username)} (You)`:K.startsWith("0x")&&K.length===42?q(K):K,ye=M(De),L="safety-zone",D='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return ue<=2?(L="promotion-zone",D='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):ue>=5&&(L="relegation-zone",D='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
                <div class="leaderboard-row ${pe?"user-highlight":""} ${L}" role="listitem" style="display: flex !important; align-items: center !important; justify-content: space-between !important; padding: 12px 16px !important; border-bottom: 1px solid rgba(255, 255, 255, 0.06) !important; margin-bottom: 0 !important; background: transparent !important; font-family: 'Space Grotesk', sans-serif !important;">
                  <!-- Left Side: Arrow + Rank + Username -->
                  <div style="flex: 1.5; display: flex; align-items: center; gap: 8px; min-width: 0;">
                    ${D}
                    <span class="leaderboard-rank rank-${ue}" style="flex-shrink: 0; margin-right: 4px;">${ue}</span>
              ...
              `}).join("")),Ze(b,{players:U,divisionNumber:S,totalDivisions:P,seasonEndsAt:O}),Ze(`division_${S}`,{players:U,divisionNumber:S,totalDivisions:P,seasonEndsAt:O}),a(O)}).catch(y=>{console.error("Failed to load division leaderboard:",y),u&&(u.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading division leaderboard. Please try again.</p>`)})};V==="division"?l(we||void 0):i(),document.querySelectorAll("[data-leaderboard-view]").forEach(d=>{d.addEventListener("click",()=>{(d.dataset.leaderboardView==="division"?"division":"global")==="division"?l(we||void 0):i()})}),document.getElementById("divisionSelector")?.addEventListener("change",d=>{let u=Number(d.target.value);l(u)}),document.getElementById("faucetClaimButton")?.addEventListener("click",async()=>{if(!t.walletAddress){v("Please sign in first!");return}if(localStorage.getItem("siftle_circle_is_mock")==="true"){let u=parseFloat(localStorage.getItem(`siftle_mock_balance_${t.walletAddress}`)||"1000.00")+100;localStorage.setItem(`siftle_mock_balance_${t.walletAddress}`,u.toFixed(2)),t.walletBalance=u.toFixed(2),v("Claimed $100 USDC mock credits!"),B(),pa()}else v("Opening Circle Faucet..."),window.open(Xe,"_blank")});let f=document.getElementById("howItWorksBtn"),c=document.getElementById("howItWorksModal"),m=document.getElementById("closeRulesModalBtn");f?.addEventListener("click",()=>{c&&c.classList.add("active")}),m?.addEventListener("click",()=>{c&&c.classList.remove("active")}),c?.addEventListener("click",d=>{d.target===c&&c.classList.remove("active")})},ma=()=>{t.activeSurface="feed",t.selectedMarketId=null,Re?.toggleAttribute("hidden",!0),qe?.toggleAttribute("hidden",!0),te?.toggleAttribute("hidden",!0),Pe?.classList.remove("active"),Ce?.classList.add("active"),Ee?.classList.remove("active"),k?.classList.remove("markets-list")},Mr=e=>e===1?"Yes resolved":e===2?"No resolved":e===3?"Invalid":"Open",Et=e=>{let a=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},r=t.marketSnapshots[e.id];if(oe(e)){let u=r?.resolvedOptionId||null,b=!!u,x=b&&a.optionId===u,w=ia(a,r),$=x?w:0,y=ie(e).find(P=>P.id===u)?.label,S=!!a.claimedAt||He().has(e.id),U=!!t.claimingMarketIds[e.id];return`
      <article class="portfolio-position-card">
        ...
        <div class="portfolio-position-stats">
          ...
          <div><span>Projected payout</span><strong>$${N($)}</strong></div>
        </div>
        <div class="portfolio-position-footer">
          <span>${b?"":`Closes ${e.closes}`}</span>
          ${b?S?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':U?'<button type="button" class="connect-wallet-btn" disabled style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; opacity: 0.7 !important; cursor: wait !important;">Claiming...</button>':x?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${N($)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>':""}
        </div>
      </article>
    `}let o=Mr(r?.outcome),s=ra(a,r),n=s.reduce((u,b)=>Math.max(u,b.payout),0),i=a.yesSharesUsdc+a.noSharesUsdc,l=r?.outcome??0,p=He().has(e.id),g=l===1?a.yesSharesUsdc:l===2?a.noSharesUsdc:0,f=l===1?r?.yesSharesUsdc??0:l===2?r?.noSharesUsdc??0:0,c=r?.volumeUsdc??0,m=g>0&&f>0?g/f*c:0,d=l===0?"":p?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':m>0?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${N(m)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>';return`
    <article class="portfolio-position-card">
      <div class="portfolio-position-top">
        <span class="category-chip ${e.category}">${j(e.category)}</span>
        <span>${o}</span>
      ...
      <div class="portfolio-position-stats">
        ...
        ${s.map(u=>`
          <div><span>${u.label}</span><strong>${N(u.shares)}</strong></div>
        `).join("")}
      </div>
      <div class="portfolio-position-footer">
  ...
  `},Lr=async e=>{if(!t.walletAddress){v("Please sign in first.");return}let a=Ue().find(o=>o.id===e),r=a?G(a):"";if(!a||!r){v("Market is not available.");return}try{t.claimingMarketIds[a.id]=!0,W(),C("claim_attempt"),ut();let o=await ka(r,t.walletAddress);C("claim_success"),o.won&&rr(a.id),delete t.marketPositions[a.id],delete t.marketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.walletBalance=await X(t.walletAddress),await z(),v(o.won?`Claimed $${N(o.amountUsdc)}`:"No payout to claim"),B(),W()}catch(o){C("claim_failed"),v(o instanceof Error?o.message:"Claim failed")}finally{delete t.claimingMarketIds[a.id],W()}},Ur=e=>{if(!e)return"";let a=t.referralData,r=a?.referrals?.length?a.referrals.map(s=>{let n=s.displayName||q(s.walletAddress),i=s.remaining<=0;return`
  ...
  `},W=()=>{if(!k||!T)return;Re?.toggleAttribute("hidden",!0),qe?.toggleAttribute("hidden",!0),te?.toggleAttribute("hidden",!0),Pe?.classList.remove("active"),Ce?.classList.remove("active"),Ee?.classList.add("active"),document.body.classList.remove("detail-mode"),T.hidden=!0,k.hidden=!1,k.classList.add("markets-list"),t.walletAddress&&!t.referralData&&!t.referralError&&!t.loadingReferralData&&Me(),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&(t.portfolioMarketPreviews.length===0&&_t(),z({force:!t.hasLoadedPortfolioPositions}));let a=He(),r=Ue().filter(c=>{let m=t.marketPositions[c.id];return a.has(c.id)||m&&(m.yesSharesUsdc+m.noSharesUsdc>0||(m.optionSharesUsdc||0)>0)}),o=r.filter(c=>(t.marketSnapshots[c.id]?.outcome??0)===0),s=r.filter(c=>(t.marketSnapshots[c.id]?.outcome??0)!==0),n=!!t.walletAddress,i=t.profileUsername||(t.walletAddress?q(t.walletAddress):"Anonymous"),l=M(i),p=M(t.profileUsername||""),g=t.profileNotice?`<div style="margin-top: 14px !important; padding: 10px 12px !important; border-radius: 8px !important; border: 1px solid ${t.profileNotice.type==="error"?"rgba(239, 68, 68, 0.28)":"rgba(16, 185, 129, 0.24)"} !important; background: ${t.profileNotice.type==="error"?"rgba(127, 29, 29, 0.22)":"rgba(6, 95, 70, 0.18)"} !important; color: ${t.profileNotice.type==="error"?"#fca5a5":"#86efac"} !important; font-size: 0.8rem !important; font-weight: 650 !important;">${M(t.profileNotice.message)}</div>`:"",f=i.charAt(0).toUpperCase();k.innerHTML=`
    <section class="portfolio-surface">
      ...
      ${t.loadingPortfolioPositions?gr(2):t.walletAddress?r.length===0?'<div class="portfolio-empty">No positions found for this wallet yet. Confirmed trades will appear here after the Arc transaction settles.</div>':`
  ...
  `},h=()=>{if(Rt.forEach(e=>{let a=e.dataset.bottomNav;e.classList.toggle("active",a==="saved"?t.showSaved:a===t.activeSurface&&!t.showSaved)}),t.activeSurface==="markets"){ua();return}if(t.activeSurface==="portfolio"){W();return}if(t.activeSurface==="leaderboard"){pa();return}ma(),Vt(),ve(),xr(),F&&(F.value=t.activeArchiveDate??"")};et.textContent=jt();te?.addEventListener("click",e=>{let r=e.target.closest("[data-category]");r&&(t.activeCategory=r.dataset.category,window.history.pushState({},"","#feed"),Y(),h(),Fe(),ne(t.activeCategory))});k?.addEventListener("input",e=>{let a=e.target;if(a.id!=="newsSearchInput")return;let r=a.selectionStart??a.value.length,o=a.selectionEnd??a.value.length;t.newsSearchQuery=a.value,ve();let s=k?.querySelector("#newsSearchInput");s&&(s.focus(),s.setSelectionRange(r,o))});Pe?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,window.history.pushState({},"","#markets"),Y(),h()});Ce?.addEventListener("click",()=>{t.activeSurface="feed",t.showSaved=!1,window.history.pushState({},"","#feed"),Y(),h(),Fe(),ne(t.activeCategory)});Ee?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=!1,window.history.pushState({},"","#portfolio"),Y(),h()});Q?.addEventListener("click",()=>{t.walletAddress?(window.location.hash="#portfolio",se()):je()});document.addEventListener("click",e=>{let a=e.target,r=a.closest(".copy-address-btn");if(r){let i=r.getAttribute("data-address");i&&navigator.clipboard.writeText(i).then(()=>{v("Wallet address copied!")})}let o=a.closest("[data-claim-market]");if(o){let i=o.getAttribute("data-claim-market");i&&Lr(i);return}if(a.closest("[data-open-referrals]")){t.referralPanelOpen=!t.referralPanelOpen,!t.referralData&&!t.loadingReferralData&&Me(),W();return}if(a.closest("[data-close-referrals]")){t.referralPanelOpen=!1,W();return}if(a.closest("[data-refresh-referrals]")){t.referralError=null,Me(),W();return}let s=a.closest("[data-copy-referral-code]");if(s){let i=s.getAttribute("data-copy-referral-code")||"";i&&navigator.clipboard.writeText(i).then(()=>v("Invite code copied"));return}let n=a.closest("[data-copy-referral-link]");if(n){let i=n.getAttribute("data-copy-referral-link")||"";i&&navigator.clipboard.writeText(i).then(()=>v("Invite link copied"));return}a.closest("[data-connect-wallet]")&&(t.walletAddress?Dt():je())});Rt.forEach(e=>{e.addEventListener("click",()=>{let a=e.dataset.bottomNav;t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=a==="saved",a==="markets"?(t.activeSurface="markets",window.history.pushState({},"","#markets")):a==="portfolio"?(t.activeSurface="portfolio",window.history.pushState({},"","#portfolio")):a==="leaderboard"?(t.activeSurface="leaderboard",window.history.pushState({},"","#leaderboard")):(t.activeSurface="feed",window.history.pushState({},"","#feed"),Fe(),ne(t.activeCategory),a==="saved"&&(tr(),rt(),Ae())),Y(),h()})});F?.addEventListener("change",()=>{t.activeArchiveDate=F.value||null,window.history.pushState({},"","#feed"),Y(),h(),ne(t.activeCategory)});Ea?.addEventListener("click",()=>{t.activeArchiveDate=null,F&&(F.value=""),window.history.pushState({},"","#feed"),Y(),h(),ne(t.activeCategory)});k?.addEventListener("click",async e=>{let a=e.target;if(a.closest("#editUsernameBtn")){let m=k?.querySelector(".username-display-row"),d=k?.querySelector("#usernameEditForm");if(m&&d){m.style.display="none",d.style.display="flex";let u=d.querySelector("#usernameInput");u&&u.focus()}return}if(a.closest("#cancelUsernameBtn")){let m=k?.querySelector(".username-display-row"),d=k?.querySelector("#usernameEditForm");m&&d&&(m.style.display="flex",d.style.display="none");return}let s=a.closest("#saveUsernameBtn");if(s){let d=k?.querySelector("#usernameEditForm")?.querySelector("#usernameInput");if(d){let u=d.value.trim().slice(0,15),b=s,x=b.textContent||"Save";b.disabled=!0,b.textContent="Saving...",er(u),t.profileNotice=null;try{t.walletAddress&&await le(!1),t.profileNotice={type:"success",message:"Username saved to your shared leaderboard profile."},v("Username updated"),W()}catch(w){let $=w instanceof Error?w.message:"Username save failed";t.profileNotice={type:"error",message:$},v($),b.disabled=!1,b.textContent=x,W()}}return}let n=a.closest("[data-timeframe]");if(n){let m=n.dataset.timeframe;t.activeMarketTimeframe=m,ua();return}let i=a.closest("[data-market-id]");if(i){t.selectedMarketId=i.dataset.marketId??null,C("market_view"),window.history.pushState({},"",`#market-${t.selectedMarketId}`),h(),window.scrollTo({top:0,behavior:"smooth"});return}let l=a.closest("[data-thread-story-id]"),p=a.closest("[data-export-id]"),g=a.closest("[data-export-action]"),f=a.closest("[data-story-id]");if(l){e.stopPropagation();let m=t.stories.find(d=>d.id===Number(l.dataset.threadStoryId));m&&Wa(m);return}let c=a.closest(".mobile-bookmark-btn, .bookmark-button");if(c){e.stopPropagation();let m=c.dataset.bookmarkUrl||"",d=t.stories.find(u=>u.sourceUrl===m);if(!d)return;d.saved=!d.saved,d.saved?ee.add(m):ee.delete(m),Ca(),v(d.saved?"Saved to your list":"Removed from saved"),ve();return}if(g){e.stopPropagation(),kr(Number(g.dataset.exportStoryId),g.dataset.exportAction);return}if(p){e.stopPropagation();let m=Number(p.dataset.exportId);t.activeShareStoryId=t.activeShareStoryId===m?null:m,ve();return}f&&(a.closest("a")||Gt(Number(f.dataset.storyId),!0))});k?.addEventListener("keydown",e=>{let r=e.target.closest("[data-story-id]");!r||e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),Gt(Number(r.dataset.storyId)))});T?.addEventListener("click",e=>{let a=e.target,r=a.closest("[data-unlock-briefing]");if(r){let f=t.stories.find(c=>c.id===Number(r.dataset.unlockBriefing));f&&tt(f);return}let o=a.closest("[data-unlock-briefing-url]");if(o){let f=decodeURIComponent(o.dataset.unlockBriefingUrl||""),c=za(f);c&&(re(c)?ze(c):tt(c));return}if(a.closest("[data-back-markets]")){t.selectedMarketId=null,t.tradeDrawerOpen=!1,window.history.pushState({},"","#markets"),h();return}if(a.closest("#openTradeDrawerBtn")){let f=E.find(d=>d.id===t.selectedMarketId);if(f){if(Ye(f,t.marketSnapshots[f.id])){v("This market is resolved and can no longer be traded.");return}if(Yt(f,t.marketSnapshots[f.id])){v("Trading is locked 20 minutes before kickoff.");return}}t.tradeDrawerOpen=!0,C("trade_drawer_open");let c=T.querySelector("#tradeDrawer"),m=T.querySelector("#tradeDrawerBackdrop");c?.classList.add("open"),m?.classList.add("open");return}if(a.closest("#closeTradeDrawerBtn")||a.closest("#tradeDrawerBackdrop")){t.tradeDrawerOpen=!1;let f=T.querySelector("#tradeDrawer"),c=T.querySelector("#tradeDrawerBackdrop");f?.classList.remove("open"),c?.classList.remove("open");return}if(a.closest("#shareWhatsAppBtn")){let f=E.find(c=>c.id===t.selectedMarketId);if(f){let c=Tr(f),m=`https://api.whatsapp.com/send?text=${encodeURIComponent(c)}`;window.open(m,"_blank")}return}let s=a.closest("[data-market-trade]");if(s&&t.selectedMarketId){let f=s.dataset.marketTrade;cr(t.selectedMarketId,f);return}let n=a.closest("[data-market-option-trade]");if(n&&t.selectedMarketId){let f=n.dataset.marketOptionTrade||t.marketTradeOptionId||"";wr(t.selectedMarketId,f);return}let i=a.closest("[data-market-option-id]");if(i){if(i.disabled||i.classList.contains("disabled"))return;t.marketTradeOptionId=i.dataset.marketOptionId||null,h();return}let l=a.closest("[data-market-trade-side]");if(l){if(l.disabled||l.classList.contains("disabled"))return;let f=E.find(d=>d.id===t.selectedMarketId),c=f?t.marketPositions[f.id]:void 0,m=l.dataset.marketTradeSide;if(!Z(t.marketOrderMode,m,c))return;t.marketTradeSide=m,h();return}let p=a.closest("[data-market-order-mode]");if(p){t.marketOrderMode=p.dataset.marketOrderMode;let f=E.find(m=>m.id===t.selectedMarketId),c=f?t.marketPositions[f.id]:void 0;t.marketTradeSide=ct(t.marketOrderMode,t.marketTradeSide,c),t.marketTradeAmount=Be(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,c),h();return}a.closest("[data-back-to-feed]")&&Ya()});T?.addEventListener("input",e=>{let a=e.target;if(!a.matches("[data-market-amount]"))return;let r=E.find(p=>p.id===t.selectedMarketId),o=r?t.marketSnapshots[r.id]:void 0,s=r?t.marketPositions[r.id]:void 0,n=Number(a.value);t.marketTradeAmount=Number.isFinite(n)?n:0;let i=r&&oe(r)?t.marketTradeAmount:aa(o,t.marketTradeSide,t.marketTradeAmount,t.marketOrderMode,s),l=T.querySelector(".market-inline-payout strong");l&&(l.textContent=`$${N(i)}`)});T?.addEventListener("focusin",e=>{e.target.matches("[data-market-amount]")&&document.body.classList.add("market-amount-focused")});T?.addEventListener("focusout",e=>{let a=e.target;if(a.matches("[data-market-amount]")){let r=E.find(s=>s.id===t.selectedMarketId),o=r?t.marketPositions[r.id]:void 0;t.marketTradeAmount=Be(Number(a.value)||0,t.marketOrderMode,t.marketTradeSide,o),a.value=String(t.marketTradeAmount),window.setTimeout(()=>document.body.classList.remove("market-amount-focused"),120)}});window.addEventListener("popstate",se);window.addEventListener("hashchange",se);window.addEventListener("focus",async()=>{if(t.walletAddress){let e=t.walletBalance,a=await X(t.walletAddress);t.walletBalance=a,B(),(!e||parseFloat(e)===0)&&parseFloat(a)>0&&(console.log("[X402] Balance changed from 0 to positive. Triggering Gateway warmup..."),xa())}});Je?.addEventListener("click",()=>{if(!Ke||!Je)return;let e=!Ke.hidden;Ke.hidden=e,Je.setAttribute("aria-expanded",String(!e))});document.addEventListener("click",e=>{let a=e.target;!a.closest(".share-control")&&t.activeShareStoryId!==null&&(t.activeShareStoryId=null,ve());let r=a.closest("[data-menu-action]");if(!r)return;let o={today:"Showing today's brief",saved:`${t.stories.filter(s=>s.saved).length} saved stories`,archive:t.archiveDates.length>0?"Choose a saved day from the archive selector":"No saved days yet"};A&&(A.textContent=o[r.dataset.menuAction??"today"]),r.dataset.menuAction==="today"&&(t.showSaved=!1,t.activeArchiveDate=null,F&&(F.value=""),Y(),Fe(),ne(t.activeCategory)),r.dataset.menuAction==="saved"&&(ma(),rt(),Ae(),t.showSaved=!0,document.querySelector("#archiveControls")?.classList.remove("mobile-open"),Y(),h())});var Pr=async()=>{try{let e=await fetch(I("/api/summary/unlock-config"));e.ok&&(t.unlockConfig=await e.json(),h())}catch(e){console.error("Failed to prefetch unlock config:",e)}};h();B();Pr();Pa().then(()=>{lr(),B(),window.setTimeout(Br,1200)});var Cr=document.querySelector(".brand-lockup");Cr?.addEventListener("click",()=>{window.location.hash="#feed"});se();var Er=document.querySelector("#mobileArchiveCard"),ge=document.querySelector("#archiveControls");Er?.addEventListener("click",()=>{if(!ge)return;ge.classList.toggle("mobile-open")&&setTimeout(()=>ge.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Ir=document.querySelector("#archivePill");Ir?.addEventListener("click",e=>{if(e.stopPropagation(),!ge)return;ge.classList.toggle("mobile-open")&&setTimeout(()=>ge.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Oe=!1,It=!1,Br=()=>{It||(It=!0,(async()=>{let e=await _e();if(Oe=!!e,e){t.walletConnecting=!0,B();try{let a=await wa();Oe=!1,t.walletConnecting=!1,a?(t.walletAddress=await _e(),t.walletAddress&&(fe(),t.walletBalance=await X(t.walletAddress),await z()),B(),t.activeSurface==="portfolio"&&h()):(t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),v("Session expired. Please sign in again."),B(),h())}catch(a){console.warn(a),Oe=!1,t.walletConnecting=!1,t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),v("Session expired. Please sign in again."),B(),h()}}await Sa(a=>{Oe||(t.walletAddress=a,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),a&&le(!1).catch(r=>console.error("Failed to report leaderboard entry:",r)),t.marketPositions={},t.hasLoadedPortfolioPositions=!1,B(),a?(Me(),X(a).then(r=>{t.walletBalance=r,B(),t.activeSurface==="portfolio"&&h()}),z()):t.activeSurface==="portfolio"&&h())})})())};C("app_open");document.addEventListener("click",e=>{let r=e.target.closest("a, button");if(r){let o=r.className||"",s=typeof o=="string"?o:r.getAttribute("class")||"",n=r.getAttribute("href")||"";!(r.hasAttribute("data-unlock-briefing")||r.hasAttribute("data-unlock-briefing-url")||r.classList.contains("summary-btn")||r.textContent?.trim()==="AI briefing"||r.textContent?.trim().includes("Unlock via"))&&(s.includes("source-button")||s.includes("source-btn")||s.includes("source-link")||r.textContent?.trim()==="Open source")&&!s.includes("disabled")&&n!=="#"&&C("open_source")}},!0);
