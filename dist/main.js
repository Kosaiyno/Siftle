...
`,hr=(e=4)=>`${ye("Loading stories")}${Array.from({length:e},gr).join("")}`,ve=()=>`
...
`,St=e=>{let a=e.type==="tweet",r='<svg class="x-logo-svg" viewBox="0 0 24 24" fill="currentColor" style="width: 14px; height: 14px; display: inline-block; vertical-align: text-top; color: var(--color-text-primary);"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>',o='<svg class="x-logo-svg" viewBox="0 0 24 24" fill="currentColor" style="width: 12px; height: 12px; display: inline-block; vertical-align: text-top; margin-right: 4px;"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>';return`
  ...
  `},be=()=>{if(!w)return;let e=Ea();if(w.hidden=!!(t.selectedStoryId||t.selectedThreadUrl),t.isLoading){w.innerHTML=hr(4);return}let a=Number(t.unlockConfig?.amountUsdc)||.001,r=U(t.newsSearchQuery.trim()),s=`
...
`},Tr=async(e,a)=>{if(!t.walletAddress){b("Session expired or wallet not connected. Please sign in."),Pe();return}let r=Me().find(c=>c.id===e);if(!r||!te(r))return;let o=re(r).find(c=>c.id===a);if(!o){b("Choose a valid option.");return}!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",g(),await z(),t.marketTradeStatus=null);let s=t.marketSnapshots[r.id];if(Fe(r,s)){b("This market is resolved and can no longer be traded.");return}let n=t.marketPositions[r.id],i=t.marketOrderMode==="sell";if(!i&&n?.optionId){b("Your pick is already locked for this market.");return}if(i&&!n?.optionId){b("You do not have a pick to exit.");return}let l=Math.max(0,Number(n?.optionSharesUsdc)||0);if(i&&l<=0){b("Your pick is still loading. Please try again."),await z({force:!0});return}let p=i?l:Be(Number(t.marketTradeAmount)||0,"buy","yes",void 0);t.marketTradeAmount=p,t.marketTradeOptionId=i&&n?.optionId||o.id,P("trade_attempt");try{t.marketTradeStatus=i?"Exiting your pick...":"Locking your pick...",g(),await ma(r.id,i?"sell":"buy",i&&n?.optionId||o.id,p,c=>{t.marketTradeStatus=c,g()}),delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await Oe(),t.walletAddress&&(t.walletBalance=await ne(t.walletAddress)),await z({force:!0}),P(i?"trade_sell_success":"trade_buy_success"),b(i?"Pick exited":`Pick locked: ${o.label}`),t.tradeDrawerOpen=!1}catch(c){P("trade_failed"),b(c instanceof Error?c.message:"Trade failed")}finally{t.marketTradeStatus=null,D(),g()}},Mr=()=>{if(!S||!w)return;let e=t.stories.find(o=>o.sourceUrl===t.selectedThreadUrl);if(w.hidden=!0,S.hidden=!1,S.classList.add("fullscreen"),document.body.classList.add("detail-mode"),!e){S.innerHTML="";return}let a=t.loadingThreadUrl===e.sourceUrl,r=t.activeThread;if(a&&!r){S.innerHTML=`
  ...
  `},Ar=()=>{if(!S||!w)return;if(t.selectedThreadUrl){Mr();return}let e=t.stories.find(i=>i.id===t.selectedStoryId);if(!e){S.hidden=!0,S.classList.remove("fullscreen"),document.body.classList.remove("detail-mode"),w.hidden=!1;return}if(e.type==="tweet"){w.hidden=!0,S.hidden=!1,S.classList.add("fullscreen"),document.body.classList.add("detail-mode");let i='<svg class="x-logo-svg" viewBox="0 0 24 24" fill="currentColor" style="width: 16px; height: 16px; display: inline-block; vertical-align: text-top; margin-right: 6px;"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>';S.innerHTML=`
    ...
    `;return}let a=de(e,t.aiSummaries[e.sourceUrl]),r=t.loadingSummaryUrl===e.sourceUrl,o=ce(e),s=t.unlockingSummaryUrl===e.sourceUrl,n=it(e);w.hidden=!0,S.hidden=!1,S.classList.add("fullscreen"),document.body.classList.add("detail-mode"),S.innerHTML=`
  ...
  `},Lr=e=>{let a=t.marketSnapshots[e.id],r=K(e),o=te(e),s=re(e).length,n=a?.volumeUsdc??(Number(e.volumeUsdc)||0),i=a?.yesPriceCents,l=i??e.probability,p=o?`${s}`:`${l}%`,c=i===void 0?r?"Loading Arc pools":"Arc setup required":`Yes ${i}\xA2 \xB7 No ${100-i}\xA2`,u=i===void 0?`Yes ${e.probability}c - No ${100-e.probability}c`:c,d=je(e),k=e.timeframe==="Daily"?jt(e,a):e.closes;return`
    <button class="market-card" type="button" data-market-id="${e.id}">
      ...
      <div class="market-card-footer">
        ...
        <span>${e.timeframe==="Daily"?`Locks ${k}`:`Closes ${k}`}</span>
      </div>
    </button>
...
Trade and discuss here: ${l}`},Pr=e=>{if(!w||!S)return;let a=je(e),r=!t.checkedMarketEvidence[e.id],o=K(e),s=t.marketSnapshots[e.id],n=te(e),i=re(e);n&&!t.marketTradeOptionId&&(t.marketTradeOptionId=i[0]?.id||null);let l=er(e),p=!!(o&&!s),c=s?.yesPriceCents??(o?e.probability:0),u=s?.noPriceCents??(o?100-e.probability:0),d=p?"":o?`${c}\xA2`:"--",k=p?"":o?`${u}\xA2`:"--",m=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},h=!!m.optionId;n&&h&&t.marketOrderMode!=="sell"&&(t.marketOrderMode="sell"),n&&!h&&t.marketOrderMode==="sell"&&(t.marketOrderMode="buy");let T=n&&t.marketOrderMode==="sell"&&h?Math.max(0,Number(m.optionSharesUsdc)||0):0,B=T>0?T:Be(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,m),v=T>0?{min:0,max:T}:Qt(t.marketOrderMode,t.marketTradeSide,m),f=t.marketOrderMode==="buy"?"exactly $2.00 USDC":`Up to $${H(v.max)} USDC`,A=!t.walletAddress||t.hasLoadedPortfolioPositions,y=Fe(e,s),$=Ft(e,s),x=!!$;n||(t.marketTradeSide=ct(t.marketOrderMode,t.marketTradeSide,m));let M=!n&&!y&&!x&&A&&se(t.marketOrderMode,"yes",m),O=!n&&!y&&!x&&A&&se(t.marketOrderMode,"no",m),Y=n?!y&&!x&&A&&(t.marketOrderMode==="sell"?h:!h&&!!l):!y&&!x&&A&&se(t.marketOrderMode,t.marketTradeSide,m),q=y?"Market resolved":$||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),V=y?"Market resolved":$||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),Z=n?B:Xt(s,t.marketTradeSide,B,t.marketOrderMode,m),Q=t.marketOrderMode==="buy"?"Buy":"Exit",ue=n?"Pick one outcome":o?"Arc testnet live":"Contract not deployed";w.hidden=!0,S.hidden=!1,S.classList.add("fullscreen"),document.body.classList.add("detail-mode"),dr(e),Vt(e),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&z({force:!t.hasLoadedPortfolioPositions});let ut=n?!!m.optionId:m.yesSharesUsdc>0||m.noSharesUsdc>0,qe="";n&&ut&&t.walletAddress?qe=`
    ...
    <div class="detail-container market-detail-container">
        ...
        <div class="market-detail-main">
          ...
          <section class="market-evidence-thread">
            ...
            <div class="market-thread-timeline">
              ${r?br(3):a.evidence.length===0?'<div class="portfolio-empty compact">Related news is still loading for this market.</div>':a.evidence.map(E=>{let _=zt(e,E),me=t.unlockingSummaryUrl===E.sourceUrl;return`
      ...
      <div class="sticky-trade-bar">
        ...
        <button class="sticky-trade-btn" type="button" id="openTradeDrawerBtn" ${y||x?"disabled":""}>
          ${y?"Market Resolved":$||(n?h?"Pick Locked":"Pick Outcome":"Trade Market")}
        </button>
      </div>
      ...
      <div class="trade-drawer ${t.tradeDrawerOpen?"open":""}" id="tradeDrawer">
        ...
        <div class="trade-drawer-body">
          ...
          <div class="market-action-grid">
            ${n?i.map(E=>{let _=t.marketTradeOptionId===E.id||m.optionId===E.id,me=y||x||t.marketOrderMode==="sell"||h||!A;return`
  ...
  `},na=()=>{if(!w||!S)return;Re?.toggleAttribute("hidden",!0),ze?.toggleAttribute("hidden",!0),le?.toggleAttribute("hidden",!0),Ae?.classList.remove("active"),Le?.classList.remove("active"),Ue?.classList.remove("active"),document.body.classList.remove("detail-mode"),S.hidden=!0,w.hidden=!1,w.classList.add("markets-list");let e=t.walletAddress&&t.hasLoadedPortfolioPositions?pt():null;t.walletAddress&&e&&fetch(C("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:t.walletAddress,points:e.points,status:e.status,username:t.profileUsername||""})}).catch(v=>console.error("Failed to report user score:",v)),ee&&(clearInterval(ee),ee=null),w.innerHTML=`
  ...
  `,((v="2026-07-19T23:59:59.000Z")=>{let f=document.getElementById("seasonTimer");ee&&clearInterval(ee);let A=()=>{let $=new Date(v).getTime()-new Date().getTime();if($<=0){f&&(f.innerText="Season Finished!"),ee&&clearInterval(ee);return}let x=Math.floor($/(1e3*60*60*24)),M=Math.floor($%(1e3*60*60*24)/(1e3*60*60)),O=Math.floor($%(1e3*60*60)/(1e3*60)),Y=Math.floor($%(1e3*60)/1e3);f&&(f.innerText=`${x}d ${M}h ${O}m ${Y}s`)};A(),ee=setInterval(A,1e3)})();let r=v=>v.map((f,A)=>{let y=Number(f.globalRank)||A+1,$=String(f.username||""),x=!!(t.walletAddress&&$.toLowerCase()===t.walletAddress.toLowerCase()),M=x&&t.profileUsername?t.profileUsername:f.displayName||$,O=x?`${t.profileUsername?M:R($)} (You)`:M.startsWith("0x")&&M.length===42?R(M):M,Y=U(O),q=kt(f.status);if(f.totalTrades!==void 0&&f.aiBriefingUnlocks!==void 0){let We=wt(f.status);q=`${We.wins}W - ${We.losses}L \xB7 ${f.totalTrades} trades \xB7 ${f.aiBriefingUnlocks} unlocks`}let V=U(q),Z=f.nextSeasonDivision?`Division ${f.nextSeasonDivision}`:"Qualify",Q=y<=10?"promotion-zone":"safety-zone",ue=y<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
    ...
    `}let o=Cr(r?.outcome),s=ea(a,r),n=s.reduce((h,T)=>Math.max(h,T.payout),0),i=a.yesSharesUsdc+a.noSharesUsdc,l=r?.outcome??0,p=He().has(e.id),c=l===1?a.yesSharesUsdc:l===2?a.noSharesUsdc:0,u=l===1?r?.yesSharesUsdc??0:l===2?r?.noSharesUsdc??0:0,d=r?.volumeUsdc??0,k=c>0&&u>0?c/u*d:0,m=l===0?"":p?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':k>0?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${H(k)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>';return`
    <article class="portfolio-position-card">
      <div class="portfolio-position-top">
        <span class="category-chip ${e.category}">${W(e.category)}</span>
        <span>${o}</span>
  ...
  `},Ir=async e=>{if(!t.walletAddress){b("Please sign in first.");return}let a=Me().find(o=>o.id===e),r=a?K(a):"";if(!a||!r){b("Market is not available.");return}try{t.claimingMarketIds[a.id]=!0,F(),P("claim_attempt"),pt();let o=await fa(r,t.walletAddress);P("claim_success"),o.won&&or(a.id),delete t.marketPositions[a.id],delete t.marketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.walletBalance=await ne(t.walletAddress),await z(),b(o.won?`Claimed $${H(o.amountUsdc)}`:"No payout to claim"),D(),F()}catch(o){P("claim_failed"),b(o instanceof Error?o.message:"Claim failed")}finally{delete t.claimingMarketIds[a.id],F()}},Er=e=>{if(!e)return"";let a=t.referralData,r=a?.referrals?.length?a.referrals.map(s=>{let n=s.displayName||R(s.walletAddress),i=s.remaining<=0;return`
  ...
  `},F=()=>{if(!w||!S)return;Re?.toggleAttribute("hidden",!0),ze?.toggleAttribute("hidden",!0),le?.toggleAttribute("hidden",!0),Ae?.classList.remove("active"),Le?.classList.remove("active"),Ue?.classList.add("active"),document.body.classList.remove("detail-mode"),S.hidden=!0,w.hidden=!1,w.classList.add("markets-list"),t.walletAddress&&!t.referralData&&!t.referralError&&!t.loadingReferralData&&$e(),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&(t.portfolioMarketPreviews.length===0&&Dt(),z({force:!t.hasLoadedPortfolioPositions}));let a=He(),r=Me().filter(d=>{let k=t.marketPositions[d.id];return a.has(d.id)||k&&(k.yesSharesUsdc+k.noSharesUsdc>0||(k.optionSharesUsdc||0)>0)}),o=r.filter(d=>(t.marketSnapshots[d.id]?.outcome??0)===0),s=r.filter(d=>(t.marketSnapshots[d.id]?.outcome??0)!==0),n=!!t.walletAddress,i=t.profileUsername||(t.walletAddress?R(t.walletAddress):"Anonymous"),l=U(i),p=U(t.profileUsername||""),c=t.profileNotice?`<div style="margin-top: 14px !important; padding: 10px 12px !important; border-radius: 8px !important; border: 1px solid ${t.profileNotice.type==="error"?"rgba(239, 68, 68, 0.28)":"rgba(16, 185, 129, 0.24)"} !important; background: ${t.profileNotice.type==="error"?"rgba(127, 29, 29, 0.22)":"rgba(6, 95, 70, 0.18)"} !important; color: ${t.profileNotice.type==="error"?"#fca5a5":"#86efac"} !important; font-size: 0.8rem !important; font-weight: 650 !important;">${U(t.profileNotice.message)}</div>`:"",u=i.charAt(0).toUpperCase();w.innerHTML=`
    <section class="portfolio-surface">
      ...
      ${t.loadingPortfolioPositions?yr(2):t.walletAddress?r.length===0?'<div class="portfolio-empty">No positions found for this wallet yet. Confirmed trades will appear here after the Arc transaction settles.</div>':`
  ...
  `},g=()=>{if(Ot.forEach(e=>{let a=e.dataset.bottomNav;e.classList.toggle("active",a==="saved"?t.showSaved:a===t.activeSurface&&!t.showSaved)}),t.activeSurface==="markets"){sa();return}if(t.activeSurface==="portfolio"){F();return}if(t.activeSurface==="leaderboard"){na();return}ia(),Gt(),be(),Ar(),j&&(j.value=t.activeArchiveDate??"")};Qe.textContent=Ht();le?.addEventListener("click",e=>{let r=e.target.closest("[data-category]");r&&(t.activeCategory=r.dataset.category,window.history.pushState({},"","#feed"),J(),g(),Ee(),ae(t.activeCategory))});w?.addEventListener("input",e=>{let a=e.target;if(a.id!=="newsSearchInput")return;let r=a.selectionStart??a.value.length,o=a.selectionEnd??a.value.length;t.newsSearchQuery=a.value,be();let s=w?.querySelector("#newsSearchInput");s&&(s.focus(),s.setSelectionRange(r,o))});Ae?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,window.history.pushState({},"","#markets"),J(),g()});Le?.addEventListener("click",()=>{t.activeSurface="feed",t.showSaved=!1,window.history.pushState({},"","#feed"),J(),g(),Ee(),ae(t.activeCategory)});Ue?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=!1,window.history.pushState({},"","#portfolio"),J(),g()});oe?.addEventListener("click",()=>{t.walletAddress?(window.location.hash="#portfolio",Ie()):Pe()});document.addEventListener("click",e=>{let a=e.target,r=a.closest(".copy-address-btn");if(r){let i=r.getAttribute("data-address");i&&navigator.clipboard.writeText(i).then(()=>{b("Wallet address copied!")})}let o=a.closest("[data-claim-market]");if(o){let i=o.getAttribute("data-claim-market");i&&Ir(i);return}if(a.closest("[data-open-referrals]")){t.referralPanelOpen=!t.referralPanelOpen,!t.referralData&&!t.loadingReferralData&&$e(),F();return}if(a.closest("[data-close-referrals]")){t.referralPanelOpen=!1,F();return}if(a.closest("[data-refresh-referrals]")){t.referralError=null,$e(),F();return}let s=a.closest("[data-copy-referral-code]");if(s){let i=s.getAttribute("data-copy-referral-code")||"";i&&navigator.clipboard.writeText(i).then(()=>b("Invite code copied"));return}let n=a.closest("[data-copy-referral-link]");if(n){let i=n.getAttribute("data-copy-referral-link")||"";i&&navigator.clipboard.writeText(i).then(()=>b("Invite link copied"));return}a.closest("[data-connect-wallet]")&&(t.walletAddress?Ct():Pe())});Ot.forEach(e=>{e.addEventListener("click",()=>{let a=e.dataset.bottomNav;t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=a==="saved",a==="markets"?(t.activeSurface="markets",window.history.pushState({},"","#markets")):a==="portfolio"?(t.activeSurface="portfolio",window.history.pushState({},"","#portfolio")):a==="leaderboard"?(t.activeSurface="leaderboard",window.history.pushState({},"","#leaderboard")):(t.activeSurface="feed",window.history.pushState({},"","#feed"),Ee(),ae(t.activeCategory),a==="saved"&&(ar(),rt(),xe())),J(),g()})});j?.addEventListener("change",()=>{t.activeArchiveDate=j.value||null,window.history.pushState({},"","#feed"),J(),g(),ae(t.activeCategory)});Aa?.addEventListener("click",()=>{t.activeArchiveDate=null,j&&(j.value=""),window.history.pushState({},"","#feed"),J(),g(),ae(t.activeCategory)});w?.addEventListener("click",async e=>{let a=e.target;if(a.closest("#editUsernameBtn")){let m=w?.querySelector(".username-display-row"),h=w?.querySelector("#usernameEditForm");if(m&&h){m.style.display="none",h.style.display="flex";let T=h.querySelector("#usernameInput");T&&T.focus()}return}if(a.closest("#cancelUsernameBtn")){let m=w?.querySelector(".username-display-row"),h=w?.querySelector("#usernameEditForm");m&&h&&(m.style.display="flex",h.style.display="none");return}let s=a.closest("#saveUsernameBtn");if(s){let h=w?.querySelector("#usernameEditForm")?.querySelector("#usernameInput");if(h){let T=h.value.trim().slice(0,15),B=s,v=B.textContent||"Save";B.disabled=!0,B.textContent="Saving...",tr(T),t.profileNotice=null;try{t.walletAddress&&await pe(!1),t.profileNotice={type:"success",message:"Username saved to your shared leaderboard profile."},b("Username updated"),F()}catch(f){let A=f instanceof Error?f.message:"Username save failed";t.profileNotice={type:"error",message:A},b(A),B.disabled=!1,B.textContent=v,F()}}return}let n=a.closest("[data-timeframe]");if(n){let m=n.dataset.timeframe;t.activeMarketTimeframe=m,sa();return}let i=a.closest("[data-market-id]");if(i){t.selectedMarketId=i.dataset.marketId??null,P("market_view"),window.history.pushState({},"",`#market-${t.selectedMarketId}`),g(),window.scrollTo({top:0,behavior:"smooth"});return}if(a.closest(".read-tweet-btn")){e.stopPropagation();let m=a.closest("[data-story-id]");m&&et(Number(m.dataset.storyId),!0);return}let p=a.closest("[data-thread-story-id]"),c=a.closest("[data-export-id]"),u=a.closest("[data-export-action]"),d=a.closest("[data-story-id]");if(p){e.stopPropagation();let m=t.stories.find(h=>h.id===Number(p.dataset.threadStoryId));m&&Fa(m);return}let k=a.closest(".mobile-bookmark-btn, .bookmark-button");if(k){e.stopPropagation();let m=k.dataset.bookmarkUrl||"",h=t.stories.find(T=>T.sourceUrl===m);if(!h)return;h.saved=!h.saved,h.saved?ie.add(m):ie.delete(m),Ma(),b(h.saved?"Saved to your list":"Removed from saved"),be();return}if(u){e.stopPropagation(),$r(Number(u.dataset.exportStoryId),u.dataset.exportAction);return}if(c){e.stopPropagation();let m=Number(c.dataset.exportId);t.activeShareStoryId=t.activeShareStoryId===m?null:m,be();return}d&&(a.closest("a")||et(Number(d.dataset.storyId),!0))});w?.addEventListener("keydown",e=>{let r=e.target.closest("[data-story-id]");!r||e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),et(Number(r.dataset.storyId)))});S?.addEventListener("click",e=>{let a=e.target,r=a.closest("[data-unlock-briefing]");if(r){let u=t.stories.find(d=>d.id===Number(r.dataset.unlockBriefing));u&&Xe(u);return}let o=a.closest("[data-unlock-briefing-url]");if(o){let u=decodeURIComponent(o.dataset.unlockBriefingUrl||""),d=za(u);d&&(ce(d)?Te(d):Xe(d));return}if(a.closest("[data-back-markets]")){t.selectedMarketId=null,t.tradeDrawerOpen=!1,window.history.pushState({},"","#markets"),g();return}if(a.closest("#openTradeDrawerBtn")){let u=I.find(m=>m.id===t.selectedMarketId);if(u){if(Fe(u,t.marketSnapshots[u.id])){b("This market is resolved and can no longer be traded.");return}if(Ft(u,t.marketSnapshots[u.id])){b("Trading is locked 20 minutes before kickoff.");return}}t.tradeDrawerOpen=!0,P("trade_drawer_open");let d=S.querySelector("#tradeDrawer"),k=S.querySelector("#tradeDrawerBackdrop");d?.classList.add("open"),k?.classList.add("open");return}if(a.closest("#closeTradeDrawerBtn")||a.closest("#tradeDrawerBackdrop")){t.tradeDrawerOpen=!1;let u=S.querySelector("#tradeDrawer"),d=S.querySelector("#tradeDrawerBackdrop");u?.classList.remove("open"),d?.classList.remove("open");return}if(a.closest("#shareWhatsAppBtn")){let u=I.find(d=>d.id===t.selectedMarketId);if(u){let d=Ur(u),k=`https://api.whatsapp.com/send?text=${encodeURIComponent(d)}`;window.open(k,"_blank")}return}let s=a.closest("[data-market-trade]");if(s&&t.selectedMarketId){let u=s.dataset.marketTrade;cr(t.selectedMarketId,u);return}let n=a.closest("[data-market-option-trade]");if(n&&t.selectedMarketId){let u=n.dataset.marketOptionTrade||t.marketTradeOptionId||"";Tr(t.selectedMarketId,u);return}let i=a.closest("[data-market-option-id]");if(i){if(i.disabled||i.classList.contains("disabled"))return;t.marketTradeOptionId=i.dataset.marketOptionId||null,g();return}let l=a.closest("[data-market-trade-side]");if(l){if(l.disabled||l.classList.contains("disabled"))return;let u=I.find(m=>m.id===t.selectedMarketId),d=u?t.marketPositions[u.id]:void 0,k=l.dataset.marketTradeSide;if(!se(t.marketOrderMode,k,d))return;t.marketTradeSide=k,g();return}let p=a.closest("[data-market-order-mode]");if(p){t.marketOrderMode=p.dataset.marketOrderMode;let u=I.find(k=>k.id===t.selectedMarketId),d=u?t.marketPositions[u.id]:void 0;t.marketTradeSide=ct(t.marketOrderMode,t.marketTradeSide,d),t.marketTradeAmount=Be(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,d),g();return}a.closest("[data-back-to-feed]")&&Wa()});S?.addEventListener("input",e=>{let a=e.target;if(!a.matches("[data-market-amount]"))return;let r=I.find(p=>p.id===t.selectedMarketId),o=r?t.marketSnapshots[r.id]:void 0,s=r?t.marketPositions[r.id]:void 0,n=Number(a.value);t.marketTradeAmount=Number.isFinite(n)?n:0;let i=r&&te(r)?t.marketTradeAmount:Xt(o,t.marketTradeSide,t.marketTradeAmount,t.marketOrderMode,s),l=S.querySelector(".market-inline-payout strong");l&&(l.textContent=`$${H(i)}`)});S?.addEventListener("focusin",e=>{e.target.matches("[data-market-amount]")&&document.body.classList.add("market-amount-focused")});S?.addEventListener("focusout",e=>{let a=e.target;if(a.matches("[data-market-amount]")){let r=I.find(s=>s.id===t.selectedMarketId),o=r?t.marketPositions[r.id]:void 0;t.marketTradeAmount=Be(Number(a.value)||0,t.marketOrderMode,t.marketTradeSide,o),a.value=String(t.marketTradeAmount),window.setTimeout(()=>document.body.classList.remove("market-amount-focused"),120)}});window.addEventListener("popstate",Ie);window.addEventListener("hashchange",Ie);window.addEventListener("focus",async()=>{if(t.walletAddress){let e=t.walletBalance,a=await ne(t.walletAddress);t.walletBalance=a,D(),(!e||parseFloat(e)===0)&&parseFloat(a)>0&&(console.log("[X402] Balance changed from 0 to positive. Triggering Gateway warmup..."),va())}});Ge?.addEventListener("click",()=>{if(!Je||!Ge)return;let e=!Je.hidden;Je.hidden=e,Ge.setAttribute("aria-expanded",String(!e))});document.addEventListener("click",e=>{let a=e.target;!a.closest(".share-control")&&t.activeShareStoryId!==null&&(t.activeShareStoryId=null,be());let r=a.closest("[data-menu-action]");if(!r)return;let o={today:"Showing today's brief",saved:`${t.stories.filter(s=>s.saved).length} saved stories`,archive:t.archiveDates.length>0?"Choose a saved day from the archive selector":"No saved days yet"};L&&(L.textContent=o[r.dataset.menuAction??"today"]),r.dataset.menuAction==="today"&&(t.showSaved=!1,t.activeArchiveDate=null,j&&(j.value=""),J(),Ee(),ae(t.activeCategory)),r.dataset.menuAction==="saved"&&(ia(),rt(),xe(),t.showSaved=!0,document.querySelector("#archiveControls")?.classList.remove("mobile-open"),J(),g())});var Br=async()=>{try{let e=await fetch(C("/api/summary/unlock-config"));e.ok&&(t.unlockConfig=await e.json(),g())}catch(e){console.error("Failed to prefetch unlock config:",e)}},Dr=()=>{window.setInterval(async()=>{try{let e=new AbortController,a=window.setTimeout(()=>e.abort(),3500),r=await fetch(C("/api/markets"),{signal:e.signal});if(window.clearTimeout(a),r.ok){let o=await r.json();Array.isArray(o)&&o.length>0&&(I=o,t.activeSurface==="markets"&&g())}}catch(e){console.warn("Background market poll failed:",e)}},3e4)};g();D();Br();ae(t.activeCategory);Dr();Ta().then(()=>{lr(),g(),D(),window.setTimeout(_r,1200),Ga()});var Nr=document.querySelector("#mobileArchiveCard"),he=document.querySelector("#archiveControls");Nr?.addEventListener("click",()=>{if(!he)return;he.classList.toggle("mobile-open")&&setTimeout(()=>he.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Or=document.querySelector("#archivePill");Or?.addEventListener("click",e=>{if(e.stopPropagation(),!he)return;he.classList.toggle("mobile-open")&&setTimeout(()=>he.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Ne=!1,Ut=!1,_r=()=>{Ut||(Ut=!0,(async()=>{let e=await Oe();if(Ne=!!e,e){t.walletConnecting=!0,D();try{let a=await ga();Ne=!1,t.walletConnecting=!1,a?(t.walletAddress=await Oe(),t.walletAddress&&(ge(),t.walletBalance=await ne(t.walletAddress),await z()),D(),t.activeSurface==="portfolio"&&g()):(t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ge(),b("Session expired. Please sign in again."),D(),g())}catch(a){console.warn(a),Ne=!1,t.walletConnecting=!1,t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ge(),b("Session expired. Please sign in again."),D(),g()}}await ha(a=>{Ne||(t.walletAddress=a,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ge(),a&&pe(!1).catch(r=>console.error("Failed to report leaderboard entry:",r)),t.marketPositions={},t.hasLoadedPortfolioPositions=!1,D(),a?($e(),ne(a).then(r=>{t.walletBalance=r,D(),t.activeSurface==="portfolio"&&g()}),z()):t.activeSurface==="portfolio"&&g())})})())};P("app_open");document.addEventListener("click",e=>{let r=e.target.closest("a, button");if(r){let o=r.className||"",s=typeof o=="string"?o:r.getAttribute("class")||"",n=r.getAttribute("href")||"";!(r.hasAttribute("data-unlock-briefing")||r.hasAttribute("data-unlock-briefing-url")||r.classList.contains("summary-btn")||r.textContent?.trim()==="AI briefing"||r.textContent?.trim().includes("Unlock via"))&&(s.includes("source-button")||s.includes("source-btn")||s.includes("source-link")||r.textContent?.trim()==="Open source")&&!s.includes("disabled")&&n!=="#"&&P("open_source")}},!0);
