import"./chunks/chunk-ZUUPKAA6.js";var me="Sports",De=[{id:"wc-spain-belgium-qualify",category:me,timeframe:"Daily",optionMarket:!0,question:"Which team will qualify in Spain vs Belgium?",options:[{id:"spain",label:"Spain"},{id:"belgium",label:"Belgium"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on the team that officially qualifies in Spain vs Belgium, including extra time and penalties.",threadTopic:"Spain vs Belgium Qualify Watch",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-spain-concede-belgium",category:me,timeframe:"Daily",optionMarket:!0,question:"Will Spain concede against Belgium?",options:[{id:"yes",label:"Yes"},{id:"no",label:"No"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on whether Belgium are officially credited with at least one goal against Spain in regular time or extra time. Penalty shootout goals do not count.",threadTopic:"Spain Clean Sheet Watch vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-yamal-goal-assist-belgium",category:me,timeframe:"Daily",optionMarket:!0,question:"Will Lamine Yamal record a goal or assist against Belgium?",options:[{id:"yes",label:"Yes"},{id:"no",label:"No"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on whether Lamine Yamal is officially credited with at least one goal or at least one assist for Spain against Belgium in regular time or extra time. Penalty shootout goals do not count.",threadTopic:"Lamine Yamal Impact vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1522778119026-d647f0596c20?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-spain-goals-belgium",category:me,timeframe:"Daily",optionMarket:!0,question:"How many goals will Spain score in regular + extra time vs Belgium?",options:[{id:"0",label:"0 goals"},{id:"1",label:"1 goal"},{id:"2",label:"2 goals"},{id:"3-plus",label:"3+ goals"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on the number of goals officially scored by Spain against Belgium in regular time and extra time. Penalty shootout goals do not count.",threadTopic:"Spain Goals vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-tonali-spurs",category:me,timeframe:"Sagas",question:"Will Sandro Tonali sign with Tottenham Hotspur in the Summer Transfer Window?",probability:58,closes:"September 1, 2026",resolution:"Resolves Yes if Tottenham Hotspur officially announces the transfer/signing of Sandro Tonali by the transfer deadline.",threadTopic:"Sandro Tonali Tottenham Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$182K",traders:"980",liquidity:"$29K",imageUrl:"https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-guimaraes-arsenal",category:me,timeframe:"Sagas",question:"Will Bruno Guimaraes officially sign with Arsenal by September 1, 2026?",probability:45,closes:"September 1, 2026",resolution:"Resolves Yes if Arsenal officially announces the transfer/signing of Bruno Guimaraes by the transfer deadline.",threadTopic:"Bruno Guimaraes Arsenal Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$204K",traders:"1,240",liquidity:"$36K",imageUrl:"https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=1200&q=80",evidence:[]}];var Xe="https://faucet.circle.com/",gt="siftle_backend_wallet_migration_notice",Ye=null,_=()=>(Ye||(Ye=import("./chunks/arc-ZAE4BJZI.js")),Ye),j=e=>e.length>10?`${e.slice(0,6)}...${e.slice(-4)}`:e,ua=async()=>(await _()).connectArcWallet(),te=async e=>(await _()).readArcUsdcBalance(e),fa=async(e,a,r,o)=>(await _()).payAiBriefingUnlock(e,a,r,o),ga=e=>{_().then(a=>a.resolveLocalTestMarketYes(e))},ha=async e=>(await _()).readArcMarketSnapshot(e);var Bt=async(e,a)=>(await _()).readArcMarketState(e,a),va=async(e,a,r,o,s,n,i)=>(await _()).executeArcMarketOrder(e,a,r,o,s,n,i),ba=async(e,a,r,o,s)=>(await _()).executeArcOptionMarketOrder(e,a,r,o,s),Dt=()=>{_().then(e=>e.disconnectArcWallet())},ya=async(e,a)=>(await _()).claimArcMarketPayout(e,a),Oe=async()=>(await _()).getConnectedArcWallet(),ka=async()=>(await _()).validateArcSession(),wa=async e=>(await _()).subscribeArcWallet(e),Sa=async()=>(await _()).triggerGatewayWarmup(),xa=["Sports"],$a="https://siftle.onrender.com",Ta=()=>{let e=(window.SIFTLE_API_BASE||"").replace(/\/$/,"");if(e)return e;let a=typeof window<"u"?window.location.hostname.toLowerCase():"";return a==="siftle.xyz"||a.endsWith(".siftle.xyz")||a.endsWith(".vercel.app")?$a:""},Ma=Ta(),C=e=>`${Ma}${e}`,Nt="siftle_theme",Aa=()=>{try{return window.localStorage.getItem(Nt)==="light"?"light":"dark"}catch{return"dark"}},xe=Aa();function E(e){fetch(C("/api/analytics"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:e})}).catch(a=>console.error("Failed to track event:",a))}var t={activeSurface:"feed",profileUsername:null,selectedMarketId:null,marketOrderMode:"buy",marketTradeSide:"yes",marketTradeOptionId:null,marketTradeAmount:5,marketSnapshots:{},marketPositions:{},marketEvidenceOverrides:{},loadingMarkets:!0,checkedMarketEvidence:{},checkedMarketSnapshots:{},loadingMarketSnapshots:{},loadingMarketEvidence:{},loadingPortfolioPositions:!1,marketTradeStatus:null,hasLoadedPortfolioPositions:!1,walletConnecting:!1,walletAddress:null,walletBalance:null,activeCategory:"Sports",stories:[],isLoading:!1,selectedStoryId:null,aiSummaries:{},loadingSummaryUrl:null,unlockingSummaryUrl:null,archiveDates:[],activeArchiveDate:null,activeShareStoryId:null,selectedThreadUrl:null,activeThread:null,loadingThreadUrl:null,feedScrollY:0,hasLoadedFeed:!1,showSaved:!1,tradeDrawerOpen:!1,activeMarketTimeframe:"All",profileNotice:null,portfolioMarketPreviews:[],referralPanelOpen:!1,referralData:null,referralError:null,loadingReferralData:!1,portfolioPositionsLoadedAt:0,unlockConfig:null,newsSearchQuery:"",briefingStatusByUrl:{},claimingMarketIds:{}},ke=null,Q="global",J=null,ht=!1,vt=!1,bt=new URLSearchParams(window.location.search).get("ref")||localStorage.getItem("siftle_pending_referral_code")||"";bt&&localStorage.setItem("siftle_pending_referral_code",bt.trim().toUpperCase());var Ot=20,I=De,La=(...e)=>{let a=new Map;return e.flat().forEach(r=>{r?.id&&a.set(r.id,{...a.get(r.id)||{},...r})}),Array.from(a.values())},Me=()=>La(t.portfolioMarketPreviews,I,De),Ua=async()=>{t.loadingMarkets=!0,I.length===0&&(I=De);try{let e=new AbortController,a=window.setTimeout(()=>e.abort(),3500),r=await fetch(C("/api/markets"),{signal:e.signal});if(window.clearTimeout(a),r.ok){let o=await r.json();Array.isArray(o)&&o.length>0&&(I=o)}}catch(e){console.error("Failed to load markets:",e)}finally{t.loadingMarkets=!1}},_t=async()=>{try{let e=await fetch(C("/api/portfolio/markets"));if(!e.ok)return;let a=await e.json();Array.isArray(a)&&(t.portfolioMarketPreviews=a.map(r=>({threadStoryId:0,updates:0,movement:0,evidence:[],...r})))}catch(e){console.warn(e)}},Ht="siftle.savedUrls",ae=new Set,st=()=>{try{let e=localStorage.getItem(Ht)||"[]",a=JSON.parse(e);ae=new Set(a.filter(Boolean))}catch{ae=new Set}},Pa=()=>{try{localStorage.setItem(Ht,JSON.stringify(Array.from(ae)))}catch{}},$e=()=>{if(Array.isArray(t.stories))for(let e of t.stories)e.saved=!!ae.has(e.sourceUrl)};st();$e();var et=document.querySelector("#dateLabel"),re=document.querySelector("#categoryTabs"),w=document.querySelector("#storyList"),S=document.querySelector("#storyDetail"),Ge=document.querySelector("#menuButton"),Je=document.querySelector("#menuPanel"),M=document.querySelector("#menuStatus"),F=document.querySelector("#archiveDateSelect"),yt=document.querySelector("#archiveStatus"),Ca=document.querySelector("#todayButton"),Re=document.querySelector(".brief-hero"),je=document.querySelector("#archiveControls"),Ae=document.querySelector("[data-surface='markets']"),Le=document.querySelector("[data-surface='feed']"),Ue=document.querySelector("[data-surface='portfolio']"),X=document.querySelector("#walletButton"),we=document.querySelector("[data-theme-toggle]"),Rt=Array.from(document.querySelectorAll("[data-bottom-nav]")),Ke,Ea=()=>{if(!we)return;let a=`Switch to ${xe==="light"?"dark":"light"} mode`;we.setAttribute("aria-label",a),we.title=a,we.dataset.activeTheme=xe},jt=e=>{xe=e,document.documentElement.dataset.theme=e;try{window.localStorage.setItem(Nt,e)}catch{}Ea()};jt(xe);var B=()=>{if(X){let e=X.querySelector(".wallet-button-label");X.classList.toggle("connected",!!t.walletAddress),X.disabled=t.walletConnecting,X.setAttribute("aria-label",t.walletAddress?`Wallet ${j(t.walletAddress)}`:"Sign in"),e&&(e.textContent=t.walletConnecting?"Signing in...":t.walletAddress?"Wallet":"Sign in"),X.title=t.walletAddress?`${t.walletBalance??"0"} Arc Testnet USDC - ${j(t.walletAddress)}`:"Sign in"}};window.addEventListener("resize",B);we?.addEventListener("click",()=>{jt(xe==="light"?"dark":"light")});var Ia=async e=>{let a=localStorage.getItem("siftle_pending_referral_code");if(a)try{let r=await fetch(C("/api/referrals/bind"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:e,referralCode:a})}),o=await r.json().catch(()=>({}));r.ok&&(o.bound||o.reason==="already_bound"||o.reason==="invalid_code")&&(localStorage.removeItem("siftle_pending_referral_code"),o.bound&&h("Referral connected"))}catch(r){console.warn(r)}},Te=async()=>{if(!(!t.walletAddress||t.loadingReferralData)){t.loadingReferralData=!0,t.referralError=null;try{let e=await fetch(C(`/api/referrals?walletAddress=${encodeURIComponent(t.walletAddress)}`)),a=await e.json().catch(()=>({}));e.ok?t.referralData=a:t.referralError=a?.error||"Referral tools are temporarily unavailable."}catch(e){console.warn(e),t.referralError="Referral tools are temporarily unavailable."}finally{t.loadingReferralData=!1,t.activeSurface==="portfolio"&&q()}}},ze=async()=>{if(!t.walletConnecting){t.walletConnecting=!0,E("wallet_connect_start"),B();try{let e=await ua();if(e){E("wallet_connect_success"),t.walletAddress=e,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ue(),t.walletBalance=await te(e),await Ia(e),Te(),await z(),ie(!0).catch(r=>console.error("Failed to report leaderboard entry:",r));let a=localStorage.getItem(gt);a?(localStorage.removeItem(gt),h(a)):h("Connected to Arc Testnet"),window.location.hash="#portfolio",Ce()}}catch(e){E("wallet_connect_failed"),h(e instanceof Error?e.message:"Wallet connection failed")}finally{t.walletConnecting=!1,B()}}},h=e=>{let a=document.querySelector("#actionToast");a||(a=document.createElement("div"),a.id="actionToast",a.className="action-toast",a.setAttribute("role","status"),a.setAttribute("aria-live","polite"),document.body.appendChild(a)),a.textContent=e,a.classList.add("show"),Ke&&window.clearTimeout(Ke),Ke=window.setTimeout(()=>{a?.classList.remove("show")},1700)};window.showActionToast=h;var Ba=(e,a,r,o)=>{let s=document.createElement("div");s.className="success-modal-overlay",s.innerHTML=`
  ...
  `,document.body.appendChild(s),setTimeout(()=>{s.classList.add("show")},10);let n=()=>{s.classList.remove("show"),setTimeout(()=>{s.remove()},300)};s.querySelector(".success-modal-close-btn")?.addEventListener("click",n),s.querySelector(".success-modal-action-btn")?.addEventListener("click",n),s.addEventListener("click",i=>{i.target===s&&n()})},Y=()=>{t.feedScrollY=0,window.scrollTo({top:0,behavior:"auto"})},zt=e=>{let a=e?new Date(`${e}T12:00:00`):new Date;return new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric"}).format(a)},Da=()=>t.stories.filter(e=>{if(t.showSaved)return!!e.saved;if(!(t.activeCategory==="All"||e.category===t.activeCategory))return!1;let a=t.newsSearchQuery.trim().toLowerCase();return a?[e.headline,e.summary,e.source,e.ai_summary].filter(Boolean).join(" ").toLowerCase().includes(a):!0}),_e=e=>t.activeArchiveDate?e.postedAt:`${e.postedAt} ago`,Na=e=>/(\*\*?\s*critique|attempt\s*\d|prompt says|let'?s try|tighter version|word count|violat(?:e|es)|output only|valid json|the model|the prompt)/i.test(e),Oa=(e,a=140)=>{let r=e.split(/\s+/).filter(Boolean);if(r.length<=a)return e;let s=r.slice(0,a).join(" "),n=Math.max(s.lastIndexOf("."),s.lastIndexOf("?"),s.lastIndexOf("!"));return n>s.length*.45?s.slice(0,n+1).trim():`${s.replace(/[,:;.'"!\?\s]+$/,"")}...`},kt=e=>{let a=String(e||"").trim();for(let r=0;r<2;r+=1){let o=a.match(/^```(?:json)?\s*([\s\S]*?)\s*```$/i);if(o&&(a=o[1].trim()),!/^\s*\{[\s\S]*\}\s*$/.test(a))break;try{let s=JSON.parse(a);if(typeof s.summary=="string"){a=s.summary.trim();continue}}catch{break}break}return a=a.replace(/&lt;|&#60;/gi,"<").replace(/&gt;|&#62;/gi,">").replace(/<[^>]+>/g," ").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&#39;/g,"'").replace(/&apos;/g,"'").replace(/&quot;/g,'"').replace(/^["'{\s]+/,"").replace(/["'}\s]+$/,"").replace(/^summary["'\s]*:[\s"']*/i,"").replace(/\s+/g," ").trim(),Na(a)?"":Oa(a)},oe=(e,a)=>kt(a||"")||kt(e.summary)||e.headline,_a=e=>{let r=e?.closest(".detail-summary, .thread-item, .market-thread-update")?.querySelector(".briefing-capture-area");if(!r||!window.html2canvas)return;let o=document.createElement("div");o.className="briefing-export-staging";let s=r.cloneNode(!0);s.classList.add("briefing-export-surface"),o.appendChild(s),document.body.appendChild(o);let n=document.documentElement.dataset.theme==="light";window.html2canvas(s,{backgroundColor:n?"#f5f7fb":"#0f172a",scale:2,logging:!1,useCORS:!0}).then(i=>{let d=document.createElement("a");d.download="siftle-briefing.png",d.href=i.toDataURL("image/png"),d.click(),window.showActionToast?.("Briefing card image downloaded!")}).catch(()=>{window.showActionToast?.("Unable to download briefing card")}).finally(()=>{o.remove()})};window.downloadBriefingCard=_a;var nt=(e,a)=>{let r=e.split(/(?:\*\*|__)?(WHAT HAPPENED|KEY POINTS|TAKEAWAY)\s*:?\s*(?:\*\*|__)?\s*:?\s*/i);if(r.length<=1)return`<p class="briefing-text">${e}</p>`;let o='<div class="briefing-capture-area">';if(a){let n=a.headline||"Football Match Update";o+=`
    ...
    `}r[0].trim()&&(o+=`<p class="briefing-capture-intro">${r[0].trim()}</p>`);let s="";for(let n=1;n<r.length;n+=2){let i=r[n].trim().toUpperCase(),d=r[n+1]?r[n+1].trim():"";if(!d)continue;let u="";if(i==="KEY POINTS"){let f=d.split(/(?:•|\*|-)\s+/).map(p=>p.trim()).filter(Boolean);f.length>0?u=`<ul class="briefing-list">${f.map(p=>`<li>${p}</li>`).join("")}</ul>`:u=`<p class="briefing-text">${d}</p>`}else u=`<p class="briefing-text">${d}</p>`,i==="TAKEAWAY"&&(s=d);let m=i.toLowerCase().replace(/\s+/g,"-");o+=`
...
Trade and discuss here: ${d}`},Er=e=>{if(!w||!S)return;let a=qe(e),r=!t.checkedMarketEvidence[e.id],o=G(e),s=t.marketSnapshots[e.id],n=K(e),i=V(e);n&&!t.marketTradeOptionId&&(t.marketTradeOptionId=i[0]?.id||null);let d=er(e),u=!!(o&&!s),m=s?.yesPriceCents??(o?e.probability:0),f=s?.noPriceCents??(o?100-e.probability:0),p=u?"":o?`${m}\xA2`:"--",y=u?"":o?`${f}\xA2`:"--",l=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},c=!!l.optionId;n&&c&&t.marketOrderMode!=="sell"&&(t.marketOrderMode="sell"),n&&!c&&t.marketOrderMode==="sell"&&(t.marketOrderMode="buy");let b=n&&t.marketOrderMode==="sell"&&c?Math.max(0,Number(l.optionSharesUsdc)||0):0,k=b>0?b:Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,l),$=b>0?{min:0,max:b}:ta(t.marketOrderMode,t.marketTradeSide,l),T=t.marketOrderMode==="buy"?"$5-$10 USDC":`Up to $${R($.max)} USDC`,v=!t.walletAddress||t.hasLoadedPortfolioPositions,x=We(e,s),L=Yt(e,s),P=!!L;n||(t.marketTradeSide=mt(t.marketOrderMode,t.marketTradeSide,l));let N=!n&&!x&&!P&&v&&ee(t.marketOrderMode,"yes",l),H=!n&&!x&&!P&&v&&ee(t.marketOrderMode,"no",l),le=n?!x&&!P&&v&&(t.marketOrderMode==="sell"?c:!c&&!!d):!x&&!P&&v&&ee(t.marketOrderMode,t.marketTradeSide,l),O=x?"Market resolved":L||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),de=x?"Market resolved":L||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),be=n?k:aa(s,t.marketTradeSide,k,t.marketOrderMode,l),ce=t.marketOrderMode==="buy"?"Buy":"Exit",Z=n?"Pick one outcome":o?"Arc testnet live":"Contract not deployed";w.hidden=!0,S.hidden=!1,S.classList.add("fullscreen"),document.body.classList.add("detail-mode"),pr(e),Xt(e),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&z({force:!t.hasLoadedPortfolioPositions});let Be=n?!!l.optionId:l.yesSharesUsdc>0||l.noSharesUsdc>0,ye="";n&&Be&&t.walletAddress?ye=`
  ...
  `},ca=()=>{if(!w||!S)return;if(Re?.toggleAttribute("hidden",!0),je?.toggleAttribute("hidden",!0),re?.toggleAttribute("hidden",!0),Ae?.classList.add("active"),Le?.classList.remove("active"),Ue?.classList.remove("active"),window.setTimeout(()=>{t.activeSurface==="markets"&&I.forEach(n=>{Xt(n)})},750),t.selectedMarketId){let n=I.find(i=>i.id===t.selectedMarketId);if(n){Er(n);return}t.selectedMarketId=null,window.location.hash.startsWith("#market-")&&window.history.replaceState({},"","#markets");return}document.body.classList.remove("detail-mode"),S.hidden=!0,S.classList.remove("fullscreen"),w.hidden=!1,w.classList.add("markets-list");let e=I,r=`
    <nav class="market-timeframe-tabs" aria-label="Timeframe navigation">
      ${["All","Daily","Weekly","Sagas"].map(n=>{let i=t.activeMarketTimeframe===n,d=n==="All"?e.length:e.filter(m=>m.timeframe===n).length;return`
  ...
  `;if(t.loadingMarkets&&I.length===0){w.innerHTML=`
    ...
    `;if(t.activeMarketTimeframe==="All"){let n=e.filter(u=>u.timeframe==="Daily"),i=e.filter(u=>u.timeframe==="Weekly"),d=e.filter(u=>u.timeframe==="Sagas");o=`
      ${s("Daily","Ends in a day or two",n)}
      ${s("Weekly","Ends in a week",i)}
      ${s("Sagas (Long-term)","Narratives & futures",d)}
    `}else{let n=e.filter(u=>u.timeframe===t.activeMarketTimeframe),i=t.activeMarketTimeframe,d="";t.activeMarketTimeframe==="Daily"?d="Ends in a day or two":t.activeMarketTimeframe==="Weekly"?d="Ends in a week":t.activeMarketTimeframe==="Sagas"&&(i="Sagas (Long-term)",d="Narratives & futures"),o=`
      ${s(i,d,n)}
    `}w.innerHTML=`
    <header class="markets-header" style="box-sizing: border-box; width: 100%; display: block; padding-top: 18px;">
      <div style="display: flex; justify-content: space-between; align-items: center; width: 100%; gap: 12px; flex-wrap: wrap;">
  ...
  `;let a=(l="2026-07-19T23:59:59.000Z")=>{let c=document.getElementById("seasonTimer");J&&clearInterval(J);let b=()=>{let $=new Date(l).getTime()-new Date().getTime();if($<=0){c&&(c.innerText="Season Finished!"),J&&clearInterval(J);return}let T=Math.floor($/(1e3*60*60*24)),v=Math.floor($%(1e3*60*60*24)/(1e3*60*60)),x=Math.floor($%(1e3*60*60)/(1e3*60)),L=Math.floor($%(1e3*60)/1e3);c&&(c.innerText=`${T}d ${v}h ${x}m ${L}s`)};b(),J=setInterval(b,1e3)};a();let r=l=>l.map((c,b)=>{let k=Number(c.globalRank)||b+1,$=String(c.username||""),T=!!(t.walletAddress&&$.toLowerCase()===t.walletAddress.toLowerCase()),v=T&&t.profileUsername?t.profileUsername:c.displayName||$,x=T?`${t.profileUsername?v:j($)} (You)`:v.startsWith("0x")&&v.length===42?j(v):v,L=A(x),P=A(Ve(c.status)),N=c.nextSeasonDivision?`Division ${c.nextSeasonDivision}`:"Qualify",H=k<=10?"promotion-zone":"safety-zone",le=k<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
    ...
    `)},i=()=>{s("global");let l=document.getElementById("leaderboardListContainer"),c="global",b=xt(c);b&&l?(l.innerHTML=Tt()+r(b.players),b.seasonEndsAt&&a(b.seasonEndsAt)):n(10);let k=new URLSearchParams;t.walletAddress&&k.set("walletAddress",t.walletAddress);let $=k.toString();fetch(C(`/api/leaderboard/global${$?`?${$}`:""}`)).then(T=>T.json()).then(T=>{let v=$t(T.players||[],b?.players||[],!0);l&&(l.innerHTML=v.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players on the global leaderboard yet.</p>`:r(v)),Ze(c,{players:v,seasonEndsAt:T.seasonEndsAt}),a(T.seasonEndsAt)}).catch(T=>{console.error("Failed to load global leaderboard:",T),l&&(l.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading global leaderboard. Please try again.</p>`)})},d=l=>{s("division");let c=document.getElementById("leaderboardListContainer"),b=`division_${l||ke||"current"}`,k=xt(b);k&&c?(c.innerHTML=Tt()+o(k.players),k.divisionNumber&&(ke=k.divisionNumber),k.seasonEndsAt&&a(k.seasonEndsAt)):c&&l!==void 0&&(c.innerHTML=`
        <div class="leaderboard-skeleton" style="display: flex; flex-direction: column; gap: 12px; width: 100%;">
          ${Array.from({length:6}).map(()=>`
            <div style="height: 52px; background: rgba(255,255,255,0.02); border: 1px solid #1e1f2b; border-radius: 8px; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 0 16px;">
              <div style="display: flex; align-items: center; gap: 12px; width: 60%;">
      ...
      `);let $=new URLSearchParams;t.walletAddress&&$.set("walletAddress",t.walletAddress),l&&$.set("division",String(l));let T=$.toString();fetch(C(`/api/leaderboard/division${T?`?${T}`:""}`)).then(v=>v.json()).then(v=>{let x=v.divisionNumber||1,L=$t(v.players||[],k?.players||[],!1),P=v.totalDivisions||1,N=v.seasonEndsAt;ke=x;let H=document.getElementById("divisionTitleText");H&&(H.innerText=`Division ${x}`);let le=document.getElementById("divisionSelector");le&&(le.innerHTML=Array.from({length:P},(O,de)=>de+1).map(O=>`
          ...
          `).join("")),c&&(L.length===0?c.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No active players in this division.</p>`:c.innerHTML=L.map((O,de)=>{let be=de+1,ce=t.walletAddress&&O.username.toLowerCase()===t.walletAddress.toLowerCase(),Z=ce&&t.profileUsername?t.profileUsername:O.displayName||O.username,ft=A(Ve(O.status)),Be=ce?`${t.profileUsername?Z:j(O.username)} (You)`:Z.startsWith("0x")&&Z.length===42?j(Z):Z,ye=A(Be),U="safety-zone",D='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return be<=2?(U="promotion-zone",D='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):be>=5&&(U="relegation-zone",D='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
    ...
    `}let o=Ir(r?.outcome),s=ra(a,r),n=s.reduce((c,b)=>Math.max(c,b.payout),0),i=a.yesSharesUsdc+a.noSharesUsdc,d=r?.outcome??0,u=He().has(e.id),m=d===1?a.yesSharesUsdc:d===2?a.noSharesUsdc:0,f=d===1?r?.yesSharesUsdc??0:d===2?r?.noSharesUsdc??0:0,p=r?.volumeUsdc??0,y=m>0&&f>0?m/f*p:0,l=d===0?"":u?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':y>0?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${R(y)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>';return`
    <article class="portfolio-position-card">
      <div class="portfolio-position-top">
        <span class="category-chip ${e.category}">${W(e.category)}</span>
        <span>${o}</span>
  ...
  `},Br=async e=>{if(!t.walletAddress){h("Please sign in first.");return}let a=Me().find(o=>o.id===e),r=a?G(a):"";if(!a||!r){h("Market is not available.");return}try{t.claimingMarketIds[a.id]=!0,q(),E("claim_attempt"),ut();let o=await ya(r,t.walletAddress);E("claim_success"),o.won&&or(a.id),delete t.marketPositions[a.id],delete t.marketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.walletBalance=await te(t.walletAddress),await z(),h(o.won?`Claimed $${R(o.amountUsdc)}`:"No payout to claim"),B(),q()}catch(o){E("claim_failed"),h(o instanceof Error?o.message:"Claim failed")}finally{delete t.claimingMarketIds[a.id],q()}},Dr=e=>{if(!e)return"";let a=t.referralData,r=a?.referrals?.length?a.referrals.map(s=>{let n=s.displayName||j(s.walletAddress),i=s.remaining<=0;return`
