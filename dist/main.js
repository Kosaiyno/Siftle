...
`,ur=(e=4)=>`${ye("Loading stories")}${Array.from({length:e},pr).join("")}`,he=()=>`
...
`,St=e=>{let a=e.type==="tweet",r=a?`<a class="card-source-button twitter-btn" href="${e.sourceUrl}" target="_blank" rel="noreferrer" onclick="event.stopPropagation()">Open Tweet</a>`:`
      ${ir(e)}
  ...
  `},ve=()=>{if(!x)return;let e=Ea();if(x.hidden=!!(t.selectedStoryId||t.selectedThreadUrl),t.isLoading){x.innerHTML=ur(4);return}let a=Number(t.unlockConfig?.amountUsdc)||.001,r=M(t.newsSearchQuery.trim()),s=`
  ...
  `;if(e.length===0){let n=t.showSaved?[]:t.stories;if(n.length>0){x.innerHTML=s+n.map(St).join("");return}x.innerHTML=s+'<div class="portfolio-empty compact news-search-empty">No stories match that keyword yet.</div>';return}x.innerHTML=s+e.map(St).join("")},xt=e=>new Promise((a,r)=>{let o=new Image;o.crossOrigin="anonymous",o.onload=()=>a(o),o.onerror=()=>r(new Error(`Unable to load image: ${e}`)),o.src=e}),xe=(e,a,r,o,s,n)=>{e.beginPath(),e.moveTo(a+n,r),e.lineTo(a+o-n,r),e.quadraticCurveTo(a+o,r,a+o,r+n),e.lineTo(a+o,r+s-n),e.quadraticCurveTo(a+o,r+s,a+o-n,r+s),e.lineTo(a+n,r+s),e.quadraticCurveTo(a,r+s,a,r+s-n),e.lineTo(a,r+n),e.quadraticCurveTo(a,r,a+n,r),e.closePath()},hr=(e,a,r,o,s,n,i)=>{let l=a.split(/\s+/).filter(Boolean),u=[],f="";for(let m of l){let p=f?`${f} ${m}`:m;if(e.measureText(p).width<=s){f=p;continue}if(f&&u.push(f),f=m,u.length===i)break}if(f&&u.length<i&&u.push(f),l.length>0&&u.length===i){for(;e.measureText(`${u[i-1]}...`).width>s&&u[i-1].length>0;)u[i-1]=u[i-1].slice(0,-1).trim();u[i-1]=`${u[i-1]}...`}return u.forEach((m,p)=>e.fillText(m,r,o+p*n)),o+u.length*n},vr=(e,a,r,o,s,n,i)=>{let l=Math.max(s/a.naturalWidth,n/a.naturalHeight),u=s/l,f=n/l,m=(a.naturalWidth-u)/2,p=(a.naturalHeight-f)/2;e.save(),xe(e,r,o,s,n,i),e.clip(),e.drawImage(a,m,p,u,f,r,o,s,n),e.restore()},$t=e=>new Promise((a,r)=>{try{e.toBlob(o=>{o?a(o):r(new Error("Unable to export image"))},"image/png")}catch(o){r(o)}}),Tt=e=>e?e.replace(/&quot;/g,'"').replace(/&apos;/g,"'").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&nbsp;/g," ").replace(/&#39;/g,"'").replace(/&#34;/g,'"').replace(/&#38;/g,"&").replace(/&#60;/g,"<").replace(/&#62;/g,">").replace(/&#8216;/g,"'").replace(/&#8217;/g,"'").replace(/&#8220;/g,'"').replace(/&#8221;/g,'"').replace(/&#8211;/g,"\u2013").replace(/&#8212;/g,"\u2014").replace(/&#8230;/g,"...").replace(/&#(\d+);/g,(a,r)=>String.fromCharCode(Number(r))):"",yr=e=>e?e.startsWith("data:")||e.startsWith("./")||e.startsWith("/")||e.includes(window.location.host)?e:`${(window.SIFTLE_API_BASE||"").replace(/\/$/,"")}/api/proxy-image?url=${encodeURIComponent(e)}`:"",At=async(e,a=!0)=>{let r=document.createElement("canvas");r.width=1080,r.height=1120;let o=r.getContext("2d");if(!o)throw new Error("Canvas is not available");o.fillStyle="#f4f7fb",o.fillRect(0,0,r.width,r.height),o.shadowColor="rgba(23, 34, 72, 0.16)",o.shadowBlur=44,o.shadowOffsetY=18,o.fillStyle="#ffffff",xe(o,70,70,940,980,34),o.fill(),o.shadowColor="transparent";let s=await xt("/assets/siftle-logo-small.png").catch(()=>null);s&&o.drawImage(s,784,106,54,54),o.fillStyle="#071229",o.font="800 34px Inter, Arial, sans-serif",o.textAlign="left",o.fillText("Siftle",850,143),o.fillStyle="#6b748c",o.font="700 24px Inter, Arial, sans-serif",o.fillText(`${Tt(e.source)} - ${e.postedAt} ago`,110,140);let n=195;if(a){let l=await xt(yr(e.imageUrl)).catch(()=>null);l?vr(o,l,110,n,860,520,28):(o.fillStyle="#eef2ff",xe(o,110,n,860,520,28),o.fill())}else o.fillStyle="#eef2ff",xe(o,110,n,860,520,28),o.fill();let i=775;return o.fillStyle=e.category==="Sports"?"#dffaf4":e.category==="Tech"?"#e8eef6":e.category==="Anime"?"#efe7ff":e.category==="Gaming"?"#ffebd9":"#eee7ff",xe(o,110,i,118,42,21),o.fill(),o.fillStyle=e.category==="Sports"?"#11a98d":e.category==="Tech"?"#3f5f86":e.category==="Gaming"?"#d95c14":"#6f3cff",o.font="800 22px Inter, Arial, sans-serif",o.fillText(W(e.category),132,i+28),o.fillStyle="#07142f",o.font="680 44px Space Grotesk, Inter, Arial, sans-serif",hr(o,Tt(e.headline),110,888,860,54,4),r},oa=async e=>{let a=await At(e,!0);try{return await $t(a)}catch{return $t(await At(e,!1))}},sa=e=>`siftle-${e.headline.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"").slice(0,48)||"story"}.png`,na=async e=>{let a=await oa(e),r=URL.createObjectURL(a),o=document.createElement("a");o.href=r,o.download=sa(e),o.click(),URL.revokeObjectURL(r)},br=async e=>{let a=await oa(e),r=new File([a],sa(e),{type:"image/png"}),o={title:e.headline,text:`Siftle: ${e.headline}`,files:[r]};if(navigator.canShare?.(o)&&navigator.share){await navigator.share(o);return}await na(e)},kr=async(e,a)=>{let r=t.stories.find(o=>o.id===e);if(r){t.activeShareStoryId=null,ve(),y(a==="share"?"Preparing share image":"Preparing download"),A&&(A.textContent=a==="share"?"Preparing share image...":"Preparing image download...");try{a==="share"?await br(r):await na(r),y(a==="share"?"Share image ready":"Image saved"),A&&(A.textContent="Branded story image ready")}catch(o){console.warn(o),y("Image export unavailable"),A&&(A.textContent="Image export was cancelled or unavailable")}}},Mt=(e,a)=>{let r=t.unlockingSummaryUrl===e.sourceUrl,o=it(e);return`
...
`},wr=async(e,a)=>{if(!t.walletAddress){y("Session expired or wallet not connected. Please sign in."),qe();return}let r=Le().find(f=>f.id===e);if(!r||!oe(r))return;let o=ie(r).find(f=>f.id===a);if(!o){y("Choose a valid option.");return}!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",h(),await j(),t.marketTradeStatus=null);let s=t.marketSnapshots[r.id];if(We(r,s)){y("This market is resolved and can no longer be traded.");return}let n=t.marketPositions[r.id],i=t.marketOrderMode==="sell";if(!i&&n?.optionId){y("Your pick is already locked for this market.");return}if(i&&!n?.optionId){y("You do not have a pick to exit.");return}let l=Math.max(0,Number(n?.optionSharesUsdc)||0);if(i&&l<=0){y("Your pick is still loading. Please try again."),await j({force:!0});return}let u=i?l:Ie(Number(t.marketTradeAmount)||0,"buy","yes",void 0);t.marketTradeAmount=u,t.marketTradeOptionId=i&&n?.optionId||o.id,C("trade_attempt");try{t.marketTradeStatus=i?"Exiting your pick...":"Locking your pick...",h(),await ga(r.id,i?"sell":"buy",i&&n?.optionId||o.id,u,f=>{t.marketTradeStatus=f,h()}),delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await Oe(),t.walletAddress&&(t.walletBalance=await X(t.walletAddress)),await j({force:!0}),C(i?"trade_sell_success":"trade_buy_success"),y(i?"Pick exited":`Pick locked: ${o.label}`),t.tradeDrawerOpen=!1}catch(f){C("trade_failed"),y(f instanceof Error?f.message:"Trade failed")}finally{t.marketTradeStatus=null,B(),h()}},Sr=()=>{if(!$||!x)return;let e=t.stories.find(o=>o.sourceUrl===t.selectedThreadUrl);if(x.hidden=!0,$.hidden=!1,$.classList.add("fullscreen"),document.body.classList.add("detail-mode"),!e){$.innerHTML="";return}let a=t.loadingThreadUrl===e.sourceUrl,r=t.activeThread;if(a&&!r){$.innerHTML=`
  ...
  `},Tr=e=>{let a=Fe(e),o=t.marketSnapshots[e.id]?.yesPriceCents??e.probability,s=100-o,n=a.evidence[0],i=n?n.headline:"No updates yet",l=`${window.location.origin}${window.location.pathname}#market-${e.id}`;return`\u{1F6A8} *Siftle Market Alert* \u{1F6A8}
...
Trade and discuss here: ${l}`},Ar=e=>{if(!x||!$)return;let a=Fe(e),r=!t.checkedMarketEvidence[e.id],o=G(e),s=t.marketSnapshots[e.id],n=oe(e),i=ie(e);n&&!t.marketTradeOptionId&&(t.marketTradeOptionId=i[0]?.id||null);let l=Ka(e),u=!!(o&&!s),f=s?.yesPriceCents??(o?e.probability:0),m=s?.noPriceCents??(o?100-e.probability:0),p=u?"":o?`${f}\xA2`:"--",g=u?"":o?`${m}\xA2`:"--",c=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},d=!!c.optionId;n&&d&&t.marketOrderMode!=="sell"&&(t.marketOrderMode="sell"),n&&!d&&t.marketOrderMode==="sell"&&(t.marketOrderMode="buy");let v=n&&t.marketOrderMode==="sell"&&d?Math.max(0,Number(c.optionSharesUsdc)||0):0,k=v>0?v:Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,c),w=v>0?{min:0,max:v}:Qt(t.marketOrderMode,t.marketTradeSide,c),T=t.marketOrderMode==="buy"?"$5-$10 USDC":`Up to $${R(w.max)} USDC`,b=!t.walletAddress||t.hasLoadedPortfolioPositions,S=We(e,s),U=jt(e,s),P=!!U;n||(t.marketTradeSide=ct(t.marketOrderMode,t.marketTradeSide,c));let N=!n&&!S&&!P&&b&&Z(t.marketOrderMode,"yes",c),H=!n&&!S&&!P&&b&&Z(t.marketOrderMode,"no",c),de=n?!S&&!P&&b&&(t.marketOrderMode==="sell"?d:!d&&!!l):!S&&!P&&b&&Z(t.marketOrderMode,t.marketTradeSide,c),O=S?"Market resolved":U||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),ce=S?"Market resolved":U||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),be=n?k:Zt(s,t.marketTradeSide,k,t.marketOrderMode,c),pe=t.marketOrderMode==="buy"?"Buy":"Exit",K=n?"Pick one outcome":o?"Arc testnet live":"Contract not deployed";x.hidden=!0,$.hidden=!1,$.classList.add("fullscreen"),document.body.classList.add("detail-mode"),sr(e),Kt(e),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&j({force:!t.hasLoadedPortfolioPositions});let Be=n?!!c.optionId:c.yesSharesUsdc>0||c.noSharesUsdc>0,ke="";if(n&&Be&&t.walletAddress){let L=ra(c,s);ke=`
      <div class="user-market-position-box" style="margin: 16px 0; padding: 16px; background: rgba(59, 130, 246, 0.05); border: 1px solid rgba(59, 130, 246, 0.15); border-radius: 12px; font-family: 'Space Grotesk', sans-serif;">
        ...
        <div style="display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 1fr); gap: 12px;">
          ...
          <div>
            ...
            <strong style="font-size: 0.95rem; color: var(--market-text-main);">$${R(L)}</strong>
          </div>
        </div>
      </div>
    `}else Be&&t.walletAddress&&(ke=`
      <div class="user-market-position-box" style="margin: 16px 0; padding: 16px; background: rgba(59, 130, 246, 0.05); border: 1px solid rgba(59, 130, 246, 0.15); border-radius: 12px; font-family: 'Space Grotesk', sans-serif;">
    ...
    <div class="detail-container market-detail-container">
        ...
        <div class="market-detail-main">
          ...
          <section class="market-evidence-thread">
            ...
            <div class="market-thread-timeline">
              ${r?fr(3):a.evidence.length===0?'<div class="portfolio-empty compact">Related news is still loading for this market.</div>':a.evidence.map(L=>{let D=Rt(e,L),ue=t.unlockingSummaryUrl===L.sourceUrl;return`
                <article class="market-thread-update">
                  ...
                  <div class="market-thread-update-content">
                    ...
                    <div style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
                      ...
                      <button type="button" class="market-thread-source-link" data-unlock-briefing-url="${encodeURIComponent(L.sourceUrl)}" ${ue?"disabled":""}>${ue?"Preparing...":"AI briefing"}</button>
                    </div>
                    ${Ee(D)}
                    ${ue?`<div style="margin-top: 12px;">${he()}</div>`:re(D)?t.loadingSummaryUrl===L.sourceUrl?`<div style="margin-top: 12px;">${he()}</div>`:it(D)?`<div style="margin-top: 12px;">${lt(D)}</div>`:`<div style="margin-top: 12px;">${ot(ae(D,t.aiSummaries[L.sourceUrl]),D)}</div>`:""}
                  </div>
                </article>
              `}).join("")}
            </div>
      ...
      <div class="sticky-trade-bar">
        ...
        <button class="sticky-trade-btn" type="button" id="openTradeDrawerBtn" ${S||P?"disabled":""}>
          ${S?"Market Resolved":U||(n?d?"Pick Locked":"Pick Outcome":"Trade Market")}
        </button>
      </div>
      ...
      <div class="trade-drawer ${t.tradeDrawerOpen?"open":""}" id="tradeDrawer">
        ...
        <div class="trade-drawer-body">
          ...
          <div class="market-action-grid">
            ${n?i.map(L=>{let D=t.marketTradeOptionId===L.id||c.optionId===L.id,ue=S||P||t.marketOrderMode==="sell"||d||!b;return`
                  <button type="button" class="market-side option ${D?"active":""} ${ue?"disabled":""}" data-market-option-id="${M(L.id)}" ${ue?"disabled":""}>
                    <span>${M(L.label)}</span>
              ...
              `:`
                ...
                <button type="button" class="market-side no ${t.marketTradeSide==="no"?"active":""} ${H?"":"disabled"}" data-market-trade-side="no" ${H?"":"disabled"} title="${H?"No":ce}">
                  <span>No</span>
                  <strong>${g}</strong>
                  ${H?"":`<small>${ce}</small>`}
                </button>
          ...
          <div class="market-amount-panel">
            ...
            <div class="market-amount-input-row">
              <span>$</span>
              <input id="marketAmountInput" type="number" min="${w.min.toFixed(2)}" max="${Math.max(w.min,w.max).toFixed(2)}" step="0.01" inputmode="decimal" value="${k}" data-market-amount ${S||P?"disabled":""} />
              <span>USDC</span>
            </div>
          </div>
  ...
  `},ia=()=>{if(!x||!$)return;if(He?.toggleAttribute("hidden",!0),Re?.toggleAttribute("hidden",!0),te?.toggleAttribute("hidden",!0),Ue?.classList.add("active"),Pe?.classList.remove("active"),Ce?.classList.remove("active"),window.setTimeout(()=>{t.activeSurface==="markets"&&E.forEach(n=>{Kt(n)})},750),t.selectedMarketId){let n=E.find(i=>i.id===t.selectedMarketId);if(n){Ar(n);return}t.selectedMarketId=null,window.location.hash.startsWith("#market-")&&window.history.replaceState({},"","#markets");return}document.body.classList.remove("detail-mode"),$.hidden=!0,$.classList.remove("fullscreen"),x.hidden=!1,x.classList.add("markets-list");let e=E,r=`
  ...
  `;let a=(c="2026-07-19T23:59:59.000Z")=>{let d=document.getElementById("seasonTimer");J&&clearInterval(J);let v=()=>{let w=new Date(c).getTime()-new Date().getTime();if(w<=0){d&&(d.innerText="Season Finished!"),J&&clearInterval(J);return}let T=Math.floor(w/(1e3*60*60*24)),b=Math.floor(w%(1e3*60*60*24)/(1e3*60*60)),S=Math.floor(w%(1e3*60*60)/(1e3*60)),U=Math.floor(w%(1e3*60)/1e3);d&&(d.innerText=`${T}d ${b}h ${S}m ${U}s`)};v(),J=setInterval(v,1e3)};a();let r=c=>c.map((d,v)=>{let k=Number(d.globalRank)||v+1,w=String(d.username||""),T=!!(t.walletAddress&&w.toLowerCase()===t.walletAddress.toLowerCase()),b=T&&t.profileUsername?t.profileUsername:d.displayName||w,S=T?`${t.profileUsername?b:q(w)} (You)`:b.startsWith("0x")&&b.length===42?q(b):b,U=M(S),P=M(Ve(d.status)),N=d.nextSeasonDivision?`Division ${d.nextSeasonDivision}`:"Qualify",H=k<=10?"promotion-zone":"safety-zone",de=k<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
    ...
    `)},i=()=>{s("global");let c=document.getElementById("leaderboardListContainer"),d="global",v=bt(d);v&&c?(c.innerHTML=wt()+r(v.players),v.seasonEndsAt&&a(v.seasonEndsAt)):n(10);let k=new URLSearchParams;t.walletAddress&&k.set("walletAddress",t.walletAddress);let w=k.toString();fetch(I(`/api/leaderboard/global${w?`?${w}`:""}`)).then(T=>T.json()).then(T=>{let b=kt(T.players||[],v?.players||[],!0);c&&(c.innerHTML=b.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players on the global leaderboard yet.</p>`:r(b)),Qe(d,{players:b,seasonEndsAt:T.seasonEndsAt}),a(T.seasonEndsAt)}).catch(T=>{console.error("Failed to load global leaderboard:",T),c&&(c.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading global leaderboard. Please try again.</p>`)})},l=c=>{s("division");let d=document.getElementById("leaderboardListContainer"),v=`division_${c||we||"current"}`,k=bt(v);k&&d?(d.innerHTML=wt()+o(k.players),k.divisionNumber&&(we=k.divisionNumber),k.seasonEndsAt&&a(k.seasonEndsAt)):d&&c!==void 0&&(d.innerHTML=`
        <div class="leaderboard-skeleton" style="display: flex; flex-direction: column; gap: 12px; width: 100%;">
          ${Array.from({length:6}).map(()=>`
            <div style="height: 52px; background: rgba(255,255,255,0.02); border: 1px solid #1e1f2b; border-radius: 8px; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 0 16px;">
              <div style="display: flex; align-items: center; gap: 12px; width: 60%;">
      ...
      `);let w=new URLSearchParams;t.walletAddress&&w.set("walletAddress",t.walletAddress),c&&w.set("division",String(c));let T=w.toString();fetch(I(`/api/leaderboard/division${T?`?${T}`:""}`)).then(b=>b.json()).then(b=>{let S=b.divisionNumber||1,U=kt(b.players||[],k?.players||[],!1),P=b.totalDivisions||1,N=b.seasonEndsAt;we=S;let H=document.getElementById("divisionTitleText");H&&(H.innerText=`Division ${S}`);let de=document.getElementById("divisionSelector");de&&(de.innerHTML=Array.from({length:P},(O,ce)=>ce+1).map(O=>`
            <option value="${O}" ${O===S?"selected":""}>Division ${O}</option>
          `).join("")),d&&(U.length===0?d.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No active players in this division.</p>`:d.innerHTML=U.map((O,ce)=>{let be=ce+1,pe=t.walletAddress&&O.username.toLowerCase()===t.walletAddress.toLowerCase(),K=pe&&t.profileUsername?t.profileUsername:O.displayName||O.username,ut=M(Ve(O.status)),Be=pe?`${t.profileUsername?K:q(O.username)} (You)`:K.startsWith("0x")&&K.length===42?q(K):K,ke=M(Be),L="safety-zone",D='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return be<=2?(L="promotion-zone",D='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):be>=5&&(L="relegation-zone",D='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
                <div class="leaderboard-row ${pe?"user-highlight":""} ${L}" role="listitem" style="display: flex !important; align-items: center !important; justify-content: space-between !important; padding: 12px 16px !important; border-bottom: 1px solid rgba(255, 255, 255, 0.06) !important; margin-bottom: 0 !important; background: transparent !important; font-family: 'Space Grotesk', sans-serif !important;">
                  ...
                  <div style="flex: 1.5; display: flex; align-items: center; gap: 8px; min-width: 0;">
                    ...
                    <span class="leaderboard-username" style="font-weight: 600; color: #ffffff; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${ke}</span>
                  </div>
                  <!-- Center Side: Points -->
                  <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
      ...
      <article class="portfolio-position-card">
        ...
        <div class="portfolio-position-footer">
          ...
          ${v?S?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':U?'<button type="button" class="connect-wallet-btn" disabled style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; opacity: 0.7 !important; cursor: wait !important;">Claiming...</button>':k?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${R(T)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>':""}
        </div>
      </article>
    `}let o=Mr(r?.outcome),s=Xt(a,r),n=s.reduce((d,v)=>Math.max(d,v.payout),0),i=a.yesSharesUsdc+a.noSharesUsdc,l=r?.outcome??0,u=_e().has(e.id),f=l===1?a.yesSharesUsdc:l===2?a.noSharesUsdc:0,m=l===1?r?.yesSharesUsdc??0:l===2?r?.noSharesUsdc??0:0,p=r?.volumeUsdc??0,g=f>0&&m>0?f/m*p:0,c=l===0?"":u?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':g>0?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${R(g)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>';return`
    <article class="portfolio-position-card">
      <div class="portfolio-position-top">
        <span class="category-chip ${e.category}">${W(e.category)}</span>
        <span>${o}</span>
  ...
  `},Lr=async e=>{if(!t.walletAddress){y("Please sign in first.");return}let a=Le().find(o=>o.id===e),r=a?G(a):"";if(!a||!r){y("Market is not available.");return}try{t.claimingMarketIds[a.id]=!0,F(),C("claim_attempt"),pt();let o=await ha(r,t.walletAddress);C("claim_success"),o.won&&Xa(a.id),delete t.marketPositions[a.id],delete t.marketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.walletBalance=await X(t.walletAddress),await j(),y(o.won?`Claimed $${R(o.amountUsdc)}`:"No payout to claim"),B(),F()}catch(o){C("claim_failed"),y(o instanceof Error?o.message:"Claim failed")}finally{delete t.claimingMarketIds[a.id],F()}},Ur=e=>{if(!e)return"";let a=t.referralData,r=a?.referrals?.length?a.referrals.map(s=>{let n=s.displayName||q(s.walletAddress),i=s.remaining<=0;return`
  ...
  `},h=()=>{if(Nt.forEach(e=>{let a=e.dataset.bottomNav;e.classList.toggle("active",a==="saved"?t.showSaved:a===t.activeSurface&&!t.showSaved)}),t.activeSurface==="markets"){ia();return}if(t.activeSurface==="portfolio"){F();return}if(t.activeSurface==="leaderboard"){la();return}da(),Yt(),ve(),xr(),z&&(z.value=t.activeArchiveDate??"")};Xe.textContent=_t();te?.addEventListener("click",e=>{let r=e.target.closest("[data-category]");r&&(t.activeCategory=r.dataset.category,window.history.pushState({},"","#feed"),Y(),h(),ze(),ne(t.activeCategory))});x?.addEventListener("input",e=>{let a=e.target;if(a.id!=="newsSearchInput")return;let r=a.selectionStart??a.value.length,o=a.selectionEnd??a.value.length;t.newsSearchQuery=a.value,ve();let s=x?.querySelector("#newsSearchInput");s&&(s.focus(),s.setSelectionRange(r,o))});Ue?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,window.history.pushState({},"","#markets"),Y(),h()});Pe?.addEventListener("click",()=>{t.activeSurface="feed",t.showSaved=!1,window.history.pushState({},"","#feed"),Y(),h(),ze(),ne(t.activeCategory)});Ce?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=!1,window.history.pushState({},"","#portfolio"),Y(),h()});Q?.addEventListener("click",()=>{t.walletAddress?(window.location.hash="#portfolio",se()):qe()});document.addEventListener("click",e=>{let a=e.target,r=a.closest(".copy-address-btn");if(r){let i=r.getAttribute("data-address");i&&navigator.clipboard.writeText(i).then(()=>{y("Wallet address copied!")})}let o=a.closest("[data-claim-market]");if(o){let i=o.getAttribute("data-claim-market");i&&Lr(i);return}if(a.closest("[data-open-referrals]")){t.referralPanelOpen=!t.referralPanelOpen,!t.referralData&&!t.loadingReferralData&&Ae(),F();return}if(a.closest("[data-close-referrals]")){t.referralPanelOpen=!1,F();return}if(a.closest("[data-refresh-referrals]")){t.referralError=null,Ae(),F();return}let s=a.closest("[data-copy-referral-code]");if(s){let i=s.getAttribute("data-copy-referral-code")||"";i&&navigator.clipboard.writeText(i).then(()=>y("Invite code copied"));return}let n=a.closest("[data-copy-referral-link]");if(n){let i=n.getAttribute("data-copy-referral-link")||"";i&&navigator.clipboard.writeText(i).then(()=>y("Invite link copied"));return}a.closest("[data-connect-wallet]")&&(t.walletAddress?Ct():qe())});Nt.forEach(e=>{e.addEventListener("click",()=>{let a=e.dataset.bottomNav;t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=a==="saved",a==="markets"?(t.activeSurface="markets",window.history.pushState({},"","#markets")):a==="portfolio"?(t.activeSurface="portfolio",window.history.pushState({},"","#portfolio")):a==="leaderboard"?(t.activeSurface="leaderboard",window.history.pushState({},"","#leaderboard")):(t.activeSurface="feed",window.history.pushState({},"","#feed"),ze(),ne(t.activeCategory),a==="saved"&&(Qa(),rt(),Te())),Y(),h()})});z?.addEventListener("change",()=>{t.activeArchiveDate=z.value||null,window.history.pushState({},"","#feed"),Y(),h(),ne(t.activeCategory)});La?.addEventListener("click",()=>{t.activeArchiveDate=null,z&&(z.value=""),window.history.pushState({},"","#feed"),Y(),h(),ne(t.activeCategory)});x?.addEventListener("click",async e=>{let a=e.target;if(a.closest("#editUsernameBtn")){let d=x?.querySelector(".username-display-row"),v=x?.querySelector("#usernameEditForm");if(d&&v){d.style.display="none",v.style.display="flex";let k=v.querySelector("#usernameInput");k&&k.focus()}return}if(a.closest("#cancelUsernameBtn")){let d=x?.querySelector(".username-display-row"),v=x?.querySelector("#usernameEditForm");d&&v&&(d.style.display="flex",v.style.display="none");return}let s=a.closest("#saveUsernameBtn");if(s){let v=x?.querySelector("#usernameEditForm")?.querySelector("#usernameInput");if(v){let k=v.value.trim().slice(0,15),w=s,T=w.textContent||"Save";w.disabled=!0,w.textContent="Saving...",Va(k),t.profileNotice=null;try{t.walletAddress&&await le(!1),t.profileNotice={type:"success",message:"Username saved to your shared leaderboard profile."},y("Username updated"),F()}catch(b){let S=b instanceof Error?b.message:"Username save failed";t.profileNotice={type:"error",message:S},y(S),w.disabled=!1,w.textContent=T,F()}}return}let n=a.closest("[data-timeframe]");if(n){let d=n.dataset.timeframe;t.activeMarketTimeframe=d,ia();return}let i=a.closest("[data-market-id]");if(i){t.selectedMarketId=i.dataset.marketId??null,C("market_view"),window.history.pushState({},"",`#market-${t.selectedMarketId}`),h(),window.scrollTo({top:0,behavior:"smooth"});return}let l=a.closest("[data-thread-story-id]"),u=a.closest("[data-export-id]"),f=a.closest("[data-export-action]"),m=a.closest("[data-story-id]");if(l){e.stopPropagation();let d=t.stories.find(v=>v.id===Number(l.dataset.threadStoryId));d&&qa(d);return}let p=a.closest(".mobile-bookmark-btn, .bookmark-button");if(p){e.stopPropagation();let d=p.dataset.bookmarkUrl||"",v=t.stories.find(k=>k.sourceUrl===d);if(!v)return;v.saved=!v.saved,v.saved?ee.add(d):ee.delete(d),Ma(),y(v.saved?"Saved to your list":"Removed from saved"),ve();return}if(f){e.stopPropagation(),kr(Number(f.dataset.exportStoryId),f.dataset.exportAction);return}if(u){e.stopPropagation();let d=Number(u.dataset.exportId);t.activeShareStoryId=t.activeShareStoryId===d?null:d,ve();return}if(!m||a.closest("a"))return;let g=Number(m.dataset.storyId),c=t.stories.find(d=>d.id===g);if(c&&c.type==="tweet"){e.stopPropagation(),window.open(c.sourceUrl,"_blank","noreferrer");return}zt(g,!0)});x?.addEventListener("keydown",e=>{let r=e.target.closest("[data-story-id]");if(!r||e.key!=="Enter"&&e.key!==" ")return;e.preventDefault();let o=Number(r.dataset.storyId),s=t.stories.find(n=>n.id===o);if(s&&s.type==="tweet"){window.open(s.sourceUrl,"_blank","noreferrer");return}zt(o)});$?.addEventListener("click",e=>{let a=e.target,r=a.closest("[data-unlock-briefing]");if(r){let m=t.stories.find(p=>p.id===Number(r.dataset.unlockBriefing));m&&tt(m);return}let o=a.closest("[data-unlock-briefing-url]");if(o){let m=decodeURIComponent(o.dataset.unlockBriefingUrl||""),p=Ha(m);p&&(re(p)?je(p):tt(p));return}if(a.closest("[data-back-markets]")){t.selectedMarketId=null,t.tradeDrawerOpen=!1,window.history.pushState({},"","#markets"),h();return}if(a.closest("#openTradeDrawerBtn")){let m=E.find(c=>c.id===t.selectedMarketId);if(m){if(We(m,t.marketSnapshots[m.id])){y("This market is resolved and can no longer be traded.");return}if(jt(m,t.marketSnapshots[m.id])){y("Trading is locked 20 minutes before kickoff.");return}}t.tradeDrawerOpen=!0,C("trade_drawer_open");let p=$.querySelector("#tradeDrawer"),g=$.querySelector("#tradeDrawerBackdrop");p?.classList.add("open"),g?.classList.add("open");return}if(a.closest("#closeTradeDrawerBtn")||a.closest("#tradeDrawerBackdrop")){t.tradeDrawerOpen=!1;let m=$.querySelector("#tradeDrawer"),p=$.querySelector("#tradeDrawerBackdrop");m?.classList.remove("open"),p?.classList.remove("open");return}if(a.closest("#shareWhatsAppBtn")){let m=E.find(p=>p.id===t.selectedMarketId);if(m){let p=Tr(m),g=`https://api.whatsapp.com/send?text=${encodeURIComponent(p)}`;window.open(g,"_blank")}return}let s=a.closest("[data-market-trade]");if(s&&t.selectedMarketId){let m=s.dataset.marketTrade;nr(t.selectedMarketId,m);return}let n=a.closest("[data-market-option-trade]");if(n&&t.selectedMarketId){let m=n.dataset.marketOptionTrade||t.marketTradeOptionId||"";wr(t.selectedMarketId,m);return}let i=a.closest("[data-market-option-id]");if(i){if(i.disabled||i.classList.contains("disabled"))return;t.marketTradeOptionId=i.dataset.marketOptionId||null,h();return}let l=a.closest("[data-market-trade-side]");if(l){if(l.disabled||l.classList.contains("disabled"))return;let m=E.find(c=>c.id===t.selectedMarketId),p=m?t.marketPositions[m.id]:void 0,g=l.dataset.marketTradeSide;if(!Z(t.marketOrderMode,g,p))return;t.marketTradeSide=g,h();return}let u=a.closest("[data-market-order-mode]");if(u){t.marketOrderMode=u.dataset.marketOrderMode;let m=E.find(g=>g.id===t.selectedMarketId),p=m?t.marketPositions[m.id]:void 0;t.marketTradeSide=ct(t.marketOrderMode,t.marketTradeSide,p),t.marketTradeAmount=Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,p),h();return}a.closest("[data-back-to-feed]")&&ja()});$?.addEventListener("input",e=>{let a=e.target;if(!a.matches("[data-market-amount]"))return;let r=E.find(u=>u.id===t.selectedMarketId),o=r?t.marketSnapshots[r.id]:void 0,s=r?t.marketPositions[r.id]:void 0,n=Number(a.value);t.marketTradeAmount=Number.isFinite(n)?n:0;let i=r&&oe(r)?t.marketTradeAmount:Zt(o,t.marketTradeSide,t.marketTradeAmount,t.marketOrderMode,s),l=$.querySelector(".market-inline-payout strong");l&&(l.textContent=`$${R(i)}`)});$?.addEventListener("focusin",e=>{e.target.matches("[data-market-amount]")&&document.body.classList.add("market-amount-focused")});$?.addEventListener("focusout",e=>{let a=e.target;if(a.matches("[data-market-amount]")){let r=E.find(s=>s.id===t.selectedMarketId),o=r?t.marketPositions[r.id]:void 0;t.marketTradeAmount=Ie(Number(a.value)||0,t.marketOrderMode,t.marketTradeSide,o),a.value=String(t.marketTradeAmount),window.setTimeout(()=>document.body.classList.remove("market-amount-focused"),120)}});window.addEventListener("popstate",se);window.addEventListener("hashchange",se);window.addEventListener("focus",async()=>{if(t.walletAddress){let e=t.walletBalance,a=await X(t.walletAddress);t.walletBalance=a,B(),(!e||parseFloat(e)===0)&&parseFloat(a)>0&&(console.log("[X402] Balance changed from 0 to positive. Triggering Gateway warmup..."),ba())}});Ge?.addEventListener("click",()=>{if(!Je||!Ge)return;let e=!Je.hidden;Je.hidden=e,Ge.setAttribute("aria-expanded",String(!e))});document.addEventListener("click",e=>{let a=e.target;!a.closest(".share-control")&&t.activeShareStoryId!==null&&(t.activeShareStoryId=null,ve());let r=a.closest("[data-menu-action]");if(!r)return;let o={today:"Showing today's brief",saved:`${t.stories.filter(s=>s.saved).length} saved stories`,archive:t.archiveDates.length>0?"Choose a saved day from the archive selector":"No saved days yet"};A&&(A.textContent=o[r.dataset.menuAction??"today"]),r.dataset.menuAction==="today"&&(t.showSaved=!1,t.activeArchiveDate=null,z&&(z.value=""),Y(),ze(),ne(t.activeCategory)),r.dataset.menuAction==="saved"&&(da(),rt(),Te(),t.showSaved=!0,document.querySelector("#archiveControls")?.classList.remove("mobile-open"),Y(),h())});var Pr=async()=>{try{let e=await fetch(I("/api/summary/unlock-config"));e.ok&&(t.unlockConfig=await e.json(),h())}catch(e){console.error("Failed to prefetch unlock config:",e)}};h();B();Pr();Aa().then(()=>{or(),B(),window.setTimeout(Br,1200)});var Cr=document.querySelector(".brand-lockup");Cr?.addEventListener("click",()=>{window.location.hash="#feed"});se();var Er=document.querySelector("#mobileArchiveCard"),ge=document.querySelector("#archiveControls");Er?.addEventListener("click",()=>{if(!ge)return;ge.classList.toggle("mobile-open")&&setTimeout(()=>ge.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Ir=document.querySelector("#archivePill");Ir?.addEventListener("click",e=>{if(e.stopPropagation(),!ge)return;ge.classList.toggle("mobile-open")&&setTimeout(()=>ge.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Ne=!1,Ut=!1,Br=()=>{Ut||(Ut=!0,(async()=>{let e=await Oe();if(Ne=!!e,e){t.walletConnecting=!0,B();try{let a=await va();Ne=!1,t.walletConnecting=!1,a?(t.walletAddress=await Oe(),t.walletAddress&&(fe(),t.walletBalance=await X(t.walletAddress),await j()),B(),t.activeSurface==="portfolio"&&h()):(t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),y("Session expired. Please sign in again."),B(),h())}catch(a){console.warn(a),Ne=!1,t.walletConnecting=!1,t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),y("Session expired. Please sign in again."),B(),h()}}await ya(a=>{Ne||(t.walletAddress=a,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),a&&le(!1).catch(r=>console.error("Failed to report leaderboard entry:",r)),t.marketPositions={},t.hasLoadedPortfolioPositions=!1,B(),a?(Ae(),X(a).then(r=>{t.walletBalance=r,B(),t.activeSurface==="portfolio"&&h()}),j()):t.activeSurface==="portfolio"&&h())})})())};C("app_open");document.addEventListener("click",e=>{let r=e.target.closest("a, button");if(r){let o=r.className||"",s=typeof o=="string"?o:r.getAttribute("class")||"",n=r.getAttribute("href")||"";!(r.hasAttribute("data-unlock-briefing")||r.hasAttribute("data-unlock-briefing-url")||r.classList.contains("summary-btn")||r.textContent?.trim()==="AI briefing"||r.textContent?.trim().includes("Unlock via"))&&(s.includes("source-button")||s.includes("source-btn")||s.includes("source-link")||r.textContent?.trim()==="Open source")&&!s.includes("disabled")&&n!=="#"&&C("open_source")}},!0);
