import"./chunks/chunk-ZUUPKAA6.js";var Be=[];var Ve="https://faucet.circle.com/",pt="siftle_backend_wallet_migration_notice",qe=null,D=()=>(qe||(qe=import("./chunks/arc-7OD5HKVW.js")),qe),R=e=>e.length>10?`${e.slice(0,6)}...${e.slice(-4)}`:e,ir=async()=>(await D()).connectArcWallet(),ne=async e=>(await D()).readArcUsdcBalance(e),lr=async(e,r,a,o)=>(await D()).payAiBriefingUnlock(e,r,a,o),dr=e=>{D().then(r=>r.resolveLocalTestMarketYes(e))},cr=async e=>(await D()).readArcMarketSnapshot(e);var Lt=async(e,r)=>(await D()).readArcMarketState(e,r),ur=async(e,r,a,o,s,n,i)=>(await D()).executeArcMarketOrder(e,r,a,o,s,n,i),pr=async(e,r,a,o,s)=>(await D()).executeArcOptionMarketOrder(e,r,a,o,s),Pt=()=>{D().then(e=>e.disconnectArcWallet())},mr=async(e,r)=>(await D()).claimArcMarketPayout(e,r),De=async()=>(await D()).getConnectedArcWallet(),fr=async()=>(await D()).validateArcSession(),gr=async e=>(await D()).subscribeArcWallet(e),hr=async()=>(await D()).triggerGatewayWarmup(),vr=["Sports"],br="https://siftle.onrender.com",yr=()=>{let e=(window.SIFTLE_API_BASE||"").replace(/\/$/,"");if(e)return e;let r=typeof window<"u"?window.location.hostname.toLowerCase():"";return r==="siftle.xyz"||r.endsWith(".siftle.xyz")||r.endsWith(".vercel.app")?br:""},kr=yr(),I=e=>`${kr}${e}`,Ct="siftle_theme",wr=()=>{try{return window.localStorage.getItem(Ct)==="light"?"light":"dark"}catch{return"dark"}},we=wr(),It="organic";function Sr(){try{let e=localStorage.getItem("siftle_traffic_source");if(!e){let r=new URLSearchParams(window.location.search),a=r.get("ref")||r.get("utm_source");if(a)a=a.trim().toLowerCase(),a==="twitter"&&(a="x"),a==="instagram"&&(a="ig"),a==="whatsapp"&&(a="wa"),a==="discord"&&(a="dc"),(a==="google_search"||a==="google-search")&&(a="google"),["x","ig","wa","dc","google","organic","briefing"].includes(a)?e=a:e=a.slice(0,20);else{let o=document.referrer;o&&(/twitter\.com|x\.com|t\.co/i.test(o)?e="x":/instagram\.com/i.test(o)?e="ig":/whatsapp\.com|wa\.me/i.test(o)?e="wa":/discord\.com|discordapp\.com/i.test(o)?e="dc":/google\.com|google\.co/i.test(o)&&(e="google"))}e||(e="organic"),localStorage.setItem("siftle_traffic_source",e)}It=e}catch(e){console.error("Failed to initialize traffic source:",e)}}Sr();function U(e,r,a){fetch(I("/api/analytics"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:e,source:It,storyUrl:r,headline:a})}).catch(o=>console.error("Failed to track event:",o))}var t={activeSurface:"feed",profileUsername:null,selectedMarketId:null,marketOrderMode:"buy",marketTradeSide:"yes",marketTradeOptionId:null,marketTradeAmount:2,marketSnapshots:{},marketPositions:{},marketEvidenceOverrides:{},loadingMarkets:!0,checkedMarketEvidence:{},checkedMarketSnapshots:{},loadingMarketSnapshots:{},loadingMarketEvidence:{},loadingPortfolioPositions:!1,marketTradeStatus:null,hasLoadedPortfolioPositions:!1,walletConnecting:!1,walletAddress:null,walletBalance:null,activeCategory:"Sports",stories:[],isLoading:!1,selectedStoryId:null,aiSummaries:{},loadingSummaryUrl:null,unlockingSummaryUrl:null,archiveDates:[],activeArchiveDate:null,activeShareStoryId:null,selectedThreadUrl:null,activeThread:null,loadingThreadUrl:null,feedScrollY:0,hasLoadedFeed:!1,showSaved:!1,tradeDrawerOpen:!1,activeMarketTimeframe:"All",profileNotice:null,portfolioMarketPreviews:[],referralPanelOpen:!1,referralData:null,referralError:null,loadingReferralData:!1,portfolioPositionsLoadedAt:0,unlockConfig:null,newsSearchQuery:"",briefingStatusByUrl:{},claimingMarketIds:{}};var G="global",Z=!1,ee=null,mt=!1,ft=!1,gt=new URLSearchParams(window.location.search).get("ref")||localStorage.getItem("siftle_pending_referral_code")||"";gt&&localStorage.setItem("siftle_pending_referral_code",gt.trim().toUpperCase());var Et=20,E=Be,xr=(...e)=>{let r=new Map;return e.flat().forEach(a=>{a?.id&&r.set(a.id,{...r.get(a.id)||{},...a})}),Array.from(r.values())},Te=()=>xr(t.portfolioMarketPreviews,E,Be),$r=async()=>{t.loadingMarkets=!0,E.length===0&&(E=Be);try{let e=new AbortController,r=window.setTimeout(()=>e.abort(),3500),a=await fetch(I("/api/markets"),{signal:e.signal});if(window.clearTimeout(r),a.ok){let o=await a.json();Array.isArray(o)&&o.length>0&&(E=o)}}catch(e){console.error("Failed to load markets:",e)}finally{t.loadingMarkets=!1}},Bt=async()=>{try{let e=await fetch(I("/api/portfolio/markets"));if(!e.ok)return;let r=await e.json();Array.isArray(r)&&(t.portfolioMarketPreviews=r.map(a=>({threadStoryId:0,updates:0,movement:0,evidence:[],...a})))}catch(e){console.warn(e)}},_t="siftle.savedUrls",ie=new Set,rt=()=>{try{let e=localStorage.getItem(_t)||"[]",r=JSON.parse(e);ie=new Set(r.filter(Boolean))}catch{ie=new Set}},Tr=()=>{try{localStorage.setItem(_t,JSON.stringify(Array.from(ie)))}catch{}},Se=()=>{if(Array.isArray(t.stories))for(let e of t.stories)e.saved=!!ie.has(e.sourceUrl)};rt();Se();var Qe=document.querySelector("#dateLabel"),le=document.querySelector("#categoryTabs"),S=document.querySelector("#storyList"),$=document.querySelector("#storyDetail"),Ye=document.querySelector("#menuButton"),Ge=document.querySelector("#menuPanel"),P=document.querySelector("#menuStatus"),j=document.querySelector("#archiveDateSelect"),ht=document.querySelector("#archiveStatus"),Mr=document.querySelector("#todayButton"),He=document.querySelector(".brief-hero"),Re=document.querySelector("#archiveControls"),Me=document.querySelector("[data-surface='markets']"),Ae=document.querySelector("[data-surface='feed']"),Ue=document.querySelector("[data-surface='portfolio']"),oe=document.querySelector("#walletButton"),ye=document.querySelector("[data-theme-toggle]"),Ar=document.getElementById("guideToggleButton"),Dt=Array.from(document.querySelectorAll("[data-bottom-nav]")),Je,Ur=()=>{if(!ye)return;let r=`Switch to ${we==="light"?"dark":"light"} mode`;ye.setAttribute("aria-label",r),ye.title=r,ye.dataset.activeTheme=we},Nt=e=>{we=e,document.documentElement.dataset.theme=e;try{window.localStorage.setItem(Ct,e)}catch{}Ur()};Nt(we);var _=()=>{if(oe){let e=oe.querySelector(".wallet-button-label");oe.classList.toggle("connected",!!t.walletAddress),oe.disabled=t.walletConnecting,oe.setAttribute("aria-label",t.walletAddress?`Wallet ${R(t.walletAddress)}`:"Sign in"),e&&(e.textContent=t.walletConnecting?"Signing in...":t.walletAddress?"Wallet":"Sign in"),oe.title=t.walletAddress?`${t.walletBalance??"0"} Arc Testnet USDC - ${R(t.walletAddress)}`:"Sign in"}};window.addEventListener("resize",_);ye?.addEventListener("click",()=>{Nt(we==="light"?"dark":"light")});Ar?.addEventListener("click",()=>{Lr()});var Lr=()=>{let e=document.createElement("div");e.className="guide-overlay",e.innerHTML=`
  ...
  `,document.body.appendChild(e);let r=e.querySelector("#guideClose"),a=e.querySelector("#guideStartBtn"),o=()=>e.remove();r.addEventListener("click",o),a.addEventListener("click",o),e.addEventListener("click",s=>{s.target===e&&o()})},Pr=async e=>{let r=localStorage.getItem("siftle_pending_referral_code");if(r)try{let a=await fetch(I("/api/referrals/bind"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:e,referralCode:r})}),o=await a.json().catch(()=>({}));a.ok&&(o.bound||o.reason==="already_bound"||o.reason==="invalid_code")&&(localStorage.removeItem("siftle_pending_referral_code"),o.bound&&w("Referral connected"))}catch(a){console.warn(a)}},xe=async()=>{if(!(!t.walletAddress||t.loadingReferralData)){t.loadingReferralData=!0,t.referralError=null;try{let e=await fetch(I(`/api/referrals?walletAddress=${encodeURIComponent(t.walletAddress)}`)),r=await e.json().catch(()=>({}));e.ok?t.referralData=r:t.referralError=r?.error||"Referral tools are temporarily unavailable."}catch(e){console.warn(e),t.referralError="Referral tools are temporarily unavailable."}finally{t.loadingReferralData=!1,t.activeSurface==="portfolio"&&F()}}},Le=async()=>{if(!t.walletConnecting){t.walletConnecting=!0,U("wallet_connect_start"),_();try{let e=await ir();if(e){U("wallet_connect_success");let r=sessionStorage.getItem("siftle_landing_url"),a=sessionStorage.getItem("siftle_landing_headline"),o=sessionStorage.getItem("siftle_signup_tracked");r&&!o&&(U("briefing_referral_signup",r,a||void 0),sessionStorage.setItem("siftle_signup_tracked","true")),t.walletAddress=e,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),t.walletBalance=await ne(e),await Pr(e),xe(),await z(),ue(!0).catch(n=>console.error("Failed to report leaderboard entry:",n));let s=localStorage.getItem(pt);s?(localStorage.removeItem(pt),w(s)):w("Connected to Arc Testnet"),window.location.hash="#portfolio",Ce()}}catch(e){U("wallet_connect_failed"),w(e instanceof Error?e.message:"Wallet connection failed")}finally{t.walletConnecting=!1,_()}}},w=e=>{let r=document.querySelector("#actionToast");r||(r=document.createElement("div"),r.id="actionToast",r.className="action-toast",r.setAttribute("role","status"),r.setAttribute("aria-live","polite"),document.body.appendChild(r)),r.textContent=e,r.classList.add("show"),Je&&window.clearTimeout(Je),Je=window.setTimeout(()=>{r?.classList.remove("show")},1700)};window.showActionToast=w;var Cr=(e,r,a,o)=>{let s=document.createElement("div");s.className="success-modal-overlay",s.innerHTML=`
...
`,Xe=async(e,r=!1)=>{if(!t.walletAddress){w("Please sign in to unlock this briefing."),Le();return}if(!(t.unlockingSummaryUrl===e.sourceUrl&&!r)){t.unlockingSummaryUrl=e.sourceUrl,t.briefingStatusByUrl[e.sourceUrl]="Preparing AI briefing payment...",U("ai_unlock_attempt"),g();try{let a=await fetch(I("/api/summary/unlock-config")),o=await a.json();if(!a.ok||!o.treasuryAddress)throw new Error(o.error||"AI briefing is not configured");let s=Number(o.amountUsdc)||.05;try{let d=await fetch(I(`/api/summary/price?sourceUrl=${encodeURIComponent(e.sourceUrl)}`));if(d.ok){let b=await d.json();typeof b.priceUsdc=="number"&&(s=b.priceUsdc)}}catch(d){console.warn("Failed to retrieve autonomous price, falling back to default:",d.message)}let n=await lr(o.treasuryAddress,s,d=>{P&&(P.textContent=d),t.briefingStatusByUrl[e.sourceUrl]=d,g()},{sourceUrl:e.sourceUrl,topic:e.headline});t.briefingStatusByUrl[e.sourceUrl]=`Briefing unlocked! Charged ${s} USDC (priced by Siftle AI Agent)`,g();let i=await fetch(I("/api/summary/unlock"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sourceUrl:e.sourceUrl,walletAddress:t.walletAddress,txHash:n})}),l=await i.json();if(!i.ok||!l.unlockToken)throw new Error(l.error||"AI briefing failed");localStorage.setItem(ot(e),l.unlockToken),U("ai_unlock_success");let c=sessionStorage.getItem("siftle_landing_url"),m=sessionStorage.getItem("siftle_landing_headline");c&&U("briefing_referral_unlock",c,m||void 0),(Number(l?.bonus?.points)||0)>0&&ue(!1).catch(d=>console.error("Failed to refresh leaderboard bonus:",d)),await $e(e)}catch(a){U("ai_unlock_failed"),delete t.briefingStatusByUrl[e.sourceUrl];let o=a instanceof Error?a.message:String(a||""),s=o,n=o.toLowerCase();if(n.includes("session expired")||n.includes("sign in first")||n.includes("unauthorized")){try{(await D()).disconnectArcWallet()}catch{}t.walletAddress=null,t.walletBalance=null,s="Your session has expired. Please sign in again to unlock this briefing."}else(n.includes("balance")||n.includes("exceeds balance")||n.includes("transfer amount exceeds"))&&(s="Your USDC balance is too low to unlock this briefing. Please go to the Portfolio tab and click 'Claim Faucet' to get free testnet USDC.");w(s)}finally{t.unlockingSummaryUrl=null,g()}}},$e=async e=>{if(ce(e)&&!(t.aiSummaries[e.sourceUrl]||t.loadingSummaryUrl===e.sourceUrl)){if(e.ai_summary){t.aiSummaries[e.sourceUrl]=de(e,e.ai_summary),U("view_summary"),P&&(P.textContent=e.ai_provider==="0g"?"Archived 0G summary loaded":"Archived summary loaded");let a=new URLSearchParams(window.location.search).get("url");if(a&&a===e.sourceUrl){let o=`siftle_unlock_tracked_${encodeURIComponent(e.sourceUrl)}`;sessionStorage.getItem(o)||(sessionStorage.setItem(o,"true"),U("briefing_unlock",e.sourceUrl,e.headline))}g();return}t.loadingSummaryUrl=e.sourceUrl,t.briefingStatusByUrl[e.sourceUrl]="Generating briefing through 0G...",g();try{let a=new URLSearchParams(window.location.search).get("url"),o=!!(a&&a===e.sourceUrl),s=await fetch(I("/api/summary"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...e,walletAddress:t.walletAddress,unlockToken:Ht(e),isSharedLanding:o})});if(!s.ok){if(s.status===402){Hr(e),delete t.aiSummaries[e.sourceUrl],t.briefingStatusByUrl[e.sourceUrl]="AI briefing unlock expired. Unlock it again to generate a new briefing.",P&&(P.textContent="Unlock expired. Unlock again to continue."),g();return}throw new Error(`Summary request failed with ${s.status}`)}let n=await s.json();t.aiSummaries[e.sourceUrl]=de(e,n.summary),t.briefingStatusByUrl[e.sourceUrl]="AI briefing ready.",P&&n.provider&&(P.textContent=n.provider==="0g"?"Summary generated by 0G":`Summary loaded from ${n.provider}`);let l=new URLSearchParams(window.location.search).get("url");if(l&&l===e.sourceUrl){let c=`siftle_unlock_tracked_${encodeURIComponent(e.sourceUrl)}`;sessionStorage.getItem(c)||(sessionStorage.setItem(c,"true"),U("briefing_unlock",e.sourceUrl,e.headline))}}catch(r){console.warn(r),delete t.aiSummaries[e.sourceUrl],t.briefingStatusByUrl[e.sourceUrl]="AI briefing unavailable. Retry to generate it again.",P&&(P.textContent="AI briefing failed. Retry available.")}finally{t.loadingSummaryUrl=null,g()}}},Ze=(e,r=!1)=>{let a=t.stories.find(o=>o.id===e);if(a){if(t.feedScrollY=window.scrollY,t.selectedStoryId=a.id,t.selectedThreadUrl=null,t.activeThread=null,window.history.pushState({},"",`#story-${a.id}`),g(),a.type==="tweet"){window.scrollTo({top:0,behavior:"smooth"});return}r&&!ce(a)?(t.walletAddress&&(t.unlockingSummaryUrl=a.sourceUrl),g(),Xe(a,!0)):ce(a)&&$e(a),window.scrollTo({top:0,behavior:"smooth"})}},jr=e=>{t.feedScrollY=window.scrollY,t.selectedStoryId=null,t.selectedThreadUrl=e.sourceUrl,t.activeThread=null,t.loadingThreadUrl=e.sourceUrl,window.history.pushState({},"",`#thread-${e.id}`),g(),Ft(e),window.scrollTo({top:0,behavior:"smooth"})},Fr=()=>{t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,t.loadingThreadUrl=null,window.location.search?window.history.pushState({},"",window.location.pathname+"#feed"):window.history.pushState({},"","#feed"),g(),requestAnimationFrame(()=>window.scrollTo({top:t.feedScrollY,behavior:"auto"}))},Ft=async e=>{try{let r=await fetch(I(`/api/thread?category=${encodeURIComponent(e.category)}&sourceUrl=${encodeURIComponent(e.sourceUrl)}`));if(!r.ok)throw new Error(`Thread request failed with ${r.status}`);t.activeThread=await r.json(),P&&(P.textContent=`${t.activeThread?.count??0} related updates found`)}catch(r){console.warn(r),t.activeThread=null,delete e.thread,t.selectedThreadUrl=null,window.history.replaceState({},"","#feed"),w("That timeline no longer has a verified past update"),P&&(P.textContent="Thread unavailable")}finally{t.loadingThreadUrl=null,g()}};function Ce(){let e=window.location.pathname.startsWith("/story/"),r=window.location.pathname.startsWith("/thread/");if(e||r){let o=window.location.pathname.split("/").pop()||"",s=e?`#story-${o}`:`#thread-${o}`;window.history.replaceState({},"",`${window.location.pathname}${window.location.search}${s}`)}if(window.location.hash==="#resolve-local-yes"){let o=E.find(s=>s.id==="siftle-local-test-2")||E.find(s=>s.timeframe==="Daily"&&K(s).startsWith("0x00000000000000000000000000000000000001"));if(o){dr(K(o)),na(o,"yes"),delete t.marketSnapshots[o.id],delete t.marketPositions[o.id],delete t.checkedMarketSnapshots[o.id],delete t.loadingMarketSnapshots[o.id],t.hasLoadedPortfolioPositions=!1,t.activeSurface="portfolio",t.selectedMarketId=null,window.history.replaceState({},"","#portfolio"),w("Local test market resolved YES"),z().then(()=>{ue(!0).catch(s=>console.error("Failed to report leaderboard entry:",s)),_(),F()});return}}let a=window.location.hash.match(/^#market-(.+)$/);if(window.location.hash==="#markets"||a){t.activeSurface="markets",t.selectedMarketId=a?.[1]??null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,g();return}if(window.location.hash==="#portfolio"){t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,g();return}if(window.location.hash==="#leaderboard"){t.activeSurface="leaderboard",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,g();return}if(window.location.hash==="#feed"||window.location.hash.startsWith("#story-")||window.location.hash.startsWith("#thread-")){t.activeSurface="feed";let o=window.location.hash.match(/^#story-(.+)$/),s=window.location.hash.match(/^#thread-(\d+)$/),i=new URLSearchParams(window.location.search).get("url"),l;if(i){sessionStorage.setItem("siftle_landing_url",i);let u=t.stories.find(b=>b.sourceUrl===i);u?.headline?sessionStorage.setItem("siftle_landing_headline",u.headline):sessionStorage.getItem("siftle_landing_headline")||sessionStorage.setItem("siftle_landing_headline","Archived Story");let d=`siftle_ref_tracked_${encodeURIComponent(i)}`;if(sessionStorage.getItem(d)||(sessionStorage.setItem(d,"true"),U("briefing_referral",i,u?.headline||"Archived Story")),l=t.stories.find(b=>b.sourceUrl===i),!l&&o){let b=i;t.loadingSummaryUrl!==b&&(t.loadingSummaryUrl=b,fetch(I(`/api/story?sourceUrl=${encodeURIComponent(b)}`)).then(f=>{if(!f.ok)throw new Error;return f.json()}).then(f=>{t.stories.some(v=>v.sourceUrl===f.sourceUrl)||(f.id=Math.max(9999,...t.stories.map(v=>v.id))+1,t.stories.push(f));let k=t.stories.find(v=>v.sourceUrl===f.sourceUrl);sessionStorage.setItem("siftle_landing_headline",k.headline),U("briefing_referral",i,k.headline),t.selectedStoryId=k.id,g(),$e(k)}).catch(f=>{console.warn("Failed to load historical story from backend:",f)}).finally(()=>{t.loadingSummaryUrl=null}))}}else if(o){let u=Number(o[1]);isNaN(u)||(l=t.stories.find(d=>d.id===u))}let c=s?t.stories.find(u=>u.id===Number(s[1])):void 0,m=t.selectedStoryId!==null||t.selectedThreadUrl!==null;l?(t.selectedStoryId=l.id,t.selectedThreadUrl=null,t.activeThread=null,g(),$e(l)):c?(t.selectedStoryId=null,t.selectedThreadUrl=c.sourceUrl,t.activeThread=null,g(),Ft(c)):i||(t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,g(),m&&requestAnimationFrame(()=>window.scrollTo({top:t.feedScrollY,behavior:"auto"})));return}t.activeSurface="feed",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,g()}var et=e=>{ht&&(ht.textContent=e)},Wr=async(e=t.activeCategory,r=!1)=>{r||(t.activeSurface="feed",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,t.loadingThreadUrl=null,t.showSaved=!1),t.isLoading=!0,t.activeSurface==="feed"&&(Yt(),g());try{let a=t.activeArchiveDate?`/api/archive?date=${encodeURIComponent(t.activeArchiveDate)}&category=${encodeURIComponent(e)}`:`/api/feed?category=${encodeURIComponent(e)}`,o=await fetch(I(a));if(!o.ok)throw new Error(`Feed request failed with ${o.status}`);let s=await o.json();if(t.stories=s.top_stories??[],Se(),t.hasLoadedFeed=!0,Qe&&(Qe.textContent=Ot(s.date??t.activeArchiveDate)),P)if(t.activeArchiveDate)P.textContent=`Showing ${e} from ${t.activeArchiveDate}`;else{let n=s.archive?.provider==="shelby"?"Shelby":"local archive";P.textContent=`Latest published feed loaded from ${n}`}et(t.activeArchiveDate?`Archive: ${t.activeArchiveDate}`:"Live feed")}catch(a){console.warn(a),t.hasLoadedFeed||(t.stories=[]),Se(),P&&(P.textContent=t.activeArchiveDate?"That saved day/category is not available yet":"Feed data is currently unavailable. Please check back shortly.")}finally{t.isLoading=!1,g(),Ce()}},qr=async()=>{if(j)try{let e=await fetch(I("/api/archive"));if(!e.ok)throw new Error(`Archive index failed with ${e.status}`);let r=await e.json(),a=new Date().toLocaleDateString("en-CA",{timeZone:"Africa/Lagos",year:"numeric",month:"2-digit",day:"2-digit"});t.archiveDates=(r.dates??[]).filter(o=>o.date!==a),j.innerHTML=['<option value="">Today</option>',...t.archiveDates.map(o=>`<option value="${o.date}">${o.date}</option>`)].join(""),j.value=t.activeArchiveDate??"",et(t.archiveDates.length>0?"Saved days ready":"Live feed ready")}catch(e){console.warn(e),et("Archive unavailable")}},Ie=()=>{mt||(mt=!0,qr())},re=(e=t.activeCategory,r=!1)=>{t.hasLoadedFeed&&e===t.activeCategory&&!t.activeArchiveDate||Wr(e,r)},Yr=()=>{ft||(ft=!0,window.setTimeout(()=>{t.activeSurface!=="feed"&&!t.hasLoadedFeed&&re(t.activeCategory,!0),Ie()},8e3))},Gr=e=>e==="All"?"For you":e==="Sports"?"Football":e,W=e=>e==="Sports"?"Football":e,tt=e=>/^@/.test(String(e.source||""))||/(?:^|\/)(?:x|twitter)\.com\//i.test(String(e.sourceUrl||"")),Wt=(e,r)=>{let a=e.trim();return a.length<=r?a:`${a.slice(0,Math.max(0,r-1)).trimEnd()}\u2026`},Jr=e=>e.replace(/^@/,"").replace(/[_-]+/g," ").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/\s+/g," ").trim().split(" ").filter(Boolean),qt=e=>{let r=String(e.source||W(e.category)).trim(),a=Jr(r);if(a.length===0)return W(e.category);let o=a.filter((i,l)=>{let c=i.toLowerCase();return!(l>0&&["live","news","official"].includes(c))}),s=o.length>0?o:a,n="";for(let i of s){let l=n?`${n} ${i}`:i;if(l.length>18)break;n=l}return Wt(n||s[0],18)},bt=e=>{let r=String(e.headline||"").replace(/\s+/g," ").trim();if(!tt(e))return r;let a=r.replace(/https?:\/\/\S+/gi,"").replace(/\(Source:[^)]+\)\s*$/i,"").replace(/\s+/g," ").trim();if(/^R to\s+@[^:]+:\s*(?:more here|watch more here)[:.!?]*$/i.test(a))return`Latest from ${qt(e)}`;let o=a.replace(/^R to\s+@[^:]+:\s*/i,"").trim(),s=o.length>=24&&!/^(?:more here|watch more here)[:.!?]*$/i.test(o)?o:a||r;return Wt(s,150)},Yt=()=>{le&&(le.innerHTML=vr.map(e=>`
        <button class="category-tab ${e===t.activeCategory?"active":""}" type="button" data-category="${e}">
          ${Gr(e)}
        </button>
      `).join(""))},Gt=e=>(e.thread?.count??0)>=1,Kr=(e=0)=>`${e} past ${e===1?"update":"updates"}`,Jt=(e=[])=>[...e].sort((r,a)=>{let o=new Date(r.publishedAt||0).getTime(),s=new Date(a.publishedAt||0).getTime();return(Number.isNaN(s)?0:s)-(Number.isNaN(o)?0:o)}),ze=e=>{let r=t.marketEvidenceOverrides[e.id],a={...e,evidence:e.evidence??[]};return r?{...a,...r,updates:r.evidence.length}:a},Vr=(e,r)=>{if(e.timeframe!=="Daily")return null;let a=e.kickoffAt?new Date(e.kickoffAt).getTime():Number.NaN;if(Number.isFinite(a))return a;let o=r?.closesAtUnix??0;return o>0?o*1e3:null},Qr=(e,r)=>r===0?"Latest":e.publishedAt?new Intl.DateTimeFormat("en",{month:"short",day:"numeric"}).format(new Date(e.publishedAt)):e.postedAt,Xr=(e,r)=>({date:Qr(e,r),source:e.source,headline:e.headline,summary:de(e),impact:r===0?"Latest":"Update",direction:"flat",sourceUrl:e.sourceUrl}),Kt=async e=>{if(!(t.checkedMarketEvidence[e.id]||t.loadingMarketEvidence[e.id])){t.loadingMarketEvidence[e.id]=!0;try{let r=await fetch(I(`/api/market-thread?id=${encodeURIComponent(e.id)}&nocache=${Date.now()}`));if(!r.ok)return;let a=await r.json(),o=[a.current,...Jt(a.items??[])],s=o.filter((l,c,m)=>m.findIndex(u=>u.sourceUrl===l.sourceUrl)===c).map(Xr),i=o[0]?.imageUrl;s.length>=1&&(t.marketEvidenceOverrides[e.id]={threadTopic:a.topic||e.threadTopic,evidence:s,imageUrl:i||e.imageUrl})}catch(r){console.warn(r)}finally{t.checkedMarketEvidence[e.id]=!0,t.loadingMarketEvidence[e.id]=!1,t.activeSurface==="markets"&&g()}}},K=e=>e.optionMarket?e.id:e.marketAddress||window.SIFTLE_MARKET_ADDRESSES?.[e.id]||"",ae=e=>Array.isArray(e.options)?e.options.filter(r=>r?.id&&r?.label):[],te=e=>!!(e.optionMarket&&ae(e).length>1),Zr=e=>{let r=ae(e);return r.find(a=>a.id===t.marketTradeOptionId)||r[0]||null},H=e=>e.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),C=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),lt=e=>`siftle_profile_username_${e.toLowerCase()}`,Vt=e=>e.trim().replace(/\s+/g," ").slice(0,15),fe=()=>{if(!t.walletAddress){t.profileUsername=null,t.profileNotice=null;return}let e=lt(t.walletAddress),r=localStorage.getItem(e),a=localStorage.getItem("siftle_profile_username");!r&&a&&(r=Vt(a),r&&localStorage.setItem(e,r),localStorage.removeItem("siftle_profile_username")),t.profileUsername=r||null,t.profileNotice=null},ea=e=>{if(!t.walletAddress)return;let r=lt(t.walletAddress),a=Vt(e);a?(localStorage.setItem(r,a),t.profileUsername=a):(localStorage.removeItem(r),t.profileUsername=null),localStorage.removeItem("siftle_profile_username")},ta=()=>{let e="one-hour-test-market",r=[];for(let a=0;a<localStorage.length;a++){let o=localStorage.key(a);o&&o.includes(e)&&r.push(o)}r.forEach(a=>localStorage.removeItem(a))},Qt=(e,r,a)=>{if(e==="sell"){let o=r==="yes"?a?.yesSharesUsdc??0:a?.noSharesUsdc??0;return o<=0?{min:.01,max:.01,fallback:.01}:{min:Math.min(.01,o),max:o,fallback:o}}return{min:2,max:2,fallback:2}},Ee=(e,r,a,o)=>{let{min:s,max:n,fallback:i}=Qt(r,a,o);return Number.isFinite(e)?Math.min(n,Math.max(s,e)):i},Xt=(e,r,a,o,s)=>{if(!e||!Number.isFinite(a)||a<=0)return 0;let n=r==="yes"?s?.yesSharesUsdc??0:s?.noSharesUsdc??0,i=e.yesSharesUsdc,l=e.noSharesUsdc;if(o==="sell")return Math.min(a,n);let c=(r==="yes"?i:l)+a,m=i+l+a;return c<=0||m<=0?a:(n+a)/c*m},Zt=(e,r)=>{let a=r?.volumeUsdc??0,o=[];return e.yesSharesUsdc>0&&o.push({label:"YES Shares",shares:e.yesSharesUsdc,payout:r&&r.yesSharesUsdc>0?e.yesSharesUsdc/r.yesSharesUsdc*a:0}),e.noSharesUsdc>0&&o.push({label:"NO Shares",shares:e.noSharesUsdc,payout:r&&r.noSharesUsdc>0?e.noSharesUsdc/r.noSharesUsdc*a:0}),o},ra=e=>{let r=e?.yesSharesUsdc??0,a=e?.noSharesUsdc??0;return r>0&&a<=0?"yes":a>0&&r<=0?"no":null},er=e=>`siftle_claimed_markets_${e.toLowerCase()}`,Oe=()=>{if(!t.walletAddress)return new Set;try{return new Set(JSON.parse(localStorage.getItem(er(t.walletAddress))||"[]"))}catch{return new Set}},aa=e=>{if(!t.walletAddress)return;let r=Oe();r.add(e),localStorage.setItem(er(t.walletAddress),JSON.stringify(Array.from(r)))},je=(e,r)=>(r?.outcome??0)!==0?!0:/^resolved$/i.test(String(e.closes||"").trim()),se=(e,r,a)=>{let o=a?.yesSharesUsdc??0,s=a?.noSharesUsdc??0;return e==="sell"?r==="yes"?o>0:s>0:r==="yes"?s<=0:o<=0},dt=(e,r,a)=>{if(se(e,r,a))return r;let o=r==="yes"?"no":"yes";return se(e,o,a)?o:r};var oa=e=>{let r=e instanceof Error?e.message:String(e||"");return/token|session|auth|unauthori[sz]ed|expired|401/i.test(r)},yt=e=>{let r=String(e||"").trim();if(!r)return"0 wins, 0 losses";let a=r.replace(/closed profits?/gi,"losses").replace(/\bprofit\b/gi,"losses");return/\bloss/i.test(a)?a:`${a}, 0 losses`};var kt=e=>{let r=String(e||"").match(/(\d+)\s+wins?/i),a=String(e||"").match(/(\d+)\s+loss(?:es)?/i);return{wins:r&&Number(r[1])||0,losses:a&&Number(a[1])||0}};var sa=(e,r)=>{let a=String(e?.optionId||"").trim(),o=Math.max(0,Number(e?.optionSharesUsdc)||0),s=Math.max(0,Number(r?.optionPools?.[a])||0),n=Math.max(0,Number(r?.volumeUsdc)||0);return!a||o<=0?0:s<=0||n<=0?o:o/s*n},Ke=(e,r)=>!te(e)||!r?r:{...r,optionPools:Object.fromEntries(ae(e).map(a=>[a.id,0]))};var ct=()=>{let e=0,r=0,a=0,o=E.filter(i=>i.timeframe==="Daily").map(i=>i.id),s=t.walletAddress?`siftle_resolved_results_${t.walletAddress.toLowerCase()}`:"",n={};if(s)try{n=JSON.parse(localStorage.getItem(s)||"{}")}catch{}if(t.walletAddress&&t.hasLoadedPortfolioPositions)for(let i of o){if(n[i]?.result==="win"){e+=Number(n[i].points)||0,r++;continue}if(n[i]?.result==="loss"){a++;continue}let l=t.marketPositions[i],m=t.marketSnapshots[i]?.outcome??0;if(m===0)continue;let u=`siftle_traded_sides_${i}_${t.walletAddress.toLowerCase()}`,d=[];try{d=JSON.parse(localStorage.getItem(u)||"[]")}catch{}let b=d.includes("yes")&&d.includes("no");if(m===1&&l&&l.yesSharesUsdc>0){let f=b?50:100;e+=f,r++,n[i]={result:"win",points:f}}else if(m===2&&l&&l.noSharesUsdc>0){let f=b?50:100;e+=f,r++,n[i]={result:"win",points:f}}else l&&(l.yesSharesUsdc>0||l.noSharesUsdc>0)&&(a++,n[i]={result:"loss",points:0})}return s&&localStorage.setItem(s,JSON.stringify(n)),{points:e,status:`${r} win${r===1?"":"s"}, ${a} loss${a===1?"":"es"}`}},na=(e,r)=>{let a=K(e).toLowerCase();if(!a)return;let o=`siftle_mock_pos_${a}_`,s=new Set;for(let n=0;n<localStorage.length;n++){let i=localStorage.key(n);if(!i||!i.startsWith(o))continue;let l=i.slice(o.length).toLowerCase();/^0x[a-f0-9]{40}$/.test(l)&&s.add(l)}s.forEach(n=>{let i=`${o}${n}`,l={yesSharesUsdc:0,noSharesUsdc:0};try{l=JSON.parse(localStorage.getItem(i)||"{}")}catch{}let c=(Number(l.yesSharesUsdc)||0)>0,m=(Number(l.noSharesUsdc)||0)>0;if(!c&&!m)return;let u=`siftle_traded_sides_${e.id}_${n}`,d=[];try{d=JSON.parse(localStorage.getItem(u)||"[]")}catch{}let b=d.includes("yes")&&d.includes("no"),f=r==="yes"?c:m,k=`siftle_resolved_results_${n}`,v={};try{v=JSON.parse(localStorage.getItem(k)||"{}")}catch{}v[e.id]={result:f?"win":"loss",points:f?b?50:100:0},localStorage.setItem(k,JSON.stringify(v));let A=0,h=0,p=0;Object.values(v).forEach(y=>{y.result==="win"?(h+=1,A+=Number(y.points)||0):y.result==="loss"&&(p+=1)});let L=localStorage.getItem(lt(n))||"";fetch(I("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:n,username:L,points:A,status:`${h} win${h===1?"":"s"}, ${p} loss${p===1?"":"es"}`})}).catch(y=>console.error("Failed to report local resolved score:",y))})},ue=async e=>{if(!t.walletAddress)return!1;let r=e&&t.hasLoadedPortfolioPositions?ct():null,a=await fetch(I("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:t.walletAddress,username:t.profileUsername||"",...r?{points:r.points,status:r.status}:{}})}),o=await a.json().catch(()=>({}));if(!a.ok||o?.success===!1)throw new Error(o?.error||"Failed to save leaderboard profile");if(o?.supabaseConfigured&&o?.supabaseSaved===!1)throw new Error(o?.supabaseError||"Supabase did not save profile");return!0},ia=()=>{let e=new Set;for(let r=0;r<localStorage.length;r++){let a=localStorage.key(r);if(a&&a.startsWith("siftle_mock_pos_")){let o=a.slice(a.lastIndexOf("_")+1).toLowerCase();try{let s=JSON.parse(localStorage.getItem(a)||"{}");((Number(s.yesSharesUsdc)||0)>0||(Number(s.noSharesUsdc)||0)>0)&&/^0x[a-f0-9]{40}$/.test(o)&&e.add(o)}catch{}}}e.forEach(r=>{fetch(I("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:r})}).catch(a=>console.error("Failed to report stored local trader:",a))})},la=async e=>{let r=K(e);if(!(!r||t.marketSnapshots[e.id]||t.loadingMarketSnapshots[e.id]||t.checkedMarketSnapshots[e.id])){if(te(e)&&!t.walletAddress){let a=e.resolvedOptionId||null,o=Number(e.outcome);t.marketSnapshots[e.id]=Ke(e,{yesPriceCents:0,noPriceCents:0,volumeUsdc:Number(e.volumeUsdc)||0,yesSharesUsdc:0,noSharesUsdc:0,outcome:o===1||o===2||o===3?o:a?1:0,optionPools:e.optionPools||Object.fromEntries(ae(e).map(s=>[s.id,0])),resolvedOptionId:a,traderCount:0}),t.checkedMarketSnapshots[e.id]=!0;return}t.loadingMarketSnapshots[e.id]=!0;try{if(te(e)&&t.walletAddress){let{position:a,snapshot:o}=await Lt(r,t.walletAddress);t.marketPositions[e.id]=a,t.marketSnapshots[e.id]=Ke(e,o)}else t.marketSnapshots[e.id]=Ke(e,await cr(r))}catch(a){console.warn(a)}finally{t.checkedMarketSnapshots[e.id]=!0,t.loadingMarketSnapshots[e.id]=!1,t.activeSurface==="markets"&&g()}}},z=async(e={})=>{if(t.walletAddress&&!(t.loadingPortfolioPositions&&!e.force)){t.hasLoadedPortfolioPositions=!1,t.loadingPortfolioPositions=!0;try{t.portfolioMarketPreviews.length===0&&await Bt();let r=Te(),a=await Promise.all(r.map(async o=>{let s=K(o);if(!s)return[o.id,{yesSharesUsdc:0,noSharesUsdc:0}];try{let{position:n,snapshot:i}=await Lt(s,t.walletAddress);return t.marketSnapshots[o.id]=i,[o.id,n]}catch(n){return console.warn(`Failed to load portfolio market ${o.id}:`,n),[o.id,{yesSharesUsdc:0,noSharesUsdc:0}]}}));t.marketPositions=Object.fromEntries(a),t.portfolioPositionsLoadedAt=Date.now()}catch(r){console.warn(r)}finally{t.loadingPortfolioPositions=!1,t.hasLoadedPortfolioPositions=!0,ue(!0).catch(r=>console.error("Failed to report leaderboard entry:",r)),(t.activeSurface==="portfolio"||t.activeSurface==="leaderboard"||t.activeSurface==="markets")&&g()}}},da=async(e,r)=>{if(!t.walletAddress){w("Session expired or wallet not connected. Please sign in."),Le();return}let a=Te().find(m=>m.id===e);if(!a)return;t.marketTradeSide=r;let o=K(a);if(!o){w("Deploy this Arc market contract before trading"),g();return}if(!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",g(),await z(),t.marketTradeStatus=null),!t.hasLoadedPortfolioPositions){w("Still loading your position. Try again in a moment."),g();return}let s=t.marketSnapshots[a.id];if(je(a,s)){t.tradeDrawerOpen=!1,w("This market is resolved and can no longer be traded."),g();return}let n=s?.yesPriceCents??a.probability,i=s?.noPriceCents??100-a.probability,l=t.marketPositions[a.id]||{yesSharesUsdc:0,noSharesUsdc:0};if(!se(t.marketOrderMode,r,l)){let m=ra(l),u=t.marketOrderMode==="sell"?m?`You can only exit your ${m.toUpperCase()} shares.`:"You do not have shares to exit in this market.":m?`Exit your ${m.toUpperCase()} shares before buying the other side.`:"You cannot buy both sides in the same market.";w(u),t.marketTradeSide=dt(t.marketOrderMode,r,l),g();return}let c=Ee(Number(t.marketTradeAmount)||0,t.marketOrderMode,r,l);t.marketTradeAmount=c,U("trade_attempt");try{t.marketTradeStatus="Preparing transaction...",g();let m=await ur(o,t.marketOrderMode,r,c,u=>{t.marketTradeStatus=u,g()},n,i);if(delete t.marketSnapshots[a.id],delete t.marketPositions[a.id],delete t.checkedMarketSnapshots[a.id],delete t.loadingMarketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await De(),t.walletAddress&&(t.walletBalance=await ne(t.walletAddress)),await z({force:!0}),ue(!0).catch(u=>console.error("Failed to report leaderboard entry:",u)),t.walletAddress){let u=`siftle_cost_basis_${a.id}_${t.walletAddress.toLowerCase()}`,d={yesCost:0,noCost:0,yesShares:0,noShares:0};try{let f=localStorage.getItem(u);if(f){let k=JSON.parse(f);d={yesCost:k.yesCost||0,noCost:k.noCost||0,yesShares:k.yesShares||0,noShares:k.noShares||0}}}catch{}let b=c;if(t.marketOrderMode==="buy"){let f=`siftle_traded_sides_${a.id}_${t.walletAddress.toLowerCase()}`,k=[];try{k=JSON.parse(localStorage.getItem(f)||"[]")}catch{}k.includes(r)||(k.push(r),localStorage.setItem(f,JSON.stringify(k))),r==="yes"?(d.yesCost+=b,d.yesShares=(d.yesShares||0)+b/(n/100)):(d.noCost+=b,d.noShares=(d.noShares||0)+b/(i/100))}else{let f=t.marketPositions[a.id];if(f){if(r==="yes"&&f.yesSharesUsdc>0){let k=Math.min(1,b/f.yesSharesUsdc);d.yesCost=Math.max(0,d.yesCost-d.yesCost*k),d.yesShares=Math.max(0,(d.yesShares||0)-(d.yesShares||0)*k)}else if(r==="no"&&f.noSharesUsdc>0){let k=Math.min(1,b/f.noSharesUsdc);d.noCost=Math.max(0,d.noCost-d.noCost*k),d.noShares=Math.max(0,(d.noShares||0)-(d.noShares||0)*k)}}}localStorage.setItem(u,JSON.stringify(d))}w(`Trade confirmed ${m.slice(0,8)}...`),U(t.marketOrderMode==="buy"?"trade_buy_success":"trade_sell_success"),Cr(t.marketOrderMode,t.marketTradeAmount,r.toUpperCase(),a.question)}catch(m){U("trade_failed"),oa(m)?(Pt(),t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),w("Session expired. Please sign in again.")):w(m instanceof Error?m.message:"Arc trade failed")}finally{t.marketTradeStatus=null,_(),g()}},ca=e=>Gt(e)?`<button class="card-source-button thread-button" type="button" data-thread-story-id="${e.id}">Thread (${e.thread?.count})</button>`:"",ua=e=>Gt(e)?`<button class="mobile-action-btn thread-btn" type="button" data-thread-story-id="${e.id}">Thread</button>`:"",pa=()=>'<svg class="action-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 4.75h10a1.75 1.75 0 0 1 1.75 1.75v14.25L12 16.35l-6.75 4.4V6.5A1.75 1.75 0 0 1 7 4.75Z"/></svg>',ma=()=>'<svg class="action-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 15V4.75"/><path d="m7.25 9.5 4.75-4.75 4.75 4.75"/><path d="M5 13.25v4.5A2.25 2.25 0 0 0 7.25 20h9.5A2.25 2.25 0 0 0 19 17.75v-4.5"/></svg>',be=e=>`<span class="skeleton-aria-label" role="status" aria-live="polite">${e}</span>`,fa=()=>`
...
`,wt=e=>{let r=e.type==="tweet",a='<svg class="x-logo-svg" viewBox="0 0 24 24" fill="currentColor" style="width: 14px; height: 14px; display: inline-block; vertical-align: text-top; color: var(--color-text-primary);"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>',o='<svg class="x-logo-svg" viewBox="0 0 24 24" fill="currentColor" style="width: 12px; height: 12px; display: inline-block; vertical-align: text-top; margin-right: 4px;"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>';return`
  ...
  `},ve=()=>{if(!S)return;let e=Ir();if(S.hidden=!!(t.selectedStoryId||t.selectedThreadUrl),t.isLoading){S.innerHTML=ga(4);return}let r=C(t.newsSearchQuery.trim()),o=`
...
`},$a=async(e,r)=>{if(!t.walletAddress){w("Session expired or wallet not connected. Please sign in."),Le();return}let a=Te().find(m=>m.id===e);if(!a||!te(a))return;let o=ae(a).find(m=>m.id===r);if(!o){w("Choose a valid option.");return}!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",g(),await z(),t.marketTradeStatus=null);let s=t.marketSnapshots[a.id];if(je(a,s)){w("This market is resolved and can no longer be traded.");return}let n=t.marketPositions[a.id],i=t.marketOrderMode==="sell";if(!i&&n?.optionId){w("Your pick is already locked for this market.");return}if(i&&!n?.optionId){w("You do not have a pick to exit.");return}let l=Math.max(0,Number(n?.optionSharesUsdc)||0);if(i&&l<=0){w("Your pick is still loading. Please try again."),await z({force:!0});return}let c=i?l:Ee(Number(t.marketTradeAmount)||0,"buy","yes",void 0);t.marketTradeAmount=c,t.marketTradeOptionId=i&&n?.optionId||o.id,U("trade_attempt");try{t.marketTradeStatus=i?"Exiting your pick...":"Locking your pick...",g(),await pr(a.id,i?"sell":"buy",i&&n?.optionId||o.id,c,m=>{t.marketTradeStatus=m,g()}),delete t.marketSnapshots[a.id],delete t.marketPositions[a.id],delete t.checkedMarketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await De(),t.walletAddress&&(t.walletBalance=await ne(t.walletAddress)),await z({force:!0}),U(i?"trade_sell_success":"trade_buy_success"),w(i?"Pick exited":`Pick locked: ${o.label}`),t.tradeDrawerOpen=!1}catch(m){U("trade_failed"),w(m instanceof Error?m.message:"Trade failed")}finally{t.marketTradeStatus=null,_(),g()}},Ta=()=>{if(!$||!S)return;let e=t.stories.find(o=>o.sourceUrl===t.selectedThreadUrl);if(S.hidden=!0,$.hidden=!1,$.classList.add("fullscreen"),document.body.classList.add("detail-mode"),!e){$.innerHTML="";return}let r=t.loadingThreadUrl===e.sourceUrl,a=t.activeThread;if(r&&!a){$.innerHTML=`
    ...
    <button class="market-card" type="button" data-market-id="${e.id}">
      ...
      <div class="market-card-news" style="margin: 12px 0 8px; width: 100%; border-top: 1px dashed var(--market-border); padding-top: 10px; box-sizing: border-box;">
        ...
        <div style="display: flex; flex-direction: column; gap: 6px;">
          ${d.evidence.slice(0,2).map(f=>`
            <div style="display: flex; align-items: flex-start; gap: 6px; font-size: 0.76rem; text-align: left; line-height: 1.35; padding: 4px 0;">
              <span style="background: rgba(59, 130, 246, 0.08); color: var(--market-accent); border: 1px solid rgba(59, 130, 246, 0.15); border-radius: 4px; padding: 1px 4px; font-size: 0.62rem; font-weight: 700; text-transform: uppercase; flex-shrink: 0; line-height: 1;">${C(f.source)}</span>
              <span style="color: var(--market-text-main); font-weight: 500;">${C(f.headline)}</span>
            </div>
          `).join("")}
        </div>
      </div>
  ...
  `},Ua=e=>{let r=ze(e),o=t.marketSnapshots[e.id]?.yesPriceCents??e.probability,s=100-o,n=r.evidence[0],i=n?n.headline:"No updates yet",l=`${window.location.origin}${window.location.pathname}#market-${e.id}`;return`\u{1F6A8} *Siftle Market Alert* \u{1F6A8}
...
Trade and discuss here: ${l}`},La=e=>{if(!S||!$)return;let r=ze(e),a=!t.checkedMarketEvidence[e.id],o=K(e),s=t.marketSnapshots[e.id],n=te(e),i=ae(e);n&&!t.marketTradeOptionId&&(t.marketTradeOptionId=i[0]?.id||null);let l=Zr(e),c=!!(o&&!s),m=s?.yesPriceCents??(o?e.probability:0),u=s?.noPriceCents??(o?100-e.probability:0),d=c?"":o?`${m}\xA2`:"--",b=c?"":o?`${u}\xA2`:"--",f=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},k=!!f.optionId;n&&k&&t.marketOrderMode!=="sell"&&(t.marketOrderMode="sell"),n&&!k&&t.marketOrderMode==="sell"&&(t.marketOrderMode="buy");let v=n&&t.marketOrderMode==="sell"&&k?Math.max(0,Number(f.optionSharesUsdc)||0):0,A=v>0?v:Ee(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,f),h=v>0?{min:0,max:v}:Qt(t.marketOrderMode,t.marketTradeSide,f),p=t.marketOrderMode==="buy"?"exactly $2.00 USDC":`Up to $${H(h.max)} USDC`,L=!t.walletAddress||t.hasLoadedPortfolioPositions,y=je(e,s),x=jt(e,s),T=!!x;n||(t.marketTradeSide=dt(t.marketOrderMode,t.marketTradeSide,f));let M=!n&&!y&&!T&&L&&se(t.marketOrderMode,"yes",f),N=!n&&!y&&!T&&L&&se(t.marketOrderMode,"no",f),Y=n?!y&&!T&&L&&(t.marketOrderMode==="sell"?k:!k&&!!l):!y&&!T&&L&&se(t.marketOrderMode,t.marketTradeSide,f),q=y?"Market resolved":x||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),V=y?"Market resolved":x||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),Q=n?A:Xt(s,t.marketTradeSide,A,t.marketOrderMode,f),X=t.marketOrderMode==="buy"?"Buy":"Exit",pe=n?"Pick one outcome":o?"Arc testnet live":"Contract not deployed";S.hidden=!0,$.hidden=!1,$.classList.add("fullscreen"),document.body.classList.add("detail-mode"),la(e),Kt(e),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&z({force:!t.hasLoadedPortfolioPositions});let ut=n?!!f.optionId:f.yesSharesUsdc>0||f.noSharesUsdc>0,We="";n&&ut&&t.walletAddress?We=`
      <div class="user-market-position-box" style="margin: 16px 0; padding: 16px; background: rgba(59, 130, 246, 0.05); border: 1px solid rgba(59, 130, 246, 0.15); border-radius: 12px; font-family: 'Space Grotesk', sans-serif;">
        ...
        <div style="display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 1fr); gap: 12px;">
          <div>
            ...
            <strong style="font-size: 0.95rem; color: var(--market-text-main);">${C(f.optionLabel||"Selected option")}</strong>
          </div>
          <div>
    ...
    <div class="detail-container market-detail-container">
      ...
      <article class="market-detail-card">
        <div class="market-detail-main">
          <div class="market-detail-topline">
            <span class="category-chip ${e.category}">${W(e.category)}</span>
            <span class="market-status-pill">${pe}</span>
          </div>
          <h2>${e.question}</h2>
          ${We}
          ${r.imageUrl?`
      ...
      <div class="sticky-trade-bar">
        <div class="sticky-trade-info">
          ${n?`<span>${k?"Pick locked":"Choose one option"}</span><span><strong>${i.length} options</strong></span>`:`<span>Choose a side</span><span><strong>${t.marketOrderMode==="sell"?"Exit available":"Trade open"}</strong></span>`}
        </div>
        <button class="sticky-trade-btn" type="button" id="openTradeDrawerBtn" ${y||T?"disabled":""}>
          ${y?"Market Resolved":x||(n?k?"Pick Locked":"Pick Outcome":"Trade Market")}
        </button>
      </div>
      ...
      <div class="trade-drawer ${t.tradeDrawerOpen?"open":""}" id="tradeDrawer">
        ...
        <div class="trade-drawer-body">
          ...
          <div class="market-action-grid">
            ${n?i.map(B=>{let O=t.marketTradeOptionId===B.id||f.optionId===B.id,me=y||T||t.marketOrderMode==="sell"||k||!L;return`
                  <button type="button" class="market-side option ${O?"active":""} ${me?"disabled":""}" data-market-option-id="${C(B.id)}" ${me?"disabled":""}>
                    <span>${C(B.label)}</span>
                    ${f.optionId===B.id?"<small>Your pick</small>":""}
                  </button>
                `}).join(""):c?`
          ...
          <div class="market-amount-panel">
            ...
            <div class="market-amount-input-row">
              <span>$</span>
              <input id="marketAmountInput" type="number" min="${h.min.toFixed(2)}" max="${Math.max(h.min,h.max).toFixed(2)}" step="0.01" inputmode="decimal" value="${A}" data-market-amount ${y||T||t.marketOrderMode==="buy"?"disabled":""} style="${t.marketOrderMode==="buy"?"opacity: 0.7; cursor: not-allowed;":""}" />
              <span>USDC</span>
            </div>
          </div>
  ...
  `,((h="2026-07-19T23:59:59.000Z")=>{let p=document.getElementById("seasonTimer");ee&&clearInterval(ee);let L=()=>{let x=new Date(h).getTime()-new Date().getTime();if(x<=0){p&&(p.innerText="Season Finished!"),ee&&clearInterval(ee);return}let T=Math.floor(x/(1e3*60*60*24)),M=Math.floor(x%(1e3*60*60*24)/(1e3*60*60)),N=Math.floor(x%(1e3*60*60)/(1e3*60)),Y=Math.floor(x%(1e3*60)/1e3);p&&(p.innerText=`${T}d ${M}h ${N}m ${Y}s`)};L(),ee=setInterval(L,1e3)})();let a=h=>h.map((p,L)=>{let y=Number(p.globalRank)||L+1,x=String(p.username||""),T=!!(t.walletAddress&&x.toLowerCase()===t.walletAddress.toLowerCase()),M=T&&t.profileUsername?t.profileUsername:p.displayName||x,N=T?`${t.profileUsername?M:R(x)} (You)`:M.startsWith("0x")&&M.length===42?R(M):M,Y=C(N),q=yt(p.status);if(p.totalTrades!==void 0&&p.aiBriefingUnlocks!==void 0){let Fe=kt(p.status);q=`${Fe.wins}W - ${Fe.losses}L \xB7 ${p.totalTrades} trades \xB7 ${p.aiBriefingUnlocks} unlocks`}let V=C(q),Q=p.nextSeasonDivision?`Division ${p.nextSeasonDivision}`:"Qualify",X=y<=10?"promotion-zone":"safety-zone",pe=y<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
      <div class="leaderboard-row global-row ${T?"user-highlight":""} ${X}" role="listitem">
        ...
        <div class="leaderboard-row-score">
          ...
          <span>${p.prizeEligible?"Prize eligible":"Season rank"} \xB7 ${C(Q)}</span>
        </div>
        <div class="leaderboard-row-right">
          <span>${V}</span>
        </div>
      </div>
    `}).join(""),o=h=>h.map((p,L)=>{let y=L+1,x=String(p.username||""),T=!!(t.walletAddress&&x.toLowerCase()===t.walletAddress.toLowerCase()),M=T&&t.profileUsername?t.profileUsername:p.displayName||x,N=yt(p.status);if(p.totalTrades!==void 0&&p.aiBriefingUnlocks!==void 0){let pe=kt(p.status);N=`${pe.wins}W - ${pe.losses}L \xB7 ${p.totalTrades} trades \xB7 ${p.aiBriefingUnlocks} unlocks`}let Y=C(N),q=T?`${t.profileUsername?M:R(x)} (You)`:M.startsWith("0x")&&M.length===42?R(M):M,V=C(q),Q="safety-zone",X='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return y<=2?(Q="promotion-zone",X='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):y>=5&&(Q="relegation-zone",X='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
      <div class="leaderboard-row ${T?"user-highlight":""} ${Q}" role="listitem" style="display: flex !important; align-items: center !important; justify-content: space-between !important; padding: 12px 16px !important; border-bottom: 1px solid rgba(255, 255, 255, 0.06) !important; margin-bottom: 0 !important; background: transparent !important; font-family: 'Space Grotesk', sans-serif !important;">
        ...
        <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
          <span style="color: #ffffff; font-weight: 750; font-size: 0.95rem; white-space: nowrap;">${Number(p.points)||0} pts</span>
        </div>
    ...
    `}).join(""),s=h=>h.map((p,L)=>{let y=L+1,x=String(p.username||""),T=!!(t.walletAddress&&x.toLowerCase()===t.walletAddress.toLowerCase()),M=T&&t.profileUsername?t.profileUsername:p.displayName||x,N=T?`${t.profileUsername?M:R(x)} (You)`:M.startsWith("0x")&&M.length===42?R(M):M,Y=C(N),q=Number(p.unlocks)||0,V=Number(p.points)||0,Q=p.status||`${q} briefing unlock${q===1?"":"s"}`;return`
    ...
    `)},i=()=>{let h=document.getElementById("leaderboardListContainer");n(h,6),fetch(I("/api/leaderboard/preseason")).then(p=>p.json()).then(p=>{let L=p.players||[];h&&(h.innerHTML=L.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players on the preseason leaderboard yet. Unlock a daily AI briefing to join!</p>`:s(L))}).catch(p=>{console.error("Failed to load preseason leaderboard:",p),h&&(h.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading preseason leaderboard. Please try again.</p>`)})},l=()=>{let h=document.getElementById("season1LeaderboardListContainer");n(h,6),fetch(I("/api/leaderboard/season1")).then(p=>p.json()).then(p=>{let L=p.map((y,x)=>{let T=x+1,M=null;return T<=6?M=1:T<=12&&(M=2),{username:y.wallet_address,displayName:y.username,points:y.points,status:`${y.wins} wins, ${y.losses} losses`,totalTrades:y.total_trades,aiBriefingUnlocks:y.ai_briefing_unlocks,globalRank:T,prizeEligible:T<=10,nextSeasonDivision:M}});if(h)if(G==="global")h.innerHTML=L.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players in Season 1.</p>`:a(L);else{let y=document.getElementById("season1DivisionSelector"),x=y?Number(y.value):1,T=L.filter(M=>M.nextSeasonDivision===x);h.innerHTML=T.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players in this division.</p>`:o(T)}}).catch(p=>{console.error("Failed to load Season 1 archive:",p),h&&(h.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading Season 1 leaderboard archive. Please try again.</p>`)})},c=h=>{G=h,document.querySelectorAll("[data-season1-view]").forEach(p=>{p.classList.toggle("active",p.dataset.season1View===h)}),document.getElementById("season1DivisionControls")?.toggleAttribute("hidden",h!=="division"),document.getElementById("season1GlobalControls")?.toggleAttribute("hidden",h!=="global"),document.getElementById("season1PrizeBox")?.toggleAttribute("hidden",h!=="global"),l()};i(),Z&&c(G);let m=document.getElementById("archiveExpandBtn"),u=document.getElementById("archiveContent"),d=document.getElementById("archiveChevron");m?.addEventListener("click",()=>{Z=!Z,u&&(u.style.display=Z?"block":"none"),d&&(d.style.transform=Z?"rotate(180deg)":"rotate(0deg)"),Z&&c(G)}),document.querySelectorAll("[data-season1-view]").forEach(h=>{h.addEventListener("click",()=>{let p=h.dataset.season1View==="division"?"division":"global";c(p)})}),document.getElementById("season1DivisionSelector")?.addEventListener("change",()=>{l()}),document.getElementById("faucetClaimButton")?.addEventListener("click",async()=>{if(!t.walletAddress){w("Please sign in first!");return}if(localStorage.getItem("siftle_circle_is_mock")==="true"){let p=parseFloat(localStorage.getItem(`siftle_mock_balance_${t.walletAddress}`)||"1000.00")+100;localStorage.setItem(`siftle_mock_balance_${t.walletAddress}`,p.toFixed(2)),t.walletBalance=p.toFixed(2),w("Claimed $100 USDC mock credits!"),_(),sr()}else w("Opening Circle Faucet..."),window.open(Ve,"_blank")});let k=document.getElementById("howItWorksBtn"),v=document.getElementById("howItWorksModal"),A=document.getElementById("closeRulesModalBtn");k?.addEventListener("click",()=>{v&&v.classList.add("active")}),A?.addEventListener("click",()=>{v&&v.classList.remove("active")}),v?.addEventListener("click",h=>{h.target===v&&v.classList.remove("active")})},nr=()=>{t.activeSurface="feed",t.selectedMarketId=null,He?.toggleAttribute("hidden",!0),Re?.toggleAttribute("hidden",!0),le?.toggleAttribute("hidden",!0),Me?.classList.remove("active"),Ae?.classList.add("active"),Ue?.classList.remove("active"),S?.classList.remove("markets-list")},Pa=e=>e===1?"Yes resolved":e===2?"No resolved":e===3?"Invalid":"Open",At=e=>{let r=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},a=t.marketSnapshots[e.id];if(te(e)){let k=a?.resolvedOptionId||null,v=!!k,A=v&&r.optionId===k,h=sa(r,a),p=A?h:0,L=ae(e).find(T=>T.id===k)?.label,y=!!r.claimedAt||Oe().has(e.id),x=!!t.claimingMarketIds[e.id];return`
      <article class="portfolio-position-card">
        <div class="portfolio-position-top">
          <span class="category-chip ${e.category}">${W(e.category)}</span>
          <span>${v?`Resolved: ${C(L||"Option selected")}`:"Open"}</span>
        </div>
        <h2>${e.question}</h2>
        <div class="portfolio-position-stats">
          <div><span>Your pick</span><strong>${C(r.optionLabel||"Selected option")}</strong></div>
          <div><span>Entry</span><strong>$${H(r.optionSharesUsdc||0)}</strong></div>
          <div><span>Projected payout</span><strong>$${H(p)}</strong></div>
        </div>
        <div class="portfolio-position-footer">
          <span>${v?"":`Closes ${e.closes}`}</span>
          ${v?y?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':x?'<button type="button" class="connect-wallet-btn" disabled style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; opacity: 0.7 !important; cursor: wait !important;">Claiming...</button>':A?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${H(p)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>':""}
        </div>
      </article>
    `}let o=Pa(a?.outcome),s=Zt(r,a),n=s.reduce((k,v)=>Math.max(k,v.payout),0),i=r.yesSharesUsdc+r.noSharesUsdc,l=a?.outcome??0,c=Oe().has(e.id),m=l===1?r.yesSharesUsdc:l===2?r.noSharesUsdc:0,u=l===1?a?.yesSharesUsdc??0:l===2?a?.noSharesUsdc??0:0,d=a?.volumeUsdc??0,b=m>0&&u>0?m/u*d:0,f=l===0?"":c?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':b>0?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${H(b)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>';return`
    <article class="portfolio-position-card">
      <div class="portfolio-position-top">
        <span class="category-chip ${e.category}">${W(e.category)}</span>
        <span>${o}</span>
      ...
      <div class="portfolio-position-footer">
        ...
        ${f||`<span>Closes ${e.closes}</span>`}
      </div>
    </article>
  `},Ca=async e=>{if(!t.walletAddress){w("Please sign in first.");return}let r=Te().find(o=>o.id===e),a=r?K(r):"";if(!r||!a){w("Market is not available.");return}try{t.claimingMarketIds[r.id]=!0,F(),U("claim_attempt"),ct();let o=await mr(a,t.walletAddress);U("claim_success"),o.won&&aa(r.id),delete t.marketPositions[r.id],delete t.marketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.walletBalance=await ne(t.walletAddress),await z(),w(o.won?`Claimed $${H(o.amountUsdc)}`:"No payout to claim"),_(),F()}catch(o){U("claim_failed"),w(o instanceof Error?o.message:"Claim failed")}finally{delete t.claimingMarketIds[r.id],F()}},Ia=e=>{if(!e)return"";let r=t.referralData,a=r?.referrals?.length?r.referrals.map(s=>{let n=s.displayName||R(s.walletAddress),i=s.remaining<=0;return`
      ...
      `}).join(""):'<div class="portfolio-empty compact">No referrals yet.</div>',o=t.loadingReferralData&&!r?'<div class="portfolio-referral-message">Loading invite tools...</div>':t.referralError&&!r?`
        <div class="portfolio-referral-message">
          <span>${C(t.referralError)}</span>
          <button type="button" data-refresh-referrals>Retry</button>
        </div>
      `:r?`
          <div class="portfolio-referral-copy-grid">
            <button type="button" class="portfolio-referral-copy" data-copy-referral-code="${C(r.code)}">
              <span>Invite code</span>
              <strong>${C(r.code)}</strong>
            </button>
            <button type="button" class="portfolio-referral-copy" data-copy-referral-link="${C(r.inviteLink)}">
  ...
  `},g=()=>{if(Dt.forEach(e=>{let r=e.dataset.bottomNav;e.classList.toggle("active",r==="saved"?t.showSaved:r===t.activeSurface&&!t.showSaved)}),t.activeSurface==="markets"){or();return}if(t.activeSurface==="portfolio"){F();return}if(t.activeSurface==="leaderboard"){sr();return}nr(),Yt(),ve(),Ma(),j&&(j.value=t.activeArchiveDate??"")};Qe.textContent=Ot();le?.addEventListener("click",e=>{let a=e.target.closest("[data-category]");a&&(t.activeCategory=a.dataset.category,window.history.pushState({},"","#feed"),J(),g(),Ie(),re(t.activeCategory))});S?.addEventListener("input",e=>{let r=e.target;if(r.id!=="newsSearchInput")return;let a=r.selectionStart??r.value.length,o=r.selectionEnd??r.value.length;t.newsSearchQuery=r.value,ve();let s=S?.querySelector("#newsSearchInput");s&&(s.focus(),s.setSelectionRange(a,o))});Me?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,window.history.pushState({},"","#markets"),J(),g()});Ae?.addEventListener("click",()=>{t.activeSurface="feed",t.showSaved=!1,window.history.pushState({},"","#feed"),J(),g(),Ie(),re(t.activeCategory)});Ue?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=!1,window.history.pushState({},"","#portfolio"),J(),g()});oe?.addEventListener("click",()=>{t.walletAddress?(window.location.hash="#portfolio",Ce()):Le()});document.addEventListener("click",e=>{let r=e.target,a=r.closest(".copy-address-btn");if(a){let i=a.getAttribute("data-address");i&&navigator.clipboard.writeText(i).then(()=>{w("Wallet address copied!")})}let o=r.closest("[data-claim-market]");if(o){let i=o.getAttribute("data-claim-market");i&&Ca(i);return}if(r.closest("[data-open-referrals]")){t.referralPanelOpen=!t.referralPanelOpen,!t.referralData&&!t.loadingReferralData&&xe(),F();return}if(r.closest("[data-close-referrals]")){t.referralPanelOpen=!1,F();return}if(r.closest("[data-refresh-referrals]")){t.referralError=null,xe(),F();return}let s=r.closest("[data-copy-referral-code]");if(s){let i=s.getAttribute("data-copy-referral-code")||"";i&&navigator.clipboard.writeText(i).then(()=>w("Invite code copied"));return}let n=r.closest("[data-copy-referral-link]");if(n){let i=n.getAttribute("data-copy-referral-link")||"";i&&navigator.clipboard.writeText(i).then(()=>w("Invite link copied"));return}r.closest("[data-connect-wallet]")&&(t.walletAddress?Pt():Le())});Dt.forEach(e=>{e.addEventListener("click",()=>{let r=e.dataset.bottomNav;t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=r==="saved",r==="markets"?(t.activeSurface="markets",window.history.pushState({},"","#markets")):r==="portfolio"?(t.activeSurface="portfolio",window.history.pushState({},"","#portfolio")):r==="leaderboard"?(t.activeSurface="leaderboard",window.history.pushState({},"","#leaderboard")):(t.activeSurface="feed",window.history.pushState({},"","#feed"),Ie(),re(t.activeCategory),r==="saved"&&(ta(),rt(),Se())),J(),g()})});j?.addEventListener("change",()=>{t.activeArchiveDate=j.value||null,window.history.pushState({},"","#feed"),J(),g(),re(t.activeCategory)});Mr?.addEventListener("click",()=>{t.activeArchiveDate=null,j&&(j.value=""),window.history.pushState({},"","#feed"),J(),g(),re(t.activeCategory)});S?.addEventListener("click",async e=>{let r=e.target;if(r.closest("#editUsernameBtn")){let v=S?.querySelector(".username-display-row"),A=S?.querySelector("#usernameEditForm");if(v&&A){v.style.display="none",A.style.display="flex";let h=A.querySelector("#usernameInput");h&&h.focus()}return}if(r.closest("#cancelUsernameBtn")){let v=S?.querySelector(".username-display-row"),A=S?.querySelector("#usernameEditForm");v&&A&&(v.style.display="flex",A.style.display="none");return}let s=r.closest("#saveUsernameBtn");if(s){let A=S?.querySelector("#usernameEditForm")?.querySelector("#usernameInput");if(A){let h=A.value.trim().slice(0,15),p=s,L=p.textContent||"Save";p.disabled=!0,p.textContent="Saving...",ea(h),t.profileNotice=null;try{t.walletAddress&&await ue(!1),t.profileNotice={type:"success",message:"Username saved to your shared leaderboard profile."},w("Username updated"),F()}catch(y){let x=y instanceof Error?y.message:"Username save failed";t.profileNotice={type:"error",message:x},w(x),p.disabled=!1,p.textContent=L,F()}}return}let n=r.closest("[data-timeframe]");if(n){let v=n.dataset.timeframe;t.activeMarketTimeframe=v,or();return}let i=r.closest("[data-market-id]");if(i){t.selectedMarketId=i.dataset.marketId??null,U("market_view"),window.history.pushState({},"",`#market-${t.selectedMarketId}`),g(),window.scrollTo({top:0,behavior:"smooth"});return}if(r.closest(".read-tweet-btn")){e.stopPropagation();let v=r.closest("[data-story-id]");v&&Ze(Number(v.dataset.storyId),!0);return}let c=r.closest("[data-thread-story-id]"),m=r.closest("[data-export-id]"),u=r.closest("[data-export-action]"),d=r.closest("[data-story-id]");if(c){e.stopPropagation();let v=t.stories.find(A=>A.id===Number(c.dataset.threadStoryId));v&&jr(v);return}let b=r.closest(".mobile-bookmark-btn, .bookmark-button");if(b){e.stopPropagation();let v=b.dataset.bookmarkUrl||"",A=t.stories.find(h=>h.sourceUrl===v);if(!A)return;A.saved=!A.saved,A.saved?ie.add(v):ie.delete(v),Tr(),w(A.saved?"Saved to your list":"Removed from saved"),ve();return}if(u){e.stopPropagation(),xa(Number(u.dataset.exportStoryId),u.dataset.exportAction);return}if(m){e.stopPropagation();let v=Number(m.dataset.exportId);t.activeShareStoryId=t.activeShareStoryId===v?null:v,ve();return}if(!d||r.closest("a"))return;let f=Number(d.dataset.storyId),k=t.stories.find(v=>v.id===f);k&&U("feed_story_click",k.sourceUrl,k.headline),Ze(f,!0)});S?.addEventListener("keydown",e=>{let a=e.target.closest("[data-story-id]");if(!a||e.key!=="Enter"&&e.key!==" ")return;e.preventDefault();let o=Number(a.dataset.storyId),s=t.stories.find(n=>n.id===o);s&&U("feed_story_click",s.sourceUrl,s.headline),Ze(o)});$?.addEventListener("click",e=>{let r=e.target,a=r.closest("[data-unlock-briefing]");if(a){let u=t.stories.find(d=>d.id===Number(a.dataset.unlockBriefing));u&&Xe(u);return}let o=r.closest("[data-unlock-briefing-url]");if(o){let u=decodeURIComponent(o.dataset.unlockBriefingUrl||""),d=Rr(u);d&&(ce(d)?$e(d):Xe(d));return}if(r.closest("[data-back-markets]")){t.selectedMarketId=null,t.tradeDrawerOpen=!1,window.history.pushState({},"","#markets"),g();return}if(r.closest("#openTradeDrawerBtn")){let u=E.find(f=>f.id===t.selectedMarketId);if(u){if(je(u,t.marketSnapshots[u.id])){w("This market is resolved and can no longer be traded.");return}if(jt(u,t.marketSnapshots[u.id])){w("Trading is locked 20 minutes before kickoff.");return}}t.tradeDrawerOpen=!0,U("trade_drawer_open");let d=$.querySelector("#tradeDrawer"),b=$.querySelector("#tradeDrawerBackdrop");d?.classList.add("open"),b?.classList.add("open");return}if(r.closest("#closeTradeDrawerBtn")||r.closest("#tradeDrawerBackdrop")){t.tradeDrawerOpen=!1;let u=$.querySelector("#tradeDrawer"),d=$.querySelector("#tradeDrawerBackdrop");u?.classList.remove("open"),d?.classList.remove("open");return}if(r.closest("#shareWhatsAppBtn")){let u=E.find(d=>d.id===t.selectedMarketId);if(u){let d=Ua(u),b=`https://api.whatsapp.com/send?text=${encodeURIComponent(d)}`;window.open(b,"_blank")}return}let s=r.closest("[data-market-trade]");if(s&&t.selectedMarketId){let u=s.dataset.marketTrade;da(t.selectedMarketId,u);return}let n=r.closest("[data-market-option-trade]");if(n&&t.selectedMarketId){let u=n.dataset.marketOptionTrade||t.marketTradeOptionId||"";$a(t.selectedMarketId,u);return}let i=r.closest("[data-market-option-id]");if(i){if(i.disabled||i.classList.contains("disabled"))return;t.marketTradeOptionId=i.dataset.marketOptionId||null,g();return}let l=r.closest("[data-market-trade-side]");if(l){if(l.disabled||l.classList.contains("disabled"))return;let u=E.find(f=>f.id===t.selectedMarketId),d=u?t.marketPositions[u.id]:void 0,b=l.dataset.marketTradeSide;if(!se(t.marketOrderMode,b,d))return;t.marketTradeSide=b,g();return}let c=r.closest("[data-market-order-mode]");if(c){t.marketOrderMode=c.dataset.marketOrderMode;let u=E.find(b=>b.id===t.selectedMarketId),d=u?t.marketPositions[u.id]:void 0;t.marketTradeSide=dt(t.marketOrderMode,t.marketTradeSide,d),t.marketTradeAmount=Ee(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,d),g();return}let m=r.closest("[data-back-to-feed]");if(m){if(m.classList.contains("read-more-news-btn")){let d=new URLSearchParams(window.location.search).get("url"),b=document.querySelector(".detail-card h2")?.textContent||void 0;U("shared_read_more_click",d||void 0,b)}Fr()}});$?.addEventListener("input",e=>{let r=e.target;if(!r.matches("[data-market-amount]"))return;let a=E.find(c=>c.id===t.selectedMarketId),o=a?t.marketSnapshots[a.id]:void 0,s=a?t.marketPositions[a.id]:void 0,n=Number(r.value);t.marketTradeAmount=Number.isFinite(n)?n:0;let i=a&&te(a)?t.marketTradeAmount:Xt(o,t.marketTradeSide,t.marketTradeAmount,t.marketOrderMode,s),l=$.querySelector(".market-inline-payout strong");l&&(l.textContent=`$${H(i)}`)});$?.addEventListener("focusin",e=>{e.target.matches("[data-market-amount]")&&document.body.classList.add("market-amount-focused")});$?.addEventListener("focusout",e=>{let r=e.target;if(r.matches("[data-market-amount]")){let a=E.find(s=>s.id===t.selectedMarketId),o=a?t.marketPositions[a.id]:void 0;t.marketTradeAmount=Ee(Number(r.value)||0,t.marketOrderMode,t.marketTradeSide,o),r.value=String(t.marketTradeAmount),window.setTimeout(()=>document.body.classList.remove("market-amount-focused"),120)}});window.addEventListener("popstate",Ce);window.addEventListener("hashchange",Ce);window.addEventListener("focus",async()=>{if(t.walletAddress){let e=t.walletBalance,r=await ne(t.walletAddress);t.walletBalance=r,_(),(!e||parseFloat(e)===0)&&parseFloat(r)>0&&(console.log("[X402] Balance changed from 0 to positive. Triggering Gateway warmup..."),hr())}});Ye?.addEventListener("click",()=>{if(!Ge||!Ye)return;let e=!Ge.hidden;Ge.hidden=e,Ye.setAttribute("aria-expanded",String(!e))});document.addEventListener("click",e=>{let r=e.target;!r.closest(".share-control")&&t.activeShareStoryId!==null&&(t.activeShareStoryId=null,ve());let a=r.closest("[data-menu-action]");if(!a)return;let o={today:"Showing today's brief",saved:`${t.stories.filter(s=>s.saved).length} saved stories`,archive:t.archiveDates.length>0?"Choose a saved day from the archive selector":"No saved days yet"};P&&(P.textContent=o[a.dataset.menuAction??"today"]),a.dataset.menuAction==="today"&&(t.showSaved=!1,t.activeArchiveDate=null,j&&(j.value=""),J(),Ie(),re(t.activeCategory)),a.dataset.menuAction==="saved"&&(nr(),rt(),Se(),t.showSaved=!0,document.querySelector("#archiveControls")?.classList.remove("mobile-open"),J(),g())});var Ea=async()=>{try{let e=await fetch(I("/api/summary/unlock-config"));e.ok&&(t.unlockConfig=await e.json(),g())}catch(e){console.error("Failed to prefetch unlock config:",e)}},Ba=()=>{window.setInterval(async()=>{try{let e=new AbortController,r=window.setTimeout(()=>e.abort(),3500),a=await fetch(I("/api/markets"),{signal:e.signal});if(window.clearTimeout(r),a.ok){let o=await a.json();Array.isArray(o)&&o.length>0&&(E=o,t.activeSurface==="markets"&&g())}}catch(e){console.warn("Background market poll failed:",e)}},3e4)};g();_();Ea();re(t.activeCategory);Ba();$r().then(()=>{ia(),g(),_(),window.setTimeout(Na,1200),Yr()});var _a=document.querySelector("#mobileArchiveCard"),ge=document.querySelector("#archiveControls");_a?.addEventListener("click",()=>{if(!ge)return;ge.classList.toggle("mobile-open")&&setTimeout(()=>ge.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Da=document.querySelector("#archivePill");Da?.addEventListener("click",e=>{if(e.stopPropagation(),!ge)return;ge.classList.toggle("mobile-open")&&setTimeout(()=>ge.scrollIntoView({behavior:"smooth",block:"center"}),50)});var _e=!1,Ut=!1,Na=()=>{Ut||(Ut=!0,(async()=>{let e=await De();if(_e=!!e,e){t.walletConnecting=!0,_();try{let r=await fr();_e=!1,t.walletConnecting=!1,r?(t.walletAddress=await De(),t.walletAddress&&(fe(),t.walletBalance=await ne(t.walletAddress),await z()),_(),t.activeSurface==="portfolio"&&g()):(t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),w("Session expired. Please sign in again."),_(),g())}catch(r){console.warn(r),_e=!1,t.walletConnecting=!1,t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),w("Session expired. Please sign in again."),_(),g()}}await gr(r=>{_e||(t.walletAddress=r,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),r&&ue(!1).catch(a=>console.error("Failed to report leaderboard entry:",a)),t.marketPositions={},t.hasLoadedPortfolioPositions=!1,_(),r?(xe(),ne(r).then(a=>{t.walletBalance=a,_(),t.activeSurface==="portfolio"&&g()}),z()):t.activeSurface==="portfolio"&&g())})})())};U("app_open");document.addEventListener("click",e=>{let a=e.target.closest("a, button");if(a){let o=a.className||"",s=typeof o=="string"?o:a.getAttribute("class")||"",n=a.getAttribute("href")||"";!(a.hasAttribute("data-unlock-briefing")||a.hasAttribute("data-unlock-briefing-url")||a.classList.contains("summary-btn")||a.textContent?.trim()==="AI briefing"||a.textContent?.trim().includes("Unlock via"))&&(s.includes("source-button")||s.includes("source-btn")||s.includes("source-link")||a.textContent?.trim()==="Open source")&&!s.includes("disabled")&&n!=="#"&&U("open_source")}},!0);
