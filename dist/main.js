import"./chunks/chunk-ZUUPKAA6.js";var me="Sports",De=[{id:"wc-spain-belgium-qualify",category:me,timeframe:"Daily",optionMarket:!0,question:"Which team will qualify in Spain vs Belgium?",options:[{id:"spain",label:"Spain"},{id:"belgium",label:"Belgium"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on the team that officially qualifies in Spain vs Belgium, including extra time and penalties.",threadTopic:"Spain vs Belgium Qualify Watch",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-spain-concede-belgium",category:me,timeframe:"Daily",optionMarket:!0,question:"Will Spain concede against Belgium?",options:[{id:"yes",label:"Yes"},{id:"no",label:"No"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on whether Belgium are officially credited with at least one goal against Spain in regular time or extra time. Penalty shootout goals do not count.",threadTopic:"Spain Clean Sheet Watch vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-yamal-goal-assist-belgium",category:me,timeframe:"Daily",optionMarket:!0,question:"Will Lamine Yamal record a goal or assist against Belgium?",options:[{id:"yes",label:"Yes"},{id:"no",label:"No"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on whether Lamine Yamal is officially credited with at least one goal or at least one assist for Spain against Belgium in regular time or extra time. Penalty shootout goals do not count.",threadTopic:"Lamine Yamal Impact vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1522778119026-d647f0596c20?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-spain-goals-belgium",category:me,timeframe:"Daily",optionMarket:!0,question:"How many goals will Spain score in regular + extra time vs Belgium?",options:[{id:"0",label:"0 goals"},{id:"1",label:"1 goal"},{id:"2",label:"2 goals"},{id:"3-plus",label:"3+ goals"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on the number of goals officially scored by Spain against Belgium in regular time and extra time. Penalty shootout goals do not count.",threadTopic:"Spain Goals vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-tonali-spurs",category:me,timeframe:"Sagas",question:"Will Sandro Tonali sign with Tottenham Hotspur in the Summer Transfer Window?",probability:58,closes:"September 1, 2026",resolution:"Resolves Yes if Tottenham Hotspur officially announces the transfer/signing of Sandro Tonali by the transfer deadline.",threadTopic:"Sandro Tonali Tottenham Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$182K",traders:"980",liquidity:"$29K",imageUrl:"https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-guimaraes-arsenal",category:me,timeframe:"Sagas",question:"Will Bruno Guimaraes officially sign with Arsenal by September 1, 2026?",probability:45,closes:"September 1, 2026",resolution:"Resolves Yes if Arsenal officially announces the transfer/signing of Bruno Guimaraes by the transfer deadline.",threadTopic:"Bruno Guimaraes Arsenal Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$204K",traders:"1,240",liquidity:"$36K",imageUrl:"https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=1200&q=80",evidence:[]}];var Xe="https://faucet.circle.com/",ft="siftle_backend_wallet_migration_notice",Ye=null,_=()=>(Ye||(Ye=import("./chunks/arc-ZAE4BJZI.js")),Ye),j=e=>e.length>10?`${e.slice(0,6)}...${e.slice(-4)}`:e,ua=async()=>(await _()).connectArcWallet(),te=async e=>(await _()).readArcUsdcBalance(e),fa=async(e,a,r,o)=>(await _()).payAiBriefingUnlock(e,a,r,o),ga=e=>{_().then(a=>a.resolveLocalTestMarketYes(e))},ha=async e=>(await _()).readArcMarketSnapshot(e);var It=async(e,a)=>(await _()).readArcMarketState(e,a),va=async(e,a,r,o,s,n,i)=>(await _()).executeArcMarketOrder(e,a,r,o,s,n,i),ba=async(e,a,r,o,s)=>(await _()).executeArcOptionMarketOrder(e,a,r,o,s),Bt=()=>{_().then(e=>e.disconnectArcWallet())},ya=async(e,a)=>(await _()).claimArcMarketPayout(e,a),Oe=async()=>(await _()).getConnectedArcWallet(),ka=async()=>(await _()).validateArcSession(),wa=async e=>(await _()).subscribeArcWallet(e),Sa=async()=>(await _()).triggerGatewayWarmup(),xa=["Sports"],$a="https://siftle.onrender.com",Ta=()=>{let e=(window.SIFTLE_API_BASE||"").replace(/\/$/,"");if(e)return e;let a=typeof window<"u"?window.location.hostname.toLowerCase():"";return a==="siftle.xyz"||a.endsWith(".siftle.xyz")||a.endsWith(".vercel.app")?$a:""},Aa=Ta(),E=e=>`${Aa}${e}`,Dt="siftle_theme",Ma=()=>{try{return window.localStorage.getItem(Dt)==="light"?"light":"dark"}catch{return"dark"}},xe=Ma();function C(e){fetch(E("/api/analytics"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:e})}).catch(a=>console.error("Failed to track event:",a))}var t={activeSurface:"markets",profileUsername:null,selectedMarketId:null,marketOrderMode:"buy",marketTradeSide:"yes",marketTradeOptionId:null,marketTradeAmount:5,marketSnapshots:{},marketPositions:{},marketEvidenceOverrides:{},loadingMarkets:!0,checkedMarketEvidence:{},checkedMarketSnapshots:{},loadingMarketSnapshots:{},loadingMarketEvidence:{},loadingPortfolioPositions:!1,marketTradeStatus:null,hasLoadedPortfolioPositions:!1,walletConnecting:!1,walletAddress:null,walletBalance:null,activeCategory:"Sports",stories:[],isLoading:!1,selectedStoryId:null,aiSummaries:{},loadingSummaryUrl:null,unlockingSummaryUrl:null,archiveDates:[],activeArchiveDate:null,activeShareStoryId:null,selectedThreadUrl:null,activeThread:null,loadingThreadUrl:null,feedScrollY:0,hasLoadedFeed:!1,showSaved:!1,tradeDrawerOpen:!1,activeMarketTimeframe:"All",profileNotice:null,portfolioMarketPreviews:[],referralPanelOpen:!1,referralData:null,referralError:null,loadingReferralData:!1,portfolioPositionsLoadedAt:0,unlockConfig:null,newsSearchQuery:"",briefingStatusByUrl:{},claimingMarketIds:{}},ke=null,Q="global",J=null,gt=!1,ht=!1,vt=new URLSearchParams(window.location.search).get("ref")||localStorage.getItem("siftle_pending_referral_code")||"";vt&&localStorage.setItem("siftle_pending_referral_code",vt.trim().toUpperCase());var Nt=20,I=De,La=(...e)=>{let a=new Map;return e.flat().forEach(r=>{r?.id&&a.set(r.id,{...a.get(r.id)||{},...r})}),Array.from(a.values())},Ae=()=>La(t.portfolioMarketPreviews,I,De),Ua=async()=>{t.loadingMarkets=!0,I.length===0&&(I=De);try{let e=new AbortController,a=window.setTimeout(()=>e.abort(),3500),r=await fetch(E("/api/markets"),{signal:e.signal});if(window.clearTimeout(a),r.ok){let o=await r.json();Array.isArray(o)&&o.length>0&&(I=o)}}catch(e){console.error("Failed to load markets:",e)}finally{t.loadingMarkets=!1}},Ot=async()=>{try{let e=await fetch(E("/api/portfolio/markets"));if(!e.ok)return;let a=await e.json();Array.isArray(a)&&(t.portfolioMarketPreviews=a.map(r=>({threadStoryId:0,updates:0,movement:0,evidence:[],...r})))}catch(e){console.warn(e)}},_t="siftle.savedUrls",ae=new Set,ot=()=>{try{let e=localStorage.getItem(_t)||"[]",a=JSON.parse(e);ae=new Set(a.filter(Boolean))}catch{ae=new Set}},Pa=()=>{try{localStorage.setItem(_t,JSON.stringify(Array.from(ae)))}catch{}},$e=()=>{if(Array.isArray(t.stories))for(let e of t.stories)e.saved=!!ae.has(e.sourceUrl)};ot();$e();var et=document.querySelector("#dateLabel"),re=document.querySelector("#categoryTabs"),k=document.querySelector("#storyList"),w=document.querySelector("#storyDetail"),Ge=document.querySelector("#menuButton"),Je=document.querySelector("#menuPanel"),A=document.querySelector("#menuStatus"),F=document.querySelector("#archiveDateSelect"),bt=document.querySelector("#archiveStatus"),Ca=document.querySelector("#todayButton"),Re=document.querySelector(".brief-hero"),je=document.querySelector("#archiveControls"),Me=document.querySelector("[data-surface='markets']"),Le=document.querySelector("[data-surface='feed']"),Ue=document.querySelector("[data-surface='portfolio']"),X=document.querySelector("#walletButton"),we=document.querySelector("[data-theme-toggle]"),Ht=Array.from(document.querySelectorAll("[data-bottom-nav]")),Ke,Ea=()=>{if(!we)return;let a=`Switch to ${xe==="light"?"dark":"light"} mode`;we.setAttribute("aria-label",a),we.title=a,we.dataset.activeTheme=xe},Rt=e=>{xe=e,document.documentElement.dataset.theme=e;try{window.localStorage.setItem(Dt,e)}catch{}Ea()};Rt(xe);var B=()=>{if(X){let e=X.querySelector(".wallet-button-label");X.classList.toggle("connected",!!t.walletAddress),X.disabled=t.walletConnecting,X.setAttribute("aria-label",t.walletAddress?`Wallet ${j(t.walletAddress)}`:"Sign in"),e&&(e.textContent=t.walletConnecting?"Signing in...":t.walletAddress?"Wallet":"Sign in"),X.title=t.walletAddress?`${t.walletBalance??"0"} Arc Testnet USDC - ${j(t.walletAddress)}`:"Sign in"}};window.addEventListener("resize",B);we?.addEventListener("click",()=>{Rt(xe==="light"?"dark":"light")});var Ia=async e=>{let a=localStorage.getItem("siftle_pending_referral_code");if(a)try{let r=await fetch(E("/api/referrals/bind"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:e,referralCode:a})}),o=await r.json().catch(()=>({}));r.ok&&(o.bound||o.reason==="already_bound"||o.reason==="invalid_code")&&(localStorage.removeItem("siftle_pending_referral_code"),o.bound&&v("Referral connected"))}catch(r){console.warn(r)}},Te=async()=>{if(!(!t.walletAddress||t.loadingReferralData)){t.loadingReferralData=!0,t.referralError=null;try{let e=await fetch(E(`/api/referrals?walletAddress=${encodeURIComponent(t.walletAddress)}`)),a=await e.json().catch(()=>({}));e.ok?t.referralData=a:t.referralError=a?.error||"Referral tools are temporarily unavailable."}catch(e){console.warn(e),t.referralError="Referral tools are temporarily unavailable."}finally{t.loadingReferralData=!1,t.activeSurface==="portfolio"&&q()}}},ze=async()=>{if(!t.walletConnecting){t.walletConnecting=!0,C("wallet_connect_start"),B();try{let e=await ua();if(e){C("wallet_connect_success"),t.walletAddress=e,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ue(),t.walletBalance=await te(e),await Ia(e),Te(),await z(),ie(!0).catch(r=>console.error("Failed to report leaderboard entry:",r));let a=localStorage.getItem(ft);a?(localStorage.removeItem(ft),v(a)):v("Connected to Arc Testnet"),window.location.hash="#portfolio",Ce()}}catch(e){C("wallet_connect_failed"),v(e instanceof Error?e.message:"Wallet connection failed")}finally{t.walletConnecting=!1,B()}}},v=e=>{let a=document.querySelector("#actionToast");a||(a=document.createElement("div"),a.id="actionToast",a.className="action-toast",a.setAttribute("role","status"),a.setAttribute("aria-live","polite"),document.body.appendChild(a)),a.textContent=e,a.classList.add("show"),Ke&&window.clearTimeout(Ke),Ke=window.setTimeout(()=>{a?.classList.remove("show")},1700)};window.showActionToast=v;var Ba=(e,a,r,o)=>{let s=document.createElement("div");s.className="success-modal-overlay",s.innerHTML=`
  ...
  `,document.body.appendChild(s),setTimeout(()=>{s.classList.add("show")},10);let n=()=>{s.classList.remove("show"),setTimeout(()=>{s.remove()},300)};s.querySelector(".success-modal-close-btn")?.addEventListener("click",n),s.querySelector(".success-modal-action-btn")?.addEventListener("click",n),s.addEventListener("click",i=>{i.target===s&&n()})},Y=()=>{t.feedScrollY=0,window.scrollTo({top:0,behavior:"auto"})},jt=e=>{let a=e?new Date(`${e}T12:00:00`):new Date;return new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric"}).format(a)},Da=()=>t.stories.filter(e=>{if(t.showSaved)return!!e.saved;if(!(t.activeCategory==="All"||e.category===t.activeCategory))return!1;let a=t.newsSearchQuery.trim().toLowerCase();return a?[e.headline,e.summary,e.source,e.ai_summary].filter(Boolean).join(" ").toLowerCase().includes(a):!0}),_e=e=>t.activeArchiveDate?e.postedAt:`${e.postedAt} ago`,Na=e=>/(\*\*?\s*critique|attempt\s*\d|prompt says|let'?s try|tighter version|word count|violat(?:e|es)|output only|valid json|the model|the prompt)/i.test(e),Oa=(e,a=140)=>{let r=e.split(/\s+/).filter(Boolean);if(r.length<=a)return e;let s=r.slice(0,a).join(" "),n=Math.max(s.lastIndexOf("."),s.lastIndexOf("?"),s.lastIndexOf("!"));return n>s.length*.45?s.slice(0,n+1).trim():`${s.replace(/[,:;.'"!\?\s]+$/,"")}...`},yt=e=>{let a=String(e||"").trim();for(let r=0;r<2;r+=1){let o=a.match(/^```(?:json)?\s*([\s\S]*?)\s*```$/i);if(o&&(a=o[1].trim()),!/^\s*\{[\s\S]*\}\s*$/.test(a))break;try{let s=JSON.parse(a);if(typeof s.summary=="string"){a=s.summary.trim();continue}}catch{break}break}return a=a.replace(/&lt;|&#60;/gi,"<").replace(/&gt;|&#62;/gi,">").replace(/<[^>]+>/g," ").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&#39;/g,"'").replace(/&apos;/g,"'").replace(/&quot;/g,'"').replace(/^["'{\s]+/,"").replace(/["'}\s]+$/,"").replace(/^summary["'\s]*:[\s"']*/i,"").replace(/\s+/g," ").trim(),Na(a)?"":Oa(a)},oe=(e,a)=>yt(a||"")||yt(e.summary)||e.headline,_a=e=>{let r=e?.closest(".detail-summary, .thread-item, .market-thread-update")?.querySelector(".briefing-capture-area");if(!r||!window.html2canvas)return;let o=document.createElement("div");o.className="briefing-export-staging";let s=r.cloneNode(!0);s.classList.add("briefing-export-surface"),o.appendChild(s),document.body.appendChild(o);let n=document.documentElement.dataset.theme==="light";window.html2canvas(s,{backgroundColor:n?"#f5f7fb":"#0f172a",scale:2,logging:!1,useCORS:!0}).then(i=>{let d=document.createElement("a");d.download="siftle-briefing.png",d.href=i.toDataURL("image/png"),d.click(),window.showActionToast?.("Briefing card image downloaded!")}).catch(()=>{window.showActionToast?.("Unable to download briefing card")}).finally(()=>{o.remove()})};window.downloadBriefingCard=_a;var st=(e,a)=>{let r=e.split(/(?:\*\*|__)?(WHAT HAPPENED|KEY POINTS|TAKEAWAY)\s*:?\s*(?:\*\*|__)?\s*:?\s*/i);if(r.length<=1)return`<p class="briefing-text">${e}</p>`;let o='<div class="briefing-capture-area">';if(a){let n=a.headline||"Football Match Update";o+=`
    ...
    `),o},Pe=e=>{let a=t.briefingStatusByUrl[e.sourceUrl]||"";return a?`<p class="briefing-status-note">${M(a)}</p>`:""},Ha=()=>{let e=String(t.walletAddress||"").trim().toLowerCase();return/^0x[a-f0-9]{40}$/.test(e)?e:"guest"},nt=e=>`siftle_ai_briefing_unlock_${Ha()}_${btoa(unescape(encodeURIComponent(e.sourceUrl))).replace(/=+$/g,"")}`,zt=e=>localStorage.getItem(nt(e))||"",Ra=e=>{localStorage.removeItem(nt(e))},se=e=>!!zt(e),Ft=(e,a)=>({id:0,headline:a.headline,category:e.category,summary:a.summary,source:a.source,sourceUrl:a.sourceUrl,imageUrl:e.imageUrl||"",publishedAt:void 0,readTime:"3 min read",postedAt:a.date,accent:"slate",saved:ae.has(a.sourceUrl),ai_summary:void 0,ai_provider:void 0}),ja=e=>{let a=t.stories.find(s=>s.sourceUrl===e);if(a)return a;let o=[t.activeThread?.current,...t.activeThread?.items??[]].filter(Boolean).find(s=>s.sourceUrl===e);if(o)return o;if(t.selectedMarketId){let s=I.find(n=>n.id===t.selectedMarketId);if(s){let n=qe(s).evidence.find(i=>i.sourceUrl===e);if(n)return Ft(s,n)}}return null},it=(e,a)=>{let r=Za(e,a);return r===null?null:r-Nt*60*1e3},qt=(e,a)=>{let r=it(e,a);return r===null?e.closes:new Intl.DateTimeFormat("en",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZoneName:"short"}).format(new Date(r))},Wt=(e,a)=>{let r=it(e,a);return r===null?null:Date.now()>=r?`Locked ${Nt}m before kickoff`:null},za=(e,a)=>{let r=t.unlockConfig?`${t.unlockConfig.amountUsdc} USDC`:"0.05 USDC",o=t.unlockConfig?.x402Enabled;return`
  ...
  `},lt=e=>/^AI briefing unavailable\./i.test(t.briefingStatusByUrl[e.sourceUrl]||"")&&!t.aiSummaries[e.sourceUrl],dt=e=>`
  <div class="briefing-section">
    ${Pe(e)}
...
`,tt=async(e,a=!1)=>{if(!t.walletAddress){v("Please sign in first.");return}if(!(t.unlockingSummaryUrl===e.sourceUrl&&!a)){t.unlockingSummaryUrl=e.sourceUrl,t.briefingStatusByUrl[e.sourceUrl]="Preparing AI briefing payment...",C("ai_unlock_attempt"),g();try{let r=await fetch(E("/api/summary/unlock-config")),o=await r.json();if(!r.ok||!o.treasuryAddress)throw new Error(o.error||"AI briefing is not configured");let s=await fa(o.treasuryAddress,Number(o.amountUsdc)||.05,m=>{A&&(A.textContent=m),t.briefingStatusByUrl[e.sourceUrl]=m,g()},{sourceUrl:e.sourceUrl,topic:e.headline});t.briefingStatusByUrl[e.sourceUrl]=o.x402Enabled?`Payment successful. Loading AI briefing paid with ${o.amountUsdc} testnet USDC through x402.`:`Payment successful. Loading AI briefing paid with ${o.amountUsdc} testnet USDC.`,g();let n=await fetch(E("/api/summary/unlock"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sourceUrl:e.sourceUrl,walletAddress:t.walletAddress,txHash:s})}),i=await n.json();if(!n.ok||!i.unlockToken)throw new Error(i.error||"AI briefing failed");localStorage.setItem(nt(e),i.unlockToken),C("ai_unlock_success"),(Number(i?.bonus?.points)||0)>0&&ie(!1).catch(m=>console.error("Failed to refresh leaderboard bonus:",m)),await Fe(e)}catch(r){C("ai_unlock_failed"),delete t.briefingStatusByUrl[e.sourceUrl],v(r instanceof Error?r.message:"AI briefing failed")}finally{t.unlockingSummaryUrl=null,g()}}},Fe=async e=>{if(se(e)&&!(t.aiSummaries[e.sourceUrl]||t.loadingSummaryUrl===e.sourceUrl)){if(e.ai_summary){t.aiSummaries[e.sourceUrl]=oe(e,e.ai_summary),C("view_summary"),A&&(A.textContent=e.ai_provider==="0g"?"Archived 0G summary loaded":"Archived summary loaded"),g();return}t.loadingSummaryUrl=e.sourceUrl,t.briefingStatusByUrl[e.sourceUrl]="Generating briefing...",g();try{let a=await fetch(E("/api/summary"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...e,walletAddress:t.walletAddress,unlockToken:zt(e)})});if(!a.ok){if(a.status===402){Ra(e),delete t.aiSummaries[e.sourceUrl],t.briefingStatusByUrl[e.sourceUrl]="AI briefing unlock expired. Unlock it again to generate a new briefing.",A&&(A.textContent="Unlock expired. Unlock again to continue."),g();return}throw new Error(`Summary request failed with ${a.status}`)}let r=await a.json();t.aiSummaries[e.sourceUrl]=oe(e,r.summary),t.briefingStatusByUrl[e.sourceUrl]="AI briefing ready.",A&&r.provider&&(A.textContent=r.provider==="0g"?"Summary generated by 0G":`Summary loaded from ${r.provider}`)}catch(a){console.warn(a),delete t.aiSummaries[e.sourceUrl],t.briefingStatusByUrl[e.sourceUrl]="AI briefing unavailable. Retry to generate it again.",A&&(A.textContent="AI briefing failed. Retry available.")}finally{t.loadingSummaryUrl=null,g()}}},Yt=(e,a=!1)=>{let r=t.stories.find(o=>o.id===e);if(r){if(t.feedScrollY=window.scrollY,t.selectedStoryId=r.id,t.selectedThreadUrl=null,t.activeThread=null,window.history.pushState({},"",`#story-${r.id}`),g(),r.type==="tweet"){window.scrollTo({top:0,behavior:"smooth"});return}a&&!se(r)?(t.walletAddress&&(t.unlockingSummaryUrl=r.sourceUrl),g(),tt(r,!0)):se(r)&&Fe(r),window.scrollTo({top:0,behavior:"smooth"})}},Fa=e=>{t.feedScrollY=window.scrollY,t.selectedStoryId=null,t.selectedThreadUrl=e.sourceUrl,t.activeThread=null,t.loadingThreadUrl=e.sourceUrl,window.history.pushState({},"",`#thread-${e.id}`),g(),Gt(e),window.scrollTo({top:0,behavior:"smooth"})},qa=()=>{t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,t.loadingThreadUrl=null,window.history.pushState({},"","#feed"),g(),requestAnimationFrame(()=>window.scrollTo({top:t.feedScrollY,behavior:"auto"}))},Gt=async e=>{try{let a=await fetch(E(`/api/thread?category=${encodeURIComponent(e.category)}&sourceUrl=${encodeURIComponent(e.sourceUrl)}`));if(!a.ok)throw new Error(`Thread request failed with ${a.status}`);t.activeThread=await a.json(),A&&(A.textContent=`${t.activeThread?.count??0} related updates found`)}catch(a){console.warn(a),t.activeThread=null,delete e.thread,t.selectedThreadUrl=null,window.history.replaceState({},"","#feed"),v("That timeline no longer has a verified past update"),A&&(A.textContent="Thread unavailable")}finally{t.loadingThreadUrl=null,g()}};function Ce(){if(window.location.hash==="#resolve-local-yes"){let a=I.find(r=>r.id==="siftle-local-test-2")||I.find(r=>r.timeframe==="Daily"&&G(r).startsWith("0x00000000000000000000000000000000000001"));if(a){ga(G(a)),dr(a,"yes"),delete t.marketSnapshots[a.id],delete t.marketPositions[a.id],delete t.checkedMarketSnapshots[a.id],delete t.loadingMarketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.activeSurface="portfolio",t.selectedMarketId=null,window.history.replaceState({},"","#portfolio"),v("Local test market resolved YES"),z().then(()=>{ie(!0).catch(r=>console.error("Failed to report leaderboard entry:",r)),B(),q()});return}}let e=window.location.hash.match(/^#market-(.+)$/);if(window.location.hash==="#markets"||e){t.activeSurface="markets",t.selectedMarketId=e?.[1]??null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,g();return}if(window.location.hash==="#portfolio"){t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,g();return}if(window.location.hash==="#leaderboard"){t.activeSurface="leaderboard",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,g();return}if(window.location.hash==="#feed"||window.location.hash.startsWith("#story-")||window.location.hash.startsWith("#thread-")){t.activeSurface="feed";let a=window.location.hash.match(/^#story-(\d+)$/),r=window.location.hash.match(/^#thread-(\d+)$/),o=a?t.stories.find(i=>i.id===Number(a[1])):void 0,s=r?t.stories.find(i=>i.id===Number(r[1])):void 0,n=t.selectedStoryId!==null||t.selectedThreadUrl!==null;t.selectedStoryId=o?.id??null,t.selectedThreadUrl=s?.sourceUrl??null,t.activeThread=null,g(),o&&Fe(o),s&&Gt(s),!o&&!s&&n&&requestAnimationFrame(()=>window.scrollTo({top:t.feedScrollY,behavior:"auto"}));return}t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,g()}var at=e=>{bt&&(bt.textContent=e)},Wa=async(e=t.activeCategory,a=!1)=>{a||(t.activeSurface="feed",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,t.loadingThreadUrl=null,t.showSaved=!1),t.isLoading=!0,t.activeSurface==="feed"&&(Vt(),g());try{let r=t.activeArchiveDate?`/api/archive?date=${encodeURIComponent(t.activeArchiveDate)}&category=${encodeURIComponent(e)}`:`/api/feed?category=${encodeURIComponent(e)}`,o=await fetch(E(r));if(!o.ok)throw new Error(`Feed request failed with ${o.status}`);let s=await o.json();if(t.stories=s.top_stories??[],$e(),t.hasLoadedFeed=!0,et&&(et.textContent=jt(s.date??t.activeArchiveDate)),A)if(t.activeArchiveDate)A.textContent=`Showing ${e} from ${t.activeArchiveDate}`;else{let n=s.archive?.provider==="shelby"?"Shelby":"local archive";A.textContent=`Latest published feed loaded from ${n}`}at(t.activeArchiveDate?`Archive: ${t.activeArchiveDate}`:"Live feed")}catch(r){console.warn(r),t.hasLoadedFeed||(t.stories=[]),$e(),A&&(A.textContent=t.activeArchiveDate?"That saved day/category is not available yet":"Feed data is currently unavailable. Please check back shortly.")}finally{t.isLoading=!1,g(),Ce()}},Ya=async()=>{if(F)try{let e=await fetch(E("/api/archive"));if(!e.ok)throw new Error(`Archive index failed with ${e.status}`);let a=await e.json(),r=new Date().toLocaleDateString("en-CA",{timeZone:"Africa/Lagos",year:"numeric",month:"2-digit",day:"2-digit"});t.archiveDates=(a.dates??[]).filter(o=>o.date!==r),F.innerHTML=['<option value="">Today</option>',...t.archiveDates.map(o=>`<option value="${o.date}">${o.date}</option>`)].join(""),F.value=t.activeArchiveDate??"",at(t.archiveDates.length>0?"Saved days ready":"Live feed ready")}catch(e){console.warn(e),at("Archive unavailable")}},Ee=()=>{gt||(gt=!0,Ya())},ne=(e=t.activeCategory,a=!1)=>{t.hasLoadedFeed&&e===t.activeCategory&&!t.activeArchiveDate||Wa(e,a)},Ga=()=>{ht||(ht=!0,window.setTimeout(()=>{t.activeSurface!=="feed"&&!t.hasLoadedFeed&&ne(t.activeCategory,!0),Ee()},8e3))},Ja=e=>e==="All"?"For you":e==="Sports"?"Football":e,W=e=>e==="Sports"?"Football":e,rt=e=>/^@/.test(String(e.source||""))||/(?:^|\/)(?:x|twitter)\.com\//i.test(String(e.sourceUrl||"")),Jt=(e,a)=>{let r=e.trim();return r.length<=a?r:`${r.slice(0,Math.max(0,a-1)).trimEnd()}\u2026`},Ka=e=>e.replace(/^@/,"").replace(/[_-]+/g," ").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/\s+/g," ").trim().split(" ").filter(Boolean),Kt=e=>{let a=String(e.source||W(e.category)).trim(),r=Ka(a);if(r.length===0)return W(e.category);let o=r.filter((i,d)=>{let m=i.toLowerCase();return!(d>0&&["live","news","official"].includes(m))}),s=o.length>0?o:r,n="";for(let i of s){let d=n?`${n} ${i}`:i;if(d.length>18)break;n=d}return Jt(n||s[0],18)},kt=e=>{let a=String(e.headline||"").replace(/\s+/g," ").trim();if(!rt(e))return a;let r=a.replace(/https?:\/\/\S+/gi,"").replace(/\(Source:[^)]+\)\s*$/i,"").replace(/\s+/g," ").trim();if(/^R to\s+@[^:]+:\s*(?:more here|watch more here)[:.!?]*$/i.test(r))return`Latest from ${Kt(e)}`;let o=r.replace(/^R to\s+@[^:]+:\s*/i,"").trim(),s=o.length>=24&&!/^(?:more here|watch more here)[:.!?]*$/i.test(o)?o:r||a;return Jt(s,150)},Vt=()=>{re&&(re.innerHTML=xa.map(e=>`
        <button class="category-tab ${e===t.activeCategory?"active":""}" type="button" data-category="${e}">
          ${Ja(e)}
        </button>
      `).join(""))},Zt=e=>(e.thread?.count??0)>=1,Va=(e=0)=>`${e} past ${e===1?"update":"updates"}`,Qt=(e=[])=>[...e].sort((a,r)=>{let o=new Date(a.publishedAt||0).getTime(),s=new Date(r.publishedAt||0).getTime();return(Number.isNaN(s)?0:s)-(Number.isNaN(o)?0:o)}),qe=e=>{let a=t.marketEvidenceOverrides[e.id],r={...e,evidence:e.evidence??[]};return a?{...r,...a,updates:a.evidence.length}:r},Za=(e,a)=>{if(e.timeframe!=="Daily")return null;let r=e.kickoffAt?new Date(e.kickoffAt).getTime():Number.NaN;if(Number.isFinite(r))return r;let o=a?.closesAtUnix??0;return o>0?o*1e3:null},Qa=(e,a)=>a===0?"Latest":e.publishedAt?new Intl.DateTimeFormat("en",{month:"short",day:"numeric"}).format(new Date(e.publishedAt)):e.postedAt,Xa=(e,a)=>({date:Qa(e,a),source:e.source,headline:e.headline,summary:oe(e),impact:a===0?"Latest":"Update",direction:"flat",sourceUrl:e.sourceUrl}),Xt=async e=>{if(!(t.checkedMarketEvidence[e.id]||t.loadingMarketEvidence[e.id])){t.loadingMarketEvidence[e.id]=!0;try{let a=await fetch(E(`/api/market-thread?id=${encodeURIComponent(e.id)}&nocache=${Date.now()}`));if(!a.ok)return;let r=await a.json(),o=[r.current,...Qt(r.items??[])],s=o.filter((d,m,u)=>u.findIndex(f=>f.sourceUrl===d.sourceUrl)===m).map(Xa),i=o[0]?.imageUrl;s.length>=1&&(t.marketEvidenceOverrides[e.id]={threadTopic:r.topic||e.threadTopic,evidence:s,imageUrl:i||e.imageUrl})}catch(a){console.warn(a)}finally{t.checkedMarketEvidence[e.id]=!0,t.loadingMarketEvidence[e.id]=!1,t.activeSurface==="markets"&&g()}}},G=e=>e.optionMarket?e.id:e.marketAddress||window.SIFTLE_MARKET_ADDRESSES?.[e.id]||"",V=e=>Array.isArray(e.options)?e.options.filter(a=>a?.id&&a?.label):[],K=e=>!!(e.optionMarket&&V(e).length>1),er=e=>{let a=V(e);return a.find(r=>r.id===t.marketTradeOptionId)||a[0]||null},R=e=>e.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),M=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ct=e=>`siftle_profile_username_${e.toLowerCase()}`,ea=e=>e.trim().replace(/\s+/g," ").slice(0,15),ue=()=>{if(!t.walletAddress){t.profileUsername=null,t.profileNotice=null;return}let e=ct(t.walletAddress),a=localStorage.getItem(e),r=localStorage.getItem("siftle_profile_username");!a&&r&&(a=ea(r),a&&localStorage.setItem(e,a),localStorage.removeItem("siftle_profile_username")),t.profileUsername=a||null,t.profileNotice=null},tr=e=>{if(!t.walletAddress)return;let a=ct(t.walletAddress),r=ea(e);r?(localStorage.setItem(a,r),t.profileUsername=r):(localStorage.removeItem(a),t.profileUsername=null),localStorage.removeItem("siftle_profile_username")},ar=()=>{let e="one-hour-test-market",a=[];for(let r=0;r<localStorage.length;r++){let o=localStorage.key(r);o&&o.includes(e)&&a.push(o)}a.forEach(r=>localStorage.removeItem(r))},ta=(e,a,r)=>{if(e==="sell"){let o=a==="yes"?r?.yesSharesUsdc??0:r?.noSharesUsdc??0;return o<=0?{min:.01,max:.01,fallback:.01}:{min:Math.min(.01,o),max:o,fallback:o}}return{min:5,max:10,fallback:5}},Ie=(e,a,r,o)=>{let{min:s,max:n,fallback:i}=ta(a,r,o);return Number.isFinite(e)?Math.min(n,Math.max(s,e)):i},aa=(e,a,r,o,s)=>{if(!e||!Number.isFinite(r)||r<=0)return 0;let n=a==="yes"?s?.yesSharesUsdc??0:s?.noSharesUsdc??0,i=e.yesSharesUsdc,d=e.noSharesUsdc;if(o==="sell")return Math.min(r,n);let m=(a==="yes"?i:d)+r,u=i+d+r;return m<=0||u<=0?r:(n+r)/m*u},ra=(e,a)=>{let r=a?.volumeUsdc??0,o=[];return e.yesSharesUsdc>0&&o.push({label:"YES Shares",shares:e.yesSharesUsdc,payout:a&&a.yesSharesUsdc>0?e.yesSharesUsdc/a.yesSharesUsdc*r:0}),e.noSharesUsdc>0&&o.push({label:"NO Shares",shares:e.noSharesUsdc,payout:a&&a.noSharesUsdc>0?e.noSharesUsdc/a.noSharesUsdc*r:0}),o},rr=e=>{let a=e?.yesSharesUsdc??0,r=e?.noSharesUsdc??0;return a>0&&r<=0?"yes":r>0&&a<=0?"no":null},oa=e=>`siftle_claimed_markets_${e.toLowerCase()}`,He=()=>{if(!t.walletAddress)return new Set;try{return new Set(JSON.parse(localStorage.getItem(oa(t.walletAddress))||"[]"))}catch{return new Set}},or=e=>{if(!t.walletAddress)return;let a=He();a.add(e),localStorage.setItem(oa(t.walletAddress),JSON.stringify(Array.from(a)))},We=(e,a)=>(a?.outcome??0)!==0?!0:/^resolved$/i.test(String(e.closes||"").trim()),ee=(e,a,r)=>{let o=r?.yesSharesUsdc??0,s=r?.noSharesUsdc??0;return e==="sell"?a==="yes"?o>0:s>0:a==="yes"?s<=0:o<=0},pt=(e,a,r)=>{if(ee(e,a,r))return a;let o=a==="yes"?"no":"yes";return ee(e,o,r)?o:a};var sr=e=>{let a=e instanceof Error?e.message:String(e||"");return/token|session|auth|unauthori[sz]ed|expired|401/i.test(a)},Ve=e=>{let a=String(e||"").trim();if(!a)return"0 wins, 0 losses";let r=a.replace(/closed profits?/gi,"losses").replace(/\bprofit\b/gi,"losses");return/\bloss/i.test(r)?r:`${r}, 0 losses`},sa="siftle_leaderboard_cache_v4_",wt=e=>{let a=String(e||"").match(/(\d+)\s+wins?/i),r=String(e||"").match(/(\d+)\s+loss(?:es)?/i);return{wins:a&&Number(a[1])||0,losses:r&&Number(r[1])||0}},St=e=>{try{let a=JSON.parse(localStorage.getItem(`${sa}${e}`)||"null");return Array.isArray(a?.players)&&a.players.length?a:null}catch{return null}},Ze=(e,a)=>{if(!(!Array.isArray(a?.players)||a.players.length===0))try{localStorage.setItem(`${sa}${e}`,JSON.stringify({...a,cachedAt:Date.now()}))}catch{}},na=(e,a)=>{let r=wt(e?.status||""),o=wt(a?.status||""),s=(Number(a?.points)||0)-(Number(e?.points)||0);return s||(o.wins!==r.wins?o.wins-r.wins:r.losses!==o.losses?r.losses-o.losses:String(e?.username||"").localeCompare(String(a?.username||"")))},nr=e=>{let a=String(e?.displayName||"").trim().toLowerCase();return a&&!/^0x[a-f0-9]{40}$/i.test(a)?`name:${a}`:`wallet:${String(e?.username||"").toLowerCase()}`},ir=e=>{let a=new Map;return e.forEach(r=>{let o=nr(r);if(!o||o==="wallet:")return;let s=a.get(o);if(!s){a.set(o,r);return}a.set(o,na(s,r)<=0?s:r)}),Array.from(a.values())},xt=(e,a=[],r=!1)=>{let o=ir(e).slice().sort(na);return r?o.map((s,n)=>({...s,globalRank:n+1})):o},lr=(e,a)=>{let r=String(e?.optionId||"").trim(),o=Math.max(0,Number(e?.optionSharesUsdc)||0),s=Math.max(0,Number(a?.optionPools?.[r])||0),n=Math.max(0,Number(a?.volumeUsdc)||0);return!r||o<=0?0:s<=0||n<=0?o:o/s*n},Qe=(e,a)=>!K(e)||!a?a:{...a,optionPools:Object.fromEntries(V(e).map(r=>[r.id,0]))},$t=()=>`
  <div class="leaderboard-sync-note" role="status">
    Showing saved standings while Siftle refreshes live scores...
  </div>
`,mt=()=>{let e=0,a=0,r=0,o=I.filter(i=>i.timeframe==="Daily").map(i=>i.id),s=t.walletAddress?`siftle_resolved_results_${t.walletAddress.toLowerCase()}`:"",n={};if(s)try{n=JSON.parse(localStorage.getItem(s)||"{}")}catch{}if(t.walletAddress&&t.hasLoadedPortfolioPositions)for(let i of o){if(n[i]?.result==="win"){e+=Number(n[i].points)||0,a++;continue}if(n[i]?.result==="loss"){r++;continue}let d=t.marketPositions[i],u=t.marketSnapshots[i]?.outcome??0;if(u===0)continue;let f=`siftle_traded_sides_${i}_${t.walletAddress.toLowerCase()}`,p=[];try{p=JSON.parse(localStorage.getItem(f)||"[]")}catch{}let h=p.includes("yes")&&p.includes("no");if(u===1&&d&&d.yesSharesUsdc>0){let l=h?50:100;e+=l,a++,n[i]={result:"win",points:l}}else if(u===2&&d&&d.noSharesUsdc>0){let l=h?50:100;e+=l,a++,n[i]={result:"win",points:l}}else d&&(d.yesSharesUsdc>0||d.noSharesUsdc>0)&&(r++,n[i]={result:"loss",points:0})}return s&&localStorage.setItem(s,JSON.stringify(n)),{points:e,status:`${a} win${a===1?"":"s"}, ${r} loss${r===1?"":"es"}`}},dr=(e,a)=>{let r=G(e).toLowerCase();if(!r)return;let o=`siftle_mock_pos_${r}_`,s=new Set;for(let n=0;n<localStorage.length;n++){let i=localStorage.key(n);if(!i||!i.startsWith(o))continue;let d=i.slice(o.length).toLowerCase();/^0x[a-f0-9]{40}$/.test(d)&&s.add(d)}s.forEach(n=>{let i=`${o}${n}`,d={yesSharesUsdc:0,noSharesUsdc:0};try{d=JSON.parse(localStorage.getItem(i)||"{}")}catch{}let m=(Number(d.yesSharesUsdc)||0)>0,u=(Number(d.noSharesUsdc)||0)>0;if(!m&&!u)return;let f=`siftle_traded_sides_${e.id}_${n}`,p=[];try{p=JSON.parse(localStorage.getItem(f)||"[]")}catch{}let h=p.includes("yes")&&p.includes("no"),l=a==="yes"?m:u,c=`siftle_resolved_results_${n}`,b={};try{b=JSON.parse(localStorage.getItem(c)||"{}")}catch{}b[e.id]={result:l?"win":"loss",points:l?h?50:100:0},localStorage.setItem(c,JSON.stringify(b));let $=0,S=0,T=0;Object.values(b).forEach(x=>{x.result==="win"?(S+=1,$+=Number(x.points)||0):x.result==="loss"&&(T+=1)});let y=localStorage.getItem(ct(n))||"";fetch(E("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:n,username:y,points:$,status:`${S} win${S===1?"":"s"}, ${T} loss${T===1?"":"es"}`})}).catch(x=>console.error("Failed to report local resolved score:",x))})},ie=async e=>{if(!t.walletAddress)return!1;let a=e&&t.hasLoadedPortfolioPositions?mt():null,r=await fetch(E("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:t.walletAddress,username:t.profileUsername||"",...a?{points:a.points,status:a.status}:{}})}),o=await r.json().catch(()=>({}));if(!r.ok||o?.success===!1)throw new Error(o?.error||"Failed to save leaderboard profile");if(o?.supabaseConfigured&&o?.supabaseSaved===!1)throw new Error(o?.supabaseError||"Supabase did not save profile");return!0},cr=()=>{let e=new Set;for(let a=0;a<localStorage.length;a++){let r=localStorage.key(a);if(r&&r.startsWith("siftle_mock_pos_")){let o=r.slice(r.lastIndexOf("_")+1).toLowerCase();try{let s=JSON.parse(localStorage.getItem(r)||"{}");((Number(s.yesSharesUsdc)||0)>0||(Number(s.noSharesUsdc)||0)>0)&&/^0x[a-f0-9]{40}$/.test(o)&&e.add(o)}catch{}}}e.forEach(a=>{fetch(E("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:a})}).catch(r=>console.error("Failed to report stored local trader:",r))})},pr=async e=>{let a=G(e);if(!(!a||t.marketSnapshots[e.id]||t.loadingMarketSnapshots[e.id]||t.checkedMarketSnapshots[e.id])){if(K(e)&&!t.walletAddress){let r=e.resolvedOptionId||null,o=Number(e.outcome);t.marketSnapshots[e.id]=Qe(e,{yesPriceCents:0,noPriceCents:0,volumeUsdc:Number(e.volumeUsdc)||0,yesSharesUsdc:0,noSharesUsdc:0,outcome:o===1||o===2||o===3?o:r?1:0,optionPools:e.optionPools||Object.fromEntries(V(e).map(s=>[s.id,0])),resolvedOptionId:r,traderCount:0}),t.checkedMarketSnapshots[e.id]=!0;return}t.loadingMarketSnapshots[e.id]=!0;try{if(K(e)&&t.walletAddress){let{position:r,snapshot:o}=await It(a,t.walletAddress);t.marketPositions[e.id]=r,t.marketSnapshots[e.id]=Qe(e,o)}else t.marketSnapshots[e.id]=Qe(e,await ha(a))}catch(r){console.warn(r)}finally{t.checkedMarketSnapshots[e.id]=!0,t.loadingMarketSnapshots[e.id]=!1,t.activeSurface==="markets"&&g()}}},z=async(e={})=>{if(t.walletAddress&&!(t.loadingPortfolioPositions&&!e.force)){t.hasLoadedPortfolioPositions=!1,t.loadingPortfolioPositions=!0;try{t.portfolioMarketPreviews.length===0&&await Ot();let a=Ae(),r=await Promise.all(a.map(async o=>{let s=G(o);if(!s)return[o.id,{yesSharesUsdc:0,noSharesUsdc:0}];try{let{position:n,snapshot:i}=await It(s,t.walletAddress);return t.marketSnapshots[o.id]=i,[o.id,n]}catch(n){return console.warn(`Failed to load portfolio market ${o.id}:`,n),[o.id,{yesSharesUsdc:0,noSharesUsdc:0}]}}));t.marketPositions=Object.fromEntries(r),t.portfolioPositionsLoadedAt=Date.now()}catch(a){console.warn(a)}finally{t.loadingPortfolioPositions=!1,t.hasLoadedPortfolioPositions=!0,ie(!0).catch(a=>console.error("Failed to report leaderboard entry:",a)),(t.activeSurface==="portfolio"||t.activeSurface==="leaderboard"||t.activeSurface==="markets")&&g()}}},mr=async(e,a)=>{if(!t.walletAddress){v("Session expired or wallet not connected. Please sign in."),ze();return}let r=Ae().find(u=>u.id===e);if(!r)return;t.marketTradeSide=a;let o=G(r);if(!o){v("Deploy this Arc market contract before trading"),g();return}if(!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",g(),await z(),t.marketTradeStatus=null),!t.hasLoadedPortfolioPositions){v("Still loading your position. Try again in a moment."),g();return}let s=t.marketSnapshots[r.id];if(We(r,s)){t.tradeDrawerOpen=!1,v("This market is resolved and can no longer be traded."),g();return}let n=s?.yesPriceCents??r.probability,i=s?.noPriceCents??100-r.probability,d=t.marketPositions[r.id]||{yesSharesUsdc:0,noSharesUsdc:0};if(!ee(t.marketOrderMode,a,d)){let u=rr(d),f=t.marketOrderMode==="sell"?u?`You can only exit your ${u.toUpperCase()} shares.`:"You do not have shares to exit in this market.":u?`Exit your ${u.toUpperCase()} shares before buying the other side.`:"You cannot buy both sides in the same market.";v(f),t.marketTradeSide=pt(t.marketOrderMode,a,d),g();return}let m=Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,a,d);t.marketTradeAmount=m,C("trade_attempt");try{t.marketTradeStatus="Preparing transaction...",g();let u=await va(o,t.marketOrderMode,a,m,f=>{t.marketTradeStatus=f,g()},n,i);if(delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],delete t.loadingMarketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await Oe(),t.walletAddress&&(t.walletBalance=await te(t.walletAddress)),await z({force:!0}),ie(!0).catch(f=>console.error("Failed to report leaderboard entry:",f)),t.walletAddress){let f=`siftle_cost_basis_${r.id}_${t.walletAddress.toLowerCase()}`,p={yesCost:0,noCost:0,yesShares:0,noShares:0};try{let l=localStorage.getItem(f);if(l){let c=JSON.parse(l);p={yesCost:c.yesCost||0,noCost:c.noCost||0,yesShares:c.yesShares||0,noShares:c.noShares||0}}}catch{}let h=m;if(t.marketOrderMode==="buy"){let l=`siftle_traded_sides_${r.id}_${t.walletAddress.toLowerCase()}`,c=[];try{c=JSON.parse(localStorage.getItem(l)||"[]")}catch{}c.includes(a)||(c.push(a),localStorage.setItem(l,JSON.stringify(c))),a==="yes"?(p.yesCost+=h,p.yesShares=(p.yesShares||0)+h/(n/100)):(p.noCost+=h,p.noShares=(p.noShares||0)+h/(i/100))}else{let l=t.marketPositions[r.id];if(l){if(a==="yes"&&l.yesSharesUsdc>0){let c=Math.min(1,h/l.yesSharesUsdc);p.yesCost=Math.max(0,p.yesCost-p.yesCost*c),p.yesShares=Math.max(0,(p.yesShares||0)-(p.yesShares||0)*c)}else if(a==="no"&&l.noSharesUsdc>0){let c=Math.min(1,h/l.noSharesUsdc);p.noCost=Math.max(0,p.noCost-p.noCost*c),p.noShares=Math.max(0,(p.noShares||0)-(p.noShares||0)*c)}}}localStorage.setItem(f,JSON.stringify(p))}v(`Trade confirmed ${u.slice(0,8)}...`),C(t.marketOrderMode==="buy"?"trade_buy_success":"trade_sell_success"),Ba(t.marketOrderMode,t.marketTradeAmount,a.toUpperCase(),r.question)}catch(u){C("trade_failed"),sr(u)?(Bt(),t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ue(),v("Session expired. Please sign in again.")):v(u instanceof Error?u.message:"Arc trade failed")}finally{t.marketTradeStatus=null,B(),g()}},ur=e=>Zt(e)?`<button class="card-source-button thread-button" type="button" data-thread-story-id="${e.id}">Thread (${e.thread?.count})</button>`:"",fr=e=>Zt(e)?`<button class="mobile-action-btn thread-btn" type="button" data-thread-story-id="${e.id}">Thread</button>`:"",gr=()=>'<svg class="action-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 4.75h10a1.75 1.75 0 0 1 1.75 1.75v14.25L12 16.35l-6.75 4.4V6.5A1.75 1.75 0 0 1 7 4.75Z"/></svg>',hr=()=>'<svg class="action-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 15V4.75"/><path d="m7.25 9.5 4.75-4.75 4.75 4.75"/><path d="M5 13.25v4.5A2.25 2.25 0 0 0 7.25 20h9.5A2.25 2.25 0 0 0 19 17.75v-4.5"/></svg>',ve=e=>`<span class="skeleton-aria-label" role="status" aria-live="polite">${e}</span>`,vr=()=>`
...
`,br=(e=4)=>`${ve("Loading stories")}${Array.from({length:e},vr).join("")}`,ge=()=>`
...
`,Tt=e=>{let a=e.type==="tweet",r='<svg class="x-logo-svg" viewBox="0 0 24 24" fill="currentColor" style="width: 14px; height: 14px; display: inline-block; vertical-align: text-top; margin-right: 6px; color: var(--color-text-primary);"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>',o='<svg class="x-logo-svg" viewBox="0 0 24 24" fill="currentColor" style="width: 12px; height: 12px; display: inline-block; vertical-align: text-top; margin-right: 4px;"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>';return`
    <article class="story-card ${a?"social-story tweet-card":rt(e)?"social-story":""}" data-story-id="${e.id}" role="button" tabindex="0" aria-label="Open summary for ${e.headline}">
      ...
      <div class="story-copy desktop-only">
        ...
        <h2 class="card-headline">${kt(e)}</h2>
        <p>${a?"Tap to open the original tweet on X.":"Tap to read the AI briefing."}</p>
      </div>

      <div class="card-action-row desktop-only">
        ${a?`<a class="card-source-button twitter-btn" href="${e.sourceUrl}" target="_blank" rel="noreferrer" onclick="event.stopPropagation()" style="display: inline-flex; align-items: center; gap: 6px;">
              ${r}
              Open Tweet
             </a>`:`
              ${ur(e)}
      ...
      <div class="mobile-card-inner mobile-only">
        <div class="mobile-card-body">
          <div class="mobile-card-text">
            <div class="mobile-card-topline">
              <span class="mobile-source-pill ${rt(e)?"social":""}">
                ${a?o:""}
                ${Kt(e)}
              </span>
        ...
        <div class="mobile-card-actions">
          ${a?`<a class="mobile-action-btn source-btn twitter-btn" href="${e.sourceUrl}" target="_blank" rel="noreferrer" onclick="event.stopPropagation()" style="display: inline-flex; align-items: center; justify-content: center; gap: 6px; width: 100%;">
                ${o}
                Open Tweet
               </a>`:`
                ${fr(e)}
  ...
  `},he=()=>{if(!k)return;let e=Da();if(k.hidden=!!(t.selectedStoryId||t.selectedThreadUrl),t.isLoading){k.innerHTML=br(4);return}let a=Number(t.unlockConfig?.amountUsdc)||.001,r=M(t.newsSearchQuery.trim()),s=`
  ...
  `;if(e.length===0){let n=t.showSaved?[]:t.stories;if(n.length>0){k.innerHTML=s+n.map(Tt).join("");return}k.innerHTML=s+'<div class="portfolio-empty compact news-search-empty">No stories match that keyword yet.</div>';return}k.innerHTML=s+e.map(Tt).join("")},At=e=>new Promise((a,r)=>{let o=new Image;o.crossOrigin="anonymous",o.onload=()=>a(o),o.onerror=()=>r(new Error(`Unable to load image: ${e}`)),o.src=e}),Se=(e,a,r,o,s,n)=>{e.beginPath(),e.moveTo(a+n,r),e.lineTo(a+o-n,r),e.quadraticCurveTo(a+o,r,a+o,r+n),e.lineTo(a+o,r+s-n),e.quadraticCurveTo(a+o,r+s,a+o-n,r+s),e.lineTo(a+n,r+s),e.quadraticCurveTo(a,r+s,a,r+s-n),e.lineTo(a,r+n),e.quadraticCurveTo(a,r,a+n,r),e.closePath()},Sr=(e,a,r,o,s,n,i)=>{let d=a.split(/\s+/).filter(Boolean),m=[],u="";for(let f of d){let p=u?`${u} ${f}`:f;if(e.measureText(p).width<=s){u=p;continue}if(u&&m.push(u),u=f,m.length===i)break}if(u&&m.length<i&&m.push(u),d.length>0&&m.length===i){for(;e.measureText(`${m[i-1]}...`).width>s&&m[i-1].length>0;)m[i-1]=m[i-1].slice(0,-1).trim();m[i-1]=`${m[i-1]}...`}return m.forEach((f,p)=>e.fillText(f,r,o+p*n)),o+m.length*n},xr=(e,a,r,o,s,n,i)=>{let d=Math.max(s/a.naturalWidth,n/a.naturalHeight),m=s/d,u=n/d,f=(a.naturalWidth-m)/2,p=(a.naturalHeight-u)/2;e.save(),Se(e,r,o,s,n,i),e.clip(),e.drawImage(a,f,p,m,u,r,o,s,n),e.restore()},Mt=e=>new Promise((a,r)=>{try{e.toBlob(o=>{o?a(o):r(new Error("Unable to export image"))},"image/png")}catch(o){r(o)}}),Lt=e=>e?e.replace(/&quot;/g,'"').replace(/&apos;/g,"'").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&nbsp;/g," ").replace(/&#39;/g,"'").replace(/&#34;/g,'"').replace(/&#38;/g,"&").replace(/&#60;/g,"<").replace(/&#62;/g,">").replace(/&#8216;/g,"'").replace(/&#8217;/g,"'").replace(/&#8220;/g,'"').replace(/&#8221;/g,'"').replace(/&#8211;/g,"\u2013").replace(/&#8212;/g,"\u2014").replace(/&#8230;/g,"...").replace(/&#(\d+);/g,(a,r)=>String.fromCharCode(Number(r))):"",$r=e=>e?e.startsWith("data:")||e.startsWith("./")||e.startsWith("/")||e.includes(window.location.host)?e:`${(window.SIFTLE_API_BASE||"").replace(/\/$/,"")}/api/proxy-image?url=${encodeURIComponent(e)}`:"",Ut=async(e,a=!0)=>{let r=document.createElement("canvas");r.width=1080,r.height=1120;let o=r.getContext("2d");if(!o)throw new Error("Canvas is not available");o.fillStyle="#f4f7fb",o.fillRect(0,0,r.width,r.height),o.shadowColor="rgba(23, 34, 72, 0.16)",o.shadowBlur=44,o.shadowOffsetY=18,o.fillStyle="#ffffff",Se(o,70,70,940,980,34),o.fill(),o.shadowColor="transparent";let s=await At("./assets/siftle-logo-small.png").catch(()=>null);s&&o.drawImage(s,784,106,54,54),o.fillStyle="#071229",o.font="800 34px Inter, Arial, sans-serif",o.textAlign="left",o.fillText("Siftle",850,143),o.fillStyle="#6b748c",o.font="700 24px Inter, Arial, sans-serif",o.fillText(`${Lt(e.source)} - ${e.postedAt} ago`,110,140);let n=195;if(a){let d=await At($r(e.imageUrl)).catch(()=>null);d?xr(o,d,110,n,860,520,28):(o.fillStyle="#eef2ff",Se(o,110,n,860,520,28),o.fill())}else o.fillStyle="#eef2ff",Se(o,110,n,860,520,28),o.fill();let i=775;return o.fillStyle=e.category==="Sports"?"#dffaf4":e.category==="Tech"?"#e8eef6":e.category==="Anime"?"#efe7ff":e.category==="Gaming"?"#ffebd9":"#eee7ff",Se(o,110,i,118,42,21),o.fill(),o.fillStyle=e.category==="Sports"?"#11a98d":e.category==="Tech"?"#3f5f86":e.category==="Gaming"?"#d95c14":"#6f3cff",o.font="800 22px Inter, Arial, sans-serif",o.fillText(W(e.category),132,i+28),o.fillStyle="#07142f",o.font="680 44px Space Grotesk, Inter, Arial, sans-serif",Sr(o,Lt(e.headline),110,888,860,54,4),r},ia=async e=>{let a=await Ut(e,!0);try{return await Mt(a)}catch{return Mt(await Ut(e,!1))}},la=e=>`siftle-${e.headline.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"").slice(0,48)||"story"}.png`,da=async e=>{let a=await ia(e),r=URL.createObjectURL(a),o=document.createElement("a");o.href=r,o.download=la(e),o.click(),URL.revokeObjectURL(r)},Tr=async e=>{let a=await ia(e),r=new File([a],la(e),{type:"image/png"}),o={title:e.headline,text:`Siftle: ${e.headline}`,files:[r]};if(navigator.canShare?.(o)&&navigator.share){await navigator.share(o);return}await da(e)},Ar=async(e,a)=>{let r=t.stories.find(o=>o.id===e);if(r){t.activeShareStoryId=null,he(),v(a==="share"?"Preparing share image":"Preparing download"),A&&(A.textContent=a==="share"?"Preparing share image...":"Preparing image download...");try{a==="share"?await Tr(r):await da(r),v(a==="share"?"Share image ready":"Image saved"),A&&(A.textContent="Branded story image ready")}catch(o){console.warn(o),v("Image export unavailable"),A&&(A.textContent="Image export was cancelled or unavailable")}}},Pt=(e,a)=>{let r=t.unlockingSummaryUrl===e.sourceUrl,o=lt(e);return`
  <article class="thread-item">
    ...
    <div class="thread-item-body">
      ...
      ${Pe(e)}
      ${r?`<div style="margin-top: 12px;">${ge()}</div>`:se(e)?t.loadingSummaryUrl===e.sourceUrl?`<div style="margin-top: 12px;">${ge()}</div>`:o?`<div style="margin-top: 12px;">${dt(e)}</div>`:`<div style="margin-top: 12px;">${st(oe(e,t.aiSummaries[e.sourceUrl]||e.ai_summary),e)}</div>`:""}
    </div>
  </article>
`},Mr=async(e,a)=>{if(!t.walletAddress){v("Session expired or wallet not connected. Please sign in."),ze();return}let r=Ae().find(u=>u.id===e);if(!r||!K(r))return;let o=V(r).find(u=>u.id===a);if(!o){v("Choose a valid option.");return}!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",g(),await z(),t.marketTradeStatus=null);let s=t.marketSnapshots[r.id];if(We(r,s)){v("This market is resolved and can no longer be traded.");return}let n=t.marketPositions[r.id],i=t.marketOrderMode==="sell";if(!i&&n?.optionId){v("Your pick is already locked for this market.");return}if(i&&!n?.optionId){v("You do not have a pick to exit.");return}let d=Math.max(0,Number(n?.optionSharesUsdc)||0);if(i&&d<=0){v("Your pick is still loading. Please try again."),await z({force:!0});return}let m=i?d:Ie(Number(t.marketTradeAmount)||0,"buy","yes",void 0);t.marketTradeAmount=m,t.marketTradeOptionId=i&&n?.optionId||o.id,C("trade_attempt");try{t.marketTradeStatus=i?"Exiting your pick...":"Locking your pick...",g(),await ba(r.id,i?"sell":"buy",i&&n?.optionId||o.id,m,u=>{t.marketTradeStatus=u,g()}),delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await Oe(),t.walletAddress&&(t.walletBalance=await te(t.walletAddress)),await z({force:!0}),C(i?"trade_sell_success":"trade_buy_success"),v(i?"Pick exited":`Pick locked: ${o.label}`),t.tradeDrawerOpen=!1}catch(u){C("trade_failed"),v(u instanceof Error?u.message:"Trade failed")}finally{t.marketTradeStatus=null,B(),g()}},Lr=()=>{if(!w||!k)return;let e=t.stories.find(o=>o.sourceUrl===t.selectedThreadUrl);if(k.hidden=!0,w.hidden=!1,w.classList.add("fullscreen"),document.body.classList.add("detail-mode"),!e){w.innerHTML="";return}let a=t.loadingThreadUrl===e.sourceUrl,r=t.activeThread;if(a&&!r){w.innerHTML=`
  ...
  `},Ur=()=>{if(!w||!k)return;if(t.selectedThreadUrl){Lr();return}let e=t.stories.find(i=>i.id===t.selectedStoryId);if(!e){w.hidden=!0,w.classList.remove("fullscreen"),document.body.classList.remove("detail-mode"),k.hidden=!1;return}if(e.type==="tweet"){k.hidden=!0,w.hidden=!1,w.classList.add("fullscreen"),document.body.classList.add("detail-mode");let i='<svg class="x-logo-svg" viewBox="0 0 24 24" fill="currentColor" style="width: 16px; height: 16px; display: inline-block; vertical-align: text-top; margin-right: 6px;"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>';w.innerHTML=`
        ...
        <article class="detail-card tweet-detail-card" style="border: 1px solid var(--border-color, #2f3336); border-radius: 16px; background: var(--bg-card, #000000); padding: 24px; box-shadow: var(--shadow-lg);">
          <div class="detail-topline" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px; font-size: 14px; color: var(--color-text-secondary, #8899a6); border-bottom: 1px solid var(--border-color, #2f3336); padding-bottom: 12px;">
            <div style="display: flex; align-items: center; gap: 8px;">
              ${i}
              <strong style="color: var(--color-text-primary, #ffffff); font-size: 15px;">${e.source}</strong>
            </div>
            <span>${_e(e)}</span>
          </div>
          
          <div class="tweet-content-wrapper" style="margin-bottom: 24px;">
            ${e.imageUrl&&!/nitter\.net\/pic/i.test(e.imageUrl)&&!/placeholder/i.test(e.imageUrl)?`<img class="detail-image" src="${e.imageUrl}" alt="" style="width: 100%; border-radius: 12px; margin-bottom: 16px; object-fit: cover; max-height: 400px; border: 1px solid var(--border-color, #2f3336);" />`:""}
    ...
    `;return}let a=oe(e,t.aiSummaries[e.sourceUrl]),r=t.loadingSummaryUrl===e.sourceUrl,o=se(e),s=t.unlockingSummaryUrl===e.sourceUrl,n=lt(e);k.hidden=!0,w.hidden=!1,w.classList.add("fullscreen"),document.body.classList.add("detail-mode"),w.innerHTML=`
  ...
  `},Cr=e=>{let a=qe(e),o=t.marketSnapshots[e.id]?.yesPriceCents??e.probability,s=100-o,n=a.evidence[0],i=n?n.headline:"No updates yet",d=`${window.location.origin}${window.location.pathname}#market-${e.id}`;return`\u{1F6A8} *Siftle Market Alert* \u{1F6A8}
...
Trade and discuss here: ${d}`},Er=e=>{if(!k||!w)return;let a=qe(e),r=!t.checkedMarketEvidence[e.id],o=G(e),s=t.marketSnapshots[e.id],n=K(e),i=V(e);n&&!t.marketTradeOptionId&&(t.marketTradeOptionId=i[0]?.id||null);let d=er(e),m=!!(o&&!s),u=s?.yesPriceCents??(o?e.probability:0),f=s?.noPriceCents??(o?100-e.probability:0),p=m?"":o?`${u}\xA2`:"--",h=m?"":o?`${f}\xA2`:"--",l=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},c=!!l.optionId;n&&c&&t.marketOrderMode!=="sell"&&(t.marketOrderMode="sell"),n&&!c&&t.marketOrderMode==="sell"&&(t.marketOrderMode="buy");let b=n&&t.marketOrderMode==="sell"&&c?Math.max(0,Number(l.optionSharesUsdc)||0):0,$=b>0?b:Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,l),S=b>0?{min:0,max:b}:ta(t.marketOrderMode,t.marketTradeSide,l),T=t.marketOrderMode==="buy"?"$5-$10 USDC":`Up to $${R(S.max)} USDC`,y=!t.walletAddress||t.hasLoadedPortfolioPositions,x=We(e,s),L=Wt(e,s),P=!!L;n||(t.marketTradeSide=pt(t.marketOrderMode,t.marketTradeSide,l));let N=!n&&!x&&!P&&y&&ee(t.marketOrderMode,"yes",l),H=!n&&!x&&!P&&y&&ee(t.marketOrderMode,"no",l),le=n?!x&&!P&&y&&(t.marketOrderMode==="sell"?c:!c&&!!d):!x&&!P&&y&&ee(t.marketOrderMode,t.marketTradeSide,l),O=x?"Market resolved":L||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),de=x?"Market resolved":L||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),be=n?$:aa(s,t.marketTradeSide,$,t.marketOrderMode,l),ce=t.marketOrderMode==="buy"?"Buy":"Exit",Z=n?"Pick one outcome":o?"Arc testnet live":"Contract not deployed";k.hidden=!0,w.hidden=!1,w.classList.add("fullscreen"),document.body.classList.add("detail-mode"),pr(e),Xt(e),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&z({force:!t.hasLoadedPortfolioPositions});let Be=n?!!l.optionId:l.yesSharesUsdc>0||l.noSharesUsdc>0,ye="";n&&Be&&t.walletAddress?ye=`
        ...
        <div class="market-detail-main">
          ...
          <div class="market-stats-row">
            <div class="market-stat">
              <span>${it(e,s)===null?"Closes":"Trade lock"}</span>
              <strong>${qt(e,s)}</strong>
            </div>
            <div class="market-stat">
              <span>Market activity</span>
              <strong>Hidden</strong>
          ...
          <section class="market-evidence-thread">
            ...
            <div class="market-thread-timeline">
              ${r?kr(3):a.evidence.length===0?'<div class="portfolio-empty compact">Related news is still loading for this market.</div>':a.evidence.map(U=>{let D=Ft(e,U),pe=t.unlockingSummaryUrl===U.sourceUrl;return`
                <article class="market-thread-update">
                  ...
                  <div class="market-thread-update-content">
                    ...
                    ${Pe(D)}
                    ${pe?`<div style="margin-top: 12px;">${ge()}</div>`:se(D)?t.loadingSummaryUrl===U.sourceUrl?`<div style="margin-top: 12px;">${ge()}</div>`:lt(D)?`<div style="margin-top: 12px;">${dt(D)}</div>`:`<div style="margin-top: 12px;">${st(oe(D,t.aiSummaries[U.sourceUrl]),D)}</div>`:""}
                  </div>
                </article>
              `}).join("")}
            </div>
      ...
      <div class="trade-drawer ${t.tradeDrawerOpen?"open":""}" id="tradeDrawer">
        ...
        <div class="trade-drawer-body">
          ...
          <div class="market-action-grid">
            ${n?i.map(U=>{let D=t.marketTradeOptionId===U.id||l.optionId===U.id,pe=x||P||t.marketOrderMode==="sell"||c||!y;return`
                  <button type="button" class="market-side option ${D?"active":""} ${pe?"disabled":""}" data-market-option-id="${M(U.id)}" ${pe?"disabled":""}>
                    <span>${M(U.label)}</span>
          ...
          <div class="market-amount-panel">
            ...
            <div class="market-amount-input-row">
              <span>$</span>
              <input id="marketAmountInput" type="number" min="${S.min.toFixed(2)}" max="${Math.max(S.min,S.max).toFixed(2)}" step="0.01" inputmode="decimal" value="${$}" data-market-amount ${x||P?"disabled":""} />
              <span>USDC</span>
            </div>
          </div>
  ...
  `},ca=()=>{if(!k||!w)return;if(Re?.toggleAttribute("hidden",!0),je?.toggleAttribute("hidden",!0),re?.toggleAttribute("hidden",!0),Me?.classList.add("active"),Le?.classList.remove("active"),Ue?.classList.remove("active"),window.setTimeout(()=>{t.activeSurface==="markets"&&I.forEach(n=>{Xt(n)})},750),t.selectedMarketId){let n=I.find(i=>i.id===t.selectedMarketId);if(n){Er(n);return}t.selectedMarketId=null,window.location.hash.startsWith("#market-")&&window.history.replaceState({},"","#markets");return}document.body.classList.remove("detail-mode"),w.hidden=!0,w.classList.remove("fullscreen"),k.hidden=!1,k.classList.add("markets-list");let e=I,r=`
  ...
  `},pa=()=>{if(!k||!w)return;Re?.toggleAttribute("hidden",!0),je?.toggleAttribute("hidden",!0),re?.toggleAttribute("hidden",!0),Me?.classList.remove("active"),Le?.classList.remove("active"),Ue?.classList.remove("active"),document.body.classList.remove("detail-mode"),w.hidden=!0,k.hidden=!1,k.classList.add("markets-list");let e=t.walletAddress&&t.hasLoadedPortfolioPositions?mt():null;t.walletAddress&&e&&fetch(E("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:t.walletAddress,points:e.points,status:e.status,username:t.profileUsername||""})}).catch(l=>console.error("Failed to report user score:",l)),J&&(clearInterval(J),J=null),k.innerHTML=`
  ...
  `;let a=(l="2026-07-19T23:59:59.000Z")=>{let c=document.getElementById("seasonTimer");J&&clearInterval(J);let b=()=>{let S=new Date(l).getTime()-new Date().getTime();if(S<=0){c&&(c.innerText="Season Finished!"),J&&clearInterval(J);return}let T=Math.floor(S/(1e3*60*60*24)),y=Math.floor(S%(1e3*60*60*24)/(1e3*60*60)),x=Math.floor(S%(1e3*60*60)/(1e3*60)),L=Math.floor(S%(1e3*60)/1e3);c&&(c.innerText=`${T}d ${y}h ${x}m ${L}s`)};b(),J=setInterval(b,1e3)};a();let r=l=>l.map((c,b)=>{let $=Number(c.globalRank)||b+1,S=String(c.username||""),T=!!(t.walletAddress&&S.toLowerCase()===t.walletAddress.toLowerCase()),y=T&&t.profileUsername?t.profileUsername:c.displayName||S,x=T?`${t.profileUsername?y:j(S)} (You)`:y.startsWith("0x")&&y.length===42?j(y):y,L=M(x),P=M(Ve(c.status)),N=c.nextSeasonDivision?`Division ${c.nextSeasonDivision}`:"Qualify",H=$<=10?"promotion-zone":"safety-zone",le=$<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
    ...
    `}).join(""),o=l=>l.map((c,b)=>{let $=b+1,S=String(c.username||""),T=!!(t.walletAddress&&S.toLowerCase()===t.walletAddress.toLowerCase()),y=T&&t.profileUsername?t.profileUsername:c.displayName||S,x=M(Ve(c.status)),L=T?`${t.profileUsername?y:j(S)} (You)`:y.startsWith("0x")&&y.length===42?j(y):y,P=M(L),N="safety-zone",H='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return $<=2?(N="promotion-zone",H='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):$>=5&&(N="relegation-zone",H='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
    ...
    `}).join(""),s=l=>{Q=l,document.querySelectorAll("[data-leaderboard-view]").forEach(c=>{c.classList.toggle("active",c.dataset.leaderboardView===l)}),document.getElementById("divisionControls")?.toggleAttribute("hidden",l!=="division"),document.getElementById("globalControls")?.toggleAttribute("hidden",l!=="global"),document.getElementById("globalPrizeBox")?.toggleAttribute("hidden",l!=="global")},n=l=>{let c=document.getElementById("leaderboardListContainer");c&&(c.innerHTML=`
      <div class="leaderboard-skeleton" style="display: flex; flex-direction: column; gap: 12px; width: 100%;">
    ...
    `)},i=()=>{s("global");let l=document.getElementById("leaderboardListContainer"),c="global",b=St(c);b&&l?(l.innerHTML=$t()+r(b.players),b.seasonEndsAt&&a(b.seasonEndsAt)):n(10);let $=new URLSearchParams;t.walletAddress&&$.set("walletAddress",t.walletAddress);let S=$.toString();fetch(E(`/api/leaderboard/global${S?`?${S}`:""}`)).then(T=>T.json()).then(T=>{let y=xt(T.players||[],b?.players||[],!0);l&&(l.innerHTML=y.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players on the global leaderboard yet.</p>`:r(y)),Ze(c,{players:y,seasonEndsAt:T.seasonEndsAt}),a(T.seasonEndsAt)}).catch(T=>{console.error("Failed to load global leaderboard:",T),l&&(l.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading global leaderboard. Please try again.</p>`)})},d=l=>{s("division");let c=document.getElementById("leaderboardListContainer"),b=`division_${l||ke||"current"}`,$=St(b);$&&c?(c.innerHTML=$t()+o($.players),$.divisionNumber&&(ke=$.divisionNumber),$.seasonEndsAt&&a($.seasonEndsAt)):c&&l!==void 0&&(c.innerHTML=`
        <div class="leaderboard-skeleton" style="display: flex; flex-direction: column; gap: 12px; width: 100%;">
          ${Array.from({length:6}).map(()=>`
            <div style="height: 52px; background: rgba(255,255,255,0.02); border: 1px solid #1e1f2b; border-radius: 8px; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 0 16px;">
              <div style="display: flex; align-items: center; gap: 12px; width: 60%;">
      ...
      `);let S=new URLSearchParams;t.walletAddress&&S.set("walletAddress",t.walletAddress),l&&S.set("division",String(l));let T=S.toString();fetch(E(`/api/leaderboard/division${T?`?${T}`:""}`)).then(y=>y.json()).then(y=>{let x=y.divisionNumber||1,L=xt(y.players||[],$?.players||[],!1),P=y.totalDivisions||1,N=y.seasonEndsAt;ke=x;let H=document.getElementById("divisionTitleText");H&&(H.innerText=`Division ${x}`);let le=document.getElementById("divisionSelector");le&&(le.innerHTML=Array.from({length:P},(O,de)=>de+1).map(O=>`
            <option value="${O}" ${O===x?"selected":""}>Division ${O}</option>
          `).join("")),c&&(L.length===0?c.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No active players in this division.</p>`:c.innerHTML=L.map((O,de)=>{let be=de+1,ce=t.walletAddress&&O.username.toLowerCase()===t.walletAddress.toLowerCase(),Z=ce&&t.profileUsername?t.profileUsername:O.displayName||O.username,ut=M(Ve(O.status)),Be=ce?`${t.profileUsername?Z:j(O.username)} (You)`:Z.startsWith("0x")&&Z.length===42?j(Z):Z,ye=M(Be),U="safety-zone",D='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return be<=2?(U="promotion-zone",D='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):be>=5&&(U="relegation-zone",D='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
              ...
              `}).join("")),Ze(b,{players:L,divisionNumber:x,totalDivisions:P,seasonEndsAt:N}),Ze(`division_${x}`,{players:L,divisionNumber:x,totalDivisions:P,seasonEndsAt:N}),a(N)}).catch(y=>{console.error("Failed to load division leaderboard:",y),c&&(c.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading division leaderboard. Please try again.</p>`)})};Q==="division"?d(ke||void 0):i(),document.querySelectorAll("[data-leaderboard-view]").forEach(l=>{l.addEventListener("click",()=>{(l.dataset.leaderboardView==="division"?"division":"global")==="division"?d(ke||void 0):i()})}),document.getElementById("divisionSelector")?.addEventListener("change",l=>{let c=Number(l.target.value);d(c)}),document.getElementById("faucetClaimButton")?.addEventListener("click",async()=>{if(!t.walletAddress){v("Please sign in first!");return}if(localStorage.getItem("siftle_circle_is_mock")==="true"){let c=parseFloat(localStorage.getItem(`siftle_mock_balance_${t.walletAddress}`)||"1000.00")+100;localStorage.setItem(`siftle_mock_balance_${t.walletAddress}`,c.toFixed(2)),t.walletBalance=c.toFixed(2),v("Claimed $100 USDC mock credits!"),B(),pa()}else v("Opening Circle Faucet..."),window.open(Xe,"_blank")});let f=document.getElementById("howItWorksBtn"),p=document.getElementById("howItWorksModal"),h=document.getElementById("closeRulesModalBtn");f?.addEventListener("click",()=>{p&&p.classList.add("active")}),h?.addEventListener("click",()=>{p&&p.classList.remove("active")}),p?.addEventListener("click",l=>{l.target===p&&p.classList.remove("active")})},ma=()=>{t.activeSurface="feed",t.selectedMarketId=null,Re?.toggleAttribute("hidden",!0),je?.toggleAttribute("hidden",!0),re?.toggleAttribute("hidden",!0),Me?.classList.remove("active"),Le?.classList.add("active"),Ue?.classList.remove("active"),k?.classList.remove("markets-list")},Ir=e=>e===1?"Yes resolved":e===2?"No resolved":e===3?"Invalid":"Open",Ct=e=>{let a=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},r=t.marketSnapshots[e.id];if(K(e)){let c=r?.resolvedOptionId||null,b=!!c,$=b&&a.optionId===c,S=lr(a,r),T=$?S:0,y=V(e).find(P=>P.id===c)?.label,x=!!a.claimedAt||He().has(e.id),L=!!t.claimingMarketIds[e.id];return`
      <article class="portfolio-position-card">
        ...
        <div class="portfolio-position-footer">
          ...
          ${b?x?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':L?'<button type="button" class="connect-wallet-btn" disabled style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; opacity: 0.7 !important; cursor: wait !important;">Claiming...</button>':$?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${R(T)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>':""}
        </div>
      </article>
    `}let o=Ir(r?.outcome),s=ra(a,r),n=s.reduce((c,b)=>Math.max(c,b.payout),0),i=a.yesSharesUsdc+a.noSharesUsdc,d=r?.outcome??0,m=He().has(e.id),u=d===1?a.yesSharesUsdc:d===2?a.noSharesUsdc:0,f=d===1?r?.yesSharesUsdc??0:d===2?r?.noSharesUsdc??0:0,p=r?.volumeUsdc??0,h=u>0&&f>0?u/f*p:0,l=d===0?"":m?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':h>0?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${R(h)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>';return`
    <article class="portfolio-position-card">
      <div class="portfolio-position-top">
        <span class="category-chip ${e.category}">${W(e.category)}</span>
        <span>${o}</span>
  ...
  `},Br=async e=>{if(!t.walletAddress){v("Please sign in first.");return}let a=Ae().find(o=>o.id===e),r=a?G(a):"";if(!a||!r){v("Market is not available.");return}try{t.claimingMarketIds[a.id]=!0,q(),C("claim_attempt"),mt();let o=await ya(r,t.walletAddress);C("claim_success"),o.won&&or(a.id),delete t.marketPositions[a.id],delete t.marketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.walletBalance=await te(t.walletAddress),await z(),v(o.won?`Claimed $${R(o.amountUsdc)}`:"No payout to claim"),B(),q()}catch(o){C("claim_failed"),v(o instanceof Error?o.message:"Claim failed")}finally{delete t.claimingMarketIds[a.id],q()}},Dr=e=>{if(!e)return"";let a=t.referralData,r=a?.referrals?.length?a.referrals.map(s=>{let n=s.displayName||j(s.walletAddress),i=s.remaining<=0;return`
  ...
  `},q=()=>{if(!k||!w)return;Re?.toggleAttribute("hidden",!0),je?.toggleAttribute("hidden",!0),re?.toggleAttribute("hidden",!0),Me?.classList.remove("active"),Le?.classList.remove("active"),Ue?.classList.add("active"),document.body.classList.remove("detail-mode"),w.hidden=!0,k.hidden=!1,k.classList.add("markets-list"),t.walletAddress&&!t.referralData&&!t.referralError&&!t.loadingReferralData&&Te(),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&(t.portfolioMarketPreviews.length===0&&Ot(),z({force:!t.hasLoadedPortfolioPositions}));let a=He(),r=Ae().filter(p=>{let h=t.marketPositions[p.id];return a.has(p.id)||h&&(h.yesSharesUsdc+h.noSharesUsdc>0||(h.optionSharesUsdc||0)>0)}),o=r.filter(p=>(t.marketSnapshots[p.id]?.outcome??0)===0),s=r.filter(p=>(t.marketSnapshots[p.id]?.outcome??0)!==0),n=!!t.walletAddress,i=t.profileUsername||(t.walletAddress?j(t.walletAddress):"Anonymous"),d=M(i),m=M(t.profileUsername||""),u=t.profileNotice?`<div style="margin-top: 14px !important; padding: 10px 12px !important; border-radius: 8px !important; border: 1px solid ${t.profileNotice.type==="error"?"rgba(239, 68, 68, 0.28)":"rgba(16, 185, 129, 0.24)"} !important; background: ${t.profileNotice.type==="error"?"rgba(127, 29, 29, 0.22)":"rgba(6, 95, 70, 0.18)"} !important; color: ${t.profileNotice.type==="error"?"#fca5a5":"#86efac"} !important; font-size: 0.8rem !important; font-weight: 650 !important;">${M(t.profileNotice.message)}</div>`:"",f=i.charAt(0).toUpperCase();k.innerHTML=`
    <section class="portfolio-surface">
      ...
      ${t.loadingPortfolioPositions?wr(2):t.walletAddress?r.length===0?'<div class="portfolio-empty">No positions found for this wallet yet. Confirmed trades will appear here after the Arc transaction settles.</div>':`
  ...
  `},g=()=>{if(Ht.forEach(e=>{let a=e.dataset.bottomNav;e.classList.toggle("active",a==="saved"?t.showSaved:a===t.activeSurface&&!t.showSaved)}),t.activeSurface==="markets"){ca();return}if(t.activeSurface==="portfolio"){q();return}if(t.activeSurface==="leaderboard"){pa();return}ma(),Vt(),he(),Ur(),F&&(F.value=t.activeArchiveDate??"")};et.textContent=jt();re?.addEventListener("click",e=>{let r=e.target.closest("[data-category]");r&&(t.activeCategory=r.dataset.category,window.history.pushState({},"","#feed"),Y(),g(),Ee(),ne(t.activeCategory))});k?.addEventListener("input",e=>{let a=e.target;if(a.id!=="newsSearchInput")return;let r=a.selectionStart??a.value.length,o=a.selectionEnd??a.value.length;t.newsSearchQuery=a.value,he();let s=k?.querySelector("#newsSearchInput");s&&(s.focus(),s.setSelectionRange(r,o))});Me?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,window.history.pushState({},"","#markets"),Y(),g()});Le?.addEventListener("click",()=>{t.activeSurface="feed",t.showSaved=!1,window.history.pushState({},"","#feed"),Y(),g(),Ee(),ne(t.activeCategory)});Ue?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=!1,window.history.pushState({},"","#portfolio"),Y(),g()});X?.addEventListener("click",()=>{t.walletAddress?(window.location.hash="#portfolio",Ce()):ze()});document.addEventListener("click",e=>{let a=e.target,r=a.closest(".copy-address-btn");if(r){let i=r.getAttribute("data-address");i&&navigator.clipboard.writeText(i).then(()=>{v("Wallet address copied!")})}let o=a.closest("[data-claim-market]");if(o){let i=o.getAttribute("data-claim-market");i&&Br(i);return}if(a.closest("[data-open-referrals]")){t.referralPanelOpen=!t.referralPanelOpen,!t.referralData&&!t.loadingReferralData&&Te(),q();return}if(a.closest("[data-close-referrals]")){t.referralPanelOpen=!1,q();return}if(a.closest("[data-refresh-referrals]")){t.referralError=null,Te(),q();return}let s=a.closest("[data-copy-referral-code]");if(s){let i=s.getAttribute("data-copy-referral-code")||"";i&&navigator.clipboard.writeText(i).then(()=>v("Invite code copied"));return}let n=a.closest("[data-copy-referral-link]");if(n){let i=n.getAttribute("data-copy-referral-link")||"";i&&navigator.clipboard.writeText(i).then(()=>v("Invite link copied"));return}a.closest("[data-connect-wallet]")&&(t.walletAddress?Bt():ze())});Ht.forEach(e=>{e.addEventListener("click",()=>{let a=e.dataset.bottomNav;t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=a==="saved",a==="markets"?(t.activeSurface="markets",window.history.pushState({},"","#markets")):a==="portfolio"?(t.activeSurface="portfolio",window.history.pushState({},"","#portfolio")):a==="leaderboard"?(t.activeSurface="leaderboard",window.history.pushState({},"","#leaderboard")):(t.activeSurface="feed",window.history.pushState({},"","#feed"),Ee(),ne(t.activeCategory),a==="saved"&&(ar(),ot(),$e())),Y(),g()})});F?.addEventListener("change",()=>{t.activeArchiveDate=F.value||null,window.history.pushState({},"","#feed"),Y(),g(),ne(t.activeCategory)});Ca?.addEventListener("click",()=>{t.activeArchiveDate=null,F&&(F.value=""),window.history.pushState({},"","#feed"),Y(),g(),ne(t.activeCategory)});k?.addEventListener("click",async e=>{let a=e.target;if(a.closest("#editUsernameBtn")){let h=k?.querySelector(".username-display-row"),l=k?.querySelector("#usernameEditForm");if(h&&l){h.style.display="none",l.style.display="flex";let c=l.querySelector("#usernameInput");c&&c.focus()}return}if(a.closest("#cancelUsernameBtn")){let h=k?.querySelector(".username-display-row"),l=k?.querySelector("#usernameEditForm");h&&l&&(h.style.display="flex",l.style.display="none");return}let s=a.closest("#saveUsernameBtn");if(s){let l=k?.querySelector("#usernameEditForm")?.querySelector("#usernameInput");if(l){let c=l.value.trim().slice(0,15),b=s,$=b.textContent||"Save";b.disabled=!0,b.textContent="Saving...",tr(c),t.profileNotice=null;try{t.walletAddress&&await ie(!1),t.profileNotice={type:"success",message:"Username saved to your shared leaderboard profile."},v("Username updated"),q()}catch(S){let T=S instanceof Error?S.message:"Username save failed";t.profileNotice={type:"error",message:T},v(T),b.disabled=!1,b.textContent=$,q()}}return}let n=a.closest("[data-timeframe]");if(n){let h=n.dataset.timeframe;t.activeMarketTimeframe=h,ca();return}let i=a.closest("[data-market-id]");if(i){t.selectedMarketId=i.dataset.marketId??null,C("market_view"),window.history.pushState({},"",`#market-${t.selectedMarketId}`),g(),window.scrollTo({top:0,behavior:"smooth"});return}let d=a.closest("[data-thread-story-id]"),m=a.closest("[data-export-id]"),u=a.closest("[data-export-action]"),f=a.closest("[data-story-id]");if(d){e.stopPropagation();let h=t.stories.find(l=>l.id===Number(d.dataset.threadStoryId));h&&Fa(h);return}let p=a.closest(".mobile-bookmark-btn, .bookmark-button");if(p){e.stopPropagation();let h=p.dataset.bookmarkUrl||"",l=t.stories.find(c=>c.sourceUrl===h);if(!l)return;l.saved=!l.saved,l.saved?ae.add(h):ae.delete(h),Pa(),v(l.saved?"Saved to your list":"Removed from saved"),he();return}if(u){e.stopPropagation(),Ar(Number(u.dataset.exportStoryId),u.dataset.exportAction);return}if(m){e.stopPropagation();let h=Number(m.dataset.exportId);t.activeShareStoryId=t.activeShareStoryId===h?null:h,he();return}f&&(a.closest("a")||Yt(Number(f.dataset.storyId),!0))});k?.addEventListener("keydown",e=>{let r=e.target.closest("[data-story-id]");!r||e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),Yt(Number(r.dataset.storyId)))});w?.addEventListener("click",e=>{let a=e.target,r=a.closest("[data-unlock-briefing]");if(r){let f=t.stories.find(p=>p.id===Number(r.dataset.unlockBriefing));f&&tt(f);return}let o=a.closest("[data-unlock-briefing-url]");if(o){let f=decodeURIComponent(o.dataset.unlockBriefingUrl||""),p=ja(f);p&&(se(p)?Fe(p):tt(p));return}if(a.closest("[data-back-markets]")){t.selectedMarketId=null,t.tradeDrawerOpen=!1,window.history.pushState({},"","#markets"),g();return}if(a.closest("#openTradeDrawerBtn")){let f=I.find(l=>l.id===t.selectedMarketId);if(f){if(We(f,t.marketSnapshots[f.id])){v("This market is resolved and can no longer be traded.");return}if(Wt(f,t.marketSnapshots[f.id])){v("Trading is locked 20 minutes before kickoff.");return}}t.tradeDrawerOpen=!0,C("trade_drawer_open");let p=w.querySelector("#tradeDrawer"),h=w.querySelector("#tradeDrawerBackdrop");p?.classList.add("open"),h?.classList.add("open");return}if(a.closest("#closeTradeDrawerBtn")||a.closest("#tradeDrawerBackdrop")){t.tradeDrawerOpen=!1;let f=w.querySelector("#tradeDrawer"),p=w.querySelector("#tradeDrawerBackdrop");f?.classList.remove("open"),p?.classList.remove("open");return}if(a.closest("#shareWhatsAppBtn")){let f=I.find(p=>p.id===t.selectedMarketId);if(f){let p=Cr(f),h=`https://api.whatsapp.com/send?text=${encodeURIComponent(p)}`;window.open(h,"_blank")}return}let s=a.closest("[data-market-trade]");if(s&&t.selectedMarketId){let f=s.dataset.marketTrade;mr(t.selectedMarketId,f);return}let n=a.closest("[data-market-option-trade]");if(n&&t.selectedMarketId){let f=n.dataset.marketOptionTrade||t.marketTradeOptionId||"";Mr(t.selectedMarketId,f);return}let i=a.closest("[data-market-option-id]");if(i){if(i.disabled||i.classList.contains("disabled"))return;t.marketTradeOptionId=i.dataset.marketOptionId||null,g();return}let d=a.closest("[data-market-trade-side]");if(d){if(d.disabled||d.classList.contains("disabled"))return;let f=I.find(l=>l.id===t.selectedMarketId),p=f?t.marketPositions[f.id]:void 0,h=d.dataset.marketTradeSide;if(!ee(t.marketOrderMode,h,p))return;t.marketTradeSide=h,g();return}let m=a.closest("[data-market-order-mode]");if(m){t.marketOrderMode=m.dataset.marketOrderMode;let f=I.find(h=>h.id===t.selectedMarketId),p=f?t.marketPositions[f.id]:void 0;t.marketTradeSide=pt(t.marketOrderMode,t.marketTradeSide,p),t.marketTradeAmount=Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,p),g();return}a.closest("[data-back-to-feed]")&&qa()});w?.addEventListener("input",e=>{let a=e.target;if(!a.matches("[data-market-amount]"))return;let r=I.find(m=>m.id===t.selectedMarketId),o=r?t.marketSnapshots[r.id]:void 0,s=r?t.marketPositions[r.id]:void 0,n=Number(a.value);t.marketTradeAmount=Number.isFinite(n)?n:0;let i=r&&K(r)?t.marketTradeAmount:aa(o,t.marketTradeSide,t.marketTradeAmount,t.marketOrderMode,s),d=w.querySelector(".market-inline-payout strong");d&&(d.textContent=`$${R(i)}`)});w?.addEventListener("focusin",e=>{e.target.matches("[data-market-amount]")&&document.body.classList.add("market-amount-focused")});w?.addEventListener("focusout",e=>{let a=e.target;if(a.matches("[data-market-amount]")){let r=I.find(s=>s.id===t.selectedMarketId),o=r?t.marketPositions[r.id]:void 0;t.marketTradeAmount=Ie(Number(a.value)||0,t.marketOrderMode,t.marketTradeSide,o),a.value=String(t.marketTradeAmount),window.setTimeout(()=>document.body.classList.remove("market-amount-focused"),120)}});window.addEventListener("popstate",Ce);window.addEventListener("hashchange",Ce);window.addEventListener("focus",async()=>{if(t.walletAddress){let e=t.walletBalance,a=await te(t.walletAddress);t.walletBalance=a,B(),(!e||parseFloat(e)===0)&&parseFloat(a)>0&&(console.log("[X402] Balance changed from 0 to positive. Triggering Gateway warmup..."),Sa())}});Ge?.addEventListener("click",()=>{if(!Je||!Ge)return;let e=!Je.hidden;Je.hidden=e,Ge.setAttribute("aria-expanded",String(!e))});document.addEventListener("click",e=>{let a=e.target;!a.closest(".share-control")&&t.activeShareStoryId!==null&&(t.activeShareStoryId=null,he());let r=a.closest("[data-menu-action]");if(!r)return;let o={today:"Showing today's brief",saved:`${t.stories.filter(s=>s.saved).length} saved stories`,archive:t.archiveDates.length>0?"Choose a saved day from the archive selector":"No saved days yet"};A&&(A.textContent=o[r.dataset.menuAction??"today"]),r.dataset.menuAction==="today"&&(t.showSaved=!1,t.activeArchiveDate=null,F&&(F.value=""),Y(),Ee(),ne(t.activeCategory)),r.dataset.menuAction==="saved"&&(ma(),ot(),$e(),t.showSaved=!0,document.querySelector("#archiveControls")?.classList.remove("mobile-open"),Y(),g())});var Nr=async()=>{try{let e=await fetch(E("/api/summary/unlock-config"));e.ok&&(t.unlockConfig=await e.json(),g())}catch(e){console.error("Failed to prefetch unlock config:",e)}};g();B();Nr();Ua().then(()=>{cr(),g(),B(),window.setTimeout(Hr,1200),Ga()});var Or=document.querySelector("#mobileArchiveCard"),fe=document.querySelector("#archiveControls");Or?.addEventListener("click",()=>{if(!fe)return;fe.classList.toggle("mobile-open")&&setTimeout(()=>fe.scrollIntoView({behavior:"smooth",block:"center"}),50)});var _r=document.querySelector("#archivePill");_r?.addEventListener("click",e=>{if(e.stopPropagation(),!fe)return;fe.classList.toggle("mobile-open")&&setTimeout(()=>fe.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Ne=!1,Et=!1,Hr=()=>{Et||(Et=!0,(async()=>{let e=await Oe();if(Ne=!!e,e){t.walletConnecting=!0,B();try{let a=await ka();Ne=!1,t.walletConnecting=!1,a?(t.walletAddress=await Oe(),t.walletAddress&&(ue(),t.walletBalance=await te(t.walletAddress),await z()),B(),t.activeSurface==="portfolio"&&g()):(t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ue(),v("Session expired. Please sign in again."),B(),g())}catch(a){console.warn(a),Ne=!1,t.walletConnecting=!1,t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ue(),v("Session expired. Please sign in again."),B(),g()}}await wa(a=>{Ne||(t.walletAddress=a,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ue(),a&&ie(!1).catch(r=>console.error("Failed to report leaderboard entry:",r)),t.marketPositions={},t.hasLoadedPortfolioPositions=!1,B(),a?(Te(),te(a).then(r=>{t.walletBalance=r,B(),t.activeSurface==="portfolio"&&g()}),z()):t.activeSurface==="portfolio"&&g())})})())};C("app_open");document.addEventListener("click",e=>{let r=e.target.closest("a, button");if(r){let o=r.className||"",s=typeof o=="string"?o:r.getAttribute("class")||"",n=r.getAttribute("href")||"";!(r.hasAttribute("data-unlock-briefing")||r.hasAttribute("data-unlock-briefing-url")||r.classList.contains("summary-btn")||r.textContent?.trim()==="AI briefing"||r.textContent?.trim().includes("Unlock via"))&&(s.includes("source-button")||s.includes("source-btn")||s.includes("source-link")||r.textContent?.trim()==="Open source")&&!s.includes("disabled")&&n!=="#"&&C("open_source")}},!0);
