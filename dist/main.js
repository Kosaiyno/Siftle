        ...
        <div class="trade-drawer-body">
          ...
          <div class="market-amount-panel">
            ...
            <div class="market-amount-input-row">
              <span>$</span>
              <input id="marketAmountInput" type="number" min="${$.min.toFixed(2)}" max="${Math.max($.min,$.max).toFixed(2)}" step="0.01" inputmode="decimal" value="${k}" data-market-amount ${x||P||t.marketOrderMode==="buy"?"disabled":""} style="${t.marketOrderMode==="buy"?"opacity: 0.7; cursor: not-allowed;":""}" />
              <span>USDC</span>
            </div>
          </div>
