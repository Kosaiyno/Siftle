...
`},ur=async(e,a)=>{if(!t.walletAddress){b("Session expired or wallet not connected. Please sign in."),je();return}let r=Me().find(m=>m.id===e);if(!r||!oe(r))return;let o=ne(r).find(m=>m.id===a);if(!o){b("Choose a valid option.");return}!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",h(),await F(),t.marketTradeStatus=null);let s=t.marketSnapshots[r.id];if(Fe(r,s)){b("This market is resolved and can no longer be traded.");return}let n=t.marketPositions[r.id],i=t.marketOrderMode==="sell";if(!i&&n?.optionId){b("Your pick is already locked for this market.");return}if(i&&!n?.optionId){b("You do not have a pick to exit.");return}let d=i?Math.max(.01,Number(n?.optionSharesUsdc)||Number(t.marketTradeAmount)||0):Ie(Number(t.marketTradeAmount)||0,"buy","yes",void 0);t.marketTradeAmount=d,t.marketTradeOptionId=i&&n?.optionId||o.id,U("trade_attempt");try{t.marketTradeStatus=i?"Exiting your pick...":"Locking your pick...",h(),await fa(r.id,i?"sell":"buy",i&&n?.optionId||o.id,d,m=>{t.marketTradeStatus=m,h()}),delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await Ne(),t.walletAddress&&(t.walletBalance=await ge(t.walletAddress)),await F({force:!0}),U("trade_success"),b(i?"Pick exited":`Pick locked: ${o.label}`),t.tradeDrawerOpen=!1}catch(m){U("trade_failed"),b(m instanceof Error?m.message:"Trade failed")}finally{t.marketTradeStatus=null,B(),h()}},fr=()=>{if(!x||!S)return;let e=t.stories.find(o=>o.sourceUrl===t.selectedThreadUrl);if(S.hidden=!0,x.hidden=!1,x.classList.add("fullscreen"),document.body.classList.add("detail-mode"),!e){x.innerHTML="";return}let a=t.loadingThreadUrl===e.sourceUrl,r=t.activeThread;if(a&&!r){x.innerHTML=`
  ...
  `},hr=e=>{let a=t.marketSnapshots[e.id],r=G(e),o=oe(e),s=ne(e).length,n=a?.yesPriceCents,i=n??e.probability,d=o?`${s}`:`${i}%`,m=n===void 0?r?"Loading Arc pools":"Arc setup required":`Yes ${n}\xA2 \xB7 No ${100-n}\xA2`,f=n===void 0?`Yes ${e.probability}c - No ${100-e.probability}c`:m,u=qe(e),p=e.timeframe==="Daily"?zt(e,a):e.closes;return`
...
Trade and discuss here: ${d}`},br=e=>{if(!S||!x)return;let a=qe(e),r=!t.checkedMarketEvidence[e.id],o=G(e),s=t.marketSnapshots[e.id],n=oe(e),i=ne(e);n&&!t.marketTradeOptionId&&(t.marketTradeOptionId=i[0]?.id||null);let d=Wa(e),m=!!(o&&!s),f=s?.yesPriceCents??(o?e.probability:0),u=s?.noPriceCents??(o?100-e.probability:0),p=m?"":o?`${f}\xA2`:"--",g=m?"":o?`${u}\xA2`:"--",l=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},c=n&&t.marketOrderMode==="sell"?Math.max(0,Number(l.optionSharesUsdc)||0):0,y=c>0?c:Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,l),w=c>0?{min:0,max:c}:Zt(t.marketOrderMode,t.marketTradeSide,l),$=t.marketOrderMode==="buy"?"$5-$10 USDC":`Up to $${D(w.max)} USDC`,k=!t.walletAddress||t.hasLoadedPortfolioPositions,v=Fe(e,s),T=qt(e,s),L=!!T;n||(t.marketTradeSide=st(t.marketOrderMode,t.marketTradeSide,l));let O=!n&&!v&&!L&&k&&ee(t.marketOrderMode,"yes",l),N=!n&&!v&&!L&&k&&ee(t.marketOrderMode,"no",l),I=!!l.optionId;n&&I&&t.marketOrderMode!=="sell"&&(t.marketOrderMode="sell");let le=n?!v&&!L&&k&&(t.marketOrderMode==="sell"?I:!I&&!!d):!v&&!L&&k&&ee(t.marketOrderMode,t.marketTradeSide,l),_=v?"Market resolved":T||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),de=v?"Market resolved":T||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),ce=n?y:Xt(s,t.marketTradeSide,y,t.marketOrderMode,l),pe=t.marketOrderMode==="buy"?"Buy":"Exit",V=n?"Pick one outcome":o?"Arc testnet live":"Contract not deployed";S.hidden=!0,x.hidden=!1,x.classList.add("fullscreen"),document.body.classList.add("detail-mode"),tr(e),Kt(e),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&F({force:!t.hasLoadedPortfolioPositions});let Be=n?!!l.optionId:l.yesSharesUsdc>0||l.noSharesUsdc>0,be="";if(n&&Be&&t.walletAddress){let A=s?.optionPools?.[l.optionId||""]||0,H=s?.volumeUsdc||0,Z=l.optionSharesUsdc&&A>0?l.optionSharesUsdc/A*H:0;be=`
      <div class="user-market-position-box" style="margin: 16px 0; padding: 16px; background: rgba(59, 130, 246, 0.05); border: 1px solid rgba(59, 130, 246, 0.15); border-radius: 12px; font-family: 'Space Grotesk', sans-serif;">
        ...
        <div style="display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 1fr); gap: 12px;">
          <div>
            ...
            <strong style="font-size: 0.95rem; color: var(--market-text-main);">${P(l.optionLabel||"Selected option")}</strong>
          </div>
          <div>
      ...
      <div class="user-market-position-box" style="margin: 16px 0; padding: 16px; background: rgba(59, 130, 246, 0.05); border: 1px solid rgba(59, 130, 246, 0.15); border-radius: 12px; font-family: 'Space Grotesk', sans-serif;">
        ...
        ${Qt(l,s).map(H=>`
          <div style="display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 1fr); gap: 12px; margin-bottom: 8px;">
            <div>
              <span style="font-size: 0.72rem; color: var(--market-text-muted); display: block; margin-bottom: 2px;">${H.label}</span>
              <strong style="font-size: 0.95rem; color: var(--market-text-main);">${D(H.shares)}</strong>
            </div>
            <div>
              <span style="font-size: 0.72rem; color: var(--market-text-muted); display: block; margin-bottom: 2px;">Projected payout</span>
              <strong style="font-size: 0.95rem; color: var(--market-text-main);">$${D(H.payout)}</strong>
            </div>
          </div>
        `).join("")}
    ...
    <div class="detail-container market-detail-container">
      ...
      <article class="market-detail-card">
        <div class="market-detail-main">
          ...
          <div class="market-resolution-panel">
            ...
            <p>${e.resolution}</p>
            ${T?`<p style="margin-top: 10px; color: #f59e0b; font-weight: 600;">${T}</p>`:""}
          </div>
          ...
          <section class="market-evidence-thread">
            ...
            <div class="market-thread-timeline">
              ${r?nr(3):a.evidence.length===0?'<div class="portfolio-empty compact">Related news is still loading for this market.</div>':a.evidence.map(A=>{let H=jt(e,A),Z=t.unlockingSummaryUrl===A.sourceUrl;return`
                <article class="market-thread-update">
                  ...
                  <div class="market-thread-update-content">
                    ...
                    ${Z?`<div style="margin-top: 12px;">${he()}</div>`:re(H)?t.loadingSummaryUrl===A.sourceUrl?`<div style="margin-top: 12px;">${he()}</div>`:`<div style="margin-top: 12px;">${at(K(H,t.aiSummaries[A.sourceUrl]))}</div>`:""}
                  </div>
                </article>
              `}).join("")}
            </div>
      ...
      <div class="sticky-trade-bar">
        <div class="sticky-trade-info">
          ${n?`<span>${I?"Pick locked":"Choose one option"}</span><span><strong>${i.length} options</strong></span>`:`<span>Yes <strong>${p}</strong></span><span>No <strong>${g}</strong></span>`}
        </div>
        <button class="sticky-trade-btn" type="button" id="openTradeDrawerBtn" ${v||L?"disabled":""}>
          ${v?"Market Resolved":T||(n?I?"Pick Locked":"Pick Outcome":"Trade Market")}
        </button>
      </div>
      ...
      <div class="trade-drawer ${t.tradeDrawerOpen?"open":""}" id="tradeDrawer">
        ...
        <div class="trade-drawer-body">
          <div class="market-order-mode">
            <button type="button" class="${t.marketOrderMode==="buy"?"active":""}" data-market-order-mode="buy" ${v||L?"disabled":""}>Buy</button>
            <button type="button" class="${t.marketOrderMode==="sell"?"active":""}" data-market-order-mode="sell" ${v||L?"disabled":""}>Exit</button>
          </div>

          <div class="market-action-grid">
            ${n?i.map(A=>{let H=s?.optionPools?.[A.id]||0,Z=t.marketTradeOptionId===A.id||l.optionId===A.id,lt=v||L||t.marketOrderMode==="sell"||I||!k;return`
                  <button type="button" class="market-side option ${Z?"active":""} ${lt?"disabled":""}" data-market-option-id="${P(A.id)}" ${lt?"disabled":""}>
                    <span>${P(A.label)}</span>
                    <strong>$${D(H)}</strong>
              ...
              `:`
                ...
                <button type="button" class="market-side no ${t.marketTradeSide==="no"?"active":""} ${N?"":"disabled"}" data-market-trade-side="no" ${N?"":"disabled"} title="${N?"No":de}">
                  <span>No</span>
                  <strong>${g}</strong>
                  ${N?"":`<small>${de}</small>`}
                </button>
          ...
          <div class="market-amount-panel">
            ...
            <div class="market-amount-input-row">
              <span>$</span>
              <input id="marketAmountInput" type="number" min="${w.min.toFixed(2)}" max="${Math.max(w.min,w.max).toFixed(2)}" step="0.01" inputmode="decimal" value="${y}" data-market-amount ${v||L?"disabled":""} />
              <span>USDC</span>
            </div>
          </div>
  ...
  `},na=()=>{if(!S||!x)return;if(He?.toggleAttribute("hidden",!0),Re?.toggleAttribute("hidden",!0),ae?.toggleAttribute("hidden",!0),Le?.classList.add("active"),Pe?.classList.remove("active"),Ue?.classList.remove("active"),window.setTimeout(()=>{t.activeSurface==="markets"&&E.forEach(n=>{Kt(n)})},750),t.selectedMarketId){let n=E.find(i=>i.id===t.selectedMarketId);if(n){br(n);return}t.selectedMarketId=null,window.location.hash.startsWith("#market-")&&window.history.replaceState({},"","#markets");return}document.body.classList.remove("detail-mode"),x.hidden=!0,x.classList.remove("fullscreen"),S.hidden=!1,S.classList.add("markets-list");let e=E,r=`
    <nav class="market-timeframe-tabs" aria-label="Timeframe navigation">
      ${["All","Daily","Weekly","Sagas"].map(n=>{let i=t.activeMarketTimeframe===n,d=n==="All"?e.length:e.filter(f=>f.timeframe===n).length;return`
  ...
  `},ia=()=>{if(!S||!x)return;He?.toggleAttribute("hidden",!0),Re?.toggleAttribute("hidden",!0),ae?.toggleAttribute("hidden",!0),Le?.classList.remove("active"),Pe?.classList.remove("active"),Ue?.classList.remove("active"),document.body.classList.remove("detail-mode"),x.hidden=!0,S.hidden=!1,S.classList.add("markets-list");let e=t.walletAddress&&t.hasLoadedPortfolioPositions?nt():null;t.walletAddress&&e&&fetch(C("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:t.walletAddress,points:e.points,status:e.status,username:t.profileUsername||""})}).catch(l=>console.error("Failed to report user score:",l)),J&&(clearInterval(J),J=null),S.innerHTML=`
  ...
  `;let a=(l="2026-07-19T23:59:59.000Z")=>{let c=document.getElementById("seasonTimer");J&&clearInterval(J);let y=()=>{let $=new Date(l).getTime()-new Date().getTime();if($<=0){c&&(c.innerText="Season Finished!"),J&&clearInterval(J);return}let k=Math.floor($/(1e3*60*60*24)),v=Math.floor($%(1e3*60*60*24)/(1e3*60*60)),T=Math.floor($%(1e3*60*60)/(1e3*60)),L=Math.floor($%(1e3*60)/1e3);c&&(c.innerText=`${k}d ${v}h ${T}m ${L}s`)};y(),J=setInterval(y,1e3)};a();let r=l=>l.map((c,y)=>{let w=Number(c.globalRank)||y+1,$=String(c.username||""),k=!!(t.walletAddress&&$.toLowerCase()===t.walletAddress.toLowerCase()),v=k&&t.profileUsername?t.profileUsername:c.displayName||$,T=k?`${t.profileUsername?v:j($)} (You)`:v.startsWith("0x")&&v.length===42?j(v):v,L=P(T),O=P(Ke(c.status)),N=c.nextSeasonDivision?`Division ${c.nextSeasonDivision}`:"Qualify",I=w<=10?"promotion-zone":"safety-zone",le=w<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
      <div class="leaderboard-row global-row ${k?"user-highlight":""} ${I}" role="listitem">
        <div class="leaderboard-row-left">
          ${le}
          <span class="leaderboard-rank rank-${w}">${w}</span>
          <span class="leaderboard-username">${L}</span>
        </div>
        <div class="leaderboard-row-score">
          <strong>${Number(c.points)||0} pts</strong>
          <span>${c.prizeEligible?"Prize eligible":"Season rank"} \xB7 ${P(N)}</span>
        </div>
        <div class="leaderboard-row-right">
          <span>${O}</span>
        </div>
      </div>
    `}).join(""),o=l=>l.map((c,y)=>{let w=y+1,$=String(c.username||""),k=!!(t.walletAddress&&$.toLowerCase()===t.walletAddress.toLowerCase()),v=k&&t.profileUsername?t.profileUsername:c.displayName||$,T=P(Ke(c.status)),L=k?`${t.profileUsername?v:j($)} (You)`:v.startsWith("0x")&&v.length===42?j(v):v,O=P(L),N="safety-zone",I='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return w<=2?(N="promotion-zone",I='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):w>=5&&(N="relegation-zone",I='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
      <div class="leaderboard-row ${k?"user-highlight":""} ${N}" role="listitem" style="display: flex !important; align-items: center !important; justify-content: space-between !important; padding: 12px 16px !important; border-bottom: 1px solid rgba(255, 255, 255, 0.06) !important; margin-bottom: 0 !important; background: transparent !important; font-family: 'Space Grotesk', sans-serif !important;">
        <div style="flex: 1.5; display: flex; align-items: center; gap: 8px; min-width: 0;">
          ${I}
          <span class="leaderboard-rank rank-${w}" style="flex-shrink: 0; margin-right: 4px;">${w}</span>
          <span class="leaderboard-username" style="font-weight: 600; color: #ffffff; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${O}</span>
        </div>
    ...
    `)},i=()=>{s("global");let l=document.getElementById("leaderboardListContainer"),c="global",y=ht(c);y&&l?(l.innerHTML=bt()+r(y.players),y.seasonEndsAt&&a(y.seasonEndsAt)):n(10);let w=new URLSearchParams;t.walletAddress&&w.set("walletAddress",t.walletAddress);let $=w.toString();fetch(C(`/api/leaderboard/global${$?`?${$}`:""}`)).then(k=>k.json()).then(k=>{let v=vt(k.players||[],y?.players||[],!0);l&&(l.innerHTML=v.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players on the global leaderboard yet.</p>`:r(v)),Ve(c,{players:v,seasonEndsAt:k.seasonEndsAt}),a(k.seasonEndsAt)}).catch(k=>{console.error("Failed to load global leaderboard:",k),l&&(l.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading global leaderboard. Please try again.</p>`)})},d=l=>{s("division");let c=document.getElementById("leaderboardListContainer"),y=`division_${l||ye||"current"}`,w=ht(y);w&&c?(c.innerHTML=bt()+o(w.players),w.divisionNumber&&(ye=w.divisionNumber),w.seasonEndsAt&&a(w.seasonEndsAt)):c&&l!==void 0&&(c.innerHTML=`
        <div class="leaderboard-skeleton" style="display: flex; flex-direction: column; gap: 12px; width: 100%;">
          ${Array.from({length:6}).map(()=>`
            <div style="height: 52px; background: rgba(255,255,255,0.02); border: 1px solid #1e1f2b; border-radius: 8px; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 0 16px;">
              <div style="display: flex; align-items: center; gap: 12px; width: 60%;">
      ...
      `);let $=new URLSearchParams;t.walletAddress&&$.set("walletAddress",t.walletAddress),l&&$.set("division",String(l));let k=$.toString();fetch(C(`/api/leaderboard/division${k?`?${k}`:""}`)).then(v=>v.json()).then(v=>{let T=v.divisionNumber||1,L=vt(v.players||[],w?.players||[],!1),O=v.totalDivisions||1,N=v.seasonEndsAt;ye=T;let I=document.getElementById("divisionTitleText");I&&(I.innerText=`Division ${T}`);let le=document.getElementById("divisionSelector");le&&(le.innerHTML=Array.from({length:O},(_,de)=>de+1).map(_=>`
            <option value="${_}" ${_===T?"selected":""}>Division ${_}</option>
          `).join("")),c&&(L.length===0?c.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No active players in this division.</p>`:c.innerHTML=L.map((_,de)=>{let ce=de+1,pe=t.walletAddress&&_.username.toLowerCase()===t.walletAddress.toLowerCase(),V=pe&&t.profileUsername?t.profileUsername:_.displayName||_.username,it=P(Ke(_.status)),Be=pe?`${t.profileUsername?V:j(_.username)} (You)`:V.startsWith("0x")&&V.length===42?j(V):V,be=P(Be),A="safety-zone",H='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return ce<=2?(A="promotion-zone",H='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):ce>=5&&(A="relegation-zone",H='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
              ...
              `}).join("")),Ve(y,{players:L,divisionNumber:T,totalDivisions:O,seasonEndsAt:N}),Ve(`division_${T}`,{players:L,divisionNumber:T,totalDivisions:O,seasonEndsAt:N}),a(N)}).catch(v=>{console.error("Failed to load division leaderboard:",v),c&&(c.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading division leaderboard. Please try again.</p>`)})};X==="division"?d(ye||void 0):i(),document.querySelectorAll("[data-leaderboard-view]").forEach(l=>{l.addEventListener("click",()=>{(l.dataset.leaderboardView==="division"?"division":"global")==="division"?d(ye||void 0):i()})}),document.getElementById("divisionSelector")?.addEventListener("change",l=>{let c=Number(l.target.value);d(c)}),document.getElementById("faucetClaimButton")?.addEventListener("click",async()=>{if(!t.walletAddress){b("Please sign in first!");return}if(localStorage.getItem("siftle_circle_is_mock")==="true"){let c=parseFloat(localStorage.getItem(`siftle_mock_balance_${t.walletAddress}`)||"1000.00")+100;localStorage.setItem(`siftle_mock_balance_${t.walletAddress}`,c.toFixed(2)),t.walletBalance=c.toFixed(2),b("Claimed $100 USDC mock credits!"),B(),ia()}else b("Opening Circle Faucet..."),window.open(Ze,"_blank")});let u=document.getElementById("howItWorksBtn"),p=document.getElementById("howItWorksModal"),g=document.getElementById("closeRulesModalBtn");u?.addEventListener("click",()=>{p&&p.classList.add("active")}),g?.addEventListener("click",()=>{p&&p.classList.remove("active")}),p?.addEventListener("click",l=>{l.target===p&&p.classList.remove("active")})},la=()=>{t.activeSurface="feed",t.selectedMarketId=null,He?.removeAttribute("hidden"),Re?.removeAttribute("hidden"),ae?.removeAttribute("hidden"),Le?.classList.remove("active"),Pe?.classList.add("active"),Ue?.classList.remove("active"),S?.classList.remove("markets-list")},yr=e=>e===1?"Yes resolved":e===2?"No resolved":e===3?"Invalid":"Open",Lt=e=>{let a=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},r=t.marketSnapshots[e.id];if(oe(e)){let c=r?.resolvedOptionId||null,y=!!c,w=r?.optionPools?.[a.optionId||""]||0,$=r?.volumeUsdc||0,k=y&&a.optionId===c,v=k&&w>0?(a.optionSharesUsdc||0)/w*$:0,T=ne(e).find(O=>O.id===c)?.label,L=_e().has(e.id);return`
      <article class="portfolio-position-card">
        <div class="portfolio-position-top">
          <span class="category-chip ${e.category}">${z(e.category)}</span>
          <span>${y?`Resolved: ${P(T||"Option selected")}`:"Open"}</span>
        </div>
        <h2>${e.question}</h2>
        <div class="portfolio-position-stats">
          ...
          <div><span>Projected payout</span><strong>$${D(v||a.optionSharesUsdc||0)}</strong></div>
        </div>
        <div class="portfolio-position-footer">
          <span>${y?"":`Closes ${e.closes}`}</span>
          ${y?L?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':k?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${D(v)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>':""}
        </div>
      </article>
    `}let o=yr(r?.outcome),s=Qt(a,r),n=s.reduce((c,y)=>Math.max(c,y.payout),0),i=a.yesSharesUsdc+a.noSharesUsdc,d=r?.outcome??0,m=_e().has(e.id),f=d===1?a.yesSharesUsdc:d===2?a.noSharesUsdc:0,u=d===1?r?.yesSharesUsdc??0:d===2?r?.noSharesUsdc??0:0,p=r?.volumeUsdc??0,g=f>0&&u>0?f/u*p:0,l=d===0?"":m?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':g>0?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${D(g)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>';return`
    <article class="portfolio-position-card">
      <div class="portfolio-position-top">
        <span class="category-chip ${e.category}">${z(e.category)}</span>
        <span>${o}</span>
  ...
  `},kr=async e=>{if(!t.walletAddress){b("Please sign in first.");return}let a=Me().find(o=>o.id===e),r=a?G(a):"";if(!a||!r){b("Market is not available.");return}try{U("claim_attempt"),nt();let o=await ga(r,t.walletAddress);U("claim_success"),o.won&&Ka(a.id),delete t.marketPositions[a.id],delete t.marketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.walletBalance=await ge(t.walletAddress),await F(),b(o.won?`Claimed $${D(o.amountUsdc)}`:"No payout to claim"),B(),W()}catch(o){U("claim_failed"),b(o instanceof Error?o.message:"Claim failed")}},wr=e=>{if(!e)return"";let a=t.referralData,r=a?.referrals?.length?a.referrals.map(s=>{let n=s.displayName||j(s.walletAddress),i=s.remaining<=0;return`
  ...
  `},h=()=>{if(Ot.forEach(e=>{let a=e.dataset.bottomNav;e.classList.toggle("active",a==="saved"?t.showSaved:a===t.activeSurface&&!t.showSaved)}),t.activeSurface==="markets"){na();return}if(t.activeSurface==="portfolio"){W();return}if(t.activeSurface==="leaderboard"){ia();return}la(),Yt(),Ae(),gr(),q&&(q.value=t.activeArchiveDate??"")};Xe.textContent=_t();ae?.addEventListener("click",e=>{let r=e.target.closest("[data-category]");r&&(t.activeCategory=r.dataset.category,window.history.pushState({},"","#feed"),Y(),h(),Ee(),se(t.activeCategory))});Le?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,window.history.pushState({},"","#markets"),Y(),h()});Pe?.addEventListener("click",()=>{t.activeSurface="feed",t.showSaved=!1,window.history.pushState({},"","#feed"),Y(),h(),Ee(),se(t.activeCategory)});Ue?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=!1,window.history.pushState({},"","#portfolio"),Y(),h()});Q?.addEventListener("click",()=>{t.walletAddress?(window.location.hash="#portfolio",Ce()):je()});document.addEventListener("click",e=>{let a=e.target,r=a.closest(".copy-address-btn");if(r){let i=r.getAttribute("data-address");i&&navigator.clipboard.writeText(i).then(()=>{b("Wallet address copied!")})}let o=a.closest("[data-claim-market]");if(o){let i=o.getAttribute("data-claim-market");i&&kr(i);return}if(a.closest("[data-open-referrals]")){t.referralPanelOpen=!t.referralPanelOpen,!t.referralData&&!t.loadingReferralData&&Te(),W();return}if(a.closest("[data-close-referrals]")){t.referralPanelOpen=!1,W();return}if(a.closest("[data-refresh-referrals]")){t.referralError=null,Te(),W();return}let s=a.closest("[data-copy-referral-code]");if(s){let i=s.getAttribute("data-copy-referral-code")||"";i&&navigator.clipboard.writeText(i).then(()=>b("Invite code copied"));return}let n=a.closest("[data-copy-referral-link]");if(n){let i=n.getAttribute("data-copy-referral-link")||"";i&&navigator.clipboard.writeText(i).then(()=>b("Invite link copied"));return}a.closest("[data-connect-wallet]")&&(t.walletAddress?Ct():je())});Ot.forEach(e=>{e.addEventListener("click",()=>{let a=e.dataset.bottomNav;t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=a==="saved",a==="markets"?(t.activeSurface="markets",window.history.pushState({},"","#markets")):a==="portfolio"?(t.activeSurface="portfolio",window.history.pushState({},"","#portfolio")):a==="leaderboard"?(t.activeSurface="leaderboard",window.history.pushState({},"","#leaderboard")):(t.activeSurface="feed",window.history.pushState({},"","#feed"),Ee(),se(t.activeCategory),a==="saved"&&(Ga(),tt(),$e())),Y(),h()})});q?.addEventListener("change",()=>{t.activeArchiveDate=q.value||null,window.history.pushState({},"","#feed"),Y(),h(),se(t.activeCategory)});Aa?.addEventListener("click",()=>{t.activeArchiveDate=null,q&&(q.value=""),window.history.pushState({},"","#feed"),Y(),h(),se(t.activeCategory)});S?.addEventListener("click",async e=>{let a=e.target;if(a.closest("#editUsernameBtn")){let g=S?.querySelector(".username-display-row"),l=S?.querySelector("#usernameEditForm");if(g&&l){g.style.display="none",l.style.display="flex";let c=l.querySelector("#usernameInput");c&&c.focus()}return}if(a.closest("#cancelUsernameBtn")){let g=S?.querySelector(".username-display-row"),l=S?.querySelector("#usernameEditForm");g&&l&&(g.style.display="flex",l.style.display="none");return}let s=a.closest("#saveUsernameBtn");if(s){let l=S?.querySelector("#usernameEditForm")?.querySelector("#usernameInput");if(l){let c=l.value.trim().slice(0,15),y=s,w=y.textContent||"Save";y.disabled=!0,y.textContent="Saving...",Ya(c),t.profileNotice=null;try{t.walletAddress&&await ie(!1),t.profileNotice={type:"success",message:"Username saved to your shared leaderboard profile."},b("Username updated"),W()}catch($){let k=$ instanceof Error?$.message:"Username save failed";t.profileNotice={type:"error",message:k},b(k),y.disabled=!1,y.textContent=w,W()}}return}let n=a.closest("[data-timeframe]");if(n){let g=n.dataset.timeframe;t.activeMarketTimeframe=g,na();return}let i=a.closest("[data-market-id]");if(i){t.selectedMarketId=i.dataset.marketId??null,U("market_view"),window.history.pushState({},"",`#market-${t.selectedMarketId}`),h(),window.scrollTo({top:0,behavior:"smooth"});return}let d=a.closest("[data-thread-story-id]"),m=a.closest("[data-export-id]"),f=a.closest("[data-export-action]"),u=a.closest("[data-story-id]");if(d){e.stopPropagation();let g=t.stories.find(l=>l.id===Number(d.dataset.threadStoryId));g&&Da(g);return}let p=a.closest(".mobile-bookmark-btn, .bookmark-button");if(p){e.stopPropagation();let g=p.dataset.bookmarkUrl||"",l=t.stories.find(c=>c.sourceUrl===g);if(!l)return;l.saved=!l.saved,l.saved?te.add(g):te.delete(g),Ta(),b(l.saved?"Saved to your list":"Removed from saved"),Ae();return}if(f){e.stopPropagation(),mr(Number(f.dataset.exportStoryId),f.dataset.exportAction);return}if(m){e.stopPropagation();let g=Number(m.dataset.exportId);t.activeShareStoryId=t.activeShareStoryId===g?null:g,Ae();return}u&&(a.closest("a")||Ft(Number(u.dataset.storyId),!!a.closest(".summary-btn")))});S?.addEventListener("keydown",e=>{let r=e.target.closest("[data-story-id]");!r||e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),Ft(Number(r.dataset.storyId)))});x?.addEventListener("click",e=>{let a=e.target,r=a.closest("[data-unlock-briefing]");if(r){let u=t.stories.find(p=>p.id===Number(r.dataset.unlockBriefing));u&&Qe(u);return}let o=a.closest("[data-unlock-briefing-url]");if(o){let u=decodeURIComponent(o.dataset.unlockBriefingUrl||""),p=Ia(u);p&&(re(p)?ze(p):Qe(p));return}if(a.closest("[data-back-markets]")){t.selectedMarketId=null,t.tradeDrawerOpen=!1,window.history.pushState({},"","#markets"),h();return}if(a.closest("#openTradeDrawerBtn")){let u=E.find(l=>l.id===t.selectedMarketId);if(u){if(Fe(u,t.marketSnapshots[u.id])){b("This market is resolved and can no longer be traded.");return}if(qt(u,t.marketSnapshots[u.id])){b("Trading is locked 20 minutes before kickoff.");return}}t.tradeDrawerOpen=!0,U("trade_drawer_open");let p=x.querySelector("#tradeDrawer"),g=x.querySelector("#tradeDrawerBackdrop");p?.classList.add("open"),g?.classList.add("open");return}if(a.closest("#closeTradeDrawerBtn")||a.closest("#tradeDrawerBackdrop")){t.tradeDrawerOpen=!1;let u=x.querySelector("#tradeDrawer"),p=x.querySelector("#tradeDrawerBackdrop");u?.classList.remove("open"),p?.classList.remove("open");return}if(a.closest("#shareWhatsAppBtn")){let u=E.find(p=>p.id===t.selectedMarketId);if(u){let p=vr(u),g=`https://api.whatsapp.com/send?text=${encodeURIComponent(p)}`;window.open(g,"_blank")}return}let s=a.closest("[data-market-trade]");if(s&&t.selectedMarketId){let u=s.dataset.marketTrade;ar(t.selectedMarketId,u);return}let n=a.closest("[data-market-option-trade]");if(n&&t.selectedMarketId){let u=n.dataset.marketOptionTrade||t.marketTradeOptionId||"";ur(t.selectedMarketId,u);return}let i=a.closest("[data-market-option-id]");if(i){if(i.disabled||i.classList.contains("disabled"))return;t.marketTradeOptionId=i.dataset.marketOptionId||null,h();return}let d=a.closest("[data-market-trade-side]");if(d){if(d.disabled||d.classList.contains("disabled"))return;let u=E.find(l=>l.id===t.selectedMarketId),p=u?t.marketPositions[u.id]:void 0,g=d.dataset.marketTradeSide;if(!ee(t.marketOrderMode,g,p))return;t.marketTradeSide=g,h();return}let m=a.closest("[data-market-order-mode]");if(m){t.marketOrderMode=m.dataset.marketOrderMode;let u=E.find(g=>g.id===t.selectedMarketId),p=u?t.marketPositions[u.id]:void 0;t.marketTradeSide=st(t.marketOrderMode,t.marketTradeSide,p),t.marketTradeAmount=Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,p),h();return}a.closest("[data-back-to-feed]")&&Oa()});x?.addEventListener("input",e=>{let a=e.target;if(!a.matches("[data-market-amount]"))return;let r=E.find(d=>d.id===t.selectedMarketId),o=r?t.marketSnapshots[r.id]:void 0,s=r?t.marketPositions[r.id]:void 0;t.marketTradeAmount=Ie(Number(a.value)||0,t.marketOrderMode,t.marketTradeSide,s),a.value=String(t.marketTradeAmount);let n=r&&oe(r)?t.marketTradeAmount:Xt(o,t.marketTradeSide,t.marketTradeAmount,t.marketOrderMode,s),i=x.querySelector(".market-inline-payout strong");i&&(i.textContent=`$${D(n)}`)});x?.addEventListener("focusin",e=>{e.target.matches("[data-market-amount]")&&document.body.classList.add("market-amount-focused")});x?.addEventListener("focusout",e=>{e.target.matches("[data-market-amount]")&&window.setTimeout(()=>document.body.classList.remove("market-amount-focused"),120)});window.addEventListener("popstate",Ce);window.addEventListener("hashchange",Ce);Ye?.addEventListener("click",()=>{if(!Ge||!Ye)return;let e=!Ge.hidden;Ge.hidden=e,Ye.setAttribute("aria-expanded",String(!e))});document.addEventListener("click",e=>{let a=e.target;!a.closest(".share-control")&&t.activeShareStoryId!==null&&(t.activeShareStoryId=null,Ae());let r=a.closest("[data-menu-action]");if(!r)return;let o={today:"Showing today's brief",saved:`${t.stories.filter(s=>s.saved).length} saved stories`,archive:t.archiveDates.length>0?"Choose a saved day from the archive selector":"No saved days yet"};M&&(M.textContent=o[r.dataset.menuAction??"today"]),r.dataset.menuAction==="today"&&(t.showSaved=!1,t.activeArchiveDate=null,q&&(q.value=""),Y(),Ee(),se(t.activeCategory)),r.dataset.menuAction==="saved"&&(la(),tt(),$e(),t.showSaved=!0,document.querySelector("#archiveControls")?.classList.remove("mobile-open"),Y(),h())});h();B();$a().then(()=>{er(),h(),B(),window.setTimeout($r,1200),Ha()});var Sr=document.querySelector("#mobileArchiveCard"),fe=document.querySelector("#archiveControls");Sr?.addEventListener("click",()=>{if(!fe)return;fe.classList.toggle("mobile-open")&&setTimeout(()=>fe.scrollIntoView({behavior:"smooth",block:"center"}),50)});var xr=document.querySelector("#archivePill");xr?.addEventListener("click",e=>{if(e.stopPropagation(),!fe)return;fe.classList.toggle("mobile-open")&&setTimeout(()=>fe.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Oe=!1,Pt=!1,$r=()=>{Pt||(Pt=!0,(async()=>{let e=await Ne();if(Oe=!!e,e){t.walletConnecting=!0,B();try{let a=await ha();Oe=!1,t.walletConnecting=!1,a?(t.walletAddress=await Ne(),t.walletAddress&&(ue(),t.walletBalance=await ge(t.walletAddress),await F()),B(),t.activeSurface==="portfolio"&&h()):(t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ue(),b("Session expired. Please sign in again."),B(),h())}catch(a){console.warn(a),Oe=!1,t.walletConnecting=!1,t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ue(),b("Session expired. Please sign in again."),B(),h()}}await va(a=>{Oe||(t.walletAddress=a,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ue(),a&&ie(!1).catch(r=>console.error("Failed to report leaderboard entry:",r)),t.marketPositions={},t.hasLoadedPortfolioPositions=!1,B(),a?(Te(),ge(a).then(r=>{t.walletBalance=r,B(),t.activeSurface==="portfolio"&&h()}),F()):t.activeSurface==="portfolio"&&h())})})())};U("app_open");document.addEventListener("click",e=>{let r=e.target.closest("a, button");if(r){let o=r.className||"",s=typeof o=="string"?o:r.getAttribute("class")||"",n=r.getAttribute("href")||"";!(r.hasAttribute("data-unlock-briefing")||r.hasAttribute("data-unlock-briefing-url"))&&(s.includes("source-button")||s.includes("source-btn")||s.includes("source-link")||r.textContent?.trim()==="Open source")&&!s.includes("disabled")&&n!=="#"&&U("open_source")}},!0);
