...
`).trim(),Da(a)?"":a.includes("WHAT HAPPENED")||a.includes("KEY POINTS")?a:Na(a)},$e=(e,a)=>kt(a||"")||kt(e.summary)||e.headline,_a=e=>{let r=e?.closest(".detail-summary, .thread-item, .market-thread-update")?.querySelector(".briefing-capture-area");if(!r||!window.html2canvas)return;let o=document.createElement("div");o.className="briefing-export-staging";let i=r.cloneNode(!0);i.classList.add("briefing-export-surface"),o.appendChild(i),document.body.appendChild(o);let s=document.documentElement.dataset.theme==="light";window.html2canvas(i,{backgroundColor:s?"#f5f7fb":"#0f172a",scale:2,logging:!1,useCORS:!0}).then(n=>{let l=document.createElement("a");l.download="siftle-briefing.png",l.href=n.toDataURL("image/png"),l.click(),window.showActionToast?.("Briefing card image downloaded!")}).catch(()=>{window.showActionToast?.("Unable to download briefing card")}).finally(()=>{o.remove()})};window.downloadBriefingCard=_a;var Ha=e=>e.toString().toLowerCase().trim().replace(/\s+/g,"-").replace(/[^\w\-]+/g,"").replace(/\-\-+/g,"-").replace(/^-+/,"").replace(/-+$/,""),Fa=(e,a)=>{let r="";if(a)try{r=decodeURIComponent(a)}catch{r=a}let o=window.location.origin,i=window.location.pathname,s=t.stories.find(d=>d.id===e||r&&d.sourceUrl===r),n=s?Ha(s.headline):e>0?`story-${e}`:"",l=e>0?`${o}/story/${n}?utm_source=briefing&url=${encodeURIComponent(s?.sourceUrl||r)}`:r?`${o}/api/redirect?url=${encodeURIComponent(r)}&source=briefing`:`${o}/story/briefing?utm_source=briefing`;navigator.clipboard.writeText(l).then(()=>{S("Shareable link copied to clipboard!")}).catch(()=>{S("Unable to copy link")})};window.copyBriefingLink=Fa;var Ht=(e,a)=>{let r=e.split(/(?:\*\*|__)?(WHAT HAPPENED|KEY POINTS|TAKEAWAY)\s*:?\s*(?:\*\*|__)?\s*:?\s*/i);if(r.length<=1)return`<p class="briefing-text">${e}</p>`;let o='<div class="briefing-capture-area">';if(a){let s=a.headline||"Football Match Update";o+=`
    ...
    `}r[0].trim()&&(o+=`<p class="briefing-capture-intro">${r[0].trim()}</p>`);let i="";for(let s=1;s<r.length;s+=2){let n=r[s].trim().toUpperCase(),l=r[s+1]?r[s+1].trim():"";if(!l)continue;let d="";if(n==="KEY POINTS"){let g=l.split(/(?:•|\*|-)\s+/).map(p=>p.replace(/\\n/g,"").trim()).filter(p=>{if(!p||p==="\\n"||p===`
`)return!1;let m=p.trim();return!(m.split(/\s+/).filter(Boolean).length<6||m.length<30||!/[.?!]"?'?$/.test(m)||/^according\s+to\s+\w+$/i.test(m.replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g,"")))});g.length>0?d=`<ul class="briefing-list">${g.map(p=>`<li>${p}</li>`).join("")}</ul>`:d=`<p class="briefing-text">${l}</p>`}else d=`<p class="briefing-text">${l}</p>`,n==="TAKEAWAY"&&(i=l);let c=n.toLowerCase().replace(/\s+/g,"-");o+=`
    ...
    `),o},Ye=e=>{let a=t.briefingStatusByUrl[e.sourceUrl]||"";return a?`<p class="briefing-status-note">${w(a)}</p>`:""},ja=()=>{let e=String(t.walletAddress||"").trim().toLowerCase();return/^0x[a-f0-9]{40}$/.test(e)?e:"guest"},ct=e=>`siftle_ai_briefing_unlock_${ja()}_${btoa(unescape(encodeURIComponent(e.sourceUrl))).replace(/=+$/g,"")}`,Ft=e=>localStorage.getItem(ct(e))||"",Ra=e=>{localStorage.removeItem(ct(e))},ue=e=>{let r=new URLSearchParams(window.location.search).get("url");return r&&r===e.sourceUrl?!0:!!Ft(e)},qa=(e,a)=>({id:0,headline:a.headline,category:e.category,summary:a.summary,source:a.source,sourceUrl:a.sourceUrl,imageUrl:e.imageUrl||"",publishedAt:void 0,readTime:"3 min read",postedAt:a.date,accent:"slate",saved:re.has(a.sourceUrl),ai_summary:void 0,ai_provider:void 0}),Wa=e=>{let a=t.stories.find(i=>i.sourceUrl===e);if(a)return a;let o=[t.activeThread?.current,...t.activeThread?.items??[]].filter(Boolean).find(i=>i.sourceUrl===e);if(o)return o;if(t.selectedMarketId){let i=E.find(s=>s.id===t.selectedMarketId);if(i){let s=Vt(i).evidence.find(n=>n.sourceUrl===e);if(s)return qa(i,s)}}return null},Ya=(e,a)=>{let r=rr(e,a);return r===null?null:r-It*60*1e3};var Ga=(e,a)=>{let r=Ya(e,a);return r===null?null:Date.now()>=r?`Locked ${It}m before kickoff`:null},Va=(e,a)=>{let r=t.unlockConfig?`${t.unlockConfig.amountUsdc} USDC`:"0.05 USDC",o=t.unlockConfig?.x402Enabled,i=!!t.walletAddress;return`
...
`,at=async(e,a=!1)=>{if(!t.walletAddress){S("Please sign in to unlock this briefing."),Ae();return}if(!(t.unlockingSummaryUrl===e.sourceUrl&&!a)){t.unlockingSummaryUrl=e.sourceUrl,t.briefingStatusByUrl[e.sourceUrl]="Preparing AI briefing payment...",P("ai_unlock_attempt"),b();try{let r=await fetch(B("/api/summary/unlock-config")),o=await r.json();if(!r.ok||!o.treasuryAddress)throw new Error(o.error||"AI briefing is not configured");let i=Number(o.amountUsdc)||.05;try{let p=await fetch(B(`/api/summary/price?sourceUrl=${encodeURIComponent(e.sourceUrl)}`));if(p.ok){let m=await p.json();typeof m.priceUsdc=="number"&&(i=m.priceUsdc)}}catch(p){console.warn("Failed to retrieve autonomous price, falling back to default:",p.message)}let s=await fa(o.treasuryAddress,i,p=>{U&&(U.textContent=p),t.briefingStatusByUrl[e.sourceUrl]=p,b()},{sourceUrl:e.sourceUrl,topic:e.headline});t.briefingStatusByUrl[e.sourceUrl]=`Briefing unlocked! Charged ${i} USDC (priced by Siftle AI Agent)`,b();let n=await fetch(B("/api/summary/unlock"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sourceUrl:e.sourceUrl,walletAddress:t.walletAddress,txHash:s})}),l=await n.json();if(!n.ok||!l.unlockToken)throw new Error(l.error||"AI briefing failed");localStorage.setItem(ct(e),l.unlockToken),P("ai_unlock_success");let d=sessionStorage.getItem("siftle_landing_url"),c=sessionStorage.getItem("siftle_landing_headline");d&&P("briefing_referral_unlock",d,c||void 0),(Number(l?.bonus?.points)||0)>0&&le(!1).catch(p=>console.error("Failed to refresh leaderboard bonus:",p)),await Te(e)}catch(r){P("ai_unlock_failed"),delete t.briefingStatusByUrl[e.sourceUrl];let o=r instanceof Error?r.message:String(r||""),i=o,s=o.toLowerCase();if(s.includes("session expired")||s.includes("sign in first")||s.includes("unauthorized")){try{(await D()).disconnectArcWallet()}catch{}t.walletAddress=null,t.walletBalance=null,i="Your session has expired. Please sign in again to unlock this briefing."}else(s.includes("balance")||s.includes("exceeds balance")||s.includes("transfer amount exceeds"))&&(i="Your USDC balance is too low to unlock this briefing. Please go to the Portfolio tab and click 'Claim Faucet' to get free testnet USDC.");S(i)}finally{t.unlockingSummaryUrl=null,b()}}},Te=async e=>{if(ue(e)&&!(t.aiSummaries[e.sourceUrl]||t.loadingSummaryUrl===e.sourceUrl)){if(e.ai_summary){t.aiSummaries[e.sourceUrl]=$e(e,e.ai_summary),P("view_summary"),U&&(U.textContent=e.ai_provider==="0g"?"Archived 0G summary loaded":"Archived summary loaded");let r=new URLSearchParams(window.location.search).get("url");if(r&&r===e.sourceUrl){let o=`siftle_unlock_tracked_${encodeURIComponent(e.sourceUrl)}`;sessionStorage.getItem(o)||(sessionStorage.setItem(o,"true"),P("briefing_unlock",e.sourceUrl,e.headline))}b();return}t.loadingSummaryUrl=e.sourceUrl,t.briefingStatusByUrl[e.sourceUrl]="Generating briefing through 0G...",b();try{let r=new URLSearchParams(window.location.search).get("url"),o=!!(r&&r===e.sourceUrl),i=await fetch(B("/api/summary"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...e,walletAddress:t.walletAddress,unlockToken:Ft(e),isSharedLanding:o})});if(!i.ok){if(i.status===402){Ra(e),delete t.aiSummaries[e.sourceUrl],delete t.aiSummaryProofs[e.sourceUrl],t.briefingStatusByUrl[e.sourceUrl]="AI briefing unlock expired. Unlock it again to generate a new briefing.",U&&(U.textContent="Unlock expired. Unlock again to continue."),b();return}throw new Error(`Summary request failed with ${i.status}`)}let s=await i.json();t.aiSummaries[e.sourceUrl]=$e(e,s.summary),t.aiSummaryProofs[e.sourceUrl]=s.proof,t.briefingStatusByUrl[e.sourceUrl]="AI briefing ready.",U&&s.provider&&(U.textContent=s.provider==="0g"?"Summary generated by 0G":`Summary loaded from ${s.provider}`);let l=new URLSearchParams(window.location.search).get("url");if(l&&l===e.sourceUrl){let d=`siftle_unlock_tracked_${encodeURIComponent(e.sourceUrl)}`;sessionStorage.getItem(d)||(sessionStorage.setItem(d,"true"),P("briefing_unlock",e.sourceUrl,e.headline))}}catch(a){console.warn(a),delete t.aiSummaries[e.sourceUrl],delete t.aiSummaryProofs[e.sourceUrl],t.briefingStatusByUrl[e.sourceUrl]="AI briefing unavailable. Retry to generate it again.",U&&(U.textContent="AI briefing failed. Retry available.")}finally{t.loadingSummaryUrl=null,b()}}},rt=(e,a=!1)=>{let r=t.stories.find(o=>o.id===e);if(r){if(t.feedScrollY=window.scrollY,t.selectedStoryId=r.id,t.selectedThreadUrl=null,t.activeThread=null,window.history.pushState({},"",`#story-${r.id}`),b(),r.type==="tweet"){window.scrollTo({top:0,behavior:"smooth"});return}a&&!ue(r)?(t.walletAddress&&(t.unlockingSummaryUrl=r.sourceUrl),b(),at(r,!0)):ue(r)&&Te(r),window.scrollTo({top:0,behavior:"smooth"})}},Ka=e=>{t.feedScrollY=window.scrollY,t.selectedStoryId=null,t.selectedThreadUrl=e.sourceUrl,t.activeThread=null,t.loadingThreadUrl=e.sourceUrl,window.history.pushState({},"",`#thread-${e.id}`),b(),qt(e),window.scrollTo({top:0,behavior:"smooth"})},Ja=()=>{t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,t.loadingThreadUrl=null,window.location.search?window.history.pushState({},"",window.location.pathname+"#feed"):window.history.pushState({},"","#feed"),b(),requestAnimationFrame(()=>window.scrollTo({top:t.feedScrollY,behavior:"auto"}))},qt=async e=>{try{let a=await fetch(B(`/api/thread?category=${encodeURIComponent(e.category)}&sourceUrl=${encodeURIComponent(e.sourceUrl)}`));if(!a.ok)throw new Error(`Thread request failed with ${a.status}`);t.activeThread=await a.json(),U&&(U.textContent=`${t.activeThread?.count??0} related updates found`)}catch(a){console.warn(a),t.activeThread=null,delete e.thread,t.selectedThreadUrl=null,window.history.replaceState({},"","#feed"),S("That timeline no longer has a verified past update"),U&&(U.textContent="Thread unavailable")}finally{t.loadingThreadUrl=null,b()}};function Pe(){let e=window.location.pathname.startsWith("/story/"),a=window.location.pathname.startsWith("/thread/");if(e||a){let o=window.location.pathname.split("/").pop()||"",i=e?`#story-${o}`:`#thread-${o}`;window.history.replaceState({},"",`${window.location.pathname}${window.location.search}${i}`)}if(window.location.hash==="#resolve-local-yes"){let o=E.find(i=>i.id==="siftle-local-test-2")||E.find(i=>i.timeframe==="Daily"&&ge(i).startsWith("0x00000000000000000000000000000000000001"));if(o){ha(ge(o)),pr(o,"yes"),delete t.marketSnapshots[o.id],delete t.marketPositions[o.id],delete t.checkedMarketSnapshots[o.id],delete t.loadingMarketSnapshots[o.id],t.hasLoadedPortfolioPositions=!1,t.activeSurface="portfolio",t.selectedMarketId=null,window.history.replaceState({},"","#portfolio"),S("Local test market resolved YES"),R().then(()=>{le(!0).catch(i=>console.error("Failed to report leaderboard entry:",i)),I(),O()});return}}let r=window.location.hash.match(/^#market-(.+)$/);if(window.location.hash==="#markets"||r){t.activeSurface="markets",t.selectedMarketId=r?.[1]??null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,b();return}if(window.location.hash==="#matches"){t.activeSurface="matches",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,b();return}if(window.location.hash==="#portfolio"){t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,b();return}if(window.location.hash==="#leaderboard"){t.activeSurface="leaderboard",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,b();return}if(window.location.hash==="#feed"||window.location.hash.startsWith("#story-")||window.location.hash.startsWith("#thread-")){t.activeSurface="feed";let o=window.location.hash.match(/^#story-(.+)$/),i=window.location.hash.match(/^#thread-(\d+)$/),n=new URLSearchParams(window.location.search).get("url"),l;if(n){sessionStorage.setItem("siftle_landing_url",n);let g=t.stories.find(m=>m.sourceUrl===n);g?.headline?sessionStorage.setItem("siftle_landing_headline",g.headline):sessionStorage.getItem("siftle_landing_headline")||sessionStorage.setItem("siftle_landing_headline","Archived Story");let p=`siftle_ref_tracked_${encodeURIComponent(n)}`;if(sessionStorage.getItem(p)||(sessionStorage.setItem(p,"true"),P("briefing_referral",n,g?.headline||"Archived Story")),l=t.stories.find(m=>m.sourceUrl===n),!l&&o){let m=n;t.loadingSummaryUrl!==m&&(t.loadingSummaryUrl=m,fetch(B(`/api/story?sourceUrl=${encodeURIComponent(m)}`)).then(v=>{if(!v.ok)throw new Error;return v.json()}).then(v=>{t.stories.some(f=>f.sourceUrl===v.sourceUrl)||(v.id=Math.max(9999,...t.stories.map(f=>f.id))+1,t.stories.push(v));let u=t.stories.find(f=>f.sourceUrl===v.sourceUrl);sessionStorage.setItem("siftle_landing_headline",u.headline),P("briefing_referral",n,u.headline),t.selectedStoryId=u.id,b(),Te(u)}).catch(v=>{console.warn("Failed to load historical story from backend:",v)}).finally(()=>{t.loadingSummaryUrl=null}))}}else if(o){let g=Number(o[1]);isNaN(g)||(l=t.stories.find(p=>p.id===g))}let d=i?t.stories.find(g=>g.id===Number(i[1])):void 0,c=t.selectedStoryId!==null||t.selectedThreadUrl!==null;l?(t.selectedStoryId=l.id,t.selectedThreadUrl=null,t.activeThread=null,b(),Te(l)):d?(t.selectedStoryId=null,t.selectedThreadUrl=d.sourceUrl,t.activeThread=null,b(),qt(d)):n||(t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,b(),c&&requestAnimationFrame(()=>window.scrollTo({top:t.feedScrollY,behavior:"auto"})));return}t.activeSurface="feed",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,b()}var ot=e=>{xt&&(xt.textContent=e)},Za=async(e=t.activeCategory,a=!1)=>{a||(t.activeSurface="feed",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,t.loadingThreadUrl=null,t.showSaved=!1),t.isLoading=!0,t.activeSurface==="feed"&&(Yt(),b());try{let r=t.activeArchiveDate?`/api/archive?date=${encodeURIComponent(t.activeArchiveDate)}&category=${encodeURIComponent(e)}`:`/api/feed?category=${encodeURIComponent(e)}`,o=await fetch(B(r));if(!o.ok)throw new Error(`Feed request failed with ${o.status}`);let i=await o.json();if(t.stories=i.top_stories??[],ke(),t.hasLoadedFeed=!0,tt&&(tt.textContent=_t(i.date??t.activeArchiveDate)),U)if(t.activeArchiveDate)U.textContent=`Showing ${e} from ${t.activeArchiveDate}`;else{let s=i.archive?.provider==="shelby"?"Shelby":"local archive";U.textContent=`Latest published feed loaded from ${s}`}ot(t.activeArchiveDate?`Archive: ${t.activeArchiveDate}`:"Live feed")}catch(r){console.warn(r),t.hasLoadedFeed||(t.stories=[]),ke(),U&&(U.textContent=t.activeArchiveDate?"That saved day/category is not available yet":"Feed data is currently unavailable. Please check back shortly.")}finally{t.isLoading=!1,b(),Pe()}},Xa=async()=>{if(H)try{let e=await fetch(B("/api/archive"));if(!e.ok)throw new Error(`Archive index failed with ${e.status}`);let a=await e.json(),r=new Date().toLocaleDateString("en-CA",{timeZone:"Africa/Lagos",year:"numeric",month:"2-digit",day:"2-digit"});t.archiveDates=(a.dates??[]).filter(o=>o.date!==r),H.innerHTML=['<option value="">Today</option>',...t.archiveDates.map(o=>`<option value="${o.date}">${o.date}</option>`)].join(""),H.value=t.activeArchiveDate??"",ot(t.archiveDates.length>0?"Saved days ready":"Live feed ready")}catch(e){console.warn(e),ot("Archive unavailable")}},Ce=()=>{yt||(yt=!0,Xa())},Z=(e=t.activeCategory,a=!1)=>{t.hasLoadedFeed&&e===t.activeCategory&&!t.activeArchiveDate||Za(e,a)},Qa=()=>{bt||(bt=!0,window.setTimeout(()=>{t.activeSurface!=="feed"&&!t.hasLoadedFeed&&Z(t.activeCategory,!0),Ce()},8e3))};var oe=e=>e==="Sports"?"Football":e,De=e=>/^@/.test(String(e.source||""))||/(?:^|\/)(?:x|twitter)\.com\//i.test(String(e.sourceUrl||"")),Wt=(e,a)=>{let r=e.trim();return r.length<=a?r:`${r.slice(0,Math.max(0,a-1)).trimEnd()}\u2026`},er=e=>e.replace(/^@/,"").replace(/[_-]+/g," ").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/\s+/g," ").trim().split(" ").filter(Boolean),it=e=>{let a=String(e.source||oe(e.category)).trim(),r=er(a);if(r.length===0)return oe(e.category);let o=r.filter((n,l)=>{let d=n.toLowerCase();return!(l>0&&["live","news","official"].includes(d))}),i=o.length>0?o:r,s="";for(let n of i){let l=s?`${s} ${n}`:n;if(l.length>18)break;s=l}return Wt(s||i[0],18)},St=e=>{let a=String(e.headline||"").replace(/\s+/g," ").trim();if(!De(e))return a;let r=a.replace(/https?:\/\/\S+/gi,"").replace(/\(Source:[^)]+\)\s*$/i,"").replace(/\s+/g," ").trim();if(/^R to\s+@[^:]+:\s*(?:more here|watch more here)[:.!?]*$/i.test(r))return`Latest from ${it(e)}`;let o=r.replace(/^R to\s+@[^:]+:\s*/i,"").trim(),i=o.length>=24&&!/^(?:more here|watch more here)[:.!?]*$/i.test(o)?o:r||a;return Wt(i,150)},Yt=()=>{if(!j)return;j.hidden=!1;let e=t.activeCategory==="Personalized";j.innerHTML=`
  ...
  `},Gt=e=>(e.thread?.count??0)>=1,tr=(e=0)=>`${e} past ${e===1?"update":"updates"}`,ar=(e=[])=>[...e].sort((a,r)=>{let o=new Date(a.publishedAt||0).getTime(),i=new Date(r.publishedAt||0).getTime();return(Number.isNaN(i)?0:i)-(Number.isNaN(o)?0:o)}),Vt=e=>{let a=t.marketEvidenceOverrides[e.id],r={...e,evidence:e.evidence??[]};return a?{...r,...a,updates:a.evidence.length}:r},rr=(e,a)=>{if(e.timeframe!=="Daily")return null;let r=e.kickoffAt?new Date(e.kickoffAt).getTime():Number.NaN;if(Number.isFinite(r))return r;let o=a?.closesAtUnix??0;return o>0?o*1e3:null};var ge=e=>e.optionMarket?e.id:e.marketAddress||window.SIFTLE_MARKET_ADDRESSES?.[e.id]||"",Kt=e=>Array.isArray(e.options)?e.options.filter(a=>a?.id&&a?.label):[],Jt=e=>!!((e?.optionMarket||e?.isOptionMarket||e?.marketType==="option"||Array.isArray(e?.options)&&e.options.length>0)&&Kt(e).length>1);var Zt=e=>e.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),w=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),pt=e=>`siftle_profile_username_${e.toLowerCase()}`,Xt=e=>e.trim().replace(/\s+/g," ").slice(0,15),ce=()=>{if(!t.walletAddress){t.profileUsername=null,t.profileNotice=null;return}let e=pt(t.walletAddress),a=localStorage.getItem(e),r=localStorage.getItem("siftle_profile_username");!a&&r&&(a=Xt(r),a&&localStorage.setItem(e,a),localStorage.removeItem("siftle_profile_username")),t.profileUsername=a||null,t.profileNotice=null},or=e=>{if(!t.walletAddress)return;let a=pt(t.walletAddress),r=Xt(e);r?(localStorage.setItem(a,r),t.profileUsername=r):(localStorage.removeItem(a),t.profileUsername=null),localStorage.removeItem("siftle_profile_username")},ir=()=>{let e="one-hour-test-market",a=[];for(let r=0;r<localStorage.length;r++){let o=localStorage.key(r);o&&o.includes(e)&&a.push(o)}a.forEach(r=>localStorage.removeItem(r))},sr=(e,a,r)=>{if(e==="sell"){let o=a==="yes"?r?.yesSharesUsdc??0:r?.noSharesUsdc??0;return o<=0?{min:.01,max:.01,fallback:.01}:{min:Math.min(.01,o),max:o,fallback:o}}return{min:2,max:2,fallback:2}},Ge=(e,a,r,o)=>{let{min:i,max:s,fallback:n}=sr(a,r,o);return Number.isFinite(e)?Math.min(s,Math.max(i,e)):n},nr=(e,a,r,o,i)=>{if(!e||!Number.isFinite(r)||r<=0)return 0;let s=a==="yes"?i?.yesSharesUsdc??0:i?.noSharesUsdc??0,n=e.yesSharesUsdc,l=e.noSharesUsdc;if(o==="sell")return Math.min(r,s);let d=(a==="yes"?n:l)+r,c=n+l+r;return d<=0||c<=0?r:(s+r)/d*c};var lr=e=>{let a=e?.yesSharesUsdc??0,r=e?.noSharesUsdc??0;return a>0&&r<=0?"yes":r>0&&a<=0?"no":null},Qt=e=>`siftle_claimed_markets_${e.toLowerCase()}`,ea=()=>{if(!t.walletAddress)return new Set;try{return new Set(JSON.parse(localStorage.getItem(Qt(t.walletAddress))||"[]"))}catch{return new Set}},dr=e=>{if(!t.walletAddress)return;let a=ea();a.add(e),localStorage.setItem(Qt(t.walletAddress),JSON.stringify(Array.from(a)))},ut=(e,a)=>(a?.outcome??0)!==0?!0:/^resolved$/i.test(String(e.closes||"").trim()),je=(e,a,r)=>{let o=r?.yesSharesUsdc??0,i=r?.noSharesUsdc??0;return e==="sell"?a==="yes"?o>0:i>0:a==="yes"?i<=0:o<=0},ta=(e,a,r)=>{if(je(e,a,r))return a;let o=a==="yes"?"no":"yes";return je(e,o,r)?o:a};var cr=e=>{let a=e instanceof Error?e.message:String(e||"");return/token|session|auth|unauthori[sz]ed|expired|401/i.test(a)};var aa=()=>{let e=0,a=0,r=0,o=E.filter(n=>n.timeframe==="Daily").map(n=>n.id),i=t.walletAddress?`siftle_resolved_results_${t.walletAddress.toLowerCase()}`:"",s={};if(i)try{s=JSON.parse(localStorage.getItem(i)||"{}")}catch{}if(t.walletAddress&&t.hasLoadedPortfolioPositions)for(let n of o){if(s[n]?.result==="win"){e+=Number(s[n].points)||0,a++;continue}if(s[n]?.result==="loss"){r++;continue}let l=t.marketPositions[n],c=t.marketSnapshots[n]?.outcome??0;if(c===0)continue;let g=`siftle_traded_sides_${n}_${t.walletAddress.toLowerCase()}`,p=[];try{p=JSON.parse(localStorage.getItem(g)||"[]")}catch{}let m=p.includes("yes")&&p.includes("no");if(c===1&&l&&l.yesSharesUsdc>0){let v=m?50:100;e+=v,a++,s[n]={result:"win",points:v}}else if(c===2&&l&&l.noSharesUsdc>0){let v=m?50:100;e+=v,a++,s[n]={result:"win",points:v}}else l&&(l.yesSharesUsdc>0||l.noSharesUsdc>0)&&(r++,s[n]={result:"loss",points:0})}return i&&localStorage.setItem(i,JSON.stringify(s)),{points:e,status:`${a} win${a===1?"":"s"}, ${r} loss${r===1?"":"es"}`}},pr=(e,a)=>{let r=ge(e).toLowerCase();if(!r)return;let o=`siftle_mock_pos_${r}_`,i=new Set;for(let s=0;s<localStorage.length;s++){let n=localStorage.key(s);if(!n||!n.startsWith(o))continue;let l=n.slice(o.length).toLowerCase();/^0x[a-f0-9]{40}$/.test(l)&&i.add(l)}i.forEach(s=>{let n=`${o}${s}`,l={yesSharesUsdc:0,noSharesUsdc:0};try{l=JSON.parse(localStorage.getItem(n)||"{}")}catch{}let d=(Number(l.yesSharesUsdc)||0)>0,c=(Number(l.noSharesUsdc)||0)>0;if(!d&&!c)return;let g=`siftle_traded_sides_${e.id}_${s}`,p=[];try{p=JSON.parse(localStorage.getItem(g)||"[]")}catch{}let m=p.includes("yes")&&p.includes("no"),v=a==="yes"?d:c,u=`siftle_resolved_results_${s}`,f={};try{f=JSON.parse(localStorage.getItem(u)||"{}")}catch{}f[e.id]={result:v?"win":"loss",points:v?m?50:100:0},localStorage.setItem(u,JSON.stringify(f));let h=0,x=0,L=0;Object.values(f).forEach(y=>{y.result==="win"?(x+=1,h+=Number(y.points)||0):y.result==="loss"&&(L+=1)});let T=localStorage.getItem(pt(s))||"";fetch(B("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:s,username:T,points:h,status:`${x} win${x===1?"":"s"}, ${L} loss${L===1?"":"es"}`})}).catch(y=>console.error("Failed to report local resolved score:",y))})},le=async e=>{if(!t.walletAddress)return!1;let a=e&&t.hasLoadedPortfolioPositions?aa():null,r=await fetch(B("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:t.walletAddress,username:t.profileUsername||"",...a?{points:a.points,status:a.status}:{}})}),o=await r.json().catch(()=>({}));if(!r.ok||o?.success===!1)throw new Error(o?.error||"Failed to save leaderboard profile");if(o?.supabaseConfigured&&o?.supabaseSaved===!1)throw new Error(o?.supabaseError||"Supabase did not save profile");return!0},ur=()=>{let e=new Set;for(let a=0;a<localStorage.length;a++){let r=localStorage.key(a);if(r&&r.startsWith("siftle_mock_pos_")){let o=r.slice(r.lastIndexOf("_")+1).toLowerCase();try{let i=JSON.parse(localStorage.getItem(r)||"{}");((Number(i.yesSharesUsdc)||0)>0||(Number(i.noSharesUsdc)||0)>0)&&/^0x[a-f0-9]{40}$/.test(o)&&e.add(o)}catch{}}}e.forEach(a=>{fetch(B("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:a})}).catch(r=>console.error("Failed to report stored local trader:",r))})};function Re(e){let a=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}${r}${o}`}function qe(e){if(!e)return"Soccer Matches";let a=e.replace(/^\d{4}(-\d{2,4})?-/g,"").replace(/-/g," ").trim(),r=a.toLowerCase();return r.includes("russian")||r.includes("rus.1")?"Russian Premier League":r.includes("scottish")||r.includes("sco.1")?"Scottish Premiership":r.includes("ukrainian")||r.includes("ukr.1")?"Ukrainian Premier League":r.includes("egyptian")||r.includes("egy.1")?"Egyptian Premier League":r.includes("english premier league")||r.includes("premier league")||r.includes("eng.1")||r.includes("eng 1")?"English Premier League":r.includes("laliga")||r.includes("esp.1")||r.includes("esp 1")||r.includes("spanish")?"Spanish LaLiga":r.includes("champions league")||r.includes("uefa champions")?"UEFA Champions League":r.includes("europa league")||r.includes("uefa europa")?"UEFA Europa League":r.includes("championship")||r.includes("eng.2")||r.includes("eng 2")?"EFL Championship":r.includes("serie a")||r.includes("ita.1")||r.includes("ita 1")||r.includes("italian")?"Italian Serie A":r.includes("bundesliga")||r.includes("ger.1")||r.includes("ger 1")||r.includes("german")?"German Bundesliga":r.includes("ligue 1")||r.includes("fra.1")||r.includes("fra 1")||r.includes("french")?"French Ligue 1":r.includes("saudi")||r.includes("sau.1")||r.includes("sau 1")?"Saudi Pro League":r.includes("eredivisie")||r.includes("ned.1")?"Dutch Eredivisie":r.includes("primeira liga")||r.includes("por.1")?"Portuguese Primeira Liga":r.includes("friendly")||r.includes("friendlies")?"Club Friendlies":a.split(" ").map(o=>o?o.charAt(0).toUpperCase()+o.slice(1).toLowerCase():"").join(" ").trim()}var ra=async e=>{let a=Re(new Date),r=e||t.activeMatchDate||a;if(!(t.loadingLiveMatches&&r===t.activeMatchDate&&t.liveMatches.length>0)){t.loadingLiveMatches=!0,t.activeMatchDate=r;try{let o=Re(new Date),i=e||t.activeMatchDate||o;t.activeMatchDate=i;let s=`?dates=${i}`,n=[`https://site.api.espn.com/apis/site/v2/sports/soccer/eng.1/scoreboard${s}`,`https://site.api.espn.com/apis/site/v2/sports/soccer/uefa.champions/scoreboard${s}`,`https://site.api.espn.com/apis/site/v2/sports/soccer/esp.1/scoreboard${s}`,`https://site.api.espn.com/apis/site/v2/sports/soccer/eng.2/scoreboard${s}`,`https://site.api.espn.com/apis/site/v2/sports/soccer/ita.1/scoreboard${s}`,`https://site.api.espn.com/apis/site/v2/sports/soccer/ger.1/scoreboard${s}`,`https://site.api.espn.com/apis/site/v2/sports/soccer/sau.1/scoreboard${s}`,`https://site.api.espn.com/apis/site/v2/sports/soccer/all/scoreboard${s}`],l=await Promise.allSettled(n.map(c=>fetch(c).then(g=>g.json()))),d=new Map;l.forEach(c=>{if(c.status==="fulfilled"&&c.value&&Array.isArray(c.value.events)){let g=c.value.leagues?.[0]?.name,p=c.value.leagues?.[0]?.logos?.[0]?.href||"",m=g&&g!=="Soccer"?g:null;c.value.events.forEach(v=>{if(!v||!v.id||d.has(v.id))return;let u=v.competitions?.[0],f=u?.competitors?.find($=>$.homeAway==="home"),h=u?.competitors?.find($=>$.homeAway==="away");if(!f||!h)return;let x=v.status?.type?.state,L=v.status?.type?.detail||v.status?.type?.shortDetail||"Scheduled",T=m||v.season?.slug||v.league?.name||"Soccer Scoreboard",y=qe(T);d.set(v.id,{id:v.id,name:v.name,league:y,leagueLogo:p,statusState:x,statusDetail:L,isLive:x==="in",isPost:x==="post",homeTeam:f.team?.displayName||f.team?.name||"Home",awayTeam:h.team?.displayName||h.team?.name||"Away",homeCrest:f.team?.logo||"https://a.espncdn.com/i/teamlogos/soccer/500/default-team-logo.png",awayCrest:h.team?.logo||"https://a.espncdn.com/i/teamlogos/soccer/500/default-team-logo.png",homeScore:f.score??null,awayScore:h.score??null,venue:u?.venue?.fullName||"Stadium",date:v.date})})}}),t.liveMatches=Array.from(d.values())}catch(o){console.error("Failed to fetch ESPN live matches:",o)}finally{t.loadingLiveMatches=!1}}},R=async(e={})=>{if(t.walletAddress&&!(t.loadingPortfolioPositions&&!e.force)){t.hasLoadedPortfolioPositions=!1,t.loadingPortfolioPositions=!0;try{t.portfolioMarketPreviews.length===0&&await Pa();let a=Le(),r=await Promise.all(a.map(async o=>{let i=ge(o);if(!i)return[o.id,{yesSharesUsdc:0,noSharesUsdc:0}];try{let{position:s,snapshot:n}=await va(i,t.walletAddress);return t.marketSnapshots[o.id]=n,[o.id,s]}catch(s){return console.warn(`Failed to load portfolio market ${o.id}:`,s),[o.id,{yesSharesUsdc:0,noSharesUsdc:0}]}}));t.marketPositions=Object.fromEntries(r),t.portfolioPositionsLoadedAt=Date.now()}catch(a){console.warn(a)}finally{t.loadingPortfolioPositions=!1,t.hasLoadedPortfolioPositions=!0,le(!0).catch(a=>console.error("Failed to report leaderboard entry:",a)),(t.activeSurface==="portfolio"||t.activeSurface==="leaderboard"||t.activeSurface==="markets")&&b()}}},gr=async(e,a)=>{if(!t.walletAddress){S("Session expired or wallet not connected. Please sign in."),Ae();return}let r=Le().find(c=>c.id===e);if(!r)return;t.marketTradeSide=a;let o=ge(r);if(!o){S("Deploy this Arc market contract before trading"),b();return}if(!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",b(),await R(),t.marketTradeStatus=null),!t.hasLoadedPortfolioPositions){S("Still loading your position. Try again in a moment."),b();return}let i=t.marketSnapshots[r.id];if(ut(r,i)){t.tradeDrawerOpen=!1,S("This market is resolved and can no longer be traded."),b();return}let s=i?.yesPriceCents??r.probability,n=i?.noPriceCents??100-r.probability,l=t.marketPositions[r.id]||{yesSharesUsdc:0,noSharesUsdc:0};if(!je(t.marketOrderMode,a,l)){let c=lr(l),g=t.marketOrderMode==="sell"?c?`You can only exit your ${c.toUpperCase()} shares.`:"You do not have shares to exit in this market.":c?`Exit your ${c.toUpperCase()} shares before buying the other side.`:"You cannot buy both sides in the same market.";S(g),t.marketTradeSide=ta(t.marketOrderMode,a,l),b();return}let d=Ge(Number(t.marketTradeAmount)||0,t.marketOrderMode,a,l);t.marketTradeAmount=d,P("trade_attempt");try{t.marketTradeStatus="Preparing transaction...",b();let c=await ya(o,t.marketOrderMode,a,d,g=>{t.marketTradeStatus=g,b()},s,n);if(delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],delete t.loadingMarketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await He(),t.walletAddress&&(t.walletBalance=await ae(t.walletAddress)),await R({force:!0}),le(!0).catch(g=>console.error("Failed to report leaderboard entry:",g)),t.walletAddress){let g=`siftle_cost_basis_${r.id}_${t.walletAddress.toLowerCase()}`,p={yesCost:0,noCost:0,yesShares:0,noShares:0};try{let v=localStorage.getItem(g);if(v){let u=JSON.parse(v);p={yesCost:u.yesCost||0,noCost:u.noCost||0,yesShares:u.yesShares||0,noShares:u.noShares||0}}}catch{}let m=d;if(t.marketOrderMode==="buy"){let v=`siftle_traded_sides_${r.id}_${t.walletAddress.toLowerCase()}`,u=[];try{u=JSON.parse(localStorage.getItem(v)||"[]")}catch{}u.includes(a)||(u.push(a),localStorage.setItem(v,JSON.stringify(u))),a==="yes"?(p.yesCost+=m,p.yesShares=(p.yesShares||0)+m/(s/100)):(p.noCost+=m,p.noShares=(p.noShares||0)+m/(n/100))}else{let v=t.marketPositions[r.id];if(v){if(a==="yes"&&v.yesSharesUsdc>0){let u=Math.min(1,m/v.yesSharesUsdc);p.yesCost=Math.max(0,p.yesCost-p.yesCost*u),p.yesShares=Math.max(0,(p.yesShares||0)-(p.yesShares||0)*u)}else if(a==="no"&&v.noSharesUsdc>0){let u=Math.min(1,m/v.noSharesUsdc);p.noCost=Math.max(0,p.noCost-p.noCost*u),p.noShares=Math.max(0,(p.noShares||0)-(p.noShares||0)*u)}}}localStorage.setItem(g,JSON.stringify(p))}S(`Trade confirmed ${c.slice(0,8)}...`),P(t.marketOrderMode==="buy"?"trade_buy_success":"trade_sell_success"),Oa(t.marketOrderMode,t.marketTradeAmount,a.toUpperCase(),r.question)}catch(c){P("trade_failed"),cr(c)?(Et(),t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ce(),S("Session expired. Please sign in again.")):S(c instanceof Error?c.message:"Arc trade failed")}finally{t.marketTradeStatus=null,I(),b()}},mr=e=>Gt(e)?`<button class="card-source-button thread-button" type="button" data-thread-story-id="${e.id}">Thread (${e.thread?.count})</button>`:"",fr=e=>Gt(e)?`<button class="mobile-action-btn thread-btn" type="button" data-thread-story-id="${e.id}">Thread</button>`:"";var gt=e=>`<span class="skeleton-aria-label" role="status" aria-live="polite">${e}</span>`,hr=()=>`
...
`,vr=(e=4)=>`${gt("Loading stories")}${Array.from({length:e},hr).join("")}`,We=()=>`
  <div class="detail-summary-skeleton" aria-hidden="true">
    ${gt("Loading AI briefing")}
...
`;var Qe=e=>{let a=e.type==="tweet",r='<svg class="x-logo-svg" viewBox="0 0 24 24" fill="currentColor" style="width: 14px; height: 14px; display: inline-block; vertical-align: text-top; color: var(--color-text-primary);"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>',o='<svg class="x-logo-svg" viewBox="0 0 24 24" fill="currentColor" style="width: 12px; height: 12px; display: inline-block; vertical-align: text-top; margin-right: 4px;"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>';return`
    <article class="story-card ${a?"social-story tweet-card":De(e)?"social-story":""}" data-story-id="${e.id}" role="button" tabindex="0" aria-label="Open summary for ${e.headline}">
      ...
      <div class="story-copy desktop-only">
        <span class="category-chip ${e.category}">${oe(e.category)}</span>
  ...
  `},me=()=>{if(!k)return;if(k.hidden=!!(t.selectedStoryId||t.selectedThreadUrl),t.isLoading){k.innerHTML=vr(4);return}if(V){k.innerHTML=Or(),ee();return}let e=w(t.newsSearchQuery.trim()),r=`
  ...
  `;if(t.activeCategory==="Personalized"){let i=Ee(),s=ca(),n=[...i.clubs,...i.players,...i.managers].join(", ");if(!s){k.innerHTML=`
      ...
      `,document.querySelector("#openTopicPickerBtn")?.addEventListener("click",_e),ee();return}let l=Xe(),d=`
...
`},Tr=async(e,a)=>{if(!t.walletAddress){S("Session expired or wallet not connected. Please sign in."),Ae();return}let r=Le().find(c=>c.id===e);if(!r||!Jt(r))return;let o=Kt(r).find(c=>c.id===a);if(!o){S("Choose a valid option.");return}!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",b(),await R(),t.marketTradeStatus=null);let i=t.marketSnapshots[r.id];if(ut(r,i)){S("This market is resolved and can no longer be traded.");return}let s=t.marketPositions[r.id],n=t.marketOrderMode==="sell";if(!n&&s?.optionId){S("Your pick is already locked for this market.");return}if(n&&!s?.optionId){S("You do not have a pick to exit.");return}let l=Math.max(0,Number(s?.optionSharesUsdc)||0);if(n&&l<=0){S("Your pick is still loading. Please try again."),await R({force:!0});return}let d=n?l:Ge(Number(t.marketTradeAmount)||0,"buy","yes",void 0);t.marketTradeAmount=d,t.marketTradeOptionId=n&&s?.optionId||o.id,P("trade_attempt");try{t.marketTradeStatus=n?"Exiting your pick...":"Locking your pick...",b(),await et(r.id,n?"sell":"buy",n&&s?.optionId||o.id,d,c=>{t.marketTradeStatus=c,b()}),delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await He(),t.walletAddress&&(t.walletBalance=await ae(t.walletAddress)),await R({force:!0}),P(n?"trade_sell_success":"trade_buy_success"),S(n?"Pick exited":`Pick locked: ${o.label}`),t.tradeDrawerOpen=!1}catch(c){P("trade_failed"),S(c instanceof Error?c.message:"Trade failed")}finally{t.marketTradeStatus=null,I(),b()}},Mr=()=>{if(!M||!k)return;let e=t.stories.find(o=>o.sourceUrl===t.selectedThreadUrl);if(k.hidden=!0,M.hidden=!1,M.classList.add("fullscreen"),document.body.classList.add("detail-mode"),!e){M.innerHTML="";return}let a=t.loadingThreadUrl===e.sourceUrl,r=t.activeThread;if(a&&!r){M.innerHTML=`
  ...
  `},Lr=()=>{if(!M||!k)return;if(t.selectedThreadUrl){Mr();return}let e=t.stories.find(n=>n.id===t.selectedStoryId);if(!e){M.hidden=!0,M.classList.remove("fullscreen"),document.body.classList.remove("detail-mode"),k.hidden=!1;return}if(e.type==="tweet"){k.hidden=!0,M.hidden=!1,M.classList.add("fullscreen"),document.body.classList.add("detail-mode");let n='<svg class="x-logo-svg" viewBox="0 0 24 24" fill="currentColor" style="width: 16px; height: 16px; display: inline-block; vertical-align: text-top; margin-right: 6px;"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>';M.innerHTML=`
    ...
    `;return}let a=$e(e,t.aiSummaries[e.sourceUrl]),r=t.loadingSummaryUrl===e.sourceUrl,o=ue(e),i=t.unlockingSummaryUrl===e.sourceUrl,s=jt(e);k.hidden=!0,M.hidden=!1,M.classList.add("fullscreen"),document.body.classList.add("detail-mode"),M.innerHTML=`
  ...
  `};var Ar=e=>{let a=Vt(e),o=t.marketSnapshots[e.id]?.yesPriceCents??e.probability,i=100-o,s=a.evidence[0],n=s?s.headline:"No updates yet",l=`${window.location.origin}${window.location.pathname}#market-${e.id}`;return`\u{1F6A8} *Siftle Market Alert* \u{1F6A8}
...
Trade and discuss here: ${l}`};var Wr=e=>{if(!e)return!1;if(e.isLocked===!0)return!0;let a=String(e.statusDetail||"").toLowerCase();if(a.includes("ft")||a.includes("final")||a.includes("ended")||a.includes("finished")||a.includes("resolved")||a.includes("postponed")||a.includes("locked")||String(e.closes||"").toLowerCase()==="resolved")return!0;if(e.isLive){let r=a.match(/([0-9]{1,3})/);if(r){let o=parseInt(r[1],10);if(!isNaN(o)&&o>=75)return!0}}return!1},ze=(()=>{try{let e=localStorage.getItem("siftle_global_odds");return e?JSON.parse(e):{}}catch{return{}}})(),G=e=>{let a=String(e?.id||"");if(ze[a])return{home:String(Number(ze[a].home).toFixed(1)),draw:String(Number(ze[a].draw).toFixed(1)),away:String(Number(ze[a].away).toFixed(1))};let r=Number(e?.homePoolUsdc)||Number(e?.optionPools?.home)||Number(e?.initialOptionPools?.home)||0,o=Number(e?.drawPoolUsdc)||Number(e?.optionPools?.draw)||Number(e?.initialOptionPools?.draw)||0,i=Number(e?.awayPoolUsdc)||Number(e?.optionPools?.away)||Number(e?.initialOptionPools?.away)||0,s=r+o+i;return s>0?{home:(r/s*100).toFixed(1),draw:(o/s*100).toFixed(1),away:(i/s*100).toFixed(1)}:e&&e.currentOdds?{home:String(Number(e.currentOdds.home).toFixed(1)),draw:String(Number(e.currentOdds.draw).toFixed(1)),away:String(Number(e.currentOdds.away).toFixed(1))}:e&&e.customOdds?{home:String(Number(e.customOdds.home).toFixed(1)),draw:String(Number(e.customOdds.draw).toFixed(1)),away:String(Number(e.customOdds.away).toFixed(1))}:{home:"33.3",draw:"33.3",away:"33.3"}},ie=()=>{if(!E||E.length===0?E=de:E=zt(de,E),!k||!M)return;fe?.toggleAttribute("hidden",!0),he?.toggleAttribute("hidden",!0),j?.toggleAttribute("hidden",!0),J?.classList.add("active"),se?.classList.remove("active"),ne?.classList.remove("active"),document.body.classList.remove("detail-mode"),M.hidden=!0,M.classList.remove("fullscreen"),k.hidden=!1,k.classList.remove("matches-surface-active");let e=t.activeMarketLeagueFilter||"All";E=E.filter(i=>{let s=(i.id+" "+i.question+" "+(i.homeTeam||"")+" "+(i.awayTeam||"")).toLowerCase();return!["coventry","nizhny","chertanova","dinamo moscow","spartak moscow"].some(n=>s.includes(n))});let a=E.find(i=>i.id==="m-chelsea-manutd")||E[0],r=[{id:"All",label:"All"},{id:"Premier League",label:"Premier League (EPL)"},{id:"La Liga",label:"La Liga"},{id:"Serie A",label:"Serie A"},{id:"Bundesliga",label:"Bundesliga"},{id:"Ligue 1",label:"Ligue 1"},{id:"Primeira Liga",label:"Primeira Liga"},{id:"Eredivisie",label:"Eredivisie"}],o=E.filter(i=>{if(e==="All")return!0;let s=(i.league||"").toLowerCase(),n=e.toLowerCase();return n.includes("premier")||n.includes("epl")?s.includes("premier")||s.includes("eng"):n.includes("la liga")||n.includes("laliga")?s.includes("laliga")||s.includes("la liga")||s.includes("spanish"):n.includes("serie a")?s.includes("serie a")||s.includes("italian"):n.includes("bundesliga")?s.includes("bundesliga")||s.includes("german"):n.includes("ligue 1")||n.includes("ligue")?s.includes("ligue 1")||s.includes("french"):n.includes("primeira")||n.includes("portuguese")?s.includes("primeira")||s.includes("portuguese"):n.includes("eredivisie")||n.includes("dutch")?s.includes("eredivisie")||s.includes("dutch"):s.includes(n)});k.innerHTML=`
    <section class="markets-surface-redesign" style="padding: 12px 6px 110px 6px; width: 100%; max-width: 100%; box-sizing: border-box; overflow-x: hidden; font-family: -apple-system, BlinkMacSystemFont, 'Inter', 'Segoe UI', Roboto, sans-serif; color: var(--ink);">
      ...
      <div style="display: flex; flex-direction: column; gap: 18px;">
        ...
        <!-- Market Cards -->
        ${o.map((i,s)=>{let n=i.homeTeam||"Brentford",l=i.awayTeam||"Spurs",d=i.homeCrest||"https://a.espncdn.com/i/teamlogos/soccer/500/337.png",c=i.awayCrest||"https://a.espncdn.com/i/teamlogos/soccer/500/367.png",g=!!i.isLive;return`
            <div class="thick-league-card" data-market-id="${i.id}" style="background: var(--paper); border: 1px solid var(--border); border-radius: 20px; padding: 18px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.4);">
              ...
              <!-- Card Header Status -->
              <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 14px;">
                <span style="font-size: 0.78rem; font-weight: 800; padding: 4px 10px; border-radius: 8px; ${g?"background: rgba(239, 68, 68, 0.2); color: #ef4444; border: 1px solid rgba(239, 68, 68, 0.4);":"background: rgba(255, 255, 255, 0.06); color: var(--muted);"}">
                  ${g?"\u{1F534} LIVE IN-PLAY \u26A1":w(i.statusDetail||"Scheduled")}
                </span>
  ...
  `;let e=document.getElementById("leaderboardListContainer");fetch(B("/api/leaderboard/preseason")).then(a=>a.json()).then(a=>{let r=a.players||[];e&&(e.innerHTML=r.length===0?'<p style="color: var(--muted); text-align: center; padding: 32px 0; font-weight: 600;">No players on Season 2 rankings yet. Make a prediction or unlock a briefing to join!</p>':r.map((o,i)=>{let s=i+1,n=String(o.username||""),l=!!(t.walletAddress&&n.toLowerCase()===t.walletAddress.toLowerCase()),d=l&&t.profileUsername?t.profileUsername:o.displayName||n,c=l?`${t.profileUsername?d:we(n)} (You)`:d.startsWith("0x")&&d.length===42?we(d):d,g=w(c),p=Number(o.points)||0,m=s===1?'<span style="width: 26px; height: 26px; border-radius: 50%; background: #fbbf24; color: #000; font-weight: 900; display: inline-flex; align-items: center; justify-content: center; font-size: 0.82rem;">1</span>':s===2?'<span style="width: 26px; height: 26px; border-radius: 50%; background: #94a3b8; color: #000; font-weight: 900; display: inline-flex; align-items: center; justify-content: center; font-size: 0.82rem;">2</span>':s===3?'<span style="width: 26px; height: 26px; border-radius: 50%; background: #d97706; color: #000; font-weight: 900; display: inline-flex; align-items: center; justify-content: center; font-size: 0.82rem;">3</span>':`<span style="width: 26px; height: 26px; border-radius: 50%; background: rgba(255,255,255,0.06); color: var(--muted); font-weight: 800; display: inline-flex; align-items: center; justify-content: center; font-size: 0.82rem;">${s}</span>`;return`
              ...
              `}).join(""))}).catch(a=>{console.error("Failed to load Season 2 leaderboard:",a),e&&(e.innerHTML='<p style="color: var(--muted); text-align: center; padding: 24px 0;">Error loading Season 2 rankings. Please refresh.</p>')})},na=()=>{t.activeSurface="feed",t.selectedMarketId=null,fe?.toggleAttribute("hidden",!0),he?.toggleAttribute("hidden",!0),j?.toggleAttribute("hidden",!0),J?.classList.remove("active"),se?.classList.add("active"),ne?.classList.remove("active"),k?.classList.remove("markets-list")};var At=e=>{let a=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0,optionSharesUsdc:0},r=t.marketSnapshots[e.id],o=e.homeTeam||"Home Team",i=e.awayTeam||"Away Team",s=e.homeCrest||"https://a.espncdn.com/i/teamlogos/soccer/500/default-team-logo.png",n=e.awayCrest||"https://a.espncdn.com/i/teamlogos/soccer/500/default-team-logo.png",l=a.optionSharesUsdc||a.yesSharesUsdc||1,d=a.optionLabel||(a.optionId==="home"?o:a.optionId==="away"?i:a.optionId==="draw"?"Draw":"Your Pick"),c=a.projectedPayout||(l>0?l*2.22:2.22),g=Math.max(0,c-l),p=(c/(l||1)).toFixed(2),m=r?.resolvedOptionId||null,v=!!m,u=v&&a.optionId===m;return`
  ...
  `},Cr=async e=>{if(!t.walletAddress){S("Please sign in first.");return}let a=Le().find(o=>o.id===e),r=a?ge(a):"";if(!a||!r){S("Market is not available.");return}try{t.claimingMarketIds[a.id]=!0,O(),P("claim_attempt"),aa();let o=await ba(r,t.walletAddress);P("claim_success"),o.won&&dr(a.id),delete t.marketPositions[a.id],delete t.marketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.walletBalance=await ae(t.walletAddress),await R(),S(o.won?`Claimed $${Zt(o.amountUsdc)}`:"No payout to claim"),I(),O()}catch(o){P("claim_failed"),S(o instanceof Error?o.message:"Claim failed")}finally{delete t.claimingMarketIds[a.id],O()}};var la=async e=>{try{let a=await fetch(`https://site.api.espn.com/apis/site/v2/sports/soccer/all/summary?event=${e}`);return a.ok?await a.json():null}catch(a){return console.error("Failed to fetch ESPN match summary:",a),null}};var nt=0;window.openSiftleMatchModal=async e=>{console.log("Global openSiftleMatchModal called for id:",e);let a=t.liveMatches.find(C=>String(C.id)===String(e))||{id:e,homeTeam:"Home",awayTeam:"Away",homeCrest:"https://a.espncdn.com/i/teamlogos/soccer/500/default-team-logo.png",awayCrest:"https://a.espncdn.com/i/teamlogos/soccer/500/default-team-logo.png",homeScore:0,awayScore:0,statusDetail:"Live",league:"Soccer Match",isLive:!0},r=document.getElementById("matchDetailModalOverlay");r&&r.remove(),r=document.createElement("div"),r.id="matchDetailModalOverlay",r.style.cssText="position: fixed; inset: 0; z-index: 999999; background: rgba(3, 7, 18, 0.88); backdrop-filter: blur(12px); display: flex; justify-content: center; align-items: flex-end; padding: 0;";let o=a.isLive,i=a.isPost,s=o?"background: rgba(239, 68, 68, 0.2); color: #ef4444; border: 1px solid rgba(239, 68, 68, 0.4);":i?"background: rgba(148, 163, 184, 0.15); color: var(--muted); border: 1px solid rgba(148, 163, 184, 0.2);":"background: rgba(59, 130, 246, 0.15); color: #60a5fa; border: 1px solid rgba(59, 130, 246, 0.3);";r.innerHTML=`
  ...
  `,document.body.appendChild(r),r.addEventListener("click",C=>{C.target===r&&r.remove()});let n=await la(e),l=document.getElementById("matchModalContent");if(!l)return;if(!n){l.innerHTML='<div style="text-align: center; color: var(--muted); padding: 32px 0;">Match statistics and commentary currently loading or unavailable for this fixture.</div>';return}let d=n.boxscore?.teams||[],c=d[0]?.statistics||[],g=d[1]?.statistics||[],p=(C,F)=>{let N=C.find(z=>z.label?.toLowerCase()===F.toLowerCase()||z.name?.toLowerCase()===F.toLowerCase());return N?N.displayValue:"-"},m=p(c,"possession")!=="-"?p(c,"possession")+"%":"50%",v=p(g,"possession")!=="-"?p(g,"possession")+"%":"50%",u=p(c,"shots"),f=p(g,"shots"),h=p(c,"on goal"),x=p(g,"on goal"),L=p(c,"corner kicks"),T=p(g,"corner kicks"),y=parseFloat(m)||50,$=parseFloat(v)||50;l.innerHTML=`
    ...
    <div style="background: rgba(255, 255, 255, 0.03); border: 1px solid var(--border); border-radius: 16px; padding: 16px;">
      ...
      <div style="display: flex; align-items: flex-end; height: 36px; gap: 3px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 6px;">
        ${Array.from({length:24}).map((C,F)=>{let N=Math.floor(Math.sin(F*.7)*14)+16,z=F%2===0;return`<div style="flex: 1; height: ${N}px; background: ${z?"#3b82f6":"#34d399"}; border-radius: 2px; opacity: 0.85;"></div>`}).join("")}
      </div>
    </div>
  ...
  `,document.body.appendChild(r),r.querySelector("#closeSuccessModalBtn")?.addEventListener("click",()=>{r.remove(),ie(),window.scrollTo({top:nt,behavior:"instant"})}),r.addEventListener("click",o=>{o.target===r&&(r.remove(),ie(),window.scrollTo({top:nt,behavior:"instant"}))})};window.openSiftleBettingModal=(e,a,r)=>{r&&(r.preventDefault(),r.stopPropagation()),nt=window.scrollY;let o=E.find(f=>f.id===e)||E[0]||{id:e,question:"Crystal Palace vs Manchester City",homeTeam:"Crystal Palace",awayTeam:"Manchester City",homeCrest:"https://a.espncdn.com/i/teamlogos/soccer/500/384.png",awayCrest:"https://a.espncdn.com/i/teamlogos/soccer/500/382.png"},i=a,s=G(o),n=parseFloat(s.home)||33.3;a==="home"?(i=o.homeTeam||"Home",n=parseFloat(s.home)||33.3):a==="away"?(i=o.awayTeam||"Away",n=parseFloat(s.away)||33.3):a==="draw"&&(i="Draw",n=parseFloat(s.draw)||33.3);let l=document.getElementById("siftleBettingModalOverlay");l&&l.remove(),l=document.createElement("div"),l.id="siftleBettingModalOverlay",l.style.cssText="position: fixed; inset: 0; z-index: 9999999; background: rgba(0, 0, 0, 0.8); backdrop-filter: blur(10px); display: flex; justify-content: center; align-items: flex-end; padding: 0; box-sizing: border-box;";let d="BUY",c=2,g=t.marketPositions[o.id],p=g&&(g.optionSharesUsdc||g.yesSharesUsdc)||0,m=t.walletAddress?t.walletBalance?`${parseFloat(String(t.walletBalance).replace(/,/g,"")).toFixed(2)} USDC`:"0.00 USDC":"$0.00 USDC",v=f=>{let h=Number(o.volumeUsdc)||0,x=Number(o[`${a}PoolUsdc`])||(h>0?h*.333:0),L=h+f,T=x+f;return T>0?f/T*L:f},u=()=>{let f=v(c),h=(f/(c||1)).toFixed(2),x=p.toFixed(2);l.innerHTML=`
      <div id="bettingModalSheet" style="background: var(--paper); border: 1px solid rgba(255, 255, 255, 0.12); border-top-left-radius: 28px; border-top-right-radius: 28px; width: 100%; max-width: 600px; padding: 24px 20px 36px 20px; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Inter', sans-serif; box-shadow: 0 -16px 48px rgba(0,0,0,0.95); animation: slideUp 0.25s ease-out; color: var(--ink); pointer-events: auto;">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px; padding-bottom: 16px; border-bottom: 1px solid rgba(255,255,255,0.06);">
          ...
          <div style="text-align: right;">
            ...
            <div style="font-size: 0.9rem; font-weight: 800; color: #38bdf8;">${d==="BUY"?m:`$${p.toFixed(2)} Shares`}</div>
          </div>
        </div>
    ...
    `;let L=(y,$=!1)=>{let C=parseInt(y,10);c=y.trim()===""||isNaN(C)?0:Math.max(0,C);let N=l.querySelector("#tradeAmountInput");N&&$&&(N.value=c>0?String(c):"");let z=l.querySelector("#toWinAmountLabel");if(c>0){let A=v(c),W=(A/c).toFixed(2);z&&(z.textContent=`${A.toFixed(2)} USDC (${W}x)`)}else z&&(z.textContent="$0.00 USDC (1.00x)");let q=l.querySelector("#confirmTradeBtn");q&&(q.textContent=c>0?`Buy Shares (${c} USDC)`:"Enter Amount",q.disabled=c<=0),l.querySelectorAll(".quick-amt-btn").forEach(A=>{Number(A.getAttribute("data-amt"))===c?(A.style.background="rgba(56, 189, 248, 0.2)",A.style.borderColor="#38bdf8",A.style.color="#38bdf8"):(A.style.background="rgba(255, 255, 255, 0.04)",A.style.borderColor="rgba(255, 255, 255, 0.08)",A.style.color="var(--ink)")})};l.querySelector("#closeBettingModalBtn")?.addEventListener("click",()=>l?.remove()),l.querySelector("#tabBuyBtn")?.addEventListener("click",()=>{d="BUY",u()}),l.querySelector("#tabSellBtn")?.addEventListener("click",()=>{d="SELL",u()}),l.querySelector("#switchBuyTabBtn")?.addEventListener("click",()=>{d="BUY",u()}),l.querySelector("#decBetBtn")?.addEventListener("click",()=>{let y=c||0,$=y>5?y-5:Math.max(1,y-1);L(String($),!0)}),l.querySelector("#incBetBtn")?.addEventListener("click",()=>{L(String((c||0)+5),!0)});let T=l.querySelector("#tradeAmountInput");T&&(T.addEventListener("input",y=>{L(y.target.value,!1)}),T.addEventListener("keyup",y=>{L(y.target.value,!1)}),T.addEventListener("blur",y=>{let $=y.target.value.trim();($===""||parseInt($,10)<1)&&L("1",!0)})),l.querySelectorAll(".quick-amt-btn").forEach(y=>{y.addEventListener("click",$=>{$.preventDefault(),$.stopPropagation();let C=y.getAttribute("data-amt")||"20";L(C,!0)})}),l.querySelector("#confirmSellBtn")?.addEventListener("click",async y=>{y.preventDefault(),y.stopPropagation();let $=l.querySelector("#confirmSellBtn");if($&&($.disabled=!0,$.textContent="Placing trade on Arc..."),t.walletAddress)try{await et(o.id,"sell",a,p,A=>{$&&($.textContent=A)})}catch(A){console.warn("Sell execution fallback:",A?.message||A)}let C=String(t.walletBalance||"100.00").replace(/,/g,""),F=parseFloat(C)||100,N=parseFloat(p.toFixed(2)),z=(F+N).toFixed(2);t.walletBalance=z;let q=t.walletAddress?t.walletAddress.toLowerCase():"guest";try{localStorage.setItem(`siftle_optimistic_bal_${q}`,z)}catch{}delete t.marketPositions[o.id];try{let A=`siftle_positions_${q}`,W=JSON.parse(localStorage.getItem(A)||"{}");delete W[o.id],localStorage.setItem(A,JSON.stringify(W))}catch{}l?.remove(),ie(),I(),S(`Successfully sold shares! +$${N} USDC refunded.`)}),l.querySelector("#confirmTradeBtn")?.addEventListener("click",async y=>{y.preventDefault(),y.stopPropagation();let $=l.querySelector("#confirmTradeBtn");$&&($.disabled=!0,$.textContent="Placing trade on Arc...");let C;if(t.walletAddress)try{C=await et(o.id,"buy",a,c,_=>{$&&($.textContent=_)})}catch(_){console.warn("On-chain execution fallback notice:",_?.message||_)}let F=String(t.walletBalance||"100.00").replace(/,/g,""),N=parseFloat(F)||100,z=Math.max(0,N-c).toFixed(2);t.walletBalance=z;let q=t.walletAddress?t.walletAddress.toLowerCase():"guest";try{localStorage.setItem(`siftle_optimistic_bal_${q}`,z)}catch{}let A=E.find(_=>String(_.id)===String(o.id))||o,W=G(A),Ue=parseFloat(W.home)||33.3,mt=parseFloat(W.draw)||33.3,Be=parseFloat(W.away)||33.3,X=Ue,ve=mt,Q=Be;a==="home"?(X=Math.min(85,Ue+2.5),Q=Math.max(10,Be-1.5),ve=Math.max(10,100-(X+Q))):a==="away"?(Q=Math.min(85,Be+2.5),X=Math.max(10,Ue-1.5),ve=Math.max(10,100-(X+Q))):(ve=Math.min(60,mt+2.5),X=Math.max(10,Ue-1.25),Q=Math.max(10,Be-1.25));let ft=(Number(A.volumeUsdc)||0)+c;A.volumeUsdc=ft,A[`${a}PoolUsdc`]=(Number(A[`${a}PoolUsdc`])||0)+c,A.volume=`$${ft.toFixed(2)}`,A.currentOdds={home:X.toFixed(1),draw:ve.toFixed(1),away:Q.toFixed(1)};let Ie=(t.marketPositions[o.id]?.optionSharesUsdc||0)+c;t.marketPositions[o.id]={marketId:o.id,side:a,optionId:a,optionLabel:i,optionSharesUsdc:Ie,yesSharesUsdc:Ie,noSharesUsdc:0,stakePlaced:Ie,costBasisUsdc:Ie,entryPriceCents:n,isLiveTrade:!!o.isLive};try{let _=`siftle_positions_${q}`,ht=JSON.parse(localStorage.getItem(_)||"{}");ht[o.id]=t.marketPositions[o.id],localStorage.setItem(_,JSON.stringify(ht))}catch{}l?.remove(),ie(),I(),S(`Successfully placed $${c} prediction on ${w(i)}!`);let pa=v(c);Ur({optionName:i,matchTitle:`${A.homeTeam||"Home"} vs ${A.awayTeam||"Away"}`,tradeAmount:c,oldPrice:parseFloat(n.toFixed(1)),newPrice:parseFloat((a==="home"?X:a==="away"?Q:ve).toFixed(1)),potentialWin:pa.toFixed(2),txHash:C})})};u(),document.body.appendChild(l)};window.openSiftleMatchPage=e=>{console.log("openSiftleMatchPage called for matchId:",e),t.selectedMatchId=String(e),t.matchDetailTab="overview",t.activeSurface==="matches"?da(String(e)):b()};var da=async e=>{if(!k||!M)return;fe?.toggleAttribute("hidden",!0),he?.toggleAttribute("hidden",!0),j?.toggleAttribute("hidden",!0),J?.classList.remove("active"),se?.classList.remove("active"),ne?.classList.remove("active"),document.body.classList.remove("detail-mode"),M.hidden=!0,k.hidden=!1,k.classList.remove("markets-list"),k.classList.add("matches-surface-active");let a=t.liveMatches.find(T=>String(T.id)===String(e))||{id:e,homeTeam:"Espanyol",awayTeam:"Real Madrid",homeCrest:"https://a.espncdn.com/i/teamlogos/soccer/500/default-team-logo.png",awayCrest:"https://a.espncdn.com/i/teamlogos/soccer/500/default-team-logo.png",homeScore:1,awayScore:1,statusDetail:"44'",league:"Spanish LaLiga",isLive:!0,isPost:!1,date:new Date().toISOString()},r=t.matchDetailTab||"overview";k.innerHTML=`
  ...
  `,document.getElementById("backToMatchesBtn")?.addEventListener("click",()=>{t.selectedMatchId=null,Me()}),document.querySelectorAll(".match-page-tab-btn").forEach(T=>{T.addEventListener("click",y=>{y.preventDefault(),y.stopPropagation();let $=T.getAttribute("data-tab-id");$&&(t.matchDetailTab=$,da(e))})});let o=await la(e);Er=o;let i=document.getElementById("matchDetailPageTabContent");if(!i)return;if(!a.isLive&&!a.isPost){i.innerHTML=`
    ...
    `;return}if(!o){i.innerHTML='<div style="text-align: center; color: var(--muted); padding: 48px 16px;">Match details loading or currently unavailable for this fixture.</div>';return}let s=o.boxscore?.teams||[],n=s[0]?.statistics||[],l=s[1]?.statistics||[],d=(T,y)=>{let $=T.find(C=>C.label?.toLowerCase()===y.toLowerCase()||C.name?.toLowerCase()===y.toLowerCase());return $?$.displayValue:"-"},c=d(n,"possession")!=="-"?d(n,"possession")+"%":"38%",g=d(l,"possession")!=="-"?d(l,"possession")+"%":"62%",p=d(n,"shots"),m=d(l,"shots"),v=d(n,"on goal")!=="-"?d(n,"on goal"):"2",u=d(l,"on goal")!=="-"?d(l,"on goal"):"5",f=d(n,"corner kicks"),h=d(l,"corner kicks"),x=parseFloat(c)||38,L=parseFloat(g)||62;if(r==="overview"){if(!a.isLive&&!a.isPost){i.innerHTML=`
        <div style="background: var(--paper); border: 1px solid var(--border); border-radius: 20px; padding: 36px 20px; text-align: center; color: var(--muted);">
      ...
      <div style="background: var(--paper); border: 1px solid var(--border); border-radius: 20px; padding: 20px;">
        ...
        <div style="margin-bottom: 18px;">
          <div style="display: flex; justify-content: space-between; font-size: 0.9rem; font-weight: 800; color: var(--ink); margin-bottom: 8px;">
            ...
            <span style="color: #34d399; font-weight: 800; background: rgba(52, 211, 153, 0.18); padding: 2px 10px; border-radius: 999px;">${g}</span>
          </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 12px;">
          ${(()=>{let y=(o.keyEvents||o.commentary||[]).filter($=>$.type?.text?.toLowerCase().includes("goal")||$.scoringPlay||$.text?.toLowerCase().includes("goal"));return y.length===0?'<div style="color: var(--muted); font-size: 0.9rem;">No goals recorded for this match yet.</div>':y.map($=>`
              <div style="display: flex; align-items: center; gap: 12px; padding: 10px 0; border-bottom: 1px solid rgba(255,255,255,0.05);">
                ...
                <span style="font-size: 0.9rem; font-weight: 700; color: var(--ink);">${w($.text)}</span>
              </div>
            `).join("")})()}
        </div>
      </div>
          ...
          <div style="display: flex; flex-direction: column; gap: 14px;">
            ${T.map(y=>`
              <div style="display: flex; gap: 12px; padding-bottom: 12px; border-bottom: 1px solid rgba(255,255,255,0.05);">
                ...
                <span style="font-size: 0.9rem; color: var(--ink); line-height: 1.4;">${w(y.text)}</span>
              </div>
            `).join("")}
          </div>
        `}
      ...
      <div style="display: flex; flex-direction: column; gap: 20px;">
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(140px, 1fr)); gap: 10px;">
            ${y.slice(0,11).map(C=>`
              <div style="background: rgba(255,255,255,0.04); padding: 8px 12px; border-radius: 10px; display: flex; align-items: center; gap: 8px;">
                <span style="font-size: 0.8rem; font-weight: 800; color: #38bdf8; background: rgba(56, 189, 248, 0.15); width: 22px; height: 22px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">${C.jersey||"#"}</span>
                <span style="font-size: 0.85rem; font-weight: 700; color: var(--ink); overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${w(C.athlete?.displayName||"Player")}</span>
              </div>
            `).join("")}
          </div>
        </div>
        ...
        <div style="background: var(--paper); border: 1px solid var(--border); border-radius: 20px; padding: 20px;">
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(140px, 1fr)); gap: 10px;">
            ${$.slice(0,11).map(C=>`
              <div style="background: rgba(255,255,255,0.04); padding: 8px 12px; border-radius: 10px; display: flex; align-items: center; gap: 8px;">
                <span style="font-size: 0.8rem; font-weight: 800; color: #34d399; background: rgba(52, 211, 153, 0.15); width: 22px; height: 22px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">${C.jersey||"#"}</span>
                <span style="font-size: 0.85rem; font-weight: 700; color: var(--ink); overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${w(C.athlete?.displayName||"Player")}</span>
              </div>
            `).join("")}
          </div>
      ...
      <div style="background: var(--paper); border: 1px solid var(--border); border-radius: 20px; padding: 20px;">
        ...
        <div style="display: flex; flex-direction: column; gap: 12px;">
          <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 0; border-bottom: 1px solid rgba(255,255,255,0.05);">
            ...
            <span style="font-weight: 800; color: #34d399;">${g}</span>
          </div>
          <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 0; border-bottom: 1px solid rgba(255,255,255,0.05);">
    ...
    <section class="matches-surface" style="padding: 16px 12px 110px 12px; box-sizing: border-box; width: 100%; font-family: -apple-system, BlinkMacSystemFont, 'Inter', 'Segoe UI', Roboto, sans-serif;">
      ...
      `:`
        <div class="league-groups-container" style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
          ${Array.from(n.entries()).map(([d,c])=>{let g=d.includes("LIVE MATCHES"),p=c[0]?.leagueLogo||"";return`
              <!-- Thick Card per League (News Card Background #12131a) -->
              <div class="thick-league-card" style="background: var(--paper); border: 1px solid ${g?"rgba(239, 68, 68, 0.4)":"rgba(255, 255, 255, 0.08)"}; border-radius: 18px; padding: 18px; box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4); width: 100%; box-sizing: border-box;">
                ...
                <div style="display: flex; align-items: center; gap: 12px; padding-bottom: 14px; border-bottom: 1px solid rgba(255, 255, 255, 0.08); margin-bottom: 14px;">
                  ...
                  <div>
                    <h2 style="margin: 0; font-size: 1.05rem; font-weight: 800; color: ${g?"#ef4444":"var(--ink)"}; letter-spacing: -0.01em;">
                      ${w(qe(d))}
                    </h2>
                  </div>
                </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 16px;">
                  ${c.map((m,v)=>{let u=m.isLive,f=m.isPost,h=v===c.length-1,x=new Date(m.date).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});return`
                      <div class="match-row-item" data-match-id="${m.id}" onclick="window.openSiftleMatchPage('${m.id}')" style="display: flex; justify-content: space-between; align-items: center; gap: 12px; cursor: pointer; ${h?"":"border-bottom: 1px solid rgba(255, 255, 255, 0.05); padding-bottom: 14px;"}">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
          ...
          <div style="display: flex; gap: 2px; background: var(--subtle-bg); padding: 2px; border-radius: 8px; border: 1px solid var(--border);">
            ${["1D","1W","1M","1Y","All"].map(u=>`
              <button type="button" class="pnl-tf-btn" data-tf="${u.toLowerCase()}" style="background: ${m===u.toLowerCase()?"rgba(255,255,255,0.12)":"transparent"}; color: ${m===u.toLowerCase()?"#38bdf8":"var(--muted)"}; border: none; padding: 3px 6px; border-radius: 5px; font-size: 0.7rem; font-weight: 800; cursor: pointer; transition: all 0.15s ease;">
                ${u}
              </button>
            `).join("")}
          </div>
        ...
        `:p==="trade_history"?`
          <div style="background: var(--paper); border: 1px solid var(--border); border-radius: 18px; padding: 16px; box-sizing: border-box;">
            ...
            <div style="display: flex; flex-direction: column; gap: 10px;">
              ${v.length?v.map(([u,f])=>{let h=f.optionLabel||(f.optionId==="home"?"Home":f.optionId==="away"?"Away":"Draw"),x=f.optionSharesUsdc||f.yesSharesUsdc||1;return`
          ...
          <div style="background: var(--paper); border: 1px solid var(--border); border-radius: 18px; padding: 16px; box-sizing: border-box;">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; margin-bottom: 16px; text-align: center;">
              <div style="background: var(--subtle-bg); padding: 12px 6px; border-radius: 12px;">
                ...
                <div style="font-size: 1.1rem; font-weight: 900; color: ${(()=>{let u=0,f=0;return o.forEach(h=>{let x=t.marketPositions[h.id];x&&h.isResolved&&(h.resolvedOptionId&&x.optionId===h.resolvedOptionId?u++:f++)}),u+f>0?"#34d399":"var(--muted)"})()};">${(()=>{let u=0,f=0;return o.forEach(h=>{let x=t.marketPositions[h.id];x&&h.isResolved&&(h.resolvedOptionId&&x.optionId===h.resolvedOptionId?u++:f++)}),u+f>0?(u/(u+f)*100).toFixed(0)+"%":"--"})()}</div>
              </div>
              <div style="background: var(--subtle-bg); padding: 12px 6px; border-radius: 12px;">
  ...
  `,k.querySelectorAll(".portfolio-subtab-btn").forEach(u=>{u.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation();let h=u.getAttribute("data-subtab");h&&(t.activePortfolioSubTab=h,O())})}),k.querySelectorAll(".pnl-tf-btn").forEach(u=>{u.addEventListener("click",f=>{f.preventDefault(),f.stopPropagation();let h=u.getAttribute("data-tf");h&&(t.pnlTimeframe=h,O())})}),k.querySelector("#startTradingBtn")?.addEventListener("click",()=>{J?.click()}),k.querySelector("#editUsernameBtn")?.addEventListener("click",()=>{let u=prompt("Enter new display name:",t.profileUsername||"");u&&u.trim()&&(t.profileUsername=u.trim(),localStorage.setItem("siftle_username",u.trim()),O(),S("Username updated!"))})},b=()=>{if(k&&t.activeSurface!=="matches"&&k.classList.remove("matches-surface-active"),Dt.forEach(e=>{let a=e.dataset.bottomNav;e.classList.toggle("active",a==="saved"?t.showSaved:a===t.activeSurface&&!t.showSaved)}),t.activeSurface==="markets"){ie();return}if(t.activeSurface==="matches"){Me();return}if(t.activeSurface==="portfolio"){O();return}if(t.activeSurface==="leaderboard"){Pr();return}na(),Yt(),me(),Lr(),H&&(H.value=t.activeArchiveDate??"")};tt.textContent=_t();j?.addEventListener("click",e=>{let r=e.target.closest("[data-category]");if(!r)return;let o=r.dataset.category;t.activeCategory=o,V=!1,K=null,window.history.pushState({},"","#feed"),Y(),b(),o==="Personalized"&&!ca()&&_e(),Ce(),Z(t.activeCategory)});var V=!1,Pt="overall",K=null,Ne=!1,Ee=()=>{try{let e=localStorage.getItem("siftle_followed_entities");if(e)return JSON.parse(e)}catch{}return{clubs:[],managers:[],players:[]}},ca=()=>{let e=Ee();return(e.clubs?.length||0)+(e.managers?.length||0)+(e.players?.length||0)>0},Ir=e=>{localStorage.setItem("siftle_followed_entities",JSON.stringify(e))},zr=e=>{if(!e)return"";let a=e.replace(/\r\n/g,`
`).replace(/\r/g,`
`),o=st(a).split(`
`),i="",s="",n=!1,l=!1;for(let d=0;d<o.length;d++){let c=o[d].trim();if(!c)continue;if(/what matters/i.test(c)||c.includes("\u{1F3AF}")){n&&(s+="</ul></div>",n=!1);let m=c.replace(/^#+\s*/,"").replace(/[🎯⚡⏱️⭐]\s*/g,"");s+=`
        <div class="briefing-highlight-box what-matters">
          <h4>${w(m||"What Matters Most")}</h4>
          <p>
      `,l=!0;continue}if(/watch next/i.test(c)||c.includes("\u23F1\uFE0F")){l&&(s+="</p></div>",l=!1);let m=c.replace(/^#+\s*/,"").replace(/[🎯⚡⏱️⭐]\s*/g,"");s+=`
        <div class="briefing-highlight-box watch-next">
          <h4>${w(m||"Key Things to Watch")}</h4>
          <ul>
      `,n=!0;continue}if(c.startsWith("## ")||c.startsWith("# "))continue;if(n){let m=c.replace(/^[-*]\s*/,"").replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>");m&&(s+=`<li>${m}</li>`);continue}if(l){let m=c.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>");s+=`${m} `;continue}let g=c.match(/^(?:###\s*)?(\d+)\.\s*(.*)$/);if(g){let m=g[1],v=g[2].replace(/\*\*/g,"").trim(),u="",f="",h=d+1;for(;h<o.length&&!o[h].trim().match(/^(?:###\s*)?(?:\d+\.|WHAT MATTERS|WATCH NEXT|🎯|⏱️)/i);){let y=o[h].trim();y.startsWith("*[")&&y.endsWith("]*")?f=y.slice(2,-2):y.startsWith("*")&&y.endsWith("*")?f=y.slice(1,-1):y.length>0&&!y.startsWith("###")&&(u+=(u?" ":"")+y),h++}d=h-1;let x="",L=u.replace(/\.\.\.$/,"").trim();L=L.replace(/[,;:\s]+(?:but|and|or|the|a|an|with|in|on|of|to|for|as|is|was|are|were|after|while|that|which|who)$/i,"").trim(),L&&!L.endsWith("...")&&L.length>=35&&L.split(" ").length>=7?x=L:x=v,x=x.replace(/^(?:deal done|here we go|official,?\s*exclusive\s*story\s*confirmed|breaking news|breaking|official|exclusive|update)\s*[:\.\-]?\s*/gi,"").replace(/Fabrizio Romano\s*\(@FabrizioRomano\)/gi,"").replace(/@[a-zA-Z0-9_]+/g,"").replace(/\b(?:BR|NL|SK|PT|FR|XK|TR|BE|EC)\s+[A-Z][a-z]+/g,"").replace(/\b(?:EC|FCB|CFC|MUFC|LFC|MCFC|AFCB|THFC|NUFC)\b/g,"").replace(/\s+/g," ").trim(),x=x.replace(/[,;:\-\s]+$/,""),x.length>0&&(x=x.charAt(0).toUpperCase()+x.slice(1)),x.endsWith(".")||(x+=".");let T=f.replace(/·\s*(confirmed|in progress|major|reported).*/i,"").trim();i+=`
  ...
  `},ee=()=>{document.querySelector("#backToFeedBtn")?.addEventListener("click",()=>{V=!1,b()}),document.querySelector("#openBriefingBtn")?.addEventListener("click",()=>{V=!0;let e=t.activeCategory==="Personalized"?"personalized":"overall";Pt!==e&&(K=null),Pt=e,b(),K||lt(!1)}),document.querySelector("#catchUpAgainBtn")?.addEventListener("click",()=>{lt(!1)})},lt=async(e=!1)=>{Ne=!0,V&&b();let a=e?null:localStorage.getItem("siftle_last_briefing_at"),r=Ee();try{let o=await fetch(B("/api/briefing/delta"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({lastBriefingAt:a,context:t.activeCategory==="Personalized"?"personalized":"overall",entities:r})}),i=await o.json();Ne=!1,o.ok&&i.success?(K=i,localStorage.setItem("siftle_last_briefing_at",i.periodEnd||new Date().toISOString()),V&&b()):(K={periodStart:new Date().toISOString(),markdown:`### Failed to generate briefing

${i.error||"Please try again in a moment."}`},V&&b())}catch(o){Ne=!1,K={periodStart:new Date().toISOString(),markdown:`### Failed to connect to briefing service

${o.message}`},V&&b()}};k?.addEventListener("input",e=>{let a=e.target;if(a.id!=="newsSearchInput")return;let r=a.selectionStart??a.value.length,o=a.selectionEnd??a.value.length;t.newsSearchQuery=a.value,me();let i=k?.querySelector("#newsSearchInput");i&&(i.focus(),i.setSelectionRange(r,o))});J?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,window.history.pushState({},"","#markets"),Y(),b()});se?.addEventListener("click",()=>{t.activeSurface="feed",t.showSaved=!1,window.history.pushState({},"","#feed"),Y(),b(),Ce(),Z(t.activeCategory)});ne?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=!1,window.history.pushState({},"","#portfolio"),Y(),b()});te?.addEventListener("click",()=>{t.walletAddress?(window.location.hash="#portfolio",Pe()):Ae()});document.addEventListener("click",e=>{let a=e.target,r=a.closest("[data-match-id]");if(r){let d=r.getAttribute("data-match-id");d&&window.openSiftleMatchPage(d);return}let o=a.closest("[data-match-date]");if(o){let d=o.getAttribute("data-match-date");d&&d!==t.activeMatchDate&&(t.activeMatchDate=d,t.liveMatches=[],t.loadingLiveMatches=!0,Me(),ra(d).then(()=>{t.activeSurface==="matches"&&Me()}));return}let i=a.closest(".copy-address-btn");if(i){let d=i.getAttribute("data-address");d&&navigator.clipboard.writeText(d).then(()=>{S("Wallet address copied!")})}let s=a.closest("[data-claim-market]");if(s){let d=s.getAttribute("data-claim-market");d&&Cr(d);return}if(a.closest("[data-open-referrals]")){t.referralPanelOpen=!t.referralPanelOpen,!t.referralData&&!t.loadingReferralData&&Se(),O();return}if(a.closest("[data-close-referrals]")){t.referralPanelOpen=!1,O();return}if(a.closest("[data-refresh-referrals]")){t.referralError=null,Se(),O();return}let n=a.closest("[data-copy-referral-code]");if(n){let d=n.getAttribute("data-copy-referral-code")||"";d&&navigator.clipboard.writeText(d).then(()=>S("Invite code copied"));return}let l=a.closest("[data-copy-referral-link]");if(l){let d=l.getAttribute("data-copy-referral-link")||"";d&&navigator.clipboard.writeText(d).then(()=>S("Invite link copied"));return}a.closest("[data-connect-wallet]")&&(t.walletAddress?Et():Ae())});Dt.forEach(e=>{e.addEventListener("click",()=>{let a=e.dataset.bottomNav;t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=a==="saved",a==="markets"?(t.activeSurface="markets",window.history.pushState({},"","#markets")):a==="matches"?(t.activeSurface="matches",window.history.pushState({},"","#matches")):a==="portfolio"?(t.activeSurface="portfolio",window.history.pushState({},"","#portfolio")):a==="leaderboard"?(t.activeSurface="leaderboard",window.history.pushState({},"","#leaderboard")):(t.activeSurface="feed",window.history.pushState({},"","#feed"),Ce(),Z(t.activeCategory),a==="saved"&&(ir(),dt(),ke())),Y(),b()})});H?.addEventListener("change",()=>{t.activeArchiveDate=H.value||null,window.history.pushState({},"","#feed"),Y(),b(),Z(t.activeCategory)});Ea?.addEventListener("click",()=>{t.activeArchiveDate=null,H&&(H.value=""),window.history.pushState({},"","#feed"),Y(),b(),Z(t.activeCategory)});k?.addEventListener("click",async e=>{let a=e.target;if(a.closest("#editUsernameBtn")){let h=k?.querySelector(".username-display-row"),x=k?.querySelector("#usernameEditForm");if(h&&x){h.style.display="none",x.style.display="flex";let L=x.querySelector("#usernameInput");L&&L.focus()}return}if(a.closest("#cancelUsernameBtn")){let h=k?.querySelector(".username-display-row"),x=k?.querySelector("#usernameEditForm");h&&x&&(h.style.display="flex",x.style.display="none");return}let i=a.closest("#saveUsernameBtn");if(i){let x=k?.querySelector("#usernameEditForm")?.querySelector("#usernameInput");if(x){let L=x.value.trim().slice(0,15),T=i,y=T.textContent||"Save";T.disabled=!0,T.textContent="Saving...",or(L),t.profileNotice=null;try{t.walletAddress&&await le(!1),t.profileNotice={type:"success",message:"Username saved to your shared leaderboard profile."},S("Username updated"),O()}catch($){let C=$ instanceof Error?$.message:"Username save failed";t.profileNotice={type:"error",message:C},S(C),T.disabled=!1,T.textContent=y,O()}}return}let s=a.closest("[data-portfolio-filter]");if(s){let h=s.getAttribute("data-portfolio-filter");t.portfolioFilter=h,O();return}let n=a.closest("[data-timeframe]");if(n){let h=n.dataset.timeframe;t.activeMarketTimeframe=h,ie();return}let l=a.closest("[data-market-id]");if(l){t.selectedMarketId=l.dataset.marketId??null,P("market_view"),window.history.pushState({},"",`#market-${t.selectedMarketId}`),b(),window.scrollTo({top:0,behavior:"smooth"});return}if(a.closest(".read-tweet-btn")){e.stopPropagation();let h=a.closest("[data-story-id]");h&&rt(Number(h.dataset.storyId),!0);return}let c=a.closest("[data-thread-story-id]"),g=a.closest("[data-export-id]"),p=a.closest("[data-export-action]"),m=a.closest("[data-story-id]");if(c){e.stopPropagation();let h=t.stories.find(x=>x.id===Number(c.dataset.threadStoryId));h&&Ka(h);return}let v=a.closest(".mobile-bookmark-btn, .bookmark-button");if(v){e.stopPropagation();let h=v.dataset.bookmarkUrl||"",x=t.stories.find(L=>L.sourceUrl===h);if(!x)return;x.saved=!x.saved,x.saved?re.add(h):re.delete(h),Ca(),S(x.saved?"Saved to your list":"Removed from saved"),me();return}if(p){e.stopPropagation(),$r(Number(p.dataset.exportStoryId),p.dataset.exportAction);return}if(g){e.stopPropagation();let h=Number(g.dataset.exportId);t.activeShareStoryId=t.activeShareStoryId===h?null:h,me();return}if(!m||a.closest("a"))return;let u=Number(m.dataset.storyId),f=t.stories.find(h=>h.id===u);f&&P("feed_story_click",f.sourceUrl,f.headline),rt(u,!0)});k?.addEventListener("keydown",e=>{let r=e.target.closest("[data-story-id]");if(!r||e.key!=="Enter"&&e.key!==" ")return;e.preventDefault();let o=Number(r.dataset.storyId),i=t.stories.find(s=>s.id===o);i&&P("feed_story_click",i.sourceUrl,i.headline),rt(o)});M?.addEventListener("click",e=>{let a=e.target,r=a.closest("[data-unlock-briefing]");if(r){let g=t.stories.find(p=>p.id===Number(r.dataset.unlockBriefing));g&&at(g);return}let o=a.closest("[data-unlock-briefing-url]");if(o){let g=decodeURIComponent(o.dataset.unlockBriefingUrl||""),p=Wa(g);p&&(ue(p)?Te(p):at(p));return}if(a.closest("[data-back-markets]")){t.selectedMarketId=null,t.tradeDrawerOpen=!1,window.history.pushState({},"","#markets"),b();return}if(a.closest("#openTradeDrawerBtn")){let g=E.find(v=>v.id===t.selectedMarketId);if(g){if(ut(g,t.marketSnapshots[g.id])){S("This market is resolved and can no longer be traded.");return}if(Ga(g,t.marketSnapshots[g.id])){S("Trading is locked 20 minutes before kickoff.");return}}t.tradeDrawerOpen=!0,P("trade_drawer_open");let p=M.querySelector("#tradeDrawer"),m=M.querySelector("#tradeDrawerBackdrop");p?.classList.add("open"),m?.classList.add("open");return}if(a.closest("#closeTradeDrawerBtn")||a.closest("#tradeDrawerBackdrop")){t.tradeDrawerOpen=!1;let g=M.querySelector("#tradeDrawer"),p=M.querySelector("#tradeDrawerBackdrop");g?.classList.remove("open"),p?.classList.remove("open");return}if(a.closest("#shareWhatsAppBtn")){let g=E.find(p=>p.id===t.selectedMarketId);if(g){let p=Ar(g),m=`https://api.whatsapp.com/send?text=${encodeURIComponent(p)}`;window.open(m,"_blank")}return}let i=a.closest("[data-market-trade]");if(i&&t.selectedMarketId){let g=i.dataset.marketTrade;gr(t.selectedMarketId,g);return}let s=a.closest("[data-market-option-trade]");if(s&&t.selectedMarketId){let g=s.dataset.marketOptionTrade||t.marketTradeOptionId||"";Tr(t.selectedMarketId,g);return}let n=a.closest("[data-market-option-id]");if(n){if(n.disabled||n.classList.contains("disabled"))return;t.marketTradeOptionId=n.dataset.marketOptionId||null,b();return}let l=a.closest("[data-market-trade-side]");if(l){if(l.disabled||l.classList.contains("disabled"))return;let g=E.find(v=>v.id===t.selectedMarketId),p=g?t.marketPositions[g.id]:void 0,m=l.dataset.marketTradeSide;if(!je(t.marketOrderMode,m,p))return;t.marketTradeSide=m,b();return}let d=a.closest("[data-market-order-mode]");if(d){t.marketOrderMode=d.dataset.marketOrderMode;let g=E.find(m=>m.id===t.selectedMarketId),p=g?t.marketPositions[g.id]:void 0;t.marketTradeSide=ta(t.marketOrderMode,t.marketTradeSide,p),t.marketTradeAmount=Ge(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,p),b();return}let c=a.closest("[data-back-to-feed]");if(c){if(c.classList.contains("read-more-news-btn")){let p=new URLSearchParams(window.location.search).get("url"),m=document.querySelector(".detail-card h2")?.textContent||void 0;P("shared_read_more_click",p||void 0,m)}Ja()}});M?.addEventListener("input",e=>{let a=e.target;if(!a.matches("[data-market-amount]"))return;let r=E.find(d=>d.id===t.selectedMarketId),o=r?t.marketSnapshots[r.id]:void 0,i=r?t.marketPositions[r.id]:void 0,s=Number(a.value);t.marketTradeAmount=Number.isFinite(s)?s:0;let n=r&&Jt(r)?t.marketTradeAmount:nr(o,t.marketTradeSide,t.marketTradeAmount,t.marketOrderMode,i),l=M.querySelector(".market-inline-payout strong");l&&(l.textContent=`$${Zt(n)}`)});M?.addEventListener("focusin",e=>{e.target.matches("[data-market-amount]")&&document.body.classList.add("market-amount-focused")});M?.addEventListener("focusout",e=>{let a=e.target;if(a.matches("[data-market-amount]")){let r=E.find(i=>i.id===t.selectedMarketId),o=r?t.marketPositions[r.id]:void 0;t.marketTradeAmount=Ge(Number(a.value)||0,t.marketOrderMode,t.marketTradeSide,o),a.value=String(t.marketTradeAmount),window.setTimeout(()=>document.body.classList.remove("market-amount-focused"),120)}});window.addEventListener("popstate",Pe);window.addEventListener("hashchange",Pe);window.addEventListener("focus",async()=>{if(t.walletAddress){let e=t.walletBalance,a=await ae(t.walletAddress);t.walletBalance=a,I(),(!e||parseFloat(e)===0)&&parseFloat(a)>0&&(console.log("[X402] Balance changed from 0 to positive. Triggering Gateway warmup..."),ka())}});Ke?.addEventListener("click",()=>{if(!Je||!Ke)return;let e=!Je.hidden;Je.hidden=e,Ke.setAttribute("aria-expanded",String(!e))});document.addEventListener("click",e=>{let a=e.target;!a.closest(".share-control")&&t.activeShareStoryId!==null&&(t.activeShareStoryId=null,me());let r=a.closest("[data-menu-action]");if(!r)return;let o={today:"Showing today's brief",saved:`${t.stories.filter(i=>i.saved).length} saved stories`,archive:t.archiveDates.length>0?"Choose a saved day from the archive selector":"No saved days yet"};U&&(U.textContent=o[r.dataset.menuAction??"today"]),r.dataset.menuAction==="today"&&(t.showSaved=!1,t.activeArchiveDate=null,H&&(H.value=""),Y(),Ce(),Z(t.activeCategory)),r.dataset.menuAction==="saved"&&(na(),dt(),ke(),t.showSaved=!0,document.querySelector("#archiveControls")?.classList.remove("mobile-open"),Y(),b())});var Dr=async()=>{try{let e=await fetch(B("/api/summary/unlock-config"));e.ok&&(t.unlockConfig=await e.json(),b())}catch(e){console.error("Failed to prefetch unlock config:",e)}},Nr=()=>{window.setInterval(async()=>{try{let e=new AbortController,a=window.setTimeout(()=>e.abort(),3500),r=await fetch(B("/api/markets"),{signal:e.signal});if(window.clearTimeout(a),r.ok){let o=await r.json();Array.isArray(o)&&o.length>0&&(E=o,t.activeSurface==="markets"&&b())}}catch(e){console.warn("Background market poll failed:",e)}},3e4)};b();I();Dr();Z(t.activeCategory);Nr();Aa().then(()=>{ur(),b(),I(),window.setTimeout(Fr,1200),Qa()});var _r=document.querySelector("#mobileArchiveCard"),pe=document.querySelector("#archiveControls");_r?.addEventListener("click",()=>{if(!pe)return;pe.classList.toggle("mobile-open")&&setTimeout(()=>pe.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Hr=document.querySelector("#archivePill");Hr?.addEventListener("click",e=>{if(e.stopPropagation(),!pe)return;pe.classList.toggle("mobile-open")&&setTimeout(()=>pe.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Oe=!1,Ct=!1,Fr=()=>{Ct||(Ct=!0,(async()=>{let e=await He();if(Oe=!!e,e){t.walletConnecting=!0,I();try{let a=await wa();Oe=!1,t.walletConnecting=!1,a?(t.walletAddress=await He(),t.walletAddress&&(ce(),t.walletBalance=await ae(t.walletAddress),await R()),I(),t.activeSurface==="portfolio"&&b()):(t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ce(),S("Session expired. Please sign in again."),I(),b())}catch(a){console.warn(a),Oe=!1,t.walletConnecting=!1,t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ce(),S("Session expired. Please sign in again."),I(),b()}}await xa(a=>{Oe||(t.walletAddress=a,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ce(),a&&le(!1).catch(r=>console.error("Failed to report leaderboard entry:",r)),t.marketPositions={},t.hasLoadedPortfolioPositions=!1,I(),a?(Se(),ae(a).then(r=>{t.walletBalance=r,I(),t.activeSurface==="portfolio"&&b()}),R()):t.activeSurface==="portfolio"&&b())})})())};P("app_open");document.addEventListener("click",e=>{let r=e.target.closest("a, button");if(r){let o=r.className||"",i=typeof o=="string"?o:r.getAttribute("class")||"",s=r.getAttribute("href")||"";!(r.hasAttribute("data-unlock-briefing")||r.hasAttribute("data-unlock-briefing-url")||r.classList.contains("summary-btn")||r.textContent?.trim()==="AI briefing"||r.textContent?.trim().includes("Unlock via"))&&(i.includes("source-button")||i.includes("source-btn")||i.includes("source-link")||r.textContent?.trim()==="Open source")&&!i.includes("disabled")&&s!=="#"&&P("open_source")}},!0);export{ze as globalOddsStore,Wr as isMarketLocked};
