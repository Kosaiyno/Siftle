import"./chunks/chunk-ZUUPKAA6.js";var ue="Sports",Ne=[{id:"wc-portugal-spain-qualify",category:ue,timeframe:"Daily",optionMarket:!0,question:"Which team will qualify in Portugal vs Spain?",options:[{id:"portugal",label:"Portugal"},{id:"spain",label:"Spain"}],probability:0,kickoffAt:"2026-07-06T19:00:00Z",closes:"Jul 6, 7:40 PM GMT+1",resolution:"One option resolves correct based on the team that officially qualifies in Portugal vs Spain, including extra time and penalties.",threadTopic:"Portugal vs Spain Qualify Watch",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-ronaldo-header-spain",category:ue,timeframe:"Daily",optionMarket:!0,question:"Will Cristiano Ronaldo score a header vs Spain?",options:[{id:"yes",label:"Yes"},{id:"no",label:"No"}],probability:0,kickoffAt:"2026-07-06T19:00:00Z",closes:"Jul 6, 7:40 PM GMT+1",resolution:"Resolves Yes if Cristiano Ronaldo is officially credited with a headed goal for Portugal against Spain in regular time or extra time. Penalty shootout goals do not count. Otherwise resolves No.",threadTopic:"Ronaldo Header Watch vs Spain",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-usa-belgium-qualify",category:ue,timeframe:"Daily",optionMarket:!0,question:"Which team will qualify in USA vs Belgium?",options:[{id:"usa",label:"USA"},{id:"belgium",label:"Belgium"}],probability:0,kickoffAt:"2026-07-07T00:00:00Z",closes:"Jul 7, 12:40 AM GMT+1",resolution:"One option resolves correct based on the team that officially qualifies in USA vs Belgium, including extra time and penalties.",threadTopic:"USA vs Belgium Qualify Watch",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-usa-goals-belgium",category:ue,timeframe:"Daily",optionMarket:!0,question:"How many goals will USA score in regular + extra time vs Belgium?",options:[{id:"0",label:"0 goals"},{id:"1",label:"1 goal"},{id:"2",label:"2 goals"},{id:"3-plus",label:"3+ goals"}],probability:0,kickoffAt:"2026-07-07T00:00:00Z",closes:"Jul 7, 12:40 AM GMT+1",resolution:"One option resolves correct based on the number of goals officially scored by the United States against Belgium in regular time and extra time. Penalty shootout goals do not count.",threadTopic:"USA Goals vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-tonali-spurs",category:ue,timeframe:"Sagas",question:"Will Sandro Tonali sign with Tottenham Hotspur in the Summer Transfer Window?",probability:58,closes:"September 1, 2026",resolution:"Resolves Yes if Tottenham Hotspur officially announces the transfer/signing of Sandro Tonali by the transfer deadline.",threadTopic:"Sandro Tonali Tottenham Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$182K",traders:"980",liquidity:"$29K",imageUrl:"https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-guimaraes-arsenal",category:ue,timeframe:"Sagas",question:"Will Bruno Guimaraes officially sign with Arsenal by September 1, 2026?",probability:45,closes:"September 1, 2026",resolution:"Resolves Yes if Arsenal officially announces the transfer/signing of Bruno Guimaraes by the transfer deadline.",threadTopic:"Bruno Guimaraes Arsenal Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$204K",traders:"1,240",liquidity:"$36K",imageUrl:"https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=1200&q=80",evidence:[]}];var Ze="https://faucet.circle.com/",mt="siftle_backend_wallet_migration_notice",Ye=null,H=()=>(Ye||(Ye=import("./chunks/arc-ZAE4BJZI.js")),Ye),j=e=>e.length>10?`${e.slice(0,6)}...${e.slice(-4)}`:e,ma=async()=>(await H()).connectArcWallet(),X=async e=>(await H()).readArcUsdcBalance(e),fa=async(e,a,r,o)=>(await H()).payAiBriefingUnlock(e,a,r,o),ga=e=>{H().then(a=>a.resolveLocalTestMarketYes(e))},ha=async e=>(await H()).readArcMarketSnapshot(e);var Bt=async(e,a)=>(await H()).readArcMarketState(e,a),va=async(e,a,r,o,n,s,i)=>(await H()).executeArcMarketOrder(e,a,r,o,n,s,i),ba=async(e,a,r,o,n)=>(await H()).executeArcOptionMarketOrder(e,a,r,o,n),Dt=()=>{H().then(e=>e.disconnectArcWallet())},ya=async(e,a)=>(await H()).claimArcMarketPayout(e,a),_e=async()=>(await H()).getConnectedArcWallet(),ka=async()=>(await H()).validateArcSession(),wa=async e=>(await H()).subscribeArcWallet(e),Sa=async()=>(await H()).triggerGatewayWarmup(),xa=["Sports"],$a="https://siftle.onrender.com",Ta=()=>{let e=(window.SIFTLE_API_BASE||"").replace(/\/$/,"");if(e)return e;let a=typeof window<"u"?window.location.hostname.toLowerCase():"";return a==="siftle.xyz"||a.endsWith(".siftle.xyz")||a.endsWith(".vercel.app")?$a:""},Aa=Ta(),E=e=>`${Aa}${e}`,Nt="siftle_theme",Ma=()=>{try{return window.localStorage.getItem(Nt)==="light"?"light":"dark"}catch{return"dark"}},$e=Ma();function C(e){fetch(E("/api/analytics"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:e})}).catch(a=>console.error("Failed to track event:",a))}var t={activeSurface:"markets",profileUsername:null,selectedMarketId:null,marketOrderMode:"buy",marketTradeSide:"yes",marketTradeOptionId:null,marketTradeAmount:5,marketSnapshots:{},marketPositions:{},marketEvidenceOverrides:{},loadingMarkets:!0,checkedMarketEvidence:{},checkedMarketSnapshots:{},loadingMarketSnapshots:{},loadingMarketEvidence:{},loadingPortfolioPositions:!1,marketTradeStatus:null,hasLoadedPortfolioPositions:!1,walletConnecting:!1,walletAddress:null,walletBalance:null,activeCategory:"Sports",stories:[],isLoading:!1,selectedStoryId:null,aiSummaries:{},loadingSummaryUrl:null,unlockingSummaryUrl:null,archiveDates:[],activeArchiveDate:null,activeShareStoryId:null,selectedThreadUrl:null,activeThread:null,loadingThreadUrl:null,feedScrollY:0,hasLoadedFeed:!1,showSaved:!1,tradeDrawerOpen:!1,activeMarketTimeframe:"All",profileNotice:null,portfolioMarketPreviews:[],referralPanelOpen:!1,referralData:null,referralError:null,loadingReferralData:!1,portfolioPositionsLoadedAt:0,unlockConfig:null,newsSearchQuery:"",briefingStatusByUrl:{},claimingMarketIds:{}},ke=null,V="global",J=null,ft=!1,gt=!1,ht=new URLSearchParams(window.location.search).get("ref")||localStorage.getItem("siftle_pending_referral_code")||"";ht&&localStorage.setItem("siftle_pending_referral_code",ht.trim().toUpperCase());var Ot=20,I=Ne,La=(...e)=>{let a=new Map;return e.flat().forEach(r=>{r?.id&&a.set(r.id,{...a.get(r.id)||{},...r})}),Array.from(a.values())},Me=()=>La(t.portfolioMarketPreviews,I,Ne),Pa=async()=>{t.loadingMarkets=!0,I.length===0&&(I=Ne);try{let e=new AbortController,a=window.setTimeout(()=>e.abort(),3500),r=await fetch(E("/api/markets"),{signal:e.signal});if(window.clearTimeout(a),r.ok){let o=await r.json();Array.isArray(o)&&o.length>0&&(I=o)}}catch(e){console.error("Failed to load markets:",e)}finally{t.loadingMarkets=!1}},_t=async()=>{try{let e=await fetch(E("/api/portfolio/markets"));if(!e.ok)return;let a=await e.json();Array.isArray(a)&&(t.portfolioMarketPreviews=a.map(r=>({threadStoryId:0,updates:0,movement:0,evidence:[],...r})))}catch(e){console.warn(e)}},Ht="siftle.savedUrls",ee=new Set,at=()=>{try{let e=localStorage.getItem(Ht)||"[]",a=JSON.parse(e);ee=new Set(a.filter(Boolean))}catch{ee=new Set}},Ua=()=>{try{localStorage.setItem(Ht,JSON.stringify(Array.from(ee)))}catch{}},Te=()=>{if(Array.isArray(t.stories))for(let e of t.stories)e.saved=!!ee.has(e.sourceUrl)};at();Te();var Xe=document.querySelector("#dateLabel"),te=document.querySelector("#categoryTabs"),k=document.querySelector("#storyList"),T=document.querySelector("#storyDetail"),Ge=document.querySelector("#menuButton"),Je=document.querySelector("#menuPanel"),A=document.querySelector("#menuStatus"),F=document.querySelector("#archiveDateSelect"),vt=document.querySelector("#archiveStatus"),Ca=document.querySelector("#todayButton"),Re=document.querySelector(".brief-hero"),je=document.querySelector("#archiveControls"),Le=document.querySelector("[data-surface='markets']"),Pe=document.querySelector("[data-surface='feed']"),Ue=document.querySelector("[data-surface='portfolio']"),Q=document.querySelector("#walletButton"),we=document.querySelector("[data-theme-toggle]"),Rt=Array.from(document.querySelectorAll("[data-bottom-nav]")),Ke,Ea=()=>{if(!we)return;let a=`Switch to ${$e==="light"?"dark":"light"} mode`;we.setAttribute("aria-label",a),we.title=a,we.dataset.activeTheme=$e},jt=e=>{$e=e,document.documentElement.dataset.theme=e;try{window.localStorage.setItem(Nt,e)}catch{}Ea()};jt($e);var B=()=>{if(Q){let e=Q.querySelector(".wallet-button-label");Q.classList.toggle("connected",!!t.walletAddress),Q.disabled=t.walletConnecting,Q.setAttribute("aria-label",t.walletAddress?`Wallet ${j(t.walletAddress)}`:"Sign in"),e&&(e.textContent=t.walletConnecting?"Signing in...":t.walletAddress?"Wallet":"Sign in"),Q.title=t.walletAddress?`${t.walletBalance??"0"} Arc Testnet USDC - ${j(t.walletAddress)}`:"Sign in"}};window.addEventListener("resize",B);we?.addEventListener("click",()=>{jt($e==="light"?"dark":"light")});var Ia=async e=>{let a=localStorage.getItem("siftle_pending_referral_code");if(a)try{let r=await fetch(E("/api/referrals/bind"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:e,referralCode:a})}),o=await r.json().catch(()=>({}));r.ok&&(o.bound||o.reason==="already_bound"||o.reason==="invalid_code")&&(localStorage.removeItem("siftle_pending_referral_code"),o.bound&&v("Referral connected"))}catch(r){console.warn(r)}},Ae=async()=>{if(!(!t.walletAddress||t.loadingReferralData)){t.loadingReferralData=!0,t.referralError=null;try{let e=await fetch(E(`/api/referrals?walletAddress=${encodeURIComponent(t.walletAddress)}`)),a=await e.json().catch(()=>({}));e.ok?t.referralData=a:t.referralError=a?.error||"Referral tools are temporarily unavailable."}catch(e){console.warn(e),t.referralError="Referral tools are temporarily unavailable."}finally{t.loadingReferralData=!1,t.activeSurface==="portfolio"&&W()}}},qe=async()=>{if(!t.walletConnecting){t.walletConnecting=!0,C("wallet_connect_start"),B();try{let e=await ma();if(e){C("wallet_connect_success"),t.walletAddress=e,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,me(),t.walletBalance=await X(e),await Ia(e),Ae(),await z(),ie(!0).catch(r=>console.error("Failed to report leaderboard entry:",r));let a=localStorage.getItem(mt);a?(localStorage.removeItem(mt),v(a)):v("Connected to Arc Testnet"),window.location.hash="#portfolio",Ee()}}catch(e){C("wallet_connect_failed"),v(e instanceof Error?e.message:"Wallet connection failed")}finally{t.walletConnecting=!1,B()}}},v=e=>{let a=document.querySelector("#actionToast");a||(a=document.createElement("div"),a.id="actionToast",a.className="action-toast",a.setAttribute("role","status"),a.setAttribute("aria-live","polite"),document.body.appendChild(a)),a.textContent=e,a.classList.add("show"),Ke&&window.clearTimeout(Ke),Ke=window.setTimeout(()=>{a?.classList.remove("show")},1700)};window.showActionToast=v;var Ba=(e,a,r,o)=>{let n=document.createElement("div");n.className="success-modal-overlay",n.innerHTML=`
  ...
  `,document.body.appendChild(n),setTimeout(()=>{n.classList.add("show")},10);let s=()=>{n.classList.remove("show"),setTimeout(()=>{n.remove()},300)};n.querySelector(".success-modal-close-btn")?.addEventListener("click",s),n.querySelector(".success-modal-action-btn")?.addEventListener("click",s),n.addEventListener("click",i=>{i.target===n&&s()})},Y=()=>{t.feedScrollY=0,window.scrollTo({top:0,behavior:"auto"})},qt=e=>{let a=e?new Date(`${e}T12:00:00`):new Date;return new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric"}).format(a)},Da=()=>t.stories.filter(e=>{if(t.showSaved)return!!e.saved;if(!(t.activeCategory==="All"||e.category===t.activeCategory))return!1;let a=t.newsSearchQuery.trim().toLowerCase();return a?[e.headline,e.summary,e.source,e.ai_summary].filter(Boolean).join(" ").toLowerCase().includes(a):!0}),Se=e=>t.activeArchiveDate?e.postedAt:`${e.postedAt} ago`,Na=e=>/(\*\*?\s*critique|attempt\s*\d|prompt says|let'?s try|tighter version|word count|violat(?:e|es)|output only|valid json|the model|the prompt)/i.test(e),Oa=(e,a=140)=>{let r=e.split(/\s+/).filter(Boolean);if(r.length<=a)return e;let n=r.slice(0,a).join(" "),s=Math.max(n.lastIndexOf("."),n.lastIndexOf("?"),n.lastIndexOf("!"));return s>n.length*.45?n.slice(0,s+1).trim():`${n.replace(/[,:;.'"!\?\s]+$/,"")}...`},bt=e=>{let a=String(e||"").trim();for(let r=0;r<2;r+=1){let o=a.match(/^```(?:json)?\s*([\s\S]*?)\s*```$/i);if(o&&(a=o[1].trim()),!/^\s*\{[\s\S]*\}\s*$/.test(a))break;try{let n=JSON.parse(a);if(typeof n.summary=="string"){a=n.summary.trim();continue}}catch{break}break}return a=a.replace(/&lt;|&#60;/gi,"<").replace(/&gt;|&#62;/gi,">").replace(/<[^>]+>/g," ").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&#39;/g,"'").replace(/&apos;/g,"'").replace(/&quot;/g,'"').replace(/^["'{\s]+/,"").replace(/["'}\s]+$/,"").replace(/^summary["'\s]*:[\s"']*/i,"").replace(/\s+/g," ").trim(),Na(a)?"":Oa(a)},ae=(e,a)=>bt(a||"")||bt(e.summary)||e.headline,_a=e=>{let r=e?.closest(".detail-summary, .thread-item, .market-thread-update")?.querySelector(".briefing-capture-area");if(!r||!window.html2canvas)return;let o=document.createElement("div");o.className="briefing-export-staging";let n=r.cloneNode(!0);n.classList.add("briefing-export-surface");let s=document.documentElement.dataset.theme==="light";s?(n.style.setProperty("background","linear-gradient(180deg, #ffffff, #f8fafc)","important"),n.style.setProperty("border","1px solid #cbd5e1","important")):(n.style.setProperty("background","linear-gradient(180deg, rgba(15, 23, 42, 0.98), rgba(17, 24, 39, 0.98))","important"),n.style.setProperty("border","1px solid #1e293b","important")),n.querySelectorAll(".briefing-section").forEach(d=>{d.style.setProperty("border","none","important"),s?d.style.setProperty("background-color","#f1f5f9","important"):d.style.setProperty("background-color","rgba(30, 41, 59, 0.45)","important")}),s&&n.querySelectorAll(".what-happened-section .briefing-text, .takeaway-section .briefing-text").forEach(u=>{u.style.setProperty("color","#000000","important")}),o.appendChild(n),document.body.appendChild(o),n.offsetHeight,requestAnimationFrame(()=>{setTimeout(()=>{window.html2canvas(n,{backgroundColor:s?"#f5f7fb":"#0f172a",scale:2,logging:!1,useCORS:!0}).then(d=>{let u=document.createElement("a");u.download="siftle-briefing.png",u.href=d.toDataURL("image/png"),u.click(),window.showActionToast?.("Briefing card image downloaded!")}).catch(()=>{window.showActionToast?.("Unable to download briefing card")}).finally(()=>{o.remove()})},40)})};window.downloadBriefingCard=_a;var rt=(e,a)=>{let r=e.split(/(?:\*\*|__)?(WHAT HAPPENED|KEY POINTS|TAKEAWAY)\s*:?\s*(?:\*\*|__)?\s*:?\s*/i);if(r.length<=1)return`<p class="briefing-text">${e}</p>`;let o='<div class="briefing-capture-area">';if(a){let s=a.headline||"Football Match Update";o+=`
    ...
    `}r[0].trim()&&(o+=`<p class="briefing-capture-intro">${r[0].trim()}</p>`);let n="";for(let s=1;s<r.length;s+=2){let i=r[s].trim().toUpperCase(),d=r[s+1]?r[s+1].trim():"";if(!d)continue;let u="";if(i==="KEY POINTS"){let m=d.split(/(?:•|\*|-)\s+/).map(p=>p.trim()).filter(Boolean);m.length>0?u=`<ul class="briefing-list">${m.map(p=>`<li>${p}</li>`).join("")}</ul>`:u=`<p class="briefing-text">${d}</p>`}else u=`<p class="briefing-text">${d}</p>`,i==="TAKEAWAY"&&(n=d);let f=i.toLowerCase().replace(/\s+/g,"-");o+=`
...
`,ur=(e=4)=>`${ve("Loading stories")}${Array.from({length:e},pr).join("")}`,ge=()=>`
...
Trade and discuss here: ${d}`},Ar=e=>{if(!k||!T)return;let a=Fe(e),r=!t.checkedMarketEvidence[e.id],o=G(e),n=t.marketSnapshots[e.id],s=oe(e),i=ne(e);s&&!t.marketTradeOptionId&&(t.marketTradeOptionId=i[0]?.id||null);let d=Xa(e),u=!!(o&&!n),f=n?.yesPriceCents??(o?e.probability:0),m=n?.noPriceCents??(o?100-e.probability:0),p=u?"":o?`${f}\xA2`:"--",h=u?"":o?`${m}\xA2`:"--",l=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},c=!!l.optionId;s&&c&&t.marketOrderMode!=="sell"&&(t.marketOrderMode="sell"),s&&!c&&t.marketOrderMode==="sell"&&(t.marketOrderMode="buy");let b=s&&t.marketOrderMode==="sell"&&c?Math.max(0,Number(l.optionSharesUsdc)||0):0,x=b>0?b:Be(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,l),w=b>0?{min:0,max:b}:ea(t.marketOrderMode,t.marketTradeSide,l),$=t.marketOrderMode==="buy"?"$5-$10 USDC":`Up to $${N(w.max)} USDC`,y=!t.walletAddress||t.hasLoadedPortfolioPositions,S=We(e,n),P=Yt(e,n),U=!!P;s||(t.marketTradeSide=dt(t.marketOrderMode,t.marketTradeSide,l));let O=!s&&!S&&!U&&y&&Z(t.marketOrderMode,"yes",l),R=!s&&!S&&!U&&y&&Z(t.marketOrderMode,"no",l),le=s?!S&&!U&&y&&(t.marketOrderMode==="sell"?c:!c&&!!d):!S&&!U&&y&&Z(t.marketOrderMode,t.marketTradeSide,l),_=S?"Market resolved":P||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),de=S?"Market resolved":P||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),ce=s?x:ta(n,t.marketTradeSide,x,t.marketOrderMode,l),pe=t.marketOrderMode==="buy"?"Buy":"Exit",K=s?"Pick one outcome":o?"Arc testnet live":"Contract not deployed";k.hidden=!0,T.hidden=!1,T.classList.add("fullscreen"),document.body.classList.add("detail-mode"),dr(e),Zt(e),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&z({force:!t.hasLoadedPortfolioPositions});let De=s?!!l.optionId:l.yesSharesUsdc>0||l.noSharesUsdc>0,be="";if(s&&De&&t.walletAddress){let L=na(l,n);be=`
      ...
      <div class="trade-drawer ${t.tradeDrawerOpen?"open":""}" id="tradeDrawer">
        ...
        <div class="trade-drawer-body">
          ...
          <div class="market-action-grid">
            ${s?i.map(L=>{let D=n?.optionPools?.[L.id]||0,ye=t.marketTradeOptionId===L.id||l.optionId===L.id,ut=S||U||t.marketOrderMode==="sell"||c||!y;return`
                  <button type="button" class="market-side option ${ye?"active":""} ${ut?"disabled":""}" data-market-option-id="${M(L.id)}" ${ut?"disabled":""}>
                    <span>${M(L.label)}</span>
                    <strong>$${N(D)}</strong>
  ...
  `;let a=(l="2026-07-19T23:59:59.000Z")=>{let c=document.getElementById("seasonTimer");J&&clearInterval(J);let b=()=>{let w=new Date(l).getTime()-new Date().getTime();if(w<=0){c&&(c.innerText="Season Finished!"),J&&clearInterval(J);return}let $=Math.floor(w/(1e3*60*60*24)),y=Math.floor(w%(1e3*60*60*24)/(1e3*60*60)),S=Math.floor(w%(1e3*60*60)/(1e3*60)),P=Math.floor(w%(1e3*60)/1e3);c&&(c.innerText=`${$}d ${y}h ${S}m ${P}s`)};b(),J=setInterval(b,1e3)};a();let r=l=>l.map((c,b)=>{let x=Number(c.globalRank)||b+1,w=String(c.username||""),$=!!(t.walletAddress&&w.toLowerCase()===t.walletAddress.toLowerCase()),y=$&&t.profileUsername?t.profileUsername:c.displayName||w,S=$?`${t.profileUsername?y:j(w)} (You)`:y.startsWith("0x")&&y.length===42?j(y):y,P=M(S),U=M(Ve(c.status)),O=c.nextSeasonDivision?`Division ${c.nextSeasonDivision}`:"Qualify",R=x<=10?"promotion-zone":"safety-zone",le=x<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
    ...
    `)},i=()=>{n("global");let l=document.getElementById("leaderboardListContainer"),c="global",b=kt(c);b&&l?(l.innerHTML=St()+r(b.players),b.seasonEndsAt&&a(b.seasonEndsAt)):s(10);let x=new URLSearchParams;t.walletAddress&&x.set("walletAddress",t.walletAddress);let w=x.toString();fetch(E(`/api/leaderboard/global${w?`?${w}`:""}`)).then($=>$.json()).then($=>{let y=wt($.players||[],b?.players||[],!0);l&&(l.innerHTML=y.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players on the global leaderboard yet.</p>`:r(y)),Qe(c,{players:y,seasonEndsAt:$.seasonEndsAt}),a($.seasonEndsAt)}).catch($=>{console.error("Failed to load global leaderboard:",$),l&&(l.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading global leaderboard. Please try again.</p>`)})},d=l=>{n("division");let c=document.getElementById("leaderboardListContainer"),b=`division_${l||ke||"current"}`,x=kt(b);x&&c?(c.innerHTML=St()+o(x.players),x.divisionNumber&&(ke=x.divisionNumber),x.seasonEndsAt&&a(x.seasonEndsAt)):c&&l!==void 0&&(c.innerHTML=`
      ...
      `);let w=new URLSearchParams;t.walletAddress&&w.set("walletAddress",t.walletAddress),l&&w.set("division",String(l));let $=w.toString();fetch(E(`/api/leaderboard/division${$?`?${$}`:""}`)).then(y=>y.json()).then(y=>{let S=y.divisionNumber||1,P=wt(y.players||[],x?.players||[],!1),U=y.totalDivisions||1,O=y.seasonEndsAt;ke=S;let R=document.getElementById("divisionTitleText");R&&(R.innerText=`Division ${S}`);let le=document.getElementById("divisionSelector");le&&(le.innerHTML=Array.from({length:U},(_,de)=>de+1).map(_=>`
            <option value="${_}" ${_===S?"selected":""}>Division ${_}</option>
          `).join("")),c&&(P.length===0?c.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No active players in this division.</p>`:c.innerHTML=P.map((_,de)=>{let ce=de+1,pe=t.walletAddress&&_.username.toLowerCase()===t.walletAddress.toLowerCase(),K=pe&&t.profileUsername?t.profileUsername:_.displayName||_.username,pt=M(Ve(_.status)),De=pe?`${t.profileUsername?K:j(_.username)} (You)`:K.startsWith("0x")&&K.length===42?j(K):K,be=M(De),L="safety-zone",D='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return ce<=2?(L="promotion-zone",D='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):ce>=5&&(L="relegation-zone",D='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
      ...
      <article class="portfolio-position-card">
        ...
        <div class="portfolio-position-footer">
          ...
          ${b?S?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':P?'<button type="button" class="connect-wallet-btn" disabled style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; opacity: 0.7 !important; cursor: wait !important;">Claiming...</button>':x?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${N($)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>':""}
        </div>
      </article>
    `}let o=Mr(r?.outcome),n=aa(a,r),s=n.reduce((c,b)=>Math.max(c,b.payout),0),i=a.yesSharesUsdc+a.noSharesUsdc,d=r?.outcome??0,u=He().has(e.id),f=d===1?a.yesSharesUsdc:d===2?a.noSharesUsdc:0,m=d===1?r?.yesSharesUsdc??0:d===2?r?.noSharesUsdc??0:0,p=r?.volumeUsdc??0,h=f>0&&m>0?f/m*p:0,l=d===0?"":u?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':h>0?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${N(h)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>';return`
    <article class="portfolio-position-card">
      <div class="portfolio-position-top">
        <span class="category-chip ${e.category}">${q(e.category)}</span>
        <span>${o}</span>
