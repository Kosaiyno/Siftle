...
`,mr=(e=4)=>`${ve("Loading stories")}${Array.from({length:e},ur).join("")}`,ge=()=>`
...
`,xt=e=>{let a=e.type==="tweet",r=a?`<a class="card-source-button twitter-btn" href="${e.sourceUrl}" target="_blank" rel="noreferrer" onclick="event.stopPropagation()">Open Tweet</a>`:`
  ...
  `},he=()=>{if(!x)return;let e=Ia();if(x.hidden=!!(t.selectedStoryId||t.selectedThreadUrl),t.isLoading){x.innerHTML=mr(4);return}let a=Number(t.unlockConfig?.amountUsdc)||.001,r=M(t.newsSearchQuery.trim()),s=`
...
`},Sr=async(e,a)=>{if(!t.walletAddress){y("Session expired or wallet not connected. Please sign in."),Fe();return}let r=Le().find(f=>f.id===e);if(!r||!oe(r))return;let o=ie(r).find(f=>f.id===a);if(!o){y("Choose a valid option.");return}!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",h(),await j(),t.marketTradeStatus=null);let s=t.marketSnapshots[r.id];if(We(r,s)){y("This market is resolved and can no longer be traded.");return}let n=t.marketPositions[r.id],i=t.marketOrderMode==="sell";if(!i&&n?.optionId){y("Your pick is already locked for this market.");return}if(i&&!n?.optionId){y("You do not have a pick to exit.");return}let l=Math.max(0,Number(n?.optionSharesUsdc)||0);if(i&&l<=0){y("Your pick is still loading. Please try again."),await j({force:!0});return}let u=i?l:Ie(Number(t.marketTradeAmount)||0,"buy","yes",void 0);t.marketTradeAmount=u,t.marketTradeOptionId=i&&n?.optionId||o.id,C("trade_attempt");try{t.marketTradeStatus=i?"Exiting your pick...":"Locking your pick...",h(),await ha(r.id,i?"sell":"buy",i&&n?.optionId||o.id,u,f=>{t.marketTradeStatus=f,h()}),delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await Ne(),t.walletAddress&&(t.walletBalance=await X(t.walletAddress)),await j({force:!0}),C(i?"trade_sell_success":"trade_buy_success"),y(i?"Pick exited":`Pick locked: ${o.label}`),t.tradeDrawerOpen=!1}catch(f){C("trade_failed"),y(f instanceof Error?f.message:"Trade failed")}finally{t.marketTradeStatus=null,B(),h()}},xr=()=>{if(!$||!x)return;let e=t.stories.find(o=>o.sourceUrl===t.selectedThreadUrl);if(x.hidden=!0,$.hidden=!1,$.classList.add("fullscreen"),document.body.classList.add("detail-mode"),!e){$.innerHTML="";return}let a=t.loadingThreadUrl===e.sourceUrl,r=t.activeThread;if(a&&!r){$.innerHTML=`
  ...
  `},Ar=e=>{let a=ze(e),o=t.marketSnapshots[e.id]?.yesPriceCents??e.probability,s=100-o,n=a.evidence[0],i=n?n.headline:"No updates yet",l=`${window.location.origin}${window.location.pathname}#market-${e.id}`;return`\u{1F6A8} *Siftle Market Alert* \u{1F6A8}
...
Trade and discuss here: ${l}`},Mr=e=>{if(!x||!$)return;let a=ze(e),r=!t.checkedMarketEvidence[e.id],o=G(e),s=t.marketSnapshots[e.id],n=oe(e),i=ie(e);n&&!t.marketTradeOptionId&&(t.marketTradeOptionId=i[0]?.id||null);let l=Va(e),u=!!(o&&!s),f=s?.yesPriceCents??(o?e.probability:0),m=s?.noPriceCents??(o?100-e.probability:0),p=u?"":o?`${f}\xA2`:"--",g=u?"":o?`${m}\xA2`:"--",c=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},d=!!c.optionId;n&&d&&t.marketOrderMode!=="sell"&&(t.marketOrderMode="sell"),n&&!d&&t.marketOrderMode==="sell"&&(t.marketOrderMode="buy");let v=n&&t.marketOrderMode==="sell"&&d?Math.max(0,Number(c.optionSharesUsdc)||0):0,k=v>0?v:Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,c),w=v>0?{min:0,max:v}:Zt(t.marketOrderMode,t.marketTradeSide,c),T=t.marketOrderMode==="buy"?"$5-$10 USDC":`Up to $${O(w.max)} USDC`,b=!t.walletAddress||t.hasLoadedPortfolioPositions,S=We(e,s),U=qt(e,s),P=!!U;n||(t.marketTradeSide=ct(t.marketOrderMode,t.marketTradeSide,c));let N=!n&&!S&&!P&&b&&Z(t.marketOrderMode,"yes",c),R=!n&&!S&&!P&&b&&Z(t.marketOrderMode,"no",c),de=n?!S&&!P&&b&&(t.marketOrderMode==="sell"?d:!d&&!!l):!S&&!P&&b&&Z(t.marketOrderMode,t.marketTradeSide,c),_=S?"Market resolved":U||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),ce=S?"Market resolved":U||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),pe=n?k:Xt(s,t.marketTradeSide,k,t.marketOrderMode,c),ue=t.marketOrderMode==="buy"?"Buy":"Exit",K=n?"Pick one outcome":o?"Arc testnet live":"Contract not deployed";x.hidden=!0,$.hidden=!1,$.classList.add("fullscreen"),document.body.classList.add("detail-mode"),nr(e),Vt(e),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&j({force:!t.hasLoadedPortfolioPositions});let Be=n?!!c.optionId:c.yesSharesUsdc>0||c.noSharesUsdc>0,ye="";if(n&&Be&&t.walletAddress){let L=oa(c,s);ye=`
        ...
        <div class="market-detail-main">
          ...
          <section class="market-evidence-thread">
            ...
            <div class="market-thread-timeline">
              ${r?gr(3):a.evidence.length===0?'<div class="portfolio-empty compact">Related news is still loading for this market.</div>':a.evidence.map(L=>{let D=Ft(e,L),be=t.unlockingSummaryUrl===L.sourceUrl;return`
                <article class="market-thread-update">
                  ...
                  <div class="market-thread-update-content">
                    ...
                    <div style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
                      ...
                      <button type="button" class="market-thread-source-link" data-unlock-briefing-url="${encodeURIComponent(L.sourceUrl)}" ${be?"disabled":""}>${be?"Preparing...":"AI briefing"}</button>
                    </div>
                    ${Ee(D)}
                    ${be?`<div style="margin-top: 12px;">${ge()}</div>`:re(D)?t.loadingSummaryUrl===L.sourceUrl?`<div style="margin-top: 12px;">${ge()}</div>`:it(D)?`<div style="margin-top: 12px;">${lt(D)}</div>`:`<div style="margin-top: 12px;">${ot(ae(D,t.aiSummaries[L.sourceUrl]),D)}</div>`:""}
                  </div>
                </article>
              `}).join("")}
            </div>
      ...
      <div class="trade-drawer ${t.tradeDrawerOpen?"open":""}" id="tradeDrawer">
        ...
        <div class="trade-drawer-body">
          ...
          <div class="market-action-grid">
            ${n?i.map(L=>{let D=s?.optionPools?.[L.id]||0,be=t.marketTradeOptionId===L.id||c.optionId===L.id,mt=S||P||t.marketOrderMode==="sell"||d||!b;return`
                  <button type="button" class="market-side option ${be?"active":""} ${mt?"disabled":""}" data-market-option-id="${M(L.id)}" ${mt?"disabled":""}>
                    <span>${M(L.label)}</span>
                    <strong>$${O(D)}</strong>
  ...
  `;let a=(c="2026-07-19T23:59:59.000Z")=>{let d=document.getElementById("seasonTimer");J&&clearInterval(J);let v=()=>{let w=new Date(c).getTime()-new Date().getTime();if(w<=0){d&&(d.innerText="Season Finished!"),J&&clearInterval(J);return}let T=Math.floor(w/(1e3*60*60*24)),b=Math.floor(w%(1e3*60*60*24)/(1e3*60*60)),S=Math.floor(w%(1e3*60*60)/(1e3*60)),U=Math.floor(w%(1e3*60)/1e3);d&&(d.innerText=`${T}d ${b}h ${S}m ${U}s`)};v(),J=setInterval(v,1e3)};a();let r=c=>c.map((d,v)=>{let k=Number(d.globalRank)||v+1,w=String(d.username||""),T=!!(t.walletAddress&&w.toLowerCase()===t.walletAddress.toLowerCase()),b=T&&t.profileUsername?t.profileUsername:d.displayName||w,S=T?`${t.profileUsername?b:F(w)} (You)`:b.startsWith("0x")&&b.length===42?F(b):b,U=M(S),P=M(Ve(d.status)),N=d.nextSeasonDivision?`Division ${d.nextSeasonDivision}`:"Qualify",R=k<=10?"promotion-zone":"safety-zone",de=k<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
    ...
    `}).join(""),o=c=>c.map((d,v)=>{let k=v+1,w=String(d.username||""),T=!!(t.walletAddress&&w.toLowerCase()===t.walletAddress.toLowerCase()),b=T&&t.profileUsername?t.profileUsername:d.displayName||w,S=M(Ve(d.status)),U=T?`${t.profileUsername?b:F(w)} (You)`:b.startsWith("0x")&&b.length===42?F(b):b,P=M(U),N="safety-zone",R='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return k<=2?(N="promotion-zone",R='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):k>=5&&(N="relegation-zone",R='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
    ...
    `)},i=()=>{s("global");let c=document.getElementById("leaderboardListContainer"),d="global",v=kt(d);v&&c?(c.innerHTML=St()+r(v.players),v.seasonEndsAt&&a(v.seasonEndsAt)):n(10);let k=new URLSearchParams;t.walletAddress&&k.set("walletAddress",t.walletAddress);let w=k.toString();fetch(I(`/api/leaderboard/global${w?`?${w}`:""}`)).then(T=>T.json()).then(T=>{let b=wt(T.players||[],v?.players||[],!0);c&&(c.innerHTML=b.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players on the global leaderboard yet.</p>`:r(b)),Qe(d,{players:b,seasonEndsAt:T.seasonEndsAt}),a(T.seasonEndsAt)}).catch(T=>{console.error("Failed to load global leaderboard:",T),c&&(c.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading global leaderboard. Please try again.</p>`)})},l=c=>{s("division");let d=document.getElementById("leaderboardListContainer"),v=`division_${c||we||"current"}`,k=kt(v);k&&d?(d.innerHTML=St()+o(k.players),k.divisionNumber&&(we=k.divisionNumber),k.seasonEndsAt&&a(k.seasonEndsAt)):d&&c!==void 0&&(d.innerHTML=`
      ...
      `);let w=new URLSearchParams;t.walletAddress&&w.set("walletAddress",t.walletAddress),c&&w.set("division",String(c));let T=w.toString();fetch(I(`/api/leaderboard/division${T?`?${T}`:""}`)).then(b=>b.json()).then(b=>{let S=b.divisionNumber||1,U=wt(b.players||[],k?.players||[],!1),P=b.totalDivisions||1,N=b.seasonEndsAt;we=S;let R=document.getElementById("divisionTitleText");R&&(R.innerText=`Division ${S}`);let de=document.getElementById("divisionSelector");de&&(de.innerHTML=Array.from({length:P},(_,ce)=>ce+1).map(_=>`
            <option value="${_}" ${_===S?"selected":""}>Division ${_}</option>
          `).join("")),d&&(U.length===0?d.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No active players in this division.</p>`:d.innerHTML=U.map((_,ce)=>{let pe=ce+1,ue=t.walletAddress&&_.username.toLowerCase()===t.walletAddress.toLowerCase(),K=ue&&t.profileUsername?t.profileUsername:_.displayName||_.username,ut=M(Ve(_.status)),Be=ue?`${t.profileUsername?K:F(_.username)} (You)`:K.startsWith("0x")&&K.length===42?F(K):K,ye=M(Be),L="safety-zone",D='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return pe<=2?(L="promotion-zone",D='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):pe>=5&&(L="relegation-zone",D='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
    ...
    <article class="portfolio-position-card">
      ...
      <h2>${e.question}</h2>
      <div class="portfolio-position-stats">
        <div><span>Projected payout</span><strong>$${O(n)}</strong></div>
        ${s.map(d=>`
          <div><span>${d.label}</span><strong>${O(d.shares)}</strong></div>
        `).join("")}
      </div>
      <div class="portfolio-position-footer">
  ...
  `},Ur=async e=>{if(!t.walletAddress){y("Please sign in first.");return}let a=Le().find(o=>o.id===e),r=a?G(a):"";if(!a||!r){y("Market is not available.");return}try{t.claimingMarketIds[a.id]=!0,z(),C("claim_attempt"),pt();let o=await va(r,t.walletAddress);C("claim_success"),o.won&&er(a.id),delete t.marketPositions[a.id],delete t.marketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.walletBalance=await X(t.walletAddress),await j(),y(o.won?`Claimed $${O(o.amountUsdc)}`:"No payout to claim"),B(),z()}catch(o){C("claim_failed"),y(o instanceof Error?o.message:"Claim failed")}finally{delete t.claimingMarketIds[a.id],z()}},Pr=e=>{if(!e)return"";let a=t.referralData,r=a?.referrals?.length?a.referrals.map(s=>{let n=s.displayName||F(s.walletAddress),i=s.remaining<=0;return`
        <div class="portfolio-referral-row">
          <div class="portfolio-referral-person">
            <strong>${M(n)}</strong>
            <span>${F(s.walletAddress)}</span>
          </div>
    ...
    <section class="portfolio-surface">
          ...
          <div class="profile-details" style="display: flex !important; flex-direction: column !important; min-width: 0 !important;">
            ...
            ${n?`
              <div class="wallet-address-row" style="display: flex !important; align-items: center !important; gap: 8px !important; margin-top: 4px !important;">
                <small style="color: var(--market-text-muted) !important; font-family: monospace !important; font-size: 0.78rem !important;">${F(t.walletAddress)}</small>
      ...
      ${t.loadingPortfolioPositions?hr(2):t.walletAddress?r.length===0?'<div class="portfolio-empty">No positions found for this wallet yet. Confirmed trades will appear here after the Arc transaction settles.</div>':`
              <section class="portfolio-position-section">
                ...
                ${o.length?o.map(Ut).join(""):'<div class="portfolio-empty compact">No open positions.</div>'}
              </section>
              <section class="portfolio-position-section">
                <h2>Finalized</h2>
                ${s.length?s.map(Ut).join(""):'<div class="portfolio-empty compact">No finalized positions yet.</div>'}
              </section>
            `:'<div class="portfolio-empty">Connect your wallet to see open and finalized market positions.</div>'}
    </section>
  `},h=()=>{if(Nt.forEach(e=>{let a=e.dataset.bottomNav;e.classList.toggle("active",a==="saved"?t.showSaved:a===t.activeSurface&&!t.showSaved)}),t.activeSurface==="markets"){la();return}if(t.activeSurface==="portfolio"){z();return}if(t.activeSurface==="leaderboard"){da();return}ca(),Gt(),he(),$r(),q&&(q.value=t.activeArchiveDate??"")};Xe.textContent=Ht();te?.addEventListener("click",e=>{let r=e.target.closest("[data-category]");r&&(t.activeCategory=r.dataset.category,window.history.pushState({},"","#feed"),Y(),h(),qe(),ne(t.activeCategory))});x?.addEventListener("input",e=>{let a=e.target;if(a.id!=="newsSearchInput")return;let r=a.selectionStart??a.value.length,o=a.selectionEnd??a.value.length;t.newsSearchQuery=a.value,he();let s=x?.querySelector("#newsSearchInput");s&&(s.focus(),s.setSelectionRange(r,o))});Ue?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,window.history.pushState({},"","#markets"),Y(),h()});Pe?.addEventListener("click",()=>{t.activeSurface="feed",t.showSaved=!1,window.history.pushState({},"","#feed"),Y(),h(),qe(),ne(t.activeCategory)});Ce?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=!1,window.history.pushState({},"","#portfolio"),Y(),h()});Q?.addEventListener("click",()=>{t.walletAddress?(window.location.hash="#portfolio",se()):Fe()});document.addEventListener("click",e=>{let a=e.target,r=a.closest(".copy-address-btn");if(r){let i=r.getAttribute("data-address");i&&navigator.clipboard.writeText(i).then(()=>{y("Wallet address copied!")})}let o=a.closest("[data-claim-market]");if(o){let i=o.getAttribute("data-claim-market");i&&Ur(i);return}if(a.closest("[data-open-referrals]")){t.referralPanelOpen=!t.referralPanelOpen,!t.referralData&&!t.loadingReferralData&&Ae(),z();return}if(a.closest("[data-close-referrals]")){t.referralPanelOpen=!1,z();return}if(a.closest("[data-refresh-referrals]")){t.referralError=null,Ae(),z();return}let s=a.closest("[data-copy-referral-code]");if(s){let i=s.getAttribute("data-copy-referral-code")||"";i&&navigator.clipboard.writeText(i).then(()=>y("Invite code copied"));return}let n=a.closest("[data-copy-referral-link]");if(n){let i=n.getAttribute("data-copy-referral-link")||"";i&&navigator.clipboard.writeText(i).then(()=>y("Invite link copied"));return}a.closest("[data-connect-wallet]")&&(t.walletAddress?Et():Fe())});Nt.forEach(e=>{e.addEventListener("click",()=>{let a=e.dataset.bottomNav;t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=a==="saved",a==="markets"?(t.activeSurface="markets",window.history.pushState({},"","#markets")):a==="portfolio"?(t.activeSurface="portfolio",window.history.pushState({},"","#portfolio")):a==="leaderboard"?(t.activeSurface="leaderboard",window.history.pushState({},"","#leaderboard")):(t.activeSurface="feed",window.history.pushState({},"","#feed"),qe(),ne(t.activeCategory),a==="saved"&&(Za(),rt(),Te())),Y(),h()})});q?.addEventListener("change",()=>{t.activeArchiveDate=q.value||null,window.history.pushState({},"","#feed"),Y(),h(),ne(t.activeCategory)});Ua?.addEventListener("click",()=>{t.activeArchiveDate=null,q&&(q.value=""),window.history.pushState({},"","#feed"),Y(),h(),ne(t.activeCategory)});x?.addEventListener("click",async e=>{let a=e.target;if(a.closest("#editUsernameBtn")){let d=x?.querySelector(".username-display-row"),v=x?.querySelector("#usernameEditForm");if(d&&v){d.style.display="none",v.style.display="flex";let k=v.querySelector("#usernameInput");k&&k.focus()}return}if(a.closest("#cancelUsernameBtn")){let d=x?.querySelector(".username-display-row"),v=x?.querySelector("#usernameEditForm");d&&v&&(d.style.display="flex",v.style.display="none");return}let s=a.closest("#saveUsernameBtn");if(s){let v=x?.querySelector("#usernameEditForm")?.querySelector("#usernameInput");if(v){let k=v.value.trim().slice(0,15),w=s,T=w.textContent||"Save";w.disabled=!0,w.textContent="Saving...",Qa(k),t.profileNotice=null;try{t.walletAddress&&await le(!1),t.profileNotice={type:"success",message:"Username saved to your shared leaderboard profile."},y("Username updated"),z()}catch(b){let S=b instanceof Error?b.message:"Username save failed";t.profileNotice={type:"error",message:S},y(S),w.disabled=!1,w.textContent=T,z()}}return}let n=a.closest("[data-timeframe]");if(n){let d=n.dataset.timeframe;t.activeMarketTimeframe=d,la();return}let i=a.closest("[data-market-id]");if(i){t.selectedMarketId=i.dataset.marketId??null,C("market_view"),window.history.pushState({},"",`#market-${t.selectedMarketId}`),h(),window.scrollTo({top:0,behavior:"smooth"});return}let l=a.closest("[data-thread-story-id]"),u=a.closest("[data-export-id]"),f=a.closest("[data-export-action]"),m=a.closest("[data-story-id]");if(l){e.stopPropagation();let d=t.stories.find(v=>v.id===Number(l.dataset.threadStoryId));d&&ja(d);return}let p=a.closest(".mobile-bookmark-btn, .bookmark-button");if(p){e.stopPropagation();let d=p.dataset.bookmarkUrl||"",v=t.stories.find(k=>k.sourceUrl===d);if(!v)return;v.saved=!v.saved,v.saved?ee.add(d):ee.delete(d),La(),y(v.saved?"Saved to your list":"Removed from saved"),he();return}if(f){e.stopPropagation(),wr(Number(f.dataset.exportStoryId),f.dataset.exportAction);return}if(u){e.stopPropagation();let d=Number(u.dataset.exportId);t.activeShareStoryId=t.activeShareStoryId===d?null:d,he();return}if(!m||a.closest("a"))return;let g=Number(m.dataset.storyId),c=t.stories.find(d=>d.id===g);if(c&&c.type==="tweet"){e.stopPropagation(),window.open(c.sourceUrl,"_blank","noreferrer");return}zt(g,!0)});x?.addEventListener("keydown",e=>{let r=e.target.closest("[data-story-id]");if(!r||e.key!=="Enter"&&e.key!==" ")return;e.preventDefault();let o=Number(r.dataset.storyId),s=t.stories.find(n=>n.id===o);if(s&&s.type==="tweet"){window.open(s.sourceUrl,"_blank","noreferrer");return}zt(o)});$?.addEventListener("click",e=>{let a=e.target,r=a.closest("[data-unlock-briefing]");if(r){let m=t.stories.find(p=>p.id===Number(r.dataset.unlockBriefing));m&&tt(m);return}let o=a.closest("[data-unlock-briefing-url]");if(o){let m=decodeURIComponent(o.dataset.unlockBriefingUrl||""),p=Ra(m);p&&(re(p)?je(p):tt(p));return}if(a.closest("[data-back-markets]")){t.selectedMarketId=null,t.tradeDrawerOpen=!1,window.history.pushState({},"","#markets"),h();return}if(a.closest("#openTradeDrawerBtn")){let m=E.find(c=>c.id===t.selectedMarketId);if(m){if(We(m,t.marketSnapshots[m.id])){y("This market is resolved and can no longer be traded.");return}if(qt(m,t.marketSnapshots[m.id])){y("Trading is locked 20 minutes before kickoff.");return}}t.tradeDrawerOpen=!0,C("trade_drawer_open");let p=$.querySelector("#tradeDrawer"),g=$.querySelector("#tradeDrawerBackdrop");p?.classList.add("open"),g?.classList.add("open");return}if(a.closest("#closeTradeDrawerBtn")||a.closest("#tradeDrawerBackdrop")){t.tradeDrawerOpen=!1;let m=$.querySelector("#tradeDrawer"),p=$.querySelector("#tradeDrawerBackdrop");m?.classList.remove("open"),p?.classList.remove("open");return}if(a.closest("#shareWhatsAppBtn")){let m=E.find(p=>p.id===t.selectedMarketId);if(m){let p=Ar(m),g=`https://api.whatsapp.com/send?text=${encodeURIComponent(p)}`;window.open(g,"_blank")}return}let s=a.closest("[data-market-trade]");if(s&&t.selectedMarketId){let m=s.dataset.marketTrade;ir(t.selectedMarketId,m);return}let n=a.closest("[data-market-option-trade]");if(n&&t.selectedMarketId){let m=n.dataset.marketOptionTrade||t.marketTradeOptionId||"";Sr(t.selectedMarketId,m);return}let i=a.closest("[data-market-option-id]");if(i){if(i.disabled||i.classList.contains("disabled"))return;t.marketTradeOptionId=i.dataset.marketOptionId||null,h();return}let l=a.closest("[data-market-trade-side]");if(l){if(l.disabled||l.classList.contains("disabled"))return;let m=E.find(c=>c.id===t.selectedMarketId),p=m?t.marketPositions[m.id]:void 0,g=l.dataset.marketTradeSide;if(!Z(t.marketOrderMode,g,p))return;t.marketTradeSide=g,h();return}let u=a.closest("[data-market-order-mode]");if(u){t.marketOrderMode=u.dataset.marketOrderMode;let m=E.find(g=>g.id===t.selectedMarketId),p=m?t.marketPositions[m.id]:void 0;t.marketTradeSide=ct(t.marketOrderMode,t.marketTradeSide,p),t.marketTradeAmount=Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,p),h();return}a.closest("[data-back-to-feed]")&&qa()});$?.addEventListener("input",e=>{let a=e.target;if(!a.matches("[data-market-amount]"))return;let r=E.find(u=>u.id===t.selectedMarketId),o=r?t.marketSnapshots[r.id]:void 0,s=r?t.marketPositions[r.id]:void 0,n=Number(a.value);t.marketTradeAmount=Number.isFinite(n)?n:0;let i=r&&oe(r)?t.marketTradeAmount:Xt(o,t.marketTradeSide,t.marketTradeAmount,t.marketOrderMode,s),l=$.querySelector(".market-inline-payout strong");l&&(l.textContent=`$${O(i)}`)});$?.addEventListener("focusin",e=>{e.target.matches("[data-market-amount]")&&document.body.classList.add("market-amount-focused")});$?.addEventListener("focusout",e=>{let a=e.target;if(a.matches("[data-market-amount]")){let r=E.find(s=>s.id===t.selectedMarketId),o=r?t.marketPositions[r.id]:void 0;t.marketTradeAmount=Ie(Number(a.value)||0,t.marketOrderMode,t.marketTradeSide,o),a.value=String(t.marketTradeAmount),window.setTimeout(()=>document.body.classList.remove("market-amount-focused"),120)}});window.addEventListener("popstate",se);window.addEventListener("hashchange",se);window.addEventListener("focus",async()=>{if(t.walletAddress){let e=t.walletBalance,a=await X(t.walletAddress);t.walletBalance=a,B(),(!e||parseFloat(e)===0)&&parseFloat(a)>0&&(console.log("[X402] Balance changed from 0 to positive. Triggering Gateway warmup..."),ka())}});Ge?.addEventListener("click",()=>{if(!Je||!Ge)return;let e=!Je.hidden;Je.hidden=e,Ge.setAttribute("aria-expanded",String(!e))});document.addEventListener("click",e=>{let a=e.target;!a.closest(".share-control")&&t.activeShareStoryId!==null&&(t.activeShareStoryId=null,he());let r=a.closest("[data-menu-action]");if(!r)return;let o={today:"Showing today's brief",saved:`${t.stories.filter(s=>s.saved).length} saved stories`,archive:t.archiveDates.length>0?"Choose a saved day from the archive selector":"No saved days yet"};A&&(A.textContent=o[r.dataset.menuAction??"today"]),r.dataset.menuAction==="today"&&(t.showSaved=!1,t.activeArchiveDate=null,q&&(q.value=""),Y(),qe(),ne(t.activeCategory)),r.dataset.menuAction==="saved"&&(ca(),rt(),Te(),t.showSaved=!0,document.querySelector("#archiveControls")?.classList.remove("mobile-open"),Y(),h())});var Cr=async()=>{try{let e=await fetch(I("/api/summary/unlock-config"));e.ok&&(t.unlockConfig=await e.json(),h())}catch(e){console.error("Failed to prefetch unlock config:",e)}};h();B();Cr();Ma().then(()=>{sr(),B(),window.setTimeout(Dr,1200)});var Er=document.querySelector(".brand-lockup");Er?.addEventListener("click",()=>{window.location.hash="#feed"});se();var Ir=document.querySelector("#mobileArchiveCard"),fe=document.querySelector("#archiveControls");Ir?.addEventListener("click",()=>{if(!fe)return;fe.classList.toggle("mobile-open")&&setTimeout(()=>fe.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Br=document.querySelector("#archivePill");Br?.addEventListener("click",e=>{if(e.stopPropagation(),!fe)return;fe.classList.toggle("mobile-open")&&setTimeout(()=>fe.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Oe=!1,Pt=!1,Dr=()=>{Pt||(Pt=!0,(async()=>{let e=await Ne();if(Oe=!!e,e){t.walletConnecting=!0,B();try{let a=await ya();Oe=!1,t.walletConnecting=!1,a?(t.walletAddress=await Ne(),t.walletAddress&&(me(),t.walletBalance=await X(t.walletAddress),await j()),B(),t.activeSurface==="portfolio"&&h()):(t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,me(),y("Session expired. Please sign in again."),B(),h())}catch(a){console.warn(a),Oe=!1,t.walletConnecting=!1,t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,me(),y("Session expired. Please sign in again."),B(),h()}}await ba(a=>{Oe||(t.walletAddress=a,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,me(),a&&le(!1).catch(r=>console.error("Failed to report leaderboard entry:",r)),t.marketPositions={},t.hasLoadedPortfolioPositions=!1,B(),a?(Ae(),X(a).then(r=>{t.walletBalance=r,B(),t.activeSurface==="portfolio"&&h()}),j()):t.activeSurface==="portfolio"&&h())})})())};C("app_open");document.addEventListener("click",e=>{let r=e.target.closest("a, button");if(r){let o=r.className||"",s=typeof o=="string"?o:r.getAttribute("class")||"",n=r.getAttribute("href")||"";!(r.hasAttribute("data-unlock-briefing")||r.hasAttribute("data-unlock-briefing-url")||r.classList.contains("summary-btn")||r.textContent?.trim()==="AI briefing"||r.textContent?.trim().includes("Unlock via"))&&(s.includes("source-button")||s.includes("source-btn")||s.includes("source-link")||r.textContent?.trim()==="Open source")&&!s.includes("disabled")&&n!=="#"&&C("open_source")}},!0);
