...
Trade and discuss here: ${d}`},Er=e=>{if(!w||!S)return;let a=qe(e),r=!t.checkedMarketEvidence[e.id],o=G(e),s=t.marketSnapshots[e.id],n=K(e),i=Z(e);n&&!t.marketTradeOptionId&&(t.marketTradeOptionId=i[0]?.id||null);let d=er(e),u=!!(o&&!s),m=s?.yesPriceCents??(o?e.probability:0),f=s?.noPriceCents??(o?100-e.probability:0),p=u?"":o?`${m}\xA2`:"--",y=u?"":o?`${f}\xA2`:"--",l=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},c=!!l.optionId;n&&c&&t.marketOrderMode!=="sell"&&(t.marketOrderMode="sell"),n&&!c&&t.marketOrderMode==="sell"&&(t.marketOrderMode="buy");let b=n&&t.marketOrderMode==="sell"&&c?Math.max(0,Number(l.optionSharesUsdc)||0):0,k=b>0?b:Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,l),$=b>0?{min:0,max:b}:ta(t.marketOrderMode,t.marketTradeSide,l),T=t.marketOrderMode==="buy"?"$5-$10 USDC":`Up to $${R($.max)} USDC`,v=!t.walletAddress||t.hasLoadedPortfolioPositions,x=We(e,s),L=Yt(e,s),P=!!L;n||(t.marketTradeSide=mt(t.marketOrderMode,t.marketTradeSide,l));let N=!n&&!x&&!P&&v&&te(t.marketOrderMode,"yes",l),H=!n&&!x&&!P&&v&&te(t.marketOrderMode,"no",l),le=n?!x&&!P&&v&&(t.marketOrderMode==="sell"?c:!c&&!!d):!x&&!P&&v&&te(t.marketOrderMode,t.marketTradeSide,l),O=x?"Market resolved":L||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),de=x?"Market resolved":L||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),be=n?k:aa(s,t.marketTradeSide,k,t.marketOrderMode,l),ce=t.marketOrderMode==="buy"?"Buy":"Exit",Q=n?"Pick one outcome":o?"Arc testnet live":"Contract not deployed";w.hidden=!0,S.hidden=!1,S.classList.add("fullscreen"),document.body.classList.add("detail-mode"),pr(e),Xt(e),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&z({force:!t.hasLoadedPortfolioPositions});let Be=n?!!l.optionId:l.yesSharesUsdc>0||l.noSharesUsdc>0,ye="";n&&Be&&t.walletAddress?ye=`
  ...
  `;let a=(l="2026-07-19T23:59:59.000Z")=>{let c=document.getElementById("seasonTimer");J&&clearInterval(J);let b=()=>{let $=new Date(l).getTime()-new Date().getTime();if($<=0){c&&(c.innerText="Season Finished!"),J&&clearInterval(J);return}let T=Math.floor($/(1e3*60*60*24)),v=Math.floor($%(1e3*60*60*24)/(1e3*60*60)),x=Math.floor($%(1e3*60*60)/(1e3*60)),L=Math.floor($%(1e3*60)/1e3);c&&(c.innerText=`${T}d ${v}h ${x}m ${L}s`)};b(),J=setInterval(b,1e3)};a();let r=l=>l.map((c,b)=>{let k=Number(c.globalRank)||b+1,$=String(c.username||""),T=!!(t.walletAddress&&$.toLowerCase()===t.walletAddress.toLowerCase()),v=T&&t.profileUsername?t.profileUsername:c.displayName||$,x=T?`${t.profileUsername?v:j($)} (You)`:v.startsWith("0x")&&v.length===42?j(v):v,L=A(x),P=A(Ve(c.status)),N=c.nextSeasonDivision?`Division ${c.nextSeasonDivision}`:"Qualify",H=k<=10?"promotion-zone":"safety-zone",le=k<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
    ...
    `)},i=()=>{s("global");let l=document.getElementById("leaderboardListContainer"),c="global",b=xt(c);b&&l?(l.innerHTML=Tt()+r(b.players),b.seasonEndsAt&&a(b.seasonEndsAt)):n(10);let k=new URLSearchParams;t.walletAddress&&k.set("walletAddress",t.walletAddress);let $=k.toString();fetch(C(`/api/leaderboard/global${$?`?${$}`:""}`)).then(T=>T.json()).then(T=>{let v=$t(T.players||[],b?.players||[],!0);l&&(l.innerHTML=v.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players on the global leaderboard yet.</p>`:r(v)),Ze(c,{players:v,seasonEndsAt:T.seasonEndsAt}),a(T.seasonEndsAt)}).catch(T=>{console.error("Failed to load global leaderboard:",T),l&&(l.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading global leaderboard. Please try again.</p>`)})},d=l=>{s("division");let c=document.getElementById("leaderboardListContainer"),b=`division_${l||ke||"current"}`,k=xt(b);k&&c?(c.innerHTML=Tt()+o(k.players),k.divisionNumber&&(ke=k.divisionNumber),k.seasonEndsAt&&a(k.seasonEndsAt)):c&&l!==void 0&&(c.innerHTML=`
      ...
      `);let $=new URLSearchParams;t.walletAddress&&$.set("walletAddress",t.walletAddress),l&&$.set("division",String(l));let T=$.toString();fetch(C(`/api/leaderboard/division${T?`?${T}`:""}`)).then(v=>v.json()).then(v=>{let x=v.divisionNumber||1,L=$t(v.players||[],k?.players||[],!1),P=v.totalDivisions||1,N=v.seasonEndsAt;ke=x;let H=document.getElementById("divisionTitleText");H&&(H.innerText=`Division ${x}`);let le=document.getElementById("divisionSelector");le&&(le.innerHTML=Array.from({length:P},(O,de)=>de+1).map(O=>`
          ...
          `).join("")),c&&(L.length===0?c.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No active players in this division.</p>`:c.innerHTML=L.map((O,de)=>{let be=de+1,ce=t.walletAddress&&O.username.toLowerCase()===t.walletAddress.toLowerCase(),Q=ce&&t.profileUsername?t.profileUsername:O.displayName||O.username,ft=A(Ve(O.status)),Be=ce?`${t.profileUsername?Q:j(O.username)} (You)`:Q.startsWith("0x")&&Q.length===42?j(Q):Q,ye=A(Be),U="safety-zone",D='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return be<=2?(U="promotion-zone",D='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):be>=5&&(U="relegation-zone",D='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
  ...
  `},Br=async e=>{if(!t.walletAddress){h("Please sign in first.");return}let a=Me().find(o=>o.id===e),r=a?G(a):"";if(!a||!r){h("Market is not available.");return}try{t.claimingMarketIds[a.id]=!0,q(),E("claim_attempt"),ut();let o=await ya(r,t.walletAddress);E("claim_success"),o.won&&or(a.id),delete t.marketPositions[a.id],delete t.marketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.walletBalance=await ae(t.walletAddress),await z(),h(o.won?`Claimed $${R(o.amountUsdc)}`:"No payout to claim"),B(),q()}catch(o){E("claim_failed"),h(o instanceof Error?o.message:"Claim failed")}finally{delete t.claimingMarketIds[a.id],q()}},Dr=e=>{if(!e)return"";let a=t.referralData,r=a?.referrals?.length?a.referrals.map(s=>{let n=s.displayName||j(s.walletAddress),i=s.remaining<=0;return`
