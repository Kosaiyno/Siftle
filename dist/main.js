import"./chunks/chunk-ZUUPKAA6.js";var me="Sports",De=[{id:"wc-portugal-spain-qualify",category:me,timeframe:"Daily",optionMarket:!0,question:"Which team will qualify in Portugal vs Spain?",options:[{id:"portugal",label:"Portugal"},{id:"spain",label:"Spain"}],probability:0,kickoffAt:"2026-07-06T19:00:00Z",closes:"Jul 6, 7:40 PM GMT+1",resolution:"One option resolves correct based on the team that officially qualifies in Portugal vs Spain, including extra time and penalties.",threadTopic:"Portugal vs Spain Qualify Watch",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-ronaldo-header-spain",category:me,timeframe:"Daily",optionMarket:!0,question:"Will Cristiano Ronaldo score a header vs Spain?",options:[{id:"yes",label:"Yes"},{id:"no",label:"No"}],probability:0,kickoffAt:"2026-07-06T19:00:00Z",closes:"Jul 6, 7:40 PM GMT+1",resolution:"Resolves Yes if Cristiano Ronaldo is officially credited with a headed goal for Portugal against Spain in regular time or extra time. Penalty shootout goals do not count. Otherwise resolves No.",threadTopic:"Ronaldo Header Watch vs Spain",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-usa-belgium-qualify",category:me,timeframe:"Daily",optionMarket:!0,question:"Which team will qualify in USA vs Belgium?",options:[{id:"usa",label:"USA"},{id:"belgium",label:"Belgium"}],probability:0,kickoffAt:"2026-07-07T00:00:00Z",closes:"Jul 7, 12:40 AM GMT+1",resolution:"One option resolves correct based on the team that officially qualifies in USA vs Belgium, including extra time and penalties.",threadTopic:"USA vs Belgium Qualify Watch",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-usa-goals-belgium",category:me,timeframe:"Daily",optionMarket:!0,question:"How many goals will USA score in regular + extra time vs Belgium?",options:[{id:"0",label:"0 goals"},{id:"1",label:"1 goal"},{id:"2",label:"2 goals"},{id:"3-plus",label:"3+ goals"}],probability:0,kickoffAt:"2026-07-07T00:00:00Z",closes:"Jul 7, 12:40 AM GMT+1",resolution:"One option resolves correct based on the number of goals officially scored by the United States against Belgium in regular time and extra time. Penalty shootout goals do not count.",threadTopic:"USA Goals vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-tonali-spurs",category:me,timeframe:"Sagas",question:"Will Sandro Tonali sign with Tottenham Hotspur in the Summer Transfer Window?",probability:58,closes:"September 1, 2026",resolution:"Resolves Yes if Tottenham Hotspur officially announces the transfer/signing of Sandro Tonali by the transfer deadline.",threadTopic:"Sandro Tonali Tottenham Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$182K",traders:"980",liquidity:"$29K",imageUrl:"https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-guimaraes-arsenal",category:me,timeframe:"Sagas",question:"Will Bruno Guimaraes officially sign with Arsenal by September 1, 2026?",probability:45,closes:"September 1, 2026",resolution:"Resolves Yes if Arsenal officially announces the transfer/signing of Bruno Guimaraes by the transfer deadline.",threadTopic:"Bruno Guimaraes Arsenal Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$204K",traders:"1,240",liquidity:"$36K",imageUrl:"https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=1200&q=80",evidence:[]}];var Ze="https://faucet.circle.com/",mt="siftle_backend_wallet_migration_notice",Ye=null,H=()=>(Ye||(Ye=import("./chunks/arc-ZAE4BJZI.js")),Ye),q=e=>e.length>10?`${e.slice(0,6)}...${e.slice(-4)}`:e,ma=async()=>(await H()).connectArcWallet(),X=async e=>(await H()).readArcUsdcBalance(e),fa=async(e,a,r,o)=>(await H()).payAiBriefingUnlock(e,a,r,o),ga=e=>{H().then(a=>a.resolveLocalTestMarketYes(e))},ha=async e=>(await H()).readArcMarketSnapshot(e);var It=async(e,a)=>(await H()).readArcMarketState(e,a),va=async(e,a,r,o,n,s,i)=>(await H()).executeArcMarketOrder(e,a,r,o,n,s,i),ba=async(e,a,r,o,n)=>(await H()).executeArcOptionMarketOrder(e,a,r,o,n),Bt=()=>{H().then(e=>e.disconnectArcWallet())},ya=async(e,a)=>(await H()).claimArcMarketPayout(e,a),Oe=async()=>(await H()).getConnectedArcWallet(),ka=async()=>(await H()).validateArcSession(),wa=async e=>(await H()).subscribeArcWallet(e),Sa=async()=>(await H()).triggerGatewayWarmup(),xa=["Sports"],$a="https://siftle.onrender.com",Ta=()=>{let e=(window.SIFTLE_API_BASE||"").replace(/\/$/,"");if(e)return e;let a=typeof window<"u"?window.location.hostname.toLowerCase():"";return a==="siftle.xyz"||a.endsWith(".siftle.xyz")||a.endsWith(".vercel.app")?$a:""},Aa=Ta(),E=e=>`${Aa}${e}`,Dt="siftle_theme",Ma=()=>{try{return window.localStorage.getItem(Dt)==="light"?"light":"dark"}catch{return"dark"}},Te=Ma();function C(e){fetch(E("/api/analytics"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:e})}).catch(a=>console.error("Failed to track event:",a))}var t={activeSurface:"markets",profileUsername:null,selectedMarketId:null,marketOrderMode:"buy",marketTradeSide:"yes",marketTradeOptionId:null,marketTradeAmount:5,marketSnapshots:{},marketPositions:{},marketEvidenceOverrides:{},loadingMarkets:!0,checkedMarketEvidence:{},checkedMarketSnapshots:{},loadingMarketSnapshots:{},loadingMarketEvidence:{},loadingPortfolioPositions:!1,marketTradeStatus:null,hasLoadedPortfolioPositions:!1,walletConnecting:!1,walletAddress:null,walletBalance:null,activeCategory:"Sports",stories:[],isLoading:!1,selectedStoryId:null,aiSummaries:{},loadingSummaryUrl:null,unlockingSummaryUrl:null,archiveDates:[],activeArchiveDate:null,activeShareStoryId:null,selectedThreadUrl:null,activeThread:null,loadingThreadUrl:null,feedScrollY:0,hasLoadedFeed:!1,showSaved:!1,tradeDrawerOpen:!1,activeMarketTimeframe:"All",profileNotice:null,portfolioMarketPreviews:[],referralPanelOpen:!1,referralData:null,referralError:null,loadingReferralData:!1,portfolioPositionsLoadedAt:0,unlockConfig:null,newsSearchQuery:"",briefingStatusByUrl:{},claimingMarketIds:{}},we=null,V="global",J=null,ft=!1;var gt=new URLSearchParams(window.location.search).get("ref")||localStorage.getItem("siftle_pending_referral_code")||"";gt&&localStorage.setItem("siftle_pending_referral_code",gt.trim().toUpperCase());var Nt=20,I=De,La=(...e)=>{let a=new Map;return e.flat().forEach(r=>{r?.id&&a.set(r.id,{...a.get(r.id)||{},...r})}),Array.from(a.values())},Le=()=>La(t.portfolioMarketPreviews,I,De),Ua=async()=>{t.loadingMarkets=!0,I.length===0&&(I=De);try{let e=new AbortController,a=window.setTimeout(()=>e.abort(),3500),r=await fetch(E("/api/markets"),{signal:e.signal});if(window.clearTimeout(a),r.ok){let o=await r.json();Array.isArray(o)&&o.length>0&&(I=o)}}catch(e){console.error("Failed to load markets:",e)}finally{t.loadingMarkets=!1}},Ot=async()=>{try{let e=await fetch(E("/api/portfolio/markets"));if(!e.ok)return;let a=await e.json();Array.isArray(a)&&(t.portfolioMarketPreviews=a.map(r=>({threadStoryId:0,updates:0,movement:0,evidence:[],...r})))}catch(e){console.warn(e)}},_t="siftle.savedUrls",ee=new Set,at=()=>{try{let e=localStorage.getItem(_t)||"[]",a=JSON.parse(e);ee=new Set(a.filter(Boolean))}catch{ee=new Set}},Pa=()=>{try{localStorage.setItem(_t,JSON.stringify(Array.from(ee)))}catch{}},Ae=()=>{if(Array.isArray(t.stories))for(let e of t.stories)e.saved=!!ee.has(e.sourceUrl)};at();Ae();var Xe=document.querySelector("#dateLabel"),te=document.querySelector("#categoryTabs"),k=document.querySelector("#storyList"),T=document.querySelector("#storyDetail"),Ge=document.querySelector("#menuButton"),Je=document.querySelector("#menuPanel"),A=document.querySelector("#menuStatus"),F=document.querySelector("#archiveDateSelect"),ht=document.querySelector("#archiveStatus"),Ca=document.querySelector("#todayButton"),He=document.querySelector(".brief-hero"),Re=document.querySelector("#archiveControls"),Ue=document.querySelector("[data-surface='markets']"),Pe=document.querySelector("[data-surface='feed']"),Ce=document.querySelector("[data-surface='portfolio']"),Q=document.querySelector("#walletButton"),Se=document.querySelector("[data-theme-toggle]"),Ht=Array.from(document.querySelectorAll("[data-bottom-nav]")),Ke,Ea=()=>{if(!Se)return;let a=`Switch to ${Te==="light"?"dark":"light"} mode`;Se.setAttribute("aria-label",a),Se.title=a,Se.dataset.activeTheme=Te},Rt=e=>{Te=e,document.documentElement.dataset.theme=e;try{window.localStorage.setItem(Dt,e)}catch{}Ea()};Rt(Te);var B=()=>{if(Q){let e=Q.querySelector(".wallet-button-label");Q.classList.toggle("connected",!!t.walletAddress),Q.disabled=t.walletConnecting,Q.setAttribute("aria-label",t.walletAddress?`Wallet ${q(t.walletAddress)}`:"Sign in"),e&&(e.textContent=t.walletConnecting?"Signing in...":t.walletAddress?"Wallet":"Sign in"),Q.title=t.walletAddress?`${t.walletBalance??"0"} Arc Testnet USDC - ${q(t.walletAddress)}`:"Sign in"}};window.addEventListener("resize",B);Se?.addEventListener("click",()=>{Rt(Te==="light"?"dark":"light")});var Ia=async e=>{let a=localStorage.getItem("siftle_pending_referral_code");if(a)try{let r=await fetch(E("/api/referrals/bind"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:e,referralCode:a})}),o=await r.json().catch(()=>({}));r.ok&&(o.bound||o.reason==="already_bound"||o.reason==="invalid_code")&&(localStorage.removeItem("siftle_pending_referral_code"),o.bound&&v("Referral connected"))}catch(r){console.warn(r)}},Me=async()=>{if(!(!t.walletAddress||t.loadingReferralData)){t.loadingReferralData=!0,t.referralError=null;try{let e=await fetch(E(`/api/referrals?walletAddress=${encodeURIComponent(t.walletAddress)}`)),a=await e.json().catch(()=>({}));e.ok?t.referralData=a:t.referralError=a?.error||"Referral tools are temporarily unavailable."}catch(e){console.warn(e),t.referralError="Referral tools are temporarily unavailable."}finally{t.loadingReferralData=!1,t.activeSurface==="portfolio"&&W()}}},qe=async()=>{if(!t.walletConnecting){t.walletConnecting=!0,C("wallet_connect_start"),B();try{let e=await ma();if(e){C("wallet_connect_success"),t.walletAddress=e,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,fe(),t.walletBalance=await X(e),await Ia(e),Me(),await z(),le(!0).catch(r=>console.error("Failed to report leaderboard entry:",r));let a=localStorage.getItem(mt);a?(localStorage.removeItem(mt),v(a)):v("Connected to Arc Testnet"),window.location.hash="#portfolio",se()}}catch(e){C("wallet_connect_failed"),v(e instanceof Error?e.message:"Wallet connection failed")}finally{t.walletConnecting=!1,B()}}},v=e=>{let a=document.querySelector("#actionToast");a||(a=document.createElement("div"),a.id="actionToast",a.className="action-toast",a.setAttribute("role","status"),a.setAttribute("aria-live","polite"),document.body.appendChild(a)),a.textContent=e,a.classList.add("show"),Ke&&window.clearTimeout(Ke),Ke=window.setTimeout(()=>{a?.classList.remove("show")},1700)};window.showActionToast=v;var Ba=(e,a,r,o)=>{let n=document.createElement("div");n.className="success-modal-overlay",n.innerHTML=`
  ...
  `,document.body.appendChild(n),setTimeout(()=>{n.classList.add("show")},10);let s=()=>{n.classList.remove("show"),setTimeout(()=>{n.remove()},300)};n.querySelector(".success-modal-close-btn")?.addEventListener("click",s),n.querySelector(".success-modal-action-btn")?.addEventListener("click",s),n.addEventListener("click",i=>{i.target===n&&s()})},Y=()=>{t.feedScrollY=0,window.scrollTo({top:0,behavior:"auto"})},qt=e=>{let a=e?new Date(`${e}T12:00:00`):new Date;return new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric"}).format(a)},Da=()=>t.stories.filter(e=>{if(t.showSaved)return!!e.saved;if(!(t.activeCategory==="All"||e.category===t.activeCategory))return!1;let a=t.newsSearchQuery.trim().toLowerCase();return a?[e.headline,e.summary,e.source,e.ai_summary].filter(Boolean).join(" ").toLowerCase().includes(a):!0}),xe=e=>t.activeArchiveDate?e.postedAt:`${e.postedAt} ago`,Na=e=>/(\*\*?\s*critique|attempt\s*\d|prompt says|let'?s try|tighter version|word count|violat(?:e|es)|output only|valid json|the model|the prompt)/i.test(e),Oa=(e,a=140)=>{let r=e.split(/\s+/).filter(Boolean);if(r.length<=a)return e;let n=r.slice(0,a).join(" "),s=Math.max(n.lastIndexOf("."),n.lastIndexOf("?"),n.lastIndexOf("!"));return s>n.length*.45?n.slice(0,s+1).trim():`${n.replace(/[,:;.'"!\?\s]+$/,"")}...`},vt=e=>{let a=String(e||"").trim();for(let r=0;r<2;r+=1){let o=a.match(/^```(?:json)?\s*([\s\S]*?)\s*```$/i);if(o&&(a=o[1].trim()),!/^\s*\{[\s\S]*\}\s*$/.test(a))break;try{let n=JSON.parse(a);if(typeof n.summary=="string"){a=n.summary.trim();continue}}catch{break}break}return a=a.replace(/&lt;|&#60;/gi,"<").replace(/&gt;|&#62;/gi,">").replace(/<[^>]+>/g," ").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&#39;/g,"'").replace(/&apos;/g,"'").replace(/&quot;/g,'"').replace(/^["'{\s]+/,"").replace(/["'}\s]+$/,"").replace(/^summary["'\s]*:[\s"']*/i,"").replace(/\s+/g," ").trim(),Na(a)?"":Oa(a)},ae=(e,a)=>vt(a||"")||vt(e.summary)||e.headline,_a=e=>{let r=e?.closest(".detail-summary, .thread-item, .market-thread-update")?.querySelector(".briefing-capture-area");if(!r||!window.html2canvas)return;let o=document.createElement("div");o.className="briefing-export-staging";let n=r.cloneNode(!0);n.classList.add("briefing-export-surface");let s=document.documentElement.dataset.theme==="light";s?(n.style.background="linear-gradient(180deg, #ffffff, #f8fafc)",n.style.border="1px solid #cbd5e1"):(n.style.background="linear-gradient(180deg, rgba(15, 23, 42, 0.98), rgba(17, 24, 39, 0.98))",n.style.border="1px solid #1e293b"),n.style.width="704px",n.style.padding="28px 30px",n.style.borderRadius="24px";let i=n.querySelector(".briefing-capture-header");i&&(i.style.display="flex",i.style.marginBottom="18px",i.style.paddingBottom="14px");let d=n.querySelector(".briefing-capture-title");d&&(d.style.display="block",d.style.fontSize="1.48rem",d.style.lineHeight="1.3",d.style.marginBottom="16px");let p=n.querySelector(".briefing-capture-intro");p&&(p.style.fontSize="1rem",p.style.lineHeight="1.65",p.style.marginBottom="18px"),n.querySelectorAll(".briefing-section").forEach(m=>{m.style.border="none",m.style.borderRadius="18px",m.style.padding="18px 20px 18px 22px",m.style.marginBottom="14px",s?m.style.backgroundColor="#f1f5f9":m.style.backgroundColor="rgba(30, 41, 59, 0.45)"}),n.querySelectorAll(".briefing-title").forEach(m=>{m.style.fontSize="0.84rem",m.style.letterSpacing="0.12em",m.style.marginBottom="12px"}),n.querySelectorAll(".briefing-text, .briefing-list li").forEach(m=>{m.style.fontSize="1rem",m.style.lineHeight="1.72",m.style.fontWeight="650",s?m.style.color="#000000":m.style.color="#e2e8f0"}),o.appendChild(n),document.body.appendChild(o),n.offsetHeight,requestAnimationFrame(()=>{setTimeout(()=>{window.html2canvas(n,{backgroundColor:s?"#f5f7fb":"#0f172a",scale:2,logging:!1,useCORS:!0}).then(m=>{let l=document.createElement("a");l.download="siftle-briefing.png",l.href=m.toDataURL("image/png"),l.click(),window.showActionToast?.("Briefing card image downloaded!")}).catch(()=>{window.showActionToast?.("Unable to download briefing card")}).finally(()=>{o.remove()})},40)})};window.downloadBriefingCard=_a;var Ha=e=>{let a=t.stories.find(s=>s.id===e),r=a?a.headline:"Siftle AI Briefing",o=`${window.location.origin}${window.location.pathname}#story-${e}`,n=`\u{1F4F0} *Siftle Briefing Alert* \u{1F4F0}

*Story:* ${r}

Read the full AI briefing, predictions and source updates here: ${o}`;navigator.clipboard.writeText(n).then(()=>{window.showActionToast?.("Shareable link copied to clipboard!")}).catch(()=>{window.showActionToast?.("Unable to copy link")})};window.copyBriefingLink=Ha;var rt=(e,a)=>{let r=e.split(/(?:\*\*|__)?(WHAT HAPPENED|KEY POINTS|TAKEAWAY)\s*:?\s*(?:\*\*|__)?\s*:?\s*/i);if(r.length<=1)return`<p class="briefing-text">${e}</p>`;let o='<div class="briefing-capture-area">';if(a){let s=a.headline||"Football Match Update";o+=`
    ...
    `}r[0].trim()&&(o+=`<p class="briefing-capture-intro">${r[0].trim()}</p>`);let n="";for(let s=1;s<r.length;s+=2){let i=r[s].trim().toUpperCase(),d=r[s+1]?r[s+1].trim():"";if(!d)continue;let p="";if(i==="KEY POINTS"){let f=d.split(/(?:•|\*|-)\s+/).map(c=>c.trim()).filter(Boolean);f.length>0?p=`<ul class="briefing-list">${f.map(c=>`<li>${c}</li>`).join("")}</ul>`:p=`<p class="briefing-text">${d}</p>`}else p=`<p class="briefing-text">${d}</p>`,i==="TAKEAWAY"&&(n=d);let g=i.toLowerCase().replace(/\s+/g,"-");o+=`
...
`,ve=()=>{if(!k)return;let e=Da();if(k.hidden=!!(t.selectedStoryId||t.selectedThreadUrl),t.isLoading){k.innerHTML=ur(4);return}let a=Number(t.unlockConfig?.amountUsdc)||.001,r=M(t.newsSearchQuery.trim()),n=`
  ...
  `;if(e.length===0){let s=t.showSaved?[]:t.stories;if(s.length>0){k.innerHTML=n+s.map(i=>`
      ...
      `).join("");return}k.innerHTML=n+'<div class="portfolio-empty compact news-search-empty">No stories match that keyword yet.</div>';return}k.innerHTML=n+e.map(s=>`
        <article class="story-card" data-story-id="${s.id}" role="button" tabindex="0" aria-label="Open summary for ${s.headline}">
          ...
          <div class="story-copy desktop-only">
            <span class="category-chip ${s.category}">${j(s.category)}</span>
            <h2>${s.headline}</h2>
            <p>Tap to read the AI briefing.</p>
          </div>
          ...
          <div class="mobile-card-inner mobile-only">
            <div class="mobile-card-body">
              <div class="mobile-card-text">
                ...
                <h2>${s.headline}</h2>
                <span class="mobile-card-time">${xe(s)}</span>
              </div>
              <div class="mobile-card-image" aria-hidden="true">
                <img src="${s.imageUrl}" alt="" loading="lazy" />
              </div>
    ...
    <div class="detail-container">
      ...
      <article class="detail-card">
        ...
        <section class="detail-summary ${e.category}">
          ...
          ${o?Ee(e):""}
          ${o?r?he():s?it(e):rt(a,e):za(e,n)}
        </section>
        <a class="source-button" href="${e.sourceUrl}" target="_blank" rel="noreferrer">Open source</a>
      </article>
    </div>
  `},xr=e=>{let a=t.marketSnapshots[e.id],r=G(e),o=oe(e),n=ie(e).length,s=a?.volumeUsdc??(Number(e.volumeUsdc)||0),i=a?.yesPriceCents,d=i??e.probability,p=o?`${n}`:`${d}%`,g=i===void 0?r?"Loading Arc pools":"Arc setup required":`Yes ${i}\xA2 \xB7 No ${100-i}\xA2`,f=i===void 0?`Yes ${e.probability}c - No ${100-e.probability}c`:g,c=Fe(e),m=e.timeframe==="Daily"?Ft(e,a):e.closes;return`
...
Trade and discuss here: ${d}`},Tr=e=>{if(!k||!T)return;let a=Fe(e),r=!t.checkedMarketEvidence[e.id],o=G(e),n=t.marketSnapshots[e.id],s=oe(e),i=ie(e);s&&!t.marketTradeOptionId&&(t.marketTradeOptionId=i[0]?.id||null);let d=Za(e),p=!!(o&&!n),g=n?.yesPriceCents??(o?e.probability:0),f=n?.noPriceCents??(o?100-e.probability:0),c=p?"":o?`${g}\xA2`:"--",m=p?"":o?`${f}\xA2`:"--",l=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},u=!!l.optionId;s&&u&&t.marketOrderMode!=="sell"&&(t.marketOrderMode="sell"),s&&!u&&t.marketOrderMode==="sell"&&(t.marketOrderMode="buy");let b=s&&t.marketOrderMode==="sell"&&u?Math.max(0,Number(l.optionSharesUsdc)||0):0,x=b>0?b:Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,l),w=b>0?{min:0,max:b}:ea(t.marketOrderMode,t.marketTradeSide,l),$=t.marketOrderMode==="buy"?"$5-$10 USDC":`Up to $${N(w.max)} USDC`,y=!t.walletAddress||t.hasLoadedPortfolioPositions,S=We(e,n),U=Wt(e,n),P=!!U;s||(t.marketTradeSide=dt(t.marketOrderMode,t.marketTradeSide,l));let O=!s&&!S&&!P&&y&&Z(t.marketOrderMode,"yes",l),R=!s&&!S&&!P&&y&&Z(t.marketOrderMode,"no",l),de=s?!S&&!P&&y&&(t.marketOrderMode==="sell"?u:!u&&!!d):!S&&!P&&y&&Z(t.marketOrderMode,t.marketTradeSide,l),_=S?"Market resolved":U||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),ce=S?"Market resolved":U||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),ue=s?x:ta(n,t.marketTradeSide,x,t.marketOrderMode,l),pe=t.marketOrderMode==="buy"?"Buy":"Exit",K=s?"Pick one outcome":o?"Arc testnet live":"Contract not deployed";k.hidden=!0,T.hidden=!1,T.classList.add("fullscreen"),document.body.classList.add("detail-mode"),lr(e),Zt(e),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&z({force:!t.hasLoadedPortfolioPositions});let Be=s?!!l.optionId:l.yesSharesUsdc>0||l.noSharesUsdc>0,ye="";if(s&&Be&&t.walletAddress){let L=na(l,n);ye=`
    ...
    <div class="detail-container market-detail-container">
      ...
      <div class="sticky-trade-bar">
        <div class="sticky-trade-info">
          ${s?`<span>${u?"Pick locked":"Choose one option"}</span><span><strong>${i.length} options</strong></span>`:`<span>Yes <strong>${c}</strong></span><span>No <strong>${m}</strong></span>`}
        </div>
        <button class="sticky-trade-btn" type="button" id="openTradeDrawerBtn" ${S||P?"disabled":""}>
          ${S?"Market Resolved":U||(s?u?"Pick Locked":"Pick Outcome":"Trade Market")}
        </button>
      </div>
      ...
      <div class="trade-drawer ${t.tradeDrawerOpen?"open":""}" id="tradeDrawer">
        ...
        <div class="trade-drawer-body">
          ...
          <div class="market-action-grid">
            ${s?i.map(L=>{let D=n?.optionPools?.[L.id]||0,ke=t.marketTradeOptionId===L.id||l.optionId===L.id,pt=S||P||t.marketOrderMode==="sell"||u||!y;return`
  ...
  `},ca=()=>{if(!k||!T)return;if(He?.toggleAttribute("hidden",!0),Re?.toggleAttribute("hidden",!0),te?.toggleAttribute("hidden",!0),Ue?.classList.add("active"),Pe?.classList.remove("active"),Ce?.classList.remove("active"),window.setTimeout(()=>{t.activeSurface==="markets"&&I.forEach(s=>{Zt(s)})},750),t.selectedMarketId){let s=I.find(i=>i.id===t.selectedMarketId);if(s){Tr(s);return}t.selectedMarketId=null,window.location.hash.startsWith("#market-")&&window.history.replaceState({},"","#markets");return}document.body.classList.remove("detail-mode"),T.hidden=!0,T.classList.remove("fullscreen"),k.hidden=!1,k.classList.add("markets-list");let e=I,r=`
    <nav class="market-timeframe-tabs" aria-label="Timeframe navigation">
      ${["All","Daily","Weekly","Sagas"].map(s=>{let i=t.activeMarketTimeframe===s,d=s==="All"?e.length:e.filter(g=>g.timeframe===s).length;return`
  ...
  `;let a=(l="2026-07-19T23:59:59.000Z")=>{let u=document.getElementById("seasonTimer");J&&clearInterval(J);let b=()=>{let w=new Date(l).getTime()-new Date().getTime();if(w<=0){u&&(u.innerText="Season Finished!"),J&&clearInterval(J);return}let $=Math.floor(w/(1e3*60*60*24)),y=Math.floor(w%(1e3*60*60*24)/(1e3*60*60)),S=Math.floor(w%(1e3*60*60)/(1e3*60)),U=Math.floor(w%(1e3*60)/1e3);u&&(u.innerText=`${$}d ${y}h ${S}m ${U}s`)};b(),J=setInterval(b,1e3)};a();let r=l=>l.map((u,b)=>{let x=Number(u.globalRank)||b+1,w=String(u.username||""),$=!!(t.walletAddress&&w.toLowerCase()===t.walletAddress.toLowerCase()),y=$&&t.profileUsername?t.profileUsername:u.displayName||w,S=$?`${t.profileUsername?y:q(w)} (You)`:y.startsWith("0x")&&y.length===42?q(y):y,U=M(S),P=M(Ve(u.status)),O=u.nextSeasonDivision?`Division ${u.nextSeasonDivision}`:"Qualify",R=x<=10?"promotion-zone":"safety-zone",de=x<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
    ...
    `)},i=()=>{n("global");let l=document.getElementById("leaderboardListContainer"),u="global",b=yt(u);b&&l?(l.innerHTML=wt()+r(b.players),b.seasonEndsAt&&a(b.seasonEndsAt)):s(10);let x=new URLSearchParams;t.walletAddress&&x.set("walletAddress",t.walletAddress);let w=x.toString();fetch(E(`/api/leaderboard/global${w?`?${w}`:""}`)).then($=>$.json()).then($=>{let y=kt($.players||[],b?.players||[],!0);l&&(l.innerHTML=y.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players on the global leaderboard yet.</p>`:r(y)),Qe(u,{players:y,seasonEndsAt:$.seasonEndsAt}),a($.seasonEndsAt)}).catch($=>{console.error("Failed to load global leaderboard:",$),l&&(l.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading global leaderboard. Please try again.</p>`)})},d=l=>{n("division");let u=document.getElementById("leaderboardListContainer"),b=`division_${l||we||"current"}`,x=yt(b);x&&u?(u.innerHTML=wt()+o(x.players),x.divisionNumber&&(we=x.divisionNumber),x.seasonEndsAt&&a(x.seasonEndsAt)):u&&l!==void 0&&(u.innerHTML=`
      ...
      `);let w=new URLSearchParams;t.walletAddress&&w.set("walletAddress",t.walletAddress),l&&w.set("division",String(l));let $=w.toString();fetch(E(`/api/leaderboard/division${$?`?${$}`:""}`)).then(y=>y.json()).then(y=>{let S=y.divisionNumber||1,U=kt(y.players||[],x?.players||[],!1),P=y.totalDivisions||1,O=y.seasonEndsAt;we=S;let R=document.getElementById("divisionTitleText");R&&(R.innerText=`Division ${S}`);let de=document.getElementById("divisionSelector");de&&(de.innerHTML=Array.from({length:P},(_,ce)=>ce+1).map(_=>`
