import"./chunks/chunk-ZUUPKAA6.js";var fe="Sports",Be=[{id:"wc-spain-belgium-qualify",category:fe,timeframe:"Daily",optionMarket:!0,question:"Which team will qualify in Spain vs Belgium?",options:[{id:"spain",label:"Spain"},{id:"belgium",label:"Belgium"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on the team that officially qualifies in Spain vs Belgium, including extra time and penalties.",threadTopic:"Spain vs Belgium Qualify Watch",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-spain-concede-belgium",category:fe,timeframe:"Daily",optionMarket:!0,question:"Will Spain concede against Belgium?",options:[{id:"yes",label:"Yes"},{id:"no",label:"No"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on whether Belgium are officially credited with at least one goal against Spain in regular time or extra time. Penalty shootout goals do not count.",threadTopic:"Spain Clean Sheet Watch vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-yamal-goal-assist-belgium",category:fe,timeframe:"Daily",optionMarket:!0,question:"Will Lamine Yamal record a goal or assist against Belgium?",options:[{id:"yes",label:"Yes"},{id:"no",label:"No"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on whether Lamine Yamal is officially credited with at least one goal or at least one assist for Spain against Belgium in regular time or extra time. Penalty shootout goals do not count.",threadTopic:"Lamine Yamal Impact vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1522778119026-d647f0596c20?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-spain-goals-belgium",category:fe,timeframe:"Daily",optionMarket:!0,question:"How many goals will Spain score in regular + extra time vs Belgium?",options:[{id:"0",label:"0 goals"},{id:"1",label:"1 goal"},{id:"2",label:"2 goals"},{id:"3-plus",label:"3+ goals"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on the number of goals officially scored by Spain against Belgium in regular time and extra time. Penalty shootout goals do not count.",threadTopic:"Spain Goals vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-tonali-spurs",category:fe,timeframe:"Sagas",question:"Will Sandro Tonali sign with Tottenham Hotspur in the Summer Transfer Window?",probability:58,closes:"September 1, 2026",resolution:"Resolves Yes if Tottenham Hotspur officially announces the transfer/signing of Sandro Tonali by the transfer deadline.",threadTopic:"Sandro Tonali Tottenham Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$182K",traders:"980",liquidity:"$29K",imageUrl:"https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-guimaraes-arsenal",category:fe,timeframe:"Sagas",question:"Will Bruno Guimaraes officially sign with Arsenal by September 1, 2026?",probability:45,closes:"September 1, 2026",resolution:"Resolves Yes if Arsenal officially announces the transfer/signing of Bruno Guimaraes by the transfer deadline.",threadTopic:"Bruno Guimaraes Arsenal Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$204K",traders:"1,240",liquidity:"$36K",imageUrl:"https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=1200&q=80",evidence:[]}];var Ze="https://faucet.circle.com/",mt="siftle_backend_wallet_migration_notice",Ye=null,N=()=>(Ye||(Ye=import("./chunks/arc-NVRCYTY3.js")),Ye),R=e=>e.length>10?`${e.slice(0,6)}...${e.slice(-4)}`:e,ia=async()=>(await N()).connectArcWallet(),ne=async e=>(await N()).readArcUsdcBalance(e),la=async(e,a,r,o)=>(await N()).payAiBriefingUnlock(e,a,r,o),da=e=>{N().then(a=>a.resolveLocalTestMarketYes(e))},ca=async e=>(await N()).readArcMarketSnapshot(e);var Pt=async(e,a)=>(await N()).readArcMarketState(e,a),pa=async(e,a,r,o,s,n,i)=>(await N()).executeArcMarketOrder(e,a,r,o,s,n,i),ua=async(e,a,r,o,s)=>(await N()).executeArcOptionMarketOrder(e,a,r,o,s),Ct=()=>{N().then(e=>e.disconnectArcWallet())},ma=async(e,a)=>(await N()).claimArcMarketPayout(e,a),Ne=async()=>(await N()).getConnectedArcWallet(),fa=async()=>(await N()).validateArcSession(),ga=async e=>(await N()).subscribeArcWallet(e),ha=async()=>(await N()).triggerGatewayWarmup(),va=["Sports"],ba="https://siftle.onrender.com",ya=()=>{let e=(window.SIFTLE_API_BASE||"").replace(/\/$/,"");if(e)return e;let a=typeof window<"u"?window.location.hostname.toLowerCase():"";return a==="siftle.xyz"||a.endsWith(".siftle.xyz")||a.endsWith(".vercel.app")?ba:""},ka=ya(),P=e=>`${ka}${e}`,Et="siftle_theme",wa=()=>{try{return window.localStorage.getItem(Et)==="light"?"light":"dark"}catch{return"dark"}},Se=wa();function C(e){fetch(P("/api/analytics"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:e})}).catch(a=>console.error("Failed to track event:",a))}var t={activeSurface:"feed",profileUsername:null,selectedMarketId:null,marketOrderMode:"buy",marketTradeSide:"yes",marketTradeOptionId:null,marketTradeAmount:2,marketSnapshots:{},marketPositions:{},marketEvidenceOverrides:{},loadingMarkets:!0,checkedMarketEvidence:{},checkedMarketSnapshots:{},loadingMarketSnapshots:{},loadingMarketEvidence:{},loadingPortfolioPositions:!1,marketTradeStatus:null,hasLoadedPortfolioPositions:!1,walletConnecting:!1,walletAddress:null,walletBalance:null,activeCategory:"Sports",stories:[],isLoading:!1,selectedStoryId:null,aiSummaries:{},loadingSummaryUrl:null,unlockingSummaryUrl:null,archiveDates:[],activeArchiveDate:null,activeShareStoryId:null,selectedThreadUrl:null,activeThread:null,loadingThreadUrl:null,feedScrollY:0,hasLoadedFeed:!1,showSaved:!1,tradeDrawerOpen:!1,activeMarketTimeframe:"All",profileNotice:null,portfolioMarketPreviews:[],referralPanelOpen:!1,referralData:null,referralError:null,loadingReferralData:!1,portfolioPositionsLoadedAt:0,unlockConfig:null,newsSearchQuery:"",briefingStatusByUrl:{},claimingMarketIds:{}};var G="global",X=!1,ee=null,ft=!1,gt=!1,ht=new URLSearchParams(window.location.search).get("ref")||localStorage.getItem("siftle_pending_referral_code")||"";ht&&localStorage.setItem("siftle_pending_referral_code",ht.trim().toUpperCase());var It=20,E=Be,Sa=(...e)=>{let a=new Map;return e.flat().forEach(r=>{r?.id&&a.set(r.id,{...a.get(r.id)||{},...r})}),Array.from(a.values())},Te=()=>Sa(t.portfolioMarketPreviews,E,Be),xa=async()=>{t.loadingMarkets=!0,E.length===0&&(E=Be);try{let e=new AbortController,a=window.setTimeout(()=>e.abort(),3500),r=await fetch(P("/api/markets"),{signal:e.signal});if(window.clearTimeout(a),r.ok){let o=await r.json();Array.isArray(o)&&o.length>0&&(E=o)}}catch(e){console.error("Failed to load markets:",e)}finally{t.loadingMarkets=!1}},Bt=async()=>{try{let e=await fetch(P("/api/portfolio/markets"));if(!e.ok)return;let a=await e.json();Array.isArray(a)&&(t.portfolioMarketPreviews=a.map(r=>({threadStoryId:0,updates:0,movement:0,evidence:[],...r})))}catch(e){console.warn(e)}},Dt="siftle.savedUrls",ie=new Set,rt=()=>{try{let e=localStorage.getItem(Dt)||"[]",a=JSON.parse(e);ie=new Set(a.filter(Boolean))}catch{ie=new Set}},$a=()=>{try{localStorage.setItem(Dt,JSON.stringify(Array.from(ie)))}catch{}},xe=()=>{if(Array.isArray(t.stories))for(let e of t.stories)e.saved=!!ie.has(e.sourceUrl)};rt();xe();var Qe=document.querySelector("#dateLabel"),le=document.querySelector("#categoryTabs"),k=document.querySelector("#storyList"),S=document.querySelector("#storyDetail"),Ge=document.querySelector("#menuButton"),Je=document.querySelector("#menuPanel"),L=document.querySelector("#menuStatus"),j=document.querySelector("#archiveDateSelect"),vt=document.querySelector("#archiveStatus"),Ta=document.querySelector("#todayButton"),He=document.querySelector(".brief-hero"),Re=document.querySelector("#archiveControls"),Me=document.querySelector("[data-surface='markets']"),Ae=document.querySelector("[data-surface='feed']"),Le=document.querySelector("[data-surface='portfolio']"),oe=document.querySelector("#walletButton"),ke=document.querySelector("[data-theme-toggle]"),Ma=document.getElementById("guideToggleButton"),Nt=Array.from(document.querySelectorAll("[data-bottom-nav]")),Ke,Aa=()=>{if(!ke)return;let a=`Switch to ${Se==="light"?"dark":"light"} mode`;ke.setAttribute("aria-label",a),ke.title=a,ke.dataset.activeTheme=Se},Ot=e=>{Se=e,document.documentElement.dataset.theme=e;try{window.localStorage.setItem(Et,e)}catch{}Aa()};Ot(Se);var D=()=>{if(oe){let e=oe.querySelector(".wallet-button-label");oe.classList.toggle("connected",!!t.walletAddress),oe.disabled=t.walletConnecting,oe.setAttribute("aria-label",t.walletAddress?`Wallet ${R(t.walletAddress)}`:"Sign in"),e&&(e.textContent=t.walletConnecting?"Signing in...":t.walletAddress?"Wallet":"Sign in"),oe.title=t.walletAddress?`${t.walletBalance??"0"} Arc Testnet USDC - ${R(t.walletAddress)}`:"Sign in"}};window.addEventListener("resize",D);ke?.addEventListener("click",()=>{Ot(Se==="light"?"dark":"light")});Ma?.addEventListener("click",()=>{La()});var La=()=>{let e=document.createElement("div");e.className="guide-overlay",e.innerHTML=`
  ...
  `,document.body.appendChild(s),setTimeout(()=>{s.classList.add("show")},10);let n=()=>{s.classList.remove("show"),setTimeout(()=>{s.remove()},300)};s.querySelector(".success-modal-close-btn")?.addEventListener("click",n),s.querySelector(".success-modal-action-btn")?.addEventListener("click",n),s.addEventListener("click",i=>{i.target===s&&n()})},J=()=>{t.feedScrollY=0,window.scrollTo({top:0,behavior:"auto"})},_t=e=>{let a=e?new Date(`${e}T12:00:00`):new Date;return new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric"}).format(a)},Ca=()=>t.stories.filter(e=>{if(t.showSaved)return!!e.saved;if(!(t.activeCategory==="All"||e.category===t.activeCategory))return!1;let a=t.newsSearchQuery.trim().toLowerCase();return a?[e.headline,e.summary,e.source,e.ai_summary].filter(Boolean).join(" ").toLowerCase().includes(a):!0}),Oe=e=>t.activeArchiveDate?e.postedAt:`${e.postedAt} ago`,Ea=e=>/(\*\*?\s*critique|attempt\s*\d|prompt says|let'?s try|tighter version|word count|violat(?:e|es)|output only|valid json|the model|the prompt)/i.test(e),Ia=(e,a=140)=>{let r=e.split(/\s+/).filter(Boolean);if(r.length<=a)return e;let s=r.slice(0,a).join(" "),n=Math.max(s.lastIndexOf("."),s.lastIndexOf("?"),s.lastIndexOf("!"));return n>s.length*.45?s.slice(0,n+1).trim():`${s.replace(/[,:;.'"!\?\s]+$/,"")}...`},bt=e=>{let a=String(e||"").trim();for(let r=0;r<2;r+=1){let o=a.match(/^```(?:json)?\s*([\s\S]*?)\s*```$/i);if(o&&(a=o[1].trim()),!/^\s*\{[\s\S]*\}\s*$/.test(a))break;try{let s=JSON.parse(a);if(typeof s.summary=="string"){a=s.summary.trim();continue}}catch{break}break}return a=a.replace(/&lt;|&#60;/gi,"<").replace(/&gt;|&#62;/gi,">").replace(/<[^>]+>/g," ").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&#39;/g,"'").replace(/&apos;/g,"'").replace(/&quot;/g,'"').replace(/^["'{\s]+/,"").replace(/["'}\s]+$/,"").replace(/^summary["'\s]*:[\s"']*/i,"").replace(/\s+/g," ").trim(),Ea(a)?"":Ia(a)},de=(e,a)=>bt(a||"")||bt(e.summary)||e.headline,Ba=e=>{let r=e?.closest(".detail-summary, .thread-item, .market-thread-update")?.querySelector(".briefing-capture-area");if(!r||!window.html2canvas)return;let o=document.createElement("div");o.className="briefing-export-staging";let s=r.cloneNode(!0);s.classList.add("briefing-export-surface"),o.appendChild(s),document.body.appendChild(o);let n=document.documentElement.dataset.theme==="light";window.html2canvas(s,{backgroundColor:n?"#f5f7fb":"#0f172a",scale:2,logging:!1,useCORS:!0}).then(i=>{let l=document.createElement("a");l.download="siftle-briefing.png",l.href=i.toDataURL("image/png"),l.click(),window.showActionToast?.("Briefing card image downloaded!")}).catch(()=>{window.showActionToast?.("Unable to download briefing card")}).finally(()=>{o.remove()})};window.downloadBriefingCard=Ba;var ot=(e,a)=>{let r=e.split(/(?:\*\*|__)?(WHAT HAPPENED|KEY POINTS|TAKEAWAY)\s*:?\s*(?:\*\*|__)?\s*:?\s*/i);if(r.length<=1)return`<p class="briefing-text">${e}</p>`;let o='<div class="briefing-capture-area">';if(a){let n=a.headline||"Football Match Update";o+=`
    ...
    `),o},Pe=e=>{let a=t.briefingStatusByUrl[e.sourceUrl]||"";return a?`<p class="briefing-status-note">${U(a)}</p>`:""},Da=()=>{let e=String(t.walletAddress||"").trim().toLowerCase();return/^0x[a-f0-9]{40}$/.test(e)?e:"guest"},st=e=>`siftle_ai_briefing_unlock_${Da()}_${btoa(unescape(encodeURIComponent(e.sourceUrl))).replace(/=+$/g,"")}`,Ht=e=>localStorage.getItem(st(e))||"",Na=e=>{localStorage.removeItem(st(e))},ce=e=>!!Ht(e),Rt=(e,a)=>({id:0,headline:a.headline,category:e.category,summary:a.summary,source:a.source,sourceUrl:a.sourceUrl,imageUrl:e.imageUrl||"",publishedAt:void 0,readTime:"3 min read",postedAt:a.date,accent:"slate",saved:ie.has(a.sourceUrl),ai_summary:void 0,ai_provider:void 0}),Oa=e=>{let a=t.stories.find(s=>s.sourceUrl===e);if(a)return a;let o=[t.activeThread?.current,...t.activeThread?.items??[]].filter(Boolean).find(s=>s.sourceUrl===e);if(o)return o;if(t.selectedMarketId){let s=E.find(n=>n.id===t.selectedMarketId);if(s){let n=je(s).evidence.find(i=>i.sourceUrl===e);if(n)return Rt(s,n)}}return null},nt=(e,a)=>{let r=Ga(e,a);return r===null?null:r-It*60*1e3},zt=(e,a)=>{let r=nt(e,a);return r===null?e.closes:new Intl.DateTimeFormat("en",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZoneName:"short"}).format(new Date(r))},jt=(e,a)=>{let r=nt(e,a);return r===null?null:Date.now()>=r?`Locked ${It}m before kickoff`:null},_a=(e,a)=>{let r=t.unlockConfig?`${t.unlockConfig.amountUsdc} USDC`:"0.05 USDC",o=t.unlockConfig?.x402Enabled,s=!!t.walletAddress;return`
...
`,ur=(e=4)=>`${ye("Loading stories")}${Array.from({length:e},pr).join("")}`,ve=()=>`
...
`,St=e=>{let a=e.type==="tweet",r='<svg class="x-logo-svg" viewBox="0 0 24 24" fill="currentColor" style="width: 14px; height: 14px; display: inline-block; vertical-align: text-top; color: var(--color-text-primary);"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>',o='<svg class="x-logo-svg" viewBox="0 0 24 24" fill="currentColor" style="width: 12px; height: 12px; display: inline-block; vertical-align: text-top; margin-right: 4px;"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>';return`
  ...
  `},be=()=>{if(!k)return;let e=Ca();if(k.hidden=!!(t.selectedStoryId||t.selectedThreadUrl),t.isLoading){k.innerHTML=ur(4);return}let a=Number(t.unlockConfig?.amountUsdc)||.001,r=U(t.newsSearchQuery.trim()),s=`
...
`},wr=async(e,a)=>{if(!t.walletAddress){y("Session expired or wallet not connected. Please sign in."),Ue();return}let r=Te().find(c=>c.id===e);if(!r||!te(r))return;let o=re(r).find(c=>c.id===a);if(!o){y("Choose a valid option.");return}!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",h(),await z(),t.marketTradeStatus=null);let s=t.marketSnapshots[r.id];if(Fe(r,s)){y("This market is resolved and can no longer be traded.");return}let n=t.marketPositions[r.id],i=t.marketOrderMode==="sell";if(!i&&n?.optionId){y("Your pick is already locked for this market.");return}if(i&&!n?.optionId){y("You do not have a pick to exit.");return}let l=Math.max(0,Number(n?.optionSharesUsdc)||0);if(i&&l<=0){y("Your pick is still loading. Please try again."),await z({force:!0});return}let p=i?l:Ie(Number(t.marketTradeAmount)||0,"buy","yes",void 0);t.marketTradeAmount=p,t.marketTradeOptionId=i&&n?.optionId||o.id,C("trade_attempt");try{t.marketTradeStatus=i?"Exiting your pick...":"Locking your pick...",h(),await ua(r.id,i?"sell":"buy",i&&n?.optionId||o.id,p,c=>{t.marketTradeStatus=c,h()}),delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await Ne(),t.walletAddress&&(t.walletBalance=await ne(t.walletAddress)),await z({force:!0}),C(i?"trade_sell_success":"trade_buy_success"),y(i?"Pick exited":`Pick locked: ${o.label}`),t.tradeDrawerOpen=!1}catch(c){C("trade_failed"),y(c instanceof Error?c.message:"Trade failed")}finally{t.marketTradeStatus=null,D(),h()}},Sr=()=>{if(!S||!k)return;let e=t.stories.find(o=>o.sourceUrl===t.selectedThreadUrl);if(k.hidden=!0,S.hidden=!1,S.classList.add("fullscreen"),document.body.classList.add("detail-mode"),!e){S.innerHTML="";return}let a=t.loadingThreadUrl===e.sourceUrl,r=t.activeThread;if(a&&!r){S.innerHTML=`
  ...
  `},Tr=e=>{let a=je(e),o=t.marketSnapshots[e.id]?.yesPriceCents??e.probability,s=100-o,n=a.evidence[0],i=n?n.headline:"No updates yet",l=`${window.location.origin}${window.location.pathname}#market-${e.id}`;return`\u{1F6A8} *Siftle Market Alert* \u{1F6A8}
...
Trade and discuss here: ${l}`},Mr=e=>{if(!k||!S)return;let a=je(e),r=!t.checkedMarketEvidence[e.id],o=K(e),s=t.marketSnapshots[e.id],n=te(e),i=re(e);n&&!t.marketTradeOptionId&&(t.marketTradeOptionId=i[0]?.id||null);let l=Va(e),p=!!(o&&!s),c=s?.yesPriceCents??(o?e.probability:0),m=s?.noPriceCents??(o?100-e.probability:0),d=p?"":o?`${c}\xA2`:"--",w=p?"":o?`${m}\xA2`:"--",u=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},g=!!u.optionId;n&&g&&t.marketOrderMode!=="sell"&&(t.marketOrderMode="sell"),n&&!g&&t.marketOrderMode==="sell"&&(t.marketOrderMode="buy");let T=n&&t.marketOrderMode==="sell"&&g?Math.max(0,Number(u.optionSharesUsdc)||0):0,B=T>0?T:Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,u),v=T>0?{min:0,max:T}:Zt(t.marketOrderMode,t.marketTradeSide,u),f=t.marketOrderMode==="buy"?"exactly $2.00 USDC":`Up to $${H(v.max)} USDC`,A=!t.walletAddress||t.hasLoadedPortfolioPositions,b=Fe(e,s),$=jt(e,s),x=!!$;n||(t.marketTradeSide=ct(t.marketOrderMode,t.marketTradeSide,u));let M=!n&&!b&&!x&&A&&se(t.marketOrderMode,"yes",u),O=!n&&!b&&!x&&A&&se(t.marketOrderMode,"no",u),Y=n?!b&&!x&&A&&(t.marketOrderMode==="sell"?g:!g&&!!l):!b&&!x&&A&&se(t.marketOrderMode,t.marketTradeSide,u),q=b?"Market resolved":$||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),V=b?"Market resolved":$||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),Z=n?B:Qt(s,t.marketTradeSide,B,t.marketOrderMode,u),Q=t.marketOrderMode==="buy"?"Buy":"Exit",ue=n?"Pick one outcome":o?"Arc testnet live":"Contract not deployed";k.hidden=!0,S.hidden=!1,S.classList.add("fullscreen"),document.body.classList.add("detail-mode"),sr(e),Kt(e),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&z({force:!t.hasLoadedPortfolioPositions});let ut=n?!!u.optionId:u.yesSharesUsdc>0||u.noSharesUsdc>0,qe="";n&&ut&&t.walletAddress?qe=`
        ...
        <div class="market-detail-main">
          ...
          <section class="market-evidence-thread">
            ...
            <div class="market-thread-timeline">
              ${r?fr(3):a.evidence.length===0?'<div class="portfolio-empty compact">Related news is still loading for this market.</div>':a.evidence.map(I=>{let _=Rt(e,I),me=t.unlockingSummaryUrl===I.sourceUrl;return`
                <article class="market-thread-update">
                  ...
                  <div class="market-thread-update-content">
                    ...
                    <div style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
                      ...
                      <button type="button" class="market-thread-source-link" data-unlock-briefing-url="${encodeURIComponent(I.sourceUrl)}" ${me?"disabled":""}>${me?"Preparing...":"AI briefing"}</button>
                    </div>
                    ${Pe(_)}
                    ${me?`<div style="margin-top: 12px;">${ve()}</div>`:ce(_)?t.loadingSummaryUrl===I.sourceUrl?`<div style="margin-top: 12px;">${ve()}</div>`:it(_)?`<div style="margin-top: 12px;">${lt(_)}</div>`:`<div style="margin-top: 12px;">${ot(de(_,t.aiSummaries[I.sourceUrl]),_)}</div>`:""}
                  </div>
                </article>
              `}).join("")}
            </div>
      ...
      <div class="trade-drawer ${t.tradeDrawerOpen?"open":""}" id="tradeDrawer">
        ...
        <div class="trade-drawer-body">
          ...
          <div class="market-action-grid">
            ${n?i.map(I=>{let _=t.marketTradeOptionId===I.id||u.optionId===I.id,me=b||x||t.marketOrderMode==="sell"||g||!A;return`
                  <button type="button" class="market-side option ${_?"active":""} ${me?"disabled":""}" data-market-option-id="${U(I.id)}" ${me?"disabled":""}>
                    <span>${U(I.label)}</span>
  ...
  `},oa=()=>{if(!k||!S)return;if(He?.toggleAttribute("hidden",!0),Re?.toggleAttribute("hidden",!0),le?.toggleAttribute("hidden",!0),Me?.classList.add("active"),Ae?.classList.remove("active"),Le?.classList.remove("active"),window.setTimeout(()=>{t.activeSurface==="markets"&&E.forEach(n=>{Kt(n)})},750),t.selectedMarketId){let n=E.find(i=>i.id===t.selectedMarketId);if(n){Mr(n);return}t.selectedMarketId=null,window.location.hash.startsWith("#market-")&&window.history.replaceState({},"","#markets");return}document.body.classList.remove("detail-mode"),S.hidden=!0,S.classList.remove("fullscreen"),k.hidden=!1,k.classList.add("markets-list");let e=E,r=`
  ...
  `,((v="2026-07-19T23:59:59.000Z")=>{let f=document.getElementById("seasonTimer");ee&&clearInterval(ee);let A=()=>{let $=new Date(v).getTime()-new Date().getTime();if($<=0){f&&(f.innerText="Season Finished!"),ee&&clearInterval(ee);return}let x=Math.floor($/(1e3*60*60*24)),M=Math.floor($%(1e3*60*60*24)/(1e3*60*60)),O=Math.floor($%(1e3*60*60)/(1e3*60)),Y=Math.floor($%(1e3*60)/1e3);f&&(f.innerText=`${x}d ${M}h ${O}m ${Y}s`)};A(),ee=setInterval(A,1e3)})();let r=v=>v.map((f,A)=>{let b=Number(f.globalRank)||A+1,$=String(f.username||""),x=!!(t.walletAddress&&$.toLowerCase()===t.walletAddress.toLowerCase()),M=x&&t.profileUsername?t.profileUsername:f.displayName||$,O=x?`${t.profileUsername?M:R($)} (You)`:M.startsWith("0x")&&M.length===42?R(M):M,Y=U(O),q=kt(f.status);if(f.totalTrades!==void 0&&f.aiBriefingUnlocks!==void 0){let We=wt(f.status);q=`${We.wins}W - ${We.losses}L \xB7 ${f.totalTrades} trades \xB7 ${f.aiBriefingUnlocks} unlocks`}let V=U(q),Z=f.nextSeasonDivision?`Division ${f.nextSeasonDivision}`:"Qualify",Q=b<=10?"promotion-zone":"safety-zone",ue=b<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
    ...
    `}let o=Ar(r?.outcome),s=Xt(a,r),n=s.reduce((g,T)=>Math.max(g,T.payout),0),i=a.yesSharesUsdc+a.noSharesUsdc,l=r?.outcome??0,p=_e().has(e.id),c=l===1?a.yesSharesUsdc:l===2?a.noSharesUsdc:0,m=l===1?r?.yesSharesUsdc??0:l===2?r?.noSharesUsdc??0:0,d=r?.volumeUsdc??0,w=c>0&&m>0?c/m*d:0,u=l===0?"":p?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':w>0?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${H(w)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>';return`
    <article class="portfolio-position-card">
      <div class="portfolio-position-top">
        <span class="category-chip ${e.category}">${W(e.category)}</span>
        <span>${o}</span>
  ...
  `},Lr=async e=>{if(!t.walletAddress){y("Please sign in first.");return}let a=Te().find(o=>o.id===e),r=a?K(a):"";if(!a||!r){y("Market is not available.");return}try{t.claimingMarketIds[a.id]=!0,F(),C("claim_attempt"),pt();let o=await ma(r,t.walletAddress);C("claim_success"),o.won&&er(a.id),delete t.marketPositions[a.id],delete t.marketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.walletBalance=await ne(t.walletAddress),await z(),y(o.won?`Claimed $${H(o.amountUsdc)}`:"No payout to claim"),D(),F()}catch(o){C("claim_failed"),y(o instanceof Error?o.message:"Claim failed")}finally{delete t.claimingMarketIds[a.id],F()}},Ur=e=>{if(!e)return"";let a=t.referralData,r=a?.referrals?.length?a.referrals.map(s=>{let n=s.displayName||R(s.walletAddress),i=s.remaining<=0;return`
  ...
  `},h=()=>{if(Nt.forEach(e=>{let a=e.dataset.bottomNav;e.classList.toggle("active",a==="saved"?t.showSaved:a===t.activeSurface&&!t.showSaved)}),t.activeSurface==="markets"){oa();return}if(t.activeSurface==="portfolio"){F();return}if(t.activeSurface==="leaderboard"){sa();return}na(),Yt(),be(),xr(),j&&(j.value=t.activeArchiveDate??"")};Qe.textContent=_t();le?.addEventListener("click",e=>{let r=e.target.closest("[data-category]");r&&(t.activeCategory=r.dataset.category,window.history.pushState({},"","#feed"),J(),h(),Ee(),ae(t.activeCategory))});k?.addEventListener("input",e=>{let a=e.target;if(a.id!=="newsSearchInput")return;let r=a.selectionStart??a.value.length,o=a.selectionEnd??a.value.length;t.newsSearchQuery=a.value,be();let s=k?.querySelector("#newsSearchInput");s&&(s.focus(),s.setSelectionRange(r,o))});Me?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,window.history.pushState({},"","#markets"),J(),h()});Ae?.addEventListener("click",()=>{t.activeSurface="feed",t.showSaved=!1,window.history.pushState({},"","#feed"),J(),h(),Ee(),ae(t.activeCategory)});Le?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=!1,window.history.pushState({},"","#portfolio"),J(),h()});oe?.addEventListener("click",()=>{t.walletAddress?(window.location.hash="#portfolio",Ce()):Ue()});document.addEventListener("click",e=>{let a=e.target,r=a.closest(".copy-address-btn");if(r){let i=r.getAttribute("data-address");i&&navigator.clipboard.writeText(i).then(()=>{y("Wallet address copied!")})}let o=a.closest("[data-claim-market]");if(o){let i=o.getAttribute("data-claim-market");i&&Lr(i);return}if(a.closest("[data-open-referrals]")){t.referralPanelOpen=!t.referralPanelOpen,!t.referralData&&!t.loadingReferralData&&$e(),F();return}if(a.closest("[data-close-referrals]")){t.referralPanelOpen=!1,F();return}if(a.closest("[data-refresh-referrals]")){t.referralError=null,$e(),F();return}let s=a.closest("[data-copy-referral-code]");if(s){let i=s.getAttribute("data-copy-referral-code")||"";i&&navigator.clipboard.writeText(i).then(()=>y("Invite code copied"));return}let n=a.closest("[data-copy-referral-link]");if(n){let i=n.getAttribute("data-copy-referral-link")||"";i&&navigator.clipboard.writeText(i).then(()=>y("Invite link copied"));return}a.closest("[data-connect-wallet]")&&(t.walletAddress?Ct():Ue())});Nt.forEach(e=>{e.addEventListener("click",()=>{let a=e.dataset.bottomNav;t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=a==="saved",a==="markets"?(t.activeSurface="markets",window.history.pushState({},"","#markets")):a==="portfolio"?(t.activeSurface="portfolio",window.history.pushState({},"","#portfolio")):a==="leaderboard"?(t.activeSurface="leaderboard",window.history.pushState({},"","#leaderboard")):(t.activeSurface="feed",window.history.pushState({},"","#feed"),Ee(),ae(t.activeCategory),a==="saved"&&(Qa(),rt(),xe())),J(),h()})});j?.addEventListener("change",()=>{t.activeArchiveDate=j.value||null,window.history.pushState({},"","#feed"),J(),h(),ae(t.activeCategory)});Ta?.addEventListener("click",()=>{t.activeArchiveDate=null,j&&(j.value=""),window.history.pushState({},"","#feed"),J(),h(),ae(t.activeCategory)});k?.addEventListener("click",async e=>{let a=e.target;if(a.closest("#editUsernameBtn")){let u=k?.querySelector(".username-display-row"),g=k?.querySelector("#usernameEditForm");if(u&&g){u.style.display="none",g.style.display="flex";let T=g.querySelector("#usernameInput");T&&T.focus()}return}if(a.closest("#cancelUsernameBtn")){let u=k?.querySelector(".username-display-row"),g=k?.querySelector("#usernameEditForm");u&&g&&(u.style.display="flex",g.style.display="none");return}let s=a.closest("#saveUsernameBtn");if(s){let g=k?.querySelector("#usernameEditForm")?.querySelector("#usernameInput");if(g){let T=g.value.trim().slice(0,15),B=s,v=B.textContent||"Save";B.disabled=!0,B.textContent="Saving...",Za(T),t.profileNotice=null;try{t.walletAddress&&await pe(!1),t.profileNotice={type:"success",message:"Username saved to your shared leaderboard profile."},y("Username updated"),F()}catch(f){let A=f instanceof Error?f.message:"Username save failed";t.profileNotice={type:"error",message:A},y(A),B.disabled=!1,B.textContent=v,F()}}return}let n=a.closest("[data-timeframe]");if(n){let u=n.dataset.timeframe;t.activeMarketTimeframe=u,oa();return}let i=a.closest("[data-market-id]");if(i){t.selectedMarketId=i.dataset.marketId??null,C("market_view"),window.history.pushState({},"",`#market-${t.selectedMarketId}`),h(),window.scrollTo({top:0,behavior:"smooth"});return}if(a.closest(".read-tweet-btn")){e.stopPropagation();let u=a.closest("[data-story-id]");u&&et(Number(u.dataset.storyId),!0);return}let p=a.closest("[data-thread-story-id]"),c=a.closest("[data-export-id]"),m=a.closest("[data-export-action]"),d=a.closest("[data-story-id]");if(p){e.stopPropagation();let u=t.stories.find(g=>g.id===Number(p.dataset.threadStoryId));u&&Ha(u);return}let w=a.closest(".mobile-bookmark-btn, .bookmark-button");if(w){e.stopPropagation();let u=w.dataset.bookmarkUrl||"",g=t.stories.find(T=>T.sourceUrl===u);if(!g)return;g.saved=!g.saved,g.saved?ie.add(u):ie.delete(u),$a(),y(g.saved?"Saved to your list":"Removed from saved"),be();return}if(m){e.stopPropagation(),kr(Number(m.dataset.exportStoryId),m.dataset.exportAction);return}if(c){e.stopPropagation();let u=Number(c.dataset.exportId);t.activeShareStoryId=t.activeShareStoryId===u?null:u,be();return}d&&(a.closest("a")||et(Number(d.dataset.storyId),!0))});k?.addEventListener("keydown",e=>{let r=e.target.closest("[data-story-id]");!r||e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),et(Number(r.dataset.storyId)))});S?.addEventListener("click",e=>{let a=e.target,r=a.closest("[data-unlock-briefing]");if(r){let m=t.stories.find(d=>d.id===Number(r.dataset.unlockBriefing));m&&Xe(m);return}let o=a.closest("[data-unlock-briefing-url]");if(o){let m=decodeURIComponent(o.dataset.unlockBriefingUrl||""),d=Oa(m);d&&(ce(d)?ze(d):Xe(d));return}if(a.closest("[data-back-markets]")){t.selectedMarketId=null,t.tradeDrawerOpen=!1,window.history.pushState({},"","#markets"),h();return}if(a.closest("#openTradeDrawerBtn")){let m=E.find(u=>u.id===t.selectedMarketId);if(m){if(Fe(m,t.marketSnapshots[m.id])){y("This market is resolved and can no longer be traded.");return}if(jt(m,t.marketSnapshots[m.id])){y("Trading is locked 20 minutes before kickoff.");return}}t.tradeDrawerOpen=!0,C("trade_drawer_open");let d=S.querySelector("#tradeDrawer"),w=S.querySelector("#tradeDrawerBackdrop");d?.classList.add("open"),w?.classList.add("open");return}if(a.closest("#closeTradeDrawerBtn")||a.closest("#tradeDrawerBackdrop")){t.tradeDrawerOpen=!1;let m=S.querySelector("#tradeDrawer"),d=S.querySelector("#tradeDrawerBackdrop");m?.classList.remove("open"),d?.classList.remove("open");return}if(a.closest("#shareWhatsAppBtn")){let m=E.find(d=>d.id===t.selectedMarketId);if(m){let d=Tr(m),w=`https://api.whatsapp.com/send?text=${encodeURIComponent(d)}`;window.open(w,"_blank")}return}let s=a.closest("[data-market-trade]");if(s&&t.selectedMarketId){let m=s.dataset.marketTrade;nr(t.selectedMarketId,m);return}let n=a.closest("[data-market-option-trade]");if(n&&t.selectedMarketId){let m=n.dataset.marketOptionTrade||t.marketTradeOptionId||"";wr(t.selectedMarketId,m);return}let i=a.closest("[data-market-option-id]");if(i){if(i.disabled||i.classList.contains("disabled"))return;t.marketTradeOptionId=i.dataset.marketOptionId||null,h();return}let l=a.closest("[data-market-trade-side]");if(l){if(l.disabled||l.classList.contains("disabled"))return;let m=E.find(u=>u.id===t.selectedMarketId),d=m?t.marketPositions[m.id]:void 0,w=l.dataset.marketTradeSide;if(!se(t.marketOrderMode,w,d))return;t.marketTradeSide=w,h();return}let p=a.closest("[data-market-order-mode]");if(p){t.marketOrderMode=p.dataset.marketOrderMode;let m=E.find(w=>w.id===t.selectedMarketId),d=m?t.marketPositions[m.id]:void 0;t.marketTradeSide=ct(t.marketOrderMode,t.marketTradeSide,d),t.marketTradeAmount=Ie(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,d),h();return}a.closest("[data-back-to-feed]")&&Ra()});S?.addEventListener("input",e=>{let a=e.target;if(!a.matches("[data-market-amount]"))return;let r=E.find(p=>p.id===t.selectedMarketId),o=r?t.marketSnapshots[r.id]:void 0,s=r?t.marketPositions[r.id]:void 0,n=Number(a.value);t.marketTradeAmount=Number.isFinite(n)?n:0;let i=r&&te(r)?t.marketTradeAmount:Qt(o,t.marketTradeSide,t.marketTradeAmount,t.marketOrderMode,s),l=S.querySelector(".market-inline-payout strong");l&&(l.textContent=`$${H(i)}`)});S?.addEventListener("focusin",e=>{e.target.matches("[data-market-amount]")&&document.body.classList.add("market-amount-focused")});S?.addEventListener("focusout",e=>{let a=e.target;if(a.matches("[data-market-amount]")){let r=E.find(s=>s.id===t.selectedMarketId),o=r?t.marketPositions[r.id]:void 0;t.marketTradeAmount=Ie(Number(a.value)||0,t.marketOrderMode,t.marketTradeSide,o),a.value=String(t.marketTradeAmount),window.setTimeout(()=>document.body.classList.remove("market-amount-focused"),120)}});window.addEventListener("popstate",Ce);window.addEventListener("hashchange",Ce);window.addEventListener("focus",async()=>{if(t.walletAddress){let e=t.walletBalance,a=await ne(t.walletAddress);t.walletBalance=a,D(),(!e||parseFloat(e)===0)&&parseFloat(a)>0&&(console.log("[X402] Balance changed from 0 to positive. Triggering Gateway warmup..."),ha())}});Ge?.addEventListener("click",()=>{if(!Je||!Ge)return;let e=!Je.hidden;Je.hidden=e,Ge.setAttribute("aria-expanded",String(!e))});document.addEventListener("click",e=>{let a=e.target;!a.closest(".share-control")&&t.activeShareStoryId!==null&&(t.activeShareStoryId=null,be());let r=a.closest("[data-menu-action]");if(!r)return;let o={today:"Showing today's brief",saved:`${t.stories.filter(s=>s.saved).length} saved stories`,archive:t.archiveDates.length>0?"Choose a saved day from the archive selector":"No saved days yet"};L&&(L.textContent=o[r.dataset.menuAction??"today"]),r.dataset.menuAction==="today"&&(t.showSaved=!1,t.activeArchiveDate=null,j&&(j.value=""),J(),Ee(),ae(t.activeCategory)),r.dataset.menuAction==="saved"&&(na(),rt(),xe(),t.showSaved=!0,document.querySelector("#archiveControls")?.classList.remove("mobile-open"),J(),h())});var Pr=async()=>{try{let e=await fetch(P("/api/summary/unlock-config"));e.ok&&(t.unlockConfig=await e.json(),h())}catch(e){console.error("Failed to prefetch unlock config:",e)}},Cr=()=>{window.setInterval(async()=>{try{let e=new AbortController,a=window.setTimeout(()=>e.abort(),3500),r=await fetch(P("/api/markets"),{signal:e.signal});if(window.clearTimeout(a),r.ok){let o=await r.json();Array.isArray(o)&&o.length>0&&(E=o,t.activeSurface==="markets"&&h())}}catch(e){console.warn("Background market poll failed:",e)}},3e4)};h();D();Pr();ae(t.activeCategory);Cr();xa().then(()=>{or(),h(),D(),window.setTimeout(Br,1200),Fa()});var Er=document.querySelector("#mobileArchiveCard"),he=document.querySelector("#archiveControls");Er?.addEventListener("click",()=>{if(!he)return;he.classList.toggle("mobile-open")&&setTimeout(()=>he.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Ir=document.querySelector("#archivePill");Ir?.addEventListener("click",e=>{if(e.stopPropagation(),!he)return;he.classList.toggle("mobile-open")&&setTimeout(()=>he.scrollIntoView({behavior:"smooth",block:"center"}),50)});var De=!1,Ut=!1,Br=()=>{Ut||(Ut=!0,(async()=>{let e=await Ne();if(De=!!e,e){t.walletConnecting=!0,D();try{let a=await fa();De=!1,t.walletConnecting=!1,a?(t.walletAddress=await Ne(),t.walletAddress&&(ge(),t.walletBalance=await ne(t.walletAddress),await z()),D(),t.activeSurface==="portfolio"&&h()):(t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ge(),y("Session expired. Please sign in again."),D(),h())}catch(a){console.warn(a),De=!1,t.walletConnecting=!1,t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ge(),y("Session expired. Please sign in again."),D(),h()}}await ga(a=>{De||(t.walletAddress=a,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,ge(),a&&pe(!1).catch(r=>console.error("Failed to report leaderboard entry:",r)),t.marketPositions={},t.hasLoadedPortfolioPositions=!1,D(),a?($e(),ne(a).then(r=>{t.walletBalance=r,D(),t.activeSurface==="portfolio"&&h()}),z()):t.activeSurface==="portfolio"&&h())})})())};C("app_open");document.addEventListener("click",e=>{let r=e.target.closest("a, button");if(r){let o=r.className||"",s=typeof o=="string"?o:r.getAttribute("class")||"",n=r.getAttribute("href")||"";!(r.hasAttribute("data-unlock-briefing")||r.hasAttribute("data-unlock-briefing-url")||r.classList.contains("summary-btn")||r.textContent?.trim()==="AI briefing"||r.textContent?.trim().includes("Unlock via"))&&(s.includes("source-button")||s.includes("source-btn")||s.includes("source-link")||r.textContent?.trim()==="Open source")&&!s.includes("disabled")&&n!=="#"&&C("open_source")}},!0);
