import"./chunks/chunk-ZUUPKAA6.js";var pe="Sports",Oe=[{id:"wc-spain-belgium-qualify",category:pe,timeframe:"Daily",optionMarket:!0,question:"Which team will qualify in Spain vs Belgium?",options:[{id:"spain",label:"Spain"},{id:"belgium",label:"Belgium"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on the team that officially qualifies in Spain vs Belgium, including extra time and penalties.",threadTopic:"Spain vs Belgium Qualify Watch",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-spain-concede-belgium",category:pe,timeframe:"Daily",optionMarket:!0,question:"Will Spain concede against Belgium?",options:[{id:"yes",label:"Yes"},{id:"no",label:"No"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on whether Belgium are officially credited with at least one goal against Spain in regular time or extra time. Penalty shootout goals do not count.",threadTopic:"Spain Clean Sheet Watch vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-yamal-goal-assist-belgium",category:pe,timeframe:"Daily",optionMarket:!0,question:"Will Lamine Yamal record a goal or assist against Belgium?",options:[{id:"yes",label:"Yes"},{id:"no",label:"No"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on whether Lamine Yamal is officially credited with at least one goal or at least one assist for Spain against Belgium in regular time or extra time. Penalty shootout goals do not count.",threadTopic:"Lamine Yamal Impact vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1522778119026-d647f0596c20?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"wc-spain-goals-belgium",category:pe,timeframe:"Daily",optionMarket:!0,question:"How many goals will Spain score in regular + extra time vs Belgium?",options:[{id:"0",label:"0 goals"},{id:"1",label:"1 goal"},{id:"2",label:"2 goals"},{id:"3-plus",label:"3+ goals"}],probability:0,kickoffAt:"2026-07-10T19:00:00Z",closes:"Jul 10, 7:40 PM GMT+1",resolution:"One option resolves correct based on the number of goals officially scored by Spain against Belgium in regular time and extra time. Penalty shootout goals do not count.",threadTopic:"Spain Goals vs Belgium",threadStoryId:0,updates:0,movement:0,volume:"$0",traders:"0",liquidity:"$0",imageUrl:"https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-tonali-spurs",category:pe,timeframe:"Sagas",question:"Will Sandro Tonali sign with Tottenham Hotspur in the Summer Transfer Window?",probability:58,closes:"September 1, 2026",resolution:"Resolves Yes if Tottenham Hotspur officially announces the transfer/signing of Sandro Tonali by the transfer deadline.",threadTopic:"Sandro Tonali Tottenham Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$182K",traders:"980",liquidity:"$29K",imageUrl:"https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?auto=format&fit=crop&w=1200&q=80",evidence:[]},{id:"transfer-guimaraes-arsenal",category:pe,timeframe:"Sagas",question:"Will Bruno Guimaraes officially sign with Arsenal by September 1, 2026?",probability:45,closes:"September 1, 2026",resolution:"Resolves Yes if Arsenal officially announces the transfer/signing of Bruno Guimaraes by the transfer deadline.",threadTopic:"Bruno Guimaraes Arsenal Transfer Link",threadStoryId:0,updates:0,movement:0,volume:"$204K",traders:"1,240",liquidity:"$36K",imageUrl:"https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=1200&q=80",evidence:[]}];var tt="https://faucet.circle.com/",ht="siftle_backend_wallet_migration_notice",Je=null,_=()=>(Je||(Je=import("./chunks/arc-ZAE4BJZI.js")),Je),j=e=>e.length>10?`${e.slice(0,6)}...${e.slice(-4)}`:e,ha=async()=>(await _()).connectArcWallet(),te=async e=>(await _()).readArcUsdcBalance(e),va=async(e,a,r,o)=>(await _()).payAiBriefingUnlock(e,a,r,o),ba=e=>{_().then(a=>a.resolveLocalTestMarketYes(e))},ya=async e=>(await _()).readArcMarketSnapshot(e);var Ot=async(e,a)=>(await _()).readArcMarketState(e,a),ka=async(e,a,r,o,n,s,i)=>(await _()).executeArcMarketOrder(e,a,r,o,n,s,i),wa=async(e,a,r,o,n)=>(await _()).executeArcOptionMarketOrder(e,a,r,o,n),_t=()=>{_().then(e=>e.disconnectArcWallet())},Sa=async(e,a)=>(await _()).claimArcMarketPayout(e,a),Re=async()=>(await _()).getConnectedArcWallet(),xa=async()=>(await _()).validateArcSession(),$a=async e=>(await _()).subscribeArcWallet(e),Ta=async()=>(await _()).triggerGatewayWarmup(),Aa=["Sports"],Ma="https://siftle.onrender.com",La=()=>{let e=(window.SIFTLE_API_BASE||"").replace(/\/$/,"");if(e)return e;let a=typeof window<"u"?window.location.hostname.toLowerCase():"";return a==="siftle.xyz"||a.endsWith(".siftle.xyz")||a.endsWith(".vercel.app")?Ma:""},Ua=La(),E=e=>`${Ua}${e}`,Ht="siftle_theme",Pa=()=>{try{return window.localStorage.getItem(Ht)==="light"?"light":"dark"}catch{return"dark"}},Te=Pa();function C(e){fetch(E("/api/analytics"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:e})}).catch(a=>console.error("Failed to track event:",a))}var t={activeSurface:"markets",profileUsername:null,selectedMarketId:null,marketOrderMode:"buy",marketTradeSide:"yes",marketTradeOptionId:null,marketTradeAmount:5,marketSnapshots:{},marketPositions:{},marketEvidenceOverrides:{},loadingMarkets:!0,checkedMarketEvidence:{},checkedMarketSnapshots:{},loadingMarketSnapshots:{},loadingMarketEvidence:{},loadingPortfolioPositions:!1,marketTradeStatus:null,hasLoadedPortfolioPositions:!1,walletConnecting:!1,walletAddress:null,walletBalance:null,activeCategory:"Sports",stories:[],isLoading:!1,selectedStoryId:null,aiSummaries:{},loadingSummaryUrl:null,unlockingSummaryUrl:null,archiveDates:[],activeArchiveDate:null,activeShareStoryId:null,selectedThreadUrl:null,activeThread:null,loadingThreadUrl:null,feedScrollY:0,hasLoadedFeed:!1,showSaved:!1,tradeDrawerOpen:!1,activeMarketTimeframe:"All",profileNotice:null,portfolioMarketPreviews:[],referralPanelOpen:!1,referralData:null,referralError:null,loadingReferralData:!1,portfolioPositionsLoadedAt:0,unlockConfig:null,newsSearchQuery:"",briefingStatusByUrl:{},claimingMarketIds:{}},ke=null,Q="global",J=null,vt=!1,bt=!1,yt=new URLSearchParams(window.location.search).get("ref")||localStorage.getItem("siftle_pending_referral_code")||"";yt&&localStorage.setItem("siftle_pending_referral_code",yt.trim().toUpperCase());var Rt=20,I=Oe,Ca=(...e)=>{let a=new Map;return e.flat().forEach(r=>{r?.id&&a.set(r.id,{...a.get(r.id)||{},...r})}),Array.from(a.values())},Le=()=>Ca(t.portfolioMarketPreviews,I,Oe),Ea=async()=>{t.loadingMarkets=!0,I.length===0&&(I=Oe);try{let e=new AbortController,a=window.setTimeout(()=>e.abort(),3500),r=await fetch(E("/api/markets"),{signal:e.signal});if(window.clearTimeout(a),r.ok){let o=await r.json();Array.isArray(o)&&o.length>0&&(I=o)}}catch(e){console.error("Failed to load markets:",e)}finally{t.loadingMarkets=!1}},jt=async()=>{try{let e=await fetch(E("/api/portfolio/markets"));if(!e.ok)return;let a=await e.json();Array.isArray(a)&&(t.portfolioMarketPreviews=a.map(r=>({threadStoryId:0,updates:0,movement:0,evidence:[],...r})))}catch(e){console.warn(e)}},zt="siftle.savedUrls",ae=new Set,nt=()=>{try{let e=localStorage.getItem(zt)||"[]",a=JSON.parse(e);ae=new Set(a.filter(Boolean))}catch{ae=new Set}},Ia=()=>{try{localStorage.setItem(zt,JSON.stringify(Array.from(ae)))}catch{}},Ae=()=>{if(Array.isArray(t.stories))for(let e of t.stories)e.saved=!!ae.has(e.sourceUrl)};nt();Ae();var at=document.querySelector("#dateLabel"),re=document.querySelector("#categoryTabs"),k=document.querySelector("#storyList"),T=document.querySelector("#storyDetail"),Ke=document.querySelector("#menuButton"),Ve=document.querySelector("#menuPanel"),A=document.querySelector("#menuStatus"),F=document.querySelector("#archiveDateSelect"),kt=document.querySelector("#archiveStatus"),Ba=document.querySelector("#todayButton"),ze=document.querySelector(".brief-hero"),qe=document.querySelector("#archiveControls"),Ue=document.querySelector("[data-surface='markets']"),Pe=document.querySelector("[data-surface='feed']"),Ce=document.querySelector("[data-surface='portfolio']"),X=document.querySelector("#walletButton"),we=document.querySelector("[data-theme-toggle]"),qt=Array.from(document.querySelectorAll("[data-bottom-nav]")),Ze,Da=()=>{if(!we)return;let a=`Switch to ${Te==="light"?"dark":"light"} mode`;we.setAttribute("aria-label",a),we.title=a,we.dataset.activeTheme=Te},Ft=e=>{Te=e,document.documentElement.dataset.theme=e;try{window.localStorage.setItem(Ht,e)}catch{}Da()};Ft(Te);var B=()=>{if(X){let e=X.querySelector(".wallet-button-label");X.classList.toggle("connected",!!t.walletAddress),X.disabled=t.walletConnecting,X.setAttribute("aria-label",t.walletAddress?`Wallet ${j(t.walletAddress)}`:"Sign in"),e&&(e.textContent=t.walletConnecting?"Signing in...":t.walletAddress?"Wallet":"Sign in"),X.title=t.walletAddress?`${t.walletBalance??"0"} Arc Testnet USDC - ${j(t.walletAddress)}`:"Sign in"}};window.addEventListener("resize",B);we?.addEventListener("click",()=>{Ft(Te==="light"?"dark":"light")});var Na=async e=>{let a=localStorage.getItem("siftle_pending_referral_code");if(a)try{let r=await fetch(E("/api/referrals/bind"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:e,referralCode:a})}),o=await r.json().catch(()=>({}));r.ok&&(o.bound||o.reason==="already_bound"||o.reason==="invalid_code")&&(localStorage.removeItem("siftle_pending_referral_code"),o.bound&&v("Referral connected"))}catch(r){console.warn(r)}},Me=async()=>{if(!(!t.walletAddress||t.loadingReferralData)){t.loadingReferralData=!0,t.referralError=null;try{let e=await fetch(E(`/api/referrals?walletAddress=${encodeURIComponent(t.walletAddress)}`)),a=await e.json().catch(()=>({}));e.ok?t.referralData=a:t.referralError=a?.error||"Referral tools are temporarily unavailable."}catch(e){console.warn(e),t.referralError="Referral tools are temporarily unavailable."}finally{t.loadingReferralData=!1,t.activeSurface==="portfolio"&&W()}}},Fe=async()=>{if(!t.walletConnecting){t.walletConnecting=!0,C("wallet_connect_start"),B();try{let e=await ha();if(e){C("wallet_connect_success"),t.walletAddress=e,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,me(),t.walletBalance=await te(e),await Na(e),Me(),await z(),ie(!0).catch(r=>console.error("Failed to report leaderboard entry:",r));let a=localStorage.getItem(ht);a?(localStorage.removeItem(ht),v(a)):v("Connected to Arc Testnet"),window.location.hash="#portfolio",Ie()}}catch(e){C("wallet_connect_failed"),v(e instanceof Error?e.message:"Wallet connection failed")}finally{t.walletConnecting=!1,B()}}},v=e=>{let a=document.querySelector("#actionToast");a||(a=document.createElement("div"),a.id="actionToast",a.className="action-toast",a.setAttribute("role","status"),a.setAttribute("aria-live","polite"),document.body.appendChild(a)),a.textContent=e,a.classList.add("show"),Ze&&window.clearTimeout(Ze),Ze=window.setTimeout(()=>{a?.classList.remove("show")},1700)};window.showActionToast=v;var Oa=(e,a,r,o)=>{let n=document.createElement("div");n.className="success-modal-overlay",n.innerHTML=`
  ...
  `,document.body.appendChild(n),setTimeout(()=>{n.classList.add("show")},10);let s=()=>{n.classList.remove("show"),setTimeout(()=>{n.remove()},300)};n.querySelector(".success-modal-close-btn")?.addEventListener("click",s),n.querySelector(".success-modal-action-btn")?.addEventListener("click",s),n.addEventListener("click",i=>{i.target===n&&s()})},Y=()=>{t.feedScrollY=0,window.scrollTo({top:0,behavior:"auto"})},Wt=e=>{let a=e?new Date(`${e}T12:00:00`):new Date;return new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric"}).format(a)},_a=()=>t.stories.filter(e=>{if(t.showSaved)return!!e.saved;if(!(t.activeCategory==="All"||e.category===t.activeCategory))return!1;let a=t.newsSearchQuery.trim().toLowerCase();return a?[e.headline,e.summary,e.source,e.ai_summary].filter(Boolean).join(" ").toLowerCase().includes(a):!0}),Se=e=>t.activeArchiveDate?e.postedAt:`${e.postedAt} ago`,Ha=e=>/(\*\*?\s*critique|attempt\s*\d|prompt says|let'?s try|tighter version|word count|violat(?:e|es)|output only|valid json|the model|the prompt)/i.test(e),Ra=(e,a=140)=>{let r=e.split(/\s+/).filter(Boolean);if(r.length<=a)return e;let n=r.slice(0,a).join(" "),s=Math.max(n.lastIndexOf("."),n.lastIndexOf("?"),n.lastIndexOf("!"));return s>n.length*.45?n.slice(0,s+1).trim():`${n.replace(/[,:;.'"!\?\s]+$/,"")}...`},wt=e=>{let a=String(e||"").trim();for(let r=0;r<2;r+=1){let o=a.match(/^```(?:json)?\s*([\s\S]*?)\s*```$/i);if(o&&(a=o[1].trim()),!/^\s*\{[\s\S]*\}\s*$/.test(a))break;try{let n=JSON.parse(a);if(typeof n.summary=="string"){a=n.summary.trim();continue}}catch{break}break}return a=a.replace(/&lt;|&#60;/gi,"<").replace(/&gt;|&#62;/gi,">").replace(/<[^>]+>/g," ").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&#39;/g,"'").replace(/&apos;/g,"'").replace(/&quot;/g,'"').replace(/^["'{\s]+/,"").replace(/["'}\s]+$/,"").replace(/^summary["'\s]*:[\s"']*/i,"").replace(/\s+/g," ").trim(),Ha(a)?"":Ra(a)},oe=(e,a)=>wt(a||"")||wt(e.summary)||e.headline,ja=e=>{let r=e?.closest(".detail-summary, .thread-item, .market-thread-update")?.querySelector(".briefing-capture-area");if(!r||!window.html2canvas)return;let o=document.createElement("div");o.className="briefing-export-staging";let n=r.cloneNode(!0);n.classList.add("briefing-export-surface"),o.appendChild(n),document.body.appendChild(o);let s=document.documentElement.dataset.theme==="light";window.html2canvas(n,{backgroundColor:s?"#f5f7fb":"#0f172a",scale:2,logging:!1,useCORS:!0}).then(i=>{let d=document.createElement("a");d.download="siftle-briefing.png",d.href=i.toDataURL("image/png"),d.click(),window.showActionToast?.("Briefing card image downloaded!")}).catch(()=>{window.showActionToast?.("Unable to download briefing card")}).finally(()=>{o.remove()})};window.downloadBriefingCard=ja;var it=(e,a)=>{let r=e.split(/(?:\*\*|__)?(WHAT HAPPENED|KEY POINTS|TAKEAWAY)\s*:?\s*(?:\*\*|__)?\s*:?\s*/i);if(r.length<=1)return`<p class="briefing-text">${e}</p>`;let o='<div class="briefing-capture-area">';if(a){let s=a.headline||"Football Match Update";o+=`
    ...
    `}r[0].trim()&&(o+=`<p class="briefing-capture-intro">${r[0].trim()}</p>`);let n="";for(let s=1;s<r.length;s+=2){let i=r[s].trim().toUpperCase(),d=r[s+1]?r[s+1].trim():"";if(!d)continue;let p="";if(i==="KEY POINTS"){let f=d.split(/(?:•|\*|-)\s+/).map(u=>u.trim()).filter(Boolean);f.length>0?p=`<ul class="briefing-list">${f.map(u=>`<li>${u}</li>`).join("")}</ul>`:p=`<p class="briefing-text">${d}</p>`}else p=`<p class="briefing-text">${d}</p>`,i==="TAKEAWAY"&&(n=d);let m=i.toLowerCase().replace(/\s+/g,"-");o+=`
    ...
    `),o},Ee=e=>{let a=t.briefingStatusByUrl[e.sourceUrl]||"";return a?`<p class="briefing-status-note">${M(a)}</p>`:""},za=()=>{let e=String(t.walletAddress||"").trim().toLowerCase();return/^0x[a-f0-9]{40}$/.test(e)?e:"guest"},lt=e=>`siftle_ai_briefing_unlock_${za()}_${btoa(unescape(encodeURIComponent(e.sourceUrl))).replace(/=+$/g,"")}`,Yt=e=>localStorage.getItem(lt(e))||"",qa=e=>{localStorage.removeItem(lt(e))},se=e=>!!Yt(e),Gt=(e,a)=>({id:0,headline:a.headline,category:e.category,summary:a.summary,source:a.source,sourceUrl:a.sourceUrl,imageUrl:e.imageUrl||"",publishedAt:void 0,readTime:"3 min read",postedAt:a.date,accent:"slate",saved:ae.has(a.sourceUrl),ai_summary:void 0,ai_provider:void 0}),Fa=e=>{let a=t.stories.find(n=>n.sourceUrl===e);if(a)return a;let o=[t.activeThread?.current,...t.activeThread?.items??[]].filter(Boolean).find(n=>n.sourceUrl===e);if(o)return o;if(t.selectedMarketId){let n=I.find(s=>s.id===t.selectedMarketId);if(n){let s=Ye(n).evidence.find(i=>i.sourceUrl===e);if(s)return Gt(n,s)}}return null},dt=(e,a)=>{let r=er(e,a);return r===null?null:r-Rt*60*1e3},Jt=(e,a)=>{let r=dt(e,a);return r===null?e.closes:new Intl.DateTimeFormat("en",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",timeZoneName:"short"}).format(new Date(r))},Kt=(e,a)=>{let r=dt(e,a);return r===null?null:Date.now()>=r?`Locked ${Rt}m before kickoff`:null},Wa=(e,a)=>{let r=t.unlockConfig?`${t.unlockConfig.amountUsdc} USDC`:"0.05 USDC",o=t.unlockConfig?.x402Enabled;return`
  ...
  `},ct=e=>/^AI briefing unavailable\./i.test(t.briefingStatusByUrl[e.sourceUrl]||"")&&!t.aiSummaries[e.sourceUrl],ut=e=>`
  <div class="briefing-section">
    ${Ee(e)}
...
`,rt=async(e,a=!1)=>{if(!t.walletAddress){v("Please sign in first.");return}if(!(t.unlockingSummaryUrl===e.sourceUrl&&!a)){t.unlockingSummaryUrl=e.sourceUrl,t.briefingStatusByUrl[e.sourceUrl]="Preparing AI briefing payment...",C("ai_unlock_attempt"),g();try{let r=await fetch(E("/api/summary/unlock-config")),o=await r.json();if(!r.ok||!o.treasuryAddress)throw new Error(o.error||"AI briefing is not configured");let n=await va(o.treasuryAddress,Number(o.amountUsdc)||.05,p=>{A&&(A.textContent=p),t.briefingStatusByUrl[e.sourceUrl]=p,g()},{sourceUrl:e.sourceUrl,topic:e.headline});t.briefingStatusByUrl[e.sourceUrl]=o.x402Enabled?`Payment successful. Loading AI briefing paid with ${o.amountUsdc} testnet USDC through x402.`:`Payment successful. Loading AI briefing paid with ${o.amountUsdc} testnet USDC.`,g();let s=await fetch(E("/api/summary/unlock"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sourceUrl:e.sourceUrl,walletAddress:t.walletAddress,txHash:n})}),i=await s.json();if(!s.ok||!i.unlockToken)throw new Error(i.error||"AI briefing failed");localStorage.setItem(lt(e),i.unlockToken),C("ai_unlock_success"),(Number(i?.bonus?.points)||0)>0&&ie(!1).catch(p=>console.error("Failed to refresh leaderboard bonus:",p)),await We(e)}catch(r){C("ai_unlock_failed"),delete t.briefingStatusByUrl[e.sourceUrl],v(r instanceof Error?r.message:"AI briefing failed")}finally{t.unlockingSummaryUrl=null,g()}}},We=async e=>{if(se(e)&&!(t.aiSummaries[e.sourceUrl]||t.loadingSummaryUrl===e.sourceUrl)){if(e.ai_summary){t.aiSummaries[e.sourceUrl]=oe(e,e.ai_summary),C("view_summary"),A&&(A.textContent=e.ai_provider==="0g"?"Archived 0G summary loaded":"Archived summary loaded"),g();return}t.loadingSummaryUrl=e.sourceUrl,t.briefingStatusByUrl[e.sourceUrl]="Generating briefing...",g();try{let a=await fetch(E("/api/summary"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...e,walletAddress:t.walletAddress,unlockToken:Yt(e)})});if(!a.ok){if(a.status===402){qa(e),delete t.aiSummaries[e.sourceUrl],t.briefingStatusByUrl[e.sourceUrl]="AI briefing unlock expired. Unlock it again to generate a new briefing.",A&&(A.textContent="Unlock expired. Unlock again to continue."),g();return}throw new Error(`Summary request failed with ${a.status}`)}let r=await a.json();t.aiSummaries[e.sourceUrl]=oe(e,r.summary),t.briefingStatusByUrl[e.sourceUrl]="AI briefing ready.",A&&r.provider&&(A.textContent=r.provider==="0g"?"Summary generated by 0G":`Summary loaded from ${r.provider}`)}catch(a){console.warn(a),delete t.aiSummaries[e.sourceUrl],t.briefingStatusByUrl[e.sourceUrl]="AI briefing unavailable. Retry to generate it again.",A&&(A.textContent="AI briefing failed. Retry available.")}finally{t.loadingSummaryUrl=null,g()}}},Vt=(e,a=!1)=>{let r=t.stories.find(o=>o.id===e);r&&(t.feedScrollY=window.scrollY,t.selectedStoryId=r.id,t.selectedThreadUrl=null,t.activeThread=null,window.history.pushState({},"",`#story-${r.id}`),g(),a&&!se(r)?(t.walletAddress&&(t.unlockingSummaryUrl=r.sourceUrl),g(),rt(r,!0)):se(r)&&We(r),window.scrollTo({top:0,behavior:"smooth"}))},Ya=e=>{t.feedScrollY=window.scrollY,t.selectedStoryId=null,t.selectedThreadUrl=e.sourceUrl,t.activeThread=null,t.loadingThreadUrl=e.sourceUrl,window.history.pushState({},"",`#thread-${e.id}`),g(),Zt(e),window.scrollTo({top:0,behavior:"smooth"})},Ga=()=>{t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,t.loadingThreadUrl=null,window.history.pushState({},"","#feed"),g(),requestAnimationFrame(()=>window.scrollTo({top:t.feedScrollY,behavior:"auto"}))},Zt=async e=>{try{let a=await fetch(E(`/api/thread?category=${encodeURIComponent(e.category)}&sourceUrl=${encodeURIComponent(e.sourceUrl)}`));if(!a.ok)throw new Error(`Thread request failed with ${a.status}`);t.activeThread=await a.json(),A&&(A.textContent=`${t.activeThread?.count??0} related updates found`)}catch(a){console.warn(a),t.activeThread=null,delete e.thread,t.selectedThreadUrl=null,window.history.replaceState({},"","#feed"),v("That timeline no longer has a verified past update"),A&&(A.textContent="Thread unavailable")}finally{t.loadingThreadUrl=null,g()}};function Ie(){if(window.location.hash==="#resolve-local-yes"){let a=I.find(r=>r.id==="siftle-local-test-2")||I.find(r=>r.timeframe==="Daily"&&G(r).startsWith("0x00000000000000000000000000000000000001"));if(a){ba(G(a)),pr(a,"yes"),delete t.marketSnapshots[a.id],delete t.marketPositions[a.id],delete t.checkedMarketSnapshots[a.id],delete t.loadingMarketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.activeSurface="portfolio",t.selectedMarketId=null,window.history.replaceState({},"","#portfolio"),v("Local test market resolved YES"),z().then(()=>{ie(!0).catch(r=>console.error("Failed to report leaderboard entry:",r)),B(),W()});return}}let e=window.location.hash.match(/^#market-(.+)$/);if(window.location.hash==="#markets"||e){t.activeSurface="markets",t.selectedMarketId=e?.[1]??null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,g();return}if(window.location.hash==="#portfolio"){t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,g();return}if(window.location.hash==="#leaderboard"){t.activeSurface="leaderboard",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,g();return}if(window.location.hash==="#feed"||window.location.hash.startsWith("#story-")||window.location.hash.startsWith("#thread-")){t.activeSurface="feed";let a=window.location.hash.match(/^#story-(\d+)$/),r=window.location.hash.match(/^#thread-(\d+)$/),o=a?t.stories.find(i=>i.id===Number(a[1])):void 0,n=r?t.stories.find(i=>i.id===Number(r[1])):void 0,s=t.selectedStoryId!==null||t.selectedThreadUrl!==null;t.selectedStoryId=o?.id??null,t.selectedThreadUrl=n?.sourceUrl??null,t.activeThread=null,g(),o&&We(o),n&&Zt(n),!o&&!n&&s&&requestAnimationFrame(()=>window.scrollTo({top:t.feedScrollY,behavior:"auto"}));return}t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,g()}var ot=e=>{kt&&(kt.textContent=e)},Ja=async(e=t.activeCategory,a=!1)=>{a||(t.activeSurface="feed",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.activeThread=null,t.loadingThreadUrl=null,t.showSaved=!1),t.isLoading=!0,t.activeSurface==="feed"&&(Xt(),g());try{let r=t.activeArchiveDate?`/api/archive?date=${encodeURIComponent(t.activeArchiveDate)}&category=${encodeURIComponent(e)}`:`/api/feed?category=${encodeURIComponent(e)}`,o=await fetch(E(r));if(!o.ok)throw new Error(`Feed request failed with ${o.status}`);let n=await o.json();if(t.stories=n.top_stories??[],Ae(),t.hasLoadedFeed=!0,at&&(at.textContent=Wt(n.date??t.activeArchiveDate)),A)if(t.activeArchiveDate)A.textContent=`Showing ${e} from ${t.activeArchiveDate}`;else{let s=n.archive?.provider==="shelby"?"Shelby":"local archive";A.textContent=`Latest published feed loaded from ${s}`}ot(t.activeArchiveDate?`Archive: ${t.activeArchiveDate}`:"Live feed")}catch(r){console.warn(r),t.hasLoadedFeed||(t.stories=[]),Ae(),A&&(A.textContent=t.activeArchiveDate?"That saved day/category is not available yet":"Feed data is currently unavailable. Please check back shortly.")}finally{t.isLoading=!1,g(),Ie()}},Ka=async()=>{if(F)try{let e=await fetch(E("/api/archive"));if(!e.ok)throw new Error(`Archive index failed with ${e.status}`);let a=await e.json(),r=new Date().toLocaleDateString("en-CA",{timeZone:"Africa/Lagos",year:"numeric",month:"2-digit",day:"2-digit"});t.archiveDates=(a.dates??[]).filter(o=>o.date!==r),F.innerHTML=['<option value="">Today</option>',...t.archiveDates.map(o=>`<option value="${o.date}">${o.date}</option>`)].join(""),F.value=t.activeArchiveDate??"",ot(t.archiveDates.length>0?"Saved days ready":"Live feed ready")}catch(e){console.warn(e),ot("Archive unavailable")}},Be=()=>{vt||(vt=!0,Ka())},ne=(e=t.activeCategory,a=!1)=>{t.hasLoadedFeed&&e===t.activeCategory&&!t.activeArchiveDate||Ja(e,a)},Va=()=>{bt||(bt=!0,window.setTimeout(()=>{t.activeSurface!=="feed"&&!t.hasLoadedFeed&&ne(t.activeCategory,!0),Be()},8e3))},Za=e=>e==="All"?"For you":e==="Sports"?"Football":e,q=e=>e==="Sports"?"Football":e,xe=e=>/^@/.test(String(e.source||""))||/(?:^|\/)(?:x|twitter)\.com\//i.test(String(e.sourceUrl||"")),Qt=(e,a)=>{let r=e.trim();return r.length<=a?r:`${r.slice(0,Math.max(0,a-1)).trimEnd()}\u2026`},Qa=e=>e.replace(/^@/,"").replace(/[_-]+/g," ").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/\s+/g," ").trim().split(" ").filter(Boolean),st=e=>{let a=String(e.source||q(e.category)).trim(),r=Qa(a);if(r.length===0)return q(e.category);let o=r.filter((i,d)=>{let p=i.toLowerCase();return!(d>0&&["live","news","official"].includes(p))}),n=o.length>0?o:r,s="";for(let i of n){let d=s?`${s} ${i}`:i;if(d.length>18)break;s=d}return Qt(s||n[0],18)},_e=e=>{let a=String(e.headline||"").replace(/\s+/g," ").trim();if(!xe(e))return a;let r=a.replace(/https?:\/\/\S+/gi,"").replace(/\(Source:[^)]+\)\s*$/i,"").replace(/\s+/g," ").trim();if(/^R to\s+@[^:]+:\s*(?:more here|watch more here)[:.!?]*$/i.test(r))return`Latest from ${st(e)}`;let o=r.replace(/^R to\s+@[^:]+:\s*/i,"").trim(),n=o.length>=24&&!/^(?:more here|watch more here)[:.!?]*$/i.test(o)?o:r||a;return Qt(n,150)},Xt=()=>{re&&(re.innerHTML=Aa.map(e=>`
        <button class="category-tab ${e===t.activeCategory?"active":""}" type="button" data-category="${e}">
          ${Za(e)}
        </button>
      `).join(""))},ea=e=>(e.thread?.count??0)>=1,Xa=(e=0)=>`${e} past ${e===1?"update":"updates"}`,ta=(e=[])=>[...e].sort((a,r)=>{let o=new Date(a.publishedAt||0).getTime(),n=new Date(r.publishedAt||0).getTime();return(Number.isNaN(n)?0:n)-(Number.isNaN(o)?0:o)}),Ye=e=>{let a=t.marketEvidenceOverrides[e.id],r={...e,evidence:e.evidence??[]};return a?{...r,...a,updates:a.evidence.length}:r},er=(e,a)=>{if(e.timeframe!=="Daily")return null;let r=e.kickoffAt?new Date(e.kickoffAt).getTime():Number.NaN;if(Number.isFinite(r))return r;let o=a?.closesAtUnix??0;return o>0?o*1e3:null},tr=(e,a)=>a===0?"Latest":e.publishedAt?new Intl.DateTimeFormat("en",{month:"short",day:"numeric"}).format(new Date(e.publishedAt)):e.postedAt,ar=(e,a)=>({date:tr(e,a),source:e.source,headline:e.headline,summary:oe(e),impact:a===0?"Latest":"Update",direction:"flat",sourceUrl:e.sourceUrl}),aa=async e=>{if(!(t.checkedMarketEvidence[e.id]||t.loadingMarketEvidence[e.id])){t.loadingMarketEvidence[e.id]=!0;try{let a=await fetch(E(`/api/market-thread?id=${encodeURIComponent(e.id)}&nocache=${Date.now()}`));if(!a.ok)return;let r=await a.json(),o=[r.current,...ta(r.items??[])],n=o.filter((d,p,m)=>m.findIndex(f=>f.sourceUrl===d.sourceUrl)===p).map(ar),i=o[0]?.imageUrl;n.length>=1&&(t.marketEvidenceOverrides[e.id]={threadTopic:r.topic||e.threadTopic,evidence:n,imageUrl:i||e.imageUrl})}catch(a){console.warn(a)}finally{t.checkedMarketEvidence[e.id]=!0,t.loadingMarketEvidence[e.id]=!1,t.activeSurface==="markets"&&g()}}},G=e=>e.optionMarket?e.id:e.marketAddress||window.SIFTLE_MARKET_ADDRESSES?.[e.id]||"",V=e=>Array.isArray(e.options)?e.options.filter(a=>a?.id&&a?.label):[],K=e=>!!(e.optionMarket&&V(e).length>1),rr=e=>{let a=V(e);return a.find(r=>r.id===t.marketTradeOptionId)||a[0]||null},R=e=>e.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),M=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),pt=e=>`siftle_profile_username_${e.toLowerCase()}`,ra=e=>e.trim().replace(/\s+/g," ").slice(0,15),me=()=>{if(!t.walletAddress){t.profileUsername=null,t.profileNotice=null;return}let e=pt(t.walletAddress),a=localStorage.getItem(e),r=localStorage.getItem("siftle_profile_username");!a&&r&&(a=ra(r),a&&localStorage.setItem(e,a),localStorage.removeItem("siftle_profile_username")),t.profileUsername=a||null,t.profileNotice=null},or=e=>{if(!t.walletAddress)return;let a=pt(t.walletAddress),r=ra(e);r?(localStorage.setItem(a,r),t.profileUsername=r):(localStorage.removeItem(a),t.profileUsername=null),localStorage.removeItem("siftle_profile_username")},sr=()=>{let e="one-hour-test-market",a=[];for(let r=0;r<localStorage.length;r++){let o=localStorage.key(r);o&&o.includes(e)&&a.push(o)}a.forEach(r=>localStorage.removeItem(r))},oa=(e,a,r)=>{if(e==="sell"){let o=a==="yes"?r?.yesSharesUsdc??0:r?.noSharesUsdc??0;return o<=0?{min:.01,max:.01,fallback:.01}:{min:Math.min(.01,o),max:o,fallback:o}}return{min:5,max:10,fallback:5}},De=(e,a,r,o)=>{let{min:n,max:s,fallback:i}=oa(a,r,o);return Number.isFinite(e)?Math.min(s,Math.max(n,e)):i},sa=(e,a,r,o,n)=>{if(!e||!Number.isFinite(r)||r<=0)return 0;let s=a==="yes"?n?.yesSharesUsdc??0:n?.noSharesUsdc??0,i=e.yesSharesUsdc,d=e.noSharesUsdc;if(o==="sell")return Math.min(r,s);let p=(a==="yes"?i:d)+r,m=i+d+r;return p<=0||m<=0?r:(s+r)/p*m},na=(e,a)=>{let r=a?.volumeUsdc??0,o=[];return e.yesSharesUsdc>0&&o.push({label:"YES Shares",shares:e.yesSharesUsdc,payout:a&&a.yesSharesUsdc>0?e.yesSharesUsdc/a.yesSharesUsdc*r:0}),e.noSharesUsdc>0&&o.push({label:"NO Shares",shares:e.noSharesUsdc,payout:a&&a.noSharesUsdc>0?e.noSharesUsdc/a.noSharesUsdc*r:0}),o},nr=e=>{let a=e?.yesSharesUsdc??0,r=e?.noSharesUsdc??0;return a>0&&r<=0?"yes":r>0&&a<=0?"no":null},ia=e=>`siftle_claimed_markets_${e.toLowerCase()}`,je=()=>{if(!t.walletAddress)return new Set;try{return new Set(JSON.parse(localStorage.getItem(ia(t.walletAddress))||"[]"))}catch{return new Set}},ir=e=>{if(!t.walletAddress)return;let a=je();a.add(e),localStorage.setItem(ia(t.walletAddress),JSON.stringify(Array.from(a)))},Ge=(e,a)=>(a?.outcome??0)!==0?!0:/^resolved$/i.test(String(e.closes||"").trim()),ee=(e,a,r)=>{let o=r?.yesSharesUsdc??0,n=r?.noSharesUsdc??0;return e==="sell"?a==="yes"?o>0:n>0:a==="yes"?n<=0:o<=0},mt=(e,a,r)=>{if(ee(e,a,r))return a;let o=a==="yes"?"no":"yes";return ee(e,o,r)?o:a};var lr=e=>{let a=e instanceof Error?e.message:String(e||"");return/token|session|auth|unauthori[sz]ed|expired|401/i.test(a)},Qe=e=>{let a=String(e||"").trim();if(!a)return"0 wins, 0 losses";let r=a.replace(/closed profits?/gi,"losses").replace(/\bprofit\b/gi,"losses");return/\bloss/i.test(r)?r:`${r}, 0 losses`},la="siftle_leaderboard_cache_v4_",St=e=>{let a=String(e||"").match(/(\d+)\s+wins?/i),r=String(e||"").match(/(\d+)\s+loss(?:es)?/i);return{wins:a&&Number(a[1])||0,losses:r&&Number(r[1])||0}},xt=e=>{try{let a=JSON.parse(localStorage.getItem(`${la}${e}`)||"null");return Array.isArray(a?.players)&&a.players.length?a:null}catch{return null}},Xe=(e,a)=>{if(!(!Array.isArray(a?.players)||a.players.length===0))try{localStorage.setItem(`${la}${e}`,JSON.stringify({...a,cachedAt:Date.now()}))}catch{}},da=(e,a)=>{let r=St(e?.status||""),o=St(a?.status||""),n=(Number(a?.points)||0)-(Number(e?.points)||0);return n||(o.wins!==r.wins?o.wins-r.wins:r.losses!==o.losses?r.losses-o.losses:String(e?.username||"").localeCompare(String(a?.username||"")))},dr=e=>{let a=String(e?.displayName||"").trim().toLowerCase();return a&&!/^0x[a-f0-9]{40}$/i.test(a)?`name:${a}`:`wallet:${String(e?.username||"").toLowerCase()}`},cr=e=>{let a=new Map;return e.forEach(r=>{let o=dr(r);if(!o||o==="wallet:")return;let n=a.get(o);if(!n){a.set(o,r);return}a.set(o,da(n,r)<=0?n:r)}),Array.from(a.values())},$t=(e,a=[],r=!1)=>{let o=cr(e).slice().sort(da);return r?o.map((n,s)=>({...n,globalRank:s+1})):o},ur=(e,a)=>{let r=String(e?.optionId||"").trim(),o=Math.max(0,Number(e?.optionSharesUsdc)||0),n=Math.max(0,Number(a?.optionPools?.[r])||0),s=Math.max(0,Number(a?.volumeUsdc)||0);return!r||o<=0?0:n<=0||s<=0?o:o/n*s},et=(e,a)=>!K(e)||!a?a:{...a,optionPools:Object.fromEntries(V(e).map(r=>[r.id,0]))},Tt=()=>`
  <div class="leaderboard-sync-note" role="status">
    Showing saved standings while Siftle refreshes live scores...
  </div>
`,ft=()=>{let e=0,a=0,r=0,o=I.filter(i=>i.timeframe==="Daily").map(i=>i.id),n=t.walletAddress?`siftle_resolved_results_${t.walletAddress.toLowerCase()}`:"",s={};if(n)try{s=JSON.parse(localStorage.getItem(n)||"{}")}catch{}if(t.walletAddress&&t.hasLoadedPortfolioPositions)for(let i of o){if(s[i]?.result==="win"){e+=Number(s[i].points)||0,a++;continue}if(s[i]?.result==="loss"){r++;continue}let d=t.marketPositions[i],m=t.marketSnapshots[i]?.outcome??0;if(m===0)continue;let f=`siftle_traded_sides_${i}_${t.walletAddress.toLowerCase()}`,u=[];try{u=JSON.parse(localStorage.getItem(f)||"[]")}catch{}let h=u.includes("yes")&&u.includes("no");if(m===1&&d&&d.yesSharesUsdc>0){let l=h?50:100;e+=l,a++,s[i]={result:"win",points:l}}else if(m===2&&d&&d.noSharesUsdc>0){let l=h?50:100;e+=l,a++,s[i]={result:"win",points:l}}else d&&(d.yesSharesUsdc>0||d.noSharesUsdc>0)&&(r++,s[i]={result:"loss",points:0})}return n&&localStorage.setItem(n,JSON.stringify(s)),{points:e,status:`${a} win${a===1?"":"s"}, ${r} loss${r===1?"":"es"}`}},pr=(e,a)=>{let r=G(e).toLowerCase();if(!r)return;let o=`siftle_mock_pos_${r}_`,n=new Set;for(let s=0;s<localStorage.length;s++){let i=localStorage.key(s);if(!i||!i.startsWith(o))continue;let d=i.slice(o.length).toLowerCase();/^0x[a-f0-9]{40}$/.test(d)&&n.add(d)}n.forEach(s=>{let i=`${o}${s}`,d={yesSharesUsdc:0,noSharesUsdc:0};try{d=JSON.parse(localStorage.getItem(i)||"{}")}catch{}let p=(Number(d.yesSharesUsdc)||0)>0,m=(Number(d.noSharesUsdc)||0)>0;if(!p&&!m)return;let f=`siftle_traded_sides_${e.id}_${s}`,u=[];try{u=JSON.parse(localStorage.getItem(f)||"[]")}catch{}let h=u.includes("yes")&&u.includes("no"),l=a==="yes"?p:m,c=`siftle_resolved_results_${s}`,b={};try{b=JSON.parse(localStorage.getItem(c)||"{}")}catch{}b[e.id]={result:l?"win":"loss",points:l?h?50:100:0},localStorage.setItem(c,JSON.stringify(b));let x=0,w=0,$=0;Object.values(b).forEach(S=>{S.result==="win"?(w+=1,x+=Number(S.points)||0):S.result==="loss"&&($+=1)});let y=localStorage.getItem(pt(s))||"";fetch(E("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:s,username:y,points:x,status:`${w} win${w===1?"":"s"}, ${$} loss${$===1?"":"es"}`})}).catch(S=>console.error("Failed to report local resolved score:",S))})},ie=async e=>{if(!t.walletAddress)return!1;let a=e&&t.hasLoadedPortfolioPositions?ft():null,r=await fetch(E("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:t.walletAddress,username:t.profileUsername||"",...a?{points:a.points,status:a.status}:{}})}),o=await r.json().catch(()=>({}));if(!r.ok||o?.success===!1)throw new Error(o?.error||"Failed to save leaderboard profile");if(o?.supabaseConfigured&&o?.supabaseSaved===!1)throw new Error(o?.supabaseError||"Supabase did not save profile");return!0},mr=()=>{let e=new Set;for(let a=0;a<localStorage.length;a++){let r=localStorage.key(a);if(r&&r.startsWith("siftle_mock_pos_")){let o=r.slice(r.lastIndexOf("_")+1).toLowerCase();try{let n=JSON.parse(localStorage.getItem(r)||"{}");((Number(n.yesSharesUsdc)||0)>0||(Number(n.noSharesUsdc)||0)>0)&&/^0x[a-f0-9]{40}$/.test(o)&&e.add(o)}catch{}}}e.forEach(a=>{fetch(E("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:a})}).catch(r=>console.error("Failed to report stored local trader:",r))})},fr=async e=>{let a=G(e);if(!(!a||t.marketSnapshots[e.id]||t.loadingMarketSnapshots[e.id]||t.checkedMarketSnapshots[e.id])){if(K(e)&&!t.walletAddress){let r=e.resolvedOptionId||null,o=Number(e.outcome);t.marketSnapshots[e.id]=et(e,{yesPriceCents:0,noPriceCents:0,volumeUsdc:Number(e.volumeUsdc)||0,yesSharesUsdc:0,noSharesUsdc:0,outcome:o===1||o===2||o===3?o:r?1:0,optionPools:e.optionPools||Object.fromEntries(V(e).map(n=>[n.id,0])),resolvedOptionId:r,traderCount:0}),t.checkedMarketSnapshots[e.id]=!0;return}t.loadingMarketSnapshots[e.id]=!0;try{if(K(e)&&t.walletAddress){let{position:r,snapshot:o}=await Ot(a,t.walletAddress);t.marketPositions[e.id]=r,t.marketSnapshots[e.id]=et(e,o)}else t.marketSnapshots[e.id]=et(e,await ya(a))}catch(r){console.warn(r)}finally{t.checkedMarketSnapshots[e.id]=!0,t.loadingMarketSnapshots[e.id]=!1,t.activeSurface==="markets"&&g()}}},z=async(e={})=>{if(t.walletAddress&&!(t.loadingPortfolioPositions&&!e.force)){t.hasLoadedPortfolioPositions=!1,t.loadingPortfolioPositions=!0;try{t.portfolioMarketPreviews.length===0&&await jt();let a=Le(),r=await Promise.all(a.map(async o=>{let n=G(o);if(!n)return[o.id,{yesSharesUsdc:0,noSharesUsdc:0}];try{let{position:s,snapshot:i}=await Ot(n,t.walletAddress);return t.marketSnapshots[o.id]=i,[o.id,s]}catch(s){return console.warn(`Failed to load portfolio market ${o.id}:`,s),[o.id,{yesSharesUsdc:0,noSharesUsdc:0}]}}));t.marketPositions=Object.fromEntries(r),t.portfolioPositionsLoadedAt=Date.now()}catch(a){console.warn(a)}finally{t.loadingPortfolioPositions=!1,t.hasLoadedPortfolioPositions=!0,ie(!0).catch(a=>console.error("Failed to report leaderboard entry:",a)),(t.activeSurface==="portfolio"||t.activeSurface==="leaderboard"||t.activeSurface==="markets")&&g()}}},gr=async(e,a)=>{if(!t.walletAddress){v("Session expired or wallet not connected. Please sign in."),Fe();return}let r=Le().find(m=>m.id===e);if(!r)return;t.marketTradeSide=a;let o=G(r);if(!o){v("Deploy this Arc market contract before trading"),g();return}if(!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",g(),await z(),t.marketTradeStatus=null),!t.hasLoadedPortfolioPositions){v("Still loading your position. Try again in a moment."),g();return}let n=t.marketSnapshots[r.id];if(Ge(r,n)){t.tradeDrawerOpen=!1,v("This market is resolved and can no longer be traded."),g();return}let s=n?.yesPriceCents??r.probability,i=n?.noPriceCents??100-r.probability,d=t.marketPositions[r.id]||{yesSharesUsdc:0,noSharesUsdc:0};if(!ee(t.marketOrderMode,a,d)){let m=nr(d),f=t.marketOrderMode==="sell"?m?`You can only exit your ${m.toUpperCase()} shares.`:"You do not have shares to exit in this market.":m?`Exit your ${m.toUpperCase()} shares before buying the other side.`:"You cannot buy both sides in the same market.";v(f),t.marketTradeSide=mt(t.marketOrderMode,a,d),g();return}let p=De(Number(t.marketTradeAmount)||0,t.marketOrderMode,a,d);t.marketTradeAmount=p,C("trade_attempt");try{t.marketTradeStatus="Preparing transaction...",g();let m=await ka(o,t.marketOrderMode,a,p,f=>{t.marketTradeStatus=f,g()},s,i);if(delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],delete t.loadingMarketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await Re(),t.walletAddress&&(t.walletBalance=await te(t.walletAddress)),await z({force:!0}),ie(!0).catch(f=>console.error("Failed to report leaderboard entry:",f)),t.walletAddress){let f=`siftle_cost_basis_${r.id}_${t.walletAddress.toLowerCase()}`,u={yesCost:0,noCost:0,yesShares:0,noShares:0};try{let l=localStorage.getItem(f);if(l){let c=JSON.parse(l);u={yesCost:c.yesCost||0,noCost:c.noCost||0,yesShares:c.yesShares||0,noShares:c.noShares||0}}}catch{}let h=p;if(t.marketOrderMode==="buy"){let l=`siftle_traded_sides_${r.id}_${t.walletAddress.toLowerCase()}`,c=[];try{c=JSON.parse(localStorage.getItem(l)||"[]")}catch{}c.includes(a)||(c.push(a),localStorage.setItem(l,JSON.stringify(c))),a==="yes"?(u.yesCost+=h,u.yesShares=(u.yesShares||0)+h/(s/100)):(u.noCost+=h,u.noShares=(u.noShares||0)+h/(i/100))}else{let l=t.marketPositions[r.id];if(l){if(a==="yes"&&l.yesSharesUsdc>0){let c=Math.min(1,h/l.yesSharesUsdc);u.yesCost=Math.max(0,u.yesCost-u.yesCost*c),u.yesShares=Math.max(0,(u.yesShares||0)-(u.yesShares||0)*c)}else if(a==="no"&&l.noSharesUsdc>0){let c=Math.min(1,h/l.noSharesUsdc);u.noCost=Math.max(0,u.noCost-u.noCost*c),u.noShares=Math.max(0,(u.noShares||0)-(u.noShares||0)*c)}}}localStorage.setItem(f,JSON.stringify(u))}v(`Trade confirmed ${m.slice(0,8)}...`),C(t.marketOrderMode==="buy"?"trade_buy_success":"trade_sell_success"),Oa(t.marketOrderMode,t.marketTradeAmount,a.toUpperCase(),r.question)}catch(m){C("trade_failed"),lr(m)?(_t(),t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,me(),v("Session expired. Please sign in again.")):v(m instanceof Error?m.message:"Arc trade failed")}finally{t.marketTradeStatus=null,B(),g()}},At=e=>ea(e)?`<button class="card-source-button thread-button" type="button" data-thread-story-id="${e.id}">Thread (${e.thread?.count})</button>`:"",Mt=e=>ea(e)?`<button class="mobile-action-btn thread-btn" type="button" data-thread-story-id="${e.id}">Thread</button>`:"",Lt=()=>'<svg class="action-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 4.75h10a1.75 1.75 0 0 1 1.75 1.75v14.25L12 16.35l-6.75 4.4V6.5A1.75 1.75 0 0 1 7 4.75Z"/></svg>',Ut=()=>'<svg class="action-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 15V4.75"/><path d="m7.25 9.5 4.75-4.75 4.75 4.75"/><path d="M5 13.25v4.5A2.25 2.25 0 0 0 7.25 20h9.5A2.25 2.25 0 0 0 19 17.75v-4.5"/></svg>',ve=e=>`<span class="skeleton-aria-label" role="status" aria-live="polite">${e}</span>`,hr=()=>`
...
`,vr=(e=4)=>`${ve("Loading stories")}${Array.from({length:e},hr).join("")}`,ge=()=>`
...
`,he=()=>{if(!k)return;let e=_a();if(k.hidden=!!(t.selectedStoryId||t.selectedThreadUrl),t.isLoading){k.innerHTML=vr(4);return}let a=Number(t.unlockConfig?.amountUsdc)||.001,r=M(t.newsSearchQuery.trim()),n=`
  ...
  `;if(e.length===0){let s=t.showSaved?[]:t.stories;if(s.length>0){k.innerHTML=n+s.map(i=>`
        <article class="story-card ${xe(i)?"social-story":""}" data-story-id="${i.id}" role="button" tabindex="0" aria-label="Open summary for ${i.headline}">
          ...
          <div class="story-copy desktop-only">
            ...
            <h2 class="card-headline">${_e(i)}</h2>
            ...
            <div class="mobile-card-body">
              <div class="mobile-card-text">
                <div class="mobile-card-topline">
                  <span class="mobile-source-pill ${xe(i)?"social":""}">${st(i)}</span>
      ...
      `).join("");return}k.innerHTML=n+'<div class="portfolio-empty compact news-search-empty">No stories match that keyword yet.</div>';return}k.innerHTML=n+e.map(s=>`
        <article class="story-card ${xe(s)?"social-story":""}" data-story-id="${s.id}" role="button" tabindex="0" aria-label="Open summary for ${s.headline}">
          ...
          <div class="story-copy desktop-only">
            ...
            <h2 class="card-headline">${_e(s)}</h2>
            <p>Tap to read the AI briefing.</p>
          </div>
          ...
          <div class="mobile-card-inner mobile-only">
            <div class="mobile-card-body">
              <div class="mobile-card-text">
                <div class="mobile-card-topline">
                  <span class="mobile-source-pill ${xe(s)?"social":""}">${st(s)}</span>
                  <div class="mobile-icons">
      ...
      `).join("")},Pt=e=>new Promise((a,r)=>{let o=new Image;o.crossOrigin="anonymous",o.onload=()=>a(o),o.onerror=()=>r(new Error(`Unable to load image: ${e}`)),o.src=e}),$e=(e,a,r,o,n,s)=>{e.beginPath(),e.moveTo(a+s,r),e.lineTo(a+o-s,r),e.quadraticCurveTo(a+o,r,a+o,r+s),e.lineTo(a+o,r+n-s),e.quadraticCurveTo(a+o,r+n,a+o-s,r+n),e.lineTo(a+s,r+n),e.quadraticCurveTo(a,r+n,a,r+n-s),e.lineTo(a,r+s),e.quadraticCurveTo(a,r,a+s,r),e.closePath()},wr=(e,a,r,o,n,s,i)=>{let d=a.split(/\s+/).filter(Boolean),p=[],m="";for(let f of d){let u=m?`${m} ${f}`:f;if(e.measureText(u).width<=n){m=u;continue}if(m&&p.push(m),m=f,p.length===i)break}if(m&&p.length<i&&p.push(m),d.length>0&&p.length===i){for(;e.measureText(`${p[i-1]}...`).width>n&&p[i-1].length>0;)p[i-1]=p[i-1].slice(0,-1).trim();p[i-1]=`${p[i-1]}...`}return p.forEach((f,u)=>e.fillText(f,r,o+u*s)),o+p.length*s},Sr=(e,a,r,o,n,s,i)=>{let d=Math.max(n/a.naturalWidth,s/a.naturalHeight),p=n/d,m=s/d,f=(a.naturalWidth-p)/2,u=(a.naturalHeight-m)/2;e.save(),$e(e,r,o,n,s,i),e.clip(),e.drawImage(a,f,u,p,m,r,o,n,s),e.restore()},Ct=e=>new Promise((a,r)=>{try{e.toBlob(o=>{o?a(o):r(new Error("Unable to export image"))},"image/png")}catch(o){r(o)}}),Et=e=>e?e.replace(/&quot;/g,'"').replace(/&apos;/g,"'").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&nbsp;/g," ").replace(/&#39;/g,"'").replace(/&#34;/g,'"').replace(/&#38;/g,"&").replace(/&#60;/g,"<").replace(/&#62;/g,">").replace(/&#8216;/g,"'").replace(/&#8217;/g,"'").replace(/&#8220;/g,'"').replace(/&#8221;/g,'"').replace(/&#8211;/g,"\u2013").replace(/&#8212;/g,"\u2014").replace(/&#8230;/g,"...").replace(/&#(\d+);/g,(a,r)=>String.fromCharCode(Number(r))):"",xr=e=>e?e.startsWith("data:")||e.startsWith("./")||e.startsWith("/")||e.includes(window.location.host)?e:`${(window.SIFTLE_API_BASE||"").replace(/\/$/,"")}/api/proxy-image?url=${encodeURIComponent(e)}`:"",It=async(e,a=!0)=>{let r=document.createElement("canvas");r.width=1080,r.height=1120;let o=r.getContext("2d");if(!o)throw new Error("Canvas is not available");o.fillStyle="#f4f7fb",o.fillRect(0,0,r.width,r.height),o.shadowColor="rgba(23, 34, 72, 0.16)",o.shadowBlur=44,o.shadowOffsetY=18,o.fillStyle="#ffffff",$e(o,70,70,940,980,34),o.fill(),o.shadowColor="transparent";let n=await Pt("./assets/siftle-logo-small.png").catch(()=>null);n&&o.drawImage(n,784,106,54,54),o.fillStyle="#071229",o.font="800 34px Inter, Arial, sans-serif",o.textAlign="left",o.fillText("Siftle",850,143),o.fillStyle="#6b748c",o.font="700 24px Inter, Arial, sans-serif",o.fillText(`${Et(e.source)} - ${e.postedAt} ago`,110,140);let s=195;if(a){let d=await Pt(xr(e.imageUrl)).catch(()=>null);d?Sr(o,d,110,s,860,520,28):(o.fillStyle="#eef2ff",$e(o,110,s,860,520,28),o.fill())}else o.fillStyle="#eef2ff",$e(o,110,s,860,520,28),o.fill();let i=775;return o.fillStyle=e.category==="Sports"?"#dffaf4":e.category==="Tech"?"#e8eef6":e.category==="Anime"?"#efe7ff":e.category==="Gaming"?"#ffebd9":"#eee7ff",$e(o,110,i,118,42,21),o.fill(),o.fillStyle=e.category==="Sports"?"#11a98d":e.category==="Tech"?"#3f5f86":e.category==="Gaming"?"#d95c14":"#6f3cff",o.font="800 22px Inter, Arial, sans-serif",o.fillText(q(e.category),132,i+28),o.fillStyle="#07142f",o.font="680 44px Space Grotesk, Inter, Arial, sans-serif",wr(o,Et(e.headline),110,888,860,54,4),r},ca=async e=>{let a=await It(e,!0);try{return await Ct(a)}catch{return Ct(await It(e,!1))}},ua=e=>`siftle-${e.headline.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"").slice(0,48)||"story"}.png`,pa=async e=>{let a=await ca(e),r=URL.createObjectURL(a),o=document.createElement("a");o.href=r,o.download=ua(e),o.click(),URL.revokeObjectURL(r)},$r=async e=>{let a=await ca(e),r=new File([a],ua(e),{type:"image/png"}),o={title:e.headline,text:`Siftle: ${e.headline}`,files:[r]};if(navigator.canShare?.(o)&&navigator.share){await navigator.share(o);return}await pa(e)},Tr=async(e,a)=>{let r=t.stories.find(o=>o.id===e);if(r){t.activeShareStoryId=null,he(),v(a==="share"?"Preparing share image":"Preparing download"),A&&(A.textContent=a==="share"?"Preparing share image...":"Preparing image download...");try{a==="share"?await $r(r):await pa(r),v(a==="share"?"Share image ready":"Image saved"),A&&(A.textContent="Branded story image ready")}catch(o){console.warn(o),v("Image export unavailable"),A&&(A.textContent="Image export was cancelled or unavailable")}}},Bt=(e,a)=>{let r=t.unlockingSummaryUrl===e.sourceUrl,o=ct(e);return`
  <article class="thread-item">
    ...
    <div class="thread-item-body">
      ...
      ${Ee(e)}
      ${r?`<div style="margin-top: 12px;">${ge()}</div>`:se(e)?t.loadingSummaryUrl===e.sourceUrl?`<div style="margin-top: 12px;">${ge()}</div>`:o?`<div style="margin-top: 12px;">${ut(e)}</div>`:`<div style="margin-top: 12px;">${it(oe(e,t.aiSummaries[e.sourceUrl]||e.ai_summary),e)}</div>`:""}
    </div>
  </article>
`},Ar=async(e,a)=>{if(!t.walletAddress){v("Session expired or wallet not connected. Please sign in."),Fe();return}let r=Le().find(m=>m.id===e);if(!r||!K(r))return;let o=V(r).find(m=>m.id===a);if(!o){v("Choose a valid option.");return}!t.hasLoadedPortfolioPositions&&!t.loadingPortfolioPositions&&(t.marketTradeStatus="Loading position...",g(),await z(),t.marketTradeStatus=null);let n=t.marketSnapshots[r.id];if(Ge(r,n)){v("This market is resolved and can no longer be traded.");return}let s=t.marketPositions[r.id],i=t.marketOrderMode==="sell";if(!i&&s?.optionId){v("Your pick is already locked for this market.");return}if(i&&!s?.optionId){v("You do not have a pick to exit.");return}let d=Math.max(0,Number(s?.optionSharesUsdc)||0);if(i&&d<=0){v("Your pick is still loading. Please try again."),await z({force:!0});return}let p=i?d:De(Number(t.marketTradeAmount)||0,"buy","yes",void 0);t.marketTradeAmount=p,t.marketTradeOptionId=i&&s?.optionId||o.id,C("trade_attempt");try{t.marketTradeStatus=i?"Exiting your pick...":"Locking your pick...",g(),await wa(r.id,i?"sell":"buy",i&&s?.optionId||o.id,p,m=>{t.marketTradeStatus=m,g()}),delete t.marketSnapshots[r.id],delete t.marketPositions[r.id],delete t.checkedMarketSnapshots[r.id],t.hasLoadedPortfolioPositions=!1,t.portfolioPositionsLoadedAt=0,t.walletAddress=await Re(),t.walletAddress&&(t.walletBalance=await te(t.walletAddress)),await z({force:!0}),C(i?"trade_sell_success":"trade_buy_success"),v(i?"Pick exited":`Pick locked: ${o.label}`),t.tradeDrawerOpen=!1}catch(m){C("trade_failed"),v(m instanceof Error?m.message:"Trade failed")}finally{t.marketTradeStatus=null,B(),g()}},Mr=()=>{if(!T||!k)return;let e=t.stories.find(o=>o.sourceUrl===t.selectedThreadUrl);if(k.hidden=!0,T.hidden=!1,T.classList.add("fullscreen"),document.body.classList.add("detail-mode"),!e){T.innerHTML="";return}let a=t.loadingThreadUrl===e.sourceUrl,r=t.activeThread;if(a&&!r){T.innerHTML=`
    ...
    <div class="detail-container thread-container">
      ...
      <article class="detail-card thread-card">
        ...
        <div class="thread-timeline">
          ${Bt(e,"Latest")}
          ${ta(r?.items??[]).map(o=>Bt(o,o.postedAt||"Earlier")).join("")}
        </div>
      </article>
    </div>
  `},Lr=()=>{if(!T||!k)return;if(t.selectedThreadUrl){Mr();return}let e=t.stories.find(i=>i.id===t.selectedStoryId);if(!e){T.hidden=!0,T.classList.remove("fullscreen"),document.body.classList.remove("detail-mode"),k.hidden=!1;return}let a=oe(e,t.aiSummaries[e.sourceUrl]),r=t.loadingSummaryUrl===e.sourceUrl,o=se(e),n=t.unlockingSummaryUrl===e.sourceUrl,s=ct(e);k.hidden=!0,T.hidden=!1,T.classList.add("fullscreen"),document.body.classList.add("detail-mode"),T.innerHTML=`
    <div class="detail-container">
      ...
      <article class="detail-card">
        ...
        <section class="detail-summary ${e.category}">
          ...
          ${o?Ee(e):""}
          ${o?r?ge():s?ut(e):it(a,e):Wa(e,n)}
        </section>
        <a class="source-button" href="${e.sourceUrl}" target="_blank" rel="noreferrer">Open source</a>
      </article>
    </div>
  `},Ur=e=>{let a=t.marketSnapshots[e.id],r=G(e),o=K(e),n=V(e).length,s=a?.volumeUsdc??(Number(e.volumeUsdc)||0),i=a?.yesPriceCents,d=i??e.probability,p=o?`${n}`:`${d}%`,m=i===void 0?r?"Loading Arc pools":"Arc setup required":`Yes ${i}\xA2 \xB7 No ${100-i}\xA2`,f=i===void 0?`Yes ${e.probability}c - No ${100-e.probability}c`:m,u=Ye(e),h=e.timeframe==="Daily"?Jt(e,a):e.closes;return`
  ...
  `},Pr=e=>{let a=Ye(e),o=t.marketSnapshots[e.id]?.yesPriceCents??e.probability,n=100-o,s=a.evidence[0],i=s?s.headline:"No updates yet",d=`${window.location.origin}${window.location.pathname}#market-${e.id}`;return`\u{1F6A8} *Siftle Market Alert* \u{1F6A8}
...
Trade and discuss here: ${d}`},Cr=e=>{if(!k||!T)return;let a=Ye(e),r=!t.checkedMarketEvidence[e.id],o=G(e),n=t.marketSnapshots[e.id],s=K(e),i=V(e);s&&!t.marketTradeOptionId&&(t.marketTradeOptionId=i[0]?.id||null);let d=rr(e),p=!!(o&&!n),m=n?.yesPriceCents??(o?e.probability:0),f=n?.noPriceCents??(o?100-e.probability:0),u=p?"":o?`${m}\xA2`:"--",h=p?"":o?`${f}\xA2`:"--",l=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},c=!!l.optionId;s&&c&&t.marketOrderMode!=="sell"&&(t.marketOrderMode="sell"),s&&!c&&t.marketOrderMode==="sell"&&(t.marketOrderMode="buy");let b=s&&t.marketOrderMode==="sell"&&c?Math.max(0,Number(l.optionSharesUsdc)||0):0,x=b>0?b:De(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,l),w=b>0?{min:0,max:b}:oa(t.marketOrderMode,t.marketTradeSide,l),$=t.marketOrderMode==="buy"?"$5-$10 USDC":`Up to $${R(w.max)} USDC`,y=!t.walletAddress||t.hasLoadedPortfolioPositions,S=Ge(e,n),L=Kt(e,n),P=!!L;s||(t.marketTradeSide=mt(t.marketOrderMode,t.marketTradeSide,l));let N=!s&&!S&&!P&&y&&ee(t.marketOrderMode,"yes",l),H=!s&&!S&&!P&&y&&ee(t.marketOrderMode,"no",l),le=s?!S&&!P&&y&&(t.marketOrderMode==="sell"?c:!c&&!!d):!S&&!P&&y&&ee(t.marketOrderMode,t.marketTradeSide,l),O=S?"Market resolved":L||(t.marketOrderMode==="sell"?"No YES shares":"Exit NO first"),de=S?"Market resolved":L||(t.marketOrderMode==="sell"?"No NO shares":"Exit YES first"),be=s?x:sa(n,t.marketTradeSide,x,t.marketOrderMode,l),ce=t.marketOrderMode==="buy"?"Buy":"Exit",Z=s?"Pick one outcome":o?"Arc testnet live":"Contract not deployed";k.hidden=!0,T.hidden=!1,T.classList.add("fullscreen"),document.body.classList.add("detail-mode"),fr(e),aa(e),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&z({force:!t.hasLoadedPortfolioPositions});let Ne=s?!!l.optionId:l.yesSharesUsdc>0||l.noSharesUsdc>0,ye="";s&&Ne&&t.walletAddress?ye=`
    ...
    <div class="detail-container market-detail-container">
      ...
      <article class="market-detail-card">
        <div class="market-detail-main">
          <div class="market-detail-topline">
            <span class="category-chip ${e.category}">${q(e.category)}</span>
            <span class="market-status-pill">${Z}</span>
          </div>
          <h2>${e.question}</h2>
          ${ye}
          ${a.imageUrl?`
          ...
          <div class="market-stats-row">
            <div class="market-stat">
              <span>${dt(e,n)===null?"Closes":"Trade lock"}</span>
              <strong>${Jt(e,n)}</strong>
            </div>
            <div class="market-stat">
              <span>Market activity</span>
              <strong>Hidden</strong>
          ...
          <section class="market-evidence-thread">
            ...
            <div class="market-thread-timeline">
              ${r?yr(3):a.evidence.length===0?'<div class="portfolio-empty compact">Related news is still loading for this market.</div>':a.evidence.map(U=>{let D=Gt(e,U),ue=t.unlockingSummaryUrl===U.sourceUrl;return`
                <article class="market-thread-update">
                  ...
                  <div class="market-thread-update-content">
                    ...
                    <div style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
                      ...
                      <button type="button" class="market-thread-source-link" data-unlock-briefing-url="${encodeURIComponent(U.sourceUrl)}" ${ue?"disabled":""}>${ue?"Preparing...":"AI briefing"}</button>
                    </div>
                    ${Ee(D)}
                    ${ue?`<div style="margin-top: 12px;">${ge()}</div>`:se(D)?t.loadingSummaryUrl===U.sourceUrl?`<div style="margin-top: 12px;">${ge()}</div>`:ct(D)?`<div style="margin-top: 12px;">${ut(D)}</div>`:`<div style="margin-top: 12px;">${it(oe(D,t.aiSummaries[U.sourceUrl]),D)}</div>`:""}
                  </div>
                </article>
              `}).join("")}
            </div>
      ...
      <div class="sticky-trade-bar">
        <div class="sticky-trade-info">
          ${s?`<span>${c?"Pick locked":"Choose one option"}</span><span><strong>${i.length} options</strong></span>`:`<span>Choose a side</span><span><strong>${t.marketOrderMode==="sell"?"Exit available":"Trade open"}</strong></span>`}
        </div>
      ...
      <div class="trade-drawer ${t.tradeDrawerOpen?"open":""}" id="tradeDrawer">
        ...
        <div class="trade-drawer-body">
          ...
          <div class="market-action-grid">
            ${s?i.map(U=>{let D=t.marketTradeOptionId===U.id||l.optionId===U.id,ue=S||P||t.marketOrderMode==="sell"||c||!y;return`
                  <button type="button" class="market-side option ${D?"active":""} ${ue?"disabled":""}" data-market-option-id="${M(U.id)}" ${ue?"disabled":""}>
                    <span>${M(U.label)}</span>
  ...
  `},ma=()=>{if(!k||!T)return;if(ze?.toggleAttribute("hidden",!0),qe?.toggleAttribute("hidden",!0),re?.toggleAttribute("hidden",!0),Ue?.classList.add("active"),Pe?.classList.remove("active"),Ce?.classList.remove("active"),window.setTimeout(()=>{t.activeSurface==="markets"&&I.forEach(s=>{aa(s)})},750),t.selectedMarketId){let s=I.find(i=>i.id===t.selectedMarketId);if(s){Cr(s);return}t.selectedMarketId=null,window.location.hash.startsWith("#market-")&&window.history.replaceState({},"","#markets");return}document.body.classList.remove("detail-mode"),T.hidden=!0,T.classList.remove("fullscreen"),k.hidden=!1,k.classList.add("markets-list");let e=I,r=`
  ...
  `;if(t.loadingMarkets&&I.length===0){k.innerHTML=`
      <header class="markets-header" style="box-sizing: border-box; width: 100%; display: block; padding-top: 18px;">
        <div style="display: flex; justify-content: space-between; align-items: center; width: 100%; gap: 12px; flex-wrap: wrap;">
          ...
          <a class="arc-faucet-button" href="${tt}" target="_blank" rel="noreferrer" style="flex-shrink: 0;">Get testnet USDC</a>
        </div>
  ...
  `},fa=()=>{if(!k||!T)return;ze?.toggleAttribute("hidden",!0),qe?.toggleAttribute("hidden",!0),re?.toggleAttribute("hidden",!0),Ue?.classList.remove("active"),Pe?.classList.remove("active"),Ce?.classList.remove("active"),document.body.classList.remove("detail-mode"),T.hidden=!0,k.hidden=!1,k.classList.add("markets-list");let e=t.walletAddress&&t.hasLoadedPortfolioPositions?ft():null;t.walletAddress&&e&&fetch(E("/api/leaderboard/report"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:t.walletAddress,points:e.points,status:e.status,username:t.profileUsername||""})}).catch(l=>console.error("Failed to report user score:",l)),J&&(clearInterval(J),J=null),k.innerHTML=`
  ...
  `;let a=(l="2026-07-19T23:59:59.000Z")=>{let c=document.getElementById("seasonTimer");J&&clearInterval(J);let b=()=>{let w=new Date(l).getTime()-new Date().getTime();if(w<=0){c&&(c.innerText="Season Finished!"),J&&clearInterval(J);return}let $=Math.floor(w/(1e3*60*60*24)),y=Math.floor(w%(1e3*60*60*24)/(1e3*60*60)),S=Math.floor(w%(1e3*60*60)/(1e3*60)),L=Math.floor(w%(1e3*60)/1e3);c&&(c.innerText=`${$}d ${y}h ${S}m ${L}s`)};b(),J=setInterval(b,1e3)};a();let r=l=>l.map((c,b)=>{let x=Number(c.globalRank)||b+1,w=String(c.username||""),$=!!(t.walletAddress&&w.toLowerCase()===t.walletAddress.toLowerCase()),y=$&&t.profileUsername?t.profileUsername:c.displayName||w,S=$?`${t.profileUsername?y:j(w)} (You)`:y.startsWith("0x")&&y.length===42?j(y):y,L=M(S),P=M(Qe(c.status)),N=c.nextSeasonDivision?`Division ${c.nextSeasonDivision}`:"Qualify",H=x<=10?"promotion-zone":"safety-zone",le=x<=12?'<span class="leaderboard-zone-arrow up">\u25B2</span>':'<span class="leaderboard-zone-arrow invisible">\u2022</span>';return`
    ...
    `)},i=()=>{n("global");let l=document.getElementById("leaderboardListContainer"),c="global",b=xt(c);b&&l?(l.innerHTML=Tt()+r(b.players),b.seasonEndsAt&&a(b.seasonEndsAt)):s(10);let x=new URLSearchParams;t.walletAddress&&x.set("walletAddress",t.walletAddress);let w=x.toString();fetch(E(`/api/leaderboard/global${w?`?${w}`:""}`)).then($=>$.json()).then($=>{let y=$t($.players||[],b?.players||[],!0);l&&(l.innerHTML=y.length===0?`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No players on the global leaderboard yet.</p>`:r(y)),Xe(c,{players:y,seasonEndsAt:$.seasonEndsAt}),a($.seasonEndsAt)}).catch($=>{console.error("Failed to load global leaderboard:",$),l&&(l.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading global leaderboard. Please try again.</p>`)})},d=l=>{n("division");let c=document.getElementById("leaderboardListContainer"),b=`division_${l||ke||"current"}`,x=xt(b);x&&c?(c.innerHTML=Tt()+o(x.players),x.divisionNumber&&(ke=x.divisionNumber),x.seasonEndsAt&&a(x.seasonEndsAt)):c&&l!==void 0&&(c.innerHTML=`
        <div class="leaderboard-skeleton" style="display: flex; flex-direction: column; gap: 12px; width: 100%;">
          ${Array.from({length:6}).map(()=>`
            <div style="height: 52px; background: rgba(255,255,255,0.02); border: 1px solid #1e1f2b; border-radius: 8px; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 0 16px;">
              <div style="display: flex; align-items: center; gap: 12px; width: 60%;">
      ...
      `);let w=new URLSearchParams;t.walletAddress&&w.set("walletAddress",t.walletAddress),l&&w.set("division",String(l));let $=w.toString();fetch(E(`/api/leaderboard/division${$?`?${$}`:""}`)).then(y=>y.json()).then(y=>{let S=y.divisionNumber||1,L=$t(y.players||[],x?.players||[],!1),P=y.totalDivisions||1,N=y.seasonEndsAt;ke=S;let H=document.getElementById("divisionTitleText");H&&(H.innerText=`Division ${S}`);let le=document.getElementById("divisionSelector");le&&(le.innerHTML=Array.from({length:P},(O,de)=>de+1).map(O=>`
            <option value="${O}" ${O===S?"selected":""}>Division ${O}</option>
          `).join("")),c&&(L.length===0?c.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">No active players in this division.</p>`:c.innerHTML=L.map((O,de)=>{let be=de+1,ce=t.walletAddress&&O.username.toLowerCase()===t.walletAddress.toLowerCase(),Z=ce&&t.profileUsername?t.profileUsername:O.displayName||O.username,gt=M(Qe(O.status)),Ne=ce?`${t.profileUsername?Z:j(O.username)} (You)`:Z.startsWith("0x")&&Z.length===42?j(Z):Z,ye=M(Ne),U="safety-zone",D='<span style="color: transparent; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u2022</span>';return be<=2?(U="promotion-zone",D='<span style="color: #34d399; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25B2</span>'):be>=5&&(U="relegation-zone",D='<span style="color: #ef4444; font-weight: bold; font-size: 0.85rem; margin-right: 4px; display: inline-block; width: 10px;">\u25BC</span>'),`
                <div class="leaderboard-row ${ce?"user-highlight":""} ${U}" role="listitem" style="display: flex !important; align-items: center !important; justify-content: space-between !important; padding: 12px 16px !important; border-bottom: 1px solid rgba(255, 255, 255, 0.06) !important; margin-bottom: 0 !important; background: transparent !important; font-family: 'Space Grotesk', sans-serif !important;">
                  <!-- Left Side: Arrow + Rank + Username -->
                  <div style="flex: 1.5; display: flex; align-items: center; gap: 8px; min-width: 0;">
                    ${D}
                    <span class="leaderboard-rank rank-${be}" style="flex-shrink: 0; margin-right: 4px;">${be}</span>
                  ...
                  <!-- Right Side: Status -->
                  <div style="flex: 1.5; display: flex; flex-direction: column; align-items: flex-end; justify-content: center; text-align: right; min-width: 0;">
                    <span style="font-size: 0.78rem; color: #8e8e93; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${gt}</span>
                  </div>
                </div>
              `}).join("")),Xe(b,{players:L,divisionNumber:S,totalDivisions:P,seasonEndsAt:N}),Xe(`division_${S}`,{players:L,divisionNumber:S,totalDivisions:P,seasonEndsAt:N}),a(N)}).catch(y=>{console.error("Failed to load division leaderboard:",y),c&&(c.innerHTML=`<p style="color: var(--market-text-muted); text-align: center; padding: 24px 0; font-family: 'Space Grotesk', sans-serif;">Error loading division leaderboard. Please try again.</p>`)})};Q==="division"?d(ke||void 0):i(),document.querySelectorAll("[data-leaderboard-view]").forEach(l=>{l.addEventListener("click",()=>{(l.dataset.leaderboardView==="division"?"division":"global")==="division"?d(ke||void 0):i()})}),document.getElementById("divisionSelector")?.addEventListener("change",l=>{let c=Number(l.target.value);d(c)}),document.getElementById("faucetClaimButton")?.addEventListener("click",async()=>{if(!t.walletAddress){v("Please sign in first!");return}if(localStorage.getItem("siftle_circle_is_mock")==="true"){let c=parseFloat(localStorage.getItem(`siftle_mock_balance_${t.walletAddress}`)||"1000.00")+100;localStorage.setItem(`siftle_mock_balance_${t.walletAddress}`,c.toFixed(2)),t.walletBalance=c.toFixed(2),v("Claimed $100 USDC mock credits!"),B(),fa()}else v("Opening Circle Faucet..."),window.open(tt,"_blank")});let f=document.getElementById("howItWorksBtn"),u=document.getElementById("howItWorksModal"),h=document.getElementById("closeRulesModalBtn");f?.addEventListener("click",()=>{u&&u.classList.add("active")}),h?.addEventListener("click",()=>{u&&u.classList.remove("active")}),u?.addEventListener("click",l=>{l.target===u&&u.classList.remove("active")})},ga=()=>{t.activeSurface="feed",t.selectedMarketId=null,ze?.toggleAttribute("hidden",!0),qe?.toggleAttribute("hidden",!0),re?.toggleAttribute("hidden",!0),Ue?.classList.remove("active"),Pe?.classList.add("active"),Ce?.classList.remove("active"),k?.classList.remove("markets-list")},Er=e=>e===1?"Yes resolved":e===2?"No resolved":e===3?"Invalid":"Open",Dt=e=>{let a=t.marketPositions[e.id]||{yesSharesUsdc:0,noSharesUsdc:0},r=t.marketSnapshots[e.id];if(K(e)){let c=r?.resolvedOptionId||null,b=!!c,x=b&&a.optionId===c,w=ur(a,r),$=x?w:0,y=V(e).find(P=>P.id===c)?.label,S=!!a.claimedAt||je().has(e.id),L=!!t.claimingMarketIds[e.id];return`
      <article class="portfolio-position-card">
        ...
        <div class="portfolio-position-stats">
          ...
          <div><span>Projected payout</span><strong>$${R($)}</strong></div>
        </div>
        <div class="portfolio-position-footer">
          <span>${b?"":`Closes ${e.closes}`}</span>
          ${b?S?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':L?'<button type="button" class="connect-wallet-btn" disabled style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; opacity: 0.7 !important; cursor: wait !important;">Claiming...</button>':x?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${R($)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>':""}
        </div>
      </article>
    `}let o=Er(r?.outcome),n=na(a,r),s=n.reduce((c,b)=>Math.max(c,b.payout),0),i=a.yesSharesUsdc+a.noSharesUsdc,d=r?.outcome??0,p=je().has(e.id),m=d===1?a.yesSharesUsdc:d===2?a.noSharesUsdc:0,f=d===1?r?.yesSharesUsdc??0:d===2?r?.noSharesUsdc??0:0,u=r?.volumeUsdc??0,h=m>0&&f>0?m/f*u:0,l=d===0?"":p?'<span style="color: #34d399; font-size: 0.82rem; font-weight: 800;">Claimed</span>':h>0?`<button type="button" class="connect-wallet-btn" data-claim-market="${e.id}" style="background: #ffffff !important; color: #000000 !important; border: 1px solid #ffffff !important; border-radius: 6px !important; padding: 8px 14px !important; font-size: 0.82rem !important; font-weight: 700 !important; cursor: pointer !important;">Claim $${R(h)}</button>`:'<span style="color: #ef4444; font-size: 0.82rem; font-weight: 800;">Lost</span>';return`
    <article class="portfolio-position-card">
      <div class="portfolio-position-top">
        <span class="category-chip ${e.category}">${q(e.category)}</span>
        <span>${o}</span>
      ...
      <h2>${e.question}</h2>
      <div class="portfolio-position-stats">
        <div><span>Projected payout</span><strong>$${R(s)}</strong></div>
        ${n.map(c=>`
  ...
  `},Ir=async e=>{if(!t.walletAddress){v("Please sign in first.");return}let a=Le().find(o=>o.id===e),r=a?G(a):"";if(!a||!r){v("Market is not available.");return}try{t.claimingMarketIds[a.id]=!0,W(),C("claim_attempt"),ft();let o=await Sa(r,t.walletAddress);C("claim_success"),o.won&&ir(a.id),delete t.marketPositions[a.id],delete t.marketSnapshots[a.id],t.hasLoadedPortfolioPositions=!1,t.walletBalance=await te(t.walletAddress),await z(),v(o.won?`Claimed $${R(o.amountUsdc)}`:"No payout to claim"),B(),W()}catch(o){C("claim_failed"),v(o instanceof Error?o.message:"Claim failed")}finally{delete t.claimingMarketIds[a.id],W()}},Br=e=>{if(!e)return"";let a=t.referralData,r=a?.referrals?.length?a.referrals.map(n=>{let s=n.displayName||j(n.walletAddress),i=n.remaining<=0;return`
  ...
  `},W=()=>{if(!k||!T)return;ze?.toggleAttribute("hidden",!0),qe?.toggleAttribute("hidden",!0),re?.toggleAttribute("hidden",!0),Ue?.classList.remove("active"),Pe?.classList.remove("active"),Ce?.classList.add("active"),document.body.classList.remove("detail-mode"),T.hidden=!0,k.hidden=!1,k.classList.add("markets-list"),t.walletAddress&&!t.referralData&&!t.referralError&&!t.loadingReferralData&&Me(),t.walletAddress&&(!t.hasLoadedPortfolioPositions||Date.now()-t.portfolioPositionsLoadedAt>15e3)&&!t.loadingPortfolioPositions&&(t.portfolioMarketPreviews.length===0&&jt(),z({force:!t.hasLoadedPortfolioPositions}));let a=je(),r=Le().filter(u=>{let h=t.marketPositions[u.id];return a.has(u.id)||h&&(h.yesSharesUsdc+h.noSharesUsdc>0||(h.optionSharesUsdc||0)>0)}),o=r.filter(u=>(t.marketSnapshots[u.id]?.outcome??0)===0),n=r.filter(u=>(t.marketSnapshots[u.id]?.outcome??0)!==0),s=!!t.walletAddress,i=t.profileUsername||(t.walletAddress?j(t.walletAddress):"Anonymous"),d=M(i),p=M(t.profileUsername||""),m=t.profileNotice?`<div style="margin-top: 14px !important; padding: 10px 12px !important; border-radius: 8px !important; border: 1px solid ${t.profileNotice.type==="error"?"rgba(239, 68, 68, 0.28)":"rgba(16, 185, 129, 0.24)"} !important; background: ${t.profileNotice.type==="error"?"rgba(127, 29, 29, 0.22)":"rgba(6, 95, 70, 0.18)"} !important; color: ${t.profileNotice.type==="error"?"#fca5a5":"#86efac"} !important; font-size: 0.8rem !important; font-weight: 650 !important;">${M(t.profileNotice.message)}</div>`:"",f=i.charAt(0).toUpperCase();k.innerHTML=`
    <section class="portfolio-surface">
      ...
      ${t.loadingPortfolioPositions?kr(2):t.walletAddress?r.length===0?'<div class="portfolio-empty">No positions found for this wallet yet. Confirmed trades will appear here after the Arc transaction settles.</div>':`
  ...
  `},g=()=>{if(qt.forEach(e=>{let a=e.dataset.bottomNav;e.classList.toggle("active",a==="saved"?t.showSaved:a===t.activeSurface&&!t.showSaved)}),t.activeSurface==="markets"){ma();return}if(t.activeSurface==="portfolio"){W();return}if(t.activeSurface==="leaderboard"){fa();return}ga(),Xt(),he(),Lr(),F&&(F.value=t.activeArchiveDate??"")};at.textContent=Wt();re?.addEventListener("click",e=>{let r=e.target.closest("[data-category]");r&&(t.activeCategory=r.dataset.category,window.history.pushState({},"","#feed"),Y(),g(),Be(),ne(t.activeCategory))});k?.addEventListener("input",e=>{let a=e.target;if(a.id!=="newsSearchInput")return;let r=a.selectionStart??a.value.length,o=a.selectionEnd??a.value.length;t.newsSearchQuery=a.value,he();let n=k?.querySelector("#newsSearchInput");n&&(n.focus(),n.setSelectionRange(r,o))});Ue?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="markets",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,window.history.pushState({},"","#markets"),Y(),g()});Pe?.addEventListener("click",()=>{t.activeSurface="feed",t.showSaved=!1,window.history.pushState({},"","#feed"),Y(),g(),Be(),ne(t.activeCategory)});Ce?.addEventListener("click",()=>{t.feedScrollY=window.scrollY,t.activeSurface="portfolio",t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=!1,window.history.pushState({},"","#portfolio"),Y(),g()});X?.addEventListener("click",()=>{t.walletAddress?(window.location.hash="#portfolio",Ie()):Fe()});document.addEventListener("click",e=>{let a=e.target,r=a.closest(".copy-address-btn");if(r){let i=r.getAttribute("data-address");i&&navigator.clipboard.writeText(i).then(()=>{v("Wallet address copied!")})}let o=a.closest("[data-claim-market]");if(o){let i=o.getAttribute("data-claim-market");i&&Ir(i);return}if(a.closest("[data-open-referrals]")){t.referralPanelOpen=!t.referralPanelOpen,!t.referralData&&!t.loadingReferralData&&Me(),W();return}if(a.closest("[data-close-referrals]")){t.referralPanelOpen=!1,W();return}if(a.closest("[data-refresh-referrals]")){t.referralError=null,Me(),W();return}let n=a.closest("[data-copy-referral-code]");if(n){let i=n.getAttribute("data-copy-referral-code")||"";i&&navigator.clipboard.writeText(i).then(()=>v("Invite code copied"));return}let s=a.closest("[data-copy-referral-link]");if(s){let i=s.getAttribute("data-copy-referral-link")||"";i&&navigator.clipboard.writeText(i).then(()=>v("Invite link copied"));return}a.closest("[data-connect-wallet]")&&(t.walletAddress?_t():Fe())});qt.forEach(e=>{e.addEventListener("click",()=>{let a=e.dataset.bottomNav;t.selectedMarketId=null,t.selectedStoryId=null,t.selectedThreadUrl=null,t.showSaved=a==="saved",a==="markets"?(t.activeSurface="markets",window.history.pushState({},"","#markets")):a==="portfolio"?(t.activeSurface="portfolio",window.history.pushState({},"","#portfolio")):a==="leaderboard"?(t.activeSurface="leaderboard",window.history.pushState({},"","#leaderboard")):(t.activeSurface="feed",window.history.pushState({},"","#feed"),Be(),ne(t.activeCategory),a==="saved"&&(sr(),nt(),Ae())),Y(),g()})});F?.addEventListener("change",()=>{t.activeArchiveDate=F.value||null,window.history.pushState({},"","#feed"),Y(),g(),ne(t.activeCategory)});Ba?.addEventListener("click",()=>{t.activeArchiveDate=null,F&&(F.value=""),window.history.pushState({},"","#feed"),Y(),g(),ne(t.activeCategory)});k?.addEventListener("click",async e=>{let a=e.target;if(a.closest("#editUsernameBtn")){let h=k?.querySelector(".username-display-row"),l=k?.querySelector("#usernameEditForm");if(h&&l){h.style.display="none",l.style.display="flex";let c=l.querySelector("#usernameInput");c&&c.focus()}return}if(a.closest("#cancelUsernameBtn")){let h=k?.querySelector(".username-display-row"),l=k?.querySelector("#usernameEditForm");h&&l&&(h.style.display="flex",l.style.display="none");return}let n=a.closest("#saveUsernameBtn");if(n){let l=k?.querySelector("#usernameEditForm")?.querySelector("#usernameInput");if(l){let c=l.value.trim().slice(0,15),b=n,x=b.textContent||"Save";b.disabled=!0,b.textContent="Saving...",or(c),t.profileNotice=null;try{t.walletAddress&&await ie(!1),t.profileNotice={type:"success",message:"Username saved to your shared leaderboard profile."},v("Username updated"),W()}catch(w){let $=w instanceof Error?w.message:"Username save failed";t.profileNotice={type:"error",message:$},v($),b.disabled=!1,b.textContent=x,W()}}return}let s=a.closest("[data-timeframe]");if(s){let h=s.dataset.timeframe;t.activeMarketTimeframe=h,ma();return}let i=a.closest("[data-market-id]");if(i){t.selectedMarketId=i.dataset.marketId??null,C("market_view"),window.history.pushState({},"",`#market-${t.selectedMarketId}`),g(),window.scrollTo({top:0,behavior:"smooth"});return}let d=a.closest("[data-thread-story-id]"),p=a.closest("[data-export-id]"),m=a.closest("[data-export-action]"),f=a.closest("[data-story-id]");if(d){e.stopPropagation();let h=t.stories.find(l=>l.id===Number(d.dataset.threadStoryId));h&&Ya(h);return}let u=a.closest(".mobile-bookmark-btn, .bookmark-button");if(u){e.stopPropagation();let h=u.dataset.bookmarkUrl||"",l=t.stories.find(c=>c.sourceUrl===h);if(!l)return;l.saved=!l.saved,l.saved?ae.add(h):ae.delete(h),Ia(),v(l.saved?"Saved to your list":"Removed from saved"),he();return}if(m){e.stopPropagation(),Tr(Number(m.dataset.exportStoryId),m.dataset.exportAction);return}if(p){e.stopPropagation();let h=Number(p.dataset.exportId);t.activeShareStoryId=t.activeShareStoryId===h?null:h,he();return}f&&(a.closest("a")||Vt(Number(f.dataset.storyId),!0))});k?.addEventListener("keydown",e=>{let r=e.target.closest("[data-story-id]");!r||e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),Vt(Number(r.dataset.storyId)))});T?.addEventListener("click",e=>{let a=e.target,r=a.closest("[data-unlock-briefing]");if(r){let f=t.stories.find(u=>u.id===Number(r.dataset.unlockBriefing));f&&rt(f);return}let o=a.closest("[data-unlock-briefing-url]");if(o){let f=decodeURIComponent(o.dataset.unlockBriefingUrl||""),u=Fa(f);u&&(se(u)?We(u):rt(u));return}if(a.closest("[data-back-markets]")){t.selectedMarketId=null,t.tradeDrawerOpen=!1,window.history.pushState({},"","#markets"),g();return}if(a.closest("#openTradeDrawerBtn")){let f=I.find(l=>l.id===t.selectedMarketId);if(f){if(Ge(f,t.marketSnapshots[f.id])){v("This market is resolved and can no longer be traded.");return}if(Kt(f,t.marketSnapshots[f.id])){v("Trading is locked 20 minutes before kickoff.");return}}t.tradeDrawerOpen=!0,C("trade_drawer_open");let u=T.querySelector("#tradeDrawer"),h=T.querySelector("#tradeDrawerBackdrop");u?.classList.add("open"),h?.classList.add("open");return}if(a.closest("#closeTradeDrawerBtn")||a.closest("#tradeDrawerBackdrop")){t.tradeDrawerOpen=!1;let f=T.querySelector("#tradeDrawer"),u=T.querySelector("#tradeDrawerBackdrop");f?.classList.remove("open"),u?.classList.remove("open");return}if(a.closest("#shareWhatsAppBtn")){let f=I.find(u=>u.id===t.selectedMarketId);if(f){let u=Pr(f),h=`https://api.whatsapp.com/send?text=${encodeURIComponent(u)}`;window.open(h,"_blank")}return}let n=a.closest("[data-market-trade]");if(n&&t.selectedMarketId){let f=n.dataset.marketTrade;gr(t.selectedMarketId,f);return}let s=a.closest("[data-market-option-trade]");if(s&&t.selectedMarketId){let f=s.dataset.marketOptionTrade||t.marketTradeOptionId||"";Ar(t.selectedMarketId,f);return}let i=a.closest("[data-market-option-id]");if(i){if(i.disabled||i.classList.contains("disabled"))return;t.marketTradeOptionId=i.dataset.marketOptionId||null,g();return}let d=a.closest("[data-market-trade-side]");if(d){if(d.disabled||d.classList.contains("disabled"))return;let f=I.find(l=>l.id===t.selectedMarketId),u=f?t.marketPositions[f.id]:void 0,h=d.dataset.marketTradeSide;if(!ee(t.marketOrderMode,h,u))return;t.marketTradeSide=h,g();return}let p=a.closest("[data-market-order-mode]");if(p){t.marketOrderMode=p.dataset.marketOrderMode;let f=I.find(h=>h.id===t.selectedMarketId),u=f?t.marketPositions[f.id]:void 0;t.marketTradeSide=mt(t.marketOrderMode,t.marketTradeSide,u),t.marketTradeAmount=De(Number(t.marketTradeAmount)||0,t.marketOrderMode,t.marketTradeSide,u),g();return}a.closest("[data-back-to-feed]")&&Ga()});T?.addEventListener("input",e=>{let a=e.target;if(!a.matches("[data-market-amount]"))return;let r=I.find(p=>p.id===t.selectedMarketId),o=r?t.marketSnapshots[r.id]:void 0,n=r?t.marketPositions[r.id]:void 0,s=Number(a.value);t.marketTradeAmount=Number.isFinite(s)?s:0;let i=r&&K(r)?t.marketTradeAmount:sa(o,t.marketTradeSide,t.marketTradeAmount,t.marketOrderMode,n),d=T.querySelector(".market-inline-payout strong");d&&(d.textContent=`$${R(i)}`)});T?.addEventListener("focusin",e=>{e.target.matches("[data-market-amount]")&&document.body.classList.add("market-amount-focused")});T?.addEventListener("focusout",e=>{let a=e.target;if(a.matches("[data-market-amount]")){let r=I.find(n=>n.id===t.selectedMarketId),o=r?t.marketPositions[r.id]:void 0;t.marketTradeAmount=De(Number(a.value)||0,t.marketOrderMode,t.marketTradeSide,o),a.value=String(t.marketTradeAmount),window.setTimeout(()=>document.body.classList.remove("market-amount-focused"),120)}});window.addEventListener("popstate",Ie);window.addEventListener("hashchange",Ie);window.addEventListener("focus",async()=>{if(t.walletAddress){let e=t.walletBalance,a=await te(t.walletAddress);t.walletBalance=a,B(),(!e||parseFloat(e)===0)&&parseFloat(a)>0&&(console.log("[X402] Balance changed from 0 to positive. Triggering Gateway warmup..."),Ta())}});Ke?.addEventListener("click",()=>{if(!Ve||!Ke)return;let e=!Ve.hidden;Ve.hidden=e,Ke.setAttribute("aria-expanded",String(!e))});document.addEventListener("click",e=>{let a=e.target;!a.closest(".share-control")&&t.activeShareStoryId!==null&&(t.activeShareStoryId=null,he());let r=a.closest("[data-menu-action]");if(!r)return;let o={today:"Showing today's brief",saved:`${t.stories.filter(n=>n.saved).length} saved stories`,archive:t.archiveDates.length>0?"Choose a saved day from the archive selector":"No saved days yet"};A&&(A.textContent=o[r.dataset.menuAction??"today"]),r.dataset.menuAction==="today"&&(t.showSaved=!1,t.activeArchiveDate=null,F&&(F.value=""),Y(),Be(),ne(t.activeCategory)),r.dataset.menuAction==="saved"&&(ga(),nt(),Ae(),t.showSaved=!0,document.querySelector("#archiveControls")?.classList.remove("mobile-open"),Y(),g())});var Dr=async()=>{try{let e=await fetch(E("/api/summary/unlock-config"));e.ok&&(t.unlockConfig=await e.json(),g())}catch(e){console.error("Failed to prefetch unlock config:",e)}};g();B();Dr();Ea().then(()=>{mr(),g(),B(),window.setTimeout(_r,1200),Va()});var Nr=document.querySelector("#mobileArchiveCard"),fe=document.querySelector("#archiveControls");Nr?.addEventListener("click",()=>{if(!fe)return;fe.classList.toggle("mobile-open")&&setTimeout(()=>fe.scrollIntoView({behavior:"smooth",block:"center"}),50)});var Or=document.querySelector("#archivePill");Or?.addEventListener("click",e=>{if(e.stopPropagation(),!fe)return;fe.classList.toggle("mobile-open")&&setTimeout(()=>fe.scrollIntoView({behavior:"smooth",block:"center"}),50)});var He=!1,Nt=!1,_r=()=>{Nt||(Nt=!0,(async()=>{let e=await Re();if(He=!!e,e){t.walletConnecting=!0,B();try{let a=await xa();He=!1,t.walletConnecting=!1,a?(t.walletAddress=await Re(),t.walletAddress&&(me(),t.walletBalance=await te(t.walletAddress),await z()),B(),t.activeSurface==="portfolio"&&g()):(t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,me(),v("Session expired. Please sign in again."),B(),g())}catch(a){console.warn(a),He=!1,t.walletConnecting=!1,t.walletAddress=null,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,me(),v("Session expired. Please sign in again."),B(),g()}}await $a(a=>{He||(t.walletAddress=a,t.walletBalance=null,t.referralData=null,t.referralError=null,t.referralPanelOpen=!1,me(),a&&ie(!1).catch(r=>console.error("Failed to report leaderboard entry:",r)),t.marketPositions={},t.hasLoadedPortfolioPositions=!1,B(),a?(Me(),te(a).then(r=>{t.walletBalance=r,B(),t.activeSurface==="portfolio"&&g()}),z()):t.activeSurface==="portfolio"&&g())})})())};C("app_open");document.addEventListener("click",e=>{let r=e.target.closest("a, button");if(r){let o=r.className||"",n=typeof o=="string"?o:r.getAttribute("class")||"",s=r.getAttribute("href")||"";!(r.hasAttribute("data-unlock-briefing")||r.hasAttribute("data-unlock-briefing-url")||r.classList.contains("summary-btn")||r.textContent?.trim()==="AI briefing"||r.textContent?.trim().includes("Unlock via"))&&(n.includes("source-button")||n.includes("source-btn")||n.includes("source-link")||r.textContent?.trim()==="Open source")&&!n.includes("disabled")&&s!=="#"&&C("open_source")}},!0);
