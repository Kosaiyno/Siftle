...
const marketsToResolve = [
  { marketId: "wc-france-england-corners", winningOptionId: "no" },
  { marketId: "wc-france-england-cards", winningOptionId: "0-2" },
  { marketId: "wc-france-england-halftime", winningOptionId: "england-lead" },
  { marketId: "wc-france-england-fouls", winningOptionId: "france" },
  { marketId: "wc-france-england-bronze-winner", winningOptionId: "england" },
  { marketId: "wc-france-england-goals", winningOptionId: "4-plus" },
  { marketId: "wc-france-england-rating-duel", winningOptionId: "mbappe" },
  { marketId: "wc-france-england-victory-method", winningOptionId: "england-regular" },
  { marketId: "wc-france-england-mbappe-goals", winningOptionId: "2-plus" },
  { marketId: "wc-france-england-exact-score", winningOptionId: "other" }
];
...
async function run() {
  console.log("Starting resolution for 10 France vs England markets...");
