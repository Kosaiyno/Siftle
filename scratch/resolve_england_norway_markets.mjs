...
const marketsToResolve = [
  { marketId: "wc-england-norway-qualify", winningOptionId: "england" },
  { marketId: "wc-haaland-kane-goals", winningOptionId: "tie" },
  { marketId: "wc-england-norway-yellow-cards", winningOptionId: "0-2" },
  { marketId: "wc-england-norway-victory-method", winningOptionId: "either-et" }
];
